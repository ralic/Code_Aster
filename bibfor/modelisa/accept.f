      SUBROUTINE ACCEPT(NOMRES,F,NBM,LIGRMO,METHOD,IMODE,JMODE,UFLUI,
     &                  JC,DIR,UC,UCT,L,LT)
      IMPLICIT NONE
C-----------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 09/07/2001   AUTEUR CIBHHLV L.VIVAN 
C ======================================================================
...
C
      ...
      INTEGER      DIM,IFREQ,NFINIT,NFIN,INUMO,NBM,NBPOIN
      INTEGER      I,IRET,IREFE,ILIME,JLVA,INOLI,IND,JND
      INTEGER      NBELEM,NBGREL,NBELGR,IPG,JPG,NBMODE
      INTEGER      JM,IM,IGR,IEL,JEL,IVE1,IVE2,N1,N2,NPG1,NPG2
      INTEGER      IMA,JMA,IALIEL,IAD1,IAD2,ITAB,IMODE,JMODE
      ...
      REAL*8       UCT,LT,HAUT1,HAUT2,RAYON,RAYON2,DIFF,CORDE,CORDE2
      REAL*8       COYANG,DIST,DTETA,MEDIAN,JC1,V1,V2,V3,W1,W2,W3
      COMPLEX*16   CBID
      CHARACTER*1  K1BID
      CHARACTER*7  JELEM,IELEM
      CHARACTER*8  VETEL,NOMRES,LPAIN(2),LPAOUT(1),MODELE,MODMEC
      CHARACTER*8  MOINT,METHOD
      CHARACTER*19 BASE,VEC,NOMCHA,NUME,CHGEOM,MATAS
      CHARACTER*24 FREQ,NUMO,REFE,LIGRMO,LCHIN(2),LCHOUT(1)
...
205               CONTINUE
                  ...
                  COEH=CORCOS(D1,D2,D3,LOCAL(1),LOCAL(2),
     &                        LOCAL(3),UC,KT,KL,OMEGA)
