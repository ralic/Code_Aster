...
C MODIF MODELISA  DATE 25/10/2010   AUTEUR COURTOIS M.COURTOIS 
C ======================================================================
...
C
      ...
      CALL MFNOML ( FID, NOMAMD, ZK16(JNOMNO), NBNOEU,
...
C
      ...
      CALL INITCH(NOMCOO, 3)
      CALL INITCH(UNICOO, 3)
C
...
C
      IF ( NDIM.EQ.3 ) THEN
C
      CALL MFCOOL ( FID, NOMAMD, NDIM, ZR(JCOORD), EDFUIN,
     &              EDALL, TABAUX, 0,
...
C
      CALL MFCOOL ( FID, NOMAMD, NDIM, ZR(JCOORL), EDFUIN,
     &              EDALL, TABAUX, 0,
     &              TYPREP, NOMCOO, UNICOO, CODRET )
      IF ( CODRET.NE.0 ) THEN
        SAUX08='MFCOOL  '
