...
C
      ...
      INTEGER IAD1,IAD2,IAD3,IFIS,NNGL,INO
      REAL*8  TLSN 
...
C
      DO 110 IMA = 1,NBMA
C -----ON VERIFIE QUE LE MAILLAGE NE CONTIENT PAS DES 'TRIA6'      
        ITYPMA=ZI(JMA-1+IMA)
        CALL JENUNO(JEXNUM('&CATA.TM.NOMTM',ITYPMA),TYPMA)
        IF (TYPMA.EQ.'TRIA6') CALL U2MESS('F','XFEM_27')
...
C     ON VERIFIE QUE LE MAILLAGE NE CONTIENT QUE DES 'TRIA6' OU 'QUAD8'
               ITYPMA=ZI(JMA-1+IMA)
               CALL JENUNO(JEXNUM('&CATA.TM.NOMTM',ITYPMA),TYPMA)
               IF (NDIM.EQ.3) THEN 
                 TYPMA = 'TR3'
               ELSE IF (NDIM.EQ.2) THEN
                 IF ((TYPMA.EQ.'QUAD8').OR.(TYPMA.EQ.'TRIA6')) THEN
                   TYPMA = 'SG2'
                 ELSE
...
C --- ON RECUPERE LE NOMBRE DE POINTS D'INTEGRATION
               CALL XMELIN(TYPMA,TYPINT,NNINT)
C     
