      SUBROUTINE CAIMPD ( CHAR, LIGRMO, NBCA, NBET, NOMA, FONREE )
      IMPLICIT   NONE
      INTEGER           NBCA, NBET
      CHARACTER*4       FONREE
...
C
      IF (FONREE.EQ.'REEL') THEN
         CALL ALCART ( 'G', CARTE, NOMA, 'IMPE_R', NBCA+1, NBET )
      ELSE IF (FONREE.EQ.'FONC') THEN
         CALL ALCART ( 'G', CARTE, NOMA, 'IMPE_F', NBCA+1, NBET )
      ELSE
         CALL UTMESS('F','CAIMPD','VALEUR INATTENDUE: '//FONREE )
      ENDIF
C
...
C
         IF (FONREE.EQ.'REEL') THEN
            CALL GETVR8 ( MOTCLF, 'IMPE', IOCC,1,1, ZR(JVALV), N )
         ELSE
