...
C
      ...
      CHARACTER*16 TYCHLU,OPTION,TYPCHS,TYPCH2
      ...
      CALL GETVID(' ','TABLE',0,IARG,1,TABIN,N1)
      CALL GETVTX(' ','TYPE_CHAM',0,IARG,1,TYCHLU,N1)
...
C     VERIFICATIONS
      ...
      ELSEIF(TYPCHS(1:2).EQ.'EL')THEN
        CALL GETVID(' ','MODELE',0,IARG,0,K8B,N1)
        CALL GETVTX(' ','OPTION',0,IARG,0,K8B,N2)
        IF(N1.NE.0)THEN
          N1=-N1
        ...
        IF(N2.NE.0)THEN
          N2=-N2
          CALL GETVTX(' ','OPTION',0,IARG,1,OPTION,N2)
        ENDIF
...
C     CREATION DU CHAMP SIMPLE
      CALL TABCHS(TABIN,TYPCH2,'V',NOMGD,MA,MO,OPTION,CHS)

C     TRANSFORMATION : CHAM_S --> CHAMP
      CALL GETVTX(' ','PROL_ZERO',0,IARG,1,PROL0,N1)
