...
C
      ...
      PARAMETER   ( NBVLI = 1 , NBVLR = 2 , NBVLK = 1 )
      INTEGER      VALI(NBVLI)
      REAL*8       VALR(NBVLR)
...
C
      ...
      IF (NOCC1.NE.0) THEN
        IF ((POND1.GT.1.D0).OR.(POND1.LT.0.D0)) THEN
          CALL U2MESR('F','ARLEQUIN_15',1,POND1)
        ENDIF
        POND2 = 1.D0 - POND1
        GOTO 50
      ENDIF
C
      ...
      IF (NOCC2.NE.0) THEN
        IF ((POND2.GT.1.D0).OR.(POND2.LT.0.D0)) THEN
          CALL U2MESR('F','ARLEQUIN_15',1,POND2)
        ENDIF
        POND1 = 1.D0 - POND2
        GOTO 50
      ENDIF
