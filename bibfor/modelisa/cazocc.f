...
C MODIF MODELISA  DATE 10/10/2006   AUTEUR KHAM M.KHAM 
C ======================================================================
...
C      CORRESPONDE A UNE INTEGRATION AUX NOEUDS
      ...
      IF((NOC.NE.0) .AND. (.NOT.LINTNO))
     &CALL UTMESS('F','CAZOCC','SANS_GROUP_NO: INTEGRATION'//
     &    ' AUX NOEUDS OBLIGATOIRE')
