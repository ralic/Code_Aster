...
C
      ...
      CHARACTER*24 TOLECO
      INTEGER      JCMCF,JECPD,JDIR,JMETH,JTGDEF,JJSUP,JPOUDI
      INTEGER      JTOLE
      CHARACTER*16 INTER,FORMUL,TYPF,SGRNO,ALGOC,ALGOF
      REAL*8       DIR1(3),DIR(3)
      REAL*8       COEFRO,COCAUR,COFAUR,REACSI
      REAL*8       COCAUS,COFAUS,COCAUP,COFAUP
      REAL*8       KWEAR,HWEAR
      REAL*8       ASPER,KAPPAN,KAPPAV
      REAL*8       DIST1,DIST2,LAMB
      LOGICAL      LINTNO,MMMAXI,LMAIT,LESCL,LAXIS
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ()
...
C --- LECTURE DES PARAMETRES DE LA LOI D'USURE POUR METHODE CONTINUE
        ...
        END IF
C --- FIN LECTURE PARAMETRES DE LA LOI D'USURE POUR METHODE CONTINUE  
        IF (NOCC .NE. 0) THEN
