...
C
      DO 10 IOCC = 1, IROTA
        ...
        CALL GETVR8 ('ROTATION','VITESSE',IOCC,1,1,ROTA(1),N1)
        CALL GETVR8 ('ROTATION','AXE',IOCC,1,3,ROTA(2),N2)
        CALL GETVR8 ('ROTATION','CENTRE',IOCC,1,3,ROTA(5),NROTA)
        ...
        IF (N1.GT.0) THEN
         ...
         END IF
        ENDIF
        CALL GETVTX ('ROTATION','MAILLE', IOCC,1,1,K8B,NBMAIL)
        CALL GETVTX ('ROTATION','GROUP_MA', IOCC,1,1,K8B,NBGPMA)
        CALL GETVTX ('ROTATION','TOUT', IOCC,1,1,K8TOUT,NBTOUT)
        NBMA = NBMAIL+NBGPMA
