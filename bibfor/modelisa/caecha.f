      SUBROUTINE CAECHA ( CHAR, LIGRMO, NBCA, NBET, NOMA, NDIM, FONREE )
      IMPLICIT   NONE
...
C
      IF (FONREE.EQ.'REEL') THEN
         CALL ALCART ( 'G', CARTE1, NOMA, 'COEH_R', NBCA+1, NBET )
         CALL ALCART ( 'G', CARTE2, NOMA, 'TEMP_R', NBCA+1, NBET )
      ELSE IF (FONREE.EQ.'FONC') THEN
         CALL ALCART ( 'G', CARTE1, NOMA, 'COEH_F', NBCA+1, NBET )
         CALL ALCART ( 'G', CARTE2, NOMA, 'TEMP_F', NBCA+1, NBET )
      ELSE
