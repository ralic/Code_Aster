...
!
            c(k,l,1)=c0(k,l,1)/2.0d0* (ac(k,l,1)+gc(k,l,1)*vint(1))&
            /(ac(k,l,1)+vint(1))
!
            cp1(k,l)= c0(k,l,1)/2.0d0* ac(k,l,1)*(gc(k,l,1)-1.0d0)&
            /(ac(k,l,1)+vint(1))**2
!
            cs1(k,l)=-c0(k,l,1)* ac(k,l,1)*(gc(k,l,1)-1.0d0) /(ac(k,l,&
            1)+vint(1))**3
!
            c(k,l,2)=c0(k,l,2)/2.0d0* (ac(k,l,2)+gc(k,l,2)*vint(2))&
            /(ac(k,l,2)+vint(2))
!
            cp2(k,l)= c0(k,l,2)/2.0d0* ac(k,l,2)*(gc(k,l,2)-1.0d0)&
            /(ac(k,l,2)+vint(2))**2
!
            cs2(k,l)=-c0(k,l,2)* ac(k,l,2)*(gc(k,l,2)-1.0d0) /(ac(k,l,&
            2)+vint(2))**3
!
        end do
!
