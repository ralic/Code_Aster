      SUBROUTINE CARACO(CHAR,MOTFAC,NOMA,NOMO,NDIM,NZOCO,
     +            NNOQUA)
...
C
      DO 8 IOC = 1,NZOCP  
         IREAD  = IOC
         IWRITE = IOC                
         CALL CAZOCO(CHAR,MOTFAC,NOMA,NOMO,NDIM,IREAD,
     +                  IWRITE)          
  8   CONTINUE   
C  
...
C
 ...
 10         CONTINUE             
  9      CONTINUE      
         IF (ISYME.NE.NSYME) CALL UTMESS ('F','CARACO',
     +                                 'ERREUR SYMETRIQUE')
         IF (IWRITE.NE.NZOCO) CALL UTMESS ('F','CARACO',
     +                                 'ERREUR SYMETRIQUE')         
      ENDIF  
