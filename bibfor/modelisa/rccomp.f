...
C ----------------------------------------------------------------------
C
      INTEGER IBID, NOCC,I,J,NM, NT, JNCMP, JVALV, NBMA,JMAIL,IER,NBCMP
      CHARACTER*8   TYPMCL(2)
      CHARACTER*16  MOTCLE(2)
      CHARACTER*24  MESMAI
      CHARACTER*1 K1BID

      INTEGER NCMPMA,ICMP,ICPRI,ICPRK,NBGMAX,ICP
      PARAMETER (NCMPMA=7+9+4)
      CHARACTER*8 NOMGRD,NOMCMP(NCMPMA),K8B,SDCOMP,MODELE
      CHARACTER*16 VALCMP(NCMPMA)
      CHARACTER*19 COMPOR
...
C
      DO 10 I = 1 , NOCC
         CALL GETVID ( 'AFFE_COMPOR', 'COMPOR' , I,1,1, SDCOMP, NM )
...
C---- REMPLISSAGE DE LA CARTE
         ...
         WRITE(ZK16(JVALV-1+7),'(I16)') ZI(ICPRI+2)
         CALL GETVTX ( 'AFFE_COMPOR', 'TOUT'  , I,1,1, K8B   , NT )
         IF ( NT .NE. 0 ) THEN
