      SUBROUTINE ELIMCO(NOMA,PZONE,NZOCO,NSUCO,NMACO,NNOCO,NNOQUA,
     &                  PSURMA,PSURNO,PNOQUA,CONTMA,CONTNO,CONOQU,
     &                  SANSNO,PSANS)
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 09/10/2002   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C ======================================================================
      ...
      CHARACTER*8 NOMA
      CHARACTER*24 PZONE,PSURMA,PSURNO,CONTMA,CONTNO,SANSNO,PSANS
      CHARACTER*24 CONOQU,PNOQUA
...
C VAR NMACO  : NOMBRE TOTAL DE MAILLES DES SURFACES
C VAR NNOCO  : NOMBRE TOTAL DE NOEUDS DES SURFACES
C VAR PSURMA : POINTEUR DES MAILLES DES SURFACES
C VAR PSURNO : POINTEUR DES NOEUDS DES SURFACES
C VAR CONTMA : LISTE DES NUMEROS DES MAILLES DE CONTACT
C VAR CONTNO : LISTE DES NUMEROS DES NOEUDS DE CONTACT
C VAR LSANNO : LONGUEUR VARIABLE DE L'OBJET SANSNO
C OUT SANSNO : LISTE DES NUMEROS ABSOLUS DES NOEUDS INTERDITS
C              COMME ESCLAVES DANS CHAQUE ZONE
C OUT PSANS  : POINTEUR DES NOEUDS ESCLAVES INTERDITS
...
C ---------------- FIN DECLARATIONS NORMALISEES JEVEUX -----------------
      ...
      INTEGER JZONE,JSUMA,JSUNO,JMACO,JNOCO,JDECMA,JDECNO
      INTEGER NSANS,IOCPRE
      INTEGER JINDMA,JINDNO,JELIMA,JELINO,JMA,JNO,JSANS,JPSANS
      INTEGER IZONE,ISUDEB,ISUFIN,IOC,NELIM,JELIM,STOCNO,LSANNO
      INTEGER NBMA,NBNO,ELIMNO,ELIMMA,NMACO0,NNOCO0,I,II,ISUCO,K,J
      INTEGER JINDQU,JELIQU,JNOQUA,JNOQU,ELIMQU,NNOQU0,JDECQU,NBNOQU
      INTEGER JQU
      CHARACTER*8 K8BID
