...
C ======================================================================
      IMPLICIT NONE
C-----------------------------------------------------------------------
C BUT : CREE UNE SD_VOISINAGE DANS UNE SD_MAILLAGE
C
C  IN/JXVAR   MAZ      : MAILLAGE
C
...
C-----------------------------------------------------------------------
      ...
      INTEGER IV,IBID,NBMA,IER,DIM,DIMMA,IATYMA,M0,MV,IS,ADCOM0,NBSOM0,
     &        NBMR,ADMAR,IR,NUMAR,NVTOT,IAD,DIMVLO
C
...
C
      ...
      CONNEX=MA//'.CONNEX'
C
      PTVOIS=MA//'.VGE.PTVOIS'
      ELVOIS=MA//'.VGE.ELVOIS'


      CALL WKVECT(PTVOIS,'G V I',NBMA+1,IADDVO)
      ZI(IADDVO)=0
...
C
      CALL WKVECT(ELVOIS,'G V I',ZI(IADDVO+NBMA),IADVOI)
C --------- BOUCLE SUR LES MAILLES  ----------------
C
      DO 120 M0=1,NBMA
        CALL JENUNO(JEXNUM('&CATA.TM.NOMTM',ZI(IATYMA-1+M0)),TYPEM0)
