      SUBROUTINE VERIPL(MA,NBMA,LINOMA,ANG,TYPERR)
      IMPLICIT NONE
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 20/10/1999   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C ======================================================================
      CHARACTER*(*) MA
      INTEGER NBMA,JCOOR,JCONX,IMA,K,IPREM,NUMAIL
      CHARACTER*8 MA2,LINOMA(NBMA),NOMAIL,NOMAI1
...
C  NBMA  IN   I  : NOMBRE DE MAILLES DANS LINOMA
C  LINOMA IN  V(K8): LISTE DES NOMS DES MAILLES DONT ON VEUT
...
C   LES MAILLES DE LINOMA DOIVENT ETRE "SURFACIQUES" 3D
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ------
      ...
      DO 20,IMA = 1,NBMA
        NOMAIL = LINOMA(IMA)
        CALL JENONU(JEXNOM(MA2//'.NOMMAI',NOMAIL),NUMAIL)
