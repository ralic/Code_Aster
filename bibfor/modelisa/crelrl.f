...
C
      ...
      ELSE IF (TYPVAL.EQ.'FONC') THEN
          CALL WKVECT(LISREL//'.RLBE',BASE//' V K8',NBRELA,IDBETA)
      ENDIF
C
...
C
      CALL JECREO(LISREL//'.RLNR',BASE//' E I')
      CALL JEVEUO(LISREL//'.RLNR','E',IDNBRE)
      ZI(IDNBRE) = 0
C
C ---  TYPE DES COEFFICIENTS DES RELATIONS (TYPCOE)
C
      CALL JECREO(LISREL//'.RLTC',BASE//' E K8')
      CALL JEVEUO(LISREL//'.RLTC','E',IDTYCO)
      ZK8(IDTYCO) = TYPCOE(1:4)//'    '
C
C ---  TYPE DES VALEURS DES RELATIONS (TYPVAL)
C
      CALL JECREO(LISREL//'.RLTV',BASE//' E K8')
      CALL JEVEUO(LISREL//'.RLTV','E',IDTYVA)
