...
C --- ALLOCATION DES CARTES
      CALL ALCAR2('G',CARTBA,NOMA,'CAGNBA')
      CALL ALCAR2('G',CARTBG,NOMA,'CAGEBA')
...
C     POUR LA CARTE DE VENT ==> FCXP
      ...
      DO 70 I = 1 , NBAAFF
         ...
         CALL NOCAR2(CARTBA,3,' ','NOM',1,NOMMAI,0,' ',1)
         CALL NOCAR2(CARTBF,3,' ','NOM',1,NOMMAI,0,' ',1)
 70   CONTINUE
C
...
C ---       GENERALE
            DO 78 I = 1 , 6
               ZR (JDVBG+I-1) = 0.D0
 78         CONTINUE
            CALL NOCAR2(CARTBG,3,' ','NOM',1,NOMMAI,0,' ',6)
         ELSE
