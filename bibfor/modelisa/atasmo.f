...
C -----  VARIABLES LOCALES
      ...
      INTEGER IEQ,JSMHC,NEQ,NBLIG,JSMDI,NCOEF,JVALM,DECAL,IER,JREFA,KK
      INTEGER I,JSMDE,JREFE,IBID,II1,II2,III,II,JJ
...
C     (ZI(JSMDI),SMHC) DE LA MATRICE
      ...
      CALL MOINIP(NEQ,NCOEF,ZI(JSMDI),ZI(IDSUIV),ZI(JHBID),ZI(JSMHC))
...
C           -- CUMUL DE VIJ DANS .VALM :
            DO 100,III = II1,II2
              IF (ZI(JSMHC-1+III).EQ.II) GO TO 110
  100       CONTINUE
            CALL ASSERT(.FALSE.)
  110       CONTINUE
