...
C --- DEBUT
      ...
      ELSE
        CALL UTMESS('F','PANBNO_01','CE TYPE DE MAILLE N"EST PAS ENCORE'
     +              //' TRAITE : '//NOMTM)
      ENDIF
      IF (NBNTOT.NE.(NBNOTT(1)+NBNOTT(2)+NBNOTT(3))) THEN
        CALL UTMESS('F','PANBNO_02','LE NOMBRE TOAL DE NOEUDS EST '
     +  //'/= DE LA SOMME DES NOEUDS SOMMETS,ARRETES ET INTERIEURS')
      ENDIF
      CALL JEDEMA()
      END
