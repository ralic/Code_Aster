      SUBROUTINE ARLCHA(DIME,CINE,NOM1Z,NOM2Z,EQ,CHARGE)
...
C LOGICAL        EQ(5,*) : SELECTION DES EQUATIONS COUPLAGE (CF ARLCLR)
...
C --- PARAMETRE
      REAL*8       PREC1,PREC2
      PARAMETER   (PREC1 = 1.D-12)
      PARAMETER   (PREC2 = 1.D-4)

C --- VARIABLES
      CHARACTER*(*) NOM1Z,NOM2Z
...
C --- ADIMENSIONNEMENT ET COMPTE DES TERMES DES EQUATIONS
      ...
      NT = 0
      CALL ARLCH0(DIME,IA1,IAC,NNC,ZI(B2),ZR(MX),PREC1,EQ,ZR(B0),NT)
      CALL ARLCH0(DIME,IA2,IAC,NNC,ZI(C2),ZR(MX),PREC1,EQ,ZR(C0),NT)
...
C --- MATRICE MORSE 1
      ...
      CALL ARLCH1(DIME,NNC,0,NU,ZR(B0),ZI(B1),ZI(B2),PREC1,
     &            EQ,NDD,NEL,NLG,ZR(D0),ZR(D1),ZI(D2),ZI(D3))
      GOTO 120

 90   CONTINUE
      CALL ARLCH2(DIME,NNC,0,NU,ZR(B0),ZI(B1),ZI(B2),PREC1,
     &            EQ,NDD,NEL,NLG,ZR(D0),ZR(D1),ZI(D2),ZI(D3))
      GOTO 120

 100  CONTINUE
      CALL ARLCH3(DIME,NNC,0,NU,ZR(B0),ZI(B1),ZI(B2),PREC1,
     &            EQ,NDD,NEL,NLG,ZR(D0),ZR(D1),ZI(D2),ZI(D3))
      GOTO 120

 110  CONTINUE
      CALL ARLCH4(DIME,NNC,0,NU,ZR(B0),ZI(B1),ZI(B2),PREC1,
     &            EQ,NDD,NEL,NLG,ZR(D0),ZR(D1),ZI(D2),ZI(D3))
...
C --- MATRICE MORSE 2
      ...
      CALL ARLCH1(DIME,NNC,1,NU,ZR(C0),ZI(C1),ZI(C2),PREC1,
     &            EQ,NDD,NEL,NLG,ZR(D0),ZR(D1),ZI(D2),ZI(D3))
      GOTO 160

 130  CONTINUE
      CALL ARLCH2(DIME,NNC,1,NU,ZR(C0),ZI(C1),ZI(C2),PREC1,
     &            EQ,NDD,NEL,NLG,ZR(D0),ZR(D1),ZI(D2),ZI(D3))
      GOTO 160

 140  CONTINUE
      CALL ARLCH3(DIME,NNC,1,NU,ZR(C0),ZI(C1),ZI(C2),PREC1,
     &            EQ,NDD,NEL,NLG,ZR(D0),ZR(D1),ZI(D2),ZI(D3))
      GOTO 160

 150  CONTINUE
      CALL ARLCH4(DIME,NNC,1,NU,ZR(C0),ZI(C1),ZI(C2),PREC1,
     &            EQ,NDD,NEL,NLG,ZR(D0),ZR(D1),ZI(D2),ZI(D3))
