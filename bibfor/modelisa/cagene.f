      SUBROUTINE CAGENE ( FONREE, CHAR, OPER, LIGRMZ, NOMA, NDIM )
...
C      FONREE : FONC OU REEL SUIVANT L'OPERATEUR
...
C
      ...
      CALL JECREO ( NOMO, 'G E K8')
      CALL JEVEUO ( NOMO, 'E', JNOMO )
      ZK8(JNOMO) = MOD
      LIGRMZ=LIGRMO
C
      CALL JEDEMA()
