...
C     CREATION D'UNE CARTE CONTENANT LE POINT P ORIGINE DE PHI
      ...
      CALL RAORFI(NOMA,LIGREL,KLISNO,LONLIS,NOEPOU,CARA,COORIG,EG1,EG2,
     &            EG3,'&&RATU3D',RAYON)
...
C --- CREATION DES .REFE_RESU DES VECTEURS EN SORTIE DE CALCUL
      ...
      CALL WKVECT('&&RATU3D.REFE_RESU','V V K24',5,IAREFE)
      ZK24(IAREFE+1-1) = MOD
...
C --- CREATION DU .LISTE_RESU
      ...
      CALL WKVECT('&&RATU3D.LISTE_RESU','V V K24',1,ILIRES)
...
C     RELATIONS ENTRE LES NOEUDS DE SURFACE ET LE NOEUD POUTRE DDL WO
     ...
     &            LPAOUT,'V')
      ...
      CALL ASSVEC('V','CH_DEPL_3',1,'&&RATU3D.LISTE_RESU',1.D0,NUMDDL,
     &            ' ','ZERO',1)
...
C   DDL UIM, UOM, VIM, VOM, WIM, WOM, M VARIANT DE 2 A NBMODE
      ...
      CALL GETVIS(' ','INFO',1,1,1,INFO,IER)
      IFM = IUNIFI('MESSAGE')
      DO 10 IMOD = 1,NBMODE
        IF (INFO.EQ.2) THEN
...
C     RELATIONS ENTRE LES NOEUDS DE SURFACE ET LE NOEUD POUTRE DDL UIM
        ...
        CALL ASSVEC('V','CH_DEPL_1',1,'&&RATU3D.LISTE_RESU',1.D0,NUMDDL,
     &              ' ','ZERO',1)
...
C     RELATIONS ENTRE LES NOEUDS DE SURFACE ET LE NOEUD POUTRE DDL UOM
        ...
        ZK24(ILIRES) = LCHOUT(4)
        CALL ASSVEC('V','CH_DEPL_4',1,'&&RATU3D.LISTE_RESU',1.D0,NUMDDL,
     &              ' ','ZERO',1)
...
C     RELATIONS ENTRE LES NOEUDS DE SURFACE ET LE NOEUD POUTRE DDL VOM
        ...
        CALL ASSVEC('V','CH_DEPL_2',1,'&&RATU3D.LISTE_RESU',1.D0,NUMDDL,
     &              ' ','ZERO',1)
...
C     RELATIONS ENTRE LES NOEUDS DE SURFACE ET LE NOEUD POUTRE DDL VIM
        ...
        ZK24(ILIRES) = LCHOUT(5)
        CALL ASSVEC('V','CH_DEPL_5',1,'&&RATU3D.LISTE_RESU',1.D0,NUMDDL,
     &              ' ','ZERO',1)
...
C     OU SI IMOD=1 LE DDL DY DANS REPERE LOCAL DU TUYAU ET WO1
        ...
        ZK24(ILIRES) = LCHOUT(6)
        CALL ASSVEC('V','CH_DEPL_6',1,'&&RATU3D.LISTE_RESU',1.D0,NUMDDL,
     &              ' ','ZERO',1)
