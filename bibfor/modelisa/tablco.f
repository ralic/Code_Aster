      SUBROUTINE TABLCO(NOMA,NDIM,PZONE,NZOCO,NSUCO,NMACO,NNOCO,PSURMA,
     &                  PSURNO,CONTMA,CONTNO,MANOCO,PMANO,NMANO,NOMACO,
     &                  PNOMA,NNOMA,NORMCO,MAMACO,PMAMA,NMAMA,NOZOCO)
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 11/07/2000   AUTEUR JMBHH01 J.M.PROIX 
C ======================================================================
...
C TOLE CRP_21
      ...
      INTEGER NDIM,NZOCO,NSUCO,NMACO,NNOCO,NMANO,NNOMA,NMAMA
      CHARACTER*8 NOMA
      CHARACTER*24 PZONE,PSURMA,PSURNO,CONTMA,CONTNO
      CHARACTER*24 MANOCO,PMANO,NOMACO,PNOMA,NORMCO,MAMACO,PMAMA,NOZOCO
...
C IN  NDIM   : DIMENSION DU MODELE (COOR_2D OU COOR_3D)
...
C OUT NORMCO : COMPOSANTES DES NORMALES INITIALES AUX NOEUDS DE CONTACT
...
C ---------------- FIN DECLARATIONS NORMALISEES JEVEUX ----------------
      ...
      INTEGER JSUMA,JSUNO,JMACO,JNOCO,JMANO,JNOMA,JPOMA,JPONO,JNORM
...
C ----------------------------------------------------------------------
      ...
      CALL WKVECT(NORMCO,'G V R',3*NNOCO,JNORM)
