...
C
      IF (FONREE.EQ.'REEL') THEN
         CALL ALCART ( 'G', CARTE, NOMA, 'RAYO_R', NBCA+1, NBET )
      ELSE IF (FONREE.EQ.'FONC') THEN
         CALL ALCART ( 'G', CARTE, NOMA, 'RAYO_F', NBCA+1, NBET )
      ELSE
         CALL UTMESS('F','CARAYO','VALEUR INATTENDUE: '//FONREE )
      END IF
C
...
C
      DO 10 IOCC = 1, NRAYO
         IF (FONREE.EQ.'REEL') THEN
            CALL GETVR8 ( MOTCLF, 'SIGMA'   , IOCC,1,1, ZR(JVALV)  , N)
            CALL GETVR8 ( MOTCLF, 'EPSILON' , IOCC,1,1, ZR(JVALV+1), N)
            CALL GETVR8 ( MOTCLF, 'TEMP_EXT', IOCC,1,1, ZR(JVALV+2), N)
         ELSE
            CALL GETVID ( MOTCLF, 'SIGMA'   , IOCC,1,1, ZK8(JVALV)  ,N)
            CALL GETVID ( MOTCLF, 'EPSILON' , IOCC,1,1, ZK8(JVALV+1),N)
            CALL GETVID ( MOTCLF, 'TEMP_EXT', IOCC,1,1, ZK8(JVALV+2),N)
         END IF
C
