...
C MODIF MODELISA  DATE 07/11/2011   AUTEUR DESOZA T.DESOZA 
C ======================================================================
...
C ---     NON UTILISE
          ...
          CALL GETVIS(' ','ITER_GCP_MAXI',1 ,IARG,1,GCPREA,NOC)
          ...
          ELSE IF (PREC.EQ.'DIRICHLET') THEN
            ZI(JPARCI+13-1) = 1
            CALL GETVR8(' ','COEF_RESI',1 ,IARG,1,RELA,NOC)
            ZR(JPARCR+5-1)  = RELA
            CALL GETVIS(' ','ITER_PRE_MAXI',1 ,IARG,1,GCPREA,NOC)
