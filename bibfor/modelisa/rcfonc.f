...
C MODIF MODELISA  DATE 03/05/2000   AUTEUR VABHHTS J.PELLET 
C ======================================================================
...
11     CONTINUE
       TESSUP = .TRUE.
       IF (PRO.EQ.'E') CALL UTMESS ('F','RCFONC_4',' PROLONGEMENT A '
     &                 // 'DROITE EXCLU POUR LA FONCTION R(P)')
       I0=NBVALE-1
21     CONTINUE
