...
C --- OU 'MAILLE_1') :
C     --------------
      CALL GETVID (MOTFAC,'GROUP_NO_1',IOCC,1,0,K8BID,N1)
      IF (N1.NE.0) THEN
         MOTCLE = 'GROUP_NO_1'
         TYMOCL = 'GROUP_NO'
      ELSE
         CALL GETVID (MOTFAC,'NOEUD_1',IOCC,1,0,K8BID,N2)
         IF (N2.NE.0) THEN
           MOTCLE = 'NOEUD_1'
           TYMOCL = 'NOEUD'
         ELSE
           CALL GETVID (MOTFAC,'GROUP_MA_1',IOCC,1,0,K8BID,N3)
           IF (N3.NE.0) THEN
             MOTCLE = 'GROUP_MA_1'
             TYMOCL = 'GROUP_MA'
           ELSE
             CALL GETVID (MOTFAC,'MAILLE_1',IOCC,1,0,K8BID,N4)
             IF (N4.NE.0) THEN
               MOTCLE = 'MAILLE_1'
               TYMOCL = 'MAILLE'
             ELSE
...
C --- OU 'MAILLE_2') :
C     --------------
      CALL GETVID (MOTFAC,'GROUP_NO_2',IOCC,1,0,K8BID,N5)
      IF (N5.NE.0) THEN
         MOTCLE = 'GROUP_NO_2'
         TYMOCL = 'GROUP_NO'
      ELSE
         CALL GETVID (MOTFAC,'NOEUD_2',IOCC,1,0,K8BID,N6)
         IF (N6.NE.0) THEN
           MOTCLE = 'NOEUD_2'
           TYMOCL = 'NOEUD'
         ELSE
           CALL GETVID (MOTFAC,'GROUP_MA_2',IOCC,1,0,K8BID,N7)
           IF (N7.NE.0) THEN
             MOTCLE = 'GROUP_MA_2'
             TYMOCL = 'GROUP_MA'
           ELSE
             CALL GETVID (MOTFAC,'MAILLE_2',IOCC,1,0,K8BID,N8)
             IF (N8.NE.0) THEN
               MOTCLE = 'MAILLE_2'
               TYMOCL = 'MAILLE'
             ELSE
