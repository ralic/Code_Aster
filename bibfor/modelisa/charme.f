...
C MODIF MODELISA  DATE 19/06/2007   AUTEUR REZETTE C.REZETTE 
C ======================================================================
...
C --- VERIFICATION QUE LE MODELE EST DE TYPE MECANIQUE
      CALL GETVID(' ','MODELE',0,1,1,MODL,IRET)
      CALL DISMOI('F','PHENOMENE',MODL,'MODELE',IBID,PHENO,IRET)
      IF(PHENO(1:4).NE.'MECA')CALL U2MESS('F','MODELISA9_30')
C
