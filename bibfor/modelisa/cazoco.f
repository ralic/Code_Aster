...
C
      ...
      REAL*8 COEFRO,COEFPN,COEFPT,COEFTE,R8NNEM
C
C
C ----------------------------------------------------------------------
C
...
C
C --- TOLE_REAC_GEOM - SUPPRIME DU CATALOGUE EN 8.2.6
C
C      CALL GETVR8(MOTFAC,'TOLE_REAC_GEOM',IREAD,1,1,GEOM,NOC)
      ZR(JTOLE+ZTOLE*(IWRITE-1)+2) = R8NNEM()
C 
