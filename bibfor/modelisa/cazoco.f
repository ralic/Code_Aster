...
C
     ...
     &     (TYPM(1:3).EQ.'GCP')) THEN
          IF (OLDMET .NE. NEWMET) THEN
            CALL U2MESS('F','MODELISA3_48')
          END IF
        END IF
      END IF
C
