...
C
            ...
            ELSE
               ...
               CALL UTMESS('F','CACOCO',
     +              'PB POUR RECUPERER "EPAIS" POUR LA MAILLE '//K8B)
            ENDIF
C
            ...
            IF (IAD1.GT.0) THEN
               EXC = ZR(ICESV-1+IAD1)
               IF ( EXC .NE. 0.D0 ) THEN
                  CALL UTMESS('F','CACOCO','EXCENTRICITE NON TRAITEE')
               ENDIF
            ELSE
               CALL JENUNO(JEXNUM(NOMA//'.NOMMAI',NUMMA),K8B)
               CALL UTMESS('F','CACOCO',
     +              'PB POUR RECUPERER "EXCENT" POUR LA MAILLE '//K8B)
            ENDIF
C
