...
C
      ...
      CHARACTER*24 METHCO,TOLECO,CARFRO
      INTEGER      JMETH,JTOLE,JCARFR
      CHARACTER*24 CONVCO
      INTEGER      JCONV
...
C --- (METHODES DUALISEES)
C
      IF ((METHOD(1:8) .EQ. 'CONTRAIN').OR.
     &    (METHOD(1:8) .EQ. 'LAGRANGI').OR.
     &    (ZI(JMETH+ZMETH*(IZONE-1)+6).EQ.3)) THEN
...
C --- (METHODES DUALISEES SAUF CONTRAINTE)
C
      IF ((METHOD(1:8) .EQ. 'LAGRANGI').OR.
     &    (ZI(JMETH+ZMETH*(IZONE-1)+6).EQ.3)) THEN
