...
C MODIF MODELISA  DATE 30/01/2002   AUTEUR VABHHTS J.TESELET 
C ======================================================================
        ...
        ELSE
          CALL JENUNO ( JEXNUM('&CATA.TM.NOMTM', ZI(JTYPM+IMA-1)),TYPM)
                DO 10 NUTYMA = 1,18
                 ...
                 END IF
 10       CONTINUE
          CALL UTMESS('F','GMGNRE','LES MAILLES DE TYPE '//TYPM//
     &             'NE SONT PAS TRAITEES POUR LA SELECTION DES NOEUDS')
 20       CONTINUE
