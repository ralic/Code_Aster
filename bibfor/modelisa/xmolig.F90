...
!     ELEMENT PRINCIPAUX 3D LINEAIRES
    ...
    call jenonu(jexnom('&CATA.TE.NOMTE', 'MECA_XHC3_HEXA8' ), ih8(14))
!
    ...
    call jenonu(jexnom('&CATA.TE.NOMTE', 'MECA_XHC3_PENTA6' ), ip6(14))
!
    ...
    call jenonu(jexnom('&CATA.TE.NOMTE', 'MECA_XHC3_PYRAM5' ), ip5(14))
!
    ...
    call jenonu(jexnom('&CATA.TE.NOMTE', 'MECA_XHC3_TETRA4' ), it4(14))
!
...
!     ELEMENT PRINCIPAUX 2D (CP/DP) LINEAIRES
    ...
    call jenonu(jexnom('&CATA.TE.NOMTE', 'MECPQU4_XHC3'), icpq4(14))
!
    ...
    call jenonu(jexnom('&CATA.TE.NOMTE', 'MECPTR3_XHC3'), icpt3(14))
!
    ...
    call jenonu(jexnom('&CATA.TE.NOMTE', 'MEDPQU4_XHC3'), idpq4(14))
!
    ...
    call jenonu(jexnom('&CATA.TE.NOMTE', 'MEDPTR3_XHC3'), idpt3(14))
!
...
! AJOUT DES ELEMENTS DE BORD 2D HM-XFEM
    call jenonu(jexnom('&CATA.TE.NOMTE', 'HM_DPSE3_XH' ), iphm(1))
...
! --- ELEMENTS HM-XFEM MECANIQUES
                ...
                else if (notype.eq.'HM_DPSE3') then
