      SUBROUTINE PROJCA(TABLCA,LIRELA,GRMABE,MAILLA,
...
C -----------------
     ...
     &              JYCA, JZCA, NBCNX, NBLIGN, NBMABE, NBNO, NBPARA,
     ...
     &              XBAR(3)
      ...
      CHARACTER*24  COORNO, GRMAMA, NOMAMA, NONOCA, NONOMA
      LOGICAL       ENCORE
C
...
C
         CALL PROJKM(GRMABE,MAILLA,X3DCA(1),NOEBE,LNUMA,LICNX,
