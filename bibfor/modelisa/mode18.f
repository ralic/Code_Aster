...
C
     ...
     +         TYPELE.EQ.'MECPQU9' ) THEN
      ...
      ELSEIF ( TYPELE.EQ.'MECPTR6_X' .OR. TYPELE.EQ.'MECPQU8_X'
     +         ) THEN
         TYPEMO = 'C_PLAN_X'
...
C
     ...
     +         TYPELE.EQ.'CFQ9E3D' .OR. TYPELE.EQ.'CFP2E3D') THEN
      ...
      ELSEIF ( TYPELE.EQ.'COT3E3D' .OR. TYPELE.EQ.'COQ4E3D' .OR.
     +         TYPELE.EQ.'COQ8E3D' .OR. TYPELE.EQ.'COT6E3D' .OR.
     +         TYPELE.EQ.'COQ9E3D' .OR. TYPELE.EQ.'COP2E3D') THEN
         TYPEMO = 'CONT_DVP_3D'
C
C --- THERMIQUE -------------------------------------------------------
C
