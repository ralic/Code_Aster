...
C MODIF MODELISA  DATE 30/11/1999   AUTEUR JMBHH01 J.M.PROIX 
C ======================================================================
...
CJMP               NJ2 = NOTUY(NNO*JMA-1)
 ...
 30   CONTINUE
      IF (NBEXT1.NE.NBEXT2) THEN
         CALL UTMESS('F','ACEAT2','NBEXT1.NE.NBEXT2')
      ENDIF
      IF (NBEXT1.NE.NBPART) THEN
         CALL UTMESS('F','ACEAT2','NBEXT1.NE.NBPART')
      ENDIF
C
