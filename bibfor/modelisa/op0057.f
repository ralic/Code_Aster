...
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 06/05/2008   AUTEUR MARKOVIC D.MARKOVIC 
C ======================================================================
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8  ENP(NA),EPC(NA),ELN(NA),EB,NUB,OMT,EAT,BT1,BT2,FT,FC,GAMMA
     ...
     &            NOMRES,VALRES,CODRES,'  ')
      ...
      CALL GETVR8('BETON','OMT',1,1,1,OMT,IBID)
      CALL GETVR8('BETON','EAT',1,1,1,EAT,IBID)
      IF(IBID .EQ. 0) EAT = EB
      CALL GETVR8('BETON','BT1',1,1,1,BT1,IBID)
      CALL GETVR8('BETON','BT2',1,1,1,BT2,IBID)
 ...
 30     CONTINUE
      ENDIF
C CALCUL DES COEFFICIENTS DE LA MATRICE ÈLASTIQUE
...
C MOYENNE DANS CHAQUE DIRECTION
      MF1 = (MF1X+MF1Y)/2.D0
      MF2 = (MF2X+MF2Y)/2.D0
      IF(BT1 .EQ. 0.0D0) THEN 
        BT1 = 5.D0/6.D0*HH/2.D0*(EB/(1+NUB)+EAT*OMT)
      ENDIF 
      IF(BT2 .EQ. 0.0D0) THEN 
