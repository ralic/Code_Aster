...
C MODIF MODELISA  DATE 11/06/2002   AUTEUR CIBHHAB S.VANDENBERGHE 
C ======================================================================
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
     ...
     &        IRET,NV
      ...
      CHARACTER*3 NUM
      CHARACTER*8 K8B,MULTIC,MATER,NOMRES(9),FICHIE
      CHARACTER*16 TYPE,NOMCMD
      LOGICAL ELAS,THER,FAUX
      PARAMETER (NV=83)
...
C     --- VERIFICATION DES MATERIAUX ---
   ...
   20 CONTINUE
      ...
      IF (IMPR.NE.0) THEN
        CALL GETVTX('IMPRESSION','FICHIER',1,1,1,FICHIE,N)
        NIMPR = 1
        IFR = IUNIFI(FICHIE)
      END IF
