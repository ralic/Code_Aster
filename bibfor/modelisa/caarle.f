...
C
      ...
      CHARACTER*8  MOD,MAIL,MODEL(3),CINE(3),NOMARL
      CHARACTER*8  K8BID
      INTEGER      DIME,NOCC
...
C
      ...
      CALL JEVEUO(MOD//'.MODELE    .LGRF','L',JNOMA)
      MAIL = ZK8(JNOMA)
C
C --- INITIALISATIONS
C
...
C
        CALL ARLLEC(MOTCLE,IOCC  ,MOD   ,NOMA  ,NOMB  ,
...
C
        CALL ARLLCC(MOTCLE,IOCC  ,NOMARL,MOD   ,MAIL  ,
...
C
        CALL ARLCOU(MAIL  ,NOMARL,TYPMAI,QUADRA,NOMC  ,
