...
C MODIF MODELISA  DATE 27/01/2009   AUTEUR MEUNIER S.MEUNIER 
C ======================================================================
...
C
      ...
      REAL*8       BC(2,3),LCARA
      REAL*8       POND1,POND2
      INTEGER      GRFIN,GRMED,GRCOL,JARLEQ
      INTEGER      IFM,NIV
      INTEGER      NR,NK,NI
...
C
        IF ((CINE(1).EQ.'COQUE   ').OR.(CINE(2).EQ.'COQUE   ')) THEN
          CALL ARLNOR(MOTCLE,ZOCC,NORM,TANG,TYPMAI,DIME)
        ENDIF
C
