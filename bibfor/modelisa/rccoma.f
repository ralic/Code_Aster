      SUBROUTINE RCCOMA( IMAT,PHENO,PHENOM,CODRET )
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 06/01/95   AUTEUR G8BHHAC A.Y.PORTABILITE 
C ======================================================================
...
C DEB ------------------------------------------------------------------
 ...
 10   CONTINUE
      CODRET = 'NO'
      CALL UTMESS ('A','RCCOMA_01','COMPORTEMENT NON TROUVE')
      GOTO 999
C
  999 CONTINUE
C FIN ------------------------------------------------------------------
