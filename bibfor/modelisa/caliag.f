...
C --- LECTURE DES DDLS IMPOSES SUR LA LISTE 1 ---
        ...
        CALL GETVTX(MOTFAC,'DDL_1',IOCC,IARG,0,K8BID,NDDL1)
        NDDL1 = -NDDL1

C --- LECTURE DES COEF. MULT. ASSOCIES AUX DDLS IMPOSES ---
C --- SUR LA LISTE 1                                    ---

        CALL GETVR8(MOTFAC,'COEF_MULT_1',IOCC,IARG,0,RBID,NMULT1)
        NMULT1 = -NMULT1
        ...
        CALL GETVTX(MOTFAC,'DDL_1',IOCC,IARG,NDDL1,ZK8(IDDL1),NDDL1)
        DO 10 K = 1,NDDL1
...
C --- LECTURE DES DDLS IMPOSES SUR LA LISTE 2 ---
        ...
        CALL GETVTX(MOTFAC,'DDL_2',IOCC,IARG,0,K8BID,NDDL2)
        NDDL2 = -NDDL2

C --- LECTURE DES COEF. MULT. ASSOCIES AUX DDLS IMPOSES ---
C --- SUR LA LISTE 2                                    ---

        CALL GETVR8(MOTFAC,'COEF_MULT_2',IOCC,IARG,0,RBID,NMULT2)
        NMULT2 = -NMULT2
        ...
        CALL GETVTX(MOTFAC,'DDL_2',IOCC,IARG,NDDL2,ZK8(IDDL2),NDDL2)
        DO 20 K = 1,NDDL2
...
C --- RELATIONS                                           ---
      ...
      DO 160 IOCC = 1,NLIAG
        ...
        ELSE
          CALL GETVID(MOTFAC,'COEF_IMPO',IOCC,IARG,1,KBETA,NB)
        END IF
        CALL JEVEUO(JEXNUM(CONI,IOCC),'L',IDCONI)
