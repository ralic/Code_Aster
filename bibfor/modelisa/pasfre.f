      SUBROUTINE  PASFRE(DISC,FREQ,PASF,DIM,NBM,IV,IMODI,IMODF,FREQI,
     +                   FREQF,NB)  
      IMPLICIT REAL*8 (A-H,O-Z)
C---------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 06/05/96   AUTEUR KXBADNG T.FRIOU 
C ======================================================================
...
C     IN  : IMODF : NUMERO D ORDRE DU DERNIER MODE PRIS EN COMPTE
