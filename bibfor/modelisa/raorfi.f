      SUBROUTINE RAORFI(NOMA,LIGREL,KLISNO,LONLIS,NOEPOU,CARA,COORIG,
     &                  EG1,EG2,EG3,TYPRAC,RAYON)
      IMPLICIT NONE
      INTEGER LONLIS,INFO,IUNIFI,IFM
      CHARACTER*8 KLISNO(LONLIS),NOEPOU,NOMA,CARA
      CHARACTER*19  LIGREL
         ...
         DO 56 J=1,NBNO
            IF (ZI(ICONEX+J-1).EQ.INOPOU) THEN
               IF (IMA.EQ.0) THEN
                  ...
                  INOPO2=ZI(ICONEX+1)
               ELSE
                  CALL UTMESS('F','RAORFI',' LE NOEUD '//NOEPOU//
     &                        ' DOIT APPARTENIR A UNE SEULE MAILLE')
               ENDIF
            ENDIF
56       CONTINUE
55    CONTINUE
...
C
      ...
      ELSEIF (NUTYMA.EQ.NTSEG4) THEN
         NNO=4
      ELSE
         CALL UTMESS('F','RAORFI','LA MAILLE A LAQUELLE APPARTIENT '//
     &   'LE NOEUD '//NOEPOU//' DOIT ETRE DE TYPE SEG3 ')
      ENDIF
C
...
C
      ...
      IF (IER.NE.0) THEN
         CALL UTMESS('F','RAORFI','ERREUR DANS ETENCA')
      ENDIF
      NOMGD = 'CAORIE'
