...
C
      CALL GETVTX(MOTCLE,'GROUP_MA_1',IOCC,1,0,K8BID,NBEV1)
      CALL WKVECT('&&'//NOMPRO//'.GMA1','V V K8', -NBEV1, JGRM1 )
      CALL GETVTX(MOTCLE,'GROUP_MA_1',IOCC,1,-NBEV1,ZK8(JGRM1),NBEV1)
C
      CALL ARLDBG(NOMPRO,NIV,IFM,1,NBVLI,VALI,NBVLR,VALR,NBVLK,VALK)
C
      CALL ARLVER(MODELE,ZK8(JGRM1),NBEV1,NOMA,MODEL(1),
     &            CINE(1),DIMVAR(1))
C
C --- LECTURE MAILLE GROUPE_MA_2
C
      CALL GETVTX(MOTCLE,'GROUP_MA_2',IOCC,1,0,K8BID,NBEV2)
      CALL WKVECT('&&'//NOMPRO//'.GMA2','V V K8', -NBEV2, JGRM2 )
      CALL GETVTX(MOTCLE,'GROUP_MA_2',IOCC,1,-NBEV2,ZK8(JGRM2),NBEV2)
C
      CALL ARLDBG(NOMPRO,NIV,IFM,2,NBVLI,VALI,NBVLR,VALR,NBVLK,VALK)
C
      CALL ARLVER(MODELE,ZK8(JGRM2),NBEV2,NOMB,MODEL(2),
     &            CINE(2),DIMVAR(2))
C
C --- MODELISATION
C
...
C
      ...
      ENDIF
      VALI(1)=DIME
      CALL ARLDBG(NOMPRO,NIV,IFM,3,NBVLI,VALI,NBVLR,VALR,NBVLK,VALK)
C
