...
C  VERIFICATION SUR LES 6 PREMIERS DDL : FX FY FZ MX MY MZ
          ...
          VALKK (1) = MOTCLE(J)
          VALKK (2) = NOMN
                  CALL U2MESG('F', 'MODELISA8_27',2,VALKK,0,0,0,0.D0)
               ENDIF
             ELSE
               DESC = IOR(DESC,2**(J-1))
             ENDIF
          ...
          VALKK (1) = MOTCLE(J)
          VALKK (2) = NOMN
          VALKK (3) = 'ON APPLIQUE LA REGLE DE SURCHARGE'
          CALL U2MESG('I', 'MODELISA8_28',3,VALKK,0,0,0,0.D0)
           END IF
