...
C
      ...
      INTEGER      IZONE 
      CHARACTER*24 DEFICO
      LOGICAL      CFDISL,LVERIF,LGCP,LGLISS
      INTEGER      ISTO,LGBLOC,STOPI,GCPREA,GCPMAX,GCPPRE,GCPREC,IGLISS
...
C    
      ...
      STOPI  = CFDISI(DEFICO,'STOP_INTERP') 
      TOLINT = CFDISR(DEFICO,'TOLE_INTERP') 
...
C      
     ...
     &              ' LES ZONES' 
      ...
      WRITE (IFM,1070) 'GLISSIERE       ',IGLISS      
      IF (IGLISS.EQ.1) THEN
        WRITE (IFM,1071) 'ALARME_JEU     ',ALJEU
      ENDIF
      
      IF (LVERIF) THEN
        WRITE (IFM,1070) 'STOP_INTERP     ',STOPI
