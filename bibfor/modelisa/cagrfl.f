...
C
      CALL GETVTX ( MOTCLF, 'GROUP_MA', 1, 1, 1, K8B, N1)
      IF ( N1 .EQ. 0 ) THEN
         CALL U2MESS('F','MODELISA2_67')
      ENDIF
      CALL GETVTX ( MOTCLF, 'GROUP_NO_ORIG', 1, 1, 1, K8B, N1)
      CALL GETVTX ( MOTCLF, 'NOEUD_ORIG'   , 1, 1, 1, K8B, N2)
      IF ( N1+N2 .EQ. 0 ) THEN
         CALL U2MESS('F','MODELISA2_68')
      ENDIF
      CALL GETVTX ( MOTCLF, 'GROUP_NO_EXTR', 1, 1, 1, K8B, N1)
      CALL GETVTX ( MOTCLF, 'NOEUD_EXTR'   , 1, 1, 1, K8B, N2)
      IF ( N1+N2 .EQ. 0 ) THEN
...
C
         CALL GETVTX ( MOTCLF, 'GROUP_MA', 1, 1, 1, KCRIT, N1)
         VALEK(1) = 'LIEU'
         VALEK(2) = 'ENTITE'
         CRIT(1) = KCRIT
         CRIT(2) = 'GROUP_MA'
