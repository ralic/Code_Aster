...
C
      INTEGER       IH8(10), IP6(10), IP5(10), IT4(10)
      INTEGER       IH20(3),IP15(3),IP13(3),IT10(3)
      INTEGER       ICPQ4(10),ICPT3(10),IDPQ4(10),IDPT3(10)
...
C     ELEMENT PRINCIPAUX 3D LINEAIRES
      ...
      CALL JENONU(JEXNOM('&CATA.TE.NOMTE','MECA_XH1_PYRAM5' ),IP5(1))
      CALL JENONU(JEXNOM('&CATA.TE.NOMTE','MECA_XH2_PYRAM5' ),IP5(2))
      CALL JENONU(JEXNOM('&CATA.TE.NOMTE','MECA_XH3_PYRAM5' ),IP5(3))
      CALL JENONU(JEXNOM('&CATA.TE.NOMTE','MECA_XH4_PYRAM5' ),IP5(4))
...
C --- ELEMENTS X-FEM
            IF (NOTYPE.EQ.'MECA_HEXA8') THEN
              CALL XMOAJO(JJ,NFISS,IH8,ITYPEL,NH8)
            ELSEIF (NOTYPE.EQ.'MECA_HEXA20') THEN
              CALL XMOAJO(JJ,NFISS,IH20,ITYPEL,NH20)
            ELSEIF (NOTYPE.EQ.'MECA_PENTA6') THEN
              CALL XMOAJO(JJ,NFISS,IP6,ITYPEL,NP6)
            ELSEIF (NOTYPE.EQ.'MECA_PENTA15') THEN
              CALL XMOAJO(JJ,NFISS,IP15,ITYPEL,NP15)
            ELSEIF (NOTYPE.EQ.'MECA_PYRAM5') THEN
              CALL XMOAJO(JJ,NFISS,IP5,ITYPEL,NP5)
            ELSEIF (NOTYPE.EQ.'MECA_PYRAM13') THEN
              CALL XMOAJO(JJ,NFISS,IP13,ITYPEL,NP13)
            ELSEIF (NOTYPE.EQ.'MECA_TETRA4') THEN
              CALL XMOAJO(JJ,NFISS,IT4,ITYPEL,NT4)
            ELSEIF (NOTYPE.EQ.'MECA_TETRA10') THEN
              CALL XMOAJO(JJ,NFISS,IT10,ITYPEL,NT10)
            ELSEIF (NOTYPE.EQ.'MECPQU4') THEN
              CALL XMOAJO(JJ,NFISS,ICPQ4,ITYPEL,NCPQ4)
            ELSEIF (NOTYPE.EQ.'MECPQU8') THEN
              CALL XMOAJO(JJ,NFISS,ICPQ8,ITYPEL,NCPQ8)
            ELSEIF (NOTYPE.EQ.'MECPTR3') THEN
              CALL XMOAJO(JJ,NFISS,ICPT3,ITYPEL,NCPT3)
            ELSEIF (NOTYPE.EQ.'MECPTR6') THEN
              CALL XMOAJO(JJ,NFISS,ICPT6,ITYPEL,NCPT6)
            ELSEIF (NOTYPE.EQ.'MEDPQU4') THEN
              CALL XMOAJO(JJ,NFISS,IDPQ4,ITYPEL,NDPQ4)
            ELSEIF (NOTYPE.EQ.'MEDPQU8') THEN
              CALL XMOAJO(JJ,NFISS,IDPQ8,ITYPEL,NDPQ8)
            ELSEIF (NOTYPE.EQ.'MEDPTR3') THEN
              CALL XMOAJO(JJ,NFISS,IDPT3,ITYPEL,NDPT3)
            ELSEIF (NOTYPE.EQ.'MEDPTR6') THEN
              CALL XMOAJO(JJ,NFISS,IDPT6,ITYPEL,NDPT6)
            ELSEIF (NOTYPE.EQ.'MECA_FACE4') THEN
              CALL XMOAJO(JJ,NFISS,IF4,ITYPEL,NF4)
            ELSEIF (NOTYPE.EQ.'MECA_FACE8') THEN
              CALL XMOAJO(JJ,NFISS,IF8,ITYPEL,NF8)
            ELSEIF (NOTYPE.EQ.'MECA_FACE3') THEN
              CALL XMOAJO(JJ,NFISS,IF3,ITYPEL,NF3)
            ELSEIF (NOTYPE.EQ.'MECA_FACE6') THEN
              CALL XMOAJO(JJ,NFISS,IF6,ITYPEL,NF6)
            ELSEIF (NOTYPE.EQ.'MEPLSE2') THEN
              CALL XMOAJO(JJ,NFISS,IPF2,ITYPEL,NPF2)
            ELSEIF (NOTYPE.EQ.'MEPLSE3') THEN
              CALL XMOAJO(JJ,NFISS,IPF3,ITYPEL,NPF3)
            ELSEIF (NOTYPE.EQ.'MEAXQU4') THEN
              CALL XMOAJO(JJ,NFISS,IAXQ4,ITYPEL,NAXQ4)
            ELSEIF (NOTYPE.EQ.'MEAXQU8') THEN
              CALL XMOAJO(JJ,NFISS,IAXQ8,ITYPEL,NAXQ8)
            ELSEIF (NOTYPE.EQ.'MEAXTR3') THEN
              CALL XMOAJO(JJ,NFISS,IAXT3,ITYPEL,NAXT3)
            ELSEIF (NOTYPE.EQ.'MEAXTR6') THEN
              CALL XMOAJO(JJ,NFISS,IAXT6,ITYPEL,NAXT6)
            ELSEIF (NOTYPE.EQ.'MEAXSE2') THEN
              CALL XMOAJO(JJ,NFISS,IAX2,ITYPEL,NAX2)
            ELSEIF (NOTYPE.EQ.'MEAXSE3') THEN
              CALL XMOAJO(JJ,NFISS,IAX3,ITYPEL,NAX3)  

C         ELEMENTS X-FEM OU LE CONTACT EST PRIS EN COMPTE
C         AVEC L'ANCIENNE FORMULATION
            ELSEIF (NOTYPE.EQ.'MECA_X_HEXA20') THEN
              CALL XMOAJO(JJ,NFISS,IH8X,ITYPEL,NH8X)
            ELSEIF (NOTYPE.EQ.'MECA_X_PENTA15') THEN
              CALL XMOAJO(JJ,NFISS,IP6X,ITYPEL,NP6X)
            ELSEIF (NOTYPE.EQ.'MECA_X_PYRAM13') THEN
              CALL XMOAJO(JJ,NFISS,IP6X,ITYPEL,NP6X)
            ELSEIF (NOTYPE.EQ.'MECA_X_TETRA10') THEN
              CALL XMOAJO(JJ,NFISS,IT4X,ITYPEL,NT4X)
            ELSEIF (NOTYPE.EQ.'MECPQU8_X') THEN
              CALL XMOAJO(JJ,NFISS,ICPQ4X,ITYPEL,NCPQ4X)
            ELSEIF (NOTYPE.EQ.'MECPTR6_X') THEN
              CALL XMOAJO(JJ,NFISS,ICPT3X,ITYPEL,NCPT3X)
            ELSEIF (NOTYPE.EQ.'MEDPQU8_X') THEN
              CALL XMOAJO(JJ,NFISS,IDPQ4X,ITYPEL,NDPQ4X)
            ELSEIF (NOTYPE.EQ.'MEDPTR6_X') THEN
              CALL XMOAJO(JJ,NFISS,IDPT3X,ITYPEL,NDPT3X)
            ELSEIF (NOTYPE.EQ.'MECA_X_FACE8') THEN
              CALL XMOAJO(JJ,NFISS,IF4,ITYPEL,NF4)
            ELSEIF (NOTYPE.EQ.'MECA_X_FACE6') THEN
              CALL XMOAJO(JJ,NFISS,IF3,ITYPEL,NF3)
            ELSEIF (NOTYPE.EQ.'MEPLSE3_X') THEN
              CALL XMOAJO(JJ,NFISS,IPF3,ITYPEL,NPF2)
            ELSE
...
C         PAS AVOIR A FAIRE CETTE ÉTAPE.
     ...
     &                        ITYPEL)
                ELSEIF (ITYPEL.EQ.IP5(I)) THEN
                  CALL JENONU(JEXNOM('&CATA.TE.NOMTE','MECA_PYRA5'),
     &                        ITYPEL)
