...
C     INITIALISATIONS DE TOUS LES COMPTEURS
     ...
     &            NPF3,NAXT3,NAXQ4,NAXQ8,NAXT6,NAX2,NAX3,NTH8,NTP6,NTP5,
     &            NTT4,NTPQ4,NTPT3,NTAQ4,NTAT3,NTF4,NTF3,NTPF2,NTAX2)
...
C     ELEMENT PRINCIPAUX 2D (PLAN) LINEAIRES
...
C     ELEMENT PRINCIPAUX AXI LINEAIRES
...
C     ELEMENT DE BORD 2D (PLAN) LINEAIRES
...
C --- ELEMENTS X-FEM THERMIQUES
            ELSEIF (NOTYPE.EQ.'THER_HEXA8') THEN
              CALL XMOAJO(JJ,NFISS,ITH8,NTH8)
            ELSEIF (NOTYPE.EQ.'THER_PENTA6') THEN
              CALL XMOAJO(JJ,NFISS,ITP6,NTP6)
            ELSEIF (NOTYPE.EQ.'THER_PYRAM5') THEN
              CALL XMOAJO(JJ,NFISS,ITP5,NTP5)
            ELSEIF (NOTYPE.EQ.'THER_TETRA4') THEN
              CALL XMOAJO(JJ,NFISS,ITT4,NTT4)
            ELSEIF (NOTYPE.EQ.'THPLQU4'    ) THEN
              CALL XMOAJO(JJ,NFISS,ITPQ4,NTPQ4)
            ELSEIF (NOTYPE.EQ.'THPLTR3'    ) THEN
              CALL XMOAJO(JJ,NFISS,ITPT3,NTPT3)
            ELSEIF (NOTYPE.EQ.'THAXQU4'    ) THEN
              CALL XMOAJO(JJ,NFISS,ITAQ4,NTAQ4)
            ELSEIF (NOTYPE.EQ.'THAXTR3'    ) THEN
              CALL XMOAJO(JJ,NFISS,ITAT3,NTAT3)
            ELSEIF (NOTYPE.EQ.'THER_FACE4' ) THEN
              CALL XMOAJO(JJ,NFISS,ITF4,NTF4)
            ELSEIF (NOTYPE.EQ.'THER_FACE3' ) THEN
              CALL XMOAJO(JJ,NFISS,ITF3,NTF3)
            ELSEIF (NOTYPE.EQ.'THPLSE2'    ) THEN
              CALL XMOAJO(JJ,NFISS,ITPF2,NTPF2)
            ELSEIF (NOTYPE.EQ.'THAXSE2'    ) THEN
...
C         PAS AVOIR A FAIRE CETTE ÉTAPE.
 ...
 230          CONTINUE
            ...
            ZI(JJ+5)=ITYPEL
          ENDIF
C             EN MECANIQUE, ERREUR SI UN SEG DOIT ETRE ENRICHI EN 3D
C             CAR LES ELEMENTS X-FEM DE BORD SEG N'EXISTENT PAS EN 3D
C             RQ: POUR LA THERMIQUE, LE PROBLEME NE SE POSE PAS CAR
C             --  EN FEM 3D, IL N'EXISTE PAS D'ELEMENTS DE DIMENSION 1
