...
C
      ...
      INTEGER      IBID,IER,IMAE,JLIST,IZONE,ITOT
      INTEGER      CFDISI,NZOCO,NDIM,NTMAE
      INTEGER      ISURFE,JDECMA,POSMAE,NUMMAE,NBMAE
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ
...
C      
      LAXIS   = MMMAXI(NOMO  ,LISMAE,NTMAE)
      IF (LAXIS) THEN
        ZI(JPARCI+16-1) = 1
      ELSE
        ZI(JPARCI+16-1) = 0
