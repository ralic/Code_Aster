      SUBROUTINE PMFD00()
C MODIF MODELISA  DATE 08/11/2004   AUTEUR LEBOUVIE F.LEBOUVIER 
...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      INTEGER IRET,IBID,INZFIB,IDAFIB,IMAFIB,IMASEC
...
C --- ALLOCATION DE TABLEAUX POUR DES VERIFICATIONS ULTERIEURES(4)
      IF (NBOCCP.GT.0)THEN
           ...
           CALL WKVECT('&&VERIF_FIBRE_MAIL','V V R',NBOCCP,IMAFIB)
      ENDIF
C
      DO 120 IOC = 1,NBOCCP
