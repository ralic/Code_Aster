      SUBROUTINE CAONDE ( CHAR, LIGRMO, NBCA, NBET, NOMA, FONREE )
      IMPLICIT   NONE
      INTEGER           NBCA, NBET
      CHARACTER*4       FONREE
...
C ======================================================================
C
C BUT : STOCKAGE DE LA PRESSION IMPOSEE D'ONDE INCIDENTE
...
C
      IF (FONREE.EQ.'REEL') THEN
         CALL ALCART ( 'G', CARTE, NOMA, 'ONDE_R', NBCA+1, NBET )
      ELSE IF (FONREE.EQ.'FONC') THEN
         CALL ALCART ( 'G', CARTE, NOMA, 'ONDE_F', NBCA+1, NBET )
      ELSE
         CALL UTMESS('F','CAONDE','VALEUR INATTENDUE: '//FONREE )
      ENDIF
C
...
C
         IF (FONREE.EQ.'REEL') THEN
            CALL GETVR8 ( MOTCLF, 'PRES', IOCC,1,1, ZR(JVALV), N )
         ELSE
            CALL GETVID ( MOTCLF, 'PRES', IOCC,1,1, ZK8(JVALV), N )
         ENDIF
C
