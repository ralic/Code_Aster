...
C MODIF MODELISA  DATE 17/07/2001   AUTEUR JMBHH01 J.M.PROIX 
C ======================================================================
...
C     ------- FIN COMMUNS NORMALISES  JEVEUX  --------------------------
      INTEGER       NBTYMX, NBTOUT(10), DILIEL, DINEMA, NBGREL, NECHP,
     +              IBID, IERD, NBAPNO, NBALL, JNCMP, JVALV, IOCC, 
     +              NH, NT, NR, NO, I, J, NBTYP, JLISTT, NBM
      PARAMETER    (NBTYMX=7)
...
C
      CALL LIGECP ( CHAR, NOMA, NBTOUT, DILIEL, DINEMA, NBGREL )
C
      NBAPNO = NBTOUT(1)
      NBALL  = MAX(1,NBTOUT(3))
      CARTE = CHAR//'.CHTH.HECHP'
      IF (FONREE.EQ.'REEL') THEN
        CALL ALCART ( 'G', CARTE, NOMA, 'COEH_R', NBAPNO, NBALL )
      ELSE IF (FONREE.EQ.'FONC') THEN
        CALL ALCART ( 'G', CARTE, NOMA, 'COEH_F', NBAPNO, NBALL )
      ELSE
