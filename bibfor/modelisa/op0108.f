...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      PARAMETER   ( NBMEC = 9 , NBTHE = 3  )
      CHARACTER*8 CHCINE,MO,NOMMEC(NBMEC),NOMTHE(NBTHE)
...
C
      ...
      IF (IOCMI.NE.0) THEN
        ZK8(ITYPE) = 'CIME_FO'
        CALL CHARCI(CHCINE,'MECA_IMPO',IOCMI,NBMEC,NOMMEC,'F')
      ENDIF
C
      CALL GETFAC('THER_IMPO',IOCTI)
      IF (IOCTI.NE.0) THEN
        ZK8(ITYPE) = 'CITH_FO'
        CALL CHARCI(CHCINE,'THER_IMPO',IOCTI,NBTHE,NOMTHE,'F')
      ENDIF
C
      CALL JEDEMA()
      END
