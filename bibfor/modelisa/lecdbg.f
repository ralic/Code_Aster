...
C
        ...
        CALL UTMESS('F',CMD,'LECTURE 1 :ERREUR DE LECTURE POUR'//MCL(1))
        ELSEIF(IV.GT.24)THEN
        CALL UTMESS('F',CMD,'LECTURE 1 :ITEM > 24 CAR '//MCL(1))
        ENDIF
        DIM(1) = DIM(1) + 1
        MTC = B24
        MTC(1:IV) = CV(1:IV)
...
C
        ...
        CALL UTMESS('F',CMD,'LECTURE 1 :ERREUR DE LECTURE POUR'//MCL(2))
        ENDIF
        IF(ICL.EQ.1)NBG = IV
