...
C OUT MCONN  : CONNECTIVITE DE LA MAILLE
...
C
      INTEGER      JGRP,JTYP,AIMA,INO,JDEC,JGCNX,LCOQUE
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ()
...
C
      ...
      IF (LCOQUE.EQ.0) THEN
         ...
         DO 10 INO = 1, NBNO
            ZI(JGCNX+INO-1) = CONNEX(JDEC-1+INO)
 10      CONTINUE
