...
C MODIF MODELISA  DATE 16/02/2010   AUTEUR PELLET J.PELLET 
C ======================================================================
...
C
      REAL*8 ROTA(7),NORME,R8MIEM,ZERO
      ...
      ROTA(6) = ZERO
      ROTA(7) = ZERO
      CALL GETVR8 (' ', 'ROTATION', 0, 1, 4, ROTA(1), N1)
      CALL GETVR8 (' ', 'CENTRE', 0, 1, 3, ROTA(5), N2)
      IF (N1.GT.0) THEN
         CALL ASSERT(N1.EQ.4)
