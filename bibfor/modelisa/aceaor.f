...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      REAL*8       R8B, R8MIEM, TSM, R8RDDG, RDDG
      REAL*8       ALPHA, BETA, GAMMA
      CHARACTER*8  NOMU, TOU, CAR(NBCAR), NOMMAI, NOMNOE, CARORI(NCO)
      CHARACTER*4  EXITUY
...
C           ET INCREMENTATION DU COMPTEUR D APPELS A NOCART POUR CARTOR
      NOCAOR = 0
...
C     -------------------------------------------------------------
      IF ( NOCAOR .GT. 0  ) THEN
         CALL ALCART('G',CARTOR,NOMA,'CAORIE',NOCAOR,NOCAOR)
...
C ---    RECUPERATION DES NUMEROS DES NOMS DES ELEMENTS
              ...
              IF ((NUNOEL.NE.'MET3SEG3').AND.(NUNOEL.NE.'MET3SEG4')
     &        .AND.(NUNOEL.NE.'MET6SEG3')) THEN
...
C
      ...
      CALL ACEATU(NOMA,NOMO,LMAX,NBEPO,NTYELE,NOMELE,IVR,IFM,
     &                  NBOCC)
      ENDIF
