      SUBROUTINE ACEAMA(NOMU,NOMA,LMAX,NOCAMA,NMTGMA,NBOCC)
      IMPLICIT REAL*8 (A-H,O-Z)
      INTEGER                     LMAX,NOCAMA,NMTGMA,NBOCC
      CHARACTER*8       NOMU,NOMA
C ----------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 23/05/2000   AUTEUR CIBHHLV L.VIVAN 
C ======================================================================
...
C --- CONSTRUCTION DES CARTES ET ALLOCATION
      ...
      TMPVMA = CARTMA//'.VALV'
C
      CALL ALCART('G',CARTMA,NOMA,'CAMASS',NOCAMA+1,NMTGMA)
