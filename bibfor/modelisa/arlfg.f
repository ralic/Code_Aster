...
C
      INTEGER      JBOIH1,JBOIH2,NBBOI1,NBBOI2,IAUX
...
C
      DIMBT1 = 0.D0
      DO 10 IAUX = 1, NBBOI1
        DIMBT1 = DIMBT1 + ZR(JBOIH1+IAUX-1)
 10   CONTINUE
      DIMBT1 = DIMBT1/NBBOI1
C
      DIMBT2 = 0.D0
      DO 20 IAUX = 1, NBBOI2
        DIMBT2 = DIMBT2 + ZR(JBOIH2+IAUX-1)
 20   CONTINUE
      DIMBT2 = DIMBT2/NBBOI2
C
C --- COMPARAISON
C
      IF (DIMBT1.LT.DIMBT2) THEN
        ARLFG = 1
      ELSE
        ARLFG = 2
      ENDIF
