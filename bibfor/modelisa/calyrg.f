...
C     -------------------------------------------------------
      ...
      IF (NTRAN .LT. 0) THEN
        ...
        CALL UTMESS('F','CALYRG','LE MOT CLE "TRAN" SOUS LE MOT CLE'
...
C
      ...
      IF (NANGL .LT. 0) THEN
        ...
        CALL UTMESS('F','CALYRG','LE MOT CLE "ANGL_NAUT" SOUS LE MOT'
...
C
      ...
      IF (NCENTR .LT. 0) THEN
        CALL CODENT(NDIM,'G',KB)
        CALL UTMESS('F','CALYRG','LE MOT CLE "CENTRE" SOUS LE MOT'
     +    //' CLE FACTEUR '//MOTFAC//' N''ADMET QUE '//KB//' VALEURS')
      ENDIF
C
