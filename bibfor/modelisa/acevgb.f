      SUBROUTINE ACEVGB ( NBOCC, NLM, NLG, IER )
      IMPLICIT  NONE
...
C
      ...
      NLG = 0
      DO 10 IOC = 1 , NBOCC
         CALL GETVID ( 'GRILLE', 'GROUP_MA', IOC,1,0, K8B, NG  )
         CALL GETVID ( 'GRILLE', 'MAILLE'  , IOC,1,0, K8B, NM  )
C
         NSOM = NG + NM
