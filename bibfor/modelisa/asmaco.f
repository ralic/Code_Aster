...
C MODIF MODELISA  DATE 09/11/2009   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C
C     TEST DE LA PRESENCE DE NOEUDS GEOMETRIQUEMENT CONFONDUS
C     DANS LA ZONE A COLLER
C     SI C EST LE CAS, L APPARIEMENT SE PASSERA MAL ENSUITE
C     PUISQU IL EST FAIT SUR UN CRITERE DE DISTANCE NULLE
C
C     NORMALEMENT FAIRE LE TEST SUR LA ZONE A COLLER DU MAILLAGE 1
C     SUFFIT, PUISQU ON VERIFIE ENSUITE QUE LA ZONE DU MAILLAGE 2
C     LUI EST TOPOLOGIQUEMENT ET GEOMETRIQUMENT IDENTIQUE
C
         DO 1031 I=1,K-1
