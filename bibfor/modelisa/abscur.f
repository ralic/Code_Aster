      SUBROUTINE ABSCUR(GRPMAI,CONNEX,TYPMAI,COOVAL,NOMU,GRPMA,IT)
C-----------------------------------------------------------------------
...
C-----------------------------------------------------------------------
      ...
      CHARACTER*8  NOMU, GRPMA, NSP
      CHARACTER*24 GRPMAI, CONNEX, TYPMAI, COOVAL
C-----------------------------------------------------------------------
...
C     ------------------
C
C     GRPMAI : REPERTOIRE DES NOMS DES GROUPES DE MAILLES
...
C     GRPMA  : NOM DU GROUPE DE MAILLES POUR LE CALCUL DE L'ABS_CURV
...
C
      CALL ALCART('G',NOMU//'.ABS_CURV  ',NOMU,'ABSC_R',NBRMA,NBRMA)
