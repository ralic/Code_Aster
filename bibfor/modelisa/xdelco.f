...
C
      ...
      INTEGER NOMIL,N,IN,NBNOMA,NMAABS,NDIME
      INTEGER NINTER,NUNO
...
C     MAILLES 2D SINGULIÈRE  : DANS OP0113, ON A FATI LA CONCATÉNATION
...
C     SI NINTER > 0, ON BOUCLE POUR DETERMINER LES LMABDAS ACTIFS
        IF (NINTER.LT.0) THEN
          GOTO 50
