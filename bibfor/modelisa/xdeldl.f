...
C---------------- DECLARATION DES VARIABLES LOCALES  -------------------
      ...
      INTEGER NDIME,ADDIM,ITYPMA,JMAIL,NDEGRE,JNFIS
      CHARACTER*1 K1BID
...
C     RECUPERATION DU DEGRE D'APPROXIMATION DE DEPLACEMENT
      CALL JEVEUO(MOD(1:8)//'.NFIS','L',JNFIS)
      NDEGRE = ZI(JNFIS+1)
...
C       EN LINÉAIRE, CE SONT LES NOEUDS SOMMET
C       EN QUADRATIQUE, CE SONT TOUS LES NOEUDS
        CALL PANBNO(ITYPMA,NBNOTT)
        IF (NDEGRE.EQ.1) NNOS = NBNOTT(1)
        IF (NDEGRE.EQ.2) NNOS = NBNOTT(1) + NBNOTT(2)
