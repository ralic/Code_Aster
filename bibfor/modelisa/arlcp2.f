...
C
      CHAMEL(1) = '&&ARLCHI.ELFAMI'
      CHAMEL(2) = '&&ARLCHI.ELINFO'
      CHAMEL(3) = '&&ARLCHI.ELREF1'
      CHAMEL(4) = '&&ARLCHI.ELCOO1'
      CHAMEL(5) = '&&ARLCHI.ELREF2'
      CHAMEL(6) = '&&ARLCHI.ELCOO2'
C
      CALL ARLCHI(MAIL  ,MODARL,NOM1  ,NOM2  ,MAILAR,QUADRA,
