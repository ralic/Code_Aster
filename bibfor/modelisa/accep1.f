...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      LOGICAL EXIGEO
      INTEGER NBM,I
      INTEGER IRET,IREFE,ILIME,INOLI,INOMA,NMA
      ...
      INTEGER IGR,IMA,II,IEL,IVE,ITAB,IMO,JLGRF
      REAL*8 RBID
...
C CREATION D UN .LIEL BASE SUR LE GROUP-MA UTILISATEUR
   ...
   40     CONTINUE
          ...
          CALL WKVECT(GRMA//'.MODELE    .LGRF','V V K8',2,JNOMA)
          ZK8(JNOMA) = MAILLA
   ...
   60     CONTINUE
      ...
      IF (ZK8(JLGRF-1+2).NE.' ') CALL U2MESK('F','CALCULEL_25',1,LIGRMO)
