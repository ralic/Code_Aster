      SUBROUTINE LRMAST ( NOMU,IFM,IFL,NBNOEU,NBMAIL,NBCOOR )
      IMPLICIT NONE
C     IN
      INCLUDE 'jeveux.h'
...
C
      ...
      CHARACTER*8     NOM, NOMN
      CHARACTER*8     NOM1
      CHARACTER*14    CNL
      CHARACTER*16    CMD,K16NOM
      CHARACTER*24    GRPNOV,GRPMAV,CONXV,GPPTNN,GPPTNM
      CHARACTER*24    VALK(2),NOMG,GPPTNV,GPPTMV
...
C
      IF ( NBGRNO .NE. 0 ) THEN
         ...
         CALL JECREC(GRPNOV,'V V K8','NO '//GPPTNV,
     &               'CONTIG','VARIABLE',NBGRNO)
...
C
      IF ( NBGRMA .NE. 0 )THEN
         ...
         CALL JECREC(GRPMAV,'V V K8','NO '//GPPTMV,
     &               'CONTIG','VARIABLE',NBGRMA)
