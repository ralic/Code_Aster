...
C --- L'ELEMENT :
C     ---------
      CALL GETVR8(MOTFAC,'ANGL_PREC',IOCC,IARG,0,ANGPRE,NBANG)
      IF (NBANG.EQ.0) THEN
         ANGPRE = UNDEMI*R8DGRD()
      ELSE
         CALL GETVR8(MOTFAC,'ANGL_PREC',IOCC,IARG,1,ANGPRE,NB)
...
C     ---------------------------------
      CALL GETVTX(MOTFAC,'VERI_SIGNE',IOCC,IARG,0,OUINON,NBOUI)
      IF (NBOUI.EQ.0) THEN
          OUINON = 'OUI'
      ELSE
         CALL GETVTX(MOTFAC,'VERI_SIGNE',IOCC,IARG,1,OUINON,NBO)
      ENDIF
C
