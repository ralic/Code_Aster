...
C ======================================================================
C
C BUT : STOCKAGE DES SOURCES DANS UNE CARTE ALLOUEE SUR LE
C       LIGREL DU MODELE
C
...
C
      IF (FONREE.EQ.'REEL') THEN
         CALL ALCAR2 ( 'G', CARTE, NOMA, 'SOUR_R' )
      ELSE IF (FONREE.EQ.'FONC') THEN
         CALL ALCAR2 ( 'G', CARTE, NOMA, 'SOUR_F' )
      ELSE
         CALL UTMESS('F','CASOUR','VALEUR INATTENDUE: '//FONREE )
      END IF
C
      CALL JEVEUO ( CARTE//'.NCMP', 'E', JNCMP )
      CALL JEVEUO ( CARTE//'.VALV', 'E', JVALV )
C
C --- STOCKAGE DE SOURCES NULLES SUR TOUT LE MAILLAGE
C
      NCMP = 1
      ZK8(JNCMP) = 'SOUR'
      IF (FONREE.EQ.'REEL') THEN
