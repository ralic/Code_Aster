      SUBROUTINE EXLIM2(SDFETI,NOMSD,LLIGRS,LIGRSD,NBCHA,IVLIGR,NUMSD,
     &                  NBSD)
C-----------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 09/11/2004   AUTEUR BOITEAU O.BOITEAU 
C ======================================================================
...
C OUT : IVLIGR : ADRESSE JEVEUX LLIGRS
...
C DECLARATION PARAMETRES D'APPELS
      INTEGER      NBCHA,IVLIGR,NUMSD,NBSD
      CHARACTER*8  NOMSD
      CHARACTER*19 LIGRSD
