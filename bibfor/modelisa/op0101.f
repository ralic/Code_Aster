...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      INTEGER     IER,IOCMI,IOCTI,IOCAI,IBID,IERD,INOM,NBCMP,ITYPE,INOMO
...
C
      ...
      IF (IOCMI.NE.0) THEN
         ZK8(ITYPE) = 'CIME_RE'
         CALL CHARCI(CHCINE,'MECA_IMPO',IOCMI,NBCMP,ZK8(INOM),'R')
      ENDIF
C
      CALL GETFAC ( 'THER_IMPO', IOCTI )
      IF (IOCTI.NE.0) THEN
         ZK8(ITYPE) = 'CITH_RE'
         CALL CHARCI(CHCINE,'THER_IMPO',IOCTI,NBCMP,ZK8(INOM),'R')
      ENDIF
C
      CALL GETFAC ( 'ACOU_IMPO', IOCAI )
      IF (IOCAI.NE.0) THEN
         ZK8(ITYPE) = 'CIAC_CX'
         CALL CHARCI(CHCINE,'ACOU_IMPO',IOCAI,NBCMP,ZK8(INOM),'C')
      ENDIF
C
      CALL JEDEMA()
      END
