...
C MODIF MODELISA  DATE 07/09/2009   AUTEUR DELMAS J.DELMAS 
C ======================================================================
...
C
C SD DE SORTIE (NOMSD) :
C ======================
C .GROUPEMA : LISTE TRIEE DES MAILLES DU DOMAINE NOMSD (MA1,MA2,...)
C
...
C
      ...
      INTEGER      NBMA,NTOT,NBLIGR,NUMA,NINIT,IBID
...
C
      ...
      ENDIF
      NBGMA = NTOT
      CALL TRI(ZI(JGROUP),IBID,0,NBGMA)
C
      VALI(1)=NTOT
      VALK(1)=MODEL
      VALK(2)=CINE
