...
C---------------- COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      LOGICAL ZL
      REAL*8 ZR
      CHARACTER*8  ZK8,CHAR,NOMA,VITESS
      CHARACTER*16 ZK16
      CHARACTER*24 ZK24,LIGRMO,LIGRCH,CATA
      CHARACTER*19 CARTE
...
C
      ...
      IF (NCONV.GT.1) THEN
         CALL UTMESS('F','CBCONV','ON NE DONNE LE MOT'
     1     //' FACTEUR "CONVECTION" QU"UNE FOIS AU MAXIMUM' )
      ELSE IF (NCONV.EQ.1) THEN
         ...
         CALL GETVID ('CONVECTION', 'VITESSE', 1, 1, 1, VITESS,
     1      NVITES)
         ZK8(IAD-1+1) = VITESS
