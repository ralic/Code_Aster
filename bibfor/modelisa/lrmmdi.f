...
C
     ...
     >              NBNOEU, CODRET)  
      IF ( CODRET.NE.0 ) THEN
        ...
        CALL UTMESS ('F',NOMPRO,'MED:ERREUR EFNEMA NUMERO '//SAUX08)
      ENDIF
      IF ( NBNOEU.EQ.0 ) THEN
        CALL UTMESS ('F',NOMPRO,'IL MANQUE LES COORDONNEES !')
      ENDIF
C
...
C
     ...
     >                  NMATYP(ITYP), CODRET )
          IF ( CODRET.NE.0 ) THEN
            CALL UTMESS ('A',NOMPRO,'MAILLES '//NOMTYP(ITYP))
            CALL CODENT ( CODRET,'G',SAUX08 )
            CALL UTMESS ('F',NOMPRO,'MED:ERREUR EFNEMA NUMERO '//SAUX08)
          ENDIF
C
...
C
      IF ( NBMAIL.EQ.0 ) THEN
        CALL UTMESS('F',NOMPRO,'IL MANQUE LES MAILLES !')
      ENDIF
C
C====
