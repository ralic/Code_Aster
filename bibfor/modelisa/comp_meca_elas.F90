...
! - Access <CARTE>
!
    call jeveuo(comp_elas(1:19)//'.VALV', 'E', j_cart_val)
!
! - Set for ELASTIQUE
!
    zk16(j_cart_val-1+1) = 'ELAS'
    zk16(j_cart_val-1+2) = '1'
    zk16(j_cart_val-1+3) = 'PETIT'
    zk16(j_cart_val-1+4) = 'COMP_ELAS'
    zk16(j_cart_val-1+5) = 'ANALYTIQUE'
    zk16(j_cart_val-1+6) = '1'
!
! - Create <CARTE>
!
