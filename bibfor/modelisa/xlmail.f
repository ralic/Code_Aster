      SUBROUTINE XLMAIL(NOMA  ,FISS  ,NDIM  ,NMAEN1,NMAEN2,NMAEN3,
...
C
      ...
      CHARACTER*24 XINDIC,XHEAV,XCTIP,XHECT,XFONFI,XFONMU
      INTEGER      JINDIC,JMA1,JMA2,JMA3,JFO,JFOMU 
      INTEGER      I,K  
C
C ----------------------------------------------------------------------
C
...
C
 ...
 840  CONTINUE
C
C --- ENREGISTREMENT DES FONDS MULTIPLES (SEULEMENT EN 3D)
C
      IF (NDIM.EQ.3) THEN
