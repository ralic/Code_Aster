     ...
     &                  NFON,JFON,NBFOND,JBAS,JFISDE,JFISAR,NDIM)
C
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF MODELISA  DATE 20/06/2012   AUTEUR GENIAUT S.GENIAUT 
C ======================================================================
...
C
      ...
      CHARACTER*24 XINDIC,XHEAV,XCTIP,XHECT,XMAFON,XFONFI,XFONMU,XBASFO
      INTEGER      JINDIC,JMA1,JMA2,JMA3,JMA4,JFO,JFOMU,JBA
      INTEGER      I,K
C
C ----------------------------------------------------------------------
C
...
C
C --- ENREGISTREMENT DES MAILLES 'HEAVISIDE'
C
      IF (NMAEN1.NE.0) THEN
 ...
 810    CONTINUE
      ENDIF
C
C --- ENREGISTREMENT DES MAILLES 'CRACKTIP'
C
      IF (NMAEN2.NE.0) THEN
 ...
 820    CONTINUE
      ENDIF
C
C --- ENREGISTREMENT DES MAILLES 'HEAVISIDE-CRACKTIP'
C
      IF (NMAEN3.NE.0) THEN
