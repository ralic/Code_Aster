...
C
      CHARACTER*24 FORMCO,DEFICO,K24BLA,K24BID
      INTEGER      JFORM,ITERG
...
C
        CALL QUADCO(CHAR  ,MOTFAC,NZOCO ,INDQUA)      
C      
C --- PREMIERE PASSE
...
C
C --- CONSTRUCTION DES TABLEAUX POUR NORMALES ET TANGENTES
C
        CALL NORMCO(CHAR  ,NNOCO)      
C
