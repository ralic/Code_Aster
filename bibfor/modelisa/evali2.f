      SUBROUTINE EVALI2(ISZ,PG,NMA,PHI,VALPAR,POSMAI,IPG,PDGI,
     &                  ICMP,NOCMPI,SPHI)
...
C-----------------------------------------------------------------------
      ...
      INTEGER      JCMP
      REAL*8       VALPAR(7),PDGJ,PDGI,VALPHI,ZEROD
      REAL*8       RESUR,RESUI
      COMPLEX*16   RESU,VALSPH
      CHARACTER*19 PHI,SPHI,PHII,SPHII,PG,IS
      CHARACTER*24 K24,CMPIS,CMPJS,NOFOS
      CHARACTER*8   NOMPAR(7),FONC,CMPI,CMPJ,NOCMPI,NOCMPJ
      CHARACTER*8  KBID,ISZ
C-----------------------------------------------------------------------
C                         _       _    _   _
