...
C
C-----------------------------------------------------------------------
      INTEGER I ,ICOEF ,ICOEGR ,IDNO ,IER ,IFONGR ,II, IUNITE 
      INTEGER IJ ,IM ,IN ,INOE ,IRET ,ISURMA ,JCOOR
      INTEGER LDGM ,LDGN ,LDNM ,LTYP ,NB ,NBMA
      INTEGER NFG ,NGN ,NM ,NN ,NNO ,NOEMAX ,NTOPO, NUMA 
      INTEGER ISURM1, ISURM2, ISURM3, ISURM4, ISURM5, ISURM6 
      INTEGER ICOEXX, ICOEXY, ICOEXZ, ICOEYY, ICOEYZ, ICOEZZ 
      REAL*8 COEF ,DDOT ,DIST ,HC ,R1 ,R2 ,R3, R4 ,R5 ,R6 
      REAL*8 SURF ,SURTOT ,XC ,XG 
      REAL*8 XX ,YC ,YG ,YY ,ZG ,ZZ, Z0
