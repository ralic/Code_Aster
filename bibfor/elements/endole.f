      SUBROUTINE ENDOLE(OPTION,LIGREL,MATE,COMPOR,
...
C  --------  ---  ----  ----
C   OPTION   IN     K*  OPTION DE CALCUL : 'ENDO_[ELGA/ELNO]'
...
C -----  ARGUMENTS
      CHARACTER*(*) OPTION,LIGREL
      CHARACTER*(*) MATE,CHEND2,COMPOR
      CHARACTER*(*) CHELE1,CHVARC,CHSIG1,CHVAR1
      CHARACTER*(*) CHELE2,CHVAC2,CHSIG2,CHVAR2
C -----  VARIABLES LOCALES
