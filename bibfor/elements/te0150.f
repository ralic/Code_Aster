...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8       KENDOG,KDESSI,SECH,HYDR,INSTAN,SECHG(3),HYDRG(3)
      INTEGER      NBFIB,NCARFI,JACF,JNF,NDIM,NNO,NNOS,NPG,IPOIDS
...
C ----   RECUPERATION DU CHAMP DU SECHAGE SUR L'ELEMENT
         SECH=0.D0
         DO 50 IGAU=1,NPG
           CALL RCVARC(' ','SECH','+','RIGI',IGAU,1,SECHG(IGAU),IRET)
...
C ----    RECUPERATION DU CHAMP D HYDRATATION SUR L'ELEMENT
         HYDR=0.D0
         DO 60 IGAU=1,NPG
           CALL RCVARC(' ','SECH','+','RIGI',IGAU,1,HYDRG(IGAU),IRET)
