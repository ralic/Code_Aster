...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8       BSM(12,12),MATK(78) ,CARSEC(6), R8BID
      REAL*8       XFL, TEMP, F, TRIGOM,TREF
...
C     --- RECUPERATION DES CARACTERISTIQUES MATERIAUX ---
 ...
 10   CONTINUE
C
      CALL MOYTEM('RIGI',NPG,1,'+',VALPAR(1))
      NBPAR  = 1
      NOMPAR(1) = 'TEMP'
C
      MATERI=' '
...
C       -- POUTRES CLASSIQUES
        CALL RCVALA(ZI(LMATER),MATERI,'ELAS',NBPAR,NOMPAR,VALPAR,NBRES,
