...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER IGEOM,IMATE,IMATU,IADZI,IAZK24,NUMA
      INTEGER KVOIS,NUMAV,NNOV,K1,K2,NNOT
      INTEGER ICO2,IMATU2,IRET,K,IVECTU
 ...
 10   CONTINUE
     ...
     &                  NBVOIS,LIVOIS,TYVOIS,NBNOVO,NBSOCO,LISOCO)
      DO 1,KVOIS=1,NBVOIS
        NNOV=NBNOVO(KVOIS)
        NUMAV=LIVOIS(KVOIS)
C       CALL TECAC2('OOO',NUMAV,'PGEOMER',1,IGEOM,IRET)
