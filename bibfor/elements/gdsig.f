      SUBROUTINE GDSIG (X0PG,PETIK,ROT0,ROTK,GRANC,ALPHA,TEMPG,TREF,
     &                  GN,GM,PN,PM)
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ELEMENTS  DATE 21/12/98   AUTEUR JMBHH01 J.M.PROIX 
C ======================================================================
...
C           TEMPG     : TEMPERATURE DU POINT DE GAUSS COURANT
