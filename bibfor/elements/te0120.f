...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER JGANO,NDIM,NNO,NNOS,NPG1,JTAB(7),IRET
...
C CALCUL DES VARIABLES DELOCALISEES PAR MINIMISATION LOCALE
      ...
      IF (NDIM.EQ.2) THEN
        CALL DELOCA(NDIM,OPTION,TYPMOD,NPG1,ZR(IPOIDS),NNO,ZR(IVF),
     &              ZR(IDFDE),ZR(IDFDE),ZR(IDFDK),DFDI2,NNOS,VFF,DFF,
     &              DFF,DFF(1+NNOS*NPG1),DFDI1,ZR(IGEOM),ZI(IMATE),
     ...
     &              ZR(IRESID),ZR(IGRAD),ZR(IENER),ZR(IVARIP))
      ...
      ELSE
        CALL DELOCA(NDIM,OPTION,TYPMOD,NPG1,ZR(IPOIDS),NNO,ZR(IVF),
     &              ZR(IDFDE),ZR(IDFDN),ZR(IDFDK),DFDI2,NNOS,VFF,DFF,
