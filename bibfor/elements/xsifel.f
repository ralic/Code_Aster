      SUBROUTINE XSIFEL(ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,NFE,
...
C------------FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      REAL*8   TTRGU,TTRGV,DFDM(3,4),CS,COEF,RHO,PULS
...
C     VÉRIFICATION DU CADRE THÉORIQUE DU CALCUL
     ...
     &    ZK16(ICOMP-1+3).NE.'PETIT') CALL U2MESS('F','ELEMENTS3_68')
