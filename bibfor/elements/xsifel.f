     ...
     &                 DDLC,DDLM,NFE,RHO,PULS,LMODA,BASLOC,NNOP,IDEPL,
...
C TOLE CRP_21
      ...
      REAL*8        BASLOC(3*NDIM*NNOP),LSN(NNOP),LST(NNOP),RHO,PULS
      LOGICAL       LMODA
...
C OUT IGTHET  : G, K1, K2, K3
      ...
      REAL*8   TTRGU,TTRGV,DFDM(3,4),CS,COEF
...
C       RECUPERATION DES DONNEES MATERIAUX
     ...
     &               3,NOMRES,VALRES,DEVRES,ICODRE)
        ...
        CALL RCVALB('XFEM',IPG,1,'+',ZI(IMATE),' ',PHENOM,0,' ',0.D0,1,
     &              'RHO',RHO,CODRHO,0)
C
...
C
     ...
     &                TTRGU,TTRGU,POIDS,C1,C2,C3,K3A,RHO,PULS,G)
          ZR(IGTHET )= ZR(IGTHET) + G

          CALL GBIL3D(DUDME,DU1DME,DTDME,DFDM,DZERO,TGUDM,TZERO,
     &                TTRGU,TTRGV,POIDS,C1,C2,C3,K3A,RHO,PULS,K1)
     ...
     &                TTRGU,TTRGV,POIDS,C1,C2,C3,K3A,RHO,PULS,K2)
     ...
     &                TTRGU,TTRGV,POIDS,C1,C2,C3,K3A,RHO,PULS,K3)
