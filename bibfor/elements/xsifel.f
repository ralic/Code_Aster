      SUBROUTINE XSIFEL(ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,DDLM,NFE,
     &             RHO,BASLOC,NNOP,NPG,IDEPL,LSN,LST,IDECPG,IGTHET,FNO)
...
C TOLE CRP_20
      ...
      CHARACTER*8   ELREFP
      CHARACTER*24  COORSE
      INTEGER       IGEOM,NDIM,DDLH,DDLC,DDLM,NFE,NNOP,NPG,IDECPG,IDEPL
      REAL*8        HE,FNO(NDIM*NNOP)
