...
C
C --- RECUPERATION DES DEPLACEMENTS DU POINT DE CONTACT ET
C --- DE SON PROJETE
C
      DO 160 I=1,6
        DPLM(I) = 0.D0
 ...
 180  CONTINUE
     ...
     &    + FFMA(J)*ZR(IDEPL+NNES*(4*NDIM)+(J-1)*2*NDIM+I-1+NDIM)
 210    CONTINUE
 200  CONTINUE
 
C----RECUPERATION DES REACTIONS DE CONTACT

      DO 220 I=1,NDIM
        DO 230 J=1,NNC
          IN=XOULA(CFACE,NFAES,J,IAINES,ESQ)
