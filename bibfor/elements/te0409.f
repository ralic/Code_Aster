...
C                    FORCE_NODA
C                    EFGE_ELNO (OU SIEF_ELNO)  VARI_ELNO
C
...
C
      ...
      INTEGER MULTIC, JTAB(7), JTAB1(7),JTAB2(7),CODRET, IDEPLM, IDEPLP
      INTEGER ICOMPO, I, I1, I2, J, K, IVECTU, IPG, NPG
      INTEGER ICHG, ICHN, NCMP, ICONTM, JCRET, LGPG1, LGPG2
...
C ---   RECUPERATION DU MATERIAU
     ...
     &      OPTION.EQ.'RIGI_MECA     ') THEN
      ...
      IF (OPTION.NE.'EFGE_ELNO'.AND. OPTION.NE.'SIEF_ELNO' .AND.
     &    OPTION.NE.'VARI_ELNO') THEN
