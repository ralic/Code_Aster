      SUBROUTINE XTEINI(NOMTE,DDLH,NFE,SINGU,DDLC,NNOM,DDLS,NDDL,DDLM)
      IMPLICIT NONE

      CHARACTER*16   NOMTE
      INTEGER        DDLH,NFE,SINGU,DDLC,NNOM,DDLS,NDDL,DDLM
