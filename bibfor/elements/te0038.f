...
C MODIF ELEMENTS  DATE 16/01/2001   AUTEUR CIBHHPD D.NUNEZ 
C ======================================================================
...
C     --- ORIENTATION DE LA POUTRE ---
   ...
   10   CONTINUE
        ...
        IF ((NOMTE.NE.'MET3SEG3').AND. (NOMTE.NE.'MET6SEG3')
     &   .AND. (NOMTE.NE.'MET3SEG4')) THEN
...
C        --- RECUPERATION DES CARACTERISTIQUES  DES TUYAUX
          ...
          NN2 = ZI(ICARAC)
          CALL CARCOU(ZR(LORIEN),XL,PGL,RAYON,THETA,PGL1,PGL2,PGL3,PGL4,
     &                NN2,OMEGA,ICOUDE)
...
C           -------- INERTIE
          ...
          YIG = RHO*XL*IY1*UNPR4/5.D0 + RHO*XL**3*A1*UNPR2/30.D0 - POXI2
          ZIG = RHO*XL*IZ1*UNPR4/5.D0 + RHO*XL**3*A1*UNPR2/30.D0 - POXI2
