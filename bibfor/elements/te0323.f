...
C MODIF ELEMENTS  DATE 15/04/2013   AUTEUR LAVERNE J.LAVERNE 
C ======================================================================
...
C ----------------------------------------------------------------------
C    OPTION FORC_NODA ET REFE_FORC_NODA POUR LES JOINTS QUADRA ET HYME
C ----------------------------------------------------------------------
...
C      OPTIONS FORC_NODA ET REFE_FORC_NODA
      ...
      IF (OPTION .EQ. 'FORC_NODA') THEN
        ...
        CALL EJFONO(NDIM,NDDL,AXI,NNO1,NNO2,NPG,IW,ZR(IW),ZR(IVF1),
     &              ZR(IVF2),IDF2,ZR(IDF2),ZR(IGEOM),IU,IP,
     &              ZR(ICONTM),ZR(IVECTU))
