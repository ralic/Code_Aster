      SUBROUTINE XBSIG (NDIM,NNOP,DDLH,NFE,DDLC,DDLM,IGEOM,JPINTT,
     &                   CNSET,HEAVT,LONCH,BASLOC,SIGMA,NBSIG,
     &                   LSN,LST,IVECTU,JPMILT)
      
       IMPLICIT NONE
C
       INTEGER       NDIM,NNOP,DDLH,NFE,DDLC,DDLM,IGEOM,NBSIG,IVECTU
       INTEGER       CNSET(4*32),HEAVT(36),LONCH(10),JPINTT,JPMILT
...
C     VARIABLES LOCALES
      ...
      CHARACTER*24  COORSE
      INTEGER       NSE,IDECPG,IDEBS
      INTEGER       IT,ISE,IN,INO,NIT,NSEMAX(3),CPT,NPG,JCOORS,J
      INTEGER       IRESE,NNO,IBID
      LOGICAL       ISMALI
...
C         DEBUT DE LA ZONE MÉMOIRE DE SIGMA CORRESPONDANTE
     ...
     &                  NPG,SIGMA(IDEBS+1),LSN,LST,ZR(IVECTU))
     ...
     &                  DDLH,DDLC,DDLM,NFE,
     &                  BASLOC,NNOP,NPG,SIGMA(IDEBS+1),LSN,LST,IVECTU)
