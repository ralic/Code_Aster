      SUBROUTINE XBSIG3(ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,NFE,
...
C
      ...
      REAL*8        HE,BASLOC(9*NNOP),SIGMA(6,NPG),LSN(NNOP),LST(NNOP)
...
C     VARIABLES LOCALES
      ...
      REAL*8     DEF(6,NNOP,NDIM+DDLH+NDIM*NFE),SIGN(6)
...
C       JUSTE POUR CALCULER LES FF
        CALL REERE3(ELREFP,NNOP,IGEOM,XG,RBID1,.FALSE.,NDIM,HE,DDLH,NFE,
