      SUBROUTINE XBSIG3(ELREFP,NDIM,COORSE,IGEOM,HE,NFH,DDLC,DDLM,NFE,
...
C
      ...
      INTEGER       NFISS,FISNO(NNOP,NFISS),DDLM,IVECTU,IBID
      INTEGER       NN,NNOPS,CODOPT
      REAL*8        BASLOC(9*NNOP),LSN(NNOP),LST(NNOP)
      REAl*8        SIGMA(CODOPT*(6-1)+1,CODOPT*(NPG-1)+1)
      REAL*8        HE(NFISS),RBID
...
C     NOMBRE DE DDL TOTAL (DEPL+CONTACT) À CHAQUE NOEUD SOMMET
      DDLS=DDLD+DDLC
      CALL ELREF4(' ','RIGI',IBID,IBID,NNOPS,IBID,IBID,IBID,
     &                        IBID,IBID)
