...
C ======================================================================
C     ------------------------------------------------------------------
C     EFFORTS ET DEFORMATIONS GENERALISES DE L'ELEMENT DE PLAQUE T3GAMMA
C     OPTION DEGE_ELNO
C     ------------------------------------------------------------------
...
C                  LE REPERE INTRINSEQUE A L'ELEMENT
      ...
      REAL*8   BF(3,9),BM(3,6),BC(2,9)
      REAL*8   BDM(3),BDF(3),BCDF(2),DCIS(2)
      REAL*8   VF(3),VM(3),VT(2)
      REAL*8   VFM(3),VMF(3),VMC(3),VFC(3),CARAT3(21)
...
C     ----- COMPOSANTES DEPLACEMENT MEMBRANE ET FLEXION ----------------
   ...
   20 CONTINUE
C
C     ----- CALCUL DU JACOBIEN SUR LE TRIANGLE -----------------
