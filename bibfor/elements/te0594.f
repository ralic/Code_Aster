...
C
C          OPTION : 'RIGI_THER_PARO_F' ET 'RIGI_THER_PARO_R'
C
...
C     SI LE COEFF D'ECHANGE PAROI EST NUL, IL N'Y A RIEN A FAIRE
      ...
      ELSEIF (OPTION.EQ.'RIGI_THER_PARO_F') THEN
        FONREE = 'FONC'
...
C
C ----------------------------------------------------------------------
C --- CALCUL DE LA MATRICE DE RIGIDITE ELEMENTAIRE DUE A ECHANGE_PAROI
C ----------------------------------------------------------------------
C
      CALL XRECHP(NDIM,ELREFP,NNOP,IGEOM,ITPS,IHECHP,JPTINT,JAINT,
