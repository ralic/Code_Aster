...
C MODIF ELEMENTS  DATE 09/05/2005   AUTEUR REZETTE C.REZETTE 
C ======================================================================
...
C..............................................................
C
      INTEGER INO, NNOP, HE, DDLH, IN, IGEOM, ID,IADZI,IAZK24
      REAL*8  PINTT(3*11)
      REAL*8  DEPR(3),DEPLA(3)

      REAL*8 F(3,3),EPS(6),XN(3),FF(NNOP),DEPL(9*NNOP)
      REAL*8 DEPR1(3,NNOP),DFDI(NNOP,3),XE(3)
      CHARACTER*8 ELREFP
C
      CALL JEMARQ()
C
      CALL LCINVN(3,0.D0,DEPR)
      CALL LCINVN(3*NNOP,0.D0,DEPR1)
...
C NOEUD D'INTERSECTION
         ...
         CALL REEREF(ELREFP,NNOP,DDLH,IGEOM,XN,
     &        DEPR1,.FALSE.,XE,FF,DFDI,F,EPS)
         DO 10 IN=1,NNOP
            ID = 9*(IN-1)
            DEPR(1) =  DEPR(1) + 
