...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX --------------------
      ...
      INTEGER      NDIM,DDLH,DDLC,DDLE,DDLS,NNO,NNOS,NNOM,NNOF
      INTEGER      NPG,NPGF,XOULA,INCOCA
      INTEGER      INDCO(60),NINTER,NFACE,CFACE(5,3)

      CHARACTER*8   ELREF,TYPMA
      REAL*8        HE,SIGN,VTMP(27*7),SOMME,FFI,REAC,JAC,FFP(27),PREC
...
C      WRITE(6,*)' '
C      WRITE(6,697)
C 697  FORMAT(4X,'I_IN',7X,'DN',11X,'REAC',7X,'I_OUT')
C
...
C
C         IMPRESSION 
C          WRITE(6,698),INDCO(ISSPG),DN,REAC,ZI(JOUT2-1+ISSPG)
C 698      FORMAT(5X,I1,4X,E11.5,4X,E11.5,4X,I1)       
