     ...
     &                  DDLH,SINGU,NFE,DDLC,DDLM,JLST,IPRES,IPREF,
...
C       ET DE DFDI : DERIVVES DES FF PARENT
     ...
     &    NNOP,IGEOM,JBASEC,XG,'DFF',JAC,FF,R27BID,DFDI,ND,R3BID,R3BID)
        ELSEIF (NDIM.EQ.2) THEN
          CALL XJACF2(ELREF,ELREFC,ELC,NDIM,FPG,JPTINT,IFA,CFACE,NDIM,
     &    IPGF,NNOP,IGEOM,JBASEC,XG,'DFF',JAC,FF,R27BID,DFDI,ND,R3BID)
        ENDIF
