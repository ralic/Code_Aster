...
C
      INTEGER            NNO,KP,NPG1,II,JJ,I,J,K,IMATUU,ITEMPE,NBRES
...
C
      ...
      REAL*8             XG,YG,CP1,CP2,CP3,DP1,DP2,DP3,TPG,VFI,VFJ
...
C
     ...
     &                   ZR(IFORC),ZR(ITEMPE),NNO,BIDON,DTDM,BIDON1,TGD)
           DTDM(4) = DTDM(4)/R
           KD1=2
           KD2=1
...
C
     ...
     &              ZR(ITEMPE),NNO,BIDON,DTDM,BIDON1,TGD)
        A22 = 1 + ALPHA * DTDM(2)
        A11 = 1 + ALPHA * DTDM(1)
        A12 =   - ALPHA * DTDM(3)
        A21 =   - ALPHA * DTDM(5)
