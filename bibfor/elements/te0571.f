...
C
C ----------------------------------------------------------------------
C --- PREALABLES AU CALCUL DE LA RIGIDITE ELEMENTAIRE
C ----------------------------------------------------------------------
C
...
C ----------------------------------------------------------------------
C
      CALL XRIGTH(NDIM,ELREFP,NNOP,IMATE,ITPS,IGEOM,ZI(JLONCH),
