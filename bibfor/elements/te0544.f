...
C ......................................................................
      ...
      CHARACTER*16 COMPOR
      INTEGER JGANO,NDIM,NNO,NNOS,NPG,LGPG,JTAB(7)
...
C - ON LES VEUT POUR LES DEFO GENERALISEES (D'OU LES ALIAS)
      CALL ELREF4(ELREF2,'RIGI',NDIM,NNO,NNOS,NPG,IPOIDS,IVF,IDFDE,
     &              JGANO)

      IF (NNO.GT.27) CALL UTMESS('F','TE0544','DFDI MAL DIMENSIONNEE')
      IF (NPG.GT.27) CALL UTMESS('F','TE0544','DFDI MAL DIMENSIONNEE')
