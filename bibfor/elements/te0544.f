...
C ......................................................................
      ...
      INTEGER JGANO,NDIM,NNO,NNOS,NPG1,I,IMATUU,ITRAV,LGPG,JTAB(7)
      INTEGER ICARAC,IFF,IPOIDS,IVF,IDFDE,IDFDN,IDFDK,IGEOM,IMATE
      INTEGER ICONTM,IVARIM,ICOPIL,IBORNE,IBID,ICTAU,IRET
...
C - ON LES VEUT POUR LES DEFO GENERALISEES (D'OU LES ALIAS)
      IF (TYPMOD(1).EQ.'3D') THEN
        CALL ELREF4(ELREF2,'RIGI',NDIM,NNO,NNOS,NPG1,IPOIDS,IVF,IDFDE,
     &              JGANO)
