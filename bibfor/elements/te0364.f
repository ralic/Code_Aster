...
C
     ...
     &            JEUSUP,NDEXFR,TYPBAR,TYPRAC,COEFAC,
     &            COEFAF)
C
...
C
     ...
     &              NNL   ,NBDM  ,LAXIS ,LDYNA ,TYPBAR,
     &              JEUSUP,PRFUSU,FFE   ,FFM   ,FFL   ,
...
C ----- PHASE DE CALCUL
C
        CALL MMMPHA(LOPTF ,LCONT ,LADHE ,TYPBAR,TYPRAC,
     &              NDEXFR,LPENAC,LPENAF,PHASEP)
