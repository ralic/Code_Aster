      SUBROUTINE COQSNL( NOMTE, OPT, GEOM, IMATE, IMATSE, CARCRI,
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8 DTILD(5,5),SGMTD(5),EFFINT(42),VECL(48),VECLL(51),ROTFCP(9)
      REAL*8 LC,CRF,ZMIN,HIC,ZIC,COEF,DZIC,KSI3S2,X,GXZ,GYZ
      REAL*8 DNSDS(9,42),DNSDSM(9,42),DNSDSF(9,42)

      PARAMETER (NPGE=3)
C ----------------------------------------------------------------------
C
      WRITE(6,*) 'COQSNL OPTION=',OPT 
      RAC2 = SQRT(2.D0)
      TYPMOD(1) = 'C_PLAN  '
      TYPMOD(2) = '        '
      NBV    = 2
...
C
      ...
      WRITE(6,*) 'COQSNL AVANT TECACH='
      CALL TECACH('OON','PVARIMR',7,ITAB,IRET)
      WRITE(6,*) 'COQSNL APRES TECACH'
      NBSP=ITAB(7)
      WRITE(6,*) 'NBSP=',NBSP
      WRITE(6,*) 'NBCOU=',NBCOU
...
C     CALCUL DE BTDMR, BTDSR : M=MEMBRANE , S=CISAILLEMENT , R=REDUIT
   ...
   60     CONTINUE
      WRITE(6,*) 'COQSNL APRES BOUCLE 60=' 
