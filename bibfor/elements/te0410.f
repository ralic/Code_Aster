...
C MODIF ELEMENTS  DATE 17/06/98   AUTEUR ADBHHPM P.MASSIN 
C ======================================================================
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      PARAMETER (NPGT=10)
      INTEGER    NB1
      REAL*8     SIGTOT(6,9),EFFGT(8,9),SIGMPG(108)
...
C --- 1 COUCHE - 2 PTS DANS L'EPAISSEUR
C---- 108 = NPGSN*6(6 CONTRAINTES STOCKEES)*NPGE
C     ------------------------------------------------------
C
              DO 10 I = 1,NPGSN*12
