...
C IN  DEPL    : DÉPLACEMENTS 
      ...
      REAL*8   EPS(6),BASLOG(9),A(3),E1(3),E2(3),NORME,E3(3),P(3,3)
      ...
      REAL*8   DTDM(3,3),TZERO(3),DZERO(3,4)
...
C       BASE LOCALE AU POINT DE GAUSS
        CALL LCINVN(NDIM,0.D0,A)
        CALL LCINVN(NDIM,0.D0,E1)
        CALL LCINVN(NDIM,0.D0,E2)
        DO 113 INO=1,NNOP
          DO 114 I=1,NDIM 
            A(I)  = A(I)  + BASLOC(9*(INO-1)+I)   * FF(INO)
