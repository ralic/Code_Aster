...
C       ---------------------------------------------
C       5) CALCUL DE G, K1, K2, K2 AU POINT DE GAUSS
C       --------------------------------------------    

        CALL GBIL3D(DUDM,DUDM,DTDM,POIDS,C1,C2,C3,G)
        ZR(IGTHET )= ZR(IGTHET) + G

        CALL GBIL3D(DUDM,DU1DM,DTDM,POIDS,C1,C2,C3,K1)
        ZR(IGTHET+1 )= ZR(IGTHET+1) + K1 * COEFF

        CALL GBIL3D(DUDM,DU2DM,DTDM,POIDS,C1,C2,C3,K2)
        ZR(IGTHET+2) = ZR(IGTHET+2) + K2 * COEFF

        CALL GBIL3D(DUDM,DU3DM,DTDM,POIDS,C1,C2,C3,K3)
