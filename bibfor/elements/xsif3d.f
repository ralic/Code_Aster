 ...
 600    CONTINUE
     ...
     &                TTRGU,TTRGV,POIDS,C1,C2,C3,K3A,0.D0,0.D0,K3)
        ...
        ELSEIF(NDIM.EQ.2)THEN
          ...
          CALL GBILIN('XFEM',IPG,ZI(IMATE),DUDME,DUDME,DTDME,DZERO,
     &              TZERO,POIDS,C1,C2,C3,0.D0,TH,0.D0,0.D0,0.D0,
     &              .FALSE.,G)
          ZR(IGTHET) = ZR(IGTHET) + G

          CALL GBILIN('XFEM',IPG,ZI(IMATE),DUDME,DU1DME,DTDME,DZERO,
     &              TZERO,POIDS,C1,C2,C3,0.D0,TH,0.D0,0.D0,0.D0,
     &              .FALSE.,K1)
          ZR(IGTHET+3) = ZR(IGTHET+1) + K1 * COEFF

          CALL GBILIN('XFEM',IPG,ZI(IMATE),DUDME,DU2DME,DTDME,DZERO,
     &              TZERO,POIDS,C1,C2,C3,0.D0,TH,0.D0,0.D0,0.D0,
     &              .FALSE.,K2)
