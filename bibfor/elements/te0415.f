...
C MODIF ELEMENTS  DATE 29/05/2002   AUTEUR CIBHHAB S.VANDENBERGHE 
C ======================================================================
...
C     OPTIONS : SIEF_ELNO_ELGA , VARI_ELNO_ELGA
C          -----------------------------------------------------------
...
C
  ...
  170     CONTINUE
          DO 200 IC = 1,NBCOU
            J = (IC-1)*NPGE*NSO + 1
            ZIC = ZMIN + (IC-1)*HIC
            CALL VDEFGN(NOMTE,OPTION,NB2,HIC,ZIC,SIGMA(1,J),EFFGC)
            DO 190 ISOM = 1,NB2
              DO 180 ICOMP = 1,8
