subroutine mmgnmm(ndim  ,nnm   ,mprt1n,mprt2n, &
                  mprojn,wpg   , &
...
#include "asterfort/vecini.h"
    ...
    real(kind=8) :: mprojn(3, 3),mprt1n(3,3),mprt2n(3,3)
    
    real(kind=8) :: ffm(9),dffm(2,9)
...
! ----------------------------------------------------------------------
    ...
    integer :: inom1, inom2, idim1, idim2
    alpha = 1.d-5 
!ETUDE HEURISTIQUE
...
! ON LE DEBRANCHE AUTOMATIQUEMENT SI SA VALEUR EST TROP 
!GRANDE COMPARATIVEMENT A MATRMM
