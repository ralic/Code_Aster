...
C       ENVIMA               : R8MIEM.
C       MATERIAUX/CHARGES    : RCVALB,RCCOMA.
...
C
     ...
     &              NOMPAR, VALPAR,NBRE1, NOMRE1, VALRE1, CODME1, 0)
C
      IF ( CODME1(1).EQ.0 ) THEN
        PERMIN = VALRE1(1)
      ELSE IF ( CODME1(1).EQ.1 ) THEN
        CALL RCVALB (FAMI,KPG,SPT,POUM, ZI(IMATE), ' ', 'THM_DIFFU', 1,
     &              NOMPAR, VALPAR,NBRR1, NOMRR1, VALRR1, CODMR1, 0)
...
C        VISCOSITE DYNAMIQUE DU LIQUIDE
     ...
     &                NOMPAR, VALPAR, NBRE2, NOMRE2, VALRE2, CODME2, 1)
C
...
C --- D. MODULE DE YOUNG
     ...
     &               NOMPAR, VALPAR,  NBRE3, NOMRE3, VALRE3, CODME3, 1)
C
