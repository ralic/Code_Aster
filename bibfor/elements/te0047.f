...
C *************** DECLARATION DES VARIABLES LOCALES ********************
      ...
      REAL*8 VARMO(7),VARPL(7),IRRAP,IRRAM
      ...
      INTEGER IRMETG,ITERAT,IVARIP,JTP,IDECOL,NDIM,JCRET,IRRAD
...
C
          ...
          IF ((IRRAMR.GT.0).AND.(IRRAPR.GT.0)) THEN
             IRRAD = 1
             IRRAM = 0.5D0 * ( ZR(IRRAMR) + ZR(IRRAMR+1) )
...
C           SAUF SUIVANT Y LOCAL : FROTTEMENT DE COULOMB
     ...
     &                ITEMP, TEMPM, TEMPP,IRRAD,IRRAM,IRRAP)
