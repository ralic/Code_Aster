...
C --- -- RECUPERE TOUS LES PARAMETRES
         ...
         CALL RCVALB(FAMIL,KPG,SPT,POUM,ZI(IMATE),' ','DIS_VISC',NBPAR,
     &               NOMPA,VALPA,NBRE2,NOMRE2,VALRE2,CODRE2,0)
...
C --- -- RECUPERE TOUS LES PARAMETRES
         ...
         CALL RCVALB(FAMIL,KPG,SPT,POUM,ZI(IMATE),' ','DIS_ECRO_CINE',
     &               NBPAR,NOMPA,VALPA,NBRE3,NOMRE3,VALRE3,CODRE3,0)
...
C --- -- TEMPERATURE : SI 2 NOEUDS ==> MOYENNE
         ...
         NBPAR = 1
         NOMPA = 'TEMP'
         CALL RCVALB(FAMIL,KPG,SPT,POUM,ZI(IMATE),' ','DIS_BILI_ELAS',
     &               NBPAR,NOMPA,VALPA,NBRE4,NOMRE4,VALRE4,CODRE4,0)
