...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
     ...
     &              DFDY(27),DFDZ(27),POIDS,FPG(81),LAMBOR(3),FLUGLO(3),
     ...
     &              FLUSZ,FLUGLS(3),FLULOS(3),R8DGRD,ALPHA,BETA
      INTEGER       IPOIDS,IVF,IDFDE,IDFDN,IDFDK,IGEOM,IMATE,NNO,KP,
     &              NPG1,I,IFLUX,ITEMPS,ITEMPE,NBPG(10),IMATSE,ITEMSE,
     &              K,L,N1,N2,JIN,NDIM,NBFPG,NNOS,JVAL,ICAMAS,IFPG,NUNO
...
110   CONTINUE
      ...
      ENDIF
      IF (ELREFE.EQ.'HEXA8L  ' .OR. ELREFE.EQ.'PENTA6L ' .OR.
...
C PHENOM MAT DERIVEE
      IF (LSENS) THEN
        ...
        IF (PHESEN.NE.PHENOM)
     &    CALL UTMESS('F','TE0063','! PB PHESEN.NE.PHENOM !')
      ENDIF
...
C CALCUL DE SENSIBILITE PART V (THERMIQUE NON-LINEAIRE)
     ...
     &              'TEMP',TPG,1,'LAMBDA',LAMBS,CODRET,'FM')
      ...
      ELSE
         CALL UTMESS ('F','TE0063','COMPORTEMENT NON TROUVE')
      ENDIF
...
101   CONTINUE
      ...
      CALL PPGANO(NNOS,NPG1,3,FPG,ZR(IFLUX))
C FIN ------------------------------------------------------------------
      END
