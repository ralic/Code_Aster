...
C
      ...
      REAL*8  A,B
      INTEGER IND
      REAL*8 A1 ,A2 ,A3 ,ALF2 ,ALF3 ,ALF4 ,ALF5
      REAL*8 ALF6 ,ALF7 ,ATILD1 ,ATILD2 ,ATILD3 ,ATILD4 ,ATILD5
      REAL*8 B1 ,B2 ,B3 ,BET2 ,BET3 ,BET4 ,BET5
      REAL*8 BET6 ,BET7 ,BTILD1 ,BTILD2 ,BTILD3 ,BTILD4 ,BTILD5
      REAL*8 C ,C1 ,C2 ,C3 ,CTILD1 ,CTILD2 ,CTILD3
      REAL*8 CTILD4 ,CTILD5 ,DEL2 ,DEL3 ,DEL4 ,DEL5 ,DEL6
      REAL*8 DEL7 ,DTILD1 ,DTILD2 ,DTILD3 ,DTILD4 ,DTILD5 ,ETILD1
      REAL*8 ETILD2 ,ETILD3 ,ETILD4 ,ETILD5 ,EX22 ,EX23 ,EX24
      REAL*8 EX25 ,EX26 ,EX27 ,EY22 ,EY23 ,EY24 ,EY25
      REAL*8 EY26 ,EY27 ,F1 ,FTILD1 ,FTILD2 ,FTILD3 ,FTILD4
      REAL*8 FTILD5 ,GAM2 ,GAM3 ,GAM4 ,GAM5 ,GAM6 ,GAM7
      REAL*8 XI12 ,XI22 ,XI32 ,XI33 ,XI34
C-----------------------------------------------------------------------
C
