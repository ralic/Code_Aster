...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER NDIM,NNO,NNOP,NPG,NPTF,JBASEC
...
C     INITIALISATION DES DIMENSIONS DES DDLS X-FEM
      CALL XTEINI(NOMTE,DDLH,NFE,SINGU,DDLC,IBID,IBID,IBID,DDLM)
...
C         FONCTION HEAVYSIDE CSTE SUR LE SS-ÉLT
          ...
          CALL XGELEM(ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,DDLM,NFE,
