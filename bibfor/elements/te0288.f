...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER NFH,NFE,DDLC,NIT,CPT,IT,NSE,ISE,IN,INO
...
C     INITIALISATION DES DIMENSIONS DES DDLS X-FEM
      CALL XTEINI(NOMTE,NFH,NFE,SINGU,DDLC,IBID,IBID,IBID,DDLM,NFISS)
...
C         BOUCLE SUR LES SOMMETS DU SOUS-TRIA (DU SOUS-SEG)
 ...
 111      CONTINUE
          ...
          CALL XGELEM(ELREFP,NDIM,COORSE,IGEOM,JHEAVT,IT,ISE,NFH,
     &                DDLC,DDLM,NFE,ZR(JBASLO),NNOP,IDEPL,
     &                ZR(JLSN),ZR(JLST),IGTHET,NFISS,JFISNO)
