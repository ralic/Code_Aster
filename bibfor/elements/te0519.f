...
C
      ...
      INTEGER       I,J,IPT,NFE,DDLC,NNOM,NPTF,NDDL,DDLM,NNOS,IN
...
C
 ...
 220      CONTINUE
          DO 230 J=1,NFH*NDIM
            DEPLM(J)=DEPLM(J)+FF(I)*ZR(JDEPL-1+IN+NDIM+J)
            DEPLE(J)=DEPLE(J)-FF(I)*ZR(JDEPL-1+IN+NDIM+J)
 230      CONTINUE
          DO 240 J=1,SINGU*NDIM
            DEPLM(J)=DEPLM(J)+R*FF(I)*ZR(JDEPL-1+IN+
     &                                     NDIM*(1+NFH)+J)
            DEPLE(J)=DEPLE(J)-R*FF(I)*ZR(JDEPL-1+IN+
     &                                     NDIM*(1+NFH)+J)
 240      CONTINUE
 210    CONTINUE
C
