...
C
       INTEGER       JPOS,I,J,NDDLE,IN,NNES,NNEM,DDLES,DDLEM,NNM
       INTEGER       DDLMS,DDLMM,IFH
       CHARACTER*19  POSDDL
...
C --- CONTACT NON ACTIF POUR CE NOEUD, ON ELIMINE LES DDL DE CONTACT
            DO 120 J=1,NDIM
              IF (.NOT.LMULTI) ZI(JPOS-1+DDLES*I-NDIM+J)=1
              IF(LMULTI)ZI(JPOS-1+DDLES*(I-1)+NDIM*(NFHE+HEAVNO(I))+J)=1
 120        CONTINUE
          ENDIF
 110    CONTINUE
      ENDIF
