     ...
     &           OPTION,LESCLX,LMAITX,LCONTX,STANO,LACT,
     &           JDDLE,MMAT,VTMP)
...
C
      IMPLICIT NONE
      INTEGER       NDIM,JNNM(3),NDDL,NDLS,STANO(16),LACT(8)
      CHARACTER*16  OPTION
      REAL*8        MMAT(168,168),VTMP(168)
      LOGICAL       LESCLX,LMAITX,LCONTX
...
C --- NOEUD CRACK-TIP, ON ELIMINE LES DDL CRACK-TIP
            DO 30 J=1,NDIM
