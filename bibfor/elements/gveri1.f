...
C
      INTEGER       KK2,KK3,JADR,NBOBJ,NENT,NSOM,MM2,MM3
      INTEGER       JJJ,NDIM,NGRO,NBGM,NBEM,IER,DIM1,DIM2
      INTEGER       IGR,NGR,INO,IRET,LL2,LL3,ITYP
      INTEGER       I,J,L,IRE1,IRE2,IN
      INTEGER       IATYMA,IBID,K2,K3
      INTEGER       JNORM,NCMP,J2,J3
      INTEGER       JSUP, NBMAS,IERA
      INTEGER       NBNOE,N1,IDCOOR,IDLINO,JNOLS,JLIMA,NBNOLS,IM
