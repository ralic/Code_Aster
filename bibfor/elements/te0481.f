...
C ......................................................................
      ...
      INTEGER IPOI1,IVF1,IDFDE1,NTROU
      ...
      CALL ELREF4(LIELRF(1),'RIGI',NDIM,NNO1,NNO1S,NPG1,IPOI1,IVF1,
     &            IDFDE1,JGANO1)
      CALL ELREF4(LIELRF(2),'RIGI',NDIM,NNO2,NNO2S,NPG2,IPOI2,IVF2,
     &            IDFDE2,JGANO2)
...
C - CALCUL DES FORCES INTERIEURES
      IF (ZK16(ICOMPO+2) (1:5).EQ.'PETIT' .OR. IRETC .NE. 0) THEN
        CALL NIFN3D(NNO1,NNO2,NPG1,IPOI1,IVF1,IVF2,
     &              IDFDE1,DFDI,ZR(IGEOM),
