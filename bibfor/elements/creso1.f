     ...
     &  VERIF,TESTCO,NBREOR,TYREOR,SCALIN,INUMSD,IMAIL,NOMSD)
C-----------------------------------------------------------------------
...
C DECLARATION PARAMETRES D'APPELS
      INTEGER      NPREC,NMAXIT,ISTOP,NIREMP,IFM,NIV,NUMSD,NBMA,NBREOR,
     &             INUMSD,IMAIL
      REAL*8       EPS,RESIRE,TBLOC,TESTCO
      CHARACTER*3  SYME     
      CHARACTER*8  METHOD,PRECO,RENUM,VERIF,TYREOR,SCALIN,NOMSD
      CHARACTER*19 SOLVEU
      CHARACTER*24 SDFETI
