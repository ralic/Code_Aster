...
C
      ...
      INTEGER       IVECTT,K,I,L,LI,IHECHP,ITEMPS,ITEMP,NBELR
...
CCDIR$ IVDEP
        DO 120 I=1,NNO
          LI = IVF+(KP-1)*NNO+I-1
          ZR(IVECTT+I-1) = ZR(IVECTT+I-1) + POIDS * ZR(LI)
     &                   * COEFH * (1.0D0-THETA)*TPG
          ZR(IVECTT+I-1+NNO) = ZR(IVECTT+I-1+NNO) - POIDS*ZR(LI)
     &                       * COEFH * (1.0D0-THETA)*TPG
120     CONTINUE
100   CONTINUE
      END
