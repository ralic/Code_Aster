...
C.======================================================================
      IMPLICIT NONE
C
C      D1PA3D  -- CALCUL DE LA MATRICE DE PASSAGE DU REPERE
C                 D'ORTHOTROPIE AU REPERE GLOBAL POUR L'INVERSE 
C                 DE LA MATRICE DE HOOKE.
C                 CETTE MATRICE EST CONSTRUITE EN ECRIVANT
C                 L'INVARIANCE DE  L'ENERGIE DE DEFORMATION ELASTIQUE
C                 LORS D'UN CHANGEMENT DE REPERE.
C
