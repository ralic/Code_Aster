...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      INTEGER            IPOIDS,IVF,IDFDX,IDFDY,IGEOM,JIN,I,J,NBFPG
      INTEGER            NDIM,NNO,IPG,NPG1,IVECTT,IHECHP,JVAL,INO,JNO
      INTEGER            IDEC,JDEC,KDEC,LDEC,ITEMPS,ITEMP,NBPG(10)
...
CCDIR$ IVDEP
        DO 103 I=1,NNO
          ZR(IVECTT+I-1) = ZR(IVECTT+I-1) + JAC * H *
     &       ZR(IPOIDS+IPG-1) * ZR(IVF+LDEC+I-1) * (1.0D0-THETA)*TEM
          ZR(IVECTT+NNO+I-1) = ZR(IVECTT+NNO+I-1) - JAC * H *
     &       ZR(IPOIDS+IPG-1) * ZR(IVF+LDEC+I-1) * (1.0D0-THETA)*TEM
103     CONTINUE
101   CONTINUE
      END
