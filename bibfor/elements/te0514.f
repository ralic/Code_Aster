...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX --------------------
      ...
      INTEGER       IGEOM,JLSN,JOUT1,JOUT2,JOUT3,JOUT4,JOUT5
      INTEGER       JPTINT,JHEAV,IADZI,IAZK24,JDIM,NNO,NNN,NODOUB
      INTEGER       NINTER,CONNEC(6,4),NIT,NSE,NSETOT
...
C     CALCUL D'UNE LONGUEUR CARACTERISTIQUE DE L'ELEMENT
      ...
      CALL LONCAR(TYPMA,ZR(IGEOM),LONREF)

C     ON SUBDIVISE L'ELEMENT PARENT EN NIT SOUS-ELEMENTS
      CALL XDIVTE(TYPMA,CONNEC,NIT)
