      SUBROUTINE PRJSHB(ITYP,SSTAR,SELAS,PENTE,IBOU,SI,DEPS,EPST,
     1 EPSTAR,ITER,SN,TET,DHOOK,PANTIN,SIG,EPS,IPOIN,
     1 SIGEL,DSIGP,TEST,TREF,ALFAH,HPAS,STOT,
     1 NCOURB,LINCOU,IBI,IMAT,ITMAX)
