     ...
     &                  BASLOC,NNOP,NPG,SIGMA,LSN,LST,IVECTU)

      IMPLICIT NONE
C
      CHARACTER*8   ELREFP,ELRESE
      CHARACTER*24  COORSE
      INTEGER       DDLH,DDLC,DDLM,NFE
      INTEGER       IGEOM,NDIM,NNOP,NPG,IVECTU
...
C       JUSTE POUR CALCULER LES FF
     ...
     &              DDLH,NFE,DDLS,DDLM,FE,DGDGL,'NON',XE,FF,DFDI,F,
     &              RBID2,RBID6)
...
C       ET CALCUL DE FF, DFDI, ET EPS
        CALL REEREF(ELREFP,NNOP,NNOPS,IGEOM,XG,IBID,.FALSE.,NDIM,HE,
     &              DDLH,NFE,DDLS,DDLM,FE,DGDGL,'OUI',XE,FF,DFDI,F,
     &              RBID2,RBID6)
