      SUBROUTINE MMMLAV(LUSURE,LDYNA ,LFOVIT,PRFUSU,CWEAR ,
...
C
      INTEGER      JPCF,JUSUP
      INTEGER      IUSURE,IFORM
      REAL*8       KW,HW,THETA,DELTAT
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ()
...
C
      ...
      JEUSUP   =      ZR(JPCF-1+14)
      IUSURE   = NINT(ZR(JPCF-1+21))
      KW       =      ZR(JPCF-1+22)
      HW       =      ZR(JPCF-1+23)
      NDEXFR   = NINT(ZR(JPCF-1+24))
      TYPBAR   = NINT(ZR(JPCF-1+25))
      TYPRAC   = NINT(ZR(JPCF-1+26))
      IFORM    = NINT(ZR(JPCF-1+27))
      DELTAT   =      ZR(JPCF-1+28)
      THETA    =      ZR(JPCF-1+29)
C
