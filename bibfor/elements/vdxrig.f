      SUBROUTINE VDXRIG(OPTION , NOMTE , XI , RIG ,  NB1 , INDM , INDF )
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ELEMENTS  DATE 14/01/2002   AUTEUR JMBHH01 J.M.PROIX 
C ======================================================================
...
C
     ...
     &                                       KWGT,HSJ1FX,WGT)
C
      CALL BTDFN(1,NB1,NB2,XI,KSI3S2,INTSN,ZR(LZR),EPAIS,VECTPT,HSJ1FX,
     &                                                             BTDF)
C
...
C
     ...
     &                                                            BTILD)
C
      CALL MATRC(INTE,INTSN,NB2,XI,KAPPA,MATC,VECTT)
C
      CALL R8SCAL(25,WGT,MATC,1)
C
