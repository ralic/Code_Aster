...
C     VERIFICATION QUE LA MAILLE EST DE TYPE HEXA
...
C    BOUCLE SUR LES 4 SOMMETS DU SOUS-TÉTRA
          DO 120 JNO=1,4
             INO=ZI(JCNSET-1 + 4*(CPT-1)+JNO)
              CALL  XDEL3D(ELREFP,DDLH,INO,NNOP,
     &                      ZR(JPINTT),
     &                     ZR(IDEPLR),DEPR,IGEOM,HE,DEPLA)
              IF(INO.LT.1000)THEN
