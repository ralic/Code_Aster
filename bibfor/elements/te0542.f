...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER    JPMILT,DDLM
      INTEGER    DDLH,DDLC,NFE,IBID,NBSIGM,DDLS,NBSIG,NDDL,JSTNO
      LOGICAL    LBID
      REAL*8     RBID
      CHARACTER*8 ENR,LAG
C DEB ------------------------------------------------------------------
...
C     INITIALISATION DES DIMENSIONS DES DDLS X-FEM
      CALL XTEINI(NOMTE,DDLH,NFE,IBID,DDLC,IBID,DDLS,NDDL,DDLM)
...
C       CALCUL DU VECTEUR DES FORCES INTERNES (BT*SIGMA)
        CALL XBSIG(NDIM,NNO,DDLH,NFE,DDLC,DDLM,IGEOM,JPINTT,
     &       ZI(JCNSET),ZI(JHEAVT),ZI(JLONCH),ZR(JBASLO),ZR(ICONTM),
     &       NBSIG,ZR(JLSN),ZR(JLST),IVECTU,JPMILT)
...
C       OPTION REFE_FORC_NODA PLUS TARD...
        ...
        CALL XBSIGR(NDIM,NNO,DDLH,NFE,DDLC,DDLM,IGEOM,JPINTT,
     &       ZI(JCNSET),ZI(JHEAVT),ZI(JLONCH),ZR(JBASLO),ZR(ICONTM),
     &       NBSIG,ZR(JLSN),ZR(JLST),DDLS,IVECTU,JPMILT)
