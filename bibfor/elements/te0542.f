...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER    DDLH,DDLC,NFE,I,IBID,NBSIGM,NPG1,DDLS,NBSIG,NDDL,JSTNO
      LOGICAL    LBID
      REAL*8     RBID
      CHARACTER*8 LAG
...
C     INITIALISATION DES DIMENSIONS DES DDLS X-FEM
      CALL XTEINI(NOMTE,DDLH,NFE,IBID,DDLC,IBID,DDLS,NDDL)
C      CALL XTEINI(NOMTE,DDLH,NFE,IBID,DDLC,NNOM,DDLS,NDDL)
...
C       CALCUL DU VECTEUR DES FORCES INTERNES (BT*SIGMA)
        CALL XBSIG(NDIM,NNO,DDLH,NFE,DDLC,IGEOM,ZR(JPINTT),ZI(JCNSET),
