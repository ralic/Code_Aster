...
C     ON CALCULE LES GRADIENTS SUR TOUS LES NOEUDS : SOMMET ET MILIEU
C     IL FAUT DONC FAIRE APPEL A L'ELT DE REF QUADRATIQUE
      IF (ELP.EQ.'HE8') ELPQ = 'H20' 
      IF (ELP.EQ.'PE6') ELPQ = 'P15' 
      IF (ELP.EQ.'TE4') ELPQ = 'T10' 
      IF (ELP.EQ.'QU4') ELPQ = 'QU8' 
      IF (ELP.EQ.'TR3') ELPQ = 'TR6' 
      CALL ELREF4(ELPQ,'NOEU',NDIM,NNO,NNOS,NPG,IPOIDS,IVF,IDFDE,JGANO)
