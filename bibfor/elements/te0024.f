...
C     POUR LES ELEMENTS ISSUS DE LA MODELATION XFEM
C     ON A MIS LES XH, XT ET XHT 3D A CAUSE DE LA PROPA 3D
      IF (NOMTE.EQ.'MECA_X_HEXA20'.OR.
     &    NOMTE.EQ.'MECA_X_PENTA15'.OR.
     &    NOMTE.EQ.'MECA_X_TETRA10'.OR.
     &    NOMTE.EQ.'MECPTR6_X'.OR.
     &    NOMTE.EQ.'MECPQU8_X'.OR.
     &    NOMTE.EQ.'MEDPTR6_X'.OR.
     &    NOMTE.EQ.'MEDPQU8_X'.OR.
     &    NOMTE.EQ.'MECA_XH_HEXA8'.OR.
     &    NOMTE.EQ.'MECA_XH_PENTA6'.OR.
     &    NOMTE.EQ.'MECA_XH_TETRA4'.OR.
     &    NOMTE.EQ.'MECA_XT_HEXA8'.OR.
     &    NOMTE.EQ.'MECA_XT_PENTA6'.OR.
     &    NOMTE.EQ.'MECA_XT_TETRA4'.OR.
     &    NOMTE.EQ.'MECA_XHT_HEXA8'.OR.
     &    NOMTE.EQ.'MECA_XHT_PENTA6'.OR.
     &    NOMTE.EQ.'MECA_XHT_TETRA4') THEN
...
C       IL FAUT DONC FAIRE APPEL A L'ELT DE REF QUADRATIQUE
        ...
        CALL ELREF4(ELPQ,'NOEU',NDIM,NNO,NNOS,NPG,IPOIDS,IVF,IDFDE,JGAN)
