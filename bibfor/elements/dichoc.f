      SUBROUTINE DICHOC (NBT,NEQ,NNO,NC,ICODMA,UL,DUL,UTL,XG,PGL,INST,
     &            SIM,KLV,KTY2,DULY,DVL,DPE,DVE,FOR2,FOR3,VARMO,VARPL)
C ----------------------------------------------------------------------
      IMPLICIT REAL*8 (A-H,O-Z)
      INTEGER NBT,NEQ,NNO,NC,ICODMA
      REAL*8  UL(NEQ),DUL(NEQ),UTL(NEQ),SIM(NEQ),DVL(NEQ)
      REAL*8  DPE(NEQ),DVE(NEQ)
      REAL*8  KLV(NBT),KTY,KTY2,DULY,INST,XG(6),PGL(3,3)
