...
C
      ...
      INTEGER            NNO1,NNO2,KP,NPG,I,L,K,ITEMPS,IFR2D,IVECTU,IFF
      INTEGER            ICARAC,IPOIDS,IVF1,IDFDE1,IDFDK1,IGEOM,ICODE
C
...
C
     ...
     &                ZR(IGEOM),DFDX,DFDY,POIDS )
        ...
        Z = 0.D0
        DO 102 I=1,NNO1
          R = R + ZR(IGEOM+2*I-2)*ZR(IVF1+K+I-1)
          Z = Z + ZR(IGEOM+2*I+1)*ZR(IVF1+K+I-1)
102     CONTINUE
