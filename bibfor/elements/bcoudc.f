...
C ======================================================================
      REAL*8 H,A,B(4,*),FF(*),DF1(*),DF2(*),RAYON,THETA,OMEGA
...
CC         SINMTE = SIN(N*FI-OMEGA)
     ...
     &                    ZETA*N*HK*SINMTE*COSFI/ (A*DENR)
          ...
          B(3,ICOLON+1) = - (N/R)*HK*SINMTE - HK*COSMTE*COSFI/DENR -
...
CC          SINMTE = SIN(N*FI-OMEGA)
     ...
     &                    ZETA*N*HK*COSMTE*COSFI/ (A*DENR)
          ...
          B(3,ICOLON+1) = (N/R)*HK*COSMTE - HK*SINMTE*COSFI/DENR -
...
C  1ERS MODES EN W
     ...
     &                  HK* (COSTE*SINFI+COSFI*SINTE)/DENR
        ...
        B(3,ICOLON+2) = DHK*SINTE* ((1.D0+2.D0*ZETA/A)/DENR+
     &                  ZETA/ (R*DENA)) + ZETA*DHK*COSTE*COSFI/DENA*DENT
        B(4,ICOLON+2) = 0.D0
     ...
     &                  2.D0*ZETA*HK*COSFI*COSTE/ (A*DENR)
        ...
        B(3,ICOLON+3) = -DHK*COSTE* ((1.D0+2.D0*ZETA/A)/DENR+
     &                  ZETA/ (R*DENA)) + ZETA*DHK*SINTE*COSFI/DENA*DENT
        B(4,ICOLON+3) = 0.D0
