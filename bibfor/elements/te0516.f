...
C MODIF ELEMENTS  DATE 29/10/2012   AUTEUR FLEJOU J-L.FLEJOU 
C ======================================================================
...
C     NPG : NOMBRE DE POINTS DE GAUSS
      ...
      REAL*8 DEFAM(6),DEFAP(6),XUGM(6),XDM(3),DGAMMA
...
C        CALCUL DU VECTEUR XLOCAL AU TEMPS T+
         DO 110 I = 1,3
            ...
            XUG(I+3) = ZR(IGEOM-1+I+3) + UTG(I+7)
110      CONTINUE
...
C           CALCUL DU VECTEUR XLOCAL AU TEMPS T-
            DO 116 I = 1,3
               XUGM(I  ) = ZR(IGEOM-1+I  ) + ZR(IDEPLM-1+I  )
               XUGM(I+3) = ZR(IGEOM-1+I+3) + ZR(IDEPLM-1+I+7)
116         CONTINUE
