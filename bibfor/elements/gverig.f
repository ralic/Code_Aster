...
C
      ...
      CHARACTER*24        CHFOND, GRPNO, NOMNO, COORN
      CHARACTER*24      TRAV,TRAV0,TRAV1,TRAV2,TRAV3,TRAV4,TRAV5
      CHARACTER*8       NOMA,NOEUD,NOEUD1,K8B
...
C
      ...
      INTEGER           IGR,NGR,NNO,IRET,NBPAR,ITO,NTO,NOUI,JJJ2,L2
...
C
      IF(NOMCMD.NE.'CALC_G')THEN
        DO 1 IOCC=1,NOCC
C
         CALL GETVTX (MOTFAC(1:L),'TOUT',IOCC,IARG,0,K8BID,NOUI)
...
C
      ...
      DO 2 IOCC=1,NOCC
C
         CALL GETVR8(MOTFAC(1:L),'MODULE',IOCC,IARG,NDIM,THET,NBM)
         ...
         ENDIF
         CALL GETVID(MOTFAC(1:L),'MODULE_FO',IOCC,IARG,NDIM,THETF,NBMOF)
         CALL GETVID(MOTFAC(1:L),'R_INF_FO',IOCC,IARG,NDIM,RINFF,NBMF)
         CALL GETVID(MOTFAC(1:L),'R_SUP_FO',IOCC,IARG,NDIM,RSUPF,NBMF)
...
C
         IF(NOMCMD.EQ.'CALC_G')THEN
           NTO=1
         ELSE
           CALL GETVTX (MOTFAC(1:L),'TOUT',IOCC,IARG,NDIM,ZK8(JJJ),NTO)
         ENDIF
C
         DO 100 ITO=1,NTO
            DO 150 J=1,LOBJ2
