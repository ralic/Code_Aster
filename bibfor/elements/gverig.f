      SUBROUTINE GVERIG ( NOMA, NOCC, CHFOND, TAILLR, CONFIG, LOBJ2,
     &                    NOMNO, COORN, TRAV1, TRAV2, TRAV3, TRAV4 )
      IMPLICIT NONE
C     ------------------------------------------------------------------
...
C        CONFIG : CONFIGURATION DE LA FISSURE
...
C
      ...
      CHARACTER*24     CHFOND, GRPNO, NOMNO, COORN,TAILLR
      CHARACTER*24     TRAV,TRAV0,TRAV1,TRAV2,TRAV3,TRAV4,TRAV5
      CHARACTER*8      CONFIG,NOMA,NOEUD,NOEUD1,K8B
...
C
      REAL*8           MAXTAI,MINTAI,RINF,RSUP,THET,XL,VALPAR(1),VALRES
C
      CHARACTER*24 VALK(2)
      CHARACTER*8  K8BID
      REAL*8       VALR(2)
