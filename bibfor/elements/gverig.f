...
C
      ...
      CHARACTER*8       NOMA,NOEUD,MODELE,NOEUD1
...
5               CONTINUE
                IF(CANOEU.EQ.0) THEN
                  CALL UTMESS('F','GVERIG','LE NOEUD '//NOEUD1
...
7             CONTINUE
              IF(CANOEU.EQ.0) THEN
                  CALL UTMESS('F','GVERIG','LE NOEUD '//ZK8(IADRNO+J-1)
     +             //' N APPARTIENT PAS AU FOND DE FISSURE')
              ENDIF
            ENDIF
6     CONTINUE
