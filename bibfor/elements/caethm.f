     ...
     > NSOM,VOISIN,NBVOS,P2P1,LUMPED,ISTHF4,ISTHF3,ISTH4,ISTH6,ISTH8)
C
...
C
      INTEGER NTHMF4,IHF4
      PARAMETER (NTHMF4=2)
      CHARACTER*16 THMF4(NTHMF4)
C
      INTEGER NTHMF3,IHF3
      PARAMETER (NTHMF3=2)
      CHARACTER*16 THMF3(NTHMF3)
C
...
C
      INTEGER NHMH8,IHH8
      PARAMETER (NHMH8=2)
      CHARACTER*16 THMH8(NHMH8)
C
      INTEGER NHMH6,IHH6
      PARAMETER (NHMH6=2)
      CHARACTER*16 THMH6(NHMH6)
C
      INTEGER NHMH4,IHH4
      PARAMETER (NHMH4=2)
      CHARACTER*16 THMH4(NHMH4)
...
C
     ...
     > 'THM_FACE8       '/
C
C     NTHMF4 : NOMBRE  D ELEMENT DE LA FAMILLE THM ET
C     SUPPORTES PAR UNE MAILLE QUAD4 EN TANT QUE FACE
C     D ELEMENTS 3D
C     THMF4  : NOM DE CES ELEMENTS
C     ISTHF4  : TRUE SI APPARTIENT A CETTE FAMILLE
C
      DATA THMF4 / 
     > 'THH_FACE4       ',
     > 'THV_FACE4       '/
C
C     NTHMF3 : NOMBRE  D ELEMENT DE LA FAMILLE THM ET
C     SUPPORTES PAR UNE MAILLE TRIA3 EN TANT QUE FACE
C     D ELEMENTS 3D
C     THMF3  : NOM DE CES ELEMENTS
C     ISTHF3  : TRUE SI APPARTIENT A CETTE FAMILLE
C
      DATA THMF3 / 
     > 'THH_FACE3       ',
     > 'THV_FACE3       '/
...
C
     ...
     > 'THM_TETRA10D     '/
C
C     NHMH4 : NOMBRE  D ELEMENT DE LA FAMILLE THM ET
C     SUPPORTES PAR UNE MAILLE TETRA4 
C     THMH4  : NOM DE CES ELEMENTS
C     ISTH4  : TRUE SI APPARTIENT A CETTE FAMILLE
C
      DATA THMH4 / 
     > 'THH_TETRA4D     ',
     > 'THV_TETRA4D     '/
C
C     NHMH6 : NOMBRE  D ELEMENT DE LA FAMILLE THM ET
C     SUPPORTES PAR UNE MAILLE PENTA6
C     THMH6  : NOM DE CES ELEMENTS
C     ISTH6  : TRUE SI APPARTIENT A CETTE FAMILLE
C
      DATA THMH6 / 
     > 'THH_PENTA6D     ',
     > 'THV_PENTA6D     '/
C
C     NHMH8 : NOMBRE  D ELEMENT DE LA FAMILLE THM ET
C     SUPPORTES PAR UNE MAILLE HEXA8
C     THMH8  : NOM DE CES ELEMENTS
C     ISTH8  : TRUE SI APPARTIENT A CETTE FAMILLE
C
      DATA THMH8 / 
     > 'THH_HEXA8D     ',
     > 'THV_HEXA8D     '/
...
C
       ELLUM(105) = 'THH_HEXA8D       '
       ELLUM(106) = 'THH_TETRA4D      '
       ELLUM(107) = 'THH_PENTA6D      '
       ELLUM(108) = 'THV_HEXA8D       '
       ELLUM(109) = 'THV_TETRA4D      '
       ELLUM(110) = 'THV_PENTA6D      '
       ELLUM(111) = 'THV_AXIS_QU4D    '
       ELLUM(112) = 'THV_AXIS_TR3D    '
       ELLUM(113) = 'THV_DPQ4D        '
       ELLUM(114) = 'THV_DPTR3D       '
C
      TROUVE  = .FALSE.
      ISTHT3  = .FALSE.
      ISTHQ4  = .FALSE.
...
C
  ...
  321  CONTINUE
       ENDIF
       IF ( .NOT.TROUVE) THEN
        DO 330 IHF4 = 1 , NTHMF4
         IF (NOMTE.EQ.THMF4(IHF4)) THEN
               ISTHF4 = .TRUE.
               TRAITE = .TRUE.
               TROUVE = .TRUE.
               GOTO 331
  ...
  331  CONTINUE
       ENDIF
       IF ( .NOT.TROUVE) THEN
        DO 340 IHF3 = 1 , NTHMF3
         IF (NOMTE.EQ.THMF3(IHF3)) THEN
               ISTHF3 = .TRUE.
               TRAITE = .TRUE.
               TROUVE = .TRUE.
               GOTO 341
