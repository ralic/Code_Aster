      SUBROUTINE ARLAPL(NDIM  ,NNS ,NDML1   ,NDML2 ,LCARA ,LINCLU,NOMTE,
...
C
      ...
      REAL*8       MCPLC1(NDIM*NDML1,NDIM*NDML1)
      REAL*8       MCPLC2(NDIM*NDML1,NDIM*NDML2)
...
C
      CALL ARLTEC(NDML1   ,NDML1   ,NDIM  ,LCARA ,
     &            MCPLN1,MCPLB1,MCPLC1)
C
C --- ASSEMBLAGE DE LA MATRICE MORTAR
C
      CALL ARLTEC(NDML1   ,NDML2   ,NDIM  ,LCARA ,
...
C
      ...
      IJKL1 = 0
      IJKL2 = 0
      DO 140 IAUX = 1,NDIM*NDML1
C
        DO 130 JAUX = 1,NDIM*NDML1
          IJKL1 = IJKL1 + 1
          ZR(IMATU1-1+IJKL1) = MCPLC1(IAUX,JAUX)
 130    CONTINUE
C
        DO 150 JAUX = 1,NDIM*NDML2
          IJKL2 = IJKL2 + 1
