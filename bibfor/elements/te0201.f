...
C------------FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      INTEGER KK, I, J , IVARIM ,IVARIP, JTAB(7)       
      REAL*8  MAT(8,8), FINT(8), SIGMA(2)  
...
C RECUPERATION DU NOMBRE DE VARIABLES INTERNES PAR POINTS DE GAUSS : 
      ...
      CALL NMFI2D( ZI(IMATER),OPTION,ZR(IGEOM),ZR(IDEPM),ZR(IDDEP),
 ...
 10       CONTINUE
      ...
      IF (OPTION.EQ.'RAPH_MECA' .OR. OPTION.EQ.'FULL_MECA') THEN
          ...
          CALL R8COPY(2, SIGMA,1, ZR(ICONT),1)
