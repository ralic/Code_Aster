...
C------------FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      INTEGER IGEOM, IMATER, ICOMP, IDEPM, IDDEP, ICONT, IVECT, IMATR
      INTEGER KK, I, J , IVARIM ,IVARIP, JTAB(7),NPG,IINSTM,IINSTP,IRET
...
C RECUPERATION DU NOMBRE DE VARIABLES INTERNES PAR POINTS DE GAUSS : 
      ...
      CALL NMFI2D( NPG,ZI(IMATER),OPTION,ZR(IGEOM),ZR(IDEPM),ZR(IDDEP),
     &             SIGMA,FINT,MAT,ZR(IVARIM),ZR(IVARIP),
     &             ZK16(ICOMP), TYPMOD ,ZR(IINSTM),ZR(IINSTP))
 ...
 10       CONTINUE
      ...
      IF (OPTION.EQ.'RAPH_MECA' .OR. OPTION.EQ.'FULL_MECA') THEN
          ...
          CALL R8COPY(4, SIGMA,1, ZR(ICONT),1) 
          CALL R8COPY(8, FINT ,1, ZR(IVECT) ,1)
