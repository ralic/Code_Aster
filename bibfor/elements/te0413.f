...
C      .SOIT AUX NOEUDS               : OPTION 'DISS_ELNO_ELGA'
...
C     =======================================
 ...
 110       CONTINUE
        ELSE
          NCMP = 1
          CALL PPGAN2 ( JGANO, NCMP, DISST, AUXT)
          CALL PPGAN2 ( JGANO, NCMP, DISSE, AUXM)
          CALL PPGAN2 ( JGANO, NCMP, DISSP, AUXF)
          DO 120 I = 1, NNOEL
