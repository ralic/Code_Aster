...
C MODIF ELEMENTS  DATE 17/04/2012   AUTEUR FERTE G.FERTE 
C ======================================================================
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX --------------------
      ...
      INTEGER       I,J,K,JJ,NLI,NNOP,NFIMAX
      ...
      INTEGER       NFISC,IFISC,NFISC2,PTMAXI,ZXAINX,NBMAX,NN
      PARAMETER    (PTMAXI=6,NBMAX=18,ZXAINX=5,NFIMAX=10)
      INTEGER       FISC(2*NFIMAX),FISCO(2*NFIMAX),VALI(2)
      INTEGER       PTHEA(NFIMAX*NBMAX)
      REAL*8        PINTER(PTMAXI*3),AINTER(PTMAXI*ZXAINX)
      CHARACTER*16  ENR
C......................................................................
...
C    ON TRANFORME LES COORDONNÉES RÉELES EN COORD. DANS L'ÉLÉMENT DE REF
          CALL REEREF(ELP,LBID,NNOP,IBID,ZR(IGEOM),PTREE,IBID,LBID,
     &              NDIM,RBID, RBID,
