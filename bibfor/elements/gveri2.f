...
C
      ...
      CHARACTER*8       NOEUD,MODELE,NOEUD1,K8B
      CHARACTER*8       NOMPAR(1),RINFF,RSUPF,THETF
      CHARACTER*6       CHAINE
      CHARACTER*16      K16B,NOMCMD,MOTFAC
C
      ...
      INTEGER           CANOEU,NDEG,NBRE,IADRT3,IOCC
C
...
C
      ...
      ENDIF
C
      CALL GETVR8 (MOTFAC, 'R_INF', IOCC, 1, 1,RINF, NR)
      CALL GETVR8 (MOTFAC, 'R_SUP', IOCC, 1, 1,RSUP, NR)
      CALL GETVID (MOTFAC, 'R_INF_FO', IOCC, 1, 1,RINFF, NRF)
      CALL GETVID (MOTFAC, 'R_SUP_FO', IOCC, 1, 1,RSUPF, NRF)
C
