      SUBROUTINE D0MPFN(NMNBN,NMPLAS,NMDPLA,NMDDPL
...
C----- LECTURE DES OBJETS "GLRC"      
 ...
 15   CONTINUE
       ...
       DO 10, I=1,2 
         CALL CDNFON(DMP1F(I),NMNBN(I),0,NMDPLA(1,I),IER0)
         IF (IER0 .GT. 0) THEN 
           CALL CDNFON(MP1F(I),NMNBN(I),1,NMDPLA(1,I),IER1)
         ENDIF
         
         CALL CDNFON(DMP2F(I),NMNBN(I),0,NMDPLA(2,I),IER0)
         IF (IER0 .GT. 0) THEN 
           CALL CDNFON(MP2F(I),NMNBN(I),1,NMDPLA(2,I),IER1)
         ENDIF
 10    CONTINUE
