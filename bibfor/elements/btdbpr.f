...
C    B(NBSIG,1)     IN     R        MATRICE (B) CALCULEE AU POINT
C                                   D'INTEGRATION COURANT ET RELIANT
C                                   LES DEFORMATIONS DU PREMIER ORDRE
C                                   AUX DEPLACEMENTS
C    D(NBSIG,1)     IN     R        MATRICE DE HOOKE DANS LE REPERE
C                                   GLOBAL
...
C -----  ARGUMENTS
           REAL*8        B(NBSIG,1),D(NBSIG,1),JACOB,BTDB(81,1)
C -----  VARIABLES LOCALES
           REAL*8 TAB1(10), TAB2(10)
