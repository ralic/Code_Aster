      SUBROUTINE BTDMSR(NB1,NB2,XI,KSI3S2,INTSR,XR,EPAIS,VECTPT,
...
C
      ...
      REAL*8 XI(3,*),XR(*),EPAIS,VECTPT(9,2,3)
      REAL*8 HSJ1M(3,9),HSJ1S(2,9),BTDM(4,3,42),BTDS(4,2,42)
      REAL*8 DNSDS(9,42),DNSDSM(9,42)
      REAL*8 KSI3S2
C
         L1= 44
         L2= 76
...
C
          DNSDS(3,5*NB1+1)=-XR(I3+J)/2*EPAIS*VECTPT(NB2,2,1)
          DNSDS(3,5*NB1+2)= XR(I3+J)/2*EPAIS*VECTPT(NB2,1,1)
C
...
C
          DNSDS(6,5*NB1+1)=-XR(I3+J)/2*EPAIS*VECTPT(NB2,2,2)
          DNSDS(6,5*NB1+2)= XR(I3+J)/2*EPAIS*VECTPT(NB2,1,2)
C
...
C
          DNSDS(9,5*NB1+1)=-XR(I3+J)/2*EPAIS*VECTPT(NB2,2,3)
          DNSDS(9,5*NB1+2)= XR(I3+J)/2*EPAIS*VECTPT(NB2,1,3)
C
