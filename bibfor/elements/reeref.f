     ...
     &                  NFE,DDLT,FE,DGDGL,CINEM,XE,FF,DFDI,F,EPS,GRAD)
      ...
      REAL*8       XG(3),DEPL(DDLT,NNOP),HE,FE(4),DGDGL(4,3)
      REAL*8       XE(3),FF(NNOP),DFDI(NNOP,3),F(3,3),EPS(6),GRAD(3,3)
      LOGICAL      GRAND
...
C------------FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      REAL*8      DFF(3,NBNOMX)
      REAL*8      RAC2, KRON(3,3),TMP,EPSTAB(3,3)
...
C     DÉRIVÉES DES FONCTIONS DE FORMES CLASSIQUES EN XE : DFDI
