      SUBROUTINE POSIGC(NOMTE,KLC,E,XNU,RHO,ALPHAT,SIGM)
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      COMPLEX*16 EFGE(12),SN1,SN2
      COMPLEX*16 SMFY1,SMFZ1,SMFY2,SMFZ2,SMF1,SMF2
C     ------------------------------------------------------------------
      ZERO = 0.D0
      UN = 1.D0
      DEUX = 2.D0
...
C     SIGNE DE L'EFFORT NORMAL
      ...
      SN1 = -EFGE(1)/A
      IF (DBLE(SN1).GE.ZERO .AND. DIMAG(SN1).GE.ZERO) THEN
        SGNSN1 = UN
      ELSE
        SGNSN1 = -1.D0
      END IF
      SN2 = EFGE(7)/A2
      IF (DBLE(SN2).GE.ZERO .AND. DIMAG(SN2).GE.ZERO) THEN
        SGNSN2 = UN
      ELSE
        SGNSN2 = -1.D0
      END IF
