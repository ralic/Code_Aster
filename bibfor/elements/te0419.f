...
C
      CALL HSJ1MS(ZR(JGEOM),INTE,INTSR,ZR(LZR),EPAIS,VECTG,VECTT,HSFM,
     &                                              HSS,HSJ1M,HSJ1S)
C
      CALL BTDMSR(NB1,NB2,ZR(JGEOM),KSI3S2,INTSR,ZR(LZR),EPAIS,VECTPT,
...
C
     ...
     &                                             VECTG,VECTT,HSF)
C
      CALL HSJ1F(ZR(JGEOM),INTE,INTSN,ZR(LZR),EPAIS,VECTG,VECTT,HSF,
     &                                                  KWGT,HSJ1FX,WGT)
C
      CALL BTDFN(1,NB1,NB2,ZR(JGEOM),KSI3S2,INTSN,ZR(LZR),EPAIS,VECTPT,
     &                                                      HSJ1FX,BTDF)
C
...
C
      CALL BTDMSN(1,NB1,ZR(JGEOM),INTE,INTSN,NPGSR,ZR(LZR),BTDM,BTDF,
     &                                                       BTDS,BTILD)
C
