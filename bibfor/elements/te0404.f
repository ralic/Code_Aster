...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER JCOOPG,JDFD2,JCOQU,MULTIC,IDFD2,ICOOPG
      REAL*8  DMIN,DISTIJ,XI,YI,ZII,XJ,YJ,ZJ,RBID
      REAL*8  E,NU,ALPHA,RHO,VITMAT,EPAIS
...
C     RECUPERATION DU MODULE D'YOUNG ET DE LA MASSE VOLUMIQUE
      ...
      ELSE IF (PHENOM.EQ.'ELAS_COQUE') THEN
        CALL ELREF5(' ','RIGI',NDIM,NNO,NNOS,NPG,IPOIDS,ICOOPG,IVF,
     &             IDFDE,IDFD2,JGANO)
        ...
        CALL DXMATE(DF,DM,DMF,DC,DCI,DMC,DFC,NNO,PGL,MULTIC,
