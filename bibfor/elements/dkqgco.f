      SUBROUTINE DKQGCO ( XYZL, OPTION, PGL, INIV, DEPL, CDL )
      IMPLICIT  NONE
      INTEGER       INIV
...
C ======================================================================
C     ------------------------------------------------------------------
C       DEFORMATIONS DE L'ELEMENT DE PLAQUE DKQG
C     ------------------------------------------------------------------
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8   HFT2(2,6),QSI,ETA,CARAQ4(25),JACOB(5)
      REAL*8   VT(2),T2EV(4),T2VE(4),T1VE(9)
