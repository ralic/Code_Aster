...
C - HYPO-ELASTICITE
        ...
        IF (ZK16(ICOMPO+2) (1:5).EQ.'PETIT') THEN
          ...
          CALL NMPL2G(NNO,NNOB,NPG,ZR(IPOIDS),ZR(IVF),ZR(IVFB),
     &                ZR(IDFDE),ZR(IDFDEB),ZR(IDFDK),ZR(IDFDKB),
     ...
     &                ZR(ITRAV+2*NNO+4*NNOB),ZR(ITRAV+2*NNO),
     &                ZR(ICONTP),ZR(IVARIP),
