...
C     OUT ELASCQ :
C        .TRUE. POUR UN MATERIAU ELAS_COQUE  AVEC COUPLAGE 
C         MEMBRANE-FLEXION, MEMBRANE-CISAILLEMENT ET 
C         FLEXION-CISAILLEMENT
C  ------------------------------------------------------------------
...
C          ET T2VE INVERSE DE T2EV
   ...
   10   CONTINUE
      ...
      ELSE IF (PHENOM.EQ.'ELAS') THEN
        IF (NORM.LE.R8PREM()) THEN
          CALL UTMESS('A','DXMATE','L''AXE DE REFERENCE EST NORMAL A'//
