      SUBROUTINE GDFINE (KP,NNO,PJACOB,EN,GRANI,X0SEC,ROT0,ROTK,
     &                   OMGK,OMPGK,   FINT)
...
C           X0SEC     : DERIVEE SECONDE DU DEPL. PAR RAPPORT AU TEMPS
...
C ------------------------------------------------------------------
      ...
      REAL*8 IROTT(3,3)
      REAL*8 EN(3,2),GRANI(4),X0SEC(3),ROT0(3,3),ROTK(3,3),OMGK(3),
