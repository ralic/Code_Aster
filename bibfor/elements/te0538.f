...
C ======================================================================
C
C    - FONCTION REALISEE:  CALCUL DE L'OPTION "MASS_MECA" POUR LES
C                          ELEMENTS X-FEM
C
C    - ARGUMENTS:
...
C ......................................................................
      ...
      INTEGER NFH,DDLC,NDDL,INO,NNOM,NFE,IBID,DDLS,DDLM
      LOGICAL LTEATT
      REAL*8  R8BID
...
C - PARAMETRES EN ENTREE
      ...
      CALL XMASEL(NNO,IPOIDS,IVF,NFH*NDIM,NFE,DDLC,IGEOM,TYPMOD,
     &            NOMTE,ZI(IMATE),LGPG,ZR(JPINTT),
     &            ZI(JCNSET),ZI(JHEAVT), ZI(JLONCH),ZR(JBASLO),
     &            ZR(JLSN),ZR(JLST),ZR(IMATUU),CODRET)
