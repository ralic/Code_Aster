...
C     VARIABLES LOCALES
      ...
      INTEGER NNO,NPG,NBCOU,NBSEC,M,ICARAC,INO,I1,N
      INTEGER IPOIDS,IVF,IBLOC,ICOLON
      INTEGER IMATE,ITEMP,ICAGEP,IGEOM,NBPAR,ICOUD2,MMT,ITAB(8)
      INTEGER IGAU,ICOU,ISECT,I,J,IFF,LORIEN,IMASS
      INTEGER IXF,NPG1,NPG2,JNBSPI,IRET
...
C        ON INTEGRE FINEMENT POUR LA MATRICE DE MASSE
...
C                        IF(ICOUDE.EQ.1) FI = FI - OMEGA
  ...
  140 CONTINUE
      ...
      IF (ICOUDE.EQ.0) THEN
        CALL KLG(NNO,NBRDDL,PGL,MASS,PASS,KTEMP)
      ELSE IF (ICOUDE.EQ.1) THEN
        CALL KLGCOU(NNO,NBRDDL,PGL1,PGL2,PGL3,PGL4,MASS,PASS,KTEMP)
      END IF
