...
C MODIF ELEMENTS  DATE 03/03/97   AUTEUR BIBERON G.ROUSSEAU 
C ======================================================================
...
C...................................................................
      ...
      REAL*8             SX(9,9),SY(9,9),SZ(9,9),UNI2N(3,9),N2N(9)
...
C            WRITE(8,*)'SX(',INO,JNO,')=',SX(INO,JNO)
C            WRITE(8,*)'SY(',INO,JNO,')=',SY(INO,JNO)
C            WRITE(8,*)'SZ(',INO,JNO,')=',SZ(INO,JNO)
