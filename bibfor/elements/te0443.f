...
C     ---------------------------------------
      IF (OPTION.EQ.'REPE_TENS' ) THEN
        CALL VDSIRO(NP,NBSP,MATVN1,'UI','N',ZR(JIN),ZR(JCONIN))
      ELSE IF (OPTION.EQ.'REPE_GENE' ) THEN
        CALL VDEFRO(NP,MATVN1,ZR(JIN),ZR(JCONIN))
      ENDIF
C
...
C       ---------------------------------------
      IF (OPTION.EQ.'REPE_TENS' ) THEN
        IF (PAIN(4:5).EQ.'NO') THEN
          CALL VDSIRO(NP,NBSP,MATVN2,'IU','N',ZR(JCONIN),ZR(JOUT))
        ELSE IF (PAIN(4:5).EQ.'GA') THEN
          CALL VDSIRO(NP,NBSP,MATVG2,'IU','G',ZR(JCONIN),ZR(JOUT))
        ENDIF
      ELSE IF (OPTION.EQ.'REPE_GENE' ) THEN
        IF (PAIN(4:5).EQ.'NO') THEN
          CALL VDEFRO(NP,MATVN2,ZR(JCONIN),ZR(JOUT))
        ELSE IF (PAIN(4:5).EQ.'GA') THEN
          CALL VDEFRO(NP,MATVG2,ZR(JCONIN),ZR(JOUT))
        ENDIF
      ENDIF
