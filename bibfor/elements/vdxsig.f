...
C
        ...
        IF (INDITH.EQ.0) THEN
            ...
            P2XI3=-XI3*(1-XI3)/2.D0
            P3XI3= XI3*(1+XI3)/2.D0
            CALL RCVARC('F','TEMP','+','RIGI',INTSN,1,TINF,
     &                  IRET)
            CALL RCVARC('F','TEMP','+','RIGI',INTSN,IMOY,TMOY,
     &                  IRET)
            CALL RCVARC('F','TEMP','+','RIGI',INTSN,3*NBCOU,TSUP,
     &                  IRET)
            TEMPGA(KWGT)=TMOY*P1XI3+TINF*P2XI3+TSUP*P3XI3
            TEMPGA(KWGT)=TEMPGA(KWGT)-TREF
        ENDIF
