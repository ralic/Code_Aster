...
C     (ET LE NOEUD MILIEU INC EN QUADRATIQUE)
        VECDIR(1)=ZR(JBASNO-1+6*(INA-1)+1)
        VECDIR(2)=ZR(JBASNO-1+6*(INA-1)+2)
        VECDIR(3)=ZR(JBASNO-1+6*(INA-1)+3)

        CALL FONNO7(NOMA,NDIM,NA,VECDIR,HMAX)
...
C     POUR LE DERNIER NOEUD
      IF (NDIM.EQ.3) THEN
          ...
          VECDIR(1)=ZR(JBASNO-1+6*(INB-1)+1)
          VECDIR(2)=ZR(JBASNO-1+6*(INB-1)+2)
          VECDIR(3)=ZR(JBASNO-1+6*(INB-1)+3)

          CALL FONNO7(NOMA,NDIM,NB,VECDIR,HMAX)
