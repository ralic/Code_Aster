...
C
      ...
      REAL*8  A   , AI , XIY , XIZ , ALFAY , ALFAZ  , XL
      REAL*8  A2  , AI2, XIY2, XIZ2, ALFAY2, ALFAZ2
C     ------------------------------------------------------------------
      C1     = 1.D0
      C2     = 2.D0
C     ------------------------------------------------------------------
...
C     --- RECUPERATION DES CARACTERISTIQUES MATERIAUX ---
 ...
 10   CONTINUE
      ...
      POUM='+'
C
      CALL RCVALB(FAMI,KPG,SPT,POUM,ZI(LMATER),' ','ELAS',NBPAR,NOMPAR,
...
C
      ...
      NOMRES(1) = 'RHO'
      NOMRES(2) = 'CELE_R'
      CALL RCVALB(FAMI,KPG,SPT,POUM,ZI(LMATER),' ','FLUIDE',NBPAR,
