...
C
      ...
      IF (OPTION.EQ.'MASS_INER')   THEN
         IF (INFODI.EQ.1) THEN
            CALL JEVECH ('PCADISM' ,'L',LMASS1 )
         ELSEIF (INFODI.EQ.2) THEN
            CALL JEVECH ('PCADNSM' ,'L',LMASS2 )
         END IF
...
C
         IF ( NOMTE. EQ. 'MECA_DIS_T_N' ) THEN
            ...
            NC  = 3
            N   = 6
            IF ( ZR(LMASS1+N) .EQ. 2 ) THEN
               CALL UTPSLG ( NNO, NC, PGL, ZR(LMASS1), MAT1 )
            ELSE
               DO 10 I = 1 , N
                  MAT1(I) = ZR(LMASS1+I-1)
 10            CONTINUE
            ENDIF
C
C           --- MASSE ---
...
C
            ...
            NC  = 3
            N   = 9
            IF ( ZR(LMASS2+N) .EQ. 2 ) THEN
               CALL UTPPLG ( NNO, NC, PGL, ZR(LMASS2), MAT2 )
            ELSE
               DO 11 I = 1 , N
                  MAT2(I) = ZR(LMASS2+I-1)
 11            CONTINUE
            ENDIF
C
C           --- MASSE ---
...
C
         ELSEIF ( NOMTE. EQ. 'MECA_2D_DIS_T_N' ) THEN
            ...
            N   = 3
            IF ( ZR(LMASS1+N) .EQ. 2 ) THEN
               CALL UT2MLG ( NNO, NC, PGL, ZR(LMASS1), MAT1 )
            ELSE
               DO 14 I = 1 , N
                  MAT1(I) = ZR(LMASS1+I-1)
 14            CONTINUE
...
C
            ...
            N   = 4
            IF ( ZR(LMASS2+N) .EQ. 2 ) THEN
               CALL UT2PLG ( NNO, NC, PGL, ZR(LMASS2), MAT2 )
            ELSE
               DO 16 I = 1 , N
                  MAT2(I) = ZR(LMASS2+I-1)
 16            CONTINUE
