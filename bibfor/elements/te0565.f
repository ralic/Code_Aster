...
C ----------------------------------------------------------------------
      ...
      REAL*8 POIDS,UP(3,27),UE(3,27)
      INTEGER JGANO,NNO,KP,I,IRET,IDEPLP,IDEPLE,IALPHA,IRET1
