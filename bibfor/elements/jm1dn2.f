...
C                 J1DN2 ( 9 ,  6 * NB1  + 3 ) =
C
C                 JTILD ( 9 , 9 ) * DNDQSI2  ( 9 ,  6 * NB1  + 3 ) 
C
C                 POUR LA PARTIE MATERIELLE DE LA RIGIDITE GEOMETRIQUE
C
...
C
      CALL VALFOR ( INDN , INDC , LT1 , LT2 , L1 , L2 , L3 )
C
...
C
     ...
     &                 TMPI )
C
C------- REMPLISSAGE DE J1DN2 ( 9 , 6 * NB1 + 3 ) 
C
...
C
C---------- BLOC U      0      TMPZI   -TMPYI  
C
            J1DN2( 1 , (JN-1) * 6 + 5 )=   TMPI ( 1 )* VECNPH ( JN , 3 )
            J1DN2( 2 , (JN-1) * 6 + 5 )=   TMPI ( 2 )* VECNPH ( JN , 3 )
            J1DN2( 3 , (JN-1) * 6 + 5 )=   TMPI ( 3 )* VECNPH ( JN , 3 )
C
            J1DN2( 1 , (JN-1) * 6 + 6 )= - TMPI ( 1 )* VECNPH ( JN , 2 )
            J1DN2( 2 , (JN-1) * 6 + 6 )= - TMPI ( 2 )* VECNPH ( JN , 2 )
            J1DN2( 3 , (JN-1) * 6 + 6 )= - TMPI ( 3 )* VECNPH ( JN , 2 )
C
C---------- BLOC V     - TMPZI 0        TMPXI 
C
            J1DN2( 4 , (JN-1) * 6 + 4 )= - TMPI ( 1 )* VECNPH ( JN , 3 )
            J1DN2( 5 , (JN-1) * 6 + 4 )= - TMPI ( 2 )* VECNPH ( JN , 3 )
            J1DN2( 6 , (JN-1) * 6 + 4 )= - TMPI ( 3 )* VECNPH ( JN , 3 )
C
            J1DN2( 4 , (JN-1) * 6 + 6 )=   TMPI ( 1 )* VECNPH ( JN , 1 )
            J1DN2( 5 , (JN-1) * 6 + 6 )=   TMPI ( 2 )* VECNPH ( JN , 1 )
            J1DN2( 6 , (JN-1) * 6 + 6 )=   TMPI ( 3 )* VECNPH ( JN , 1 )
C
C---------- BLOC W       TMPY  -TMPXI   0
C
            J1DN2( 7 , (JN-1) * 6 + 4 )=   TMPI ( 1 )* VECNPH ( JN , 2 )
            J1DN2( 8 , (JN-1) * 6 + 4 )=   TMPI ( 2 )* VECNPH ( JN , 2 )
            J1DN2( 9 , (JN-1) * 6 + 4 )=   TMPI ( 3 )* VECNPH ( JN , 2 )
C
            J1DN2( 7 , (JN-1) * 6 + 5 )= - TMPI ( 1 )* VECNPH ( JN , 1 )
            J1DN2( 8 , (JN-1) * 6 + 5 )= - TMPI ( 2 )* VECNPH ( JN , 1 )
            J1DN2( 9 , (JN-1) * 6 + 5 )= - TMPI ( 3 )* VECNPH ( JN , 1 )
C
C
...
C
            J1DN2( 1 ,  NB1 * 6   + 3 )= - TMPI ( 1 )* VECNPH ( JN , 2 )
            J1DN2( 2 ,  NB1 * 6   + 3 )= - TMPI ( 2 )* VECNPH ( JN , 2 )
            J1DN2( 3 ,  NB1 * 6   + 3 )= - TMPI ( 3 )* VECNPH ( JN , 2 )
C
C---------- BLOC V     - TMPZI 0        TMPXI 
C
            J1DN2( 4 ,  NB1 * 6   + 1 )= - TMPI ( 1 )* VECNPH ( JN , 3 )
            J1DN2( 5 ,  NB1 * 6   + 1 )= - TMPI ( 2 )* VECNPH ( JN , 3 )
            J1DN2( 6 ,  NB1 * 6   + 1 )= - TMPI ( 3 )* VECNPH ( JN , 3 )
C
...
C
            J1DN2( 7 ,  NB1 * 6   + 2 )= - TMPI ( 1 )* VECNPH ( JN , 1 )
            J1DN2( 8 ,  NB1 * 6   + 2 )= - TMPI ( 2 )* VECNPH ( JN , 1 )
            J1DN2( 9 ,  NB1 * 6   + 2 )= - TMPI ( 3 )* VECNPH ( JN , 1 )
C
       ENDIF
C
 100    CONTINUE
