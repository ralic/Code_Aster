...
C DECLARATION VARIABLES LOCALES
      ...
      INTEGER ICOMP,IGEOM,ITEMPS,IDEPL,ITEMP,IMATE
      ...
      REAL*8 THET,TREF,TG(27),TGD(20),TGDM(3),DUDMDE(3),FLAG(3)
...
C
     ...
     &           +(DE+2.D0*E*DNU/NU1M)*TRADE)
          TERM6 = ((3.D0*ALPHA*(TG(KP)-TREF))/NU1M)*
     &             (ALPHA + DALPHA*(TG(KP)-TREF) + ALPHA*(TG(KP)-TREF)
     &             *DNU/NU1M)
