...
C     --- RECUPERATION DES CARACTERISTIQUES DES FIBRES :
      ...
      IF (OPTION.EQ.'EPSI_ELGA') THEN
         CALL TECACH('OON','PDEFOPG','E',7,JTAB,IRET)
         JCONT = JTAB(1)
      ELSE IF (OPTION.EQ.'SIEF_ELGA') THEN
         CALL JEVECH('PMATERC','L',IMATE)
         CALL TECACH('OON','PCONTRR','E',7,JTAB,IRET)
         JCONT = JTAB(1)
...
C     RAPPEL : LES EFFORTS SONT CALCULES AU MILIEU DES DEUX POINTS DE
C     GAUSS ET STOQUES DANS LE PREMIER POINT, IL FAUDRA CHANGER CELA
