...
C     PROPRE AUX ELEMENTS 1D ET 2D (QUADRATIQUES)
     ...
     & .OR.ENR.EQ.'XHC'.OR.ENR.EQ.'XHT'.OR.ENR.EQ.'XT')
     & .AND. NDIM.LE.2) CALL JEVECH('PPMILTO','L',JPMILT)
...
C
      ...
      CALL RCVALB(FAMI,1,1,'+',ZI(IMATE),' ',PHENOM,0,' ',0.D0,1,
     &              'RHO',RHO,CODRHO,0)
C
...
C       BOUCLE SUR LES SOMMETS DU SOUS-TRIA (DU SOUS-SEG)
 ...
 111    CONTINUE
     ...
     &              DDLC,DDLM,NFE,RHO,PULS,LMODA,ZR(JBASLO),NNOP,IDEPL,
