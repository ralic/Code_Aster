...
C
C     BUT:
C         CALCUL DE L'INDICATEUR D'ERREUR SUR UN ELEMENT 3D
...
C
      ...
      INTEGER INOV,IMAV,JKP,NOE(9,6,3),IPGF,NDI
...
C
        CALL ERE3D1(NNO,IPG,IVF,IAD,NBCMP,DFDX,DFDY,DFDZ,POIDS,
     &              DSX,DSY,DSZ,NOR)
C
...
C
            CALL ERE3D3(NOE,IFA,ITYP,IREF1,IREF2,IVOIS,IGEOM,IAD,
...
C
          CALL ERE3D2(NOE,IFA,ITYP,NBNV,NPGB,IREF1,IVOIS,IAD,NBCMP,
