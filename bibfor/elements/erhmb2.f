...
C
          ELSE
            CALL UTMESS('F',NOMPRO,'BIZARRE : '//NOMGD2)
          ENDIF
C
C 2.2.4. ERREUR
C
        ELSE
          CALL UTMESS('F',NOMPRO,'ON NE SAIT PAS TRAITER : '//NOMGD2)
        ENDIF
C
C --------------------------------------------------------------------
...
C
          ELSE
            CALL UTMESS('F',NOMPRO,'BIZARRE : '//NOMGD3)
          ENDIF
C
C 3.2.4. ERREUR
C
        ELSE
          CALL UTMESS('F',NOMPRO,'ON NE SAIT PAS TRAITER : '//NOMGD3)
        ENDIF
C
C --------------------------------------------------------------------
