      SUBROUTINE INI100(NOMTE,CODE,NMAX,ITABL,K24TAB,NVAL)
...
C OUT NVAL  : NVAL EST LE NOMBRE D'OBJETS CREES PAR INI0IJ C
...
C.......................................................................
     ...
     &              ICOPG,I,J,KK,IDER,IDPDX2,IDPDY2,IDPDZ2,
...
C       --->       INTEGRATION SELON Z
        NPG2(2,2) = 3
C
      ELSE IF(NOMTE(11:15).EQ.'HEXA8') THEN
        NNO1 = 8
        NNO2 = 8
        ALIAS = 'HEXA8'
        NPG1(1,1) = 2
...
C --- PLACE MEMOIRE POUR COORDONNEES DES DIFFERENTS POINTS DE GAUSS ---
     ...
     +           NPG2(2,1)*NPG2(2,1)*NPG2(2,2) )
      CALL WKVECT('&&INI021.FFT','V V R',LFFT,IFFT)
C     --------------------------------------------
...
C
 400   CONTINUE
C
      CALL JEDETR ('&&INI021.FFT')
C
9998  CONTINUE


      NVAL = 2
      IF (NMAX.LT.NVAL) THEN
        NVAL = -NVAL
      ELSE
        K24TAB(1) = CARAC
        K24TAB(2) = FF
