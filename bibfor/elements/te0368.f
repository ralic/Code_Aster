...
C
      ...
      INTEGER IVOIS,IAREPE,JCELD,JCELV
      INTEGER JAD,JADV,IGREL,IEL,NCMPM1,NBNV,NCHER
      INTEGER NBCMP,ITABP(7),ITABD(7),IBID,IPP,IRP,IPD,IRD
      INTEGER INOV,IMAV,JKP,NOE(9,6,3),IPGF,NDI,IS
      ...
      REAL*8 ERREST,NOR,SIGCAL,NUEST,COEFF
      ...
      CHARACTER*2 CODRET
      CHARACTER*8 TYPMAV,ELREFE,ELREF2,PRF,FXF,FYF,FZF
      CHARACTER*16 PHENOM,K16BID
...
C
        CALL ERE3D1(NNO,IPG,IVF,IADP,NBCMP,DFDX,DFDY,DFDZ,POIDS,
     &              DSPX,DSPY,DSPZ,R8BID)
C
C ------- CALCUL DE LA DIVERGENCE ET DE LA NORME DE SIGMA PB. DUAL -----
C
        CALL ERE3D1(NNO,IPG,IVF,IADD,NBCMP,DFDX,DFDY,DFDZ,POIDS,
...
C
            CALL ERE3D3(NOE,IFA,ITYP,IREFD1,IREFD2,IVOIS,IGEOM,IADD,
...
C
          CALL ERE3D2(NOE,IFA,ITYP,NBNV,NPGF,IREFP1,IVOIS,IADP,NBCMP,
     &                SGP11,SGP22,SGP33,SGP12,SGP13,SGP23)
C
C ------- CALCUL DU SAUT DE CONTRAINTE ENTRE ELEMENTS PB. DUAL ---------
C
          CALL ERE3D2(NOE,IFA,ITYP,NBNV,NPGF,IREFD1,IVOIS,IADD,NBCMP,
