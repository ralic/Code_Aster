      SUBROUTINE ANGCO4(COOR,ZK1,IZK,ICOUDE,ZK2,RAYON,THETA,NNO,
...
1     CONTINUE
       ...
       CALL ANGCOU(COOR3,ZKINI,IZK,ICOUD1,ZK4,RAYON1,THETA1,NNO,
...
2     CONTINUE
       ...
       CALL ANGCOU(COOR3,ZKINI,IZK,ICOUD2,ZK2,RAYON2,THETA2,NNO,
...
3     CONTINUE
     ...
     &              ( COO1(3)-COO2(3) )**2 )
      ...
      IF (ABS(RAYON2-RAYON1).GT.TEST) THEN
         CALL UTMESS('F','ANGCOU','ABS(RAYON2-RAYON1).GT.EPSI')
      ELSE
         RAYON=RAYON2
      ENDIF
      ...
      IF (ABS(THETA2-THETA1).GT.TEST) THEN
         CALL UTMESS('F','ANGCOU','ABS(THETA2-THETA1).GT.EPSI')
      ELSE
         THETA=1.5D0*THETA1
      ENDIF
      ...
      IF (ABS(OMEGA2-OMEGA1).GT.TEST) THEN
         CALL UTMESS('F','ANGCOU','ABS(OMEGA2-OMEGA1).GT.EPSI')
      ELSE
         OMEGA=OMEGA1
      ENDIF
      END
