...
C-----------------------------------------------------------------------
C     BUT : CALCUL DES OPTIONS NON LINEAIRES DES ELEMENTS DE JOINT ET
C           JOINT_HYME
...
C TYPE DE MODELISATION
      ...
      IF (LTEATT(NOMTE,'TYPMOD2','ELEMJOIN')) THEN
        TYPMOD(2) = 'ELEMJOIN'
      ELSEIF (LTEATT(NOMTE,'TYPMOD2','EJ_HYME')) THEN
        TYPMOD(2) = 'EJ_HYME'
      ELSE
C       MODELISATION NON SUPORTEE
        CALL ASSERT(TYPMOD(2).EQ.'ELEMJOIN'.OR.
     &              TYPMOD(2).EQ.'EJ_HYME')
      END IF
