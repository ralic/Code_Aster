...
C------------FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      INTEGER ICONTP,IVECT,IMATR,IU(3,16),IP(4)
      INTEGER KK,I,J,IVARIM,IVARIP,JTAB(7),IRET,IINSTM,IINSTP
      INTEGER LGPG1,LGPG
      CHARACTER*8 TYPMOD(2),LIELRF(10)
      LOGICAL LTEATT,RESI,RIGI,AXI
...
C CALCUL DES CONTRAINTES, VIP, FORCES INTERNES ET MATR TANG ELEMENTAIRES
     ...
     &            ZR(IGEOM),ZR(IDDLM),ZR(IDDLD),IU,IP,ZR(ICONTP),
     &            ZR(IVECT),ZR(IMATR),ZR(IVARIM),ZR(IVARIP),
     &            ZR(IINSTM),ZR(IINSTP),ZR(ICARCR),ZK16(ICOMP),
     &            TYPMOD)
