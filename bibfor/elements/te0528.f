...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
     ...
     &        IDEF,ICOMPO,NBVARI,IVARI,K,
     &        JTAB(7),IRET,ITEMPE,IMATE,ITEMPS
      PARAMETER (MXCMEL=162)
      PARAMETER (NBSGM=6)
      REAL*8 EPSFL(MXCMEL),EPSFLN(MXCMEL),EPSTMP(NBSGM)
      REAL*8 VALPAR(2),NU,TEMPG
      CHARACTER*2 CODRET
      CHARACTER*8 NOMRES,NOMPAR(2),MODELI
...
C        -----------------------
        CALL PPGAN2(JGANO,NBSIG,EPSFL,EPSFLN)
