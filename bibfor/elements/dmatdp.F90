subroutine dmatdp(fami, mater, instan, poum, igau,&
                  isgau, repere, d)
! ======================================================================
...
!.======================================================================
!
!      DMATDP --   CALCUL DE LA MATRICE DE HOOKE POUR LES ELEMENTS
!                  MASSIFS 2D EN DEFORMATIONS PLANES OU AXISYMETRIQUES
...
!
    ...
    real(kind=8) :: zero, undemi, un, deux, c10, c01, c20, k
    real(kind=8) :: e, e1, e2, e3, coef, coef1, coef2, coef3, c1, delta, g
