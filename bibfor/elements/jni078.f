      SUBROUTINE JNI078(ELREFE,NMAXOB,LIOBJ,NBOBJ)
      IMPLICIT NONE
      CHARACTER*8 ELREFE
C ----------------------------------------------------------------------
...
C --------- FIN DECLARATIONS NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER NNO,IRET,NDIM,NNOS,NBFPG
      INTEGER NBPG(27),NMAXOB,NBOBJ,ITRAV
      REAL*8 X(3*27)
...
C DEB ------------------------------------------------------------------
     ...
     &              NBPG(1)+ (133+36*NNO)*NNO,ITRAV)
        CALL INIOB1(NDIM,NNO,NNOS,NBFPG,ELREFE,X,NBPG)

      ELSE
        CALL UTMESS('F','INI078','ELREFE NON PREVU '//ELREFE)
      END IF
