...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      IF (NNO.GT.9) CALL U2MESS('F','ELEMENTS3_24')
...
C -- TYPE DE MODELISATION
      ...
      IF (NOMTE(1:2).EQ.'MI') THEN
        CALL U2MESS('F','ELEMENTS4_24')
      END IF
      IF (TYPMOD(1).EQ.'C_PLAN  ') THEN
        CALL U2MESS('F','ELEMENTS4_25')
      ENDIF
