...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
      ...
      REAL*8        BETA,DBETA,LAMBDA,THETA,DELTAT,TPG,R8BID,DFDX(27),
     &              DFDY(27),DFDZ(27),POIDS,DTPGDX,DTPGDY,DTPGDZ,LAMBS,
     &              CPS,DTPGMX,DTPGMY,DTPGMZ,DTPGPX,DTPGPY,DTPGPZ,
     &              TEMS,DLAMBD,FLUXS(3),PREC,R8PREM,TPGM,TPGBUF
      INTEGER       IPOIDS,IVF,IDFDE,IDFDN,IDFDK,IGEOM,IMATE,ITEMP,NNO,
     &              KP,NPG1,I,K,L,IFON(3),JIN,JVAL,NDIM,NPG,ICOMP,
     &              IVECTT,IVECTI,ITEMPS,IMATSE,IVAPRI,IVAPRM,IFONS(3),
     &              TETYPS,IFM,NIV
      LOGICAL       LSENS,LSTAT
