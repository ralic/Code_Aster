      SUBROUTINE DICOUL(FAMI,OPTION,NNO,NBT,NEQ,NC,ICODMA,ULM,
     &                  DUL,SIM,TP,VARIM,PGL,KLV,VARIP,FONO,SIP,
     &                  IRRAP)
C ----------------------------------------------------------------------
      IMPLICIT NONE
      INTEGER NBT,NEQ,ICODMA,NC,JTAB(7)
...
C ***************** FIN COMMUNS NORMALISES JEVEUX **********************
      ...
      REAL*8 ET,DUT,PM,DUN,SIELEQ,DP,RP,TEMPP,TEMPM
...
C ---    SURCHARGE DE LA RIGIDITE EN ROTATION
      ...
      IF (NC.GT.3) THEN
        ...
        ELSE IF (CODANG.EQ.'OK') THEN
           CALL RCMOM2 (FAMI,NNO,ICODMA,IRRAP, VALE,CP,ITRAC )
        ENDIF
