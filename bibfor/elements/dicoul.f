...
C --- DIRECTION LOCALE Z
     ...
     &              RPRIMZ,CPRAGM,RBID,RBID)
        ...
        ELSE
          ...
          NU = 0.D0
          SIEEQZ = ABS(MOPESZ)
          CALL RCFON2('E',JPROLP,JVALEP,NBVALP,RBID,CPMOD,NU,PMZ,RPZ,
     &                RPRIMZ,CPRAGM,SIEEQZ,DPZ)
...
C --- DIRECTION LOCALE X
        ...
        CALL RCFON2('V',JPROLP,JVALEP,NBVALP,RBID,RBID,RBID,PMX,RPX,
     &              RPRIMX,CPRAGM,RBID,RBID)
