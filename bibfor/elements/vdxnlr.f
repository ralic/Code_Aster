...
C     CALCUL DE BTDMR, BTDSR : M=MEMBRANE , S=CISAILLEMENT , R=REDUIT
     ...
     +                  VECTT,HSFM,HSS)
            ...
            CALL HSJ1MS(XI,INTE,INTSR,ZR(LZR),HIC,VECTG,VECTT,HSFM,HSS,
     +                  HSJ1M,HSJ1S)

            CALL BTDMSR(NB1,NB2,XI,KSI3S2,INTSR,ZR(LZR),HIC,VECTPT,
...
C                          (NORMAL) ET DU DETERMINANT DU JACOBIEN
     ...
     +                 VECTT,HSF)
            ...
            CALL HSJ1F(XI,INTE,INTSN,ZR(LZR),HIC,VECTG,VECTT,HSF,KWGT,
     +                 HSJ1FX,WGT)
...
C     PRODUIT DU POIDS DES PTS DE GAUSS DANS L'EPAISSEUR ET DE WGT
            ...
            CALL BTDFN(1,NB1,NB2,XI,KSI3S2,INTSN,ZR(LZR),HIC,VECTPT,
     +                 HSJ1FX,BTDF)
...
C     FORMATION DE BTILD
            ...
            CALL BTDMSN(1,NB1,XI,INTE,INTSN,NPGSR,ZR(LZR),BTDM,BTDF,
     +                  BTDS,BTILD)
...
C     EXPANSION DE LA MATRICE : AJOUTER DE LA ROTATION FICTIVE
        ...
        NDDLET = 6*NB1 + 3
        CALL MATRKB(NB1,42,NDDLE,51,NDDLET,KTILD,CTOR,RIG,COEF)
        ZR(LZR-1+1550) = COEF
