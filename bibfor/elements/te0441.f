...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER I,J,KK,NDIM,NNO,NNOP,NNOS,NNOM,NDDL,NPG,SINGU,IRET,IBID
      INTEGER DDLH,DDLS,NFE,DDLC,NIT,CPT,IT,NSE,ISE,IN,INO
      INTEGER JPINTT,JCNSET,JHEAVT,JLONCH,JLSN,JLST,JCOORS,JSTNO
      INTEGER IVECTU,ITEMPS,IGEOM,IDECPG,IROTA,IPESA,IMATE,NSEMAX(3)
      REAL*8  HE,RBID,FNO(81),RHO,OM,OMO
      CHARACTER*2   CODRET(3)
      CHARACTER*8   ELREFP,ELRESE(3),FAMI(3),LAG
      CHARACTER*16  PHENOM
      CHARACTER*24  COORSE
      LOGICAL FOGA,FONC,LBID
      DATA    NSEMAX / 2 , 3 , 6 /
...
C         POSITION DANS LA FAMILLE 'XFEM' DU 1ER PG DU SE COURANT
          ...
          CALL XPESRO(ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,NFE,
...
C     SUPPRESSION DES DDLS SUPERFLUS
     ...
     &            .FALSE.,LBID,OPTION,NOMTE,RBID,ZR(IVECTU))
