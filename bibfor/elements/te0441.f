...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER I,J,KK,NDIM,NNO,NNOP,NNOPS,NNOS,NNOM,NDDL,NPG,SINGU,IRET
      INTEGER DDLH,DDLS,NFE,DDLC,NIT,CPT,IT,NSE,ISE,IN,INO,IBID,DDLM
