...
!  EST CONSTRUITE SUR LES 3 POINTS D'INTÈGRATION PAR COUCHE UTILISÈS EN
!  NON LINÈAIRE, ALORS QU'EN LINÈAIRE, IL N'Y A QUE 2 POINTS.
!  IL FAUDRAIT DONC SOIT METTRE 3 POINTS EN LINÈAIRE, SOIT CHANGER LE
!  PASSAGE GAUSS NOEUDS EN NON LINÈAIRE ET EN LINÈAIRE.
