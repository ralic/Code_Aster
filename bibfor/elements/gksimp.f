...
C- IMPRESSION DU TAUX DE RESTITUTION D ENERGIE G
      ...
      IF ( NUMERO .NE. 1 ) THEN
        ...
        WRITE(UNIT,*)
        DO 20 I=1,NNOFF
          WRITE(UNIT,110) I,ZR(IADGKI-1+(I-1)*4+1)
20      CONTINUE
        WRITE(UNIT,*)
      ENDIF
C
      IF ( (NUMERO.EQ.1) .OR. (NUMERO.EQ.2) ) THEN
        ...
        DO 10 I=1,NDEG+1
           I1 = I-1
           WRITE(UNIT,*) 'DEGRE ',I1,' : ',ZR(IADGKI-1+I1*4+1)
10      CONTINUE
        WRITE(UNIT,*)
      ENDIF
C
      ...
      WRITE(UNIT,*)
      DO 30 I=1,NNOFF
         WRITE(UNIT,111) ABSC(I), ZR(IADGKS-1+(I-1)*4+1)
30    CONTINUE
      WRITE(UNIT,*)
C
...
C- IMPRESSION DES FACTEURS D INTENSITE DE CONTRAINTE K
      ...
      DO 40 IMOD=1,3
        ...
        IF ( NUMERO .NE. 1 ) THEN
          ...
          WRITE(UNIT,*)
          DO 401 I=1,NNOFF
            WRITE(UNIT,110) I,ZR(IADGKI-1+(I-1)*4+IMOD+1)
401        CONTINUE
          WRITE(UNIT,*)
        ...
        IF ( (NUMERO.EQ.1) .OR. (NUMERO.EQ.2) ) THEN
          ...
          DO 41 I=1,NDEG+1
            I1 = I-1
            WRITE(UNIT,*) 'DEGRE ',I1,' : ',ZR(IADGKI-1+I1*4+IMOD+1)
41        CONTINUE
          WRITE(UNIT,*)
        ENDIF
        ...
        WRITE(UNIT,*)
        DO 42 I=1,NNOFF
           WRITE(UNIT,111) ABSC(I), ZR(IADGKS-1+(I-1)*4+IMOD+1)
42      CONTINUE
        WRITE(UNIT,*)
40    CONTINUE
