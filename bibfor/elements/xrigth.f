      SUBROUTINE XRIGTH(NDIM,ELREFP,NNOP,IMATE,ITEMPS,IGEOM,LONCH,CNSET,
...
C     BUT: MATRICE DE RIGIDITE ELEMENTAIRE EN THERMIQUE LINEAIRE
...
C OUT :
C ----
C MATTT  --> MATRICE DE RIGIDITE ELEMENTAIRE
C.......................................................................
      INCLUDE 'jeveux.h'
C-----------------------------------------------------------------------
C
...
C-----------------------------------------------------------------------
C
      CHARACTER*8  ELRESE(3),FAMI(3),POUM
      CHARACTER*16 PHENOM
      LOGICAL AXI,LTEATT
      REAL*8  BASLOG(3*NDIM),TEM,LSNG,LSTG,COORSE(81),XG(NDIM),XE(NDIM)
      REAL*8  FEMEC(4),DGDMEC(4,NDIM),FETH,FF(NNOP),DFDI(NNOP,NDIM),HE
      REAL*8  FFENR(NNOP,1+NFH+NFE),DELTAT,VALPAR(1),VALRES(1),LAMBDA,R
      REAL*8  JAC,THETA,DGDTH(NDIM),DFFENR(NNOP,1+NFH+NFE,NDIM),PDSCAL
      INTEGER IVF,KPG,IBID,NNO,NPG,J,IRET,NSE,ISE,INP,IN,INO,KDDL,NBDDL
      INTEGER MXSTAC,ICODRE,SPT,IPOIDS,IDFDE,NOSEMA,IND1,LDDL,JNP,IDDLMA
      INTEGER IDIM,IND2
C
...
C         RECUPERER LES PARAMETRES MATERIAUX
     ...
     &                1,'INST',VALPAR,1,'LAMBDA',VALRES,ICODRE,1)
          LAMBDA = VALRES(1)
C
...
C           DDL CRACK-TIP (E1)
 ...
 1250     CONTINUE
C
C ------- REMPLISSAGE DE LA MATRICE DE RIGIDITE
C
          DO 1270 INP=1,NNOP
C
...
C                 ON NE DEPASSE PAS PAS LA DIAGONALE
                  IF (LDDL.LE.IDDLMA) THEN
                    PDSCAL = 0.D0
                    DO 1274 IDIM=1,NDIM
                      PDSCAL = PDSCAL + DFFENR(INP,KDDL,IDIM)
     &                                * DFFENR(JNP,LDDL,IDIM)
 1274               CONTINUE
