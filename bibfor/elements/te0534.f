...
C     INCRÉMENT DE DÉP DEPUIS L'ÉQUILIBRE PRÉCÉDENT (DEPDEL) : 'PDEPL_P'
...
C     RÉCUPÉRATION DE LA BASE COVARIANTE AUX POINTS D'INTERSECTION
 ...
 13   CONTINUE
C
C     REACTUALISATION DE LA GEOMETRIE AVEC DEPMOI : IGEOM=IGEOM+IDEPMOI
C     CA NE SERT À RIEN EN PETITS DÉPLACEMENTS
      DO 20 I = 1,NNO       
...
C           SI PAS DE CONTACT POUR CE PG : ON REMPLIT QUE LN3
            IF (INDCO(ISSPG).EQ.0) THEN
              ...
              DO 170 I = 1,NNOF
                ...
                CALL PSCAL(3,TAU1(1,NLI),REAC12,METR(1))
...
C             TERME LN3
              DO 190 I = 1,NNOF
                ...
                CALL PSCAL(3,TAU1(1,NLI),RPB,METR(1))
                CALL PSCAL(3,TAU2(1,NLI),RPB,METR(2))
...
C             SI INDCO N'EST NI ÉGAL À 0 NI ÉGAL À 1
          ...
          ELSE
C           SI OPTION NI 'CHAR_MECA_CONT' NI 'CHAR_MECA_FROTT'
