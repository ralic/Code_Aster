...
C -- PARTIE ELASTIQUE DU COMPORTEMENT (TEMPERATURE MOINS)
      CALL MATELA(ICDMAT,MATERI,1,TEMPM,EM,NU,ALPHAM)
      CALL MATELA(ICDMAT,MATERI,1,TEMPP,EP,NU,ALPHAP)
...
C ---   BOUCLE COMPORTEMENT SUR CHAQUE FIBRE
        DO 20 I = 1,NF
          IVARI = NBVALC* (I-1) + 1
          CALL NMCB1D(EP,Y01,Y02,A1,A2,B1,B2,BETA1,BETA2,SIGF1,ALPHAP,
   ...
   30   CONTINUE
        DO 40 I = 1,NF
          IVARI = NBVALC* (I-1) + 1
          CALL NM1DPM('RIGI',KPG,I,OPTION,NBVALC,ALPHAP,13,CSTPM,
