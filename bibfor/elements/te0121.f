...
C - HYPO-ELASTICITE
      ...
      IF (ZK16(ICOMPO+2) (1:5).EQ.'PETIT') THEN
        ...
        CALL NMPL3G(NNO,NNOB,NPG,ZR(IPOIDS),ZR(IVF),ZR(IVFB),ZR(IDFDE),
     &              ZR(IDFDEB),ZR(IDFDN),ZR(IDFDNB),ZR(IDFDK),
     &              ZR(IDFDKB),ZR(IGEOM),TYPMOD,NDIM,OPTION,ZI(IMATE),
     &              ZK16(ICOMPO),LGPG,ZR(ICARCR),ZR(IINSTM),ZR(IINSTP),
     &              ZR(ITEMPM),ZR(ITEMPP),ZR(IHYDRM),ZR(IHYDRP),
     &              ZR(ISECHM),ZR(ISECHP),NZ,ZR(IPHASM),ZR(IPHASP),
     &              ZR(ITREF),ZR(IDPLGM),ZR(IDDPLG),ZR(IDEFAM),
     &              ZR(IDEFAP),DEFANE,ZR(ICONTM),ZR(IVARIM),DFDI,DEF,
