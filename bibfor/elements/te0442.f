...
C       ---------------------------------------
        IF (OPTION.EQ.'REPE_TENS' ) THEN
          CALL DXSIR2(NP,NBSP,T2EV1,ZR(JIN),ZR(JCONIN))
        ELSE IF (OPTION.EQ.'REPE_GENE' ) THEN
          CALL DXEFR3(NP,NBSP,T2EV1,ZR(JIN),ZR(JCONIN))
        ENDIF
C
      ELSE IF (PAIN(4:5).EQ.'GA') THEN
C
...
C       -----------------------------------------
      IF (OPTION.EQ.'REPE_TENS' ) THEN
        CALL DXSIR2(NP,NBSP,T2VE2,ZR(JCONIN),ZR(JOUT))
      ELSE IF (OPTION.EQ.'REPE_GENE' ) THEN
        CALL DXEFR3(NP,NBSP,T2VE2,ZR(JCONIN),ZR(JOUT))
      ENDIF
