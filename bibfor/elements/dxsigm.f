      SUBROUTINE DXSIGM (FAMI,NOMTE,XYZL,PGL,IC,INIV,DEPL,SIGM)
      IMPLICIT  NONE
      INTEGER            IC,INIV
...
C     ------------------------------------------------------------------
     ...
     &      NOMTE.EQ.'MEDKTG3 ' ) THEN
          CALL DKTCOL(FAMI,XYZL,PGL,IC,INIV,DEPL,SIGM)
        ELSE IF (NOMTE.EQ.'MEDSTR3 ') THEN
          CALL DSTCOL(FAMI,XYZL,PGL,IC,INIV,DEPL,SIGM)
        ELSE IF (NOMTE.EQ.'MEDKQU4 ' .OR.
     &           NOMTE.EQ.'MEDKQG4 ') THEN
          CALL DKQCOL(FAMI,XYZL,PGL,IC,INIV,DEPL,SIGM)
        ELSE IF (NOMTE.EQ.'MEDSQU4 ') THEN
          CALL DSQCOL(FAMI,XYZL,PGL,IC,INIV,DEPL,SIGM)
        ELSE IF (NOMTE.EQ.'MEQ4QU4 ') THEN
          CALL Q4GCOL(FAMI,XYZL,PGL,IC,INIV,DEPL,SIGM)
        ELSE
