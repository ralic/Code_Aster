...
C ......................................................................
      ...
      INTEGER JPINTT,JCNSET,JHEAVT,JLONCH,JBASLO
      INTEGER KK,NI,MJ,JTAB(7),NZ,NNOS,ICAMAS
      INTEGER DDLH,DDLC,NDDL,INO,NNOM,NFE
...
C     NOMBRE DE DDLS TOTAL DE L'ÉLÉMENT
      NDDL=NNO*(NDIM+DDLH+NFE*NDIM+DDLC)+NNOM*DDLC
...
C         OPTION RIGI_MECA_TANG :         ARGUMENTS EN T-
     ...
     &                ZR(ITREF),ZR(IDEPLM),ZR(ICONTM),ZR(IVARIM),
...
C        OPTION FULL_MECA OU RAPH_MECA : ARGUMENTS EN T+
 ...
 200      CONTINUE
     ...
     &                ZR(ITREF),ZR(IDEPLP),ZR(ICONTP),ZR(IVARIP),
     &                ZR(IMATUU),ZR(IVECTU),CODRET)
