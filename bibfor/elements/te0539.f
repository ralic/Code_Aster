...
C ......................................................................
      ...
      INTEGER IPOIDS,IVF,IDFDE,IGEOM,IMATE,JLSN
      ...
      INTEGER IHYDRM,IHYDRP,ISECHM,ISECHP,IIRRAM,IIRRAP,ISREF,IVARIX
      LOGICAL DEFANE, MATSYM
      INTEGER NDDL,KK,NI,MJ,JTAB(7),NZ,NNOS,ICORRM,ICORRP,ICAMAS,NDDLE
...
C        OPTION RIGI_MECA_TANG :         ARGUMENTS EN T-
          CALL XMEL3D(NNO,NPG,IPOIDS,IVF,IDFDE,NDDLE,
     &              IGEOM,TYPMOD,OPTION,ZI(IMATE),
     &              ZK16(ICOMPO),LGPG,ZR(ICARCR),ZR(ITEMPM),ZR(JLSN),
...
C        OPTION FULL_MECA OU RAPH_MECA : ARGUMENTS EN T+
          ...
          DO 10 LI = 1,(3+NDDLE)*NNO
            ZR(IDEPLP+LI-1) = ZR(IDEPLM+LI-1) + ZR(IDEPLP+LI-1)
   10     CONTINUE

          CALL XMEL3D(NNO,NPG,IPOIDS,IVF,IDFDE,NDDLE,
     &              IGEOM,TYPMOD,OPTION,ZI(IMATE),
     &              ZK16(ICOMPO),LGPG,ZR(ICARCR),ZR(ITEMPP),ZR(JLSN),
