...
C ......................................................................
      CHARACTER*8 TYPMOD(2),ELREFP,LAG
...
C      CHARACTER*4 FAMI
      ...
      REAL*8  ANGMAS(7),R8VIDE,R8BID,R8DGRD,BARY(3)
...
C---- CALCUL POUR L'OPTION RIGI_MECA (APPEL DEPUIS MERIME)
     ...
     &               R8BID,ZR(JPINTT),ZI(JCNSET),ZI(JHEAVT),
     &               ZI(JLONCH),ZR(JBASLO),
     &               R8BID,ZR(JLSN),ZR(JLST),R8BID,
     &               R8BID,ZR(IMATUU),R8BID,CODRET)
...
C --- RÈACTUALISER LA GEOMETRIE DES POINTS D'INTERSECTION ZR(JPINTT)
...
C            DO 50 I = 1,3*NNO
   ...
   50     CONTINUE
          ...
          CALL XNMGR('+',NNO,IPOIDS,IVF,DDLH,NFE,DDLC,IGEOM,
     &                ZR(IINSTM),ZR(IINSTP),ZR(IDEPLP),ZR(ICONTM),
     &                ZR(IVARIP),TYPMOD,OPTION,NOMTE,ZI(IMATE),
     &                ZK16(ICOMPO),LGPG,ZR(ICARCR),ZR(JPINTT),
     &                ZI(JCNSET),ZI(JHEAVT),ZI(JLONCH),ZR(JBASLO),
