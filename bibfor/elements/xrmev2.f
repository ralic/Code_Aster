      SUBROUTINE XRMEV2(CPT,NPG,NDIM,JSIGSE,COORSE,TVOLSE)
      IMPLICIT NONE
      INTEGER CPT,NPG,NDIM,JSIGSE
      REAL*8  TVOLSE
      CHARACTER*24 COORSE
C ----------------------------------------------------------------------
...
C
        IADPG=IVF+(KPG-1)*NNO
        CALL ERMEV2(NNO,IBID,ZR(IADPG),JSIGNO,NBCMP,DFDX,DFDY,
     &              RBID1,IBID,DSX,DSY,NORME)
C
