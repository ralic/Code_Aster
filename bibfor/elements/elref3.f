...
C MODIF ELEMENTS  DATE 08/08/2002   AUTEUR CIBHHLV L.VIVAN 
C ======================================================================
...
C     ------------------------------------------------------------------
      IF ( ELREFE(1:3) .EQ. 'HEX' ) THEN

         NDIM = 3

C     ------------------------------------------------------------------
      ELSE IF ( ELREFE(1:3) .EQ. 'TET' ) THEN

         NDIM = 3

C     ------------------------------------------------------------------
      ELSE IF ( ELREFE(1:4) .EQ. 'PENT' ) THEN

         NDIM = 3

C     ------------------------------------------------------------------
      ELSE IF ( ELREFE(1:4) .EQ. 'PYRA' ) THEN

         NDIM = 3

C     ------------------------------------------------------------------
      ELSE IF ( ELREFE(1:4) .EQ. 'FACE' ) THEN
...
C     ------------------------------------------------------------------
      ELSE IF ( ELREFE.EQ.'SEG2' .OR. ELREFE.EQ.'THCOSE2' .OR. 
     &          ELREFE.EQ.'SEG3' .OR. ELREFE.EQ.'THCOSE3' ) THEN
...
C     ------------------------------------------------------------------
      ELSE IF( ELREFE .EQ. 'MET3SEG3'.OR. ELREFE .EQ. 'MET6SEG3' .OR.
     &         ELREFE .EQ. 'MET3SEG4' ) THEN
