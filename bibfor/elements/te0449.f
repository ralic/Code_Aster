...
C ......................................................................
      ...
      REAL*8  KUA(2,9,2,4), KAA(2,4,2,4), TRAV1(54)
...
C   FONCTIONS DE FORMES ET POINTS DE GAUSS
      ...
      IF ( ALIAS8(6:8).EQ.'TR6') THEN
         ELREF2 = 'TR3'
      ELSEIF (ALIAS8(6:8).EQ. 'QU8'  ) THEN
         ELREF2 = 'QU4'
      ELSE
        CALL U2MESK('F','DVP_4',1,NOMTE(5:8))
      ENDIF
...
C FORMATTAGE DES INCONNUES
 ...
 10   CONTINUE
        ...
        IF (ZK16(ICOMPO+2) (1:5).EQ.'PETIT') THEN
          CALL NIPL2D(FAMI,NNO1,NNO2,NPG1,IPOIDS,IVF1,IVF2,IDFDE1,
