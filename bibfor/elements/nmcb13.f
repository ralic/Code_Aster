...
C MODIF ELEMENTS  DATE 28/06/2004   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C ---  CALCUL DE SIGMA DANS LE CAS 1 & 3 PAR DICHOTOMIE
      ...
      REAL*8 X1,X2,XG,XD,FCTD,PAS,ERREUR,TOL,TOLR
      INTEGER NBPAS
...
C       VALEUR DE LA FONCTION A LA BORNE DROITE D13=XD
      D13 = XD
      IF (ABS(D13-UN).LE.TOLR) THEN
         CALL UTMESS('F','NMCB13','DIVISION PAR ZERO (D13 EGAL A UN)')
      ENDIF
