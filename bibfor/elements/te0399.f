...
C
      INTEGER  IPOIDS,IVF,IDFDE,NNO,KP,NPG1,COMPT,NNOS,JGANO
      INTEGER  IGEOM,ITHET,IFIC,IDEPL
      INTEGER  IPULS,KPG,SPT
      INTEGER  IMATE,IFOND,K,I,J,L,NDIM
C
      LOGICAL  LTEATT
C
C
...
C
        ...
        CALL RCVALB(FAMI,KPG,SPT,POUM,ZI(IMATE),' ',PHENOM,1,' ',RBID,1,
     &              'RHO',RHO,CODRHO,1)
C
        IF (CODRHO.NE.0) THEN
