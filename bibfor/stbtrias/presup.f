...
C MODIF STBTRIAS  DATE 26/04/2011   AUTEUR COURTOIS M.COURTOIS 
C ======================================================================
...
C     LORSQU'ON A UN ECHEC LORS DE LA LECTURE DU DATASET
C     ON INITIALISE DATASET A 0
      IF(IO.GT.0) DATSET=0
...
C  -->   LECTURE ET ECRITURE DES  NOEUDS
         CALL SLENEU(IUNV,NBNODE,AMA,BMA,CMA,AMI,BMI,CMI,MIN,
     &               MAN,ITES,DATSET)
         LARRET=.FALSE.
         CALL ECRNEU(IMOD,NBNODE,AMA,BMA,CMA,AMI,BMI,CMI,MIN,MAN,ITES)
...
C  -->   LECTURE ET ECRITURE DES  MAILLES
         CALL SLEELT(IUNV,MAXNOD,NBTYMA,INDIC,PERMUT,NBMAIL,MINT,MANT,
     &               DATSET,NBMTOT)
         LARRET=.FALSE.
         CALL ECRELT(IMOD,MAXNOD,NBTYMA,NOMAIL,NBMAIL,MINT,MANT,
     &               LIMAIL,NBMTOT)
