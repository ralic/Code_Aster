      SUBROUTINE FDJAC2(N,X,FVEC,FJAC,LDFJAC,IFLAG,ML,MU,EPSFCN,
     *                  WA1,WA2,LAMEQ,FLUID,GEOM1,CFPCD1,EPS,EPS0,
     *                  Z0,Z,DZ)
      IMPLICIT  NONE
      INTEGER   N, LDFJAC, IFLAG, ML, MU, EPS, EPS0
      REAL*8    EPSFCN, X(N), FVEC(N), FJAC(LDFJAC,N), WA1(N), WA2(N)
      REAL*8    FLUID(*), GEOM1(*), CFPCD1(*), Z0, Z, DZ
C-----------------------------------------------------------------------
...
C-----------------------------------------------------------------------
      INTEGER   I, J, K, MSUM
      REAL*8    EPSMCH, H, TEMP, ZERO, R8PREM, LAMEQ, TOLE
      DATA      ZERO /0.0D0/
C     ------------------------------------------------------------------
C
...
C
         DO 20 J = 1, N
            ...
            IF (H .EQ. ZERO) H = TOLE
            X(J) = TEMP + H
            CALL GFRESG(X,WA1,LAMEQ,FLUID,GEOM1,CFPCD1,EPS,EPS0,Z0,Z,DZ)
