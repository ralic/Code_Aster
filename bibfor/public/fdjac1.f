     ...
     *                  WA1,WA2,COEF1,FLUID,GEOM1,CFPCD1,DZ,D2Z,DT,
     *                  ITDASH,URM1)
      IMPLICIT   NONE
      INTEGER    N, LDFJAC, IFLAG, ML, MU, ITDASH
      REAL*8     EPSFCN, X(N), FVEC(N), FJAC(LDFJAC,N), WA1(N), WA2(N)
      REAL*8     DZ,D2Z,DT,COEF1(*),FLUID(*),GEOM1(*),CFPCD1(*),URM1
C-----------------------------------------------------------------------
...
C-----------------------------------------------------------------------
      INTEGER  I, J, K, MSUM
      REAL*8   EPS, EPSMCH, H, TEMP, ZERO, R8PREM
      DATA     ZERO / 0.0D0 /
C     ------------------------------------------------------------------
C
...
C
         DO 20 J = 1, N
            ...
            IF (H .EQ. ZERO) H = EPS
            X(J) = TEMP + H
            CALL GFRESD(DZ,D2Z,DT,X,WA1,COEF1,FLUID,GEOM1,CFPCD1,
     +                  ITDASH,URM1)
