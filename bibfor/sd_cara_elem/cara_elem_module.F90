...
!
!     integer, parameter :: ACE_NB_CARTE = 14
!     character(len=9), parameter :: ACE_CARTE(ACE_NB_CARTE*2) =[ &
!         '.CARCABLE', 'CACABL   ',  &
!         '.CVENTCXF', 'VENTCX_F ',  &
!         '.CARORIEN', 'CAORIE   ',  &
!         '.CARGENBA', 'CAGNBA   ',  &
...
!         '.CARCOQUF', 'CACOQUF  ' ]
!
!     integer, parameter :: ACE_CAR_CABLE = 1
!
! --------------------------------------------------------------------------------------------------
!
...
!
! --------------------------------------------------------------------------------------------------
    integer, parameter :: ACE_NB_COQUE     = 29
    character(len=16), parameter :: ACE_EL_COQUE(ACE_NB_COQUE) =[ &
        ...
        'MET3GG3         ','METCSE3         ','METDSE3         ','THCASE3         ',&
        'THCPSE3         ','MEC3QU9H        ','MEC3TR7H        ','MEBODKT         ',&
        'MEBODST         ','MEBOQ4G         ','MEBOCQ3         ','THCOSE3         ',&
        'THCOSE2         ' ]
!
! --------------------------------------------------------------------------------------------------
...
!
! --------------------------------------------------------------------------------------------------
    integer, parameter :: ACE_NB_MEMBRANE = 4
