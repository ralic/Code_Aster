      SUBROUTINE JJALLT ( LONOI, GENRI, TYPEI, LTYPI, CI, JCTAB, JCDYN)
...
C DEB ------------------------------------------------------------------
      ...
      IF ( TYPEI(1:1) .EQ. 'I' ) THEN
        CALL JJALLS (LONOI,GENRI,TYPEI,LTYPI,CI,ZI ,JBID,JCTAB,JCDYN)
      ELSE IF ( TYPEI(1:1) .EQ. 'R' ) THEN
        CALL JJALLS (LONOI,GENRI,TYPEI,LTYPI,CI,IZR,JBID,JCTAB,JCDYN)
      ELSE IF ( TYPEI(1:1) .EQ. 'C' ) THEN
        CALL JJALLS (LONOI,GENRI,TYPEI,LTYPI,CI,IZC,JBID,JCTAB,JCDYN)
      ELSE IF ( TYPEI(1:1) .EQ. 'K' ) THEN
        IF ( LTYPI .EQ. 8 ) THEN
          CALL JJALLS (LONOI,GENRI,TYPEI,LTYPI,CI,IZK8,JBID,JCTAB,JCDYN)
        ELSE IF ( LTYPI .EQ. 16 ) THEN
          CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,CI,IZK16,JBID,JCTAB,JCDYN)
        ELSE IF ( LTYPI .EQ. 24 ) THEN
          CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,CI,IZK24,JBID,JCTAB,JCDYN)
        ELSE IF ( LTYPI .EQ. 32 ) THEN
          CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,CI,IZK32,JBID,JCTAB,JCDYN)
        ELSE IF ( LTYPI .EQ. 80 ) THEN
          CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,CI,IZK80,JBID,JCTAB,JCDYN)
        ENDIF
      ELSE IF ( TYPEI(1:1) .EQ. 'L' ) THEN
        CALL JJALLS (LONOI,GENRI,TYPEI,LTYPI,CI,IZL,JBID,JCTAB,JCDYN)
      ENDIF
C FIN ------------------------------------------------------------------
      END
