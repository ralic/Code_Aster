      SUBROUTINE JEPRAT ( CUNIT , NOMLU , CIDATR , PARM , MESS )
...
C TOLE CFT_726 CFT_720 CRP_18 CRS_508 CRS_512
      ...
      CHARACTER *(*)      CUNIT , NOMLU , CIDATR , PARM , MESS
C ----------------------------------------------------------------------
C ROUTINE D'IMPRESSION DES OBJETS SYSTEME OU DES OBJETS ATTRIBUT DE
C COLLECTION
C
C IN  CUNIT : UNITE LOGIQUE D'IMPRESSION
      ...
      IF ( NOML32(1:1) .EQ. '$' ) THEN
        ...
        DO 1 K = 1, LIDBAS
           IF ( NOM .EQ. CIDBAS(K) ) THEN
              ...
              CALL JJIMPO ( CUNIT,IADMI, IDECI, 0, GENRI, TYPEI, LTYPI,
     +                      LONOI , MESS , PARM)
              GO TO 10
           ENDIF
 1      CONTINUE
...
C
 ...
 30       CONTINUE
     ...
     +                 NOM//' NON ACCESSIBLE '
             ...
             CALL JJIMPO(CUNIT,IBATR,IDECI,0,GENRI,TYPEI,LTYPI,LONOI,
     +                   MESS , PARM)
          ENDIF
        ENDIF
        IF ( LCOL ) THEN
