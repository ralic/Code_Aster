...
C DEB ------------------------------------------------------------------
      ...
      ELSE IF ( TYPEI .EQ. 'C' ) THEN
        CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,'INIT',IZC,JADR,IADMI)
        NBV = 2*NBVAL
      ELSE IF ( TYPEI .EQ. 'K' ) THEN
        IF ( LTYPI .EQ. 8 ) THEN
          CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,'INIT',IZK8 ,JADR,IADMI)
        ELSE IF ( LTYPI .EQ. 16 ) THEN
          CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,'INIT',IZK16,JADR,IADMI)
        ELSE IF ( LTYPI .EQ. 24 ) THEN
          CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,'INIT',IZK24,JADR,IADMI)
        ELSE IF ( LTYPI .EQ. 32 ) THEN
          CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,'INIT',IZK32,JADR,IADMI)
        ELSE IF ( LTYPI .EQ. 80 ) THEN
          CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,'INIT',IZK80,JADR,IADMI)
        ENDIF
      ELSE IF ( TYPEI .EQ. 'L' ) THEN
        CALL JJALLS(LONOI,GENRI,TYPEI,LTYPI,'INIT',IZL,JADR,IADMI)
      ENDIF
      ...
      IF ( TYPEI .EQ. 'I' ) THEN
        ...
        IF ( LOIS .LT. LTYPB ) THEN
          LON = NBVAL*LTYPB
          CALL JJALLS(LON,'V',TYPEI,LOIS,'INIT',ZI,JADR,KADM)
