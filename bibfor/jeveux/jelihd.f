...
C ----------------------------------------------------------------------
     ...
     &                 NOMAT2 = 'BASE GLOBALE JEVEUX' )
      ...
      INTEGER          HDFNOM,HDFTYP,HDFCLD,HDFOPG,HDFCLG,HDFRSI
...
C
     ...
     &                ' HDF SUR LE FICHIER :'
      ...
      IF ( CVERSU .NE. CVERSB ) THEN
          CALL JVMESS ( 'A' ,'JELIHD' , ' LA BASE '//NOMBAS(IC)
...
C
      ...
      IEXT(IC) = 1
C 
C ----ALLOCATION DES TAMPONS DE LECTURE/ECRITURE, DES ADRESSES MÉMOIRE
C     ET DES MARQUES
C
