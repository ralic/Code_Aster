...
C
      ...
      INTEGER J, K, NBORDR, NSTAT,L
      INTEGER JMASG, JMASJ, JMST, JORDR, JNOEU, JPARI
...
C
      ...
      CALL RSLIPA(BASEMO,'NOEUD_CMP','&&IREDPL.LINOEU',JNOEU,NBMODT)
...
C     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      IF ( NBMODS .NE. 0 ) THEN
        CALL WKVECT('&&IREDPL.NOEUDS','V V K8',NBNOEU,KNOEU)
        INOEU = 1
...
C     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      CALL WKVECT('&&IREDPL.MODE_STAT','V V K24',NBORDR,JMST)
      NSTAT = 0
      DO 100 I = 1 , NBORDR
        IORD = ZI(JORDR+I-1)
...
C         CALL JENONU(JEXNOM(MANONO,ZK16(JNOEU+I-1)(1:8)),INOE)
     ...
     >                  NIVE,VERSIO)
        ENDIF
 100  CONTINUE
      CALL JEDETR ('&&IREDPL.MODE_STAT' )
C     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C
C                 --- IMPRESSION DES MATRICES MODALES ---
C
C     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      CALL WKVECT('&&IREDPL.MASS_GENE','V V R',NBMODE*NBMODE,JMASG)
      CALL WKVECT('&&IREDPL.RIGI_GENE','V V R',NBMODE*NBMODE,JRIGG)
      IF ( NBMODS .NE. 0 ) THEN
        CALL WKVECT('&&IREDPL.MASS_JONC','V V R',NBMODS*NBMODS,JMASJ)
        CALL WKVECT('&&IREDPL.RIGI_JONC','V V R',NBMODS*NBMODS,JRIGJ)
        CALL WKVECT('&&IREDPL.RIGI_INFE','V V R',NBMODE*NBMODS,JPARI)
        CALL WKVECT('&&IREDPL.MASS_INFE','V V R',NBMODE*NBMODS,JPAMI)
      ENDIF
C
