...
C MODIF UTILITAI  DATE 26/05/2010   AUTEUR PELLET J.PELLET 
C ======================================================================
...
C---------------- COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      CHARACTER*80 ZK80
C---------------- COMMUNS NORMALISES  JEVEUX  --------------------------
      INTEGER INDI ,IBID,JVALMS,K,JNOML,NBFOIS,JVALMI,NBFOAV
      INTEGER RANG, NBPROC,NPROMX
      PARAMETER (NPROMX=1000)
      CHARACTER*8 KBID
      CHARACTER*50 NOMMEL
      REAL*8 XTOTA,XUSER,XSYST,XELAP,MOYENN(3),ECTYPE(3),RBID
...
C     -- EN PARALLELE, ATTENTION : TOUS LES PROCS N'ONT
C        PAS FORCEMENT FAIT LA MESURE. IL FAUT POURTANT
C        PARFOIS PARTICIPER AU CALCUL DE LA MOYENNE
      NBFOAV=NBFOIS
      CALL MPICM1('MPI_MAX','I',1,NBFOIS,RBID)

C     -- SI PERSONNE N'A FAIT LA MESURE, ON PEUT SORTIR :
      IF (NBFOIS.EQ.0) GOTO 9999

      IF (NBFOIS.NE.NBFOAV) THEN
