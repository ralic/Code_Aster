      SUBROUTINE UTACCE(BAS1,VAR,NOMSD,ACCES1,ACCES2,TYPE,NBORDR)
...
C
      IF ( TYPE(1:1) .EQ. 'R' ) THEN
         CALL WKVECT(NOMS2//'.'//ACCE2,BAS1//' V R',NBORDR,LINST)
         DO 10 I = 0 , NBORDR-1
            ZR(LINST+I) = RUNDEF
 10      CONTINUE
C
      ELSEIF ( TYPE(1:1) .EQ. 'I' ) THEN
         CALL WKVECT(NOMS2//'.'//ACCE2,BAS1//' V I',NBORDR,LINST)
         DO 12 I = 0 , NBORDR-1
            ZI(LINST+I) = IUNDEF
 12      CONTINUE
C
      ELSEIF ( TYPE(1:3) .EQ. 'K80' ) THEN
         CALL WKVECT(NOMS2//'.'//ACCE2,BAS1//' V K80',NBORDR,LINST)
C
      ELSEIF ( TYPE(1:3) .EQ. 'K32' ) THEN
         CALL WKVECT(NOMS2//'.'//ACCE2,BAS1//' V K32',NBORDR,LINST)
C
      ELSEIF ( TYPE(1:3) .EQ. 'K24' ) THEN
         CALL WKVECT(NOMS2//'.'//ACCE2,BAS1//' V K24',NBORDR,LINST)
C
      ELSEIF ( TYPE(1:3) .EQ. 'K16' ) THEN
         CALL WKVECT(NOMS2//'.'//ACCE2,BAS1//' V K16',NBORDR,LINST)
C
      ELSEIF ( TYPE(1:2) .EQ. 'K8' ) THEN
         CALL WKVECT(NOMS2//'.'//ACCE2,BAS1//' V K8',NBORDR,LINST)
      ENDIF
C
