...
C
      ...
      IF (NBCMP . GE. 31) THEN
        CALL UTMESS('F','RECUGD','NOMBRE DE COMPOSANTES DE LA'//
     +              ' GRANDEUR SUPERIEURE A 30.')
      ENDIF
...
C
  ...
  30      CONTINUE
          IF (IRANG .EQ. 0) THEN
            CALL UTMESS('E','RECUGD','LA COMPOSANTE '//NOMCMP(JJ)//
     +            ' N EXISTE PAS DANS LE CHAMP DE LA GRANDEUR.')
          ENDIF
          IRANV = 0
          DO 40 LL=1,IRANG
