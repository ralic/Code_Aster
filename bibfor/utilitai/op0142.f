...
C ----------------------------------------------------------------------
      ...
      CHARACTER*16 NOMCMD, TPROF, TYPFON
      CHARACTER*19 NOMFON
...
C
      CALL GETVID(' ','MAILLAGE',0,IARG,1,NOMMAI,L)
...
C
      ...
      CALL GETVTX(' ','PROL_GAUCHE',0,IARG,1,PROLGD(1:1) ,N3)
      CALL GETVTX(' ','PROL_DROITE',0,IARG,1,PROLGD(2:2) ,N3)
C
...
C
      CALL GETVTX('VITE ','PROFIL',1,IARG,1,TPROF,IBID)
      IF (TPROF.EQ.'UNIFORME') THEN
        CALL GETVR8('VITE ','VALE',1,IARG,1,RVALE,IBID)
        DO 50 I=1,NBRSE1
  ...
  50    CONTINUE
      ELSE
        CALL GETVIS('VITE ','NB_BAV',1,IARG,1,NBBAV,IBID)
        IF     (NBBAV .EQ. 0) THEN
          ITP = 1
