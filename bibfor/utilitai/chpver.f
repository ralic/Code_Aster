...
C     VERIFICATION DU TYPE
      IF(LOCHAM(1:1).NE.'*')THEN
         LOCH=LOCHAM
         CALL DISMOI(ARRET,'TYPE_CHAMP',NOCH,'CHAMP',IBID,TYCH,IE1)
...
C     VERIFICATION DE LA GRANDEUR
      IF(GDCHAM(1:1).NE.'*')THEN
         GDCH=GDCHAM
         CALL DISMOI(ARRET,'NOM_GD',NOCH,'CHAMP',IBID,NOMGD,IE2)
...
C    VERIFICATION CROISE POUR SORTIR UN 'ET' DES 2 CONDITIONS
