      SUBROUTINE ARLDBG(NOMPRO,NIV,IFM,IOCC,NBVLI,VALI,NBVLR,VALR,
     &                  NBVLK,VALK)
C
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF UTILITAI  DATE 13/10/2009   AUTEUR CAO B.CAO 
C ======================================================================
...
C
      IMPLICIT NONE
      CHARACTER*6  NOMPRO
      INTEGER      NBVLI,NBVLR,NBVLK,NBEV0
      INTEGER      NIV,IFM,IOCC,VALI(NBVLI)
      REAL*8       VALR(NBVLR)
...
C IN NBVLI  : I    : NOMBRE DE VALEURS ENTIERES DANS LE TABLEAU
C IN VALI   : I(*) : TABLEAU DE VALEURS ENTIERES
C IN NBVLR  : I    : NBVLOMBRE DE VALEURS REELLES DANBVLS LE TABLEAU
C IN VALR   : R(*) : TABLEAU DE VALEURS REELLES
C IN NBVLK  : I    : NOMBRE DE K24 DANS LE TABLEAU
...
C
        IF (NOMPRO.EQ.'ARLPAR') THEN
          ...
          IF (IOCC.EQ.1) THEN
            CALL U2MESG('I','ARLEQUINDEBG_1',NBEV0,VALK,NBVLI,VALI,
     &           NBVLR,VALR)
          ENDIF
C
        ...
        ELSEIF(NOMPRO.EQ.'ARLLCC') THEN
          ...
          ELSEIF (IOCC.EQ.5) THEN
            CALL U2MESI('I','ARLEQUINDEBG_13',NBVLI,VALI)
          ELSEIF (IOCC.EQ.6) THEN
            CALL U2MESI('I','ARLEQUINDEBG_14',NBVLI,VALI)
          ENDIF

        ELSEIF(NOMPRO.EQ.'ARLMED') THEN

          IF (IOCC.EQ.1) THEN
            CALL U2MESI('I','ARLEQUINDEBG_15',NBVLI,VALI)
          ENDIF

        ELSEIF(NOMPRO.EQ.'ECHMCO') THEN

          IF (IOCC.EQ.1) THEN
            CALL U2MESK('I','ARLEQUINDEBG_16',NBVLK,VALK)
          ELSEIF (IOCC.EQ.2) THEN
            CALL U2MESI('I','ARLEQUINDEBG_17',NBVLI,VALI)
          ELSEIF (IOCC.EQ.3) THEN
            CALL U2MESI('I','ARLEQUINDEBG_18',NBVLI,VALI)
          ELSEIF (IOCC.EQ.4) THEN
            CALL U2MESS('I','ARLEQUINDEBG_19')
          ELSEIF (IOCC.EQ.5) THEN
            CALL U2MESI('I','ARLEQUINDEBG_20',NBVLI,VALI)
          ELSEIF (IOCC.EQ.6) THEN
            CALL U2MESI('I','ARLEQUINDEBG_21',NBVLI,VALI)
        ...
        ELSEIF(NOMPRO.EQ.'ARLBBS') THEN
          ...
          ELSEIF (IOCC.EQ.2) THEN
            CALL U2MESR('I','ARLEQUINDEBG_31',NBVLR,VALR)
          ELSEIF (IOCC.EQ.3) THEN
            CALL U2MESR('I','ARLEQUINDEBG_32',NBVLR,VALR)
          ENDIF
        ...
        ELSEIF(NOMPRO.EQ.'ARLLEC') THEN
          ...
          ELSEIF (IOCC.EQ.3) THEN
            CALL U2MESI('I','ARLEQUINDEBG_41',NBVLI,VALI)
          ENDIF
        ...
        ELSEIF(NOMPRO.EQ.'INTMAD') THEN
          ...
          IF (IOCC.EQ.1) THEN
            CALL U2MESK('I','ARLEQUINDEBG_46',NBVLK,VALK)
          ELSEIF (IOCC.EQ.2) THEN
          ...
          ELSEIF (IOCC.EQ.9) THEN
            CALL U2MESR('I','ARLEQUINDEBG_54',NBVLR,VALR)
          ELSEIF (IOCC.EQ.10) THEN
            CALL U2MESR('I','ARLEQUINDEBG_55',NBVLR,VALR)
          ...
          ELSEIF (IOCC.EQ.14) THEN
            CALL U2MESR('I','ARLEQUINDEBG_59',NBVLR,VALR)
          ELSEIF (IOCC.EQ.15) THEN
            CALL U2MESR('I','ARLEQUINDEBG_60',NBVLR,VALR)
          ENDIF

        ELSEIF(NOMPRO.EQ.'ARLBO0') THEN

          IF (IOCC.EQ.1) THEN
            CALL U2MESI('I','ARLEQUINDEBG_61',NBVLI,VALI)
          ENDIF
        ...
        ELSEIF(NOMPRO.EQ.'ARLGDG') THEN
          ...
          ELSEIF (IOCC.EQ.7) THEN
            CALL U2MESI('I','ARLEQUINDEBG_71',NBVLI,VALI)
          ENDIF

        ELSEIF(NOMPRO.EQ.'ARLLPO') THEN

          IF (IOCC.EQ.1) THEN
            CALL U2MESG('I','ARLEQUINDEBG_72',NBEV0,VALK,NBVLI,
     &                  VALI,NBVLR,VALR)
          ENDIF
        ...
        ELSEIF(NOMPRO.EQ.'ARLVER') THEN
          ...
          IF (IOCC.EQ.1) THEN
            CALL U2MESI('I','ARLEQUINDEBG_75',NBVLI,VALI)
          ELSEIF (IOCC.EQ.2) THEN
            CALL U2MESG('I','ARLEQUINDEBG_76',NBVLK,VALK,NBVLI,
     &                  VALI,NBEV0,VALR)
          ENDIF
        ...
        ELSEIF(NOMPRO.EQ.'INTMAM') THEN
          ...
          IF (IOCC.EQ.1) THEN
            CALL U2MESK('I','ARLEQUINDEBG_77',NBVLK,VALK)
          ELSEIF (IOCC.EQ.2) THEN
          ...
          ELSEIF (IOCC.EQ.7) THEN
            CALL U2MESR('I','ARLEQUINDEBG_83',NBVLR,VALR)
          ELSEIF (IOCC.EQ.8) THEN
            CALL U2MESR('I','ARLEQUINDEBG_84',NBVLR,VALR)
          ELSEIF (IOCC.EQ.9) THEN
          ...
          ELSEIF (IOCC.EQ.13) THEN
            CALL U2MESG('I','ARLEQUINDEBG_89',NBVLK,VALK,NBVLI,
     &                  VALI,NBEV0,VALR)
          ELSEIF (IOCC.EQ.14) THEN
          ...
          ELSEIF (IOCC.EQ.16) THEN
            CALL U2MESI('I','ARLEQUINDEBG_92',NBVLI,VALI)
          ELSEIF (IOCC.EQ.17) THEN
            CALL U2MESS('I','ARLEQUINDEBG_93')
          ELSEIF (IOCC.EQ.18) THEN
            CALL U2MESI('I','ARLEQUINDEBG_94',NBVLI,VALI)
          ELSEIF (IOCC.EQ.19) THEN
            CALL U2MESK('I','ARLEQUINDEBG_95',NBVLK,VALK)
          ENDIF
        ...
        ELSEIF(NOMPRO.EQ.'ARLMAI') THEN
          ...
          ELSEIF (IOCC.EQ.2) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_2',NBVLI,VALI)
          ELSEIF (IOCC.EQ.3) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_3',NBVLI,VALI)
          ELSEIF (IOCC.EQ.4) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_4',NBVLI,VALI)
          ELSEIF (IOCC.EQ.5) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_5',NBVLI,VALI)
          ELSEIF (IOCC.EQ.6) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_6',NBVLI,VALI)
          ELSEIF (IOCC.EQ.7) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_7',NBVLI,VALI)
          ELSEIF (IOCC.EQ.8) THEN
            CALL U2MESS('I','ARLEQUINDEBG2_8')
          ELSEIF (IOCC.EQ.9) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_9',NBVLI,VALI)
          ELSEIF (IOCC.EQ.10) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_10',NBVLI,VALI)
          ELSEIF (IOCC.EQ.11) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_11',NBVLI,VALI)
          ELSEIF (IOCC.EQ.12) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_12',NBVLI,VALI)
          ELSEIF (IOCC.EQ.13) THEN
        ...
        ELSEIF(NOMPRO.EQ.'ECHMAP') THEN
          ...
          IF (IOCC.EQ.1) THEN
            CALL U2MESG('I','ARLEQUINDEBG2_16',NBVLK,VALK,NBVLI,
     &                  VALI,NBEV0,VALR)
          ELSEIF (IOCC.EQ.2) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_17',NBVLI,VALI)
          ELSEIF (IOCC.EQ.3) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_18',NBVLI,VALI)
          ELSEIF (IOCC.EQ.4) THEN
            CALL U2MESS('I','ARLEQUINDEBG2_19')
          ELSEIF (IOCC.EQ.5) THEN
            CALL U2MESG('I','ARLEQUINDEBG2_20',NBEV0,VALK,NBVLI,
     &                  VALI,NBVLR,VALR)
          ELSEIF (IOCC.EQ.6) THEN
            CALL U2MESG('I','ARLEQUINDEBG2_21',NBEV0,VALK,NBVLI,
     &                  VALI,NBVLR,VALR)
          ELSEIF (IOCC.EQ.7) THEN
        ...
        ELSEIF(NOMPRO.EQ.'PLINT2') THEN
          ...
          ELSEIF (IOCC.EQ.4) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_26',NBVLI,VALI)
          ELSEIF (IOCC.EQ.5) THEN
            CALL U2MESS('I','ARLEQUINDEBG2_27')
          ELSEIF (IOCC.EQ.6) THEN
            CALL U2MESS('I','ARLEQUINDEBG2_28')
          ELSEIF (IOCC.EQ.7) THEN
            CALL U2MESI('I','ARLEQUINDEBG2_29',NBVLI,VALI)
          ELSEIF (IOCC.EQ.8) THEN
            CALL U2MESG('I','ARLEQUINDEBG2_30',NBEV0,VALK,NBVLI,VALI,
     &                  NBVLR,VALR)
          ENDIF
        ...
        ELSEIF(NOMPRO.EQ.'PLINT3') THEN
          ...
          ELSEIF (IOCC.EQ.4) THEN
            CALL U2MESI('I','ARLEQUINDEBG_26',NBVLI,VALI)
          ELSEIF (IOCC.EQ.5) THEN
            CALL U2MESS('I','ARLEQUINDEBG_27')
          ELSEIF (IOCC.EQ.6) THEN
            CALL U2MESS('I','ARLEQUINDEBG_28')
          ELSEIF (IOCC.EQ.7) THEN
            CALL U2MESI('I','ARLEQUINDEBG_29',NBVLI,VALI)
          ELSEIF (IOCC.EQ.8) THEN
            CALL U2MESG('I','ARLEQUINDEBG2_31',NBEV0,VALK,NBVLI,VALI,
     &                  NBVLR,VALR)
          ENDIF
        ...
        ELSEIF(NOMPRO.EQ.'ARLAP1') THEN
          ...
          IF (IOCC.EQ.1) THEN
            CALL U2MESG('I','ARLEQUINDEBG2_32',NBVLK,VALK,NBVLI,VALI,
     &                  NBEV0,VALR)
          ELSEIF (IOCC.EQ.2) THEN
            CALL U2MESK('I','ARLEQUINDEBG2_33',NBVLK,VALK)
          ENDIF
