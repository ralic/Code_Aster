...
C MODIF UTILITAI  DATE 08/06/2001   AUTEUR VABHHTS J.PELLET 
C ======================================================================
...
C
      IF ( IDESC .EQ. 1 ) THEN
         ...
         ELSE
            CALL UTMESS('F','RGNDAS',' TYPE INCONNU')
         ENDIF
         NEC = NBEC(GD)
C
...
C
         ...
         ELSE
            ...
            CALL UTMESS('A','RGNDAS','ON NE TROUVE PAS L''EQUATION '//
     +                                NOMEQ//' DANS LE "PROF_CHNO"')
         ENDIF
C
 9999    CONTINUE
C
...
C
      ELSE
        CALL UTDEBM('F','RGNDAS','TYPE DE NUMEROTATION NON CONNUE')
        CALL UTIMPK('L',' NUMEROTATION:',1,NUME)
        CALL UTFINM
      ENDIF
C
      CALL JEDEMA()
