...
C -----  VARIABLES LOCALES
     ...
     &        IPTMA,IGD,IDEBGD,DG,IMA,ICONEX,NBNO,NEC,IVARI
      ...
      COMPLEX*16 C16B
      CHARACTER*2 CODRET
      CHARACTER*8 RESUL,CRIT,NOMA,NOMMAI,NOMLIG,VALEK(2),KIORDM
      CHARACTER*8 KIORD,K8B,LPAIN(10),LPAOUT(2),TYPARR(NBPARR)
      CHARACTER*8 NOMGD
...
C     ------------------------------------------------
     ...
     &            CHHARM,IRET)
      ...
      NOMLIG = '&&PEINGL'
      CALL EXLIMA(OPTIOZ,'V',MODELE,NOMLIG,LIGREL)
