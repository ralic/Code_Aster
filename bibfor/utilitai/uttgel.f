...
C
     ...
     >           NOMTE(1:5).EQ.'HH_DP' ) THEN
          IAUX = 6
C
C 1.2. ==> CAS PARTICULIER DES ELEMENTS OSGS
C
        ELSEIF ( NOMTE(1:6).EQ.'MIPLOS' .OR.
     >           NOMTE(1:6).EQ.'MIAXOS' ) THEN
          IAUX = 7
C
C 1.3. ==> CAS GENERAL
C
...
C
     ...
     >           NOMTE(1:3).EQ.'HH_' ) THEN
          IAUX = 4
C
C 2.2. ==> CAS PARTICULIER DES ELEMENTS OSGS
C
        ELSEIF ( NOMTE(1:7).EQ.'MINCOS_') THEN
          IAUX = 8
C
C 2.3. ==> CAS GENERAL
C
