...
C MODIF UTILITAI  DATE 13/03/2002   AUTEUR GNICOLAS G.NICOLAS 
C ======================================================================
...
C
      INTEGER LXLGUT
C
      INTEGER NBARG, IAUX, IBID, JVEC, JLMCLE, JLTYP
C
      CHARACTER*3 TYPE2
      CHARACTER*24 NOMVE2
...
C====
C
      CALL GETMFM ( MOTFA2, 0, K16BID, K16BID, NBARG )
      NBARG = ABS(NBARG)
      CALL WKVECT ( '&&'//NOMPRO//'.LMOCLE','V V K16',
     >              MAX(1,NBARG),JLMCLE)
      CALL WKVECT ( '&&'//NOMPRO//'.LTYP','V V K16',
     >              MAX(1,NBARG),JLTYP)
      CALL GETMFM ( MOTFA2, NBARG,
     >              ZK16(JLMCLE), ZK16(JLTYP), IBID )
C
      TYPE2 = '???'
      DO 21, IAUX = 1 , NBARG
