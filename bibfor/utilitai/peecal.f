...
C MODIF UTILITAI  DATE 02/11/2009   AUTEUR LEBOUVIER F.LEBOUVIER 
C ======================================================================
...
C     - TABLEAU DES VALEURS DES MOYENNES : ZR(JINTR)
      ...
      ELSE
        ...
        CALL WKVECT('&&PEECAL.INTE_K','V V K16',2*NBCMP+2,JINTK)
        ZK16(JINTK)='VOL'
        ZK16(JINTK+1)=LIEU
        VALK(1)=CHPOST
        VALK(2)=NOMLIE
...
C --- CALCUL DE L'INTEGRALE ET DE LA MOYENNE(=INTEGRALE/VOLUME):
 ...
 35      CONTINUE
         ...
         ZK16(JINTK+IND1+ICMP-1)='INTE_'//NOMCMP(ICMP)
         ZR(JINTR+NBCMP+ICMP+IND2)=VAL/VOL
         ZK16(JINTK+IND1+NBCMP+ICMP-1)='MOYE_'//NOMCMP(ICMP)
 30   CONTINUE
