...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX --------------------------
      ...
      INTEGER NBV,NBMAPL,IBID,NTOUT,NNUME,NP
      ...
      INTEGER NBORDT,TE,TYPELE,NBGREL,NBGR,IGR
      ...
      CHARACTER*16 NOMCMD,CONCEP,NSYMB,NOMTE
...
C TEST SUR LA PRESENCE DE MAILLE PONCTUELLE
      IF (ITEST.NE.0) CALL UTMESS('I',NOMCMD,
...
C     FORMAT IDEAS OBLIGATOIRE
      ...
      IF (FORM.NE.'IDEAS') THEN
        CALL UTMESS('F',NOMCMD,'LE FORMAT DOIT ETRE IDEAS')
      END IF
      CALL JEEXIN(NOMAPL//'           .TITR',IRET)
      IF (IRET.EQ.0) THEN
        CALL UTMESS('F',NOMCMD,'LE MAILLAGE DOIT ETRE ISSU D''IDEAS')
      ELSE
     ...
     &                  )
          END IF
        ELSE
          CALL UTMESS('A',NOMCMD,' MAILLAGE NON ISSU D''IDEAS')
        END IF
      END IF
...
C  ==> LES TE SAVENT CE QU4ILS ONT A FAIRE
  ...
  160 CONTINUE
      ...
      CALL UTDEBM('I',NOMCMD,'LECTURE DES CHAMPS:')
