      SUBROUTINE PECAGE(RESU,MODELE,MATE,CARA,NCHAR,LCHAR,NH,NBOCC)
      IMPLICIT   NONE
      INTEGER NCHAR,NH,NBOCC
      CHARACTER*(*) RESU,MODELE,MATE,CARA,LCHAR(*)
C     ------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF UTILITAI  DATE 30/09/2002   AUTEUR JMBHH01 J.M.PROIX 
C ======================================================================
...
C      IF ( IRET .NE. 0 ) GOTO 9999
      ...
      NOMLIG = '&&PECAGE'
      CALL EXLIMA('CARA_GEOM','V',MODELE,NOMLIG,LIGREL)
   ...
   10 CONTINUE
      ...
      DO 40 IOCC = 1,NBOCC
        ...
        IF (NG.NE.0) THEN
          ...
          CALL GETVID('CARA_GEOM','GROUP_MA',IOCC,1,NBGRMA,ZK8(JGR),NG)
          VALEK(2) = 'GROUP_MA'
          DO 20 IG = 1,NBGRMA
...
C     &                                    NBGRMA, ZK8(JGR), VALPAR )
   ...
   20     CONTINUE
        ...
        IF (NM.NE.0) THEN
          ...
          CALL GETVID('CARA_GEOM','MAILLE',IOCC,1,NBMAIL,ZK8(JMA),NM)
          VALEK(2) = 'MAILLE'
          DO 30 IM = 1,NBMAIL
