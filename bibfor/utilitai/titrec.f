...
C MODIF UTILITAI  DATE 23/01/2002   AUTEUR DURAND C.DURAND 
C ======================================================================
 ...
 12      CONTINUE
         IF ( ICLASS .EQ. -1 ) THEN
            ...
            IF(ILIGD.GT.NBTITR) THEN
               CALL UTMESS('A',DEMON,' EXPRESSION INCORRECTE ')
               NBPARA = 0
               GO TO 20
            ENDIF
            GOTO 11
...
CCC            CALL LXCAPS(PARA(NBPARA))
         ...
         ELSEIF (ICLASS .EQ. 5 .AND. CVAL(1:1) .EQ. ')' ) THEN
            IF ( NBPARA .NE. MXPARA ) THEN
               NBPARA = 0
               CALL UTMESS('A',DEMON,' NOMBRE D''ARGUMENT INCORRECT'
     +                           //' POUR LE DEMON ')
            ENDIF
            GOTO 20
         ELSE
            NBPARA = 0
            CALL UTMESS('A',DEMON,' VOTRE PARAMETRE '//
