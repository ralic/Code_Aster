      SUBROUTINE CREAGM(NBMATO,NBPART,SDB,MA,SDBORD,MASD)
...
C DECLARATION VARIABLES LOCALES
     ...
     &              JVG,JGG,IFM,NIV,NBGMA
      REAL*8        TMPS(3)
      CHARACTER*8   KTMP,K8BID
      CHARACTER*24  SDBORD,NOM,GRPMAV,GRPMA,GPPTNM,GRPEMA
      INTEGER      IARG
C----------------------------------------------------------------------
C CORPS DU PROGRAMME
      CALL JEMARQ()
...
C ------- ON AGRANDIT LA COLLECTION GROUPE-MAILLE
      ...
      IF ( ERR .EQ. 0 ) THEN
        ...
        CALL JECREC(GRPMA,'G V I','NO '//GPPTNM,
     &              'DISPERSE','VARIABLE',NBPART)
      ELSE
