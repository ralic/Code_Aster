...
C MODIF UTILITAI  DATE 30/08/2000   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C     ------------------------------------------------------------
      ...
      IF (TSCA.NE.'K8') CALL UTMESS('F','CNSEVA',
...
C     --------------------------------------------------------------
      ...
      DO 10,IPARA = 1,NPARA
        ...
        IF (TSCA.NE.'R') CALL UTMESS('F','CNSEVA',
     &                               'LES PARAMETRES DOIVENT ETRE REELS'
     &                               )
        IF (MA2.NE.MA) CALL UTMESS('F','CNSEVA','MAILLAGES DIFF.')
            ...
            DO 30,IPARA = 1,NPARA
              ...
              DO 20,K2 = 1,NCMP2
                IF (ZL(JPL-1+ (INO-1)*NCMP2+K2)) THEN
                  NBPU = NBPU + 1
                  IF (NBPU.GT.NBPUMX) CALL UTMESS('F','CNSEVA',
...
C           --------------------
            ...
            IF (IER.NE.0) CALL UTMESS('F','CNSEVA','STOP1')
