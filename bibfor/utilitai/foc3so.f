      SUBROUTINE FOC3SO(NBFREQ,FREQ,NBAMOR,AMOR,NBINST,INST,ACCE,SPECTR)
      IMPLICIT REAL*8 (A-H,O-Z)
      REAL*8    FREQ(*),AMOR(*),INST(*),ACCE(*),SPECTR(NBFREQ,NBAMOR,3)
C     ------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF UTILITAI  DATE 03/07/96   AUTEUR CIBHHLV L.VIVAN 
C ======================================================================
...
C IN  INST   : R : VALEURS DES INSTANTS
C IN  ACCE   : R : VALEURS DE L'ACCELEROGRAMME
