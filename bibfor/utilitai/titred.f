...
C      12345678901234567890123456789012345678901234567890123456789012345
     ...
     A       3,
     1'ASTER &VERSION',14,
     2' CONCEPT &RESULTAT CALCULE LE &DATE A &HEURE',44,
     3' DE TYPE &TYPE',14/
C     ------------------------------------------------------------------
C
...
C      12345678901234567890123456789012345678901234567890123456789012345
     ...
     A       7,
     1'CHAMP AUX NOEUDS DE',19,
     2' NOM SYMBOLIQUE ',16,
     3' &NOM_SYMB(''1234567890123456789'',''1234567890123456789'')',55,
     4' &RL',4,
     5'NUMERO D''ORDRE: ',16,
     6'&NUME_ORDRE(''1234567890123456789'',''1234567890123456789'')',56,
     7' &ACCES(''1234567890123456789'',''1234567890123456789'')',52/
C     ------------------------------------------------------------------
C
...
C      12345678901234567890123456789012345678901234567890123456789012345
     ...
     A       8,
     1'CHAMP PAR ELEMENT',17,
     2' &LOC(''1234567890123456789'') DE',31,
     3' NOM SYMBOLIQUE ',16,
     4' &NOM_SYMB(''1234567890123456789'',''1234567890123456789'')',55,
     5' &RL',4,
     6'NUMERO D''ORDRE: ',16,
     7'&NUME_ORDRE(''1234567890123456789'',''1234567890123456789'')',56,
     8' &ACCES(''1234567890123456789'',''1234567890123456789'')',52/
C     ------------------------------------------------------------------
C
...
C     --- CHOIX D'UN TITRE ---
      ...
      ELSE
         ...
         IF (IERD .NE.0 ) THEN
            CALL UTMESS('F','TITRED(0)','ET ALORS TYPESD = '//TYPESD)
     ...
     +                                                             IERD)
            ...
            ELSEIF ( TYPESD(1:4) .EQ. 'CART') THEN
               ICHOIX = 9
            ELSE
               CALL UTMESS('F','TITRED(1)','ET ALORS TYPESD = '//TYPESD)
            ENDIF
         ELSE
...
CCCC +                                                             IERD)
            ...
            ELSEIF ( TYPESD(1:4) .EQ. 'CART') THEN
               ...
               DEFAUT(7,ICHOIX)(32:50) = NOMCHA
            ELSE
               CALL UTMESS('F','TITRED(2)','ET ALORS TYPESD = '//TYPESD)
            ENDIF
         ENDIF
      ENDIF
C
