      SUBROUTINE COCOPG(OBIN,OBOUT,NMAXNW,LONNEW,BASE)
...
C ----------------------------------------------------------------------
C     IN:
C       OBIN   : NOM D'UNE COLLECTION  JEVEUX (K24) A RECOPIER
C                DANS OBOUT QUI A PLUS D'ELEMENTS QUE OBIN
C       BASE   : 'G','V','L'
C     OUT:
C       OBOUT  : NOM D'UNE COLLECTION JEVEUX (K24) (CIBLE)
C
C ----------------------------------------------------------------------
C     VARIABLES LOCALES:
C     ------------------
...
C     -------------
     ...
     +         ACCE2,STOCKA,MODLO2,NMAXNW)
      ELSE
         CALL JECREC(OB2,BAS2(1:1)//' '//GENR(1:1)//' '//TYPE(1:4) ,
     +         ACCE2,STOCKA,NOPTLG,NMAXNW)
      END IF
C
C     -- DOCU :
C     ---------
