...
C
      IF ( BASE.NE.'V' .AND. BASE.NE.'G' ) THEN
         CALL UTMESS('F','TBEXV1','TYPE BASE INCONNU :'//BASE)
      ENDIF
C
...
C
      ...
      IF ( IRET .EQ. 0 ) THEN
         CALL UTMESS('F','TBEXV1','LA TABLE N''EXISTE PAS') 
      ENDIF
C
      ...
      NBLIGN = ZI(JTBNP+1)
      IF ( NBPARA .EQ. 0 ) THEN
         CALL UTMESS('F','TBEXV1','PAS DE PARAMETRES DEFINIS') 
      ENDIF
      IF ( NBLIGN .EQ. 0 ) THEN
         CALL UTMESS('F','TBEXV1','PAS DE LIGNES DEFINIES') 
      ENDIF
C
...
C
 ...
 10      CONTINUE
         CALL UTDEBM('F','TBEXV1','ERREUR DANS LES DONNEES') 
