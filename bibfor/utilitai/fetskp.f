...
C MODIF UTILITAI  DATE 24/01/2011   AUTEUR BOITEAU O.BOITEAU 
C ======================================================================
...
C DECLARATION VARIABLES LOCALES
     ...
     &              RANG,NBPROC,NBFORM,ITMP,VERSCO,N1,N2,N3,IER
      REAL*8        TMPS(6)
      CHARACTER*8   MA,K8BID,GRPEMA,KTMP,NOM,MOD,SDBORD,FATAL,
     &              VERIF,KTMP2,METH,BORD,KTMP3,KTMP4,K8NB,KERSCO
      CHARACTER*32  JEXNUM
...
C --- ON IMPOSE PROVISOIREMENT KMETIS A LA PLACE DE SCOTCH EN ATTENDANT
C     LA MONTEE DE VERSION DE SCOTCH 4.0 A SCOTCH 5.1.6
      IF (METH(1:6).EQ.'SCOTCH') THEN
        NBPROC=1
        RANG=0
...
C -------  UTILISATION DE CONTRAINTES
 ...
 115  CONTINUE
      ...
      DO 116 IOCC=1,NOCC
        CALL GETVTX('GROUPAGE','GROUP_MA',IOCC,1,1,GRPEMA,ERR)
 ...
 116  CONTINUE
      ...
      DO 117 IOCC=1,NOCC
        CALL GETVTX('POIDS_MAILLES','GROUP_MA',IOCC,1,1,GRPEMA,ERR)
        CALL JELIRA(MA//'.GROUPEMA','NMAXOC',NBRE,K8BID)
        NBMA=0
        DO 207 J=1,NBRE
          CALL JENUNO(JEXNUM(MA//'.GROUPEMA',J),NOM)
