...
C DECLARATION VARIABLES LOCALES
     ...
     &              IAUX2
      INTEGER       VALI(2), IRET, LXLGUT
      REAL*8        TMPS(6)
      CHARACTER*8   MA,K8BID,KTMP,MOD,
     &              VERIF,KTMP2,METH,BORD,K8NB,KERSCO
      CHARACTER*24  K24B,GRPEMA,NOM,SDBORD
...
C ------- CREATION DES GROUP_MA
      ...
      NBMATO=NBMABO
      CALL CREAGM(NBMATO,NBPART,SDB,MA,SDBORD,MASD)
