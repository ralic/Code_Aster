...
C
      ...
      IF ( IRET .EQ. 0 ) THEN
         CALL UTMESS('F','TBAJLI','LA TABLE N''EXISTE PAS') 
      ENDIF
...
C
      ...
      NBLIGN = ZI(JTBNP+1)
      IF ( NBPARA .EQ. 0 ) THEN
         CALL UTMESS('F','TBAJLI','PAS DE PARAMETRES DEFINIS') 
      ENDIF
      IF ( NUME .LT. 0 ) THEN
         CALL UTMESS('F','TBAJLI','NUMERO DE LIGNE NEGATIF') 
      ENDIF
      IF ( NUME .GT. NBLIGN ) THEN
         CALL UTMESS('F','TBAJLI','NUMERO DE LIGNE TROP GRAND') 
      ENDIF
C
