...
C     ------------------------------------------------------------------
     ...
     &            VALK(2)
      ...
      CHARACTER*24 LCHIN(16),LCHOUT(1),MLGGMA,MLGNMA,VALK2(2)
...
C     --- CREATION DE LA TABLE ---
     ...
     &              NM)
        ...
        IF (NT.NE.0) THEN
          ...
          VALK(1) = NOMA
          VALK(2) = 'TOUT'
          CALL TBAJLI(RESU,NBPARR,NOPARR,IBID,ZR(LVALE),C16B,VALK,0)
        END IF
        IF (NG.NE.0) THEN
          NBGRMA = -NG
     ...
     &                  ICAGE)
            ...
            CALL TBAJLI(RESU,NBPARR,NOPARR,IBID,ZR(LVALE),C16B,VALK2,0)
   30     CONTINUE
