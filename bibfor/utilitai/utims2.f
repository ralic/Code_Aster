      SUBROUTINE UTIMS2(COMM,ICOMM,SCH1,IPOS,BASE)
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF UTILITAI  DATE 06/09/2000   AUTEUR VABHHTS J.PELLET 
C ======================================================================
...
C     -------------------------
      ...
      IF (LEN(SCH1).GT.24) THEN
        CALL UTMESS('F','UTIMS2','CHAINE SCH1 TROP LONGUE >24')
      END IF
      IF ((IPOS.LT.0) .OR. (IPOS.GT.24)) THEN
        CALL UTMESS('F','UTIMS2','IPOS HORS DE L INTERVALLE (0 24)')
      END IF
      IF (IPOS+LEN(SCH1).GT.25) THEN
        CALL UTMESS('F','UTIMS2','LONGUEUR TOTALE > 24 ')
      END IF
...
C    --------------------------
      ...
      WRITE (IFM,*) ' '
      WRITE (IFM,*) '#AJ1 ====> UTIMS2 DE LA STRUCTURE DE DONNEE : ',
     &  CHAIN2
...
C    -------------------------------------------------------
      CALL WKVECT('&&UTIMS2.LISTE','V V K24',NBOBJ,IALIOB)
      IF (LONG.EQ.24) THEN
