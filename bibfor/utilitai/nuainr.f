...
C MODIF UTILITAI  DATE 25/07/2001   AUTEUR RATEAU G.RATEAU 
C ======================================================================
...
C           W = NUAPOI(NX1,IP1,NUAX1,X2,DREF)
   ...
   31     CONTINUE
        ...
        IF (NX1.EQ.1) THEN
          CALL MGAUSS(K1,F,2,2,1,ZERO,FAUX)
        ELSE IF (NX1.EQ.2) THEN
          CALL MGAUSS(K2,F,3,3,1,ZERO,FAUX)
        ELSE IF (NX1.EQ.3) THEN
          CALL MGAUSS(K3,F,4,4,1,ZERO,FAUX)
        END IF
