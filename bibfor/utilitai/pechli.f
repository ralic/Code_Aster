...
C -- VERIFICATIONS INITIALES
      ...
      IF (IRET.EQ.0) CALL U2MESK('F','MODELISA_96',1,ERREUR(3))
...
C -- EXTRACTION DES NUMEROS D'ORDRE DU CALCUL
      ...
      IF (IRET.NE.0) CALL U2MESK('F','MODELISA_96',1,ERREUR(1))
...
C      EXTRACTION DU CHAMP DE DEPLCAMENT
        ...
        IF (IRET.NE.0) CALL U2MESK('F','MODELISA_96',1,ERREUR(2))
...
C       CHLIM(3) : MAX UTILE AU CALCUL DE CHAR_LIMI_ESTIM
        ...
        CALL MEMAX('MAX',LCHOUT(1),3,3,CHMAX,0,IBID)
