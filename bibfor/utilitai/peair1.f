...
C MODIF UTILITAI  DATE 05/01/2000   AUTEUR CIBHHLV L.VIVAN 
C ======================================================================
...
C
  ...
  10  CONTINUE
      IF (NBMA.NE.NBEL) THEN
          CALL UTMESS('F','PAAIR1','NBMA DIFFERENT DE NBEL' )
      ENDIF
C
...
C
 ...
 30   CONTINUE
      IF ((NBEXT1.NE.0).AND.(NBEXT2.NE.0)) THEN
         CALL UTMESS('F','PEAIR1','LE CONTOUR N EST PAS FERME')
      ENDIF
C
...
C
 ...
 11   CONTINUE
      IF (NBMA.NE.NBE) THEN
          CALL UTMESS('F','PAAIR1','NBMA DIFFERENT DE NBE')
      ENDIF
      NJ2=ZI(JN2-1+3*NBE-1)
      NJ0=ZI(JN2)
      IF (NJ2.NE.NJ0) THEN
          CALL UTMESS('F','PAAIR1','NJ2 DIFFERENT DE NJ0')
      ENDIF
C
