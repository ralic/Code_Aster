      SUBROUTINE UTFLM2(MAILLA,TABMAI,NBMA,DIM,NBTROU,TATROU)
      IMPLICIT NONE
      INTEGER DIM,NBTROU,TABMAI(NBMA),NBMA,TATROU(NBMA)
      CHARACTER*8 MAILLA
C ----------------------------------------------------------------------
...
C
      ...
      CALL WKVECT('&&UTDIMM.LISTE_TYPMAI','V V I',NBMA,IT)
      CALL WKVECT('&&UTDIMM.LISTE_M_TEMP','V V I',NBMA,ITEMPO)
