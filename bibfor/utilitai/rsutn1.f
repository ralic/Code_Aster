...
C
      ...
      IF ( IRET .NE. 0 ) THEN
         K8B = RESU
         CALL UTMESS('F','RSUTN1','PROBLEME POUR RECUPERER LES NUMEROS'
...
C
 ...
 20   CONTINUE
      IF ( II .EQ. 0 ) THEN
         CALL UTMESS('F','RSUTN1','AUCUN NUMERO D''ORDRE NE CORRESPOND'
     +                //' AU PARAMETRE DEMANDE '//NOPARA)
      ENDIF
C
