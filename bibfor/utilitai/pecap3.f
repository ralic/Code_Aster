...
C MODIF UTILITAI  DATE 23/08/2004   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C     -------------------------------------------
      ...
      IF (NBORDR.NE.1) THEN
        CALL UTMESS('F','PECAP3','LE NOMBRE D''ORDRES DU '//
     &              'RESULTAT '//TEMPER//' NECESSAIRE POUR '//
     &              'CALCULER LA CONSTANTE DE GAUCHISSEMENT DOIT '//
     &              'ETRE EGAL A 1.')
      END IF
...
C     -------------------------------------------------
      ...
      IF (IRET.GT.0) THEN
        CALL UTMESS('F','PECAP3','ON N''ARRIVE PAS A RECUPERER'//
