...
C ----------------------------------------------------------------------
C     INITIALISE LA STRUCTURE QUI CONTIENDRA TOUTES LES
...
C ----------------------------------------------------------------------
C IN  CHOIX  : 1 POUR L'INITIALISATION DE LA STRUCTURE
C              2 POUR RECUPERER LE NOMBRE DE STRUCTURES ENREGISTREES
C . SI CHOIX = 1 :
...
C                8. VARIABLE COMPLEMENTAIRE NUMERO 1
C                9. VARIABLE COMPLEMENTAIRE NUMERO 2
C               DIVERS NOMS DE STRUCTURES DE TRAVAIL CONSTRUITS AVEC
C               UN PREFIXE ARBITRAIRE :
C               10. VECTEUR DES CHARGES SOUS LE NOM "&&VECnnn    "
C               11. VECTEUR DES DIRICHLETS SOUS LE NOM "&&VEDnnn    "
C . SI CHOIX = 2 :
...
C                      12345678   90123456   789      01234
        ...
        ZK24(IAUX+8) = BASENO  //'VAR_CP_1'//SAUX03//'     '
        ZK24(IAUX+9) = BASENO  //'VAR_CP_2'//SAUX03//'     '
...
C                        12345   678      9012345678901234
        ZK24(IAUX+10) = '&&VEC'//SAUX03//'                '
        ZK24(IAUX+11) = '&&VED'//SAUX03//'                '
