...
C 0.3. ==> VARIABLES LOCALES
      ...
      INTEGER NBMA,JNBPGM,JNBPMM,NNCP,NAUX,NCMPRF,JAUX,JCESL,JNOCMP
      REAL*8 EPSI,LCOEF(2),R8B
      CHARACTER*1 KBID
      CHARACTER*3 PROLZ
      CHARACTER*4 ACCE
      ...
      INTEGER NBCMPV,IAUX,NPAS0,JSNI,ITPS0,N3
      ...
      LOGICAL EXISTM,IDENSD,MATCST,COECST,LLOG(2)
