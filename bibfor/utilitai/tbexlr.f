...
C
      ...
      IF ( IRET .EQ. 0 ) THEN
         CALL UTMESS('F','TBEXLR','LA TABLE N''EXISTE PAS') 
      ENDIF
...
C
      ...
      NBLIGN = ZI(JTBNP+1)
      IF ( NBPARA .EQ. 0 ) THEN
         CALL UTMESS('F','TBEXLR','PAS DE PARAMETRES DEFINIS') 
      ENDIF
      IF ( NBLIGN .EQ. 0 ) THEN
         CALL UTMESS('F','TBEXLR','PAS DE LIGNES DEFINIES') 
      ENDIF
C
...
C
 ...
 10   CONTINUE
      IF ( NBPR .EQ. 0 ) THEN
         CALL UTMESS('F','TBEXLR','PAS DE PARAMETRES DE TYPE I ET R') 
      ENDIF
C
...
C
 ...
 20   CONTINUE
      IF ( NBLG .EQ. 0 ) THEN
         CALL UTMESS('F','TBEXLR','PAS DE LIGNES SELECTIONNEES') 
      ENDIF
C
      ...
      DO 30 I = 1 , NBLG
         ...
         DO 32 J = 1 , NBPR
            ...
            IF ( ZL(JLOGQ+ILIG-1) ) THEN
               ...
               KCOL1 = KCOL1 + 1
               IF ( IVIDE .EQ. 1 ) THEN
                  CALL UTMESS('F','TBEXLR','TABLE NON DIAGONALISABLE') 
               ENDIF
               IF ( TYPE(1:1) .EQ. 'I' ) THEN
                  K1 = K1 + 1
