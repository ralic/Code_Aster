     ...
     &              NDEG,THLAGR,GLAGR,MILIEU,THETLG,ALPHA,
     &              NBPRUP,NOPRUP,FISS,
     &              LONVEC,IVEC,VCHAR,RESUCO)
      IMPLICIT NONE        
C
      INTEGER NCHA,NBPRUP,LONVEC,IVEC,NNOFF,NDEG
      REAL*8 ALPHA
      CHARACTER*8 MODELE,THETAI,FISS,LATABL
      CHARACTER*8 SYMECH,RESUCO
      CHARACTER*16 OPTION,NOPRUP(*)
      CHARACTER*24 CHFOND,MATE,COMPOR,THETLG,BASLOC,COURB,VCHAR
      LOGICAL THLAGR,GLAGR,MILIEU

C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF UTILITAI  DATE 28/08/2006   AUTEUR GALENNE E.GALENNE 
C ======================================================================
...
C
      ...
      CHARACTER*4  K4B
      CHARACTER*8  K8B
      CHARACTER*16 K16BID,OPTIO2,LISTK(3)
...
C CALCUL DE K POUR CHACUNE DES SITUATIONS
      ...
      DO 1 I = 1,LONVEC
         ...
         IF (IRET.NE.0) THEN
           CALL UTDEBM('F','NMAXKL','ACCES IMPOSSIBLE ')
...
3         CONTINUE
        CALL JEDETR('&&MMAXKL.TMP')
      ELSE
        CALL UTMESS('F','MMAXKL','MOT-CLEF <SIGNES> OBLIGATOIRE'//
     &                  ' AVEC OPTION CALC_K_MAX !')
      ENDIF
...
C
 ...
 60   CONTINUE
     ...
     &              1,NDEG,THLAGR,GLAGR,MILIEU,THETLG,ALPHA,EXITIM,
     &              TIME,NBPRUP,NOPRUP,FISS)
...
C
      ...
      CALL WKVECT('&&MMAXGL.TABR','V V R',5,IPR)
      CALL WKVECT('&&MMAXGL.TABI','V V I',LONVEC+1,IPI)
