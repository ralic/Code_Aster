...
C MODIF UTILITAI  DATE 27/02/2012   AUTEUR DEVESA G.DEVESA 
C ======================================================================
...
C     
      ...
      ELSEIF (CHAINE(1:15).EQ.'COEF_MASS_SHIFT') THEN
        NDYNLO = ZL(JLOSD+14-1)  
      ELSEIF (CHAINE(1:8).EQ.'VECT_ISS') THEN
        NDYNLO = ZL(JLOSD+15-1)
      ELSEIF (CHAINE(1:13).EQ.'AMOR_RAYLEIGH') THEN
