      SUBROUTINE CFCARN(NOMA  ,DEFICO,RESOCO,NEWGEO,POSNO ,
     &                  NBDDL ,COORNO,TYPNOE,NOMNO )
C     
...
C
      CHARACTER*24 PDDL,TYPENO
      INTEGER      JPDDL,JTYPNO
      INTEGER      JCOOR
      INTEGER      NUMNO,CODRET,IRET
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ ()
...
C      
      IF (ZI(JTYPNO+POSNO -1).EQ.1) THEN
        TYPNOE = 'MAIT'
      ELSEIF (ZI(JTYPNO+POSNO -1).EQ.-1) THEN
        TYPNOE = 'ESCL'
      ELSE
        CALL ASSERT(.FALSE.)
      ENDIF      
