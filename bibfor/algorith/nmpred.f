     ...
     &                   LMODAL, DEPDEL, LSSTRU, ACCGEM, ACCGEP,
     &                   VITGEM, VITGEP, DEPGEM, DEPGEP, RIGGEN, 
     &                   AMOGEN, FONGEN, FORGEN, IALGO,  SECOLD, 
     &                   CNFOLD, FOPREC)
...
C TOLE CRP_21
      ...
      CHARACTER*24 VITKM1, VALMOD,SECOLD
...
C -- PREDICTION PAR DEPLACEMENT CALCULE
     ...
     &              COMPOR, LISCHA, MEDIRI, METHOD, SOLVEU,
     &              PARMET, CARCRI, PILOTE, PARTPS, NUMINS,
     &              VALMOI, POUGD , VALPLU, SECMBR, DEPPIL, 
     &              LICCVG)
