...
C
      IMPLICIT NONE
      INTEGER      NUMINS, LICCVG(*), NONDP 
      REAL*8       PARMET(*), INST(*)
      REAL*8       PARCRI(*), CONV(*)
      LOGICAL      PREMIE, LONDE, LIMPED, FOPREC
      CHARACTER*8  MODEDE
      CHARACTER*14 PILOTE
      CHARACTER*16 METHOD(*)
      CHARACTER*19 LISCHA, SOLVEU, PARTPS, SDDYNA
      ...
      CHARACTER*24 MEMASS, DEPENT, VITENT, STADYN, CHONDP
      CHARACTER*24 VITKM1, SECOLD, RIGID
...
C
     ...
     &              VALPLU,SECMBR,DEPPIL,LICCVG,SDDYNA)
