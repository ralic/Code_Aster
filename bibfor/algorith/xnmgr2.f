      SUBROUTINE  XNMGR2(POUM,ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,NFE,
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      LOGICAL  GRDEPL,GRROTA,AXI,CPLAN,RESI,RIGI
      REAL*8   F(3,3),FM(3,3),FR(3,3),EPSM(6),EPSP(6),DEPS(6)
      REAL*8   DSIDEP(6,6),R,SIGMA(6),FTF,DETF
      REAL*8   POIDS,TEMP,TMP1,TMP2,SIG(6),FE(4),BASLOG(6)
