...
C
        CALL MDACCE(TYPBAS,NEQGEN,PULSAT,ZR(JPULS),ZR(JMASS),DESCM,
...
C     --- ACCELERATIONS GENERALISEES INITIALES ---
C
        CALL MDACCE(TYPBAS,NEQGEN,PULSAT,PULSA2,MASGEN,DESCM,RIGGEN,
...
C
              CALL MDACCE(TYPBAS,NEQGEN,PULSAT,ZR(JPULS),ZR(JMASS),
...
C
              NBACC = NBACC + 1
              CALL MDACCE(TYPBAS,NEQGEN,PULSAT,PULSA2,MASGEN,DESCM,
