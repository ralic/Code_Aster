...
C
      ...
      CHARACTER*24 APPOIN,APCOEF,APDDL,JEUALG
      INTEGER      JAPPTR,JAPCOE,JAPDDL,JJEUAL
      CHARACTER*24 APJEU,APCOFR,APJEFX
      INTEGER      JAPJEU,JAPCOF,JAPJFX
      INTEGER      CFDISD,NBLIAI,NEQ,NBLIAC,LLF,LLF1,LLF2,NDIM
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ ()
