...
C
      ...
      CHARACTER*16  METHOD(*)
      CHARACTER*19  LISCHA,SDDYNA,SDNURO,SDPILO
...
C
      INTEGER      NVEA,NSOL,NVAL
      PARAMETER    (NVEA=32,NSOL=17,NVAL=18)
C
      ...
      CHARACTER*19 VEASST(NVEA),SOLALT(NSOL),VALINT(NVAL,2)
...
C
     ...
     &              SDPILO,ITERAT,SDNURO,VALINT(1,ACT),SOLALG,
     &              VEELEM,VEASST,SDTIME,NBEFFE,IRECLI,
