...
C
      ...
      INTEGER      TYPALC,TYPALF,MATTAN
      INTEGER      JSOLVE
      LOGICAL      ISFONC,NDYNLO
      LOGICAL      LFETI,LCTCC,LCTCD,LPILO,LRELI,LMACR,LUNIL
      LOGICAL      LCTCV,LFROT,LMVIB,LFLAM,LEXPL,LCONT,LXFEM
      LOGICAL      LMUMPS,LGCPC,LSYME,LMUMPD,LIMPEX,LGCP
      LOGICAL      LONDE,LDYNA,LSENS,REAROT,LTHETA
      CHARACTER*24 K24BID
      INTEGER      IFM,NIV
C
C ---------------------------------------------------------------------
...
C
      ...
      TYPALF = 0
      IF (LCTCD) THEN
        CALL CFDISC(DEFICO,' ',TYPALC,TYPALF,IBID,MATTAN)
      ENDIF
      LFROT = ABS(TYPALF).NE.0
      LGCP  = ABS(TYPALC).EQ.6
C
C --- INITIALISATIONS
C
