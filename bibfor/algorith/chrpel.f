...
C        SI LE NOUVEAU REPERE EST DONNE VIA DES VECTEURS
         ...
         ELSE
           IF (NDIM.EQ.3) THEN
            CALL GETVR8('AFFE','ANGL_NAUT',1,IARG,3,ANGNOT,IBID)
            IF (IBID.NE.3) THEN
               CALL U2MESS('F','ALGORITH2_7')
            ENDIF
           ELSE
            CALL GETVR8('AFFE','ANGL_NAUT',1,IARG,1,ANGNOT(1),IBID)
            IF (IBID.NE.1) THEN
                           VALR = ANGNOT(1)
...
C REPERE CYLINDRIQUE
     ...
     &                TYCH, IRET)
         IF (NDIM.EQ.3) THEN
            CALL GETVR8('AFFE','ORIGINE',1,IARG,3,ORIG,IBID)
            IF (IBID.NE.3) THEN
               CALL U2MESS('F','ALGORITH2_8')
            ENDIF
            CALL GETVR8('AFFE','AXE_Z',1,IARG,3,AXEZ,IBID)
            IF (IBID.EQ.0) THEN
               CALL U2MESS('F','ALGORITH2_9')
            ENDIF
         ELSE
            CALL GETVR8('AFFE','ORIGINE',1,IARG,2,ORIG,IBID)
            IF (IBID.NE.2) THEN
