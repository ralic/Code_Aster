...
C
      LOGICAL      ISFONC,LGROT,NDYNLO,LDYNA,LEXPL,LCONT
      LOGICAL      CFDISL,LALLV,LNKRY
      INTEGER      NEQ,IRET,I
      CHARACTER*8  K8BID
