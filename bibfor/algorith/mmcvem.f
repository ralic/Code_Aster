      SUBROUTINE MMCVEM(PHASE ,MODELE,NOMA  ,DEFICO,RESOCO,
...
C IN  DEFICOCO : SD POUR LA DEFINITION DE CONTACT
...
C OUT VECTCE : VECT_ELEM DE CONTACT OU DE FROTTEMENT
C
C ----------------------------------------------------------------------
C
      CHARACTER*16 OPTION
...
C
      CALL MMCVEC(OPTION,MODELE,RESOCO,DEPMOI,DEPDEL,
