...
C
      ...
      LOGICAL      LTAB, LFREQF, LFREQI, LNBPN, LINTER, LPREM
      INTEGER      IARG
C
...
C===============
      ...
      CALL GETVID (' ', 'INTE_SPEC'     , 0,IARG,1, NOMINT, L )
