...
C 
      IF ( LTAB.AND.(N1.EQ.0) ) THEN
        CALL UTMESS('F','GEFACT','LE TYPE DE CONCEPT: TABLE_SDASTER'//
      ...
      IF (LINTER) THEN
        ...
        DO 100 II = 1,NBVAL-1
          ...
          IF (DIFPAS.GT.PREC) THEN
            CALL UTMESS('F','GEFACT','PAS DE DISCRETISATION'//
  ...
  100   CONTINUE
        DO 20 I = 2,NBFC
          ...
          IF (NBVALU.NE.NBVAL3) THEN
            CALL UTMESS('F','GEFACT','DISCRETISATIONS DIFFERENTES'//
