      SUBROUTINE NIFN3B(OPTION, NNO1, NNO2, NPG, IPOIDS, IVF1, IVF2,
...
C TOLE CRS_1404
      ...
      REAL*8 GEOM(3,NNO1),DFDI(NNO1,3), SIG(7,NPG)
      REAL*8 FINTU(3,20), FINTA(1,8), DEPLM(3,NNO1), GONFLM(1,NNO2)
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8 TMP, RAC2, RBID, DEF(6,20,3), ALPHA, F(3,3), POIDS
      REAL*8 EPSM(6), SIGMA(6), PM, DIVUM, DDOT, TREPST
      REAL*8 DGOVID(1,NNO1), DSBDEP(6,6), KBB(3,3), KBP(3,4), KCE(4,4)
      REAL*8 RCE(1,4)
C --------------------------------------------------------------------
...
C - CALCUL DE LA MATRICE DE CONDENSATION STATIQUE
        CALL CALKBB(NNO1, 3, .FALSE., 0.D0, KPG, GEOM, IVF1,
     &               F, IPOIDS, IDFDE1, DSBDEP, KBB )
        CALL CALKBP(NNO2, 3, .FALSE., 0.D0, KPG, GEOM, IVF2, IPOIDS,
     &              IDFDE1,KBP)
        CALL CALKCE(NNO1, 3, KBP, KBB, GONFLM, DGOVID, KCE, RCE)
