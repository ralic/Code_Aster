...
C
      ...
      DO 666 I=1,NBMOD
        ...
        CALL R8COPY(NEQ,ZR(LLCHAM),1,ZR(LTVECA+(I-1)*NEQ),1)
        CALL JELIBE(CHAMVA)
 ...
 666  CONTINUE
      DO 667 I=1,NBDDR
        ...
        CALL JEVEUO(CHAMVA,'L',LLCHAM)
        CALL R8COPY(NEQ,ZR(LLCHAM),1,ZR(LTVECB+(I-1)*NEQ),1)
        CALL JELIBE(CHAMVA)
 ...
 667  CONTINUE
      DO 668 I=1,NBDDR
        ...
        CALL DCAPNO(BASMOD,'DEPL    ',IORD,CHAMVA)
        CALL JEVEUO(CHAMVA,'L',LLCHAM)
        CALL R8COPY(NEQ,ZR(LLCHAM),1,ZR(LTVECC+(I-1)*NEQ),1)
        CALL JELIBE(CHAMVA)
 ...
 668  CONTINUE
      IF(NBDAX.GT.0) THEN
        DO 669 I=1,NBDAX
          ...
          CALL DCAPNO(BASMOD,'DEPL    ',IORD,CHAMVA)
          CALL JEVEUO(CHAMVA,'L',LLCHAM)
          CALL R8COPY(NEQ,ZR(LLCHAM),1,ZR(LTVECD+(I-1)*NEQ),1)
          CALL JELIBE(CHAMVA)
...
C
        ZR(LDK0II+KTRIAN) = R8DOT(NEQ,ZR(LTVEC1),1,
     &    ZR(LTVECA+(I-1)*NEQ),1)
        ZR(LDM0II+KTRIAN) = R8DOT(NEQ,ZR(LTVEC3),1,
     &   ZR(LTVECA+(I-1)*NEQ),1)
        KTRIAN = KTRIAN + 1
        DO 20 J=I-1,1,-1
           ZR(LDK0II+KTRIAN) = R8DOT(NEQ,ZR(LTVEC1),1,
...
C
        ZR(LDK0JJ+KTRIAN) = R8DOT(NEQ,ZR(LTVEC1),1,
     &                      ZR(LTVECB+(I-1)*NEQ),1)
        ZR(LDM0JJ+KTRIAN) = R8DOT(NEQ,ZR(LTVEC3),1,
     &                      ZR(LTVECB+(I-1)*NEQ),1)
C
...
C
        DO 65 J=1,NBMOD
           XPROD= R8DOT(NEQ,ZR(LTVEC1),1,ZR(LTVECA+(J-1)*NEQ),1)
           CALL AMPPR(ZR(LDK0IJ),NBMOD,NBDDR,XPROD,1,1,J,I)
           XPROD= R8DOT(NEQ,ZR(LTVEC3),1,ZR(LTVECA+(J-1)*NEQ),1)
...
C
        IF(NBDAX.GT.0) THEN
          DO 75 J=1,NBDAX
            XPROD= R8DOT(NEQ,ZR(LTVEC1),1,ZR(LTVECD+(J-1)*NEQ),1)
            CALL AMPPR(ZR(LDK0AJ),NBDAX,NBDDR,XPROD,1,1,J,I)
            XPROD= R8DOT(NEQ,ZR(LTVEC3),1,ZR(LTVECD+(J-1)*NEQ),1)
...
C ----- CALCUL TERME DIAGONAL
C
        XPROD= R8DOT(NEQ,ZR(LTVEC1),1,ZR(LTVECC+(I-1)*NEQ),1)
        CALL AMPPR(ZR(LTKGG),NBDGA,NBDGA,XPROD,1,1,I,I)
        XPROD= R8DOT(NEQ,ZR(LTVEC3),1,ZR(LTVECC+(I-1)*NEQ),1)
...
C
        DO 90 J=1,NBDDR
          XPROD= R8DOT(NEQ,ZR(LTVEC1),1,ZR(LTVECB+(J-1)*NEQ),1)
          CALL AMPPR(ZR(LTKDG),NBDDR,NBDDR,XPROD,1,1,J,I)
          XPROD= R8DOT(NEQ,ZR(LTVEC3),1,ZR(LTVECB+(J-1)*NEQ),1)
...
C
        DO 100 J=1,I-1
          XPROD= R8DOT(NEQ,ZR(LTVEC1),1,ZR(LTVECC+(J-1)*NEQ),1)
          CALL AMPPR(ZR(LTKGG),NBDGA,NBDGA,XPROD,1,1,J,I)
          CALL AMPPR(ZR(LTKGG),NBDGA,NBDGA,XPROD,1,1,I,J)
          XPROD= R8DOT(NEQ,ZR(LTVEC3),1,ZR(LTVECC+(J-1)*NEQ),1)
