      SUBROUTINE GGPEPR(S,DPC,T,FLUPHI,VALDRP,TTAMAX,DEUXMU,
     *                  PREC,G,DGDST,DGDEV)
...
C
      IF (S.EQ.0.D0.OR.DPC.EQ.0.D0)THEN
        ...
        GO TO 99
      ELSE
        CALL TPSEPR(TPS,S,DPC,T,FLUPHI,VALDRP,TTAMAX,PREC)
        CALL FGDEPR(TPS,S,T,FLUPHI,VALDRP,TTAMAX,F1,FP1,FS1,F2,
