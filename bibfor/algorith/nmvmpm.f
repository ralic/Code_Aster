...
C MODIF ALGORITH  DATE 22/05/2000   AUTEUR JMBHH01 J.M.PROIX 
C ======================================================================
...
C
     ...
     &              NOMRE2,VALRES,CODRET,'FM')
        ...
        PUISS = VALRES(4)
        IF (SY .GE. SU) THEN
           CALL UTMESS('F','TE0346','SY >= SU. IMPOSSIBLE.')
        ENDIF
      ENDIF
        IF (EP .GE. E) THEN
           CALL UTMESS('F','TE0346','EP >= E. IMPOSSIBLE.')
        ENDIF
        EP = E*EP/(E-EP)
C
C     NP,MEY,CAY,...,MPX
C
     ...
     &              NOMRE3,VALRES,CODRET,'FM')
      ...
      IF (XMEY .GT. XMPY) THEN
         CALL UTMESS('F','VMIS_POU_','INCOHERENCE DANS LES '//
     &               'DONNEES MATERIAU : MEY > MPY IMPOSSIBLE.')
      ENDIF
      
      IF (XMEZ .GT. XMPZ) THEN
         CALL UTMESS('F','VMIS_POU_','INCOHERENCE DANS LES '//
     &               'DONNEES MATERIAU : MEZ > MPZ IMPOSSIBLE.')
      ENDIF
C
