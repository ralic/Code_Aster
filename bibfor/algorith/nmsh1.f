...
C
      ...
      REAL*8 FDM(3,3),FMAM(3,3), FTA(3,3)
      REAL*8 DEPLDA(3*27), DEPLT(3*27)
      REAL*8 SIG(6),SIGMAM(6),SIGG(6)
      REAL*8 ETDPNV(6),EDPN1(3,3),PRODF(3,3),ETDPN1(3,3)
      REAL*8 JM,JP,R,POIDS
      ...
      REAL*8 TBID(6),RBID,R8BID,ID(3,3),R8VIDE
      REAL*8 EPSM(6),EPSMM(6)
      REAL*8 RP(3,3),RPA(3,3)
      REAL*8 RPAT(3,3),ETDM(3,3),LAMBP(3,3)
      REAL*8 RPT(3,3)
...
C---------------------TRANSFORMATION DES ARG D ENTRE SUBROUTINE NMCOMP
     ...
     &         IVF,IDFF,DEPLM,.TRUE.,R8BID,DFF,FM,EPSM,R8BID)
