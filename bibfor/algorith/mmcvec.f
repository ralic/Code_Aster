      SUBROUTINE MMCVEC(MODELE,RESOCO,DEPMOI,DEPDEL,VITMOI,VITPLU,
     &                  ACCMOI)
C
...
C
      ...
      LOGICAL      EXIGEO
      INTEGER      IFM,NIV
      CHARACTER*19 LIGRCF,CARTCF,SCON19
      CHARACTER*24 MELEME
      INTEGER      JMELEM
      CHARACTER*8  SCONEL
C
...
C
      LPAOUT = 'PVECTUR'
      LCHOUT = SCON19(1:8) // '.VE001'
      CALL CALCUL('S','CHAR_MECA_CONT',LIGRCF,8,LCHIN,LPAIN,1,LCHOUT,
     &           LPAOUT,'V')
      CALL REAJRE(SCON19,LCHOUT,'V')
      CALL REAJRE(VECCON,LCHOUT,'V')
C
C --- PARTIE FROTTEMENT
C
      LPAOUT = 'PVECTUR'
      LCHOUT = SCON19(1:8) // '.VE002'
      CALL CALCUL('S','CHAR_MECA_FROT',LIGRCF,8,LCHIN,LPAIN,1,LCHOUT,
     &           LPAOUT,'V')
      CALL REAJRE(SCON19,LCHOUT,'V')
      CALL REAJRE(VECFRO,LCHOUT,'V')
C
      CALL JEDEMA()
      END
