      SUBROUTINE COPNOR(NOMA,POSMA,XPG,YPG,NEWGEO,DEFICO,
     & LTANG1,LTANG2)
...
C.......................................................................
      ...
      INTEGER NUTYP,ITYP,NNO,JDEC,INO,POSNNO(9),I,J,JNOESC
      REAL*8 FF(9),XPG,YPG
      REAL*8 VECTA1(27),VECTA2(27)
      CHARACTER*8  ALIAS
      CHARACTER*24 PZONE,CONTMA,CONTNO,NOMACO,PNOMA,NOESCL
C-----------------------------------------------------------------------
C
      CALL JEMARQ()
...
C   RECUPERATION DE LA GEOMETRIE DES NOEUDS
      ...
      DO 10 INO = 1,NNO
        ...
        VECTA1(3*(INO-1)+1)=ZR(JNOESC+10*(POSNNO(INO)-1)+1+4)
        VECTA1(3*(INO-1)+2)=ZR(JNOESC+10*(POSNNO(INO)-1)+1+5)
        VECTA1(3*(INO-1)+3)=ZR(JNOESC+10*(POSNNO(INO)-1)+1+6)
        VECTA2(3*(INO-1)+1)=ZR(JNOESC+10*(POSNNO(INO)-1)+1+7)  
        VECTA2(3*(INO-1)+2)=ZR(JNOESC+10*(POSNNO(INO)-1)+1+8)
        VECTA2(3*(INO-1)+3)=ZR(JNOESC+10*(POSNNO(INO)-1)+1+9)
   10 CONTINUE
