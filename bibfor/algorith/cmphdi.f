     ...
     &NDIMAX,CMAT1,CMAT2,CVECT,CVECT1,CVECT2,ALPHA,BETA,LAMBD1,LAMBD2,
     &INTERV,IFIC)
...
C CVECT2   /M/: VECTEUR COMPLEXE DE TRAVAIL
...
C
      ...
      COMPLEX*16 CK(*),CM(*)
      COMPLEX*16 CEIGEN(NBMOD),CMOD(NDIMAX,NBMOD)
      COMPLEX*16 CMAT1(*),CMAT2(NDIM,NDIM)
      COMPLEX*16 CVECT(NDIM),CVECT1(NDIM),CVECT2(NDIM)
...
C
 30     CONTINUE
        ...
        IF(IRETOU.EQ.1) CALL UTMESS('F','MODE_ITER_CYCL','VECTEUR  '//
     &              'DE NORME NULLE  ')
        CALL CTESCV(CVECT1,CMOD(1,J),NDIM,ECART)
