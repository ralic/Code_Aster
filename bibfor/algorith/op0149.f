...
C
      ...
      MODEFL = ZK8(IREFFL+1)
      IF (BASEMO.NE.MODEFL) CALL UTMESS('F','OP0149','LE CONCEPT '//
...
C
      ...
      IF (NUMVIT.LE.0 .OR. NUMVIT.GT.NBVITE) CALL UTMESS('F','OP0149',
...
C
      ...
      IF (.NOT.LNUOR .AND. LAMOR .AND. NBAMO1.NE.NBMOD2) THEN
        CALL UTMESS('F','OP0149','TOUS LES MODES NON COUPLES ETANT '//
...
C
          IF (NBNUO2.EQ.0) THEN
          CALL UTMESS('F','OP0149','LES NUMEROS D ORDRE FOURNIS NE '//
