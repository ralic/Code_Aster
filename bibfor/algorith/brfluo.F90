...
!      I=5   => SIGMA 13
!      I=6   => SIGMA 23
!        PARTITION DES CONTRAINTES EN PARTIE POSITIVE ET PARTIE NÈGATIVE
...
30  end do
!     DEFORMATION VISCOPLASTIQUE POSITIVES LIMITES ASSOCIÈES AUX
...
!       CONTRAINTES EFFECTIVES PRINCIPALES ET MATRICE DE PASSAGE ‡
!       LA BASE PRINCIPALE
    do 40 i = 1, 3
        do 50 j = 1, 3
            x33(i,j)=sut33(i,j)
