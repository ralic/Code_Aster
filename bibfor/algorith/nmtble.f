...
C RESPONSABLE PBADEL P.BADEL
      ...
      INTEGER      NIVEAU,MAXB(4),COMGEO,CSEUIL,COBCA,ICONTX
      CHARACTER*8  MAILLA
      CHARACTER*24 DEFICO,OLDGEO,NEWGEO,DEPMOI,DEPGEO,DEPLAM
      CHARACTER*24 DEPPLU,MODELE
      REAL*8       INST(3)
      LOGICAL      DECOL      
C ----------------------------------------------------------------------
C
...
C -------------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ----------------
      ...
      IF (ICONTX.EQ.0) THEN
       CALL MMMBCA(MAILLA,DEFICO,OLDGEO,DEPPLU,DEPMOI,INCOCA,INST,DECOL)
      ELSE
C       CAS X-FEM
...
C     MAXB(4)=1 SI FROTTEMENT='SANS'
C     MAXB(4)=3 SI FROTTEMENT='COULOMB'
