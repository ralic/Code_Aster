...
C    DIMANV = DIMENSION MAX DE LA LISTE DU NOMBRE DE VAR INT EN THM
      ...
      CHARACTER*19 CODI,SDDISC,K19B,SDCRIT,TABINC
      REAL*8       INSTAM,INSTAP,ANG(7),R8B,CARCRI(9),FEM(9)
      REAL*8       DEPS(9),SIGM(6),SIGP(6),EPSM(9),EPS(9)
...
C        6 CMP DE EPSI OU 9 CMP DE GRAD DONNEES : PAS BESOIN DE NEWTON 
 ...
 30            CONTINUE
     ...
     &         CARCRI,INSTAM,INSTAP,NCMP,EPSM,DEPS,6,SIGM,VIM,OPT2,
...
C           CALCUL DU RESIDU
     ...
     &             INSTAM,INSTAP,6,EPSM,DEPS,6,SIGM,VIM,OPTION,
...
C           VERIFICATION DES EVENT-DRIVEN
  500       CONTINUE
            ...
            CALL PMSTA1(SIGM,SIGP,DEPS,VIM,VIP,NBVARI,NBVITA,
