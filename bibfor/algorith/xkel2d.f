...
C TOLE CRP_21
      ...
      CHARACTER*24  COORSE
      REAL*8        BASLOC(6*NNOP),CRIT(3),T(NNOP),TREF,HE,HYDR(NNOP)
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8   POIDS,TEMP,TMP1,TMP2,SIGP(6),HYDRG,SECHG,FE(4),BASLOG(6)
...
C - DE L HYDRATATION ET DU SECHAGE AU POINT DE GAUSS PARENT
