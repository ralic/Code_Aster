     ...
     1                      NMAT,MATERD,MATERF,TIMED,TIMEF,INTG,
     2                      NR, NVI, YD,EPSD,   DEPS, DY,COMP,NBCOMM,
     3                      CPMONO, PGL,NFS,NSG,TOUTMS,VIND,SIGD,
     4                      SIGF,EPSTR,BNEWS,MTRAC,INDI,IRET)
        IMPLICIT   NONE
C       ================================================================
...
C           BNEWS  :  GESTION TRACTION AVEC HUJEUX (IN/OUT)
C           MTRAC  :  GESTION TRACTION AVEC HUJEUX (BIS) (IN/OUT)
