      SUBROUTINE NSCOMP(OPTION,TYPMOD,COMPOR,NDIM,IMATE,EPS,DEPS,DEDT,
...
C
     ...
     &    (COMPOR(1)(1:9).EQ.'VMIS_ISOT')) THEN
        CALL NSISOT (OPTION,COMPOR,NDIM,IMATE,DEPS,DEDT,SIGMS,
     &     VARMS,VARM,SIGM,VARP,SIPAS,SIGP,SIGPS,VARPS,STYPSE)
      ELSEIF (COMPOR(1)(1:14).EQ.'DRUCKER_PRAGER') THEN
        CALL NSDRPR (OPTION,TYPMOD,COMPOR,NDIM,IMATE,DEPS,DEDT,SIGMS,
     &     VARMS,VARM,SIGM,VARP,SIPAS,SIGP,SIGPS,VARPS,STYPSE)
      ELSE
