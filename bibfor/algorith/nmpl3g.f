       SUBROUTINE  NMPL3G(NNO,NNOB,NPG,POIDSG,VFF,VFFB,DFDE,DFDEB,DFDN,
     &                    DFDNB,DFDK,DFDKB,GEOM,TYPMOD,NDIM,
...
C.................FIN MODIFS............................................
      ...
      INTEGER KPG,KU,N,I,M,J,J1,KL,K,KP,KKL,PQ,COD(27)
      ...
      REAL*8 CCC
      REAL*8 RAC2
      REAL*8 E, NU, LAMBDA, DEUXMU, ADIME
...
C -  CALCUL DE LA MATRICE DE RIGIDITE EPSRM/U
          ...
          DO 193 M=1,NNOB
            DO 183 N=1,NNO
              DO 173 PQ=1,NDIMSI
                DO 163 J=1,NDIM
                  MATEU(PQ,M,N,J) = MATEU(PQ,M,N,J)- VFFB(M,KPG)*
     &                DEF(PQ,N,J)*POIDS
 163            CONTINUE
 173          CONTINUE
 183        CONTINUE
