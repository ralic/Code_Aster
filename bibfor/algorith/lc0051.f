      SUBROUTINE LC0051(FAMI,KPG,KSP,NDIM,IMATE,COMPOR,CRIT,INSTAM,
...
C               CODRET  CODE RETOUR (0 SI OK, 1 SI ECHEC)
C ======================================================================
      
      CALL LCEIAB(FAMI,KPG,KSP,IMATE,OPTION,EPSM,DEPS,SIGP,
     &            DSIDEP,VIM,VIP,TAMPON,CODRET)
