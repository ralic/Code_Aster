      SUBROUTINE NMIBLE(NIVEAU,PREMIE,NOMA,DEFICO,OLDGEO,NEWGEO,
     &               DEPMOI,DEPGEO,MAXB,DEPLAM,COMGEO,CSEUIL,COBCA,
     &               NEQ,DEPDEL,DDEPLA,DEPPLU,LIGRCF,CARTCF,MODELE,
     &               LISCHA,SOLVEU,NUMEDD,MCONEL,SCONEL,MATASS,MEMASS,
     &               MASSE,VITPLU,VITMOI,ACCPLU,ACCMOI,VITINI,ACCINI,
     &               CMD,INST,ICONTX)
C
...
C 
      ...
      IF (.NOT.ICONTX) THEN
        CALL CONLIG(NEQ,DEPDEL,DDEPLA,DEPMOI,DEPPLU,DEFICO,NOMA,
     &              LIGRCF,CARTCF,MODELE,LISCHA,SOLVEU,NUMEDD,MCONEL,
     &              SCONEL,MATASS,MEMASS,MASSE,PREMIE,CMD,INST,VITMOI,
     &              ACCMOI)
      ELSE
C       CAS X-FEM
