      SUBROUTINE EXPRLI(BASMDZ,LINTFZ,NMINTZ,NUMINT,FAMPRZ,II)
...
C
      ...
      CHARACTER*1 K1BID
      CHARACTER*8 BASMOD,NOMINT,LINTF,KBID,BLANC,NOMG
...
C
      KBID=' '
      CALL BMRDDA(BASMOD,KBID,NOMINT,NUMINT,0,IBID,NBDDL)
      KBID=' '
