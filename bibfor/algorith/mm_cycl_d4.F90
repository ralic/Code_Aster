subroutine mm_cycl_d4(sd_cont_solv, point_index, indi_cont_curr)
!
    implicit     none
!
#include "jeveux.h"
...
!
    ...
    integer, intent(in) :: indi_cont_curr
!
! --------------------------------------------------------------------------------------------------
!
! Contact - Cycling
...
! In  indi_cont_curr : current contact indicator
!
! --------------------------------------------------------------------------------------------------
!
...
!
    ...
    statut(cycl_long) = indi_cont_curr
