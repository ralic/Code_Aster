      SUBROUTINE NMCOMP (KPGVRC,NDIM,TYPMOD,IMATE,COMPOR,CRIT,
     &                   INSTAM,INSTAP,
     &                   TM,TP,TREF,
     &                   HYDRM,HYDRP,
     &                   SECHM,SECHP,SREF,
...
C TOLE CRP_21
      IMPLICIT NONE
      INTEGER            KPGVRC,NDIM,IMATE,NZ,CODRET
      CHARACTER*8        TYPMOD(*)
...
C-- INTEGRATION IMPLICITE: METHODE D'EULER
     ...
     &           COMPOR(1)(1:10) .EQ. 'VISC_IRRA_' ) THEN
          IF ( INT(CRIT(6)) .EQ. 0 ) THEN
            CALL NMVPIR (KPGVRC,NDIM,TYPMOD,IMATE,COMPOR,CRIT,
     &                  INSTAM,INSTAP,
     &                  TM,TP,TREF,
     &                  DEPS,
     &                  SIGM,VIM,
...
C----LOI D'ACIER CORRODE
     ...
     &          'INTEGRATION EXPLICITE DU COMPORTEMENT NON PROGRAMMEE')
          ELSE
          CALL NM3DCO(KPGVRC,NDIM,OPTION,IMATE,TM,TP,SIGM,
