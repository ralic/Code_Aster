...
C
      REAL*8       PARMET(30), PARCRI(11), CONV(21), ETAN, R8VIDE
...
C
      ...
      CHARACTER*24 LISINS
      CHARACTER*24 MASGEN, BASMOI, MERIGI, NOOBJ,VARIGV
C
C ----------------------------------------------------------------------
C
...
C
     ...
     &               NREAVI, LIMPED, LONDE, CHONDP, NONDP,K24BID,
     &               MULTIA, R8BID,IBID,K24BID,K24BID,LBID)
...
C -- INITIALISATION DES DEPLACEMENTS, VITESSES 
     ...
     &                 ACCENT,MULTIA,NBMODS,NBPASE,INPSCO,R8BID,
     &                 IBID,CMD,DEFICO,LOGBID,K24BID,K24BID,K24BID)
...
C -- ARCHIVAGE DES RESULTATS
     ...
     &             NBMODS,DEPENT,VITENT,ACCENT,LOGIC,MODELE,MATE,
     &             CARELE,LISCH2)
