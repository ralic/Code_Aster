...
C MODIF ALGORITH  DATE 22/07/2003   AUTEUR BOYERE E.BOYERE 
C ======================================================================
...
C
      ...
      CHARACTER*24 LISINS
      CHARACTER*24 MASGEN, BASMOI, MERIGI
C
C ----------------------------------------------------------------------
C
      ...
      DATA VITPLU, ACCPLU    /'&&OP0069.VITPLU', '&&OP0069.ACCPLU'/
      ...
      DATA DEPENT,VITENT     /'&&OP0069.DEPENT', '&&OP0069.VITENT'/
      DATA ACCENT            /'&&OP0069.ACCENT'/
...
C                       {An}={An+1}
C                       {Vn}={Vn+1}
      CALL MXMAJD(NEQ, REAROT, NURO, COEVI2, COEAC2, VITMOI, ACCMOI,
     &            VITPLU, ACCPLU)
