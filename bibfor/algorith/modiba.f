     ...
     &                    IMASSE,NUOR,AMOR,NBNUOR,NUMO,NBMFL)
      IMPLICIT NONE
...
C MODIF ALGORITH  DATE 08/12/98   AUTEUR KXBADNG F.BEAUD 
C ======================================================================
...
C IN  : AMOR   : LISTE DES AMORTISSEMENTS REDUITS MODAUX AFFECTES AUX
C                MODES NON PERTURBES PAR LE COUPLAGE FLUIDE-STRUCTURE
