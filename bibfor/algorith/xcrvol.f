...
C
C  BUT: ESTIMATION CRITERE DE RIGIDITE
C
...
C
        CALL REEREF(ELREFP,.FALSE., NBNOMA,IBID,ZR(IGEOM),BARY,1,
 ...
 190    CONTINUE
C       EN QUADRATIQUE : AUGMENTATION DU NOMBRE DE POINTS
 ...
 210      CONTINUE
          CALL REEREF(ELREFP,.FALSE., NBNOMA,IBID,ZR(IGEOM),POINT,IBID,
     &        .FALSE.,NDIM,RBID,RBID, RBID,
     &        IBID,IBID,IBID,IBID,IBID,IBID,RBID,RBID,'DFF',
     &        XE,FF,DFDI,RBID,RBID,RBID)
          DO 220 I=1,NDIM
