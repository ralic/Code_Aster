     ...
     &            INSTAP,NEPS,EPSM,DEPS,NSIG,SIGM,VIM,OPTION,ANGMAS,
     &            SIGP,VIP,NWKIN,WKIN,TYPMOD,ICOMP,NVI,NDSDE,DSIDEP,
     &            NWKOUT,WKOUT,CODRET)
...
C ======================================================================
      ...
      INTEGER ICOMP,NVI
      REAL*8 WKIN(NWKIN),WKOUT(NWKOUT),CRIT(*)
      REAL*8 EPSM(NEPS),DEPS(NEPS),SIGP(NSIG),VIM(NVI),VIP(NVI)
      REAL*8 DSIDEP(NDSDE),INSTAM,INSTAP,SIGM(NSIG),ANGMAS(3)
      CHARACTER*(*)   FAMI
      CHARACTER*8     TYPMOD(*)
...
C     FORMULATION NON-LOCALE A GRADIENT D'ENDOMMAGEMENT
      IF (TYPMOD(2).EQ.'GRADVARI') THEN
        ...
        CALL LCESGV (FAMI,KPG,KSP,NEPS,TYPMOD,OPTION,IMATE,EPSM ,DEPS,
     &               VIM,NINT(CRIT(1)),CRIT(3),SIGP,VIP,DSIDEP,
     &               CODRET)
        
C     ENDO_SCALAIRE N'EST PAS DISOPNIBLE POUR D'AUTRE FORMULATIONS
      ELSE
