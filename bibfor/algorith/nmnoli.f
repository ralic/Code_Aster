      SUBROUTINE NMNOLI(COMPOR,SDDISC,CARCRI,INERTE,CRITNL,
     &                  FONACT,DERNIE,MODELE,MAILLA,MATE  ,
     &                  SDSENS,CARELE,LISCHA,DEFICO,RESOCO,
     &                  SDDYNA)
C
...
C
     ...
     &                  CRITNL,CARCRI,INERTE,RESOCO,VALINI,INCR  ,
