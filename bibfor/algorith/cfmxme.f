...
C ----------------------------------------------------------------------
C
C ROUTINE CONTACT (METHODES CONTINUE ET XFEM)
C
...
C
      ...
      CHARACTER*24 MDECOL,CRNUDD,ETATCT
      INTEGER      JMDECO,JCRNUD,JETAT
      CHARACTER*24 TABFIN
      INTEGER      JTABF
      CHARACTER*24 VITINI,ACCINI 
      CHARACTER*24 APJEU ,JEUSUP,JEUSUR,FLIFLO
      INTEGER      JAPJEU,JJSUP ,JUSU  ,JFLIP
      INTEGER      CFDISI
      INTEGER      CFMMVD,ZTABF,ZETAT
      LOGICAL      CFDISL,LXFCM
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ()
...
C
      ...
      ENDIF      
C
C --- JEU SUPPLEMENTAIRE (DIST_* ET USURE) 
C      
