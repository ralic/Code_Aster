      SUBROUTINE CFPARN(RESOCO,POSNOE,POSNOM,IESCL)
C
...
C IN  POSNOM : POSITION DANS CONTNO DU NOEUD MAITRE APPARIE     
...
C
C --- NOEUD MAITRE APPARIE      
C
      ZI(JAPPAR+ZAPPA*(IESCL-1)+2) =  -POSNOM   
C      
