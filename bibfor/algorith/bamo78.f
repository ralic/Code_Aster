...
C
      ...
      CHARACTER*14 NUMDDL
      CHARACTER*24 NUMEDD
      CHARACTER*19 CHAMEL,CHAMGD,CHAM19,CHAMNO,CHGENE,LIGREL,CHS(2)
      CHARACTER*19 CHES1,CHEL1,CHES2,CHEL2,CHES3
      CHARACTER*16 NOSY,OPTION,OPTI(2)
      CHARACTER*24 CHSIG,CHEPS,CHFREQ,CHMASS
      ...
      CHARACTER*8  CTYPE,SDNOLI,K8BLA,MODELE,CHAREP,MATERI,CRIT
      CHARACTER*1  TYPCOE
      CHARACTER*2  CODRET      
      CHARACTER*24 TRGENE
      INTEGER      JTRGEN
...
C      
      ...
      CALL GETVID(' ','RESU_FINAL',1,1,1,K8BID,IEVNEW)
      MATERI = ' '
...
C      WRITE(6,*) 'KNUME ',(ZI(JNUME+I-1),I=1,NBINST)
      ...
      CALL GETVTX(' ','CRITERE',1,1,1,CRIT,N)
C           
