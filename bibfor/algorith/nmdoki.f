...
C RESPONSABLE PROIX J-M.PROIX
      ...
      CHARACTER*(*) MODELE,COMP
      CHARACTER*16 LCOMEL(5),NOMKIT(DIMAKI),MOCLEF
C ----------------------------------------------------------------------
...
C        KIT META
         IF (COMP(1:4).EQ.'META') THEN
           CALL GETVTX(MOCLEF,'RELATION_KIT',K,1,1,NOMKIT(1),N1)
...
C          FAIRE UN TRAITEMENT SPECIFIQUE META CAR 
         ...
         ELSEIF (COMP.EQ.'KIT_DDI')  THEN
           NBKIT=2
           CALL GETVTX(MOCLEF,'RELATION_KIT',K,1,2,NOMKIT(1),N1)
           DO 102 II=1,NBKIT
              NCOMEL=NCOMEL+1
  ...
  102      CONTINUE
     ...
     &       .OR.(COMP(1:6).EQ.'KIT_TH')) THEN
           CALL GETVTX(MOCLEF,'RELATION_KIT',K,1,0,NOMKIT(1),N1)
           NBKIT = -N1
           CALL GETVTX(MOCLEF,'RELATION_KIT',K,1,
     &                 NBKIT,NOMKIT(1),N1)
