...
C      
      DO 40 ICHAM = 1,NBCHAM
        ...
        ELSEIF (NOMCHA.EQ.'VALE_CONT') THEN
          ...
          NOMCHX = CNOINR
        ELSEIF (NOMCHA.EQ.'INDC_ELGA') THEN
          NOMCHX = XINDCO
        ELSEIF (NOMCHA.EQ.'SECO_ELGA') THEN
          NOMCHX = XSEUCO
        ELSEIF (NOMCHA.EQ.'COHE_ELGA') THEN
          NOMCHX = XCOHES
        ELSEIF (NOMCHA.EQ.'MODE_FLAMB') THEN
          NOMCHX = VECFLA
        ELSEIF (NOMCHA.EQ.'MODE_MECA') THEN
          NOMCHX = VECVIB
