...
C TOLE CRP_21
      ...
      CHARACTER*14  RESOCO
      CHARACTER*16  OPTION
      CHARACTER*19  LISCHA, CNRESI, CNDIRI
...
C -------------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ----------------
      ...
      INTEGER      NEQ,ICONTA,JRESI,JDIRI,JATMU,JAFMU,I,IRET,JREFN,IINF,
     &             IFM,NIV,NIVMPI,IBID,NBPROC
      LOGICAL      TABRET(0:10),LFETI
      REAL*8       RBID
      CHARACTER*8  K8BID,LIVEL(2)
      CHARACTER*19 K19BID
      CHARACTER*24 VERESI, VEDIRI, MERIGI, KMET,INFOFE,K24BID
...
C --- FORCES INTERIEURES ET REACTIONS D'APPUI ELEMENTAIRES
     ...
     &             OPTION, MERIGI, VERESI, VEDIRI, ITERAT+1, 
     &             TABRET )
      LICCVG = 0
      IF (TABRET(0)) THEN
         IF ( TABRET(3) ) THEN
