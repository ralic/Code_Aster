...
C
      ...
      REAL*8   TT,PHIT,THETA,R8DEPI,DPHI,DR,DZ,RAC,TRIGOM
      PARAMETER    (EPS  = 1.D-6)
...
C
C     VERIFICATIONS
      IF (A.LE.0.D0) CALL U2MESS('F','ALGORITH11_87')
      IF (B.LE.0.D0) CALL U2MESS('F','ALGORITH11_88')
      IF (A.LT.B)    CALL U2MESS('F','ALGORITH11_89')
