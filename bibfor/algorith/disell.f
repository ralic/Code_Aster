...
C
C IN  PZ     : POINT DU PLAN DONT ON CHERCHE LA DISTANCE A L'ELLIPSE
C IN  AZ     : DEMI-GRAND AXE DE L'ELLIPSE (SUIVANT L'AXE X)
C IN  BZ     : DEMI-PETIT AXE DE L'ELLIPSE (SUIVANT L'AXE Y)
...
C     COPIE LOCALE DES ARGUMENTS D'ENTREE
C     SINON ON RISQUE DE LES MODIFIER
      A=AZ
      B=BZ
      P(1)=PZ(1)
      P(2)=PZ(2)
