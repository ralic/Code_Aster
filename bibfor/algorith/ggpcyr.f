      SUBROUTINE GGPCYR(S,DPC,T,EPSFAB,TPREC,FLUPHI,DEUXMU,
     *                  PREC,G,DGDST,DGDEV)
...
C
      IF (S.EQ.0.D0.OR.DPC.EQ.0.D0)THEN
        ...
        GO TO 99
      ELSE
        CALL TPSCYR(TPS,S,DPC,T,EPSFAB,TPREC,FLUPHI,PREC)
        CALL FGDCYR(TPS,S,T,EPSFAB,TPREC,FLUPHI,F1,FP1,FS1,F2,
