      SUBROUTINE EPSREG(NPI,IPOIDS,IPOID2,IVF,IVF2,IDFDE,IDFDE2,GEOM,
     +                  DIMDEF,DIMUEL,NDIM,NDDLS,NDDLM,NNO,NNOS,NNOM,
     +                  AXI,REGULA,DEPLP,DEFGEP)
C ======================================================================
...
C ======================================================================
         DO 10 I=1,DIMDEF
            ...
            DO 20 N=1,DIMUEL
               DEFGEP((KPI-1)*DIMDEF+I) =
     +         DEFGEP((KPI-1)*DIMDEF+I) + B(I,N)*DEPLP(N)
 20         CONTINUE
 10      CONTINUE
 100  CONTINUE
C ======================================================================
