...
C VARIABLES DE CALCUL
      REAL*8  T1,T2,T4,T7,T8,T10,T13,T19,T12,PI,R8PI
      INTEGER I0
...
C         (ATTENTION ON TRAVAILLE AVEC LES GAMMA POUR J>3...)
     ...
     &  MU1,ETA1D,MU2,ETA2D,0.D0,E0DF(J),E1DF(J),
     &  E2DF(J),E2MIN,E2MAX,SE2DV6(J))
