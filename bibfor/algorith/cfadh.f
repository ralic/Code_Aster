       SUBROUTINE CFADH (NDIM, INDIC, NBLIAC, NBLIAI, AJLIAI, SPLIAI,
...
C ======================================================================
C ----------------------------------------------------------------------
C --- BUT : ON VERIFIE QUE LES LIAISONS SONT BIEN ADHERENTES -----------
C ----------------------------------------------------------------------
...
C ======================================================================
      INTEGER      JLIAC, JVECC, JMU, BTOTAL, ILIAC, JJ, LLIAC, LLJAC
      INTEGER      POSIT, DEKL, DEKL2, DEKLAG, POSMU, II, IFRO, KK
      INTEGER      COMPT0, COMPTS, COMPTN, JSPLF0, IDEBUT, IFIN
      INTEGER      NBSUF0, NBSUF1, LIAISO
      INTEGER      COMPTA, COMPTB, COMPT1, COMPT2, COMPTU, COMPTV
