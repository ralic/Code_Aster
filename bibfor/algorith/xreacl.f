      SUBROUTINE XREACL(NOMA  ,NOMO  ,DEPPLU,DEFICO,RESOCO)
C
...
C
      ...
      CHARACTER*24  DEPPLU,DEFICO,RESOCO
C     
C ----------------------------------------------------------------------
C
...
C IN  DEPPLU : DÉPLACEMENTS ACTUELS   
C 
...
C
      INTEGER      NBMA,IBID
      CHARACTER*8  KBID
      CHARACTER*19 LIGREL,XDONCO,XSEUCO,CSEUIL
      CHARACTER*16 OPTION
      CHARACTER*24 AINTER,CFACE,FACLON
      CHARACTER*24 XCONTA
      INTEGER      JCONTX 
      LOGICAL      DEBUG         
