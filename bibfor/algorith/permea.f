      SUBROUTINE PERMEA(IMATE,HYDR,PHI,P1,P2,T,SAT,DSATP1,NCON,COND)
C
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGORITH  DATE 13/02/2002   AUTEUR CIBHHLV L.VIVAN 
C ======================================================================
...
C  
      ...
      PARAMETER     ( NC = 1)
      REAL*8         P1,P2,T,PHI,VALPAR(2),SAT,DSATP1
      CHARACTER*16   HYDR
...
C     LAMBDA GAZ : 
      ...
      IF (HYDR.EQ.'HYDR') THEN
         ...
         CALL UTMESS('F','PERMEA','POUR UTILISER LE COMPORTEMENT '//
     +    '"HYDR" IL FAUT SURCHARGER LE CODE EN "MODE DEVELOPPEMENT"'//
     +    ' AVEC LES ROUTINES "PERMEA" ET "SATURA".')
