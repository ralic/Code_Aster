...
C 
      ...
      INTEGER      IFM,NIV
      INTEGER      POSNOE,NUMNOE,ILIAC,KK,ICMP,ILIAI
      INTEGER      NDIM,NBLIAI,NBLIAC,NBDDL,NEQ
      ...
      REAL*8       TAU1(3),TAU2(3),NORM(3),R8BID
      CHARACTER*2  TYPEC0,TYPLIA
      CHARACTER*19 LIAC,ATMU,AFMU,MU,CONVEC
      INTEGER      JLIAC,JATMU,JAFMU,JMU,LMAT,JVECC
      CHARACTER*24 APPARI,CONTNO,APPOIN
      INTEGER      JAPPAR,JNOCO,JAPPTR
      CHARACTER*24 APDDL,APJEU,APCOFR
      INTEGER      JAPDDL,JAPJEU,JAPCOF
      CHARACTER*24 TANGCO,JEUINI,TACFIN
      INTEGER      JTANGO,JJEUIN,JTACF
      INTEGER      JCNSVR,JCNSLR,JDEPDE,JDDEPL
      LOGICAL      CFDISL,LPENAC,LCTFD,LVERIF
      LOGICAL      LAG2D
