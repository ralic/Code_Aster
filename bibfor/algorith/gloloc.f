      SUBROUTINE GLOLOC(XGLOBA,XORIG,SINA,COSA,SINB,COSB,
     &                  SING,COSG,XLOCAL
     &                    )
...
C***********************************************************************
C     FONCTION  : PASSAGE REPERE GLOBAL AU REPERE LOCAL
C
C-----------------------------------------------------------------------
C                             ARGUMENTS
...
C    XORIG          <--   ORIGINE DU REPERE LOCAL (COORD GLOBALES)
...
C-----------------------------------------------------------------------
      ...
      REAL*8 XGLOBA(3),XORIG(3),XLOCAL(3),XPIV(3)
C
      DO 10 I=1,3
        XPIV(I)=XGLOBA(I)-XORIG(I)
 10   CONTINUE
      CALL ROT3D(XPIV,SINA,COSA,SINB,COSB,SING,COSG,XLOCAL)
 9999 CONTINUE
      END
