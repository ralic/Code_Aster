...
C MODIF ALGORITH  DATE 12/07/2010   AUTEUR GREFFET N.GREFFET 
C ======================================================================
...
C 
      LOGICAL      LDYNA,LEXPL
      LOGICAL      LONDE,LSENS,LLAPL,LAMMO,LSSTF
      LOGICAL      LIMPE,LPILO,LMACR,LIMPEX
      LOGICAL      LELTC,LELTF,LCTFC
...
C
C --- FORCES NODALES (POUR METHODE IMPL_EX)
C
        IF (LIMPEX) THEN
