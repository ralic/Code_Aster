     ...
     &     TYPMOD,NDSDE,DSIDEP,CODRET)
      ...
      REAL*8  CRIT(*),INSTAM,INSTAP,VIM(*),VIP(*),DSIDEP(NDSDE),R8BID
      REAL*8  EPSM(NEPS),DEPS(NEPS),SIGM(NSIG),SIGP(NSIG)
...
C.......................................................................
C
C     BUT: LOI DE COMPORTEMENT ELASTOPLASTIQUE A ECROUISSAGE ISOTROPE
C
C          RELATIONS : 'VMIS_ISOT_LINE'
C                      'VMIS_ISOT_TRAC'
C                      'VMIS_ISOT_PUIS'
C                      'VISC_ISOT_TRAC'
C                      'VISC_ISOT_LINE'
...
C     DEFORMATIONS DE SIMO_MIEHE
      IF (COMPOR(3).EQ.'SIMO_MIEHE') THEN
        ...
        CALL LCPIVM (FAMI,KPG,KSP,IMATE,COMPOR(1),CRIT,INSTAM,INSTAP,
...
C     PETITES DEFORMATIONS
      ELSE
         ...
         IF (CRIT(2).NE.9) THEN
            CALL NMISOT (FAMI,KPG,KSP,NDIM,TYPMOD,IMATE,COMPOR(1),CRIT,
     &          DEPS,SIGM,VIM,OPTION,SIGP,VIP,DSIDEP,R8BID,R8BID,CODRET)
         ELSE
C              IMPLEX
