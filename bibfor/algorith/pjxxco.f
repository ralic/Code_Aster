      SUBROUTINE PJXXCO(METHOD,LCORRE,ISOLE,
     &                  RESUIN,CHAM1,
     &                  MOA1,MOA2,
     &                  NOMA1,NOMA2,CNREF)
...
C    (EX. : 'COLOCATION' NE SAIT PAS TRAITER LES CHAM_ELEM ELGA)
C
C  SI TOUT EST COHERENT, ON APPELLE :
C    PJEFCO VIA LE 1ER ARGT DE LA SD LCORRESP_2_MAILLA ('COLOCATION')
