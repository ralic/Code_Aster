     ...
     &                  VU,VP,VPI,GEOMI,TYPMOD,OPTION,NOMTE,MATE,COMPOR,
...
C-----------------------------------------------------------------------
      ...
      REAL*8       GPRESM(3*27),GPRESD(3*27)
      REAL*8       PM,PD,GPM(NDIM),GPD(NDIM),PIM(NDIM),PID(NDIM)
...
C - TERME K:UPI = 0.D0     KUP(NDIM,NNO1,NDIM,NNO3)
...
C - TERME K:PPI     KPPI(NNO2,NDIM,NNO3)
            DO 660 RB = 1,NNO3
              DO 670 IB = 1,NDIM
...
C - TERME K:PIU = 0.D0     KUU(NDIM,NNO3,NDIM,NNO1)

C - TERME K:PIP     KPIP(NDIM,NNO3,NNO2)
              DO 720 SB = 1,NNO2
...
C - TERME K:PIPI    KPIPI(NDIM,NNO3,NDIM,NNO3)
C - REMARQUE : MATRICE NON NULLE QUE SI I=J DONC K:PIPI(I,N,J,M)=0 SINON
              DO 730 RB = 1,NNO3
                DO 740 IB = 1,NDIM
