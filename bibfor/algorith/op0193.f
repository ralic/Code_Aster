...
C
      CALL GETVID ('MODELE_CALCUL','BASE',1,IARG,1,BASEMO,N1)
C
C --- RECUPERATION DE LA MESURE
C
      CALL GETVID ('MODELE_MESURE','MESURE',1,IARG,1,NOMMES,N1)
C
...
C
     ...
     &             VCHAM)
C
C --- ECRITURE SD RESULTAT (TRAN_GENE, HARM_GENE OU MODE_GENE)
C
