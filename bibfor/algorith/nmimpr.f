...
C
C IMPRESSION D'UNE LIGNE DU TABLEAU DE CONVERGENCE
C
C ----------------------------------------------------------------------
C
C
...
C
C --- IMPRESSION LIGNE DANS LE FICHIER MESSAGE
C
      SEPCOL = '|'
      CALL IMPSDL(SDTABC,SEPCOL,UNIMES)
C
C --- IMPRESSION LIGNE DANS LE FICHIER CSV
C
      IF (LCSV) THEN
        SEPCOL = ','
