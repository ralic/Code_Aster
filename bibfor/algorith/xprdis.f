...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      INTEGER        IFM,NIV,JFONR,LONG,NBPTFR,JFMULT,NUMFON,JFOND,
     &               NBPTFD,I,J,FON
      CHARACTER*1    K1BID
...
C     RETREIVE THE CRACK FRONT (FISREF)
      ...
      CALL JELIRA(FISREF//'.FONDFISS','LONMAX',LONG,K1BID)
      NBPTFR=LONG/4

C     RETRIEVE THE DIFFERENT PIECES OF THE CRACK FRONT
      CALL JEVEUO(FISREF//'.FONDMULT','L',JFMULT)
      CALL JELIRA(FISREF//'.FONDMULT','LONMAX',NUMFON,K1BID)
      NUMFON = NUMFON/2
...
C     RETREIVE THE CRACK FRONT (FISDIF)
      ...
      CALL JELIRA(FISDIS//'.FONDFISS','LONMAX',LONG,K1BID)
      NBPTFD=LONG/4
