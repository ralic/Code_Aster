     ...
     &                  SIGM,SIGP,FINT,KTAN,VIM,VIP,CRIT,
...
C TOLE CRP_21 CRS_1404
      ...
      REAL*8  SIGM(3,NPG),SIGP(3,NPG),VIM(LGPG,NPG),VIP(LGPG,NPG)
...
C IN  SIGM   CONTR LOCALES AUX POINTS DE GAUSS - (SIGN, SITX, SITY)
C OUT SIGP   CONTR LOCALES AUX POINTS DE GAUSS + (SIGN, SITX, SITY)
...
C-----------------------------------------------------------------------
      ...
      REAL*8  B(3,60),SIGMO(6),SIGMA(6)
      REAL*8  SUM(3),DSU(3),DSIDEP(6,6),POIDS
