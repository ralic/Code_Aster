...
C         MATASZ : MATRICE ASSEMBLEE DU SYSTEME
C
...
C 0.1. ==> ARGUMENTS
      ...
      INCLUDE 'jeveux.h'
      CHARACTER*(*) MODELZ,FOMULZ,LISCHZ,MATE,CARAZ,LTPSZ,SOLVEZ
      CHARACTER*(*) MATASZ
      CHARACTER*8   LTPS
...
C 0.3. ==> VARIABLES LOCALES
     ...
     &             PARTPS(3),RBID, VALR(3)
      ...
      CHARACTER*14 NUPOSS
      CHARACTER*16 K16BID
      CHARACTER*19 MAPREC,VECASS,CHDEPL,K19B,MATASS
...
C     QUE FOIS.
      ...
      INSTF=R8MAEM()
      CALL GETVR8(' ','INST_FIN',0,IARG,1,INSTF,IBID)
