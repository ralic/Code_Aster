...
C 0.3. ==> VARIABLES LOCALES
     ...
     &             ITPS0,IRET,IAUX,NRPASE,NRORES,NINSTC,ISLVK,IDIME,
     &             IFETPT
     ...
     &             PARTPS(3)
      ...
      CHARACTER*24 NUMEDD,METHOD,CHARGE,INFOCH,CRITER,
...
C INIT POUR FETI (ON PASSE L'INDICE DE L'INCREMENT A ALFETI ET LA
C DECISION DE REASSEMBLER OU NON LA MATRICE POUR ACCELERATION_MA)
          IF (LFETI) THEN
            ZI(IFETPT+1)=ITPS
            IF (ASSMAT) THEN
              ZI(IFETPT+2)=1
