      SUBROUTINE NMMENG(FONACT,MATASZ,SOLVEZ)
C
...
C
       ...
       CHARACTER*19 SOLVEU,MATASS,K19BID,SOLVBD
       INTEGER      IBID,JSLVK,IRET
       REAL*8       R8BID
       LOGICAL      ISFONC,LFETI,LDLTSP
       COMPLEX*16   CBID
C      
C ----------------------------------------------------------------------
C
