     ...
     &                  NUMFIX,COMPOR,CARCRI,SDTIME,MEELEM,
     &                  MEASSE,VEELEM,LDCCVG,MATASS,MATGEO)
C
...
C
      ...
      CHARACTER*24  COMREF,NUMEDD,NUMFIX
...
C
C --- OBJET POUR RECONSRUCTION RIGIDITE TOUJOURS SYMETRIQUE
C
