...
C IN  DEPDEL : INCREMENT DE DEPLACEMENT DEPUIS LE DERNIER PAS DE TEMPS
...
C
C --- REACTUALISATION DU JEU NECESSAIRE AU CAS OU
C --- IL Y AURAIT EU REDECOUPAGE DU PAS DE TEMPS
C
         IF (ITERAT.EQ.0) THEN
           CALL REAJEU(RESOCO,DEPDEL)
         ENDIF
      ENDIF
C
