...
C
     ...
     &             LTNOFA,LNNOFA,GRLTFA,GRLNFA
      CHARACTER*24 LISMAE,LISNOE,TMP
      LOGICAL      GRILLE,LDMAX
      CHARACTER*8  FISGRI,CHGRI
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ()
...
C     CHECK IF THE USER WANTS TO USE AN AUXILIARY GRID
      CALL GETVID(' ','MODELE_GRILLE',1,0,1,GRIAUX,IRET)
      IF (IRET.GT.0) THEN
C        YES
         GRILLE = .TRUE.
...
C
      ...
      GRLN   = '&&OP0041.GRLN'
C
      CALL XGRALS(IFM,NOMO,NOMA,LNNO,LTNO,GRLT,GRLN)
C
...
C-----------------------------------------------------------------------
      ...
      IF (GRILLE) THEN
         ...
         GRLNG   = '&&OP0041.GRLNG'
C
         CALL XGRALS(IFM,GRIAUX,MAIAUX,LNNOFA,LTNOFA,GRLTG,GRLNG)
