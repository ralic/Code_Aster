...
C
      ...
      INTEGER      NDIM,JDIME
      REAL*8       CENTRE(3),VECTX(3),VECTY(3),A,B
      CHARACTER*8  FISS,NOMO,NFONF,NFONG,MAFIS,FONFIS,NOMA,METH
      CHARACTER*8  GEOFIS,COTE
      CHARACTER*16 K16BID
...
C
      ...
      CALL GETVID('DEFI_FISS','FORM_FISS',1,1,1,GEOFIS,ME3)
...
C
      ...
      ENDIF
C
      CALL XINILS(IFM,NOMA,METH,NFONF,NFONG,GEOFIS,A,B,CENTRE,COTE,
