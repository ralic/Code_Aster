...
C
      ELSEIF (QUESTI.EQ.'FOND_FISSURE') THEN
        ...
        IF (ZR(JCMCF-1+ZCMCF*(IZONE-1)+17) .EQ. 0.D0) THEN
          LREP(1) = .FALSE.
        ELSE
          LREP(1) = .TRUE.
        ENDIF
C
      ELSEIF (QUESTI.EQ.'RACCORD_LINE_QUAD') THEN
        CALL JEVEUO(CARACF,'L',JCMCF)
        IF (ZR(JCMCF-1+ZCMCF*(IZONE-1)+18) .EQ. 0.D0) THEN
          LREP(1) = .FALSE.
        ELSE
          LREP(1) = .TRUE.
        ENDIF
...
C
      ELSEIF (QUESTI.EQ.'COEF_AUGM_CONT') THEN
        IF (IFORM.EQ.2) THEN
          CALL JEVEUO(CARACF,'L',JCMCF)
          RREP(1) = ZR(JCMCF-1+ZCMCF*(IZONE-1)+2)
        ELSE
          CALL ASSERT(.FALSE.)
        ENDIF
C
      ELSEIF (QUESTI.EQ.'COEF_AUGM_FROT') THEN
        IF (IFORM.EQ.2) THEN
          CALL JEVEUO(CARACF,'L',JCMCF)
          RREP(1) = ZR(JCMCF-1+ZCMCF*(IZONE-1)+4)
        ELSE
          CALL ASSERT(.FALSE.)
        ENDIF
C
