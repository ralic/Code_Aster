...
C     AVERTISSEMENTS SUR LE CHOIX DE PFON_INI
      IF (NBBORI.EQ.NFON) THEN
        CALL UTMESS('A','XORIFF','TOUS LES POINTS DU FOND DE FISSURE '
     &      //'SONT DES POINTS DE BORD. ASSUREZ-VOUS DU BON CHOIX DES '
     &      //'PARAMETRES D''ORIENTATION DE FISSURE ET DE PFON_INI.')
      ELSEIF (MOD(NBBORI,2).EQ.0.AND.(NBBORI.NE.0.D0))  THEN
        CALL UTMESS('A','XORIFF','PFON_INI SEMBLE ETRE UN POINT DE FIN '
     &      //'DE FISSURE SELON L''ORIENTATION CHOISIE.'
