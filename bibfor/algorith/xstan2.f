...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX --------------------
      ...
      INTEGER       NBMANO,NUMA,IN,NUNO2,NBNO,JLISNO,CPT,IER,IFM,NIV
      LOGICAL       MAAPB(NBMA)
C......................................................................
...
C     BOUCLE SUR TOUTES LES MAILLES DU MAILLAGE
      DO 10 IMA = 1,NBMA
        ...
        IF (TYPMA(1:4).NE.'HEXA'.OR.NINTER.NE.3) THEN
          CALL CODENT(NINTER,'D',CHAINE)
          CALL UTMESS('F','XSTAN2','LE CRITERE DE MODIFICATION DE '//
     &                'L''ENRICHISSEMENT HEAVISIDE SERVANT A EVITER '//
     &                'LES PIVOTS NULS A ABOUTI A UN CAS DE FIGURE '//
     &                'QUI SEMBLE BIZARRE. NORMALEMENT, ON DOIT AVOIR'//
     &                ' UN HEXAEDRE COUPE DANS UN COIN (3 POINTS D'''//
     &                'INTERSECTION), OR LA, ON A UN '//TYPMA//
     &                'AVEC '//CHAINE//' POINTS D''INTERSETION.')
C        CALL U2MESK('F','ALGORITH11_71', 2 ,VALK)
        ENDIF
        MAAPB(IMA)=.TRUE.
