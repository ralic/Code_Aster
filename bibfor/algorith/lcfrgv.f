...
C ----------------------------------------------------------------------
      ...
      REAL*8  COPLAN, EPS(6), W, TREPS, EPSEPS, FD, LAP
      REAL*8  N0, NG, D0, DG(3), DG2, D0M, D2PHI, COEFG, Q0, Q1, Q2
...
C -- DEFORMATIONS COURANTES      
      ...
      IF (RAPH.OR.FULL.OR.DECO) CALL R8AXPY(NDIMSI,1.D0,DEPS,1,EPS,1)
