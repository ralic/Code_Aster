      SUBROUTINE COPMO3 ( BASEMO, NEQ, NU, NBMODE, BMODAL )
...
C    NU             <--   NUMEROTATION DDL DU SYSTEME ASSEMBLE
...
C      ----FIN DES COMMUNS JEVEUX----------
      ...
      INTEGER       IBID, IDDEEQ, I, IRET, JREF, JVAL, IDDL
      COMPLEX*16    DCMPLX
...
C ------ TEST COMPARANT NOMA A MAILLAGE(NU) 
         ...
         IF ( NU .NE. NU2 ) THEN
            ...
            CALL ZCOPY ( NEQ, ZC(JVAL), 1, BMODAL((I-1)*NEQ+1), 1 )
     ...
     &      BMODAL((I-1)*NEQ+IDDL) = DCMPLX(0.D0,0.D0)
20       CONTINUE
