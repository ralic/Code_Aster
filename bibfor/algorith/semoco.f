...
C HYPOTHESES : MODES SIMPLES, DERIVEES MASSES ET AMOR NULLES
C-----------------------------------------------------------------------
...
C VARIABLES LOCALES
      ...
      INTEGER JDVEC,LDVEC,LDVAL,INEG,IPREC,ILGCON,LXLGUT
...
C  STOCKAGE DU VECTEUR PROPRE NUMODE DANS VAPRIN
          ...
          CALL WKVECT(DVECT,'V V C',NEQ,JDVEC)
...
125       CONTINUE
     ...
     &        FREQ,ZC(JVECTC),
     &        NUMODE,ZC(JDVEC),CDVAL,ZC(JTRAV))
