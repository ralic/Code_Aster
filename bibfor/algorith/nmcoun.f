      SUBROUTINE NMCOUN(NOMA  ,FONACT,MATASS,DEFICO,RESOCO,
     &                  DEFICU,RESOCU,ITERAT,VALINC,SOLALG,
     &                  VEASSE,INSTAN,RESIGR,SDSTAT,SDTIME,
     &                  CTCCVG)
C
...
C
      IF (LCTCD) THEN 
        ...
        IF (.NOT.LALLV) THEN
          CALL NMCOFR(NOMA  ,DEPPLU,DEPDEL,DDEPLA,MATASS,
     &                DEFICO,RESOCO,ITERAT,RESIGR,SDSTAT,
     &                SDTIME,CTCCVG)
        ENDIF
      END IF
C
