...
C     
      CALL JEEXIN(VECELE(1:8)//'.LISTE_RESU' ,IRET)
      IF ( IRET .EQ. 0 ) THEN
        CALL MEMARE('V',VECELE,MODELE,MATE  ,CARELE,'CHAR_MECA')
        CALL WKVECT(VECELE(1:8)//'.LISTE_RESU','V V K24',NCHAR,JDIR)
      ELSE
        CALL JEVEUO(VECELE(1:8)//'.LISTE_RESU','E',JDIR)
      ENDIF
C
