...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
      CHARACTER*4 TYCH
      CHARACTER*8 K8BID,LPAIN(21),PAOUT,MAILLA,NOMGD
      CHARACTER*19 LIGREL,CHTEM2,LISCH2
      CHARACTER*24 LCHIN(21),RESUEL,CHGEOM
      CHARACTER*24 CHCARA(15),CHPESA
      LOGICAL EXIGEO,EXICAR
      INTEGER IRET,JLVE,NBCHME,IBID,NH,IED,NCHAR,IPESAN,JCHAR
...
C     -- ON TESTE LA NATURE DU CHAMP DE TEMPERATURE
      ...
      CALL CALCUL('S','FORC_NODA',LIGREL,21,LCHIN,LPAIN,1,RESUEL,PAOUT,
     &            'V')
      ZK24(JLVE) = RESUEL
