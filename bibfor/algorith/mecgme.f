...
C
      ...
      INTEGER      IBID,IRET,ILME,IERD,IER,I,K,ICHA,INUM
      LOGICAL      LBID,PREM
      INTEGER      JCHAR,JINF,JLME
      INTEGER      NCHAR,NUMCHM,NBCHME,LONLIS
      COMPLEX*16   C16BID
      INTEGER      IFM,NIV
C      
      INTEGER NBCHMX
...
C
      ...
      IF (IRET.EQ.0) THEN
        ...
        CALL WKVECT(MESUIV(1:8)//'.LISTE_RESU','V V K24',LONLIS,JLME)
        CALL JEECRA(MESUIV(1:8)//'.LISTE_RESU','LONUTI',0,K8BID)
      ELSE
        PREM   = .FALSE.
        CALL JELIRA(MESUIV(1:8)//'.LISTE_RESU','LONUTI',NBCHME,K8BID)
        CALL JEVEUO(MESUIV(1:8)//'.LISTE_RESU','E',JLME)
      END IF
C
...
C               POUR UNE MATRICE NON SYMETRIQUE EN COQUE3D (VOIR TE0486)
     ...
     &                        LCHOUT,LPAOUT,'V')
                  ...
                  CALL JEECRA(MESUIV(1:8)//'.LISTE_RESU','LONUTI',
     &                         ILME,K8BID)
                END IF
              END IF
   20       CONTINUE
