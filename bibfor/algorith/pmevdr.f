      SUBROUTINE PMEVDR(SDDISC,CONVER,TABINC,LICCVG,LEVDRI)
C
...
C I/O CONVER : .TRUE. SI CONVERGENCE REALISEE
...
C         DVAL :MAX EN VALEUR ABSOLUE DU DELTA(CHAMP+CMP)
          ...
          CALL TBACCE (TABINC(1)(1:16),2,NOCMP,'L',IB,DVAL,CBID,K8B)
