...
C ======================================================================
C     BARSOUM : TRAITEMENT DES MAILLES "PYRAM13"
C-----------------------------------------------------------------------
C
      INTEGER   I, N1, N2, N3
C     ------------------------------------------------------------------
...
C
 ...
 220     CONTINUE
C
      ELSEIF ( (I1+I2.EQ.7) .AND. (I1.EQ.4 .OR. I2.EQ.4) ) THEN
         DO 230 I = 1 , 4
            IF ( I .EQ. 1 ) THEN
               N1 = 4
               N2 = 5
...
C
 ...
 250     CONTINUE
C
      ELSEIF ( (I1+I2.EQ.7) .AND. (I1.EQ.5 .OR. I2.EQ.5) ) THEN
         DO 260 I = 1 , 5
            IF ( I .EQ. 1 ) THEN
               N1 = 5
               N2 = 4
...
C
      ELSE
         CALL UTMESS ('F', 'BARPYR', 'BARSOUM, PYRAM : BUG ! ')
C
      ENDIF
C
      END
