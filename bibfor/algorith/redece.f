...
C
     ...
     &                TIMED, TIMEF, TEMPD, TEMPF, TREF, EPSDT,
     &                DEPST, SIGD, VIND, OPT, ANGMAS, SIGF,
     &                VINF, DSDE, ICOMP, NVI, IRTET)
        ENDIF
...
C
     ...
     &                      CRIT, TD, TF, TEMD, TEMF, TREF, EPS,
     &                      DEPS, SD, VIND, OPT, ANGMAS, SIGF,
     &                      VINF, DSDELO, ICOMP, NVI, IRTET)
            ENDIF
