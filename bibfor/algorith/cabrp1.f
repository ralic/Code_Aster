      SUBROUTINE CABRP1(KPI,IPOIDS,IPOID2,IVF,IVF2,IDFDE,IDFDE2,GEOM,
...
C ======================================================================
 ...
 20      CONTINUE
         B(ADDER1,(N-1)*NDDLS+NDIM+2) = B(ADDER1,(N-1)*NDDLS+NDIM+2) +
...
C ======================================================================
      DO 50 N=1,NNOS
         DO 60 I=1,NDIM
            B(ADDER2-1+I,(N-1)*NDDLS+NDIM+2)=
     +      B(ADDER2-1+I,(N-1)*NDDLS+NDIM+2)+DFDI2(N,I)
 60      CONTINUE
 50   CONTINUE
C ======================================================================
