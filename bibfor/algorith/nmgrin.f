       SUBROUTINE NMGRIN(NUMEDD,SDDYNA,VALMOI,NUMINI)
C
...
C
      ...
      CHARACTER*24 DEPMOI,VITMOI,ACCMOI,CHGRFL
      LOGICAL      LGRFL,NDYNLO
      CHARACTER*19 LISINS
      REAL*8       DELTAT,DIINST
C      
C ----------------------------------------------------------------------
C
      CALL JEMARQ()
...
C
      IF ( LGRFL )  THEN
        ...
        DELTAT =  DIINST(LISINS,1) - DIINST(LISINS,0)
        CALL GFINIT(NUMEDD,NUMINI,DEPMOI,VITMOI,ACCMOI,
     &              DELTAT,CHGRFL)
      ENDIF  
C
      CALL JEDEMA()      
