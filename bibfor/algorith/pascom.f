...
C MODIF ALGORITH  DATE 13/06/2006   AUTEUR GREFFET N.GREFFET 
C ======================================================================
...
C     VERIFICATION DE LA CONFORMITE DE LA LISTE D'INSTANTS
      ...
      IF (N1.EQ.1) THEN
        DTCOU =DTCOU/(2.D0)        
        CALL UTDEBM('I','PASCOM','PAS DE TEMPS MAX POUR DIFF_CENT :')
      ...
      ELSE
        ...
        IF (N1.EQ.1) THEN
          ...
          CALL UTDEBM('I','PASCOM','PAS DE TEMPS MAX POUR TCHAMWA :')
          CALL UTIMPR('S',' ',1,DTCOU)
          CALL UTFINM()
        ELSE
          CALL UTMESS('F','PASCOM','SCHEMA INCONNU')
        ENDIF
      ENDIF
      ...
      DO 20 I=1,NBDT
        IF (ZR(JPAS-1+I).GT.DTCOU) THEN
          IF (STOCFL(1:3).EQ.'OUI') THEN
            CALL UTMESS('F','PASCOM','LA LISTE D''INSTANTS'
     &   //  ' FOURNIE NE RESPECTE PAS LA CONDITION DE STABILITE.')
          ELSE
            CALL UTMESS('A','PASCOM','LA LISTE D''INSTANTS'
     &   //  ' FOURNIE NE RESPECTE PAS LA CONDITION DE STABILITE.')
          ENDIF
        ENDIF
 20   CONTINUE
