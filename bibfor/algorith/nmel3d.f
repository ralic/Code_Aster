     ...
     &             SECH, TREF, DEPL,ANGMAS, DFDI, PFF, DEF, SIG, VI,
     &             MATUU, VECTU, CODRET )
...
C
      ...
      REAL*8   POIDS,TEMP,TMP1,TMP2,SECHG
C
...
C - DU SECHAGE AU POINT DE GAUSS
C
      DO 10 KPG=1,NPG
C
...
C
        CALL NMCPEL('RIGI',KPG,1,3,TYPMOD,ANGMAS,IMATE,COMPOR,CRIT,TEMP,
     &              TREF,SECHG,OPTION,EPS,SIGMA,VI(1,KPG),DSIDEP,CODRET)
C
C
