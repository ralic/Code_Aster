       SUBROUTINE  NMEL3D(FAMI,NNO, NPG, IPOIDS, IVF, IDFDE,
...
C - DE LA TEMPERATURE AU POINT DE GAUSS
C
      DO 10 KPG=1,NPG
C
...
C
        CALL NMCPEL(FAMI,KPG,1,3,TYPMOD,ANGMAS,IMATE,COMPOR,CRIT,TEMP,
