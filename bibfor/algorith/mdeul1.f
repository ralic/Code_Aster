...
C
        CALL MDACCE(TYPBAS,NEQGEN,PULSAT,ZR(JPULS),ZR(JMASS),DESCMM,
...
C     --- ACCELERATIONS GENERALISEES INITIALES ---
C
        CALL MDACCE(TYPBAS,NEQGEN,PULSAT,PULSA2,MASGEN,DESCMM,RIGGEN,
...
C
 ...
 15         CONTINUE
            CALL R8COPY(NEQGEN,ZR(JACCGI),1,ZR(JACCE),1)
...
C        --- ACCELERATIONS GENERALISEES ---
C
         CALL MDACCE(TYPBAS,NEQGEN,PULSAT,PULSA2,MASGEN,DESCMM,
