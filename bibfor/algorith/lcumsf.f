...
C FLUAGE DE DESSICCATION DEBRANCHE YLP 
C
C_______________________________________________________________________
C
C ROUTINE QUI CALCUL LA DEFORMATION DE FLUAGE DE DESSICCATION
...
C
      IMPLICIT NONE
      INTEGER I,ICOU,IFOU,IFPO,ISPH,J,NMAT,NSTRS,NVARI
      REAL*8 ERSP,EISP
...
C  => EQUATION (3.11-4)
C
        CALL LCUMFS(VARI,NVARI,CMAT,NSTRS,NMAT,1,ISPH,TDT,HINI,HFIN,
     &                  AFPS,BFPS,CFPS)
        ERSP = ERSP + AFPS + BFPS*SIGISP
     &                 + CFPS*SIGFSP
C
        CALL LCUMFS(VARI,NVARI,CMAT,NSTRS,NMAT,2,ISPH,TDT,HINI,HFIN,
     &                  AFPS,BFPS,CFPS)
