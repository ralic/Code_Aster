      SUBROUTINE XBASLO(MODELE,NOMA,CHFOND,GRLT,GRLN,BASLOC)
      IMPLICIT NONE

      CHARACTER*8     MODELE,NOMA
      CHARACTER*19    GRLT,GRLN
      CHARACTER*24    CHFOND,BASLOC


C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGORITH  DATE 04/10/2004   AUTEUR GENIAUT S.GENIAUT 
C ======================================================================
...
C     CHAMP PAR ÉLÉMENTS AUX POINTS DE GAUSS
      ...
      CELMOD = '&&XBASLO.CELMOD'
      CESMOD = '&&XBASLO.CESMOD'
      CES = '&&XBASLO.CES'
      MNOGA = '&&XBASLO.MANOGA'
      ...
      CALL CESCEL(CES,LIGREL,'CALC_K_G','PBASLOR','NON','G',BASLOC)
