...
C
                ...
                VALI = INTG
                VALR = DP
            CALL UTEXCM(23,'ALGORITH16_64',0,' ',1,VALI,1,VALR)
                ENDIF
                ENDIF
C
...
C
                        ...
                        VALI = ITER
                        VALR = TOLER
            CALL UTEXCM(23,'ALGORITH16_65',0,' ',1,VALI,1,VALR)
                        ENDIF
                        ENDIF
C
C -                 SINON STOP
C
                    ...
                    VALI = ITER
                    VALR = TOLER
            CALL UTEXCM(23,'ALGORITH16_66',0,' ',1,VALI,1,VALR)
                    ENDIF
                    ENDIF
C
C -               ITER < 6 STOP
C
                  ...
                  VALI = ITER
                  VALR = TOLER
            CALL UTEXCM(23,'ALGORITH16_67',0,' ',1,VALI,1,VALR)
