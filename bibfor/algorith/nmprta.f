...
C
      ...
      REAL*8       R8BID
      LOGICAL      LBID,NDYNLO,LSTAT,LIMPL,LIMPEX,ISFONC
      INTEGER      IFM,NIV
      CHARACTER*24 DEPMOI,SIGMOI,VARMOI,COMMOI,VITMOI
      CHARACTER*24 ACCMOI,SIGEXT,K24BID
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ()
...
C
     ...
     &              VITMOI,ACCMOI,SIGEXT,K24BID)
        CALL AGGLOM(DEPMOI,SIGEXT,VARMOI,COMMOI,
     &              VITMOI,ACCMOI,SIGMOI,K24BID, 7, VALMOI)
      ENDIF
     ...
     &            MEASSE,VEASSE,SDSENS,SDDYNA)
      ...
      IF (LIMPEX) THEN
        CALL DESAGG(VALMOI,DEPMOI,SIGEXT,VARMOI,COMMOI,
     &              VITMOI,ACCMOI,SIGMOI,K24BID)
        CALL AGGLOM(DEPMOI,SIGMOI,VARMOI,COMMOI,
     &              VITMOI,ACCMOI,SIGEXT,K24BID, 7, VALMOI)
      ENDIF
C
