...
C-----------------------------------------------------------------------
      ...
      REAL*8 DMAX ,DMIN ,DXETYP ,DXETYT ,DXMAX ,DXMAXT ,DXMIN 
      REAL*8 DXMINT ,DXMOY ,DXMOYT ,DXRMS ,DXRMST ,FETYP ,FNMAX 
      REAL*8 FNMAXM ,FNMIN ,FNMINM ,FNMOYC ,FNMOYT ,FNRMSC ,FNRMST 
      REAL*8 FRMS ,FTETYP ,FTMAX ,FTMIN ,FTMOY ,FTMOYE ,FTRMS 
      REAL*8 FXMAXT ,FXMINT ,FXMOYC ,FXMOYT ,FXRMSC ,FXRMST ,FYETYC 
      REAL*8 FYETYT ,FYMAXT ,FYMINT ,FYMOYC ,FYMOYT ,FYRMSC ,FYRMST 
      REAL*8 PUSURN ,R8RDDG ,RAD ,SFN ,SFN2 ,TCHMAX ,TCHMIN 
      REAL*8 TCHOC ,TCHOCG ,TCHOCM ,TCHOCT ,TCHOMA ,TCHOMI ,TCHOMY 
      REAL*8 TREBMY ,TREBOG ,TREBOM ,TREBOT ,TTOT ,TXCHOC ,XTETYP 
      REAL*8 XTMOY ,XTRMS ,ZERO 
C-----------------------------------------------------------------------
