      SUBROUTINE ALGOGL(DEFICO,RESOCO,MATASS,LMAT  ,LDSCON,
     &                  NOMA  ,RESU  ,DEPTOT,CTCCVG)
C
...
C
      ...
      INTEGER      ILIAI,KK,ITER,ILIAC,NEQMAX,IALARM
      INTEGER      JRESU,JDEPP
      INTEGER      INDIC,LLMIN
...
C ======================================================================
C --- ACTIVATION DE TOUTES LES LIAISONS DETECTEES EN VIS A VIS
