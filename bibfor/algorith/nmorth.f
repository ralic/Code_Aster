      SUBROUTINE NMORTH (FAMI,KPG,KSP,TEST,NDIM,PHENOM,TYPMOD,IMATE,
...
C ======================================================================
      IMPLICIT NONE
      CHARACTER*(*)    FAMI
      INTEGER          KPG,KSP,TEST,NDIM,IMATE
...
C     VARIABLE LOCALE
      REAL*8 RBID,R8VIDE,REPERE(4),HOOKF(36)
      REAL*8 VALPAR(3),VALRES(3),DEPLTH(6),DEPGTH(6),DEPSTR(6)
      REAL*8 ALPTM,ALPLM,ALPNM,ALPTP,ALPLP,ALPNP,TM,TP,TREF
      REAL*8 DEPSME(6),RAC2,VEPST1(6),VEPST2(6)
...
C     APPEL A DMATMC POUR RECUPERER LA MATRICE TANGENTE
      IF ( OPTION.EQ.'RIGI_MECA_TANG') THEN
        CALL DMATMC(FAMI,MODELI,IMATE,RBID,'-',KPG,KSP,REPERE,
...
C RECUPERATION DES PARAMETRES MATERIAUX A L INSTANT -
          ...
          CALL RCVALB(FAMI,KPG,KSP,'-',IMATE,' ','ELAS_ORTH',0,' ',
     &              0.D0,3,NOMRES,VALRES,CODRET,' ')
...
C RECUPERATION DES PARAMETRES MATERIAUX A L INSTANT -
         ...
         CALL RCVALB(FAMI,KPG,KSP,'-',IMATE,' ','ELAS_ISTR',0,' ',
