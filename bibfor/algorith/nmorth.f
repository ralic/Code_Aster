      SUBROUTINE NMORTH (FAMI,KPG,KSP,NDIM,PHENOM,IMATE,POUM,
...
C     VARIABLE LOCALE
      ...
      REAL*8 VALRES(3),DEPLTH(6),DEPGTH(6),DEPSTR(6)
 ...
 10     CONTINUE
      ...
      IF ( OPTION.EQ.'FULL_MECA'.OR.OPTION.EQ.'RAPH_MECA') THEN
        ...
        IF (PHENOM.EQ.'ELAS_ORTH') THEN
          ...
          CALL VERIFT(FAMI,KPG,KSP,POUM,IMATE,'ELAS_ORTH',3,
     &                VALRES,IRET)
          DEPLTH(1) = VALRES(1)
          DEPLTH(2) = VALRES(2)
          DEPLTH(3) = VALRES(3)
...
C RECUPERATION DES PARAMETRES MATERIAUX A L INSTANT -
          ...
          CALL VERIFT(FAMI,KPG,KSP,POUM,IMATE,'ELAS_ISTR',2,
     &                VALRES,IRET)
          DEPLTH(1) = VALRES(1)
          DEPLTH(2) = VALRES(1)
          DEPLTH(3) = VALRES(2)
