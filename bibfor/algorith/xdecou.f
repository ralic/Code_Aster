...
C     - VRAI NUMERO ARETE CORRESPONDANTE (SERT QUE POUR NOEUD SOMMET)
...
C           ON AJOUTE A LA LISTE LE POINT A
            CALL XAJPIN(JPTINT,PTMAX,IPT,INS,A,LONGAR,JAINT,0,IA,0.D0)

          ENDIF
          IF (LSNB.EQ.0) THEN
C           ON AJOUTE A LA LISTE LE POINT B
            CALL XAJPIN(JPTINT,PTMAX,IPT,INS,B,LONGAR,JAINT,0,IA,LONGAR)
          ENDIF
