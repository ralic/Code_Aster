...
C           ON AJOUTE A LA LISTE LE POINT A
      CALL XAJPIN(PINTER,PTMAX,IPT,INS,A,LONREF,AINTER,0,NA,0.D0)
          ENDIF
          IF (LSNB.EQ.0) THEN
C           ON AJOUTE A LA LISTE LE POINT B
      CALL XAJPIN(PINTER,PTMAX,IPT,INS,B,LONREF,AINTER,0,NB,0.D0)
          ENDIF
...
C           ON AJOUTE A LA LISTE LE POINT C
           CALL XAJPIN(PINTER,PTMAX,IPT,IBID,C,LONREF,AINTER,
     &                 IA,0,0.D0)
          ENDIF
        ENDIF
 100  CONTINUE
