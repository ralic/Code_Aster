      SUBROUTINE  NIRM3B (OPTION, NNO1, NNO2, NPG1, IPOIDS, IVF1, IVF2,
...
C TOLE CRS_1404
      ...
      INTEGER NNO1, NNO2, NPG1, IMATE, IPOIDS, IVF1, IVF2, IDFDE1
...
C......................................................................
C     BUT:  CALCUL  DES OPTIONS RIGI_MECA AVEC LE MINI-ELEMENT EN 3D
C......................................................................
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8 F(3,3), DSBDEP(6,6)
      REAL*8 DEF(6,NNO1,3), DEFD(6,27,3), DEFTR(27,3)
      REAL*8 TMP, B(6,81), POIDS, ALPHA, TREPST
      REAL*8 KBB(3,3), KBP(3,4), KCE(4,4), RCE(1,4)
...
C - CALCUL DE LA MATRICE D'ELASTICITE BULLE
        CALL TANBUL(OPTION, 3, KPG, IMATE, 'ELAS            ', ALPHA,
     &              DSBDEP, TREPST)

C - CALCUL DE LA MATRICE DE CONDENSATION STATIQUE 
        CALL CALKBB(NNO1, 3, AXI, 0.D0, KPG, GEOM, IVF1, F, IPOIDS,
     &              IDFDE1, DSBDEP, KBB)
        CALL CALKBP(NNO2, 3, AXI, 0.D0, KPG, GEOM, IVF2, IPOIDS, IDFDE1,
     &              KBP)
        CALL CALKCE(NNO1, 3, KBP, KBB, GONFVD, DGONVD, KCE, RCE)
