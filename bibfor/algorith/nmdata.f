...
C
      ...
      CHARACTER*16  METHOD(*),INERTE
      REAL*8        PARMET(*),PARCRI(*),PARCON(*),TBGRCA(3)
C
C ----------------------------------------------------------------------
C
...
C
     ...
     &            LISCHA,SOLVEU,SDSENS,INERTE,TBGRCA)
C
...
C
C --- OPTIONS OBLIGATOIRES POUR DEPL_CALCULE
C      
      IF (METHOD(5).EQ.'DEPL_CALCULE') THEN
        IF ((PARCRI(4).EQ.0).AND.(PARCRI(1).NE.0)) THEN
          CALL U2MESS('F','MECANONLINE5_44')
        ENDIF
      END IF      
C
