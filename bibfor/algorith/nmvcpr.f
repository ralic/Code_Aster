...
C
      ...
      REAL*8       X(2)
      CHARACTER*8  VECEL(2),VECELP,VECELM
      CHARACTER*8  MODELE
...
C
      CALL JEEXIN(VECELM//'.LISTE_RESU',IRET)
      IF (IRET.EQ.0) THEN
        CALL MEMARE('V',VECELM,MODELE,MATE,CARELE,'CHAR_MECA')
        CALL MEMARE('V',VECELP,MODELE,MATE,CARELE,'CHAR_MECA')
        CALL WKVECT(VECELM//'.LISTE_RESU','V V K24',NBRENV,JVCP)
        CALL WKVECT(VECELP//'.LISTE_RESU','V V K24',NBRENV,JVCM)
      END IF
C
