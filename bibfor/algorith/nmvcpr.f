      SUBROUTINE NMVCPR(MODELE, LISCHA, NUMEDD, MATE  , CARELE, COMREF,
...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
      ...
      INTEGER      JVCP, JVCM,JINF,NCHAR,NUMCHT
      REAL*8       X(2)
      CHARACTER*6  MASQUE
      CHARACTER*8  VECEL(2), LPAIN(23), LPAOUT(1), PARTPM, PARTPP, NOMGD
      CHARACTER*8  K8BID
      CHARACTER*16 OPTION
      CHARACTER*24 DEPMOI, SIGMOI, VARMOI, COMMOI, CHVREF
      CHARACTER*24 VRCPLU, PHAPLU, INSPLU
