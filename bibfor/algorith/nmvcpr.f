...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
      ...
      REAL*8       X(2)
      CHARACTER*6  MASQUE
      CHARACTER*8  VECEL(2), LPAIN(25), LPAOUT(1), PARTPM, PARTPP, NOMGD
      CHARACTER*8  K8BID
      CHARACTER*16 OPTION
      CHARACTER*24 DEPMOI, SIGMOI, VARMOI, COMMOI, CHTREF, CHSREF
      CHARACTER*24 TEMPLU, VRCPLU, SECPLU, PHAPLU, EPAPLU, INSPLU
      CHARACTER*24 TEMMOI, VRCMOI, SECMOI, PHAMOI, EPAMOI, INSMOI
      CHARACTER*24 LIGRMO, CHGEOM, CHCARA(16), LCHIN(25), LCHOUT(1)
      CHARACTER*24 K24BID
...
C    THERMIQUE
      IF (EXITEM) THEN
       ...
       CALL CALCUL('S',OPTION,LIGRMO,25,LCHIN,LPAIN,1,LCHOUT,LPAOUT,'V')
