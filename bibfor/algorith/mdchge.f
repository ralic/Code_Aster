...
C
         CALL GETVTX(MOTFAC,'NOEUD_1',I,1,1,NOMNO1,IBID)
         IF (IBID.NE.0) THEN
            NOECHO(I,1) = NOMNO1
         ELSE
            CALL GETVTX(MOTFAC,'GROUP_NO_1',I,1,1,NOMGR1,IBID)
         ...
         NOECHO(I,4) = MAYA1
C
         CALL GETVTX(MOTFAC,'NOEUD_2'   ,I,1,1,NOMNO2,NN1)
         CALL GETVTX(MOTFAC,'GROUP_NO_2',I,1,1,NOMGR2,NN2)
