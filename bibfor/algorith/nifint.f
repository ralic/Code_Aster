     ...
     &   TEMPM,TEMPP,TREF,DDLM,DDLD,ANGMAS,SIGM,VIM,SIGP,VIP,VECT,MATR,
     &   CODRET)
...
C TOLE CRP_21
      ...
      REAL*8 TEMPM(NNO1),TEMPP(NNO1),TREF,INSTM,INSTP,ANGMAS(7)
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8 TMG,TPG,GM,GD,GP,PM,PD,PP,R,W,WM,WP,JM,JD,JP
      REAL*8 FM(3,3),FD(3,3),EPSM(6),EPSD(6),CORM,CORD,FTD(3,3),FTM(3,3)
      REAL*8 SIGMAM(6),TAUHYM,TAUP(6),TAUHY,TAUDV(6),TAULDC(6)
...
C      VARIABLES DE COMMANDE
        TMG = DDOT(NNO1,VFF1(1,G),1,TEMPM,1)
        TPG = DDOT(NNO1,VFF1(1,G),1,TEMPP,1)
...
C      ET QUI UTILISENT ENCORE LA CONTRAINTE EN T-
     ...
     &             INSTM,INSTP,TMG,TPG,TREF,FTM,FTD,
