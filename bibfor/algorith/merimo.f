...
C
      ...
      CHARACTER*24 TEMMOI,PHAMOI,INSMOI,VRCMOI
      CHARACTER*24 TEMPLU,PHAPLU,INSPLU,VRCPLU
...
C --- ON TESTE LA NATURE DU CHAMP DE TEMPERATURE :
      ...
      LCHIN(38) = VRCPLU
      LPAIN(39) = 'PNBSP_I'
      LCHIN(39) = CHCARA(1) (1:8)//'.CANBSP'
      LPAIN(40) = 'PFIBRES'
      LCHIN(40) = CHCARA(1) (1:8)//'.CAFIBR'
      LPAIN(41) = ' '
      LCHIN(41) = ' '
      LPAIN(42) = ' '
      LCHIN(42) = ' '
