...
C 
      ...
      CALL MAJOUR(NEQ    ,LGROT ,SDNUME,ZR(JDEPDL),ZR(JDDEPL),
     &            1.D0   ,ZR(JDEPDT))
C
...
C  
      ...
      CALL MAJOUR(NEQ    ,LGROT ,SDNUME,ZR(JDEPPL),ZR(JDDEPL),
     &            1.D0   ,ZR(JDEPPT))
C
