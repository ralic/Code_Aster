...
C
      INTEGER      NOCC,JINFC,NBCHAR,IRET,NBSS,NBSST,IBID
...
C
      ...
      DO 10 ICHAR = 1,NBCHAR
        IF (ZI(JINFC+NBCHAR+ICHAR).EQ.4) THEN
          FONACT(13) = 1 
        ENDIF
 10   CONTINUE
C
...
C
      DO 12 ICHAR = 1,NBCHAR
        IF (ZI(JINFC+3*NBCHAR+2+ICHAR).EQ.1)  THEN
          FONACT(22) = 1 
        ENDIF      
 12   CONTINUE 
C
...
C
      IF (NBCHAR.NE.0) THEN
        IF (ZI(JINFC+2*NBCHAR+2)*NBCHAR.NE.0) THEN
          FONACT(20) = 1
        ENDIF  
      ENDIF    
C
