...
C
     ...
     &            SDIMPR,SDDISC,SDCRIT,SDERRO,PARMET,
     &            COMREF,MATASS,METHOD,NUMINS,ITERAT,
     &            CONV  ,ETA   ,PARCRI,DEFICO,RESOCO,
     &            LICCVG,VALMOI,VALPLU,SOLALG,MEASSE,
     &            VEASSE,ITEMAX,CONVER,ERROR ,FINPAS,
     &            MAXREL)
C
...
C
C --- IMPRESSION STATISTIQUES TEMPS
C 
      CALL NMSTAT(FONACT,SDTIME,RESOCO)
C 
