...
C
      ...
      PARAMETER   (ZFON    = 25,ZPMET  = 30,ZPCRI  = 11,ZCONV = 21)
...
C
      ...
      LOGICAL      LEXPL,LMPAS,LCTCG,LIMPEX
C
C --- FONCTIONS
C
...
C --- SUIVI DE DDL
C
      CALL NMOBSV(MAILLA,SDDISC,NUMINS,SDIMPR,
...
C 
      CALL NMADAT(SDDISC,NUMINS,ITERAT,VALMOI,VALPLU,
     &            FINPAS)
C
