...
C
      ...
      PARAMETER   (ZINST   = 5 ,ZPCON  =  9,ZNMETH = 7 ,ZLICC = 5)    
      LOGICAL      FONACT(ZFON)
...
C
     ...
     &            METHOD,ITERAT,ETA   ,CONV  ,LICCVG,
     &            ITEMAX,CONVER,ECHLDC,ECHEQU,ECHCON,
     &            ECHPIL,FINPAS,SDCRIT,NUMINS,SDDISC,
     &            PARMET,CNVFRE,MAILLA,INST  ,VALMOI,
     &            VALPLU,DEPALG,MEASSE,SDDYNA,CNVCF1,
     &            NUMEDD,DEFICO,RESOCO,MATASS,SDIMPR,
     &            FONACT,MAXREL,MATE  ,COMREF)
C
...
C -- SAUVEGARDE DU SECOND MEMBRE POUR ALPHA-METHODE
      ...
      IF ( NDYNLO(SDDYNA,'HHT_COMPLET')) THEN
        CALL NMCHSV(CNFINT,SECMBR,SDDYNA,NUMINS)
      ENDIF
