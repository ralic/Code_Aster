...
C
      ...
      LOGICAL      LREAC(2), LOGIC, LMODAL,MAXREL,ECHPIL, FOPREC
C
      INTEGER      LICCVG(5), MAXB(4), VECONT(2),TYPALC
      INTEGER      IFM,    NIV,    NEQ,    IRET,   IBID,   I , IRET2
...
C
      CHARACTER*13 INPSCO,K13BID,SCHEMA
      CHARACTER*14 PILOTE
C
...
C -- ETAT INITIAL ET CREATION DES STRUCTURES DE DONNEES
     ...
     &            PARCRI(6),NBPASE,INPSCO,LISCH2,NBOBSE,NUINS0,
     &            LOBSER,NUOBSE,NOMTAB,MAILL2,NBOBAR,LISINS,LISOBS,
     &            INSTAM,IMPRCO,SUIVCO)     
...
C -- PREDICTION D'UNE DIRECTION DE DESCENTE
     ...
     &            LMODAL, DEPDEL, IALGO,  SECOLD, CNFOLD, FOPREC)
...
C -- DES RIGI_ELEM (SI DEMANDE)
     ...
     &            LAMORT, MEMASS, MASSE,  AMORT,  COEDEP, COEVIT, 
...
C -- CALCUL DE FLAMBEMENT EN STATIQUE ET DYNAMIQUE
     ...
     &             MEMASS,MASSE,AMORT,COEVIT,COEACC,LICCVG,'FLAMBSTA')
     ...
     &             ITERAT,POUGD,DEPDEL,PARTPS,
     &             DEFICO,STADYN,PREMIE,CMD,DEPENT,VITENT,LAMORT,
     &             MEMASS,MASSE,AMORT,COEVIT,COEACC,LICCVG,'FLAMBDYN')
      ENDIF
...
C -- CALCUL DE MODES VIBRATOIRES EN DYNAMIQUE
     ...
     &           ITERAT,POUGD,DEPDEL,PARTPS,
     &           DEFICO,STADYN,PREMIE,CMD,DEPENT,VITENT,LAMORT,
     &           MEMASS,MASSE,AMORT,COEVIT,COEACC,LICCVG,'VIBRDYNA')
        ENDIF
      ENDIF
