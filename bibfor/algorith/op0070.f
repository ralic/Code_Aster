...
C -- ESTIMATION DES FORCES NODALES LIEE AUX VAR. COMMANDES INITIALES
      CALL NMVCFO(MODELE(1:8), NUMEDD, MATE  , CARELE, COMPOR, COMREF,
     &            COMMOI, CNVCF1)
...
C -- ESTIMATION D'UNE FORCE DE REFERENCE LIEE AUX VAR. COMMANDES EN T+
      CALL NMVCFO(MODELE, NUMEDD, MATE  , CARELE, COMPOR, COMREF,
     &            COMPLU, CNVCFO)
...
C -- ET COMMUNIQUENT PAR LA VARIABLE NIVEAU
  ...
  101 CONTINUE
     ...
     &            ACCINI, CMD, INST, FONACT(9), USUMOI, 
...
C -- DES RIGI_ELEM (SI DEMANDE)
     ...
     &            DEPGEM, DEPGEP, USUPLU, USUMOI, USUINI,
     &            USUFIX)
...
C --- METHODE CONTACT CONTINUE
     ...
     &            MAXREL, IMPRCO, USUFIX, VECNOD, NEQ,
...
C -- OBSERVATION EVENTUELLE
      ...
      IF ( LOBSER ) THEN
        CALL DYOBAR(MAILL2,NBMODS,INSTAP,IBID,
     &            VITPLU,ACCPLU,VALPLU,K24BID,
     &            SECMBR,K24BID,K24BID,
     &            DEPENT,VITENT,ACCENT,CNSINR,
     &            NOMTAB,NBOBAR,NUOBSE,.FALSE.)
      ENDIF
...
C -- ON COMMENCE PAR ARCHIVER LE PAS DE TEMPS PRECEDENT
     ...
     &               MODELE, MATE, CARELE, LISCH2 )
      ...
      ELSE IF (MTCPUP) THEN
        RTAB(1)=TPS1(4)
        RTAB(2)=TPS1(1)
        CALL UTEXCM(28,'MECANONLINE_80',0,K8BID,1,NUMINS,2,RTAB)
