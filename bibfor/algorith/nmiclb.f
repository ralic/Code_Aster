     ...
     &                  TEMPM,TEMPP,TREF,VIM,EFFNOP,VIP,KLV,FONO)
C ------------------------------------------------------------------
...
C --- CARACTERISTIQUES ELASTIQUES A TMOINS
      ...
      VALPAR = TEMPM
      CALL RCVALA(IMATE,'ELAS',NBPAR,NOMPAR,VALPAR,1,'E',EM,CODRES,FB2)
...
C --- CARACTERISTIQUES ELASTIQUES A TPLUS
      ...
      VALPAR = TEMPP
      CALL RCVALA(IMATE,'ELAS',NBPAR,NOMPAR,VALPAR,1,'E',EP,CODRES,FB2)
