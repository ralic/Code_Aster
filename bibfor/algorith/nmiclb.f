      SUBROUTINE NMICLB(KPGVRC,OPTION,COMPOR,IMATE,XLONG0,A,DLONG0,
     &          EFFNOM,TEMPM,TEMPP,TREF,VIM,EFFNOP,VIP,KLV,FONO,EPSM,
     &          CRILDC,CODRET)
C ------------------------------------------------------------------
...
C ------------------------------------------------------------------
      IMPLICIT NONE
      INTEGER IMATE,NEQ,NBT,NBPAR,KPGVRC,CODRET
...
C --- CARACTERISTIQUES ELASTIQUES A TPLUS
     ...
     &              DEPS,VIM,OPTION,SIGP,VIP,DSDE)
      ...
      ELSE IF (CORR) THEN
        CALL NM1DCO(KPGVRC,OPTION,IMATE,TEMPM,TEMPP,EP,SIGM,EPSM,DEPS,
