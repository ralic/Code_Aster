...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
      ...
      INTEGER      NBMA,IBID,IMA,IAD,IRET,ISPT,STACO0
      ...
      DELTAT = 100.D0   
      WRITE(6,*)'DELTAT A MODIFIER',DELTAT
...
C       (SI STACO_INIT EST DIFFÉRENT DE 0 BIEN ÉVIDEMMENT)
   ...
   12       CONTINUE 
   11     CONTINUE        
          CALL CESCEL(CES,LIGREL,'RIGI_CONT','PINDCOI','OUI','V',CEL1)
...
C       2) CHAM_ELEM DO (DONNÉES DU CONTACT)
 ...
 20     CONTINUE
        ...
        CALL CESCEL(CES,LIGREL,'RIGI_CONT','PDONCO','OUI','V',CEL2)
        CALL DETRSD('CHAM_ELEM_S',CES)
...
C       (SI SEUIL_INIT EST DIFFÉRENT DE 0 BIEN ÉVIDEMMENT)
   ...
   32       CONTINUE 
   31     CONTINUE        
          CALL CESCEL(CES,LIGREL,'RIGI_CONT','PSEUIL','OUI','V',CEL3)
