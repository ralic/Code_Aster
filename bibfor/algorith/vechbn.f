...
C
     ...
     &      (SS1.EQ.SST2.AND.SS2.EQ.SST1)) THEN
          ...
          MACRO1 = ZK8(LLNOM1)
          MACRO2 = ZK8(LLNOM2)
          CALL JEVEUO(MACRO1//'.MAEL.MASS .REFE','L',LMACR1)
          ...
          LINO2 = INTF2(1:14)//'.INTD.LINO'
          CALL JENONU(JEXNOM(LINO1(1:19)//'.NOMS',LIAI1),IBID)
          CALL JEVEUO(JEXNUM(LINO1,IBID),'L',LLINO1)
          CALL JENONU(JEXNOM(LINO2(1:19)//'.NOMS',LIAI2),IBID)
          CALL JEVEUO(JEXNUM(LINO2,IBID),'L',LLINO2)
          K8BID = '        '
          CALL JELIRA(JEXNUM(LINO2,IBID),'LONMAX',NBNOEU,K8BID)
          CALL JEVEUO(INTF1(1:14)//'.INTD.DEFO','L',LDEFO1)
          CALL JEVEUO(INTF2(1:14)//'.INTD.DEFO','L',LDEFO2)
          CALL JEVEUO(INTF1(1:14)//'.INTD.REFE','L',LREFE1)
          CALL JEVEUO(INTF2(1:14)//'.INTD.REFE','L',LREFE2)
