...
! =====================================================================
            ...
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        ...
                        0)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, ncra2(2), val2(2), icodre,&
                        0)
!
            if (icodre(1) .eq. 1) then
                call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                            [0.d0], 1, ncra2(7), val2(7), icodre,&
                            0)
!
                if (icodre(1) .eq. 1) then
! ELAS_ISTR 3D
...
! =====================================================================
            ...
            if (icodre(1) .eq. 1) then
                call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                            [0.d0], 1, ncra4(8), val4(8), icodre,&
                            0)
                if (icodre(1) .eq. 1) then
! ELAS_ISTR 3D
                    aniso=1
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.d0], 2, ncra4(4), val4(4), icodre,&
                                0)
!
                else
! ELAS_ORTH 2D
