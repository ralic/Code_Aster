...
30          continue
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.0d0], 1, ncra2, val2, icodre, 0)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.0d0], 1, ncra2(2), val2(2), icodre, 0)
!
            if (icodre(1) .eq. 1) then
                call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                            [0.0d0], 1, ncra2(7), val2(7), icodre, 0)
!
                if (icodre(1) .eq. 1) then
! ELAS_ISTR 3D
                    aniso=1
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.0d0], 2, ncra2(3), val2(3), icodre, 0)
                else
! ELAS_ORTH 2D
                    aniso=2
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
            ...
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.0d0], 1, ncra2(6), val2(6), icodre, 0)
            rhod = val2(1)
            biot(1) = val2(2)
            biot(2) = val2(3)
            biot(3) = val2(4)
...
50          continue
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.0d0], 2, ncra4, val4, icodre, 0)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.0d0], 1, ncra4(3), val4(3), icodre, 0)
            if (icodre(1) .eq. 1) then
                call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                            [0.0d0], 1, ncra4(8), val4(8), icodre, 0)
                if (icodre(1) .eq. 1) then
! ELAS_ISTR 3D
                    aniso=1
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.0d0], 2, ncra4(4), val4(4), icodre, 0)
!
                else
! ELAS_ORTH 2D
                    aniso=2
            ...
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.0d0], 1, ncra4(7), val4(7), icodre, 0)
            rgaz = val4(1)
            rhod = val4(2)
            biot(1) = val4(3)
            biot(2) = val4(4)
...
120          continue
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        ...
                        0)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, ncra9(3), val9(3), icodre,&
                        0)
            if (icodre(1) .eq. 1) then
                call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                            [0.d0], 1, ncra9(10), val9(11), icodre,&
                            0)
                if (icodre(1) .eq. 1) then
! ELAS_ISTR 3D
                    aniso=1
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.d0], 2, ncra9(4), val9(4), icodre,&
                                0)
!
                else
! ELAS_ORTH 2D
...
131          continue
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        ...
                        0)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, ncra35(3), val35(3), icodre,&
                        0)
            if (icodre(1) .eq. 1) then
...
! ELAS_ISTR 3D
                    aniso=1
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.d0], 2, ncra35(4), val35(4), icodre,&
                                0)
                else
! ELAS_ORTH 2D
                    aniso=2
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                ...
                                0)
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.d0], 1, ncra35(10), val35(11), icodre,& 
                                0)
                endif
            else if (icodre(1).eq.0) then
                aniso=0
...
!
            ...
            call rcvala(imate, ' ', 'THM_AIR_DISSOUS', 1, 'TEMP',&
                        ...
                        1)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, ncra35(9), val35(10), icodre,&
                        0)
            rgaz = val35(1)
            rhod = val35(2)
            biot(1) = val35(3)
...
9131          continue
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        ...
                        0)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, crad35(3), val35(3), icodre,&
                        0)
            if (icodre(1) .eq. 1) then
                call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
...
! ELAS_ISTR 3D
                    aniso=1
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.d0], 2, crad35(4), val35(4), icodre,&
                                0)
                else
! ELAS_ORTH 2D
                    aniso=2
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                ...
                                0)
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.d0], 1, crad35(10), val35(11), icodre,&
                                0)
                endif
            else if (icodre(1).eq.0) then
                aniso=0
...
!
            ...
            call rcvala(imate, ' ', 'THM_AIR_DISSOUS', 1, 'TEMP',&
                        ...
                        1)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, crad35(9), val35(10), icodre,&
                        0)
            rgaz = val35(1)
            rhod = val35(2)
            biot(1) = val35(3)
...
150          continue
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        ...
                        0)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, ncra13(3), val13(3), icodre,&
                        0)
            if (icodre(1) .eq. 1) then
                call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
...
! ELAS_ISTR 3D
                    aniso=1
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.d0], 2, ncra13(4), val13(4), icodre,&
                                0)
!
                else
! ELAS_ORTH 2D
                    ...
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                ...
                                0)
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.d0], 1, ncra13(10), val13(11), icodre,&
                                0)
                endif
            else if (icodre(1).eq.0) then
                aniso=0
...
170          continue
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        ...
                        0)
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, ncra16(2), val16(2), icodre,&
                        0)
            if (icodre(1) .eq. 1) then
                call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                            [0.d0], 1, ncra16(9), val16(10), icodre,&
                            0)
                if (icodre(1) .eq. 1) then
! ELAS_ISTR 3D
                    aniso=1
                    call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                                [0.d0], 2, ncra16(3), val16(3), icodre,&
                                0)
!
                else
! ELAS_ORTH 2D
...
! ELAS_ORTH 2D
              aniso=2
              call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, 'BIOT_L', biot(2), icodre,&
                        0)
              call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 1, 'BIOT_N', biot(3), icodre,&
                        0)
              call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
...
!
            call rcvala(imate, ' ', 'THM_DIFFU', 0, ' ',&
                        [0.d0], 3, ncra18(1), val18(1), icodre,&
                        0)
...
!
            call rcvala(imate, ' ', 'THM_DIFFU', 1, 'INST',&
                        [instap], 1, 'PESA_MUL', fpesa(1), icodre, 0)
...
! =====================================================================
            ...
            if (ther .ne. ' ') then
                ...
                if (icodre(1) .eq. 1) then
                    call rcvala(imate, ' ', 'THM_DIFFU', 1, 'TEMP',&
                                [t], 1, ncra25(15), val25(15), icodre, 0)
                    if (icodre(1) .eq. 0) then
                        aniso3=1
                        call rcvala(imate, ' ', 'THM_DIFFU', 1, 'TEMP',&
