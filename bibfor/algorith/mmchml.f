...
C ------- COMPLIANCE
          ZR(JVALV-1+21) = ICOMPL
          ZR(JVALV-1+22) = ASPERI
          ZR(JVALV-1+23) = COMPEN
          ZR(JVALV-1+24) = COMPEV
          ZR(JVALV-1+25) = ZR(JTABF+ZTABF*(IPTC-1)+23)
C ------- USURE
          ZR(JVALV-1+26) = IUSURE
          ZR(JVALV-1+27) = KWEAR
          ZR(JVALV-1+28) = HWEAR
C ------- EXCLUSION/RACCORDS
          ZR(JVALV-1+29) = ZR(JTABF+ZTABF*(IPTC-1)+19)
          ZR(JVALV-1+30) = ZR(JTABF+ZTABF*(IPTC-1)+20)
          ZR(JVALV-1+31) = ZR(JTABF+ZTABF*(IPTC-1)+21)
C ------- DYNAMIQUE
          ZR(JVALV-1+32) = IFORM   
