      SUBROUTINE  DELOCA(FAMI,NDIM, OPTION, TYPMOD, NPG, IPOIDS, NNO2,
     &                 IVF2, IDFDE2, DFDI2,
     &                 NNO1, VFF1, DFDE1,DFDN1, DFDK1, DFDI1, GEOMI,
     &                 IMATE, COMPOR, CARCRI, RLAG,
...
C -- INITIALISATION
      IF (NNO2*NDIM .GT. 27*3) CALL U2MESS('F','ALGORITH2_77')
...
C        CALCUL DE F POUR DT  =>  DF, RM  ET DFDIM
          CALL DCOPY(NDIM*NNO2,GEOMI,1,GEOMM,1)
          CALL DAXPY(NDIM*NNO2,1.D0,DEPLM,1,GEOMM,1)
...
C -- LOI DE COMPORTEMENT : PARTIE NON LOCALE
        ...
        CALL EDCOMP (FAMI,KPG,1,NDIM, TYPMOD, OPTION, COMPOR, IMATE,
     &               CARCRI,EPSM, DEPS, SIGMA,
