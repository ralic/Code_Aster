      SUBROUTINE TTPRSM(NDIM,C,GEOME,GEOMM,DEPLE,DEPLM,COEFFA,INADH,
     &                    RESE,TAU1,TAU2)
...
C ======================================================================
      ...
      REAL*8  COEFFA,NRESE
      REAL*8  C(3,3),GEOME(3),GEOMI(3),GEOMM(3),RESE(3),DEPLE(6)
...
C                  GEOME  : LA GEOMETRIE DE POINT DE CONTACT
C                  GEOMM  : LA GEOMETRIE DE POINT VIS A VIS
