...
C        FISS    : NOM DU CONCEPT FISSURE XFEM DE LA FISSURE PROPAGEE
C        FISPRE  : NOM DU CONCEPT FISSURE XFEM DE LA FISSURE ACTUELLE
...
C     ------------------------------------------------------------------
     ...
     &               JFEL,JFELL,JFELD,JMEAST,JMESTL,JMESTD,ITEMP,
     ...
     &               DIST,DISMIN,R8MAEM
      CHARACTER*3    ITERK3
      CHARACTER*8    K8B,LPAIN(4),LPAOUT(2),TYPMA
     ...
     &               CELGDF,CELPTF,CNOPTF,CNOGDF,K19BID
