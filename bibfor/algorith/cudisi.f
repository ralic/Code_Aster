...
C
C RETOURNE DES INFOS DIVERSES POUR LIAISON_UNIL (ENTIER)
C
C ----------------------------------------------------------------------
C
C      
C IN  DEFICU  : SD DE DEFINITION DE LIAISON_UNILATER (DEFI_CONTACT)
