...
C ----------------------------------------------------------------------
      ...
      REAL*8   KRON(6)
      REAL*8   MUM,MU,TROIKM,TROISK,ALPHAM,ALPHAP,ANIC(6,6),ANI(6,6)
...
C EN AXI C EST SIMPLE CAR IL SUFFIT D INVERSER LES TERMES 2 ET 3
      ...
      CALL EDGMAT (FAMI,KPG,KSP,IMAT,C1,ZALPHA,TEMP,DT,MUM,MU,
     1             TROIKM,TROISK,ALPHAM,ALPHAP,ANIC,M,N,GAMMA)
