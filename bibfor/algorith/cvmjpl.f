...
C
        ...
        N8 = 3*NDT + 4 + NOPT
C
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N1,N1,DGDS  ,6,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N1,N2,DGDX1 ,6,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N1,N3,DGDX2 ,6,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N1,N4,DGDP  ,6,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N1,N5,DGDR  ,6,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N1,N6,DGDQ  ,6,1,1,1)
C
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N2,N1,DLDS  ,6,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N2,N2,DLDX1 ,6,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N2,N3,DLDX2 ,6,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N2,N4,DLDP  ,6,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N2,N5,DLDR  ,6,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N2,N6,DLDQ  ,6,1,1,1)
C
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N3,N1,DJDS  ,6,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N3,N2,DJDX1 ,6,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N3,N3,DJDX2 ,6,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N3,N4,DJDP  ,6,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N3,N5,DJDR  ,6,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N3,N6,DJDQ  ,6,1,1,1)
C
        CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N4,N1,DKDS  ,1,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N4,N2,DKDX1 ,1,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N4,N3,DKDX2 ,1,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N4,N4,DKDP  ,1,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N4,N5,DKDR  ,1,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N4,N6,DKDQ  ,1,1,1,1)
C
        CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N5,N1,DRDS  ,1,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N5,N2,DRDX1 ,1,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N5,N3,DRDX2 ,1,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N5,N4,DRDP  ,1,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N5,N5,DRDR  ,1,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N5,N6,DRDQ  ,1,1,1,1)
C
        CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N6,N1,DTDS  ,1,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N6,N2,DTDX1 ,1,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N6,N3,DTDX2 ,1,6,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N6,N4,DTDP  ,1,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N6,N5,DTDR  ,1,1,1,1)
        CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N6,N6,DTDQ  ,1,1,1,1)
C
        IF ( MOD(1:6) .EQ. 'C_PLAN' ) THEN
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N1,N8,DGDE3 ,6,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N2,N8,DLDE3 ,6,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N3,N8,DJDE3 ,6,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N4,N8,DKDE3 ,1,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N5,N8,DRDE3 ,1,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N6,N8,DTDE3 ,1,1,1,1)
C
           CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N8,N1,DQDS  ,1,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N8,N2,DQDX1 ,1,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N8,N3,DQDX2 ,1,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N8,N4,DQDP  ,1,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N8,N5,DQDR  ,1,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N8,N6,DQDQ  ,1,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N8,N8,DQDE3 ,1,1,1,1)
        ENDIF
C
        IF ( IOPTIO .EQ. 2) THEN
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N1,N7,DGDXXI ,6,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N2,N7,DLDXXI ,6,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N3,N7,DJDXXI ,6,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N4,N7,DKDXXI ,1,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N5,N7,DRDXXI ,1,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N6,N7,DTDXXI ,1,6,1,1)
C
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N7,N1,DXIDS  ,6,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N7,N2,DXIDX1 ,6,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N7,N3,DXIDX2 ,6,6,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N7,N4,DXIDP  ,6,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N7,N5,DXIDR  ,6,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N7,N6,DXIDQ  ,6,1,1,1)
           CALL LCICMA (DRDY,NMOD,NMOD,NDT,NDT,N7,N7,DXIDXI,6,6,1,1)
C
           IF ( MOD(1:6) .EQ. 'C_PLAN' ) THEN
              CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N8,N6,DQDQ   ,1,1,1,1)
              CALL LCICMA (DRDY,NMOD,NMOD,  1,NDT,N8,N7,DQDXXI ,1,6,1,1)
              CALL LCICMA (DRDY,NMOD,NMOD,NDT,  1,N7,N8,DXIDE3 ,6,1,1,1)
              CALL LCICMA (DRDY,NMOD,NMOD,  1,  1,N6,N8,DTDE3  ,1,1,1,1)
           ENDIF
        ENDIF
C
