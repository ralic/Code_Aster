      SUBROUTINE VFGEFA(MAXDIM,NDIM,NBNOS,XS,T,XG,SURF,NORM,XGF,D,IRET)
      IMPLICIT NONE
      INTEGER  MAXDIM,NDIM,NBNOS,IRET
      REAL*8   XS(MAXDIM,NBNOS),T(MAXDIM,NBNOS)
      REAL*8   XG(NDIM),SURF,NORM(MAXDIM),XGF(MAXDIM),D
C ----------------------------------------------------------------------
...
C     XS(MAXDIM,J) COORD SOMMET J
C     T(MAXDIM,J)  COORD DU VECTEUR DE L J EME ARETE
...
C
      INTEGER  IDIM,IS
      REAL*8   XS1(3,3),T1(3,2)
      REAL*8   SURF1,NORM1(3),XGF1(3),D1
      REAL*8   XS2(3,3),T2(3,2)
      REAL*8   SURF2,NORM2(3),XGF2(3),D2,N1VN2(3)
      REAL*8   XN1N2
C
C ----------------------------------------------------------------------
C
