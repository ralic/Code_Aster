      SUBROUTINE       XPLMAT(NDIM,DDLH,DDLE,DDLC,NNO,NNOM,N,PL)

      IMPLICIT NONE
      INTEGER          NDIM,DDLH,DDLE,DDLC,NNO,NNOM,N,PL
...
C IN  DDLE    : NOMBRE DE DDL ENRICHI EN FOND (PAR NOEUD)
