...
C     SI CELLE-CI EST IMPOSEE A PRIORI, ON ANNULE SON INFLUENCE
...
C       POST-TRAITEMENT DE LA PRESSION DE FLUIDE CALCULEE
C       AUX NOEUDS (DDL) ET INTERPOLEE AU PG :
        PRESG = EPSM(2*NDIM)
...
C       POST-TRAITEMENT DE LA PRESSION DE FLUIDE IMPOSEE AU PG :
        VIP(18) = PRESFL
