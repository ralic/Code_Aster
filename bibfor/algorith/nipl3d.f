       SUBROUTINE  NIPL3D(NNO1,NNO2,NPG1,POIDSG,VFF1,VFF2,DFDE1,DFDN1,
     &                 DFDK1,GEOM,TYPMOD,OPTION,IMATE,COMPOR,LGPG,CRIT,
...
C TOLE CRP_21
       ...
       REAL*8        INSTAM,INSTAP,DFDE1(*),DFDN1(*),DFDK1(*)
...
C......................................................................
      ...
      INTEGER      KPG,KK,N,I,I1,M,J,J1,KL,PQ

      REAL*8       DSIDEP(6,6),F(3,3),EPS(6),DEPS(6)
      REAL*8       EPSM(6), DEPSM(6), EPSLDC(6), DEPLDC(6)
