...
C        REAJUSTEMENT DE LA LEVEL SET TANGENTE AUX NOEUDS SOMMETS, QUAND
C        LA VALEUR D'UN LST DIVISE PAR LA DIFFERENCE DES VALEURS AUX
C        DEUX EXTREMITES SONT INFERIEURES D'UN CERTAINE NOMBRE, ON MET
C        LES LST A ZERO.
...
C             RÉAJUSTEMENT DE LSNM AUX NOEUDS MILIEUX,QUAND LA VALEUR
C             D'UN LSNM SUR LA VALEUR LSNM LE PLUS GRAND DANS LE MEME
C             ELEMENT EST INFERIEURE D'UN CERTAINE NOMBRE, ON MET LES
C             LSN A ZERO.
...
C              RÉAJUSTEMENT DE LSTM AUX NOEUDS MILIEUX,QUAND LA VALEUR
C              D'UN LSTM SUR LA VALEUR LSTM LE PLUS GRAND DANS LE MEME
C              ELEMENT EST INFERIEURES D'UN CERTAINE NOMBRE, ON MET LES
C              LST A ZERO.
