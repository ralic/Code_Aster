...
C
      ...
      INTEGER      NESMAX,NBNOM,NBMA,NBDDLT,NDIM,NESCL
      ...
      CHARACTER*24 APJEFX,APJEFY,APCOFR,NOMACO,PNOMA
      INTEGER      JAPCOF,JAPJFX,JAPJFY,JNOMA,JPONO
...
C
     ...
     &                NBDDLT,DDL   ,NOMA  ,PROJ  ,JEUPM ,
     &                PROYES)
C
C --- CHOIX DE L'APPARIEMENT SUIVANT LE RESULTAT DE LA PROJECTION
C
          CALL CFCHOI(POSMA ,PROYES,JEUPM ,JEUMIN,POSMIN,
     &                PROMIN,PROJOP)     
C          
