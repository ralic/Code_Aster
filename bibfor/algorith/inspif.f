     ...
     1 EDT,RTM,EPSC,DEFR,TANG,IPLA,EQSTR,EPSEQ,IDIR )
...
C            REMARQUE : ON RETROUVE CETTE PENTE EN COMPRESSION
C            LORSQUE LA DEFORMATION EST SUPERIEURE A EPST
...
C     IDIR : DIRECTION D ORTHOTROPIE 1 OU 2 (SEULEMENT POUR DEBUG)
C
C OUT
C     SIGRX, EPSRX, ETS, EDC, EPST, IFISU, JFISU, EDT, RTM, EPSC
...
C------------------------------------------------------------------
      ...
      REAL*8    EPSC,EDC,EDT,RTM,DEFR,ETS
