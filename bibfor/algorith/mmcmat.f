...
C OUT MECTCE : MATR_ELEM CONTACT/FROTTEMENT METHODE CONTINUE
C
...
C
C --- ON DETRUIT MECTCE S'IL EXISTE
C
...
C
      ...
      LCHIN(8) = VITPLU
C
C --- CALCUL DES MATRICES ELEMENTAIRES CONTACT
C
