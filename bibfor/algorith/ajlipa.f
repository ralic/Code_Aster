...
C  REMARQUES :
C     * LA SD N'EST CREEE QUE DANS LE CAS DU //ISME MPI
...
C --- FIN DECLARATIONS NORMALISEES JEVEUX --------------------
      ...
      CHARACTER*19 LIGR19
      CHARACTER*8 MODELE,PARTIT,MA,KBID


      INTEGER I,RANG,NBPROC,IFM,NIV,IBID,JLGRF,ISD,NBSD,NBMA,JMAIL,IERD
      ...
      INTEGER IGR,JNUGSD,JNOLIG,NBGREL,JREPE
...
C     -- PAS DE SOUS-STRUCTURES EN DISTRIBUE
C     --------------------------------------
...
C     ----------------------------------------
        NBPRO1=NBPROC
        CALL WKVECT(PARTIT//'.NUPROC.GREL','G V I',NBGREL,JNUGSD)
        CALL WKVECT(PARTIT//'.NUPROC.LIGREL','G V K24',1,JNOLIG)
        ZK24(JNOLIG-1+1)=LIGR19
        DO 42,IGR=1,NBGREL
          ZI(JNUGSD-1+IGR)=MOD(IGR,NBPRO1)
   42   CONTINUE
