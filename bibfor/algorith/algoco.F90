subroutine algoco(ds_measure, defico, resoco, solveu, matass,&
                  noma, ctccvg)
!
! ======================================================================
...
!
! ALGO. POUR CONTACT    : CONTRAINTES ACTIVES
...
!
        call cfgran(resoco, nbliac, kkliai, kkliac)
!
        if (kkliai .eq. 0) then
!
! ------- ON A CONVERGE (IL Y A CONTACT)
!
            goto 160
        else
!
...
!
            call cftabl(indic, nbliac, ajliai, spliai, llf,&
                        llf1, llf2, resoco, typesp, kkliac,&
                        kkliai, typec0)
            call cfimp2(defico, resoco, noma, kkliai, typec0,&
                        'LIB')
        endif
    endif
!
