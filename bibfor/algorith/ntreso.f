      SUBROUTINE NTRESO(NRPASE,SDSENS,MODELE,MATE  ,CARELE,
...
C CALCUL STD TRANSITOIRE AVEC SENSIBILITE A SUIVRE (POUR 5.1)
        CALL NTNSLE(SDSENS,NRPASE,'VTEMPM',VTEMPM)
      ENDIF
      IF (NRPASE.GT.0) THEN
