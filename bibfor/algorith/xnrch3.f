...
C--------------------------------------------------------------------
     ...
     &  'DES LEVEL SETS. SUITE DES CALCULS RISQUEE...')
       ...
       IF (RAYON.GT.0.D0) CALL UTMESS('F','XNRCH3','NE PAS UTILISER '//
...
C--------------------------------------------------------------------
     ...
     &   CALL UTMESS('A','XENRCH','LE POINT INITIAL DE FISSURE N''EST'
     &    //' PAS UN POINT DE BORD DE FISSURE, BIEN QUE LA FISSURE '
     &    //'SOIT DEBOUCHANTE. ASSUREZ-VOUS DE LA BONNE DEFINITION DE'
     &    //' PFON_INI.')
      NBFOND=1
