      SUBROUTINE MMAPRE(PREMIE,NOMA  ,DEFICO,RESOCO,NEWGEO,
     &                  SDAPPA)
C     
...
C
      ...
      REAL*8       COORPC(3),VECTPM(3),JEUSGN,DDOT
      REAL*8       MMINFR,SEUILI,EPSINT
      REAL*8       ARMINI,ARMIN
      CHARACTER*8  ALIASE,NOMMAM
      LOGICAL      MMINFL,LVERI,LCOMPL,CTCINI
      INTEGER      MMINFI
      INTEGER      IBID
      INTEGER      JDECME
      ...
      LOGICAL      LAPPAR,LSSFRO,LSSCON,LPIVOT,LGLISS
...
C
            CALL MMEXCL(RESOCO,TYPINT,LGLISS,IPTC  ,IPTM  ,
...
C                                        
            CALL MMAPMA(NOMA  ,DEFICO,RESOCO,NEWGEO,NDIMG ,
     &                  IZONE ,LSSFRO,TYPINT,ALIASE,POSMAE,
     &                  NUMMAE,NNOMAE,COORPC,POSMAM,NUMMAM,
     &                  KSIPR1,KSIPR2,TAU1M ,TAU2M ,IPTM  ,
     &                  IPTC  ,NORM  ,NOMMAM)
C
C --------- JEU SIGNE
C
...
C
            CALL MMOPTI(PREMIE,RESOCO,SEUILI,CTCINI,LCOMPL,
