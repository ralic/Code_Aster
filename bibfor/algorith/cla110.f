...
C-----------------------------------------------------------------------
      PARAMETER   (NBCMPM=10)
      CHARACTER*8  NOMRES,MODGEN,TT,MAILLA,NOMCOU,NOMSST
      CHARACTER*16 CSS,CMA,CGR,MAICON,NOMCON
      REAL*8       XANC(3)
      CHARACTER*24 REPNOM,MODROT,MODTRA,GPPTNM
      CHARACTER*24 VALK(2),NOMGR
      REAL*8       MATROT(NBCMPM,NBCMPM)
      REAL*8       MATBUF(NBCMPM,NBCMPM),MATTMP(NBCMPM,NBCMPM)
      CHARACTER*8  K8BID,EXCLU
      INTEGER      IARG
C
C-----------------------------------------------------------------------
      DATA TT      /'&&CLA110'/
...
C-----DETERMINATION DU NOMBRE DE MAILLES POUR CHAQUE SST ACTIVE---------
      ...
      DO 220 I=1,IOC
        ...
        NGRMA = 0
        IF(NBTOUT.EQ.0) THEN
          CALL GETVTX(CSS,CGR,I,IARG,NBGR,ZK24(LTNOGR),IBID)
...
C
      ...
      CALL JECREC(NOMRES//'.GROUPEMA','G V I','NO '//GPPTNM,
...
C       --- TRAITEMENT DES GROUPES DE MAILLES
     ...
     &        NBINCR,ZK24(ILSTGR),ZK8(LUTSST),ZK24(LUTGMA),ZK24(LUTNOM))
        ENDIF
        CALL JELIBE(JEXNUM(TT//'.LISTE.MA',I))
