...
C ======================================================================
C       ----------------------------------------------------------------
C       VISCOCHABOCHE        : CONTROLE DE LA CONVERGENCE
...
C            DY     :  VECTEUR SOLUTION DY = ( DSIG DP DX1 )
...
C
     ...
     4          '- REDECOUPAGE DU PAS DE TEMPS')
                ...
                GOTO 9999
                ELSE
                  CALL UTDEXC(23,'VISCOCHABOCHE','ERREUR D INTEGRATION')
...
C
     ...
     4                  '- REDECOUPAGE DU PAS DE TEMPS')
                        ...
                        GOTO 9999
                       ELSE
                          CALL UTDEXC(23,'VISCOCHABOCHE',' ERREUR')
