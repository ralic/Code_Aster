...
C
      ...
      IF(SIGEQ.EQ.ZERO) THEN
         ...
         CALL UTMESS('A','BETJPL','INTEGRATION ELASTOPLASTIQUE DE '
     &     //'LOI MULTI-CRITERE BETON_DOUBLE_DP : LA CONTRAINTE '
     &     //'EQUIVALENTE EST NULLE POUR LA MAILLE: '//NOMAIL
     &     //'CALCUL DE LA MATRICE TANGENTE IMPOSSIBLE.')
         SIGEQ = 1.D0
      ENDIF
C
