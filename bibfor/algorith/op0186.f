   ...
   30         CONTINUE
     ...
     &        ) '|',ITERAT,TESTR,TESTM,ITERHO,RHO,KREAS,'|'
            ...
            ELSE IF ((.NOT.CONVER) .AND. ITEMAX .AND. (.NOT.ARRET)) THEN
              ...
              ITAB(1) = NUMINS
              ITAB(2) = ITERAT
              CALL UTEXCM(22,'THERNONLINE4_85',0,K8B,2,ITAB,0,RTAB)
            END IF
            WRITE (IFM,FMT1)
C
