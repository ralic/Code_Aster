...
C --- LECTURE DE L'ETAT INITIAL ET DES DONNEES D'INCREMENTATION
      CALL NTINIT(RESULT,MODELE,INFCHA,CHARGE,INFOCH,
...
C -- OBSERVATION EVENTUELLE
      ...
      IF (EVOL) THEN
        CALL DYOBAR(MAILLA,INSTAP,LISINS,K24BID,K24BID,
     &              SDOBSE,K19BLA,K24BID,VTEMP ,K24BID,
     &              K24BID,.FALSE.)
      ENDIF
