      SUBROUTINE VEMSME(MODELE,MATE,CARCRI,CARELE,COMPOR,INST,INPSCO,
...
C RESPONSABLE PABHHHH N.TARDIEU
      IMPLICIT NONE
      CHARACTER*24 MATE,MODELE,COMPOR,STYPSE,CARELE,CARCRI
      CHARACTER*13 INPSCO
...
C -------------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ----------------
      ...
      CHARACTER*24 SIGPLU,VARPLU,MATERI,MATSEN,CHCARA(15)
      CHARACTER*24 DEPMOS,SIGPLS,SIGMOS,VARMOS,DUTMP,CACO3D
      CHARACTER*19 LCHIN(NCHINX),LCHOU(NCHOUX),LIGRMO,CHDERI,CHTIME
...
C    ----------------------------
      ...
      IF((TYPESE.NE.2).AND.(TYPESE.NE.3)
     & .AND.(TYPESE.NE.4).AND.(TYPESE.NE.5))THEN
