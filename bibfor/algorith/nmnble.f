      SUBROUTINE NMNBLE(NIVEAU,NUMEDD,SDDYNA,RESOCO,VALMOI,
     &                  VALPLU,SOLALG)
C
...
C
      IMPLICIT NONE
      INTEGER      NIVEAU
      CHARACTER*24 NUMEDD,VALMOI(8),VALPLU(8)
      CHARACTER*24 RESOCO
      CHARACTER*19 SDDYNA
      CHARACTER*19 SOLALG(*)
...
C
      ...
      CHARACTER*8  K8BID   
      CHARACTER*24 K24BID,DEPMOI,DEPPLU
      CHARACTER*24 DEPDEL,DDEPLA 
      CHARACTER*19 NMCHEX      
      INTEGER      JDEPDE,JDDEPL
      CHARACTER*24 VITINI,ACCINI,VITPLU,ACCPLU
C      
C ----------------------------------------------------------------------
C
      CALL JEMARQ()
