...
C
      ...
      INTEGER      IBID,JLVE
      COMPLEX*16   CBID
      CHARACTER*8  K8BID,SIGERE(5),LPAIN(16),LPAOUT(1)
      CHARACTER*19 LIGRMO,VEREFE,CARTE
      CHARACTER*24 CHGEOM,LVEDIP
      CHARACTER*24 LCHOUT(1),LCHIN(16)
...
C -- CONVERGENCE SUR CRITERE EN CONTRAINTE GENERALISEE
     ...
     &                IBID, PARCON, CBID, K8BID)
      ...
      LPAIN(10) = 'PPINTTO'
      LCHIN(10) = MODELE(1:8)//'.TOPOSE.PINTTO'
      LPAIN(11) = 'PHEAVTO'
      LCHIN(11) = MODELE(1:8)//'.TOPOSE.HEAVTO'
      LPAIN(12) = 'PLONCHA'
      LCHIN(12) = MODELE(1:8)//'.TOPOSE.LONCHAM'
      LPAIN(13) = 'PCNSETO'
      LCHIN(13) = MODELE(1:8)//'.TOPOSE.CNSETO'
      LPAIN(14) = 'PBASLOR'
      ...
      CALL CALCUL('S','REFE_FORC_NODA', LIGRMO, 16, LCHIN, LPAIN,
     &            1 , LCHOUT, LPAOUT, 'V')
