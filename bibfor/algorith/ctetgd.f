...
C
      CALL JEVEUO(JEXNUM(INTF//'      .INTD.LINO',NUMD),'L',LLNOD)
      CALL JEVEUO(JEXNUM(INTF//'      .INTD.LINO',NUMG),'L',LLNOG)
C
C
C--------------RECUPERATION NOMBRE DE NOEUDS AUX INTERFACES-------------
C
       CALL JELIRA(JEXNUM(INTF//'      .INTD.LINO',NUMD),'LONMAX',
     &NBNOD,K1BID)
C
       CALL JELIRA(JEXNUM(INTF//'      .INTD.LINO',NUMG),'LONMAX',
     &NBNOG,K1BID)
C
