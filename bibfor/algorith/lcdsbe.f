...
C LOC EDFRC1  COMMON CARACTERISTIQUES DU MATERIAU (AFFECTE DANS EDFRMA)
      ...
      REAL*8      DEUMUD(3), LAMBDD, SIGP(3),RTEMP3,RTEMP4
      REAL*8      EPSM(6), EPSRM(6), DEPS(6), DEPSR(6)
      REAL*8        EPSTHE(2), KDESS, BENDO
      REAL*8      LAMBDA, DEUXMU, GAMMA, SEUIL
      REAL*8      DDOT,R8NNEM
...
C    LECTURE DES CARACTERISTIQUES DU MATERIAU
      ...
      CALL LCEIB1 (FAMI,IMATE, COMPOR, NDIM, EPSRM, R8NNEM(),R8NNEM(),
     &            0.D0,0.D0,0.D0,T,LAMBDA,DEUXMU,EPSTHE,KDESS,
     &            BENDO,GAMMA,SEUIL,.FALSE.)
