      SUBROUTINE  XSIDEP(NNOP,NFH,NFE,DDLC,DDLM,IGEOM,
     &                  TYPMOD,IMATE,COMPOR,
     &                  JPINTT,CNSET,HEAVT,LONCH,
     &                  BASLOC,IDEPL,LSN,LST,SIG,
     &                  JPMILT,NFISS,JFISNO)
...
C.......................................................................
C
C     BUT:  CALCUL DE L'OPTION SIEF_ELGA AVEC X-FEM
C.......................................................................
...
C IN  JPINTT  : POINTEUR DE COORDONNÉES DES POINTS D'INTERSECTION
...
C IN  JPMILT  : POINTEUR DE COORDONNEES DES POINTS MILIEUX
...
C----------------------------------------------------------------
      ...
      CHARACTER*8   ELREFP,ELRESE(6),FAMI(6),TYPMOD(*)
      CHARACTER*24  COORSE
      CHARACTER*16  COMPOR(4)
      REAL*8        HE(NFISS),SIG(*),LSN(NNOP),LST(NNOP),BASLOC(*)
      INTEGER       NSE,NPG,NBSIGM,IMATE,DDLC,DDLM,NDIM,NFH
      INTEGER       J,ISE,IN,INO,JCOORS,CNSET(4*32),HEAVT(*),LONCH(10)
...
C       DEBUT DE LA ZONE MEMOIRE DE SIG CORRESPONDANTE
        ...
        IF (NDIM .EQ. 3) THEN
          ...
          CALL XSIDE3(ELREFP,NDIM,COORSE,ELRESE(NDIM+IRESE),
     &                  IGEOM,HE,NFH,DDLC,DDLM,NFE,BASLOC,NNOP,NPG,
     &                  IMATE,COMPOR,ZR(IDEPL),LSN,LST,NFISS,
     &                  FISNO,SIG(IDEBS+1))
        ELSEIF (NDIM.EQ.2) THEN

          CALL ASSERT(NBSIG.EQ.4)

          CALL XSIDE2(ELREFP,NDIM,COORSE,ELRESE(NDIM+IRESE),
     &                  IGEOM,HE,NFH,DDLC,DDLM,NFE,BASLOC,NNOP,NPG,
     &                  TYPMOD,IMATE,COMPOR,IDEPL,LSN,LST,NFISS,FISNO,
     &                  SIG(IDEBS+1))
