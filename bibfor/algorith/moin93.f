...
C     ------------------------------------------------------------------
      ...
      INTEGER      IBID,IERD,NEQ, LIMPED, LMATM, LDUTI, IFM, NIV,IEQ,
     &             VALI,I1,J1,K1,L1,M1,N1,NBGRNO,NBNO,NRA,NMA,
     &             NBCMP,INDCMP(6),LNUME,LAG1,LAG2,IND,NBMOIN,LINDNO,
     &             II,JGG,JVG,IRET,LINDDL,LDDLD,NBNOEU,
     &             LCOORD,LPRNO,NNOINT,IPOS1,IPOS2,NUMNO,NBMODE,LVALE,
     &             NIVE, VERSIO,NBMA,NBGRMA,IDLIMA,NBGMA,LNBMA,LMODD,
     &             NBCMPM,NBEC,NDDLIN,LNOINT,IMODE,
     &             IE,LNOM,LTYPE,NBTROU,LRES,NBPAR,JPARA,IUL,IUNIFI,
     &             CONNEC,LCONNC,SIZECO,NMRIG,INPN,LMAT,
     &             NDECI,ISINGU,NPVNEG,NBVECT,LINTRF,
     &             LVEC,LMATMA,LDDL,LPROD,NBLAGR,
     &             NBCINE,NEQACT,NFREQ,NPIVOT,LMATR,LINLAG,LIPOS,LFREQ
     
      PARAMETER    (NBCMPM=10)
      INTEGER      DECO(NBCMPM)
      REAL*8       R8B, ZERO, UN, COEF(3),COMLIN(2),RBID,
     &             R8GAEM,SHIFT,OMEMAX,OMEMIN
      COMPLEX*16   C16B
      
      CHARACTER*1  LISTYP(2)
      CHARACTER*8  K8B,K8BID,RESU,NOMMA,MONAXE,FORMAR,NOMNOE,
     &             NOMCMP,KNUM,NOMDIR,NOSIMP,NOPASE,NOMG,NOGMA,MODELE
      CHARACTER*14 NUME,NUME91
      CHARACTER*16 NOMCMD, CONCEP, ACCES(3)
      CHARACTER*19 CHAMNO,RAIDE,IMPED,MASSE,AMOR,NUMEDD,MATPRE,
     &             LISMAT(2),SOLVEU,RESU19,PRNO,
     &             SSAMI,RAIINT,RAIDFA
      CHARACTER*24 VALE,VALK,LISMA,GRPMAI,GRPMAV,COINT,NODDLI,
     &             MATMOD,VEFREQ
      LOGICAL      DEPLIM,FORCIM,ACCUNI,ACCDDL,DIRECT,LMOD,LBID
