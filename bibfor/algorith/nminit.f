...
C
      ...
      CHARACTER*24 SDIMPR,SDSENS,SDTIME,SDERRO,SDIETO,SDSTAT
...
C
      ...
      CHARACTER*19 COMMOI
      CHARACTER*2  CODRET
      LOGICAL      LVIT0E,LACC0,LPILO,LMPAS,LSSTF,LERRT,LRELI,LVISS
...
C
      CALL NMINMC(LVIT0E,FONACT,LISCHA,SDDYNA,MODELE,
     &            COMPOR,SOLVEU,NUMEDD,NUMFIX,DEFICO,
     &            RESOCO,CARCRI,SOLALG,VALINC,MATE  ,
     &            CARELE,SDDISC,SDSTAT,SDTIME,COMREF,
     &            MEELEM,MEASSE,VEELEM,CODERE)
C
C --- INSTANT INITIAL
C
      NUMINS = 0
...
C
     ...
     &            NUMEDD,FONACT,PARCON,VEELEM,SDSENS,
     &            VEASSE,MEASSE)
C
...
C
      CALL NMINMA(LVIT0E,FONACT,LISCHA,SDDYNA,SOLVEU,NUMEDD,
     &            NUMFIX,MEELEM,MEASSE)
C
C --- CALCUL DE LA FORCE AMORTISSEMENT INITIALE 
C     
      IF (LVIT0E) THEN
        CALL NMAMOR(FONACT,SDDYNA,VALINC,MEASSE)
      ENDIF
C
