     ...
     &                  METHOD,LISCH2,MAILLA,SDPILO,SDDYNA,
     &                  SDIMPR,SDSUIV,SDSENS,SDOBSE,SDTIME,
     &                  SDERRO,DEFICU,RESOCU,RESOCO,VALINC,
...
C
      ...
      CHARACTER*14 SDOBSE
      CHARACTER*19 SOLVEU,SDNURO,SDDISC,SDCRIT,SDPILO
...
C
      ...
      CHARACTER*19 COMMOI
      CHARACTER*2  CODRET
      LOGICAL      REAROT,LACC0,LPILO,LMPAS,LSSTF,LERRT,LRELI
...
C
     ...
     &            PARCRI,INSTIN,SDDISC,DERNIE,SDOBSE,
     &            SDSUIV)
C
