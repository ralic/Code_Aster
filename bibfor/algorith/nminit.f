     ...
     &                 PARCRI,NBPASE,INPSCO,LISCH2,NBOBSE,NUINS0,
...
C
     ...
     &              MEMASS,OPMASS,MEDIRI,LISCHA,INSTAM,COMMOI,DEPMOI,
     &              VITPLU,ACCPLU,SIGMOI,VARMOI,MAPREC,SOLVEU,CARCRI,
     &              VARDEM,LAGDEM,PARTPS,NBPASE,INPSCO,DEFICO)
      END IF
C
