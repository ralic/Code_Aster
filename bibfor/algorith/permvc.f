...
C PAR MUALEM-POUR L EAU ET CUBIQUE POUR LE GAZ
...
C
        CALL KFOMVC(PR,SR,M,N,USM,USN,S,S1,KRL,KRG,DKLDS,DKGDS)
C
...
C
        CALL KFOMVC(PR,SR,M,N,USM,USN,X0,S1MAX,Y0W,KRG,Y0WP,DKGDS)
        Y1=1.D0
...
C  REGUL KL(S) GAUCHE
C
        CALL KFOMVC(PR,SR,M,N,USM,USN,X0,S1MIN,Y0W,KRG,Y0WP,DKGDS)
