        SUBROUTINE LCMMKR(TAUS,COEFT,CISA2,IFA,NMAT,NBCOMM,IS,NBSYS,HSR,
     &      VIND,DY,DT,DALPHA,DGAMMA,DP,CRIT,SGNS,IRET)
        ...
        REAL*8 RP,SGNS,HSR(5,24,24),DY(*)
        REAL*8 VIND(*),ALPHA,DALPHA 
        CHARACTER*16 NECOUL
...
C     ----------------------------------------------------------------
      ...
      REAL*8 AUX,CISA2,RACR,ALPHAS,TERME,PETITH,PETITG
