      SUBROUTINE NIPL3B(NNO1, NNO2, NPG1, IPOIDS, IVF1, IVF2,
...
C TOLE CRP_21
      ...
      REAL*8 DDEPL(3,NNO1), GONFLM(1,NNO2), DGONFL(1,NNO2)
      REAL*8 DFDI(NNO1,3), SIGM(7,NPG1), SIGP(7,NPG1), ANGMAS(3)
      REAL*8 VIM(LGPG,NPG1), VIP(LGPG,NPG1)
      REAL*8 KUU(3,20,3,20),KUA(3,20,1,8), KAA(1,8,1,8)
      REAL*8 FINTU(3,20), FINTA(1,8)
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8 PM, DP, DIVUM, DDIVU, SIGTR, RBID, DDOT, TREPST
      REAL*8 DEF(6,27,3), DEFD(6,27,3), DEFTR(27,3), ALPHA
      REAL*8 KBB(3,3), KBP(3,4), KCE(4,4), RCE(1,4), DSBDEP(6,6)
...
C - CALCUL DE DFDI, F, EPS ET POIDS
     ...
     &              IVF1,IDFDE1,DEPLM,.TRUE.,POIDS,DFDI,F,EPSM,R)

C - CALCUL DE DEPS
        CALL NMGEOM(3,NNO1,.FALSE.,GRAND,GEOM,KPG,IPOIDS,
     &              IVF1,IDFDE1,DDEPL,.FALSE.,POIDS,DFDI,F,DEPS,R)
...
C - CALCUL DE LA MATRICE DE CONDENSATION STATIQUE
        ...
        CALL CALKBB(NNO1, 3, .FALSE., R, KPG, GEOM, IVF1, F, IPOIDS,
     &              IDFDE1, DSBDEP, KBB)
        CALL CALKBP(NNO2, 3, .FALSE., R, KPG, GEOM, IVF2, IPOIDS,
     &              IDFDE1, KBP)
        CALL CALKCE(NNO1, 3, KBP, KBB, GONFLM, DGONFL, KCE, RCE)
...
C - CALCUL DE FINT_P ET FINT_G
          DO 150 N = 1, NNO2
            TMP = (DIVUM+DDIVU-(PM+DP)*ALPHA-TREPST)*
