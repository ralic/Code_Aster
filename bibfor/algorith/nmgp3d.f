       SUBROUTINE NMGP3D(NNO, NPG, IPOIDS, IVF, IDFDE, GEOMI,TYPMOD,
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      REAL*8  TEMPM, TEMPP, SECHGM, SECHGP
      REAL*8  DEFAM, DEFAP
      REAL*8  ELGEOM(10,27)
      REAL*8  R8VIDE
...
C - CALCUL DES ELEMENTS GEOMETRIQUES SPECIFIQUES LOIS DE COMPORTEMENT
      ...
      CALL LCEGEO(NNO,NPG,IPOIDS,IVF,IDFDE,GEOMI,TYPMOD,
...
C     CALCUL DE F EN T-  =>  FM
        CALL NMGEOM(3,NNO,AXI,GRAND,GEOMI,KPG,IPOIDS,
     &              IVF,IDFDE,DEPLM,POIDS,DFDIM,
     &              FM,EPS,R)

C     CALCUL DE F POUR DT  =>  DF  ET DFDIM
        CALL NMGEOM(3,NNO,AXI,GRAND,GEOMM,KPG,IPOIDS,
     &              IVF,IDFDE,DDEPL,POIDS,DFDIM,
     &              DF,EPS,R)

C     CALCUL DE DFDIP ET POIDS EN T+
        CALL NMGEOM(3,NNO,AXI,GRAND,GEOMP,KPG,IPOIDS,
