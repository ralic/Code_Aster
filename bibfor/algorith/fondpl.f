...
C ======================================================================
      ...
      CHARACTER*24 CHINST
      CHARACTER*24 VEONDE,VAONDE,LCHIN(4),LCHOUT(1)
...
C     ----- FIN COMMUNS NORMALISES  JEVEUX  ----------------------------
   ...
   10 CONTINUE
     ...
     &            'INST',IBID,TEMPS,CBID,K8BID)
      ...
      DO 30 I = 1,NCHOND
        CALL EXISD('CHAMP_GD',CHONDP(I)//'.CHME.ONDPL',IRET)
        IF (IRET.NE.0) THEN
     ...
     &                LPAOUT,'V')
          ...
          CALL JEDETR(VEONDE(1:8)//'.LISTE_RESU')
          CALL WKVECT(VEONDE(1:8)//'.LISTE_RESU','V V K24',1,IVEOND)
          ZK24(IVEOND) = LCHOUT(1)
