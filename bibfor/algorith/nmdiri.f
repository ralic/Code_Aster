...
C OUT CNDIRI : VECT_ASSE DES REACTIONS D'APPUI BT.LAMBDA
C
...
C
      CALL JEMARQ()
C
C --- CALCUL DES REACTIONS D'APPUI BT.LAMBDA <CNDIRI>
C
      CALL VEBTLA(MODELE,MATE  ,CARELE,VECLAG,LISCHA,
     &            VEDIRI)
C
C --- ASSEMBLAGE DES REACTIONS D'APPUI BT.LAMBDA <CNDIRI>
C       
