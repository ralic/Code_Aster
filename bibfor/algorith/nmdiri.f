      SUBROUTINE NMDIRI(MODELE,NUMEDD,MATE  ,CARELE,LISCHA,
     &                  SDDYNA,VALVAL,VEDIRI)
C
...
C IN  VALVAL : VECTEUR CHAPEAU DEPL/VITE/ACCE
...
C
      ...
      INTEGER      NDYNIN
      CHARACTER*24 VECLAG,DEPL,VITE,ACCE,K24BID
...
C
      CALL DESAGG(VALVAL,DEPL  ,K24BID,K24BID,K24BID,
     &            VITE  ,ACCE  ,K24BID,K24BID)           
C
