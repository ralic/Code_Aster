...
C     ROUTINE ANCIENNEMENT NOMMEE FLU_ORTO
...
C ======================================================================
        ...
        IMPLICIT REAL*8(A-Z) 
      REAL*8 SIGE6(6),SIGE3(3),SIGET3(3),SIGED6(6)
      REAL*8 EVP06(6),EVP16(6),EVPD06(6)
      REAL*8 SIGE33(3,3),VSE33(3,3),VSE33T(3,3)
      REAL*8 X33(3,3),Z33(3,3),Y33(3,3),SUT33(3,3)
      REAL*8 SUT3(3),VDT33(3,3),VDT33T(3,3),DT3(3),SUT6(6)
      REAL*8 SMECA,DMECA,DRAG3(3),ST,DRG3MX,TRAV(3,3)
      REAL*8 SIGEC3(3),PSIT3(3),EVPL3F(3),DEVPT6(6),DEVPT3(3)
      REAL*8 EVPMAX,SGEDT6(6),AA,BGPGMX,ERAGMX
      INTEGER I,J
      REAL*8 XMT
