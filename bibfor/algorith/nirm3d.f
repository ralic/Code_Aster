      SUBROUTINE NIRM3D (NNO1, NNO2, NPG1, IPOIDS, IVF1, IVF2,
     &                   IDFDE1, IGEOM, IMATE, KUU, KUA, KAA)
...
C......................................................................
C     BUT:  CALCUL  DES OPTIONS RIGI_MECA POUR LA FORMULATION UPG EN 3D
C......................................................................
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER IDECPG, IDECNO, NDIM

      REAL*8 DSIDEP(6,6), DEF(6,NNO1,3), DEFD(6,27,3), DEFTR(27,3)
      REAL*8 TMP, TMP2, B(6,81), POIDS, XYZGAU(3)
...
C - COORDONNEES AU POINT D'INTEGRATION COURANT
        ...
        DO 31 I = 1,NNO1
          IDECNO = 3* (I-1) - 1
          XYZGAU(1) = XYZGAU(1) + ZR(IVF1+I+IDECPG)*ZR(IGEOM+1+IDECNO)
          XYZGAU(2) = XYZGAU(2) + ZR(IVF1+I+IDECPG)*ZR(IGEOM+2+IDECNO)
          XYZGAU(3) = XYZGAU(3) + ZR(IVF1+I+IDECPG)*ZR(IGEOM+3+IDECNO)
 31     CONTINUE
...
C - ETRE ISOTROPE, ISOTROPE-TRANSVERSE OU ORTHOTROPE)
        CALL DMAT3D('RIGI',ZI(IMATE),0.D0,'+',KPG,1,
     &                  REPERE,XYZGAU,DSIDEP)
