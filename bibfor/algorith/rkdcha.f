...
C     ----------------------------------------------------------------
      ...
      REAL*8 COEFT(NMAT),VINI(*),DVIN(*)
      REAL*8 SMX(6),PETIN(6),PETIN2(6),SIGI(6)
      REAL*8 EVI(6),A1V(6),A2V(6),CSI(6),DEVI(6),DA1V(6),DA2V(6),DCSI(6)
      REAL*8 K0,K,N,MR,MU,M1,M2,GAMMA1,G20,G10,EVCUM,ETA,DRAYVI,DQCUM
      REAL*8 DEVCUM,DETAT,GRJX2,GRJX1,GRJEPS,GRJ2V,GRANQR,GRANQ,GR,ALP
      REAL*8 D2,GAMMA2,TRSIG,TREST,RAYVI,QR0,QM,QCUM,Q0,GX1,GX2
      REAL*8 XX,XNA1V,XNA2V,ZE,XXN,AI,AK,TEMPO
      REAL*8 B,C1,C2,CRITME,CRITV,D1
      DATA ZE/0.0D0/
C
