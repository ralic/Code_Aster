      SUBROUTINE HMLADG(OPTION,MECA,THER,HYDR,IMATE,NDIM,DIMDEF,DIMCON,
     ...
     +                  DP1,DP2,T,DT,PHI,PADP,H11,H12,KH,
...
C ======================================================================
C **********************************************************************
C ROUTINE HMLADG : CETTE ROUTINE CALCULE LES CONTRAINTES GENERALISE
...
C   DANS LE CAS OU THMC = 'LIQU_AD_GAZ'
C **********************************************************************
...
C ======================================================================
      ...
      REAL*8        P1,DP1,P2,DP2,T,DT,PHI,PADP,H11,H12
      REAL*8        RHO11,PHI0,KH,RINSTP
      CHARACTER*16  OPTION,MECA,THER,HYDR,THMC
C ======================================================================
C --- VARIABLES LOCALES ------------------------------------------------
C ======================================================================
      INTEGER      I
      REAL*8       SATM,EPSVM,PHIM,RHO11M,RHO21M,RHO22M
      REAL*8       BIOT,K0,CS,ALPHA0,ALPLIQ,CLIQ,RHO110
      REAL*8       CP11,CP12,CP21,SAT,DSATP1,MAMOLG
      REAL*8       R,RHO0,COEPS,CSIGM,ALP11,ALP12,ALP21
      REAL*8       DP11T, DP11P1, DP11P2
...
C ======================================================================
      ...
      REAL*8       RBID39, RBID45, RBID46, RBID49, RBID50,
     >             RBID51,R3BID(6)
      REAL*8       SIGNE,  DPAD, PAS
      REAL*8       M11M,M21M,M22M,DMASP1,DMASP2
      REAL*8       DMADP1,DMADP2,DMWDP1,DMWDP2,DQDEPS,DQDP,DQDT,DMASDT
      REAL*8       DMADT,DMWDT,DMDEPV,DSPDP1,DSPDP2,APPMAS,SIGMAP
      REAL*8       MASVOL,DILEAU,DILGAZ,ENTEAU,ENTGAZ,CALOR,DHW2P1
      REAL*8       DHW2P2,DHW2DT,DHDT,MAJPAS
      REAL*8       ZERO
      PARAMETER(ZERO=0.D0)
C
      LOGICAL NET,BISHOP
...
C --- INITIALISATIONS --------------------------------------------------
C ======================================================================
C    LA VARIABLE INTERNE DE PRESSION DE VAPEUR EST 0
...
C =====================================================================
         CALL MAJPAD(P2,ZERO,R,T,KH,DP2,ZERO,DT,PADP,PADM,DPAD)
C =====================================================================
...
C ======================================================================
     ...
     +    (OPTION(1:9).EQ.'FULL_MECA')) THEN
         CALL DPLADG(YATE,RHO11,RHO12,R,T,KH,CONGEM,DIMCON,ADCP11,
...
C ======================================================================
     ...
     +           DMASP1(RHO11,RHO12,RHO21,SAT,DSATP1,BIOT,PHI,CS,P2,
     +                   EMMAG,EM)
