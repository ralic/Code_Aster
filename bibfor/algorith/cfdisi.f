...
C   'APPARIEMENT'     TYPE APPRIEMENT: NODAL, MAITRE_ESCL,
C                      VECT_NORM_ESCL
C   'TANG_DEF'        TANGENTE DEFINIE PAR L'UTILISATEUR
C                     (VECT_Y/VECT_ORIE_POU)
C   'MAIT_ESCL_SYME'  APPARIEMENT SYMETRIQUE
C   'PROJECTION'      TYPE DE PROJECTION (LINEAIRE/QUADRATIQUE)
C   'RECHERCHE'       TYPE DE RECHERCHE (NOEUD_BOUCLE/NOEUD_VOISIN) 
...
C
      ...
      CHARACTER*24 CONVCO,METHCO,NDIMCO
      INTEGER      JCONV,JMETH,JDIM
...
C
      ...
      ELSEIF (QUESTI(1:8) .EQ.'TANG_DEF')       THEN
        CALL JEVEUO(METHCO,'L',JMETH)      
