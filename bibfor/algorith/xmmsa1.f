      SUBROUTINE XMMSA1(ALGOFR,NDIM,NNO,NNOS,NNOL,PLA,
     &                  FFC,FFP,IDEPD,IDEPM,
     &                  NFH,ND,TAU1,TAU2,SINGU,RR ,
     &                  LACT,DDLS,DDLM,
     &                  COEFFR,COEFFP,
     &                  P,ADHER,KNP,PTKNP,IK)
      ...
      REAL*8      RR,COEFFR,COEFFP,P(3,3),IK(3,3)
...
C IN  COEFFR  :
C IN  COEFFR : COEFFICIENTS DE STABILISATION DU FROTTEMENT
C IN  COEFFP : COEFFICIENTS DE PENALISATION DU FROTTEMENT
...
C
      CALL XADHER(P,SAUT,LAMB1,COEFFR,COEFFP,ALGOFR,
