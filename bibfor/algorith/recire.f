...
C
         CALL GETVTX ( 'REPONSE', 'OPTION'    , 1,IARG,1, TYPOPT, IBID )
         CALL GETVIS ( 'REPONSE', 'DERIVATION', 1,IARG,1, IDERRE, IBID )
C
C----INCLUSION DES FREQUENCES DEXCITATION DANS LA DISCRETISATION REPONSE
C
         CALL GETVTX ( 'REPONSE', 'FREQ_EXCIT', 1,IARG,1, FREXCI, IBID )
C-
...
C
         CALL GETVR8 ( 'REPONSE', 'PAS', 1,IARG,1, PAS, IBID )
C
