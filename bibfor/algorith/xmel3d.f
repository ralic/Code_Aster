      SUBROUTINE  XMEL3D(POUM,NNOP,IPOIDS,IVF,DDLH,NFE,DDLC,IGEOM,
...
C           TE4-'XINT' : SCHÉMAS À 15 POINTS
            CALL ELREF5('TE4','XINT',IBID,IBID,IBID,NPG,IBID,
     &                  IBID,IBID,IBID,IBID,IBID)
            NCMPS=6
            IDEBS=(NSEMAX*NPG*(IT-1)+NPG*(ISE-1))*NCMPS+1
            IDEBV=(NSEMAX*NPG*(IT-1)+NPG*(ISE-1))*LGPG+1

            CALL XKEL3D(POUM,ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,NFE,
...
C           TRI3-'RIGI' : SCHEMA A 3 POINTS
            CALL ELREF5('TR3','RIGI',IBID,IBID,IBID,NPG,IBID,
     &                  IBID,IBID,IBID,IBID,IBID)
            NCMPS=4  
            IDEBS=(NSEMAX*NPG*(IT-1)+NPG*(ISE-1))*NCMPS+1
            IDEBV=(NSEMAX*NPG*(IT-1)+NPG*(ISE-1))*LGPG+1
 
            CALL XKEL2D(POUM,ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,NFE,
     &                  BASLOC,NNOP,NPG,TYPMOD,OPTION,IMATE,COMPOR,LGPG,
     &                  CRIT,DEPL,LSN,LST,SIG(IDEBS),
     &                  VI(IDEBV),MATUU,VECTU,CODRET)
