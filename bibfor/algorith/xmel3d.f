     ...
     &                   CNSET,HEAVT,LONCH,BASLOC,HYDR,SECH,TREF,DEPL,
...
C
       ...
       REAL*8       TREF,HYDR(NNOP),SECH(NNOP),DEPL(*)
       REAL*8       MATUU(*),VECTU(*),SIG(*),BASLOC(*)
       PARAMETER   (NDIM=3)
C
...
C         DEBUT DE LA ZONE MÉMOIRE DE SIG CORRESPONDATE
     ...
     &                  CRIT,T,HYDR,SECH,TREF,DEPL,SIG(IDEB),VI,MATUU,
     &                  VECTU,CODRET)
