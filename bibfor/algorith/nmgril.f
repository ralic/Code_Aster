      SUBROUTINE NMGRIL (KPGVRC,IMATE, TYPMOD, COMPOR, OPTION,
     &                   EPSM, DEPS,
     &                    ANGMAS,
     &                   SIGM, VIM,
     &                   TM, TP, TREF,
...
C
C
C IN  KPGVRC  : NUMERO DE PG POUR LES VARIABLES DE COMMANDE
...
C
      ...
      CALL NMCO1D(KPGVRC,IMATE,COMPOR,OPTION,
     &            EPSML(1),DEPSL(1),
     &            ANGMAS,
     &            SIGML(1),VIM(1),
     &            TM,TP,TREF,
