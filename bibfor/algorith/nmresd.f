      SUBROUTINE NMRESD(FONACT,SDDYNA,SDTIME,SOLVEU,NUMEDD,
...
C
      ...
      CHARACTER*24  NUMEDD,SDTIME,DEFICO
      REAL*8        INSTAN
C 
C ----------------------------------------------------------------------
C
...
C
      LOGICAL      NDYNLO,LPRMO,LXFCM,ISFONC
...
C         
     ...
     &              MAPREC,MATASS,DEPSO1,DEPSO2)
      ENDIF 
C
C --- MISE A ECHELLE SI CONTACT X-FEM
C
      IF(LXFCM) CALL NMMEAR(SOLALG,MODELE,DEFICO,FONACT)
C
