      SUBROUTINE CFDIST(DEFICO,IZONE ,TYPPCT,POSNOE,POSMAE,
     &                  COORD ,DIST  )
C
...
C IN  TYPPCT : TYPE D'INTEGRATION
C               'NOEU': INTEGRATION AUX NOEUDS ESCLAVES
C               'POIN': INTEGRATION SUR UN POINT DE CONTACT
...
C
      IF (TYPPCT.EQ.'NOEU') THEN
        CALL ASSERT(POSMAE.EQ.0)
        CALL CFDISM(DEFICO,LDPOU ,LDCOQ ,POSNOE,DISTST)
      ELSEIF (TYPPCT.EQ.'POIN') THEN
