     ...
     &                   DDLM,NFE,BASLOC,NNOP,NPG,IMATE,COMPOR,IDEPL,
     &                   LSN,LST,NFISS,FISNO,SIG)

      IMPLICIT NONE
      INCLUDE 'jeveux.h'
      INTEGER       NDIM,IGEOM,IMATE,NNOP,NPG,NFH,DDLC,DDLS,NFE
      INTEGER       NFISS,FISNO(NNOP,NFISS),IDEPL
