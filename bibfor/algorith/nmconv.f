...
C MODIF ALGORITH  DATE 23/05/2006   AUTEUR VABHHTS J.PELLET 
C ======================================================================
...
C ======================================================================
      ...
      INTEGER      ITERAT, LICCVG(*), NUMINS, NEQ, VECONT(2),JCRI,IRET
      REAL*8       ETA, CONV(*), PARCRI(*), PARMET(*)
      CHARACTER*19 CRITNL, CNRESI, CNDIRI, CNFEXT, CNVCFO, CNVFRE
      CHARACTER*19 FOINER, PARTPS, AUTOC1, AUTOC2, CNVCF1, MATASS
      CHARACTER*24 DEPDEL
      CHARACTER*8  MAILLA
      CHARACTER*24 NUMEDD
      CHARACTER*24 RESOCO
