...
C 
      ...
      INTEGER      ITERAT, LICCVG(*), NUMINS, NEQ
      REAL*8       ETA, CONV(*), PARCRI(*), PARMET(*)
      CHARACTER*19 CRITNL,CNRESI,CNDIRI,CNFEXT,CNVCFO,CNVFRE
      CHARACTER*19 FOINER,PARTPS,CNVCF1,MATASS
      CHARACTER*24 DEPDEL,COMREF,COMMOI,MATE
      CHARACTER*8  MAILLA
      CHARACTER*24 NUMEDD
...
C IN  CRITNL : SYNTHESE DES RESULTATS DE CONVERGENCE POUR
C                   ARCHIVAGE
C IN  COMMOI : VARI_COM EN T- POUR AFFICHAGE MESSAGE ERREUR
C IN  COMREF : VARI_COM REFE  POUR AFFICHAGE MESSAGE ERREUR
C
...
C
      CALL NMRESI(CNRESI,CNDIRI,CNFEXT,CNVCFO,CNVFRE,
     &            FOINER,CNVCF1,NEQ   ,CREFE ,CINIT ,
     &            MATASS,VRELA ,VMAXI ,VCHAR ,VRESI ,
