      SUBROUTINE REACCO (PREMIE,METH,CHAM,REAC)
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGORITH  DATE 12/10/2000   AUTEUR ADBHHPM P.MASSIN 
C ======================================================================
...
C IN  CHAM   : CHAMP SUR LEQUEL PORTE LA LIAISON UNILATERALE
C               +1 : DEPLACEMENT AVEC APPARIEMENT (CONTACT DEFORMABLE)
C               -1 : DEPLACEMENT SANS APPARIEMENT (CONTACT RIGIDE)
C               -2 : PRESSION SANS APPARIEMENT
C               -3 : TEMPERATURE SANS APPARIEMENT
