...
C
      ...
      INTEGER ADRECG,I,NBMA,IER,JPJK1
      LOGICAL ISOLE
      LOGICAL LNOEU,LELNO,LELEM,LELGA
      CHARACTER*4 TYCHV,TYPCAL
      CHARACTER*8 K8B,NOMA1,NOMA2,NOMA3,RESUIN,PROL0,MA1P,PROJON
...
C       / '2'    : ON UTILISE LA SD_CORRESP_2_MAILLA DEJA CALCULEE
      CALL GETVTX(' ','PROJECTION',1,1,1,PROJON,N1)
      CALL GETVID(' ','MATR_PROJECTION',1,1,1,CORRU,N2)
      IF (N2.EQ.0) CORRU=' '
