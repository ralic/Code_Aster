       SUBROUTINE  NMGC2D(NNO,NPG,IPOIDS,IVF,IDFDE,GEOMI,TYPMOD,
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      LOGICAL GRAND,AXI,RESI,RIGI,TPLUS
      ...
      REAL*8 SECHGM,SECHGP,ELGEOM(10,9),FP(3,3)
