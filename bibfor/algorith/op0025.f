...
C
      INTEGER VALI
      INTEGER NRPTPA, NRORES
      INTEGER IFM,NIV,JARCH
      INTEGER IBID,JLCHA,JFCHA,JINFC
      INTEGER NOPT,NCHAR,JINF,I,IALIFC,IALICH
      INTEGER NBGRPA,NBPTPA,NUMFIN,NBOBAR
      INTEGER NEQ,NUMORD,COMPT,NBOBSE,DERNIE,NUOBSE
      INTEGER NBPASE, NRPASE, NUINS0
      INTEGER PARMEI(1), PARCRI(1)
C
      REAL*8 PARMER(1), PARCRR(1), PARA(2), VALR(2)
      REAL*8 TPSTHE(6),TPS1(4),DELTAT,DELTAM,TPSNP1
      REAL*8 THETA,INSTAP,DIINST
C
      LOGICAL MATCST,COECST,LNUAR,LOSTAT,EVOL,ASME,ASMS,FINPAS
      LOGICAL REASVC,REASVT,REASMT,REASRG,REASMS,LOBSER,DIDERN
C
      CHARACTER*1 CREAS
      CHARACTER*4 TYPCAL
      CHARACTER*8 EVOLSC,MAILL2
      CHARACTER*8 SAUX08
      CHARACTER*13 INPSCO
      CHARACTER*19 MAPREC,SOLVEU,INFCHA,LISCHA,K19B,PARTPS
      CHARACTER*19 NOMTAB,LISOBS
      CHARACTER*24 RESULT,MODELE,CHARGE,CARELE,SDSUIV
      CHARACTER*24 FOMULT,NUMEDD,LISINS
      ...
      CHARACTER*24 LISOPT,LISARC,EXCARC
C
C ----------------------------------------------------------------------
      DATA RESULT          /' '/
...
C --- LA LISTE D INSTANT DE LA SD PARTPS 
...
C
            CALL NTRESO ( NRPASE, NBPASE, INPSCO, PARTPS,
