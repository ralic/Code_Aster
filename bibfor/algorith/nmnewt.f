...
C
      ...
      CHARACTER*24 CARCRI
      CHARACTER*24 SDTIME,SDERRO,SDIMPR,SDIETO,SDSTAT,SDCONV
...
C
     ...
     &            FONACT,SDIMPR,SDDISC,SDDYNA,SDNUME,
...
C
 315  CONTINUE
      CALL NMCONV(NOMA  ,MATE  ,NUMEDD,SDNUME,FONACT,
...
C
 330  CONTINUE
C
C --- AFFICHAGES PENDANT LA BOUCLE DE NEWTON
C
