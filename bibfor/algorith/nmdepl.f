     ...
     &                  DEPPLT,DEFICO,CNCINE,SOLVEU,LREAC,
...
C
      ...
      CHARACTER*19 USUPLU,USUMOI,USUINI,USUFIX
...
C
     ...
     &                    MCONEL,SCONEL)
            ELSE
              CALL MAJUSU(PREMIE,MAILLA,DEFICO,LIGRCF,
     &                    USUMOI,USUPLU,USUFIX,USUINI,
     &                    DEPMOI,DEPDEL)
                          
              CALL MMCMEM(MODELE,
     1                    DEPMOI,VITMOI,ACCMOI,DEPDEL,
