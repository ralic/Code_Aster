     ...
     &                 LICCVG,DDEPLA,VITMOI,ACCMOI,IALGO)
...
C
      LOGICAL CFINT
      INTEGER NEQ,JDEPM,JDEPDE,JDEPP,JDDEPL,IBID,NEQ2,JDEPP2,JDEPP3
      CHARACTER*8 K8BID
      CHARACTER*19 K19BLA
...
C
      INTEGER IRET,IRE2,JTRA,JRESI,JRSST,NBSS,IALGO
      CHARACTER*24 TABTRA
...
C    A-T-ON BESOIN DE REACTUALISER LES RIGI_ELEM OU PAS 
     ...
     &           LAMORT,MEMASS,MASSE,AMORT,COEDEP,COEVIT,COEACC,IBID)
C
