...
C TOLE CRP_21
      ...
      INTEGER       ITERAT, LICCVG(2), INDRO, NBEFFE, NUMINS,IECPCO
...
C -------------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ----------------
      ...
      LOGICAL      CFINT
      INTEGER      NEQ,JDEPM,JDEPDE, JDEPP, JDDEPL,IBID,I
      REAL*8       PROETA(2) 
      CHARACTER*8  K8BID
      CHARACTER*19 K19BLA
...
C     PROJECTION DE DELTA.U + DU0 = DU SUR CONTACT ADMISSIBLE
      ...
      IF (FONACT(4)) THEN
         CALL NMCOFR (INSTAP, MAILLA, DEPPLT, DEPDEL, DEPPIL,
...
C    EN PARTICULIER SUITE A LA PREDICTION
     ...
     &               MODEDE, NUMEDE, SOLVDE, PARCRI, POUGD ,
     &               ITERAT, VALMOI, RESOCO, VALPLU, CNRESI,
     &               CNDIRI, REAROT, NURO  , FONACT, CMD,
     &               OPTION, CONV  , STADYN, DEPENT, VITENT,
     &               COEVIT, COEACC, DEPKM1, VITKM1, ACCKM1,
     &               VITPLU, ACCPLU, ROMKM1, ROMK,   INDRO ,   
...
C        write (6,*) 'NMDEPL : DEPPLU ET DEPDEL'
C        DO 666 I=0,NEQ-1
C          write (6,*) ZR(JDEPP+I),ZR(JDEPDE+I)
C666     CONTINUE
