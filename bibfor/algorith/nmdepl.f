...
C TOLE CRP_21
      ...
      INTEGER       ITERAT, LICCVG(2), INDRO, NUMINS,IECPCO,ICONTX
...
C -- MISE A JOUR DES DEPLACEMENTS
     ...
     &             ROMK)
      ...
      IF (CFINT) THEN
        ...
        IF (IECPCO.GT.0.AND.ICONTX.EQ.0) THEN
          CALL MMCMEM(MODELE,DEPMOI,DEPDEL,LIGRCF,CARTCF,MCONEL,SCONEL)
        ELSE IF(ICONTX.GT.0) THEN
          CALL XMMCME(MODELE(1:8),DEPMOI,DEPDEL,DEFICO,MCONEL,SCONEL)
        ENDIF
