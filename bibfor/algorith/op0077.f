...
C     ---------------------------
      CALL GETVID(' ','SQUELETTE',1,IARG,1,K8B,IR)
C     --- SI RESTITUTION SUR UNE SQUELETTE, ALORS ATTACHER UN PROF_CHNO
C         AU RESULTAT
      IF (IR.EQ.0) THEN
      ...
      ENDIF
C --- CREATION D'UN OBJET REFN DU PROFIL SUR BASE VOLATILE
