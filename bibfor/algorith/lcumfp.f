     ...
     &                    TINSTM,TINSTP,TM,TP,TREF,SECHM,SECHP,SREF,
     &                    EPSM,DEPS,SIGM,VIM,OPTION,SIGP,VIP,DSIDEP)
...
C MODIFI MARS 2006 "NOUVELLE" VARIABLE DE COMMANDE HYDR
      REAL*8   HYDRM,HYDRP
...
C
     ...
     &        DEPS,VIM(22),TM,TP,TREF,SECHM,SECHP,SREF,
...
C    FULL_MECA | RIGI_MECA_
        IF (OPTION(1)(1:9).EQ.'RIGI_MECA') THEN
          IF (OPTION(2).EQ.'ENDO_ISOT_BETON') THEN
            COMPOZ(1)='ENDO_ISOT_BETON'
            CALL LCLDSB(FAMI,KPG,KSP,NDIM,TYPMOD,IMATE,COMPOZ,EPSM,
     &                 RBID,VIM(22),TM,TP,TREF,SECHM,SECHP,SREF,
