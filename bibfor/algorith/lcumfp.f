     ...
     &                    TINSTP,HYDRM,HYDRP,SECHM,SECHP,SREF,EPSM,
...
C MODIFI DU 18 AOUT 2004 - YLP AJOUT DU SECHAGE DE REFERENCE
      REAL*8  SECHM,SECHP,SREF,ZERO
C MODIFI DU 18 AOUT 2004 - YLP AJOUT DES VARIABLES D'HYDRATATION
      REAL*8  HYDRM,HYDRP
...
C
      NOMRES(1)='B_ENDOGE'
      NOMRES(2)='K_DESSIC'
      CALL RCVALA(IMATE,' ','ELAS',3,'TEMP',0.D0,2,
     &             NOMRES,VALRES,CODRET, 'F ' )
      BENDO=VALRES(1)
      KDESS=VALRES(2)
C
...
C PAR LES DEFORMATIONS DE RETRAIT 
        EPSRM = KDESS*(SECHM-SREF)-BENDO*HYDRM
        EPSRP = KDESS*(SECHP-SREF)-BENDO*HYDRP
