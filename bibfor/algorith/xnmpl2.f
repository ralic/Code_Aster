      SUBROUTINE  XNMPL2(POUM,ELREFP,ELRESE,NDIM,COORSE,IGEOM,HE,DDLH,
...
C RESPONSABLE GENIAUT S.GENIAUT
      ...
      INTEGER       DDLH,DDLC,DDLM,NFE,IDEPLM,IVECTU,IDEPLP
      CHARACTER*(*) POUM
      CHARACTER*8   ELREFP,TYPMOD(*)
      CHARACTER*8   ELRESE
      CHARACTER*16  OPTION,COMPOR(4)
      CHARACTER*24  COORSE
      REAL*8        BASLOC(6*NNOP),CRIT(3),HE
...
C       ET CALCUL DE FF, DFDI, DEPS ET EPS
     ...
     &     DDLH,NFE,DDLS,DDLM,FE,DGDGL,'OUI',XE,FF,DFDI,F,DEPS,GRAD)
