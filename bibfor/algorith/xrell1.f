      SUBROUTINE XRELL1(TABNOZ,NDIM  ,NAR   ,TABCO ,PICKNO,
     &                  NBPINO,FISS   )
C
...
C                FISS//'.CONTACT.LISRL'
C                FISS//'.CONTACT.LISCO'
C
...
C
      IF (NRELEQ.GT.0) THEN
        CALL WKVECT(FISS(1:8)//'.CONTACT.LISEQ','G V I',NRELEQ*2,JLIS1)
        DO 130 IE=1,NRELEQ
...
C
      IF (NRELRL.GT.0) THEN
        CALL WKVECT(FISS(1:8)//'.CONTACT.LISRL','G V I',NRELRL*3,JLIS2)
        CALL WKVECT(FISS(1:8)//'.CONTACT.LISCO','G V R',NRELRL*3,JLIS3)
        DO 230 IE=1,NRELRL
          DO 231 J=1,3
