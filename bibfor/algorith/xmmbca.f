      SUBROUTINE XMMBCA(NOMA  ,NOMO  ,DEFICO,RESOCO,OLDGEO,
...
C
      ...
      CHARACTER*24  OLDGEO,DEPPLU,DEPMOI
C     
C ----------------------------------------------------------------------
C
...
C IN  OLDGEO : GÉOMÉTRIE INITIALE DU MAILLAGE
...
C
      ...
      REAL*8       RBID
      COMPLEX*16   CBID
      CHARACTER*19 XDONCO,XINDCO,XMEMCO,XGLISS
      CHARACTER*16 OPTION
      CHARACTER*8  K8BID
      CHARACTER*19 LIGREL,CICOCA,CINDOO,CMEMCO,LTNO
      CHARACTER*19 PINTER,AINTER,CFACE ,FACLON
