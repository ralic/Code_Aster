...
C ---------------- FIN DECLARATIONS NORMALISEES JEVEUX -----------------
      ...
      INTEGER       IMA,IAD,JINDCO,I,JCES,NBMAC(3),JXFEM
      REAL*8        RBID
      COMPLEX*16    CBID
...
C     SI SINCO EST INFERIEUR AU NOMBRE DE MAILLES DE CONTACT, ALORS ON
C     A PAS CONVERGÉ
      IF (SINCO.LT.(NBMAC(1)+NBMAC(2)+NBMAC(3))) INCOCA=0
