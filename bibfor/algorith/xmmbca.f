...
C ---------------- FIN DECLARATIONS NORMALISEES JEVEUX -----------------
      ...
      INTEGER       IMA,IAD,JINDCO,I,JCES
      REAL*8        RBID
      COMPLEX*16    CBID
      CHARACTER*8   LPAIN(9),LPAOUT(2),LICMP(2),KBID
      CHARACTER*19  LIGREL,CICOCA,CINDOO,LEVSET,LCHIN(9),LCHOUT(2)
...
C     CREATION DES LISTES DES CHAMPS IN ET OUT
      ...
      CALL CALCUL('S','XCVBCA',LIGREL,9,LCHIN,LPAIN,2,LCHOUT,LPAOUT,'V')
...
C     ON COMPARE LA SOMME DES INCOCA POUR CHAQUE ÉLÉMENTS AU NB D'ÉLTS
      INCOCA=1
      IF (SINCO.NE.ZI(JINDIC+1)) INCOCA=0
C     NB DE MAILLES OU HYP DE CONTACT VIOLÉE
C      WRITE(6,*)' ',ZI(JINDIC+1)-SINCO
