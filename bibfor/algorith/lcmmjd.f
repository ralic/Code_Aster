     ...
     &    NBCOMM,DT,IR,IS,NBSYS,HSR,VIND,DY,
     ...
     &            HR,SOMS1,SOMS2,SOMS3)
      ...
      DO 56 I=1,12
         IF (ALPHAP(I).GT.0.D0) THEN
            SOMAAL=SOMAAL+HSR(NUMHSR,IR,I)*ALPHAP(I)
         ENDIF
 56   CONTINUE
      SOMAAL=SQRT(SOMAAL)
      DTRDAS=0.D0
      ...
      IF (ALPHAP(IS).GT.0.D0) THEN
         IF (SOMAAL.GT.0.D0) THEN
            DTRDAS=CEFF/2.D0/SOMAAL*HSR(NUMHSR,IR,IS)
         ENDIF
      ENDIF
