...
C        CALCUL de dF/dtau
     ...
     &         DY(NSFA+1),HSR,RR,ALPHAR,DALPHA,GAMMAR,
...
C        CALCUL DE DALPHAs/dGAMMAs
     ...
     &        IR,IS,NECRCI,DGAMMS,ALPHAM,DALPHA,SGNR,DARDGR)
