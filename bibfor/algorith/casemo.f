     ...
     &                  FREQ,VECT,
     &                  NUMODE,DVECTI,CDVAL,CDVEC)

C-----------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGORITH  DATE 11/08/2004   AUTEUR A3BHHAE H.ANDRIAMBOLOLONA 
C ======================================================================
...
C HYPOTHESES : MODES SIMPLES, DM/DP ET DC/DP SONT NULLES
C-----------------------------------------------------------------------
...
C PARAMETRES D'APPELS
      ...
      REAL*8 FREQ(MXRESF,*)
      COMPLEX*16 VECT(*),DVECTI(*),CDVAL,CDVEC(*)
...
C SI DERIVATION MASSE ET/OU AMOR, IL FAUT RAJOUTER :
C   LAMBDA*PHItr*M'*PHI+LAMBDA*PHItr*C'
126    CONTINUE
       CDVAL = -CDVAL/PSIC
...
C SI DERIVATION MASSE ET/OU AMORTISSEMENT, IL FAUT RAJOUTER :
C    -LAMBDA2*M'*VECT - LAMBDA*C'*VECT
700   CONTINUE
