...
C MODIF ALGORITH  DATE 13/05/2013   AUTEUR PELLET J.PELLET 
C ======================================================================
...
C---------------------------------------------------------------------
      ...
      INTEGER       IFM,NIV
      REAL*8        TPS(6),MIJ,CIJ,KIJ
      REAL*8        BID,EBID
      CHARACTER*2   MODEL
      CHARACTER*3   ND
      CHARACTER*8   NOMRES, K8BID,MODMEC,PHIBAR
      CHARACTER*8   MOFLUI,MOINT,MA,MATERI,NOMCMP(6)
      CHARACTER*8   CHAR,NUMGEN,MODGEN
      CHARACTER*9   OPTION
      CHARACTER*14  NU,NUM,NUGENE
      CHARACTER*16  TYPRES,NOMCOM
      CHARACTER*19  MAX,MAY,MAZ,CHAMNO
      CHARACTER*19  STOLCI,SOLVEU
      CHARACTER*24  NOMCHA,TIME,NOCHAM
      CHARACTER*24  MATE,PHIB24
      COMPLEX*16    CBID
      INTEGER      IARG
C -----------------------------------------------------------------
...
C
      ...
      CALL GETVID(' ','NUME_DDL_GENE',0,IARG,1,NUMGEN,N9)
      CALL GETVID(' ','MODELE_GENE',0,IARG,1,MODGEN,N10)
      CALL GETVID(' ','POTENTIEL',0,IARG,1,PHIBAR,N12)
      CALL GETVTX(' ','OPTION',0,IARG,1,OPTION,N13)
      CALL GETVTX(' ','NOEUD_DOUBLE',0,IARG,1,ND,N14)
C
