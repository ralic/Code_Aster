     ...
     +                  ADVIME,ADVITH,ADDEP1,ADCP11,ADCP12,ADDEP2,
     +                  ADCP21,ADCP22,ADDETE,ADCOTE,CONGEM,CONGEP,VINTM,
     +                  VINTP,DSDE,EPSV,DEPSV,P1,DP1,T,DT,PHI,PVP,H11,
     +                  H12,H21,RHO11,PHI0,PVP0,P10,T0,SAT,RETCOM)
C ======================================================================
...
C ======================================================================
      ...
      REAL*8        PHI,PVP,H11,H12,H21,RHO11,PHI0,PVP0,P10,T0
...
C ======================================================================
      ...
      REAL*8       VARBIO,VARLQ,VARVP,UMPRHS
      CHARACTER*8  NOMAIL
C ======================================================================
...
C =====================================================================
     ...
     +             RBID6,
     +             RBID7, RBID8, RBID9, RBID10, RBID11, RHO0, CSIGM,
...
C =====================================================================
      IF (YATE.EQ.1) THEN
         IF (T.LE.0.D0) THEN
        WRITE (UMESS,9001) 'CALCCO_LIQ_SATU',' T <0  ','A LA MAILLE: ',
     +     NOMAIL
           RETCOM = 1
           GO TO 30
         ENDIF
...
C =====================================================================
         IF (YAMEC.EQ.1) THEN
            ...
            WRITE (UMESS,9001) 'CALCCO_LIQ_SATU','-VARBIO > EXPMAX  ',
     &        'A LA MAILLE: ',NOMAIL
            RETCOM = 1
            GO TO 30
            ENDIF
         ...
         IF (VARLQ.NE.0.D0) THEN
            ...
            WRITE (UMESS,9001) 'CALCCO_LIQ_SATU','VARLQ > EXPMAX  ',
     &        'A LA MAILLE: ',NOMAIL
            RETCOM = 1
            GO TO 30
            ENDIF
     ...
     &        'A LA MAILLE: ',NOMAIL
         ...
         IF (VARVP.GT.EXPMAX) THEN
          WRITE (UMESS,9001) 'CALCCO_LIQ_SATU','VARVP > EXPMAX  ',
     &      'A LA MAILLE: ',NOMAIL
          RETCOM = 1
          GO TO 30
         ENDIF
...
C =====================================================================
      IF (YATE.EQ.1) THEN
         ...
         IF (UMPRHS.LE.0.D0) THEN
          WRITE (UMESS,9001) 'CALCCO_LIQ_SATU',' RHOS(1-PHI) <=0 ',
     &      '  A LA MAILLE: ',NOMAIL
          RETCOM = 1
          GO TO 30
         ENDIF
         ...
         IF (C0EPS.LE.0.D0) THEN
          WRITE (UMESS,9001) 'CALCCO_LIQ_SATU','C0EPS <=0  ',
     &      'A LA MAILLE: ',NOMAIL
          RETCOM = 1
          GO TO 30
         ENDIF
...
C =====================================================================
C --- CAS D'UN SEUL CONSTITUANT : LIQUIDE 1 ---------------------------
C =====================================================================
      IF ((YATE.EQ.1)) THEN
