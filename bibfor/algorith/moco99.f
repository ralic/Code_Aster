...
C MODIF ALGORITH  DATE 25/01/2010   AUTEUR SELLENET N.SELLENET 
C ======================================================================
...
C SEUL   /I/ : INDICATEUR POUR PRECISER SI'L S'AGIT D'UNE DEUXIEME OCC.
...
C
      ...
      CHARACTER*16 TYPRES,CHAM,DEPL,BMPARA(NBPABM),CHMECA(NBCHAM),TYPMO
...
C ----- REQUETE NOM ET ADRESSE ANCIEN CHAMNO
          CALL RSEXCH(RESUL,CHMECA(II),IOROL,CHAMOL,IER)
          IF (IER.EQ.0) THEN
C ----- CONFIRMATION DU NOM DE CHAMNO AUPRES DU RESULTAT COMPOSE
            CALL RSNOCH(NOMRES,CHMECA(II),IORNE,CHAMOL)
          ENDIF
 30     CONTINUE
