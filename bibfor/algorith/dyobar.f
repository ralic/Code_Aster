      SUBROUTINE DYOBAR(MAILLA,INSTAP,ITERAT,VITPLU,ACCPLU,
     &                  VALPLU,DEPDEL,SECMBR,SDIMPR,SDSUIV,
     &                  DEPENT,VITENT,ACCENT,CNSINR,NOMTAB,
...
C
      ...
      CHARACTER*24 SDIMPR
      CHARACTER*24 SDSUIV
      CHARACTER*19 CNSINR,NOMTAB,SDDYNA
      LOGICAL      LSUIVI
C
C ----------------------------------------------------------------------
C
