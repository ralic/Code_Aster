     ...
     +                  VINTP,DSDE,DEPS,EPSV,DEPSV,P1,P2,DP1,DP2,T,
     +                  DT,PHI,PVP,H11,H12,H21,RHO11,PHI0,PVP0,SAT,
     +                  RETCOM,THMC,CRIT,BIOT)
C ======================================================================
...
C ======================================================================
      ...
      INTEGER       YATE,RETCOM,ADCOME,ADCP11,ADCP12,ADVITH
