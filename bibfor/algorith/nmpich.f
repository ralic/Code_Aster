...
C TOLE CRP_21
      ...
      CHARACTER*8   MODEDE
      CHARACTER*14  PILOTE
      CHARACTER*16  OPTION, CMD
      CHARACTER*19  LISCHA, CNRESI, CNDIRI, CNFEXT, SOLVDE, NURO
      CHARACTER*24  MODELE, NUMEDD, MATE  , CARELE, COMREF, COMPOR
      CHARACTER*24  CARCRI, VALMOI, POUGD , DDEPLA, VALPLU, DEPDEL
      CHARACTER*24  RESOCO, SECMBR, DEPOLD, NUMEDE, DEPPIL(2)
      CHARACTER*24  STADYN, DEPENT, VITENT, DEPKM1, VITKM1, ACCKM1
...
C      CALCUL DE ETA_PILOTAGE
     ...
     &              R8BID) 
C          write (6,*) 'NMPICH - 3 : ETA = ',ETA
C          write (6,*) 'NMPICH - 4 : LICCVG(1) = ',LICCVG(1)
