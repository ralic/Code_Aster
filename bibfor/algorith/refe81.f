...
C
        ...
        VALK (1) = MASS
        VALK (2) = CAL
            CALL U2MESG('A', 'ALGORITH14_17',2,VALK,0,0,0,0.D0)
            OPT=CAL
        ENDIF
C
...
C
        ...
        VALK (1) = RAID
        VALK (2) = CAL
            CALL U2MESG('A', 'ALGORITH14_18',2,VALK,0,0,0,0.D0)
        ENDIF
C
...
C
      IF(ITYBA.EQ.3) THEN
        IF(OPT.EQ.ORT) THEN
        VALK (1) = CAL
            CALL U2MESG('A', 'ALGORITH14_19',1,VALK,0,0,0,0.D0)
            OPT=CAL
        ENDIF
        IF(MASS.EQ.BLANC.OR.RAID.EQ.BLANC) THEN
        VALK (1) = MASS
        VALK (2) = RAID
            CALL U2MESG('F', 'ALGORITH14_20',2,VALK,0,0,0,0.D0)
        ENDIF
C
C --- TRAITEMENT DU NOM FINAL MASSE ET RAIDEUR
C
