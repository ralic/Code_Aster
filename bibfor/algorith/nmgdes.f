     ...
     &                   TPMXM,TPMXP,DEPST,SIGM,VIM,OPTION,SIGP,VIP,
     &                   DSIDEP)
...
C
      ...
      VALPAP = TPMXP
C
      CALL RCVALB(FAMI,KPG,KSP,'-',IMATE,' ','ELAS',1,NOMPAR,
     &            VALPAM,2,NOMRES(1),VALRES(1),CODRET(1), FB2 )
      EM  = VALRES(1)
      NUM = VALRES(2)
C
      CALL RCVALB(FAMI,KPG,KSP,'-',IMATE,' ','ELAS',1,NOMPAR,
...
C
      CALL RCVALB(FAMI,KPG,KSP,'+',IMATE,' ','ELAS',1,NOMPAR,
     &            VALPAP,2,NOMRES(1),VALRES(1),CODRET(1), FB2 )
      CALL RCVALB(FAMI,KPG,KSP,'+',IMATE,' ','ELAS',1,NOMPAR,
...
C
      ...
      NOMRES(2)='K_DESSIC'
      CALL RCVALB(FAMI,KPG,KSP,'-',IMATE,' ','ELAS',1,NOMPAR,
     &            VALPAM,1,NOMRES(1),VALRES(1),CODRET(1), BL2 )
      IF ( CODRET(1) .NE. 'OK' ) VALRES(1) = 0.D0
      BENDOM = VALRES(1)
C
      CALL RCVALB(FAMI,KPG,KSP,'+',IMATE,' ','ELAS',1,NOMPAR,
     &            VALPAP,1,NOMRES(1),VALRES(1),CODRET(1), BL2 )
      IF ( CODRET(1) .NE. 'OK' ) VALRES(1) = 0.D0
      BENDOP = VALRES(1)
C
      CALL RCVALB(FAMI,KPG,KSP,'-',IMATE,' ','ELAS',1,NOMPAR,
