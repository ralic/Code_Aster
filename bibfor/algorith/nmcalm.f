...
C
      ...
      INTEGER      IBID,IRET,I
      CHARACTER*16 OPTMAT  
      CHARACTER*19 DEPMOI,SIGPLU,VITPLU,VITMOI,ACCMOI
      CHARACTER*19 DEPDEL
...
C
      ELSEIF (TYPMAT.EQ.'MEELTC') THEN            
        CALL NMELCM('CONT',MODELE,DEFICO,RESOCO,MATE  ,DEPMOI,
     &              DEPDEL,VITMOI,VITPLU,ACCMOI,MATELE)
C
C --- MATR_ELEM DES ELTS DE FROTTEMENT (XFEM+CONTINUE)
C
      ELSEIF (TYPMAT.EQ.'MEELTF') THEN       
        CALL NMELCM('FROT',MODELE,DEFICO,RESOCO,MATE  ,DEPMOI,
     &              DEPDEL,VITMOI,VITPLU,ACCMOI,MATELE)
      ELSE  
        CALL ASSERT(.FALSE.)
      ENDIF
