...
C
      CALL GETVTX('LIAISON','DROITE',1,IARG,1,KAR8,IBID)
      DROITE=KAR8
      CALL GETVTX('LIAISON','GAUCHE',1,IARG,1,KAR8,IBID)
      GAUCHE=KAR8
      CALL GETVTX('LIAISON','AXE',1,IARG,0,KAR8,IBAXE)
      IF(IBAXE.EQ.-1) THEN
        CALL GETVTX('LIAISON','AXE',1,IARG,1,KAR8,IBID)
        AXE=KAR8
      ELSE
        AXE=' '
      ENDIF
