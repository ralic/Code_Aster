...
C MODIF ALGORITH  DATE 20/10/2009   AUTEUR DESOZA T.DESOZA 
C ======================================================================
...
C
      ...
      LOGICAL      LBID,MMCVF1,MMCVF2,MMCVG1,MMCVG2
...
C
      IF ((.NOT.MMCVCA).AND.(MMITCA.GE.ITERC)) THEN
        IF (LFROTT) THEN
...
C
      CALL MMMCRI('DEPL',DEPLAM,DEPPLU,EPSFRO,MMCVF1)
      CALL MMMCRI('CONT',DEPLAM,DEPPLU,EPSFRO,MMCVF2)
      MMCVFR = MMCVF1.AND.MMCVF2
C
      IF ((.NOT.MMCVFR).AND.(MMITFR.GE.ITERF)) THEN
...
C
      IF ((.NOT.LXFCM).OR.LTFCM) THEN
        CALL MMMCRI('DEPL',DEPGEO,DEPPLU,EPSGEO,MMCVG1)
        CALL MMMCRI('CONT',DEPGEO,DEPPLU,EPSGEO,MMCVG2)
        MMCVGO = MMCVG1.AND.MMCVG2
