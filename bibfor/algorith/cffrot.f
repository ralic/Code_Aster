...
C
C ----------------------------------------------------------------------
C ROUTINE APPELEE PAR : FROGDP/FROLGD/FROPGD
C ----------------------------------------------------------------------
C
C CALCUL DE LA MATRICE DE FROTTEMENT
C
C IN  MAT    : MATRICE TANGENTE GLOBALE
C IN  MAF1   : PARTIE 1 DE LA MATRICE FROTTEMENT
C IN  MAF2   : PARTIE 2 DE LA MATRICE FROTTEMENT
C IN  MAFROT : MATRICE GLOBALE TANGENTE AVEC FROTTEMENT RESULTANTE
C
...
C
C --- DESTRUCTION ANCIENNE MATRICE GLOBALE TANGENTE
C
