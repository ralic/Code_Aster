     ...
     &     NWKIN,WKIN,TYPMOD,ICOMP,NVI,NDSDE,DSIDEP,NWKOUT,WKOUT,CODRET)
      ...
      INTEGER         ICOMP,NVI
      INTEGER         CODRET
      REAL*8          ANGMAS(*),WKIN(NWKIN),WKOUT(NWKOUT)
      REAL*8          CRIT(*),SIGM(*)
...
C     FORMULATION NON-LOCALE A GRADIENT D'ENDOMMAGEMENT
      IF (TYPMOD(2).EQ.'GRADVARI') THEN
        ...
        CALL LCEIGV (FAMI,KPG,KSP,NEPS,IMATE,COMPOR,
...
C     FORMULATION NON-LOCALE AVEC REGULARISATION DES DEFORMATIONS
     ...
     &              VIM,OPTION,SIGP,VIP,DSIDEP,WKOUT)
C     FORMULATION LOCALE
     ...
     &              DEPS,VIM,TM,TP,TREF,OPTION,SIGP,VIP,DSIDEP,CRIT)
        ELSE
            CALL EIBEX(FAMI,KPG,KSP,NDIM,IMATE,COMPOR,INSTAM,
