...
C ================================================================
         CALL TECAC2('OOO',NUMAV,'PGEOMER','L',1,IGEOMV,IRET)
         CALL ASSERT(IRET.EQ.0)
         CALL TECAC2('OOO',NUMAV,'PMATERC','L',1,IMATEV,IRET)
         CALL ASSERT(IRET.EQ.0)
         CALL TECAC2('OOO',NUMAV,'PDEPLMR','L',1,IDEPMV,IRET)
         CALL ASSERT(IRET.EQ.0)
         CALL TECAC2('OOO',NUMAV,'PCOMPOR','L',1,ICOMPV,IRET)
         CALL ASSERT(IRET.EQ.0)
         CALL TECAC2('OOO',NUMAV,'PCARCRI','L',1,ICARCV,IRET)
         CALL ASSERT(IRET.EQ.0)
         CALL TECAC2('OOO',NUMAV,'PVARIMR','L',1,IVARMV,IRET)
         CALL ASSERT(IRET.EQ.0)
...
C
         ...
         IF (CONT) THEN
            ...
            CALL ASSERT(IRET.EQ.0)
            CALL TECAC2('OOO',NUMAV,'PCONTPR','E',1,ICONPV,IRET)
            CALL ASSERT(IRET.EQ.0)
            CALL TECAC2('OOO',NUMAV,'PVARIPR','E',1,IVARPV,IRET)
            CALL ASSERT(IRET.EQ.0)
         ELSE
            IVARPV = IVARMV
            ICONPV = ICONMV
