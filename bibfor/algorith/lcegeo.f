...
C MODIF ALGORITH  DATE 14/12/2009   AUTEUR PROIX J-M.PROIX 
C ======================================================================
...
C       CALCUL DE L = DF*F-1 
        ...
        DO 200 KPG=1,NPG
           CALL NMGEOM(NDIM,NNO,.FALSE.,.TRUE.,GEOM,KPG,IPOIDS,
     &              IVF,IDFDE,DEPLP,R8BID,DFDI,F, EPSBID,R)
           CALL NMGEOM(NDIM,NNO,.FALSE.,.TRUE.,GEOMM,KPG,IPOIDS,
