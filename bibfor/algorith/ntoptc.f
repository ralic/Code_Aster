...
C --- CALCUL DES OPTIONS
     ...
     &                  ' INCOMPATIBLE AVEC L''OPTION : '//OPTION)
          ...
          CALL MECHTI(CHGEOM(1:8),ZR(JINST+IORD-1),CHTIME)
          IBID = 0
     ...
     &                CHELEM,LIGREL,BASE,K24B,K24B,K24B,K24B,
     &                  K24B, K24B, K8BID, IBID, IRET )
          CALL RSNOCH(TEMPER,OPTION,NUMORD,' ')
          WRITE (IFM,1020) OPTION,NUMORD,ZR(JINST+IORD-1)
   10   CONTINUE
