...
C MODIF ALGORITH  DATE 17/08/2004   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C====
     ...
     &               AFFCHA,IERD)             
      ...
      IF (NBPASE.GT.0 .AND. CHCOMP) THEN
          CALL UTMESS('F',NOMPRO,'ON NE PEUT PAS DERIVER'//
     &     ' AVEC UNE CHARGE COMPLEXE EN ENTREE DE DYNA_LINE_HARM.')
      ENDIF 
...
C           
           IF ( TYPESE.EQ.-1 ) THEN
             TYPCAL = 'DLAG'
             CALL UTMESS('F',NOMPRO,'DERIVEE LAGRANGIENNE NON'
     &             //' PROGRMMEE POUR L INSTANT POUR LA DYNAMIQUE')
           ENDIF
