...
C VIM(4,GG) = CONTRAINTE DE PROPAGATION AU PT DE GAUSS GG
      ...
      INTEGER ICODRE(5)
      INTEGER K2,KPG,SPT
      CHARACTER*8 NOMRES(5),FAMI,POUM
...
C SI NON PRECISEE
        ...
        SPT=1
        POUM='+'
        CALL RCVALB(FAMI,KPG,SPT,POUM,IMATE,' ','ENDO_HETEROGENE',
     &              0,' ',0.D0,5,NOMRES,VALRES,ICODRE,1)
        CALL RCVALB(FAMI,KPG,SPT,POUM,IMATE,' ','NON_LOCAL',0,' ',
     &              0.D0,1,'LONG_CAR',LC,K2,1)
C  FACTEUR D ECHELLE
        ECHP = VALRES(1)
C  MODULE DE WEIBULL
        MM   = VALRES(2)
