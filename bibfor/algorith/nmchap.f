     ...
     &                  SOLALG,MEELEM,VEELEM,VEASSE,MEASSE,FONACT)
C
...
C
      ...
      INTEGER      NRPASE
      INTEGER      IFM,NIV
      LOGICAL      NDYNLO,LDYNA,LIMPEX,ISFONC
C
...
C
      ...
      CHARACTER*19 CNXFTF,CNMSME,CNSSTF
...
C
     ...
     &            VITMOI,ACCMOI,SIGEXT,K24BLA, 7, VALMOI)
C
C --- NOMS DES CHAMPS - ETAT T+ (SANS SENSIBILITE)
C
      NRPASE = 0
