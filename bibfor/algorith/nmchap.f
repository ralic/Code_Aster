      SUBROUTINE NMCHAP(SDSENS,SDDYNA,VALINC,SOLALG,MEELEM,
...
C
      ...
      CHARACTER*19 CNIMPP,CNIMPC,CNUSUR,CNVISS
C
...
C
      ...
      DATA STRMOI,STRPLU    /'&&OP0070.STRMOI','&&OP0070.STRPLU'/
      DATA SIGEXT           /'&&OP0070.SIGEXT'/
C
      DATA FEXMOI,FEXPLU    /'&&OP0070.FEXMOI','&&OP0070.FEXPLU'/
      DATA FAMMOI,FAMPLU    /'&&OP0070.FAMMOI','&&OP0070.FAMPLU'/
      DATA FLIMOI,FLIPLU    /'&&OP0070.FLIMOI','&&OP0070.FLIPLU'/
      DATA FNOMOI,FNOPLU    /'&&OP0070.FNOMOI','&&OP0070.FNOPLU'/
C
...
C
      ...
      CALL NMNSLE(SDSENS,NRPASE,'STRMOI',STRMOI)
      IF (LDYNA) THEN
...
C
      ...
      CALL NMNSLE(SDSENS,NRPASE,'STRPLU',STRPLU)
      IF (LDYNA) THEN
