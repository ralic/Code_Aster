...
C TOLE CRP_20
      ...
      INTEGER NEPS,IMATE
      REAL*8 EPSM(NEPS),EPSPC(NEPS),EPSDC(NEPS),ETAMIN,ETAMAX,TAU,VIM(2)
      REAL*8 COPILO(2,2)
C ----------------------------------------------------------------------
...
C -- LECTURE DES CARACTERISTIQUES THERMOELASTIQUES
      NOMRES(1) = 'E'
      NOMRES(2) = 'NU'
      CALL RCVALB(FAMI,KPG,SPT,POUM,IMATE,' ','ELAS',0,' ',
...
C    LECTURE DES CARACTERISTIQUES DE REGULARISATION
      NOMRES(1) = 'PENA_LAGR'
...
C    LECTURE DES CARACTERISTIQUES D'ENDOMMAGEMENT
      ...
      NOMRES(2) = 'SYT'
      NOMRES(3) = 'SYC'
      CALL RCVALB(FAMI,KPG,SPT,POUM,IMATE,' ','BETON_ECRO_LINE',
     &           0,' ',0.D0,3, NOMRES,VALRES,ICODRE,0)
      GAMMA  = -E/VALRES(1)
