     ...
     &                  DIMGI,IRR,JGITGI,IPIV,GI,LSTOGI)
C-----------------------------------------------------------------------
...
C DECLARATION PARAMETRES D'APPELS
     ...
     &             IRR,I1,IINF,IPIV
      ...
      CHARACTER*19 MATAS,CHSECM,SDFETI,CHSOL,INFOFE
...
C CALCUL ALPHA SI MODES DE CORPS RIGIDES
        IF (LRIGID) THEN     
           ...
           OPTIOP=2
           CALL FETPRJ(NBI,ZR(IRR),ZR(IALPHA),COLAUI,JGITGI,LRIGID,
     &                 DIMGI,OPTIOP,SDFETI,IPIV,NBSD,VSDF,VDDL,MATAS,
     &                 GI,LSTOGI)
           IDECAA=IALPHA           
        ENDIF
