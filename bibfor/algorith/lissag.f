...
C      ATTENTION A L'ORIENTATION DE VECT_Y = TAU2
C
              IF(ALIAS(1:3).EQ.'SG2') THEN
                TAU2(1)=ZR(JTGDEF+6*(IZONE-1))
                TAU2(2)=ZR(JTGDEF+6*(IZONE-1)+1)
                TAU2(3)=ZR(JTGDEF+6*(IZONE-1)+2)
