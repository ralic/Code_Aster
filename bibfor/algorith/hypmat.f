...
C
      NOMRES(1)='K'
      CALL RCVALB(FAMI,KPG,KSP,POUM,IMATE,BL2,'ELAS_HYPER',0,' ',0.D0,1,
     &            NOMRES,VALRES,CODRES,AB2 )
      ...
      ELSE
        NOMRES(1)='NU'
        CALL RCVALB(FAMI,KPG,KSP,POUM,IMATE,BL2,'ELAS_HYPER',0,' ',0.D0,
     &              1,NOMRES,VALRES,CODRES,FB2 )
        NU    = VALRES(1)
      ...
      NOMRES(3)='C20'
      CALL RCVALB(FAMI,KPG,KSP,POUM,IMATE,BL2,'ELAS_HYPER',0,' ',0.D0,
     &            NBRES,NOMRES,VALRES,CODRES,FB2 )
      C10 = VALRES(1)
      C01 = VALRES(2)
      C20 = VALRES(3)
