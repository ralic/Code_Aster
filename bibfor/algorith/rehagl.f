...
C
      ...
      IF (IRET.EQ.0) THEN
            VALK (1) = MAILSK
        CALL U2MESG('F', 'ALGORITH14_39',1,VALK,0,0,0,0.D0)
      END IF
...
C
      IF (NBSYMB.EQ.0) THEN
            VALK (1) = RESGEN
        CALL U2MESG('F', 'ALGORITH14_40',1,VALK,0,0,0,0.D0)
      END IF
C
      ...
      IF (NBSYMB.GT.1) THEN
        DO 10 I = 2,NBSYMB
          IF (NUME(I).NE.NUMGEN) THEN
            ...
            VALK (3) = SYMB(1)
            VALK (4) = NUMGEN
            CALL U2MESG('F', 'ALGORITH14_41',4,VALK,0,0,0,0.D0)
          END IF
...
C  REQUETTE NOM ET ADRESSE CHAMNO GENERALISE
          WRITE (6,*) 'RESGEN = ',RESGEN,' CHSYMB = ',CHSYMB
          CALL DCAPNO(RESGEN,CHSYMB,I,CHAMOL)
          CALL JEVEUO(CHAMOL,'L',LLCHOL)
          WRITE (6,*) 'I = ',I,' CHAMOL = ',CHAMOL,' LLCHOL = ',LLCHOL
C
...
C
        ...
        FREQ = ZR(IAFREQ(1))
        WRITE (6,*) 'FREQ=',FREQ,' ET NOMRES=',NOMRES
