...
C MODIF ALGORITH  DATE 16/08/2011   AUTEUR NISTOR I.NISTOR 
C ======================================================================
...
C     --- RECUPERATION DES ARGUMENTS DE LA COMMANDE ---
      ...
      CALL GETVIS('PARA_LAME_FLUI','NMAX_ITER',1,1,1,ITEMAX,N1)
      CALL GETVR8('PARA_LAME_FLUI','RESI_RELA',1,1,1,PREC,N1)
      CALL GETVR8('PARA_LAME_FLUI','LAMBDA',1,1,1,XLAMBD,N1)
      CALL GETFAC('EXCIT',NEXCIT)

C     --- RECUPERATION DES MATRICES PROJETEES ---

      CALL GETVID(' ','MATR_MASS',0,1,1,MASGEN,NM)
      CALL GETVID(' ','MATR_RIGI',0,1,1,RIGGEN,NR)
      CALL GETVID(' ','MATR_AMOR',0,1,1,AMOGEN,NA)
      IF (NEXCIT.NE.0) THEN
        CALL WKVECT('&&MDTR74.NOMVEC','V V K8',NEXCIT,JVEC)
        DO 10 I = 1,NEXCIT
          CALL GETVID('EXCIT','VECT_ASSE',I,1,1,VECGEN,NV)
          ZK8(JVEC-1+I) = VECGEN
   10   CONTINUE
      END IF
...
C Lecture des donnees paliers
          CALL GETVIS('PALIER_EDYOS','UNITE',1,1,1,UNITPA,N1)
          IF ( N1 .NE. 0 ) THEN
