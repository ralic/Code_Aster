      SUBROUTINE MAJOU(MODEL,MODMEC,
     &         NUM,NU,MA,MATE,MOINT,MOFLUI,NDBLE,ICOR,TABAD)
      IMPLICIT REAL*8  (A-H,O-Z)
C---------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGORITH  DATE 29/09/98   AUTEUR BIBERON G.ROUSSEAU 
C ======================================================================
...
C     --- FIN DES COMMUNS JEVEUX ------------------------------------
      ...
      CHARACTER*8   MOFLUI,MOINT,MA,K8BID,MAFLUI,MODMEC
