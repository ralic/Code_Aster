...
C
      ...
      INTEGER      JDECAL
      INTEGER      JCOOR
      REAL*8       JEU,RBID,R6BID(6),OLDJEU,DIST3,DIST4
      CHARACTER*24 APPARI,APPOIN,APJEU,APCOEF,APDDL
      INTEGER      JAPPAR,JAPPTR,JAPJEU,JAPCOE,JAPDDL
      CHARACTER*24 NOZOCO,CONTNO,NDIMCO
      INTEGER      JZOCO,JNOCO,JDIM
...
C
        ...
        POSMA  = ZI(JAPPAR+ZAPPA*(IESCL-1)+2)
        REACTU = ZI(JAPPAR+ZAPPA*(IESCL-1)+3)
        REAPRO = ABS(REACTU)
