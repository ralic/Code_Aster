...
C MODIF ALGORITH  DATE 07/11/2005   AUTEUR GNICOLAS G.NICOLAS 
C ======================================================================
...
C
        LIGNE = LIGBLA
        LIGNE(1:8) = 'CCNoChaI'
        LIGNE(10:9+LNMDIN) = NMDIN(1:LNMDIN)
        WRITE (NUFIHO,30000) LIGNE
C
        LIGNE = LIGBLA
        LIGNE(1:8) = 'CCCoChaI'
...
C
      LIGNE = LIGBLA
      LIGNE = 'DicoOSGM $HOME/HOMARD/V8.n/CONFIG/typobj.stu'
      WRITE (NUFIHO,30000) LIGNE
C
      IF ( NIVINF.GT.1 ) THEN
        LIGNE = LIGBLA
        LIGNE(1:10) = 'MessInfo 2'
        WRITE (NUFIHO,30000) LIGNE
      ENDIF
C
30000 FORMAT (A)
