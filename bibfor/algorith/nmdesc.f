...
C
     ...
     &            CNDONN)
C
C --- POUR LE CALCUL DE DDEPLA,  ON SOUSTRAIT LA VALEUR
C     ACTUELLE DES DDL CORRESPONDANT AUX CONDITIONS IMPOSEES PAR 
C     ELIMINATION
      CALL COPISD('CHAMP_GD','V',CNCINE,CNCINX)
      CALL ACTCIN(FONACT,CNCINX,MATASS,SOLALG) 
C
C --- RESOLUTION
C
      CALL NMRESD(FONACT,SDDYNA,SDTIME,SOLVEU,NUMEDD,
     &            R8BID ,MAPREC,MATASS,CNDONN,CNPILO,
     &            CNCINX,MODELE,DEFICO,SOLALG)    
C
9999  CONTINUE
C
