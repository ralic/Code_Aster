...
C MODIF ALGORITH  DATE 27/11/2000   AUTEUR VABHHTS J.PELLET 
C ======================================================================
...
C     --------------------------------------------------------
      ...
      IF (IRET.EQ.0) CALL UTMESS('F','ASASVE',
     &                           'LE VECT_ELEM'//' N''EXISTE PAS : '//
     &                           VECELE)
...
C       CALL UTIMS2('ASASVE 1',I,RESUEL,1,' ')
        ...
        IF (ICHA.EQ.0) THEN
          CALL UTMESS('F','ASASVE','CHAMP NON RENSEIGNE.'//
     &                ' IL FAUT AVOIR UTILISE CORICH(''E'',...) SUR: '//
     &                RESUEL)
        ELSE IF (ICHA.LT.-2) THEN
          CALL UTMESS('F','ASASVE','IMPOSSIBLE')
        END IF
