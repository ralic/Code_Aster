     ...
     &                  MATASS,DDEPLA,DEPDEL,CTCCVG,CTCFIX)
C
...
C
      IF (ICONT.EQ.4) THEN
        IF (IFROT.EQ.0) THEN
          CALL ALGOCP(SDSTAT,RESOCO,LMAT  ,DDEPLA)
        ELSEIF (IFROT.EQ.1) THEN
          CALL FROGDP(SDSTAT,DEFICO,RESOCO,LMAT  ,DDEPLA,
     &                RESIGR,DEPDEL)
        ELSE
          CALL ASSERT(.FALSE.)
        ENDIF    
      ELSE IF (ICONT.EQ.1) THEN
        IF (LGLISS) THEN
          CALL ALGOGL(SDSTAT,DEFICO,RESOCO,LMAT  ,LDSCON,
     &                NOMA  ,DDEPLA,CTCCVG)
        ELSE
          CALL ALGOCO(SDSTAT,DEFICO,RESOCO,LMAT  ,LDSCON,
     &                NOMA  ,DDEPLA,CTCCVG)
        ENDIF
      ELSE IF (ICONT.EQ.2) THEN
        IF (IFROT.EQ.0) THEN      
          CALL ALGOCG(SDSTAT,DEFICO,RESOCO,MATASS,NOMA  ,
     &                DDEPLA)
        ELSE
          CALL ASSERT(.FALSE.)
        ENDIF
      ...
      ELSE IF (ICONT.EQ.5) THEN
        IF (IFROT.EQ.0) THEN
          CALL ALGOCL(SDSTAT,DEFICO,RESOCO,LMAT  ,LDSCON,
     &                NOMA  ,DDEPLA,CTCCVG,CTCFIX)             
        ELSEIF (IFROT.EQ.1) THEN
          CALL FROPGD(SDSTAT,DEFICO,RESOCO,LMAT  ,LDSCON,
     &                NOMA  ,DDEPLA,RESIGR,DEPDEL,CTCCVG,
     &                CTCFIX)
        ELSEIF (IFROT.EQ.2) THEN
          IF (NDIMG.EQ.2) THEN
            CALL FRO2GD(SDSTAT,DEFICO,RESOCO,LMAT  ,LDSCON,
     &                  NOMA  ,DEPDEL,DDEPLA,CTCCVG)
          ELSEIF (NDIMG.EQ.3) THEN
            CALL FROLGD(SDSTAT,DEFICO,RESOCO,LMAT  ,LDSCON,
     &                  NOMA  ,DDEPLA,RESIGR,DEPDEL,CTCCVG)
          ELSE
            CALL ASSERT(.FALSE.)
          ENDIF
