...
C
      ...
      INTEGER      IBID,IRET,IAM,IMODE
      INTEGER      NA,NB,N,NM
      INTEGER      NBMD,NEQ,NBMODE,NBMAX,NBAMOR
      INTEGER      IADRIF,IDDEEQ,LMAT,IAMOR,LTVEC
...
C
      CALL WKVECT('&&NMMOAM.AMORTISSEMENT','V V R',NBMODE,JAMOR)
...
C
        ...
        IF (NBAMOR.LT.NBMODE) THEN
          CALL WKVECT('&&NMMOAM.AMORTISSEMEN2','V V R',NBMODE,JAMO2)
          DO 40 IAM = 1,NBAMOR
