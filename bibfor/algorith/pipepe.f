...
C      CALCUL DE EPSGENE MOINS        
          CALL NMGEOB(NDIM,NNO,GEOM,KPG,IPOIDS,IVF,IDFDE,
     &                DEPLM,POIDS,DFDI,EPSM,T18BID)

C      CALCUL DE DEPSGENE
          CALL NMGEOB(NDIM,NNO,GEOM,KPG,IPOIDS,IVF,IDFDE,
     &                DDEPL,POIDS,DFDI,DEPS,T18BID)

C      CALCUL DE EPSGENEP
          CALL NMGEOB(NDIM,NNO,GEOM,KPG,IPOIDS,IVF,IDFDE,
     &                DEPL0,POIDS,DFDI,EPSP,T18BID)
          CALL DAXPY(NDIMSI,1.D0,DEPS,1,EPSP,1)

C      CALCUL DE EPSGENED
          CALL NMGEOB(NDIM,NNO,GEOM,KPG,IPOIDS,IVF,IDFDE,
     &                DEPL1,POIDS,DFDI,EPSD,T18BID)
