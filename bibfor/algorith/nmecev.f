...
C
C ECHEC DU TRAITEMENT D'UNE ACTION - SAUVEGARDE/LECTURE POUR INFO
C
C ----------------------------------------------------------------------
C
C
C IN  SDERRO : SD ERREUR
C IN  ACCES  : TYPE ACCES 'E' OU 'L'
C I/O NOMEVD : NOM DE L'EVENEMENT
C I/O ACTION : NOM DE L'ACTION
C
