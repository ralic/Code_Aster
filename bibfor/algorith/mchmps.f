      SUBROUTINE MCHMPS(NOMA,GEOM,POSNO,NEWGEO,DEFICO,POSMIN,T1MIN,
...
C ---------------- FIN DECLARATIONS NORMALISEES JEVEUX -----------------
      ...
      INTEGER JDEC,JDEC1
      INTEGER JNOCO,JMACO,JMANO,JPOMA,IFM,NIV,JTOLE,ZTOLE,JMAESC,IZONE
      INTEGER POSMA,IMA,NBMA,K
      INTEGER INO,POSNNO(10)
      INTEGER NUMA,NO(9)
      REAL*8 JEU,JEUMIN,R8GAEM,TAU1(3),TAU2(3),TOL
      CHARACTER*24 CONTMA,CONTNO,MANOCO,PMANO,PNOMA,NOMACO,TOLECO,MAESCL
...
C --- COORDONNéES DU NOEUD à PROJETER
        DO 20 I = 1,3
          COOR(I) = GEOM(I)
   20   CONTINUE
   
C --- COORDONNEES DES NOEUDS DE LA MAILLE MAITRE
C     (SUR LAQUELLE ON PROJETTE)
...
C - SI JEU (AVANT CORRECTION) < JEU MINIMUM, STOCKER LES VALEURS
   ...
   50 CONTINUE
      ...
      IF(NPTOL.EQ.1 .AND. NBMA.EQ.1) CONDI=.FALSE.
      IF(TOL.EQ.-1.D0) CONDI=.TRUE.
