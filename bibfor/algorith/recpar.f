      SUBROUTINE RECPAR(NEQ,DTMAX,VMIN,VVAR,CMP,CDP,CPMIN,NPER,NRMAX)
C
      IMPLICIT REAL*8 (A-H,O-Z)
      REAL*8      VMIN(*),CMP,CPMIN,DTMAX,R8BID
      REAL*8 VALR(4)
      CHARACTER*8 VVAR
      CHARACTER*24 VALK
...
C                PAR PAS DE CALCUL
C OUT : DTMAX  : PAS DE TEMPS MAXIMAL
C OUT : DTMXIN : LE PAS DE TEMPS MAXIMAL EST-IL EGAL AU PAS INITIAL ?
C
C
