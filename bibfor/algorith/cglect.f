     ...
     &                  FONOEU,CHFOND,BASFON,TAILLR,CONF,LNOFF,LISS,
     &                  NDEG)
      IMPLICIT NONE

      INTEGER      NDIM,LNOFF,NDEG
      CHARACTER*8  RESU,MODELE,TYPFIS,NOMFIS,CONF
      CHARACTER*16 OPTION,CAS
      CHARACTER*24 FONOEU,CHFOND,BASFON,TAILLR,LISS
...
C     ET RECUPERATION DES OBJETS FONOEU, CHFOND, BASFON + LNOFF
      CALL CGLEFF(TYPFIS,NOMFIS,FONOEU,CHFOND,BASFON,TAILLR,CONF,LNOFF)
