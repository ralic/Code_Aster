...
C
      ...
      INTEGER      K,L,IZONE,IESCL,IESCL0,IESOLD
      INTEGER      REAAPP,REACTU,APPAR
      CHARACTER*24 NDIMCO,APPOIN,APJEU,APPARI,METHCO,CONTNO
      INTEGER      JDIM,JAPPTR,JAPJEU,JAPPAR,JMETH,JNOCO
      CHARACTER*24 JEUFO1,JEUFO2,JEUFO3,JEUSUP,FROTE,APREAC,CARACF,PENAL
      INTEGER      JJFO1,JJFO2,JJFO3,JJSUP,JFRO,JREAC,JCMCF,JPENA
      CHARACTER*24 COMAFO,PNOMA,NOMACO,APJEFX,APJEFY,APDDL,JEUINI
      INTEGER      JCOMA,JPONO,JNOMA,JAPJFX,JAPJFY,JAPDDL
      CHARACTER*24 APMEMO,NORMCO,TANGCO,APCOFR,PDDL,APCOEF
      INTEGER      JAPMEM,JNORMO,JTANGO,JAPCOF,JPDDL,JAPCOE
      REAL*8       R8BID
      INTEGER      POSNOE,REAC,POSMA,POSNO(10),NBNO,NBDDL,JDECAL

      INTEGER      JCOOR
      CHARACTER*8  K8BID
      INTEGER      TYPALC,TYPALF,FROT3D,MATTAN
      INTEGER      IFM,NIV
      INTEGER      JOLDAP,JOLDPT,JOLDCO,JOLDDD,JOLDNO,JOLDTG
      INTEGER      JOLDJE,JOLDCF
C
C ----------------------------------------------------------------------
C
      CALL INFNIV(IFM,NIV)
