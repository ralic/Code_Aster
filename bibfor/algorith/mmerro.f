...
C
      ...
      IF (ERROR(1:8).EQ.'MAT_SING') THEN
        ...
        IF (NND.NE.-1) THEN
          CALL JENUNO(JEXNUM(NOMA//'.NOMNOE',NND),NOMNOE)
           VALK(1) = NOMNOE
           VALK(2) = NOMMAI
           CALL U2MESK(TYPERR,'ALGORITH5_95', 2 ,VALK)
        ELSE
      ...
      ELSEIF (ERROR(1:8).EQ.'NON_CONV') THEN
        ...
        IF (NND.NE.-1) THEN
          CALL JENUNO(JEXNUM(NOMA//'.NOMNOE',NND),NOMNOE)
           VALK(1) = NOMNOE
           VALK(2) = NOMMAI
           CALL U2MESK(TYPERR,'ALGORITH5_97', 2 ,VALK)
        ELSE
      ...
      ELSEIF (ERROR(1:13).EQ.'VECT_TANG_NUL') THEN
        ...
        IF (NND.NE.-1) THEN
          CALL JENUNO(JEXNUM(NOMA//'.NOMNOE',NND),NOMNOE)
           VALK(1) = NOMNOE
           VALK(2) = NOMMAI
           CALL U2MESK(TYPERR,'ALGORITH5_99', 2 ,VALK)
        ELSE
      ...
      ELSEIF (ERROR(1:11).EQ.'BARSOUM_NEX') THEN
        CALL JENUNO(JEXNUM(NOMA//'.NOMMAI',NMA),NOMMAI)
         VALK(1) = NOMMAI
         VALK(2) = KINF(1)
         CALL U2MESK(TYPERR,'ALGORITH6_5', 2 ,VALK)
