      SUBROUTINE XDECQU(IT,NDIM,CONNEC,JLSN,JGRLSN,IGEOM,PINTER,
...
C MODIF ALGORITH  DATE 06/07/2010   AUTEUR CARON A.CARON 
C ======================================================================
...
C           CALCUL DU POINT MILIEU DE 101-102
            CALL XMILFI(ELREFP,NDIM,NNOP,JPTINT,IGEOM,JLSN,
     &                                              IPP,R,MILFI)
            MFIS=MFIS+1
C           STOCKAGE PMILIE
