...
C       ----------------------------------------------------------------
        ...
        REAL*8          EPSI
        CHARACTER*8     MOD , NOMC(12) , NOMPAR(2)
...
C
     ...
     1                VALPAD,5,NOMC(1),MATERD(1,1),CERR(1), BL2 )
          ...
          CALL RCVALB(FAMI,KPG,KSP,'-',IMAT,' ','NADAI_B',2,NOMPAR,
     1                VALPAD, 7,NOMC(6),MATERD(1,2),  CERR(6), FB2 )
...
C
     ...
     1                VALPAF,5,NOMC(1),MATERF(1,1),CERR(1),BL2 )
          ...
          CALL RCVALB(FAMI,KPG,KSP,'+',IMAT,' ','NADAI_B',2,NOMPAR,
     1                VALPAF,7,NOMC(6),MATERF(1,2),CERR(6), FB2 )
C
C -     MATERIAU CONSTANT ?
C
        MATCST = 'OUI'
