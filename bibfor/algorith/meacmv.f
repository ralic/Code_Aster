...
C          SIMPLIFIER LA PROGRAMMATION.
     ...
     >                  CHAMEL, LIGRMO, BASE, CHVARC, CHSECH,CHSREF,
     >                  K24BID,K24BID,
...
C 3.2. ==> CAS DU CHARGEMENT TEMPERATURE, HYDRATATION, SECHAGE
      ...
      IF ( NUMCHT.GT.0 .OR. NUMVRC.GT.0 .OR. NUMCHS.GT.0 ) THEN
