     ...
     &                  VAPRIN,VAPRMO,NRGRPA,NOPASE,TYPESE,STYPSE,
     &                  LVECHN)
...
C 0.3. ==> VARIABLES LOCALES
      CHARACTER*6 NOMPRO
      PARAMETER (NOMPRO='VECHNL')
      CHARACTER*1 C1
      CHARACTER*8 LPAIN(7),LPAOUT(1),K8BID,NEWNOM,NOMCHA,NOMCHS,NOMCH2
      CHARACTER*16 OPTION
      CHARACTER*24 LIGRMO,LCHIN(7),LCHOUT(1),CHGEOM,CHCARA(15)
      INTEGER IRET,ILIRES,JLVN,IFM,NIV,EXICHA,NCHIN,I,NCHAR,JCHAR,JINF,
     &        ICHA,IBID,IRT
...
C====
      CALL JEMARQ()
      IF (TYPCAL.NE.'THER' .AND. TYPCAL.NE.'SENS') CALL UTMESS('F',
     &    NOMPRO,'TYPCAL INVALIDE')
      CALL INFNIV(IFM,NIV)
...
C INCREMENTATION DE LONUTI ET STOCKAGE DU RESULTAT
              ...
              IF (IRT.NE.0) THEN
                ZK24(JLVN-1+ILIRES) = LCHOUT(1)
                CALL JEECRA(LVECHN(1:8)//'.LISTE_RESU','LONUTI',ILIRES,
     &                      ' ')
              END IF
