...
C
      ...
      CHARACTER*19 CHMLCF
      CHARACTER*16 OPTION
      CHARACTER*19 CPOINT,CPINTE,CAINTE,CCFACE,CCOHES
      ...
      LOGICAL      CFDISL,LCTCC,LXFCM,LTFCM,LEXIP,LALLV,LXCZM
      CHARACTER*24 NOSDCO
      INTEGER      JNOSDC
C
C ----------------------------------------------------------------------
...
C
      IF(LXCZM) THEN
         CALL DISMOI('F','NOM_MAILLA',MODELE,
     &               'MODELE',IB  ,NOMA ,IBID)
         CALL DISMOI('F','NB_MA_MAILLA',MODELE,
     &               'MODELE',NBMA,K8BID,IBID)
      ENDIF
C
