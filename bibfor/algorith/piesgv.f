...
C -- LECTURE DES CARACTERISTIQUES MATERIAU
      ...
      SPT=1
      POUM='+'
      CALL RCVALB(FAMI,KPG,SPT,POUM,MAT,' ','ELAS',0,' ',0.D0,2,NOM(1),
     &            VAL(1),K2,2)
      CALL RCVALB(FAMI,KPG,SPT,POUM,MAT,' ','ENDO_SCALAIRE',0,' ',
     &            0.D0,4,NOM(3),VAL(3),K2,2)
C     NU     = VAL(2)
