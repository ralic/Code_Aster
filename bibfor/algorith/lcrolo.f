      SUBROUTINE LCROLO (FAMI,KPG,KSP,MATE,OPTION,CARCRI,
     &                    FM,DF,VIM,VIP,TAUP,DTAUDF,IRET)
...
C RESPONSABLE ADBHHVV V.CANO
      ...
      REAL*8             VIP(9),TAUP(6),DTAUDF(6,3,3)

C......................................................................
C       INTEGRATION DE LA LOI DE ROUSSELIER LOCAL
C EN GRANDES DEFORMATIONS DE TYPE NOUVELLE FORMULATION DE CANO-LORENTZ
C......................................................................
...
C OUT TAUP    : CONTRAINTE A L INSTANT ACTUEL
C OUT DTAUDF  : DERIVEE DE TAU PAR RAPPORT A DF  * TRANSPOSE(DF)
...
C ----------------------------------------------------------------------
      ...
      INTEGER IJ,K,L,INDICE
      REAL*8  INFINI,PETIT
      REAL*8  POROM,PORO,EM(6),EP(6)
...
C    CARACTERISTIQUES MATERIAU
      ...
      CALL GDCLEL(FAMI,KPG,KSP,POUM,YOUNG,NU,ALPHA)
...
C 4.6 - VALIDITE DE L'INTEGRATION
...
C 5 - INTEGRATION DE LA POROSITE EN EXPLICITE
...
C 6 - CALCUL DES CONTRAINTES

        CALL GDCLCO(EP,TAUP)

C 7 - STOCKAGE DES VARIABLES INTERNES EN T+
...
C 8 - CORRECTION DE LA LOI D'ECOULEMENT A POSTERIORI
...
C 9 - CALCUL DE LA MATRICE TANGENTE
...
C      GRANDEURS DERIVEES COMMUNES A CANO-LORENTZ
        CALL GDCLTG(DF,EP)
