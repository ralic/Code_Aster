...
C         
      CALL NMFLAL(COMPOR,METHOD,MAXDDL, OPTFLA,MOD45 ,DEFO  ,NFREQ ,
...
C
      NFREQC = NFREQ
      CALL NMOP45(MATAS2,MATGEO,DEFO  ,OPTMOD,NFREQC,BANDE ,
...
C
      IF (MOD45.EQ.'FLAM') THEN
        CALL NMIMPR('IMPR','IMPR_MODE_FLAM',' ',ZR(LJEVEU),IM)
      ELSEIF (MOD45.EQ.'VIBR') THEN
        CALL NMIMPR('IMPR','IMPR_MODE_VIBR',' ',ZR(LJEVEU),IM)
      ELSE
        CALL ASSERT(.FALSE.)
      ENDIF
C
...
C
      IF (MOD45.EQ.'FLAM') THEN
        CALL NMIMPR('IMPR','ARCH_MODE_FLAM',' ',R8BID ,NUMARC)
      ELSEIF (MOD45.EQ.'VIBR') THEN
        CALL NMIMPR('IMPR','ARCH_MODE_VIBR',' ',R8BID ,NUMARC)
      ELSE
        CALL ASSERT(.FALSE.)
      ENDIF
C
