     ...
     &           MEMASS,MASSE,AMORT,COEVIT,COEACC,LICCVG,OPTFLA)
...
C TOLE CRP_21
      ...
      CHARACTER*24 RESOCO
      CHARACTER*16 METHOD(6),CMD,CMDS
...
C -------------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ----------------
      ...
      CHARACTER*4  MOD45
      CHARACTER*8  MATEL,SYME,MRIG
      CHARACTER*16 K16BID,OPTION,SAUVMT
      CHARACTER*19 MATGEO
...
C
     ...
     &           MEMASS,MASSE,AMORT,1.D0,0.D0,0.D0,LICCVG(5))
       CMD = CMDS
      ELSE
       CALL NMMATR('FLAMBEMENT',MODELE,NUMEDD,MATE,CARELE,COMREF,COMPOR,
     &           LISCHA,MEDIRI,RESOCO,METHOD,SOLVEU,PARMET,CARCRI,
