      SUBROUTINE XMTBCA(NOMA    ,NOMO,DEFICO,RESOCO,
     &                  VALPLU,MMCVCA)
C
...
C
      INTEGER      NBPC,SINCO,IPC,IPC2,GROUP,NARET,NARET2
      ...
      CHARACTER*24  OLDGEO,DEPPLU,K24BID
      CHARACTER*16  OPTION
      LOGICAL      DEBUG
...
C
C --- ON RECUPÈRE LE NOUVEL INDICE DE CONTACT
C
