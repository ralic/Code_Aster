      SUBROUTINE DYOBSE(MAILLA,RESULT,NBINST,LISINS,NUMINI,
     &                  SDOBSE,SDSUIV)
C
...
C
C IN  NBINST : NOMBRE DE PAS DE CALCUL
...
C 
      CALL DYOBS3(MOTFAC,NBOCC ,NBINST,ZL(JSDDL),ZI(JOBSE),
     &            LISINS,NBOBSE)
      IF (NBOBSE.EQ.0) THEN 
        GOTO 999
      ENDIF
