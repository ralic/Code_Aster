...
C MODIF ALGORITH  DATE 29/01/2002   AUTEUR CIBHHPD D.NUNEZ 
C ======================================================================
...
C     VARIABLES LOCALES:
C     ------------------
      INTEGER       IAD, IADESC, IAPRNO, IAREFE, IAVALD, IAVALF,NUMNO,
     +              IAVALI, IBID, ICMP, ICOMPT, IERD, IGD, INO, IVAL, 
     +              NBEC, NBNO, NCMP, NCMPMX, NEC, NUM, 
     +              JNO,NGST,NBNO1,NBNO2,IEM,KNO,JGNAP,JNOAP,NUNOST,
     +              NUNOAP,NGAP,JGNST,NNO,JNOST,JCNSK,JCNSD,JCNSC,
     +              JCNSV,JCNSL,NOAP,NOST
      REAL*8        RDEPLA
      LOGICAL       EXISDG
      CHARACTER*1   BAS2,TSCA
      CHARACTER*8   KBID, NOMMA,KARG,NOMGD
...
C RECUPERATION DES GROUPES DE NOEUDS
     ...
     +            1,1,0,K8B,NGAP)
      IF (NGST.NE.NGAP) THEN 
        CALL UTMESS('F','DEFAPP','LES LISTES DES GROUPES DE NOEUDS  '
     +       //'A FOURNIR DOIVENT CONTENIR LE MEME NOMBRE '
...
C DEUXIEME BOUCLE POUR RECUPERER LES NUMEROS DES NOEUDS
 ...
 80     CONTINUE
      ...
      IF (NBNO1 .NE. NBNO2 ) THEN
        CALL UTMESS('F','DEFAPP',' LES LISTES DES GROUPES DE NOEUDS  '
     +       //'DOIVENT CONTENIR LE MEME NOMBRE DE  NOEUDS')
      ENDIF
C         
      NBNO = NBNO1
