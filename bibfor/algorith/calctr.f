...
C
          CALL JENONU(JEXNOM(LINT//'      .INTD.NOMS',INTF),IBID)
          CALL JEVEUO(JEXNUM(LINT//'      .INTD.LINO',IBID),'L',LLINT)
          CALL JELIRA(JEXNUM(LINT//'      .INTD.LINO',IBID),'LONMAX',
     &                NBNO,K8BID)
          CALL JEVEUO(LINT//'      .INTD.DEFO','L',LLDESC)
...
C
          CALL JENONU(JEXNOM(LINT0//'      .INTD.NOMS',INTF0),IBID)
          CALL JEVEUO(JEXNUM(LINT0//'      .INTD.LINO',IBID),'L',LLINT)
          CALL JELIRA(JEXNUM(LINT0//'      .INTD.LINO',IBID),'LONMAX',
     &                NBNO,K8BID)
          CALL JEVEUO(LINT0//'      .INTD.DEFO','L',LLDESC)
