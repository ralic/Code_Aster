      SUBROUTINE MMMBCA(NOMA  ,NEQ   ,INST  ,DEFICO,RESOCO,
     &                  DEPPLU,MMCVCA)
C
...
C
      IMPLICIT NONE
      CHARACTER*8   NOMA
      CHARACTER*24  DEFICO,RESOCO,DEPPLU
      REAL*8        INST(*)
      LOGICAL       MMCVCA
      INTEGER       NEQ
C      
...
C
      ...
      REAL*8       GEOMM(3),GEOME(3),GEOLDM(3),GEOLDE(3)
      REAL*8       NORM(3),TAU1(3),TAU2(3)
      REAL*8       DT,ASPERI,R8BID,LAMBDC
...
C
          ...
          CALL MCOPCO(NOMA  ,NEWGEO,NUMMAM,KSIPR1,KSIPR2,
     &                GEOMM)          
C            
...
C --- COORDONNEES ACTUALISEES DU POINT DE CONTACT (SUR MAILLE ESCLAVE)
C
            CALL MCOPCO(NOMA  ,OLDGEO,NUMMAE,KSIPC1,KSIPC2,
     &                  GEOLDE)        
C
C --- COORDONNEES ACTUALISEES DE LA PROJECTION DU POINT DE CONTACT
C
            CALL MCOPCO(NOMA  ,OLDGEO,NUMMAM,KSIPR1,KSIPR2,
     &                  GEOLDM)
C
