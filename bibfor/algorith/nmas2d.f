      SUBROUTINE NMAS2D(NNO,NPG,POIDSG,VFF,DFDE,DFDK,GEOM,TYPMOD,OPTION,
     &                  IMATE,COMPOR,LGPG,CRIT,INSTAM,INSTAP,TM,TP,
     &                  HYDRM,HYDRP,SECHM,SECHP,NZ,PHASM,PHASP,TREF,
     &                  DEPLM,DEPLP,EPAM,EPAP,DEFANE,SIGM,VIM,DFDI,DEF,
...
C     CALCUL DE DFDI,F,EPS,DEPS,R(EN AXI) ET POIDS
   ...
   70 CONTINUE
      ...
      CALL NMGEOM(2,NNO,AXI,GRAND,GEOM,KPG,POIDSG(KPG),VFF(1,KPG),DFDE,
     &            DUM,DFDK,DEPLM,POIDS,DFDI,F,EPS,R)

C     CALCUL DE DEPS

      CALL NMGEOM(2,NNO,AXI,GRAND,GEOM,KPG,POIDSG(KPG),VFF(1,KPG),DFDE,
     &            DUM,DFDK,DEPLP,POIDS,DFDI,F,DEPS,R)
...
C - LOI DE COMPORTEMENT
     ...
     &            TREF,HYDRGM,HYDRGP,SECHGM,SECHGP,EPS,DEPS,SIGN,
     &            VIM(1,KPG),OPTIOS,EPSANM,EPSANP,NZ,PHASM(1,KPG),
     &            PHASP(1,KPG),ELGEOM(1,KPG),SIGMA,VIP(1,KPG),DSIDEP,
     &            COD(KPG))
...
C        CALCUL DES TERMES EVALUES AUX 4 POINTS DE GAUSS
     ...
     &                 COOPG(2*KPGS)*SDEDY(KPGS)
          ...
          CALL CALSTA(TYPMOD,GAMMA,DH,DEF,NNO,KPGS,OPTION,SIG,TMP,KK,
     &                KKD,MATUU,POI2SG(KPGS),DSIDEP,JAC)
