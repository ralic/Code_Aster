      SUBROUTINE VECGME(MODELE,CARELE,MATE,CHARGE,INFCHA,INSTAP,DEPMOI,
...
C          1 - VITESSE
   ...
   30   CONTINUE
        CALL NMVGME(MODELE,LIGREL,CARELE,MATE,CHARGE,ICHA,INSTAP,RESUFV,
     &              DEPMOI,DEPDEL,VITES,ACCEL)
        DO 40 II = 1,1
