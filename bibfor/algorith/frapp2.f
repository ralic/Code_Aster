...
C              NOMBRE DE NOEUDS DU TYPE DE MAILLE
      NBNOT = 0
      DO 20 IPC = 1,NBPC
        NUMA1 = NINT(ZR(JTABF+20*(IPC-1)+1))
        NUMA2 = NINT(ZR(JTABF+20*(IPC-1)+2))
...
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(1) = COMPT(1) + 1
        ELSEIF ((NTYMA1.EQ.'SEG3') .AND. (NTYMA2.EQ.'SEG3')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(2) = COMPT(2) + 1
        ELSEIF ((NTYMA1.EQ.'SEG2') .AND. (NTYMA2.EQ.'SEG3')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(3) = COMPT(3) + 1
        ELSEIF ((NTYMA1.EQ.'SEG3') .AND. (NTYMA2.EQ.'SEG2')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(4) = COMPT(4) + 1
        ELSEIF ((NTYMA1.EQ.'TRIA3') .AND. (NTYMA2.EQ.'TRIA3')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(5) = COMPT(5) + 1
        ELSEIF ((NTYMA1.EQ.'TRIA3') .AND. (NTYMA2.EQ.'TRIA6')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          COMPT(6) = COMPT(6) + 1
C
        ELSEIF ((NTYMA1.EQ.'TRIA6') .AND. (NTYMA2.EQ.'TRIA3')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(7) = COMPT(7) + 1
        ELSEIF ((NTYMA1.EQ.'TRIA6') .AND. (NTYMA2.EQ.'TRIA6')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(8) = COMPT(8) + 1
        ELSEIF ((NTYMA1.EQ.'QUAD4') .AND. (NTYMA2.EQ.'QUAD4')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(9) = COMPT(9) + 1
        ELSEIF ((NTYMA1.EQ.'QUAD4') .AND. (NTYMA2.EQ.'QUAD8')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          COMPT(10) = COMPT(10) + 1
C
        ELSEIF ((NTYMA1.EQ.'QUAD8') .AND. (NTYMA2.EQ.'QUAD4')) THEN
C
...
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(23) = COMPT(23) + 1
        ELSEIF ((NTYMA1.EQ.'QUAD9') .AND. (NTYMA2.EQ.'QUAD8')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(24) = COMPT(24) + 1
        ELSEIF ((NTYMA1.EQ.'QUAD9') .AND. (NTYMA2.EQ.'QUAD4')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(25) = COMPT(25) + 1
        ELSEIF ((NTYMA1.EQ.'QUAD4') .AND. (NTYMA2.EQ.'QUAD9')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(26) = COMPT(26) + 1
        ELSEIF ((NTYMA1.EQ.'QUAD9') .AND. (NTYMA2.EQ.'TRIA3')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(27) = COMPT(27) + 1
        ELSEIF ((NTYMA1.EQ.'TRIA3') .AND. (NTYMA2.EQ.'QUAD9')) THEN
C
     ...
     &                ZI(JTYNMA-1+2*(IPC-1)+1))
          ...
          NBNOT = NBNOT + 0
          COMPT(28) = COMPT(28) + 1
        ELSEIF ((NTYMA1.EQ.'QUAD9') .AND. (NTYMA2.EQ.'QUAD9')) THEN
C
...
C
      ICO = 0
      DO 90 K = 1,NBTYP
        IF (COMPT(K) .EQ. 0) GOTO 90
        ICO = ICO + 1
        CALL JECROC(JEXNUM(LIGREL//'.LIEL',ICO))
        CALL JEECRA(JEXNUM(LIGREL//'.LIEL',ICO),'LONMAX',COMPT(K)+1,KBID
     &             )
...
C
        JCO = 0
        DO 80 IPC = 1,NBPC
          IF (ZI(JTYNMA-1+2*(IPC-1)+1) .NE. ITYMA) GOTO 80
          JCO = JCO + 1
          ZI(JAD-1+JCO) = -IPC
 80     CONTINUE
C
...
C
      DO 110 IPC = 1,NBPC
        ZR(JVALV-1+1) = ZR(JTABF+20*(IPC-1)+3)
        ZR(JVALV-1+2) = ZR(JTABF+20*(IPC-1)+4)
        ZR(JVALV-1+3) = ZR(JTABF+20*(IPC-1)+5)
        ZR(JVALV-1+4) = ZR(JTABF+20*(IPC-1)+6)
        ZR(JVALV-1+5) = ZR(JTABF+20*(IPC-1)+7)
        ZR(JVALV-1+6) = ZR(JTABF+20*(IPC-1)+8)
        ZR(JVALV-1+7) = ZR(JTABF+20*(IPC-1)+9)
        ZR(JVALV-1+8) = ZR(JTABF+20*(IPC-1)+10)
        ZR(JVALV-1+9) = ZR(JTABF+20*(IPC-1)+11)
        ZR(JVALV-1+10) = ZR(JTABF+20*(IPC-1)+12)
        ZR(JVALV-1+11) = ZR(JTABF+20*(IPC-1)+13)
        ZR(JVALV-1+12) = ZR(JTABF+20*(IPC-1)+14)
        IZONE = NINT(ZR(JTABF+20*(IPC-1)+15))
        ...
        ZR(JVALV-1+19) = ZR(JTABF+20*(IPC-1)+16)
        ZR(JVALV-1+20) = INST(2)
        ZR(JVALV-1+21) = ZI(JECPD+6*(IZONE-1)+6)
        ZR(JVALV-1+22) = ZR(JTABF+20*(IPC-1)+17)
        ZR(JVALV-1+23) = ZR(JTABF+20*(IPC-1)+18)
        ZR(JVALV-1+24) = ZR(JTABF+20*(IPC-1)+19)
        ZR(JVALV-1+25) = ZR(JTABF+20*(IPC-1)+20)
