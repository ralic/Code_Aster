...
C              NOMBRE DE NOEUDS DU TYPE DE MAILLE
      ...
      DO 20,IPC = 1,NBPC
        ...
        NUMA1 = NINT(ZR(JTABF+16* (IPC-1)+1))
        NUMA2 = NINT(ZR(JTABF+16* (IPC-1)+2))
...
C      -------------------------
  ...
  100 CONTINUE
      ...
      DO 110,IPC = 1,NBPC
        ZR(JVALV-1+1) = ZR(JTABF+16* (IPC-1)+3)
        ZR(JVALV-1+2) = ZR(JTABF+16* (IPC-1)+4)
        ZR(JVALV-1+3) = ZR(JTABF+16* (IPC-1)+5)
        ZR(JVALV-1+4) = ZR(JTABF+16* (IPC-1)+6)
        ZR(JVALV-1+5) = ZR(JTABF+16* (IPC-1)+7)
        ZR(JVALV-1+6) = ZR(JTABF+16* (IPC-1)+8)
        ZR(JVALV-1+7) = ZR(JTABF+16* (IPC-1)+9)
        ZR(JVALV-1+8) = ZR(JTABF+16* (IPC-1)+10)
        ZR(JVALV-1+9) = ZR(JTABF+16* (IPC-1)+11)
        ZR(JVALV-1+10) = ZR(JTABF+16* (IPC-1)+12)
        ZR(JVALV-1+11) = ZR(JTABF+16* (IPC-1)+13)
        ZR(JVALV-1+12) = ZR(JTABF+16* (IPC-1)+14)
        IZONE = NINT(ZR(JTABF+16* (IPC-1)+15))
        ZR(JVALV-1+13) = ZR(JCMCF+6* (IZONE-1)+2)
