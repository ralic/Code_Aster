...
C
     ...
     +             ITRESU,JBID,LDNEW,LLCHOL,LLINSK,LLNUEQ,LLREF,LREFE,
     +             NBMOD,NBNOT,NEQ,NNO,NUMO,IADPAR(5)
...
C
         ...
         CALL COPMOD(BASMOD,'DEPL',NEQ,PROFNO(1:14),NBMOD,ZR(IDBASE))
C
...
C
            ...
            CALL MDGEPH ( NEQ,NBMOD, ZR(IDBASE), ZR(LLCHOL), ZR(LDNEW))
...
C
         DO 20 I=1,NBMOD
            IORD = ZI(JBID+I-1)
C
C --------- REQUETTE NOM ET ADRESSE CHAMOL GENERALISE
