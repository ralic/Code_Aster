      SUBROUTINE  XCALF2(XYZ,HE,LSNG,LSTG,BASLOG,FE,DGDGL,IRET)
C
...
C
       IMPLICIT NONE
C
       REAL*8        XYZ(2),HE,LSNG,LSTG,BASLOG(6),FE(4),DGDGL(4,2)
       INTEGER       IRET
C
...
C     VERIFICATION QUE LE DETERMINANT DE P VAUT BIEN 1
      ...
      IF ((ABS(DET)-1.D0).GT.1.D-5) THEN    
        CALL UTMESS('F','XCALF2','LA BASE LOCALE SEMBLE FAUSSE')      
      ENDIF
