      SUBROUTINE XPRDOM(DNOMO,DNOMA,DCNXIN,DISFR,NOMO,NOMA,CNXINV,FISS,
...
C     DOMAINE LEVEL SETS MESH (AUXILIARY GRID)
     ...
     &              JCNLTV,JCNLNL,JCNLTL,JNOCAL,NODADJ

C     DOMAINE PHYSICAL MESH
      CHARACTER*19  TMPLSN,TMPLST
      INTEGER       JFONF,LONG,NBPTFF,NBNO,JCOOR,JNTO,NUNOPR,
     &              JTMPLT,JTMPLN,LNOFF,JNOFLA,JDIST,NODE,NUMELM,JMAI,
     &              ITYPMA,JCONX1,JCONX2,JDIME,NDIM,JAUX,JNOFL1,JDMAI
      INTEGER       ELDIM
      REAL*8        EPS,XM,YM,ZM,XI1,YI1,ZI1,XJ1,YJ1,ZJ1,XIJ,YIJ,
     &              ZIJ,XIM,YIM,ZIM,S,NORM2,XN,YN,ZN,D,DMIN
      CHARACTER*24  TMPFF,NODFLA,NODFL1,NODFL2,DISTNO
      CHARACTER*8   TYPMA

C     GENERAL PURPOSE
      INTEGER       IRET,I,J,K,IBID
      CHARACTER*8   K8B
      CHARACTER*1   K1BID
