      SUBROUTINE INSSCT (SIGR,SIGM,VIND,SCT,IMAT,NMAT,MATERF,LFISU)
...
C       -----------------------------------------------------------
        INTEGER   NMAT , IMAT , NDT , NDI ,LFISU
        REAL*8    VIND(*)
...
C       ------------------------------------------------------------
        ...
        CALL INSNAT ( SIGD, IMAT, NMAT, MATERF, SEQD , SEUILD )
        CALL INSNAT ( SIGF, IMAT, NMAT, MATERF, SEQF , SEUILF )
C
        DTAU = SEQF - SEQD
