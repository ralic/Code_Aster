      SUBROUTINE NMFOGN(NDIM,NNO1,NNO2,NPG,IW,VFF1,VFF2,
...
C
       ...
       REAL*8  SIGM(2*NDIM+1,NPG),VECT(*),DDL(*)
C ---------------------------------------------------------------------
C
C     FORC_NODA POUR GVNO (2D ET 3D)
C
