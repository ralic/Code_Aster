      SUBROUTINE XMMCVE(OPTION,NOMO  ,NOMA  ,DEPMOI,DEPDEL,
     &                  RESOCO,VEXFEE)
C
...
C OUT VEXFEE : VECT_ELEM CONTACT/FROTTEMENT METHODE CONTINUE
C
...
C
      CALL DETRSD('VECT_ELEM',VEXFEE)      
C
C --- PREPARATION DES VECTEURS ELEMENTAIRES 
C
      CALL MEMARE('V',VEXFEE,NOMO,' ',' ','CHAR_MECA')
C
