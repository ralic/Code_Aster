...
C
      ...
      INTEGER      NEWITE,RELITE,FETITE,CTCITE,MMITGO,CTCSTA
C
C ----------------------------------------------------------------------
C
...
C IN  CTCSTA : NOMBRE DE POINTS AYANT CHANGE DE STATUT DE CONTACT
C
C ----------------------------------------------------------------------
C
      CHARACTER*16 K16BLA
...
C
C --- ECRITURE CONTACT CONTINUE
C
      CALL IMPSDR(SDIMPR,'CONT_NEWT',K16BLA,R8BID ,CTCSTA)
C
      END
