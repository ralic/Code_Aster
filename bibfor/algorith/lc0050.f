...
C MODIF ALGORITH  DATE 05/09/2011   AUTEUR TARDIEU N.TARDIEU 
C ======================================================================
...
C     LECTURE DES PROPRIETES MATERIAU (MOT-CLE UMAT DE DEFI_MATERIAU)
 ...
 1002 CONTINUE
      DO 1012 I=100,NPROPS
         WRITE (NOMRES(I),'(A1,I3)') 'C',I
 1012 CONTINUE
