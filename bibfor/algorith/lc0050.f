...
C MODIF ALGORITH  DATE 26/02/2013   AUTEUR DESROCHE X.DESROCHES 
C ======================================================================
...
C ======================================================================
      ...
      REAL*8        VIM(*),STATEV(NVI)
      REAL*8        PREDEF(NPRED),DPRED(NPRED),VRCM,VRCP
      CHARACTER*8   LVARC(NPRED)
      REAL*8        DDSDDE(36),R8NNEM,DFGRD0(3,3),DFGRD1(3,3)
...
C     &'C198','C199','C200'/ FTNCHK LIMITE LE NOMBRE DE LIGNES SUITE
      ...
      DATA LVARC/'IRRA','SECH','HYDR','CORR','NEUT1','NEUT2'/
