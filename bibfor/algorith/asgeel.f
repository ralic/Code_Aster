...
C
     ...
     &             NOMSST
      CHARACTER*11 ADNOM,OPTION
      CHARACTER*24 K24BID,NOMBLO,SELIAI,SIZLIA,SST
      REAL*8       VALR,DDOT,TEMP,DIAG,COEFF
C
      INTEGER      IBID,I1,J1,K1,L1,M1,N1,LRES,LONG,NEQ,LNEQ,LPROJ,
     &             NBDDL,INDSST,LSST,LLREF,NBMACR,EXIST,
     &             LNOMCR,LIMACR,LMACR,LLMACR,INDMCR,DECAL,
     &             DDLCP,LSELIA,NLT,IND,LDCONL,IRET,NMADDL,LTEMP,
     &             JREFA,BIDON,LDLIM,NBSST,LSILIA,CEIL
