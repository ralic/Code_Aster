      SUBROUTINE GG1VIL(S,DPC,TEMP,FLUPHI,A,B,CTPS,ENER,THETA,
     *                  YOUNG,PREC,NITER,
     *                  G,DGDST,DGDEV)
...
C ======================================================================
       IMPLICIT NONE
       REAL*8   S,DPC,TEMP,FLUPHI,A,B,CTPS,ENER,YOUNG,PREC
       REAL*8   THETA
...
C     YOUNG :R: MODULE DE YOUNG (ELASTIQUE)
...
C        DE LA FLUENCE (PROJET PACHYDERME) EN 1D
