      SUBROUTINE NMDOET(RESULT,MODELE,COMPOR,CARELE,INSTAM,
...
C RESPONSABLE MABBAS M.ABBAS
      ...
      CHARACTER*24 DEPMOI,SIGMOI,VARMOI,VARDEM,LAGDEM,DEPOLD,NUMEDD
      CHARACTER*14 PILOTE
      INTEGER      NEQ
...
C
      CHARACTER*6 NOMPRO
      PARAMETER ( NOMPRO = 'NMDOET' )
C
      LOGICAL LBID,EVONOL,PILOT
      INTEGER N1,N2,REENTR,NOCC,NUME,NCHOUT,JINST,IRET,IBID,I
      INTEGER NBR,NRPASE,IAUX,JAUX, IER
      REAL*8 PREC,R8VIDE,RBID,INST
      COMPLEX*16 CBID
      CHARACTER*8 LPAIN(1),LPAOUT(2),CRITER,K8BID
      CHARACTER*8 NOPASE
      CHARACTER*16 OPT,TYPPIL,SELPIL
      CHARACTER*24 LIGRMO,LIGRDE,EVOL,LCHIN(1),LCHOUT(2),TYPE
      CHARACTER*24 VALK(2)
      CHARACTER*24 CHAMP,CHAMP2,CHGEOM,RESUID,STRUCT,K24BID,DEP2,DEP1
      INTEGER      JDEP1,JDEP2,JDEPOL
      DATA  DEP1 /'&&NMDOET.DEPL1'/
      DATA  DEP2 /'&&NMDOET.DEPL2'/
...
C -- DERNIERS DEPALCMENTS POUR QUE C AMARCHE (CHAMP DEPOLD)
...
C -- LECTURE DES DEPLACEMENTS (OU DERIVE)
          ...
          IF (PILOT) THEN
            CALL VTCREB(DEP1,NUMEDD,'V','R',NEQ)          
            CALL VTCREB(DEP2,NUMEDD,'V','R',NEQ) 
