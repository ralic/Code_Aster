...
C OUT LVIT0E : .TRUE. SI VITESSE DONNEE PAR VITE_INI (POUR ENERGIES)
...
C
      DO 30 ICHAM  = 1,NBCHAM
        ...
        IF (NOMCHS.EQ.'VITE') THEN
          ...
          ELSE IF (.NOT.EVONOL) THEN
C LA VITESSE EST DONNEE PAR VITE_INI. POUR LE CALCUL DES ENERGIES,
C EN PRESENCE D AMORTISSEMENT, IL EST NECESSAIRE DE CREER UNE FORCE
C D AMORTISSEMENT INITIALE.
            LVIT0E = .TRUE.
          ENDIF
        ENDIF
