        SUBROUTINE ONOFSX ( SIG , X1, X2, X3, X4, X5, I4, DDFDSX )
...
C ======================================================================
C       ----------------------------------------------------------------
C       DERIVEE /S /X DE LA NORMALE A LA FONCTION SEUIL
C                      A (SIG,X1,X2,X3,X4,X5)
...
C       ----------------------------------------------------------------
        ...
        REAL*8          DDFDSX(6,6) , DFDS2(6,6), X3(6), X4(6), X5(6)
        REAL*8          I4(6,6)
        REAL*8          LCNRTS
C       ----------------------------------------------------------------
        COMMON /TDIM/   N , ND
