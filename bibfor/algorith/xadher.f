      SUBROUTINE XADHER(P,SAUT,LAMB1,CSTAFR,CPENFR,ALGOFR,
...
C RESPONSABLE GENIAUT S.GENIAUT
      ...
      INCLUDE 'jeveux.h'
      INTEGER   ALGOFR
      REAL*8    P(3,3),SAUT(3),LAMB1(3),CSTAFR,CPENFR,PBOUL(3)
...
C IN    CSTAFR       : COEFFICIENT DE REGULARISATION DE FROTTEMENT
...
C                       DIVISÉ PAR L'INCRÉMENT DE TEMPS
C IN    ALGOFR      : FORMULATION POUR LE FROTTEMENT
...
C OUT   ADHER       : STATUT D'ADHERENCE
      ...
      REAL*8     PREC,NORME,XAB(3,3),GT(3)
