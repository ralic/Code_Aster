...
C
      ...
      INTEGER      JBID,II,JJEUIN,JNORMO,JNRINI,JREFA
      ...
      INTEGER      ITBLOC
      INTEGER      JSCDI,JSCHC,JSCBL,JSCIB,JSCDE
...
C --- CETTE MATRICE EST SYMETRIQUE PLEINE
C ----------------------------------------------------------------------
...
C --- CREATION SCHC
      CALL WKVECT (STOC//'.SCHC','V V I',NEQU,JSCHC)
      DO 5 II = 1, NEQU
         ZI(JSCHC+II-1) = II
 5    CONTINUE
C --- CREATION SCDI
      CALL WKVECT (STOC//'.SCDI','V V I',NEQU,JSCDI)
      DO 6 II = 1, NEQU
...
C --- CREATION .SCIB
      CALL WKVECT(STOC//'.SCIB','V V I',NEQU,JSCIB)
      ICOMPT = 0
      DO 210 I = 1,NBLC
