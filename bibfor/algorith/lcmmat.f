        SUBROUTINE LCMMAT (COMP,MOD,IMAT,NMAT,TEMPD,TEMPF,IMPEXP,
...
C
      ...
      CALL R8INIR(5*24*24, 0.D0, HSR, 1)
...
C        COEFFICIENTS MATERIAUX LIES A L'ECROUISSAGE ISOTROPE
         ...
         CALL LCMAEI(NMATER,IMAT,NECRIS,NECOUL,NBVAL,1,NOMPAR,
     &            IMPEXP,VALPAD,VALRES,NMAT,HSR,IFA,NOMFAM,NBSYS)
         NVINI=NBCOMM(IFA,3)
         DO 503 I=1,NBVAL
            MATERD(NVINI-1+I,2)=VALRES(I)
 503     CONTINUE
...
C     ON STOCKE A LA FIN LE NOMBRE TOTAL DE COEF MATERIAU
 ...
 505     CONTINUE
         ...
         CALL LCMAEI(NMATER,IMAT,NECRIS,NECOUL,NBVAL,1,NOMPAR,
     &       IMPEXP,VALPAF,VALRES,NMAT,HSR,IFA,NOMFAM,NBSYS)
         NVINI=NBCOMM(IFA,3)
         DO 506 I=1,NBVAL
            MATERF(NVINI-1+I,2)=VALRES(I)
 506     CONTINUE
