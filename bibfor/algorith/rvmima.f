...
C
      INTEGER      IBID, N1, NP, NC, IRET, I12
      ...
      COMPLEX*16   C16B
      CHARACTER*8  K8B, CRIT, RESU, MAMAX, NOMAX, MAMIN, NOMIN, TYCH
      CHARACTER*8  MAAMAX, NOAMAX, MAAMIN, NOAMIN
      CHARACTER*8  CPMAX, CPMIN, CPAMAX, CPAMIN
      CHARACTER*16 NOMCMD, NOMCHA, VALK(9), INTITU
...
C
         ELSE
            CALL UTMESS('F',NOMCMD,'ON NE SAIT PAS POST-TRAITER'//
     +                            ' LE CHAMP DE TYPE: '//TYCH )
         ENDIF
         GOTO 9999
      ENDIF
C
...
C
      ...
      IF (IRET.EQ.10) THEN
         CALL UTMESS('F',NOMCMD,'LE RESULTAT '//RESU//
     +                ' N''EXISTE PAS')
      ENDIF
      IF (IRET.NE.0) THEN
