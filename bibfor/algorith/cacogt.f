...
C **********************************************************************
     ...
     &               P2M, T, DT,PHI0,J1,J2,J3, BT,DF,DC,RDBTDT,RDBTP1,
     &                     RDBTP2,PHI)
            J1D= BT*J1
C            J1F=0.D0
C            J1C=0.0D0 
...
C         CALCUL DE DEGRE DE SATURATION ET SES DERIVEES
            CALL STATSR(IMATE,MECA,ADCOME,CONGEM,DIMCON,P1M,P2M,T,DT,
     &                   SAT,G1,G2,G3)
              G1D= BT*G1
C              G1F= 0.D0
C              G1C= 0.D0
...
C            J1C=0.0D0 
            ...
            J1C=DC*J1 
C         CALCUL DE DEGRE DE SATURATION ET SES DERIVEES
            CALL STATSR(IMATE,MECA,ADCOME,CONGEP,DIMCON,P1,P2,T,DT,
     &                   SAT,G1,G2,G3)
              G1D= BT*G1
C              G1F= 0.D0
C              G1C= 0.D0
