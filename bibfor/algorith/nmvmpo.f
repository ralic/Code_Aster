...
C MODIF ALGORITH  DATE 06/05/2003   AUTEUR CIBHHPD D.NUNEZ 
C ======================================================================
...
C
      ...
      REAL*8 EPS4(6),DEPS4(6),SIGM4(6),SIGP4(6),VIP7(7),VIM7(7)
...
CJMP        IF ( INT(CARCRI(6)).EQ.1) THEN
        IF ( INT(CARCRI(6)).GT.0.5D0) THEN
           CALL NMVMPK(KP,NC,XL,EPS,DEPS,VIM,SIGM,LOI346,HOEL,
...
554         CONTINUE
            ...
            CALL NMVMPI(EPS4,DEPS4,VIM7,SIGM4,L346P,
