...
C NOUVELLE CONVENTION POUR LES LIGRELS FILS, GESTTION DE NOMS
C ALEATOIRES
C         SOLFEB=SOLFET(1:11)//NOMSD(1:8)
          CALL GCNCON('.',K8BID)
          K8BID(1:1)='F'
...
C --------------------------------------------------------------
     ...
     &  RESIRE,TBLOC,NPREC,NMAXIT,ISTOP,NIREMP,IFM,NIV,0,NBMA,
     &  VERIF,TESTCO,NBREOR,TYREOR,SCALIN,INUMSD,IMAIL,K8BID)
