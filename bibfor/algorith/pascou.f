...
C IN  CARELE  : ADRESSE DU CHAMP DE CARACTERISTIQUES ELEMENTAIRES
C ----------------------------------------------------------------------
C
...
C
      ...
      LOGICAL   EXIGEO,BOONEG,BOOPOS,EXICAR
      CHARACTER*6 NOMPRO
      CHARACTER*8  K8BID,MO,LPAIN(3),LPAOUT(1),STOCFL
      CHARACTER*19 CHAMS,LISINS
      CHARACTER*24 CHGEOM,LIGREL,LCHIN(3),LCHOUT(1),CHCARA(15)
        ...
        DO 20 I=1,NBDT
          IF (ZR(JPAS-1+I).GT.DTCOU) THEN
            IF (STOCFL(1:3).EQ.'OUI') THEN
              CALL U2MESS('F','ALGORITH9_77')
            ELSE
              CALL U2MESS('A','ALGORITH9_77')
            ENDIF
          ENDIF
 20     CONTINUE

      ELSEIF (STOCFL(1:3).EQ.'OUI') THEN
        CALL U2MESS('F','ALGORITH9_79')
      ELSEIF (STOCFL(1:3).EQ.'NON') THEN
          CALL U2MESS('A','ALGORITH9_79')
      ENDIF
