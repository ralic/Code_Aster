...
C IN  DEPL    : DEPLACEMENT A PARTIR DE LA CONF DE REF
C IN  LDFDI   : VEUT-ON CALCULER DFDI ET POIDS
C OUT POIDS   : "POIDS" DU POINT DE GAUSS
...
C......................................................................
C REMARQUE CONCERNANT L'ARGUMENT LDFDI :
C  NMGEOM EST PARFOIS APPELE 2 FOIS DE SUITE AVEC U ET DELTA_U (PAR
C  EXEMPLE DANS NMPL3D). COMME LE CALCUL DE DFDM3D EST COUTEUX ET QU'IL
C  EST INDEPENDANT DE U, ON PEUT ECONOMISER LE 2EME CALCUL EN UTILISANT
C  L'ARGUMENT LDFDI : 1ER APPEL .TRUE. ; 2EME APPEL .FALSE.
C
C
      LOGICAL TRIDIM
      INTEGER I,J,K,N
