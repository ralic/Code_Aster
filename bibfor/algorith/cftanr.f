      SUBROUTINE CFTANR(NOMA  ,NDIMG ,DEFICO,IZONE ,POSNOE,
     &                  TYPENM,POSENM,NUMENM,KSI1  ,KSI2  ,
...
C
     ...
     &              ITYPEM,VECTOR,K24BID,LBID)
        ...
        ENDIF
        CALL CFNORS(NOMA  ,DEFICO,POSMAM,TYPENM,NUMENM,
...
C
     ...
     &              ITYPEE,VECTOR,K24BID,LBID)
        ...
        CALL CFNORS(NOMA  ,DEFICO,POSMAE,TYPENM,NUMENM,
