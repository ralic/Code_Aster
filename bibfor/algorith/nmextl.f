...
C                'MINI_ABS' VALEUR MINI EN ABSOLU SUR TOUTES LES
C                          MAILLES/NOEUDS
C                'MAXI_ABS' VALEUR MAXI EN ABSOLU SUR TOUTES LES
C                          MAILLES/NOEUDS
...
C
      ...
      IF (TYPCHA.EQ.'NOEU') THEN
        CALL GETVTX(MOTFAC,'NOEUD'    ,IOCC,IARG,0,K8BID,N1    )
        CALL GETVTX(MOTFAC,'GROUP_NO' ,IOCC,IARG,0,K8BID,N2    )
        CALL GETVTX(MOTFAC,'MAILLE'   ,IOCC,IARG,0,K8BID,N3    )
        CALL GETVTX(MOTFAC,'GROUP_MA' ,IOCC,IARG,0,K8BID,N4    )
        CALL GETVTX(MOTFAC,'TOUT'     ,IOCC,IARG,1,OUI  ,N5    )
...
C --- TYPE D'EXTRACTION
C
      CALL GETVTX(MOTFAC,'EVAL_CHAM' ,IOCC,IARG,1,EXTRCH,N6    )
      IF (N6.EQ.0) THEN
        EXTRCH = 'VALE'
