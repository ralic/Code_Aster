...
C ----------------------------------------------------------
     ...
     &             IMSMI,REACRE,REACR1,IMSMK
      ...
      CHARACTER*8  RENUM,PRECO,K8BID,VERIF
      ...
      CHARACTER*19 SOLFEB
      CHARACTER*24 SDFETI,MASD,INFOFE,K24BID
      LOGICAL      TESTOK
      INTEGER      IARG
C------------------------------------------------------------------
      CALL JEMARQ()
...
C         -----------------------------------------------------------
     ...
     &                TESTC1,NBREO1,TYREO1,SCALI1,INUMSD,IMAIL,
   ...
   50 CONTINUE
     ...
     &            TESTCO,NBREOR,TYREOR,SCALIN,INUMSD,IMAIL,INFOFE,
