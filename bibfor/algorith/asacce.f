      SUBROUTINE ASACCE(NOMSY,MONOAP,NBSUP,NSUPP,NEQ,NBMODE,
     +                  ID,NUME,VECMOD,PARMOD,ASSPEC,
     +                  NOMSUP,REASUP,ZRCREP)
      IMPLICIT  REAL*8 (A-H,O-Z)
      INTEGER           NSUPP(ID)
      REAL*8            VECMOD(NEQ,*),PARMOD(NBMODE,*),ASSPEC(NBSUP,*),
     +                  REASUP(NBSUP,NBMODE,*),ZRCREP(NBSUP,NEQ,*)
      CHARACTER*(*)     NOMSY,NUME,NOMSUP(NBSUP,*)
      LOGICAL           MONOAP
C     ------------------------------------------------------------------
