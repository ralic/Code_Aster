      SUBROUTINE  XRIGEL(NNOP,IPOIDS,IVF,DDLH,NFE,DDLC,IGEOM,
     &                  TYPMOD,NOMTE,LGPG,
     &                  PINTT,CNSET,HEAVT,LONCH,BASLOC,
     &                  LSN,LST,SIG,MATUU,CODRET)

       IMPLICIT NONE
       INTEGER      NNOP,LGPG,CODRET,IPOIDS,IVF,IGEOM
       INTEGER      DDLH,NFE,DDLC,CNSET(4*32),HEAVT(36),LONCH(7)
       CHARACTER*8  TYPMOD(*)
       CHARACTER*16 NOMTE
...
C         DEBUT DE LA ZONE MEMOIRE DE SIG CORRESPONDANTE
     ...
     &                  LSN,LST,SIG(IDEBS+1),IDECPG,MATUU,CODRET)
          ...
          ELSEIF (NDIM.EQ.2) THEN
            ...
            CALL XRIGE2(ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,
     &                  NFE,BASLOC,NNOP,NPG,TYPMOD,LGPG,
     &                  LSN,LST,SIG(IDEBS+1),IDECPG,MATUU,CODRET)
