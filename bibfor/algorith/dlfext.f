...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      INTEGER J2ND1,JAUX,JCHAR,JSTD
      REAL*8 PARTPS(3), R8PREM,R8BID
...
C IL FAUT UTILISER DANS CE CAS : TYPCAL = 'DYNM' + 'MECA'
...
C
     ...
     &                   VECHMP )
       ...
       CALL R8COPY(NEQ,ZR(J2ND1),1,F,1)
