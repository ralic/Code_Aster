...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      LOGICAL SECAL
      INTEGER JINF,JTT,LONCH,IF1,IF2,JCN1,JJ,NUMCHT,TYPESE
      INTEGER IRET,INEW,IEQ
...
C 2.2.1 ==>
          ...
          IF (NUMCHT.GT.0) THEN
            ...
            CALL VECTME(MODELE,LISCHA,CARELE,MATE,K24BID,COM,VECEL1)
          END IF
...
C VAPRIN : CHAMP DE DEPL A L INSTANT T (JSTD = 0 ET JAUX = 4)
     ...
     &                R8BID,VAPRIN,K24BID,CHVARC,K24BID,LIGRMO,NOPASE,
     &                VECHMP)
