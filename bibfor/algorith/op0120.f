...
C           --- CREATION DE L'OBJET NOMCOD//'.PROL' ---
          ...
          CHPROL = NOMCOD//'.PROL'
          CALL WKVECT ( CHPROL, 'G V K8', 5, LPROL )
          ZK8(LPROL  ) = 'FONCT_C '
          ZK8(LPROL+1) = 'LIN LIN '
          ZK8(LPROL+2) = 'FREQ    '
          ZK8(LPROL+3) = 'DSP     '
...
C 
      ...
      IF ( NIV .GE. 2 ) THEN
         ...
         IF (NFCOD.NE.NBF1) CALL UTMESS('F','OP0120','Y A UN BUG 1' )
...
C
      CALL TITRE
C
      CALL JEDETR('&&OP0120.TEMP.VALE')
      CALL JEDETR('&&OP0120.TEMP.VALC')
      CALL JEDETR('&&OP0120.TEMP.LFON')
      CALL JEDETR('&&OP0120.TEMP.LINT')
      CALL JEDETR('&&OP0120.TEMP.LSSX')
      CALL JEDETR('&&OP0120.TEMP.LRMS')
C
