     ...
     &                  CARCRI,NUMEDD,COMREF,SDTIME,DEFICO,
     &                  RESOCO,PARCON,INSTAM,INSTAP,VALINC,
     &                  SOLALG,SDDYNA,SDSENS,LSENS ,NRPASE,
     &                  OPTION,VECELE)
C
...
C
      ...
      CHARACTER*24  SDSENS,COMREF,SDTIME
      INTEGER       NRPASE
