...
C DECLARATION PARAMETRES D'APPELS
      INTEGER      IFM,NITER,NBI,NBREOR,DIMGI,IPIV,NBSD,IFETF,IFETH,
     &             IREX,IPRJ,IR2,IFIV,RANG,NBPROC
      LOGICAL      LRIGID,LSTOGI
      CHARACTER*19 SDFETI,MATAS
      CHARACTER*24 INFOFE,NOMGGT,NOMGI
...
C DECLARATION VARIABLES LOCALES
     ...
     &             ITEST2,ITEST3,ITEST4,ITEST5,ITEST6,ITEST7,ITEST8,
     &             IPNTR(14),LONWL
      REAL*8       TOL
      CHARACTER*24 K24B
      LOGICAL      LPARA
...
C NIVEAU D'IMPRESSION ARPACK
   ...
   31   CONTINUE
     ...
     &       NOMGGT,LRIGID,DIMGI,1,SDFETI,IPIV,NBSD,ZI(IFETF),ZI(IFETH),
     &       MATAS,NOMGI,LSTOGI,INFOFE,IREX,IPRJ,NBPROC,RANG,K24B)
          CALL FETFIV(NBSD,NBI,ZR(ITEST7),ZR(IR2),ZR(ITEST8),MATAS,
     &     ZI(IFETF),ZI(IFETH),INFOFE,IREX,IFIV,NBPROC,RANG,K24B,SDFETI)
          CALL FETPRJ(NBI,ZR(ITEST8),ZR(ITEST2+IPNTR(2)-1),
     &       NOMGGT,LRIGID,DIMGI,1,SDFETI,IPIV,NBSD,ZI(IFETF),ZI(IFETH),
     &       MATAS,NOMGI,LSTOGI,INFOFE,IREX,IPRJ,NBPROC,RANG,K24B)
          GOTO 31
        ELSE IF (IDO.EQ.2) THEN
          CALL DCOPY(NBI4,ZR(ITEST2+IPNTR(1)-1),1,ZR(ITEST2+IPNTR(2)-1),
     &              1)
          GOTO 31
        ENDIF
