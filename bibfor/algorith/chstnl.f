     ...
     &                    COMPLU, DEPMOI, DEPDEL, SIGMOI, VERESI,
...
C TOLE CRP_21
     ...
     &             DEPMOI, DEPDEL, SIGMOI, VERESI, COMPLU,
     &             VECCHA, VITES, ACCEL
...
1     CONTINUE
      CALL UTMESS('F','CHSTNL','CHARGE NON TRAITEE: '//CHAINE )
C
2     CONTINUE
...
C
50    CONTINUE
      CALL VELAME (MODELE,CHARGE,INFCHA,INSTAP,DEPMOI,DEPDEL,VECELE)
