      SUBROUTINE RKDCFC( MOD,  NVI,   VINI,  COEFT, E,
...
C MODIF ALGORITH  DATE 08/09/98   AUTEUR CIBHHLV L.VIVAN 
C ======================================================================
...
C ======================================================================
C       ---------------------------------------------------------------
C     POLY_CFC  : RELATION DE COMPORTEMENT POLYCRISTALLIN (PILVIN)
C                  A 13 PARAMETRES
