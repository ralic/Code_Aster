...
C ======================================================================
C       ----------------------------------------------------------------
C  BETON_DOUBLE_DP : NOMBRE DE COMPOSANTES DES CONTRAINTES ET
C                    NOMBRE VARIABLES
C       ----------------------------------------------------------------
...
C - C_PLAN
        ELSE IF (MOD(1:6).EQ.'C_PLAN')THEN
           ...
           NR  = NDT+2
           NVI = 4
           CALL UTMESS('F','BETNVI','BETON_DOUBLE_DP: LE CAS DES '
     &     //'CONTRAINTES PLANES N ESP PAS TRAITE POUR CE MODELE.')
C - 1D
