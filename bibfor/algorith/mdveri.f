...
C
      IF (METHOD(1:4).EQ.'ITMI') THEN
        ...
        IF (NBASFL.EQ.0) THEN
          CALL U2MESS('E','ALGORITH5_69')
        ENDIF
C
        CALL GETVR8('INCREMENT','PAS',1,1,0,R8BID,NPAS)
        IF (NPAS.EQ.0) THEN
          CALL U2MESS('E','ALGORITH5_70')
        ENDIF
C
