...
C
      ...
      CALL UTMESS('E','MDVERI','ALGORITHME DE DEVOGE: DEVELOPPEMENT'//
     +                         ' "AMOR_GENE" NON IMPLANTE.')
      ENDIF
      IF (NAGEN.EQ.0 .AND. NARED.EQ.0 .AND. METHOD(1:4).EQ.'ITMI') THEN
      CALL UTMESS('E','MDVERI','ALGORITHME ITMI : IL FAUT RENSEIGNER '//
...
C
      IF (METHOD(1:4).EQ.'ITMI') THEN
        ...
        IF (NBASFL.EQ.0) THEN
          CALL UTMESS('E','MDVERI','ALGORITHME ITMI : IL FAUT '//
...
C
        ...
        IF (OUINON(1:3).EQ.'OUI') THEN
          ...
          IF (NTS.EQ.0) THEN
          CALL UTMESS('E','MDVERI','ALGORITHME ITMI : LORSQUE L ON '//
...
C
      ...
      IF ( NBREDE .NE. 0 ) THEN
       ...
       CALL UTMESS('E','MDVERI','ALGORITHME DE NEWMARK: DEVELOPPEMENT'//
...
C
 ...
 20   CONTINUE
      ...
      CALL UTMESS('E','MDVERI', 'MAUVAISE DEFINITION DE L EXCITATION '//
