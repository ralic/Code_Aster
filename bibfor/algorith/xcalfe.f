...
C----------------------------------------------------------------
      ...
      REAL*8    RG,TG,DGDPO(4,2),DGDLO(4,3),R8PREM,DET
...
C     VÉRIFICATION QUE LE DÉTERMINANT DE P VAUT BIEN 1
     ...
     +    - P(2,1)*P(1,2)*P(3,3) - P(1,1)*P(3,2)*P(2,3) 
      ...
      IF (ABS(DET-1.D0).GT.1.D-3) THEN    
        CALL UTMESS('A','XCALFE','LA DISCRETISATION DU FOND DE '//
     &              'FISSURE EST GROSSIERE PAR RAPPORT A LA COURBURE '//
     &              'DU FOND DE FISSURE. POSSIBILITE DE RESULTATS '//
     &              'FAUX. IL FAUDRAIT RAFFINER LE MAILLAGE AUTOUR '//
     &              'DU FOND DE FISSURE.')      
      ENDIF
