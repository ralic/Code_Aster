...
C      
      ...
      LOGICAL      LEXGE,LCTCC,LMUAP,REAROT,LEXPL,LMPAS,LHHTC
...
C     
      CALL NDPRED(NUMINS,SDSENS,SDDYNA,VALMOI,VALPLU,
     &            POUGD ,SOLALG)       
C
...
C     
     ...
     &                    COEEQU
      ...
      ENDIF    
C
C --- COEFFICIENTS DEVANT MATRICE POUR TERME DE RAPPEL DYNAMQIUE
C
      IF (LTHETA) THEN
        IF (LVITE) THEN
          COERMA = ZERO
