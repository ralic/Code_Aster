      SUBROUTINE LCBARE(MATE,OPTION,SU,TM,TP,SIGMA,DSIDEP,VIM,VIP)
...
C-----------------------------------------------------------------------
      ...
      REAL*8 SIGMAC,K,LAMBDA,VALRES(3),UMAX,KP,VALPA,TM,TP
...
C RECUPERATION DES PARAMETRES PHYSIQUES :
      ...
      VALPA=TP
      ENDIF
       CALL RCVALA(MATE,' ','RUPT_FRAG',1,'TEMP',VALPA,3,
