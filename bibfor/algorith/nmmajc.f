...
C
      LOGICAL      ISFONC,NDYNLO,LGROT,LDYNA,LSTAT,LEXPL
      LOGICAL      LEXGE,LTCHA
...
C
      ...
      IF (LDEPL) THEN
        IF (LSTAT) THEN
          CALL NMMAJI(NUMEDD,LGROT ,SDNUME,COEFPR,DEPDEL,
     &                DDEPLA,DEPDEL)
          CALL NMMAJI(NUMEDD,LGROT ,SDNUME,COEFPR,DEPPLU,
     &                DDEPLA,DEPPLU)
        ENDIF   
      ELSEIF (LVITE) THEN
        CALL NMMAJI(NUMEDD,LGROT ,SDNUME,COEFPR,VITDEL,
     &              DVITLA,VITDEL)
        CALL NMMAJI(NUMEDD,LGROT ,SDNUME,COEFPR,VITPLU,
     &              DVITLA,VITPLU)           
      ELSEIF (LACCE) THEN
        IF (LEXPL) THEN
          CALL COPISD('CHAMP_GD','V',DACCLA,ACCPLU) 
        ELSE 
          CALL NMMAJI(NUMEDD,LGROT ,SDNUME,COEFPR,ACCDEL,
     &                DACCLA,ACCDEL)
          CALL NMMAJI(NUMEDD,LGROT ,SDNUME,COEFPR,ACCPLU,
     &                DACCLA,ACCPLU)         
        ENDIF         
      ELSE
        CALL ASSERT(.FALSE.)
