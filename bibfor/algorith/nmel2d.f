       SUBROUTINE  NMEL2D(FAMI,POUM,NNO, NPG, IPOIDS, IVF, IDFDE,
...
C - LOI DE COMPORTEMENT : S(E) ET DS/DE
        ...
        CALL NMCPEL(FAMI,KPG,1,POUM,2,TYPMOD,ANGMAS,IMATE,COMPOR,CRIT,
