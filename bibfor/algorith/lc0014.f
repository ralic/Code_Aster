      SUBROUTINE LC0014(FAMI,KPG,KSP,NDIM,IMATE,COMPOR,CRIT,INSTAM,
     &              INSTAP,EPSM,DEPS,SIGM,VIM,OPTION,ANGMAS,SIGP,VIP,
     &                  TAMPON,TYPMOD,ICOMP,NVI,DSIDEP,CODRET)
      IMPLICIT NONE
      INTEGER            KPG,KSP,NDIM,IMATE,IRET,CODRET
      CHARACTER*(*)      FAMI
      CHARACTER*8        TYPMOD(*)
      CHARACTER*16       COMPOR(*),OPTION
      INTEGER            ICOMP,NVI
      REAL*8             ANGMAS(*),TAMPON(*)
      REAL*8             INSTAM,INSTAP,CRIT(*)
...
C ======================================================================
     ...
     &            EPSM,DEPS,VIM,VIP,SIGP,DSIDEP,IRET)
      END
