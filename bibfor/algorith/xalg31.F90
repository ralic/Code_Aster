subroutine xalg31(ndim, elrefp, nnop, it, nnose,&
...
!
    ...
    real(kind=8) :: milfa(3)
    real(kind=8) :: geom(81)
    real(kind=8) :: pmiref(8*ndime), ksia(ndime), ksib(ndime)
    integer :: n(3)
    integer :: i, ipm, k, ino
    integer :: noeua
    integer :: j, r, a2, a3, ip1(4), ip2(4), nbpi
...
500 continue
!
    ASSERT(ipm.eq.8.and.mfisloc.eq.3)
!
    nmilie = ipm
    mfis=mfis+mfisloc
!
