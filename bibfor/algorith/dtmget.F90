...
! command DYNA_VIBRA//TRAN/GENE
!
!  sd_dtm_ [Obl]: Name of the dtm data structure requested [K24]
...
!     according to the sd_dtm_ data structure's map
!
! Examples : call dtmget('&&OP0074', RESU_IN, kscal=resu)
!
!            call dtmget('&&OP0074', NOM_CMP, iocc=2, lonvec=nbcmp)
