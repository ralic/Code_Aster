...
C ......................................................................
      ...
      CHARACTER*8 LPAIN(14),LPAOUT(1),REPK,KBID
      CHARACTER*16 OPTION
      CHARACTER*24 CHGEOM,CHFOND,CHTEMP,CHTREF,CHPULS
...
C- RECUPERATION DE L'ETAT INITIAL
      ...
      IF (INIT.NE.0) THEN
        CALL UTMESS('F','MEMOKG','CALC_K_G : CHAMP INITIAL IMPOSSIBLE')
      END IF

C- RECUPERATION (S'ILS EXISTENT) DES CHAMP DE TEMPERATURES (T,TREF)

      TEMPE = ' '
      CHTEMP = '&&MEMOKG.CH_TEMP_R'
      DO 10 I = 1,NCHAR
