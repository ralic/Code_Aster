...
C   UN ASSEMBLAGE EN QUATRE TEMPS (ADAPTE AU CYCLIQUE)
C
C-----------------------------------------------------------------------
C
...
C
      CALL AMPCPR(CMAT,NDIM,NDIM,ZR(LLOB),NOBL,NOBC,IDEB,JDEB,ABET,1,1)
      CALL AMPCPR(CMAT,NDIM,NDIM,ZR(LLOB),NOBL,NOBC,IDEB,JDEB,BBET,2,1)
      CALL AMPCPR(CMAT,NDIM,NDIM,ZR(LLOB),NOBL,NOBC,JDEB,IDEB,ABET,1,-1)
      CALL AMPCPR(CMAT,NDIM,NDIM,ZR(LLOB),NOBL,NOBC,JDEB,IDEB,-BBET,
     &2,-1)
C
      ENDIF
C
