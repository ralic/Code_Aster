      SUBROUTINE ALGOCU(DEFICU,RESOCU,LMAT,LDSCON,NOMA,CINE,RESU,
     &                  DEPTOT)
C
...
C
      ...
      CHARACTER*24 APCOEF,APJEU,APDDL,COEFMU
      INTEGER      JAPCOE,JAPJEU,JAPDDL,JCMU
      CHARACTER*24 POINOE,DIMECU
      INTEGER      JPOI,JDIM
      CHARACTER*19 LIAC,MU,DELT0,DELTA,CM1A,COCO,ATMU
      INTEGER      JLIAC,JMU,JDELT0,JDELTA,JCM1A,JCOCO,JATMU
...
C 
         CALL CUPIVO(XJVMAX,INDIC,NBLIAC,AJLIAI,SPLIAI,SPAVAN,
     &               NOMA,DEFICU,RESOCU)
C
