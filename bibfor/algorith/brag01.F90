...
!          PW BRANCHï¿½SUR LES 2 AMORTISSEURS SPHï¿½IQUES, 2CAS DE
...
!    CORREC 23/9/04 AS INTï¿½RATIONDE L' ENDOMMAGEMENT DE FLUAGE ET
...
!     XMAT00  CONSTANTES DU MATï¿½IAUX DANS L'ORDRE DES Dï¿½LARATIONS
