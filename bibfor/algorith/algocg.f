      SUBROUTINE ALGOCG(DEFICO,RESOCO,LMAT  ,NOMA  ,CNCINE,
     &                  RESU  ,CTCCVG)
C     
...
C
      ...
      CHARACTER*19 LIAC,MU,DELTA,COCO,ATMU,SGRADM,SGRADP
      ...
      CHARACTER*24 METHCO,SECMBR,DELTAU
      COMPLEX*16   C16BID
...
C     SECOND MEMBRE ET VECTEUR NUL
      ...
      CALL COPISD('CHAMP_GD','V',CNCINE,SECMBR)
      CALL COPISD('CHAMP_GD','V',CNCINE,DELTAU)
      CALL COPISD('CHAMP_GD','V',CNCINE,VEZERO)
...
C ======================================================================
     ...
     &              ZR(JRESU),VAL)
        IF (ZR(JAPJEU+ILIAI-1).NE.R8VIDE()) THEN
