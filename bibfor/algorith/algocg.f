...
C
      ...
      INTEGER JNOCO,JMACO,JSECMB,JVEZER,JMUM,JVECC
      ...
      REAL*8 NUMER,DENOM,NINF,ALPHA,EPSI,R8BID,GAMMA,NUMER2,EPSIPC,RBID
      CHARACTER*2 TYPEC0
      CHARACTER*8 METRES
      CHARACTER*16 PRECON,SEARCH
      CHARACTER*19 LIAC,MU,DELT0,DELTA,COCO,ATMU,SGRADM,SGRADP
      ...
      CHARACTER*24 CONTNO,CONTMA,METHCO,SECMBR,DELTAU
