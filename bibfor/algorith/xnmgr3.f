      SUBROUTINE  XNMGR3(POUM,ELREFP,NDIM,COORSE,IGEOM,HE,DDLH,DDLC,NFE,
...
C
      ...
      LOGICAL  GRDEPL,GRROTA,RESI,RIGI
      REAL*8   F(3,3),FM(3,3),FR(3,3),EPSM(6),EPSP(6),DEPS(6)
      REAL*8   DSIDEP(6,6),R,SIGMA(6),FTF,DETF
...
C             JUSTE POUR CALCULER LES FF
          CALL REEREF(ELREFP,NNOP,IGEOM,XG,DEPLM,GRDEPL,NDIM,HE,DDLH,
...
C       CALCUL EN T-
        CALL REEREF(ELREFP,NNOP,IGEOM,XG,DEPLM,GRDEPL,NDIM,HE,DDLH,NFE,
...
C       ATTETION, IL FAUDRA AJOUTER LES PRODUIT DES DERIVéS DES FF 
