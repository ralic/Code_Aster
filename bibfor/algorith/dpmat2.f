      SUBROUTINE DPMAT2( MOD, MATER, ALPHA, BETA, DP, DPDENO, PPLUS,
     +                                            SE, SEQ, PLAS, DSDE )
C =====================================================================
...
C =====================================================================
      IMPLICIT      NONE
      REAL*8        MATER(5,2), DP, BETA, SE(6), SEQ, DSDE(6,6)
      REAL*8        PLAS, ALPHA, PPLUS, DPDENO
      CHARACTER*8   MOD
C =====================================================================
...
C =====================================================================
      ...
      REAL*8     PULT, QUATRE, NEUF, MATER2(5,2), DDPDE(6), VECT4(6)
      REAL*8     BETAP,BETAPS,PMOINS,BETAM,VECT5(6)
