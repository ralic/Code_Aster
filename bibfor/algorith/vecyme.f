      SUBROUTINE VECYME(MODELZ,CARELZ,MATE,COMPOR,COMPLZ,NUMEDD,CNCHTP)
...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
      ...
      CHARACTER*16 OPTION
      CHARACTER*24 CHGEOM,CHMATE,CHCARA(18),CHTIME,CHTREF
      CHARACTER*24 LIGRMO,LCHIN(15),LCHOUT(1)
      CHARACTER*24 VECHYP,CNCHYP,VRCPLU,SECPLU
      CHARACTER*19 VECEL,CHVREF
      LOGICAL EXIGEO,EXICAR,EXITRF,EXITEM
      COMPLEX*16 CBID
      DATA CNCHYP/' '/
      DATA TYPRES/'R'/
