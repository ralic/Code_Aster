...
C
      DO 80 I=1,NBMOD
        ...
        CALL R8COPY(NEQ,ZR(LLCHAM),1,ZR(LTVEC),1)
...
80    CONTINUE
C
      CALL R8AXPY(NBMOD*NBDDR,-1.D0,ZR(LTCDP),1,ZR(LDK0JI),1)
...
C
     ...
     &             1,ZR(LDKPAI),NBDAX,NBMOD)
        CALL R8AXPY(NBMOD*NBDAX,-1.D0,ZR(LTCAP),1,ZR(LDK0AI),1)
...
C
      ...
      CALL R8AXPY(NBDDR*NBDDR,-1.D0,ZR(LTFLEX),1,ZR(LTMAT),1)
      K = 0
      DO 110 J=1,NBDDR
      DO 110 I=J,1,-1
...
C
     ...
     &              NUMA,NUMD)
        CALL R8AXPY(NBDAX*NBDDR,-1.D0,ZR(LTFLEX),1,ZR(LDK0AJ),1)
...
C
     ...
     &             ZR(LTMAT),NBDAX,NBDDR)
        ...
        CALL R8AXPY(NBDAX*NBDDR,-1.D0,ZR(LTMAT),1,ZR(LTFLEX),1)
...
C
     ...
     &              NUMA,NUMA)
        CALL R8AXPY(NBDAX*NBDAX,-1.D0,ZR(LTFLEX),1,ZR(LDK0AA),1)
     ...
     &             ZR(LTFLEX),NBDAX,NBDAX)
        ...
        CALL R8AXPY(NBDAX*NBDAX,-1.D0,ZR(LTFLEX),1,ZR(LTMAT),1)
