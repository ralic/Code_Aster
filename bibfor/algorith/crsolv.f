...
C MODIF ALGORITH  DATE 22/01/2002   AUTEUR CIBHHPD D.NUNEZ 
C ======================================================================
...
C
      CALL WKVECT(SOLVEU//'.SLVK',BASE//' V K24',5,ISLVK)
      CALL WKVECT(SOLVEU//'.SLVR',BASE//' V R'  ,3,ISLVR)
      CALL WKVECT(SOLVEU//'.SLVI',BASE//' V I'  ,4,ISLVI)
C
