      SUBROUTINE NMEXTD(NOMCHA,SDIETO,SDSENS,CHAMP )
C
...
C
      IMPLICIT NONE 
      CHARACTER*24 NOMCHA,SDIETO,SDSENS  
      CHARACTER*19 CHAMP     
C 
C ----------------------------------------------------------------------
C
...
C 
      INTEGER      ICHAM,NRPASE 
C
C ----------------------------------------------------------------------
C
      CALL JEMARQ()
C
C --- PAS D'EXTRACTION EN SENSIBILITE
C
      NRPASE = 0
C
C --- INDICE DU CHAMP
...
C
      CALL NMETNC(SDIETO,SDSENS,NRPASE,ICHAM ,CHAMP )
C
      CALL JEDEMA()
