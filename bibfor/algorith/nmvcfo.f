...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
      ...
      INTEGER      JVCP
      CHARACTER*6  MASQUE
      CHARACTER*8  VECEL, LPAIN(18), LPAOUT(1), PARTPP, NOMGD, K8BID
      CHARACTER*8  MODELE
      CHARACTER*16 OPTION
      CHARACTER*24 CHTREF, CHSREF
      CHARACTER*24 TEMPLU, HYDPLU, SECPLU, PHAPLU, EPAPLU, INSPLU
      CHARACTER*24 LIGRMO, CHGEOM, CHCARA(17), LCHIN(18), LCHOUT(1)
...
C    THERMIQUE
      IF (EXITEM) THEN
       ...
       CALL CALCUL('S',OPTION,LIGRMO,18,LCHIN,LPAIN,1,LCHOUT,LPAOUT,'V')
