      SUBROUTINE NMVCFO(MODELE, NUMEDD, MATE  , CARELE, COMREF,
     &                  COMPLU, CNVCFO)
...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
      ...
      INTEGER      JVCP
      CHARACTER*6  MASQUE
      CHARACTER*8  VECEL, LPAIN(17), LPAOUT(1), PARTPP, NOMGD, K8BID
      CHARACTER*16 OPTION
      CHARACTER*24 CHTREF
      CHARACTER*24 TEMPLU, HYDPLU, SECPLU, PHAPLU, EPAPLU, INSPLU
      CHARACTER*24 LIGRMO, CHGEOM, CHCARA(17), LCHIN(17), LCHOUT(1)
...
C -- ON TESTE LA NATURE DU CHAMP DE TEMPERATURE (FONCTION OU CHAMP)
      ...
      ELSE IF (NOMGD.EQ.'TEMP_F') THEN
         PARTPP  = 'PTEMPEF'
      ELSE
         CALL UTMESS('F','NMVCFO','TEMPERATURE : GRANDEUR INCONNUE')
      END IF
