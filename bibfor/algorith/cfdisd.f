...
C   BTOTAL : SOMME NBLIAC+LLF+LLF1+LLF2
...
C     
      ...
      ELSEIF (QUESTI.EQ.'NESMAX') THEN
        CFDISD = ZI(JCOCO+10-1)         
      ELSEIF (QUESTI.EQ.'NBLIAI') THEN
        CFDISD = ZI(JCOCO+11-1)        
      ELSEIF (QUESTI.EQ.'BTOTAL') THEN
        CFDISD = ZI(JCOCO+3-1)+ZI(JCOCO+6-1)+ZI(JCOCO+7-1)+ZI(JCOCO+8-1)
      ELSE
        CALL ASSERT(.FALSE.)
      ENDIF 
C
