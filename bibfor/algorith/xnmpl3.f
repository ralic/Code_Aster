      SUBROUTINE  XNMPL3(ELREFP,NDIM,COORSE,IGEOM,HE,NFH,DDLC,DDLM,
     &                   NFE,INSTAM,INSTAP,IDEPLP,SIGM,VIP,
...
C             JUSTE POUR CALCULER LES FF
     ...
     &              NDIM,HE,RBID,RBID,FISNO,NFISS,NFH,NFE,
     &              DDLS,DDLM,FE,DGDGL,'NON',XE,FF,DFDI,F,EPS,GRAD)
...
C       ET CALCUL DE FF, DFDI, DEPS ET EPS
     ...
     &              DDLM,FE,DGDGL,'OUI',XE,FF,DFDI,F,DEPS,GRAD)

        CALL REEREF(ELREFP,.FALSE.,NNOP,NNOPS,ZR(IGEOM),XG,IDEPL,GRDEPL,
     &              NDIM,HE,RBID,RBID,FISNO,NFISS,NFH,NFE,DDLS,DDLM,
     &              FE,DGDGL,'OUI',XE,FF,DFDI,F,EPS,GRAD)
