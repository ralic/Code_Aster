...
C
      INTEGER      CFDISI
      INTEGER      LG,IBID,IL
      INTEGER      LLIAC,JDECAL,NBDDL,POSIT,IERD,JRCINE
      ...
      CHARACTER*24 NOMMAT,CHSECM,CHCINE
C
C ----------------------------------------------------------------------
C
...
C
      CHCINE='&&CFACA1.CHCINE0   .VALE'
      CALL WKVECT(CHCINE,'V V R',NEQ,JRCINE)
C
C --- NOM DE LA MATRICE
C
...
C
      ...
      IZONE  = 1
      LGBLOC = CFDISI(DEFICO,'LONG_BLOC',IZONE)
...
C
         CALL NMRLDB(LMAT,ZR(TAMPON),LG,CHCINE)
C
C --- RECOPIE
C
         DO 50 IL = 1,LG
...
C --- RECOPIE
 ...
 80      CONTINUE
      ...
      CALL JEDETR('&&CFACA1.CHCINE0   .VALE')
