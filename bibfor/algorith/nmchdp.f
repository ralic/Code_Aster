...
C    MAT(8+2*NBVAR) IN    R       TABLEAU DES COEFFICIENTS
...
C
      ...
      INTEGER IDELTA
      REAL*8  MAT(18),PM,SIGEDV(6),ALFAM(6),DEUXMU,DP,DT,QP,KSIP(6)
      REAL*8  CRIT(*),SEUIL,ALFA2M(6),Z,ZZ,KSIM(6),QM,DPE,N1,N2,BETA1
      REAL*8  ZERO,DIX,EPSPM(6),DPMAX1,PREC,DPMAX,DDP,RPVM,RPVP,BETA2
      REAL*8  CINF,K,W,C2INF,CM,C2M,KVI,VALDEN,NMCHCR,F0,FMAX,DEPSP(6)
      EXTERNAL NMCHCR
