      SUBROUTINE NMDETE ( MODELZ, MATE, CHARGE, INFCHA, NOPASE,
     &                    INSTAN, TEMMOZ, EXITMP )
C
...
C
            ...
            CHPNUL = .FALSE.
          ELSE
            CALL UTMESS('F', NOMPRO//'_01',' LE CONCEPT EVOL_THER : '//
     &                 TEMPE//' NE CONTIENT AUCUN CHAMP.')
          ENDIF
C
...
C
        ELSE
          CALL UTMESS('F', NOMPRO//'_02','ERREUR DE TYPE SUR LA CHARGE '
     &                //'THERMIQUE '//TEMPE )
C
        ENDIF
C
