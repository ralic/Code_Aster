...
! ======================================================================
!     BARSOUM : TRAITEMENT DES MAILLES "PYRAM13"
!-----------------------------------------------------------------------
!
    integer :: i, n1, n2, n3
!     ------------------------------------------------------------------
...
220      continue
!
    else if ((i1+i2.eq.7) .and. (i1.eq.4 .or. i2.eq.4)) then
        do 230 i = 1, 4
            if (i .eq. 1) then
                n1 = 4
                n2 = 5
...
250      continue
!
    else if ((i1+i2.eq.7) .and. (i1.eq.5 .or. i2.eq.5)) then
        do 260 i = 1, 5
            if (i .eq. 1) then
                n1 = 5
                n2 = 4
...
!
        ...
        call utmess('F', 'ALGORITH_36', sk='PYRA')
!
    endif
!
end subroutine
