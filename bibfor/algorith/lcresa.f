...
C     CALCUL DES DERIVEES DES VARIABLES INTERNES AU POINT T+THETA*DT   
      CALL LCDVIN(FAMI,KPG,KSP,COMP,TYPMOD,IMAT,MATCST,NVI,NMAT,VINI,
     &     MATERF(1,2),X,DTIME,SMX,DVIN,IRET)
