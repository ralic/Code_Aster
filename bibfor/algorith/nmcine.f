      SUBROUTINE NMCINE (NDIM,IMATE,COMPOR,CRIT,
...
C LECTURE DES CARACTERISTIQUES ELASTIQUES DU MATERIAU (TEMPS - ET +)
      ...
      NOMRES(2)='NU'
      NOMRES(3)='ALPHA'
      CALL RCVALA(IMATE,'ELAS',1,'TEMP',TM,2,NOMRES,VALRES,CODRET,FB2)
     ...
     +              NOMRES(3),VALRES(3),CODRET(3), BL2 )
      ...
      CALL RCVALA(IMATE,'ELAS',1,'TEMP',TP,2,NOMRES,VALRES,CODRET,FB2)
