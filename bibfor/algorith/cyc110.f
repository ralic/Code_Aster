...
C
      ...
      CHARACTER*3  KNUSEC
      CHARACTER*6  KCHIFF
      CHARACTER*8  K8BID,NOMRES,MAILLA,NOMCOU
      CHARACTER*16 MCGRM,MOTFAC,MCMAIL
      CHARACTER*24 GPPTNM,GRMCOU
      INTEGER      IARG
C-----------------------------------------------------------------------
C
C-----------------------------------------------------------------------
...
C
      ...
      IF (NBGR.LT.0) THEN
        ...
        CALL GETVTX(MOTFAC,MCGRM,1,IARG,NBGR,ZK24(LTNMGR),NBID)
...
C
    ...
    5   CONTINUE
      ELSE
        CALL RECUMA(MAILLA,NBMA,NBGR,ZK8(LTNMMA),ZK24(LTNMGR),NBSKMA,
     &              ZI(LTNUMA))
      END IF
C
