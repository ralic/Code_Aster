...
C
      ...
      CHARACTER*24 NDYNKK,FEPILD,FEDOLD,CNFOLD,FEDOL0,FEPIL0
      CHARACTER*16 TYPVEC
      CHARACTER*19 SSTRU
...
C    
      ...
      FEDOL0 = '&&NMASSV.FEDOL0'
      FEPIL0 = '&&NMASSV.FEPIL0'
C
...
C --- SCHEMA HHT_COMPLET        
        IF (NDYNLO(SDDYNA,'HHT_COMPLET')) THEN
          ...
          IF (FOPREC) THEN
            ...
            CALL COPISD('CHAMP_GD','V',VECTOR,FEDOL0)
            IF (IRET.NE.0) THEN
              CALL VTAXPY(COEFML,FEDOLD,VECTOR)
            ENDIF  
            CALL COPISD('CHAMP_GD','V',FEDOL0,FEDOLD)
            CALL JEDETR(FEDOL0)
         ELSE
         ENDIF  
        ENDIF      
...
C --- SCHEMA HHT_COMPLET        
        IF (NDYNLO(SDDYNA,'HHT_COMPLET')) THEN
          ...
          IF (FOPREC) THEN
            ...
            CALL COPISD('CHAMP_GD','V',VECTOR,FEPIL0)
            IF (IRET.NE.0) THEN
              CALL VTAXPY(COEFML,FEPILD,VECTOR)
            ENDIF  
            CALL COPISD('CHAMP_GD','V',FEPIL0,FEPILD)
            CALL JEDETR(FEPIL0)
          ENDIF  
        ENDIF      
C
