      SUBROUTINE XENRCH(IFM,NIV,NOMA,CNSLT,CNSLN,CNSEN,PFI,VOR,ORI,
     &                  RAYON,FISS,NMAEN1,NMAEN3)
      IMPLICIT NONE
      REAL*8        PFI(3),VOR(3),ORI(3),RAYON
      INTEGER       IFM,NIV,NMAEN1,NMAEN3
...
C              RAYON  :   RAYON DE LA ZONE D'ENRICHISSEMENT DES NOEUDS
C                         EN FOND DE FISSURE
C
C    SORTIE : 
C              FISS   :   SD_FISS
...
C
      ...
      INTEGER       IM1,IM2,IM3,IN,NMAEN2,JMAEN2,JMAEN3
...
C     ENREGISTREMENT DES GROUP_MA DE SORTIE SI NON VIDE
 ...
 720    CONTINUE
      ...
      IF (NMAEN1+NMAEN2+NMAEN3.EQ.0) THEN
        CALL UTMESS('A','XENRCH','LA STRUCTURE NE COMPORTE AUCUNE '//
     &       'MAILLE ENRICHIE. LA FISSURE SE TROUVE EN DEHORS DE '//
     &       'LA STRUCTURE.')
      ENDIF
