...
C       ERREUR SI UN SEG POSSÈDE DES NOEUDS ENRICHIS EN 3D
C       CAR LES ELEMENTS X-FEM DE BORD SEG N'EXISTENT PAS EN 3D
        IF (NDIM.EQ.3.AND.TYPMA(1:3).EQ.'SEG'.AND.EM.NE.0)
...
C     SEULEMENT EN 3D
      IF (NDIM.EQ.3) THEN
        ...
        CALL XORIFF(NDIM,NFON,JFON,JBAS,JBORD,PFI,ORI,VOR,DIMIN)
