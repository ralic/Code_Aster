...
C--------------------------+ PRESSION*MAZ*MODZ  EN 3D---------------
       ...
       CALL UTMESS('A','CALCIN', 'CERTAINS COEFFICIENTS DE MASSE '//
     +        'AJOUTEE SONT NEGATIFS. VERIFIEZ L'' ORIENTATION '//
     +        'DES NORMALES DES ELEMENTS D'' INTERFACE.'//
     +        'CONVENTION ADOPTEE : STRUCTURE VERS FLUIDE')
        ENDIF
        IF ((I.EQ.J).AND.(MIJ.LT.0).AND.(OPTION.EQ.'AMOR_AJOU')) THEN
       CALL UTMESS('A','CALCIN','CERTAINS COEFFICIENTS '//
     +        'D AMORTISSEMENT AJOUTE SONT NEGATIFS. POSSIBILITE'//
     +         'D INSTABILITE'//
     +         'DE FLOTTEMENT')
        ENDIF
