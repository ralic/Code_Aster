function dmasp2(rho11, rho12, rho21, sat, biot,&
                phi, cs, pas, emmag, em)
    implicit none
    real(kind=8) :: rho11, rho12, rho21, sat, biot, phi, cs, pas, dmasp2
...
! ======================================================================
    if (emmag) then
        ...
        dmasp2 = rho21*( (biot-phi)*(1.d0-sat)*cs + phi*(1.d0-sat)*( rho11-rho12)/rho11/pas )
    endif
! ======================================================================
end function
