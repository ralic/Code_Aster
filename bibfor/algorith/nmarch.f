...
C
      ...
      INTEGER      NUMINS
      CHARACTER*8  RESULT
      CHARACTER*19 SDDISC,SDCRIT,SDDYNA,SDPILO
      CHARACTER*19 VALINC(*)
...
C
      ...
      INTEGER      IFM,NIV
      INTEGER      NUMARC
      REAL*8       INSTAP,INSTAN,R8BID,VALR
      CHARACTER*8  K8BID
      CHARACTER*16 VALK
      CHARACTER*19 DEPPLU,SIGPLU,VARPLU
      CHARACTER*24 CHAMP,TYPSEL,TYPPIL
      INTEGER      DIARCH
      REAL*8       DIINST,THETA,COEF
      LOGICAL      DIINCL,NDYNLO,ISFONC,CFDISL,LNOEU
      LOGICAL      LDYNA ,LCONT ,LERRT,LTHM,LPILO
