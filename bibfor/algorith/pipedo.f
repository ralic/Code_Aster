      SUBROUTINE PIPEDO(NDIM, TYPMOD, TAU,IMATE, SIGM, VIM,
     &                   EPSM,
...
C TOLE CRP_20
      ...
      INTEGER     NCAS,I,J,L,T(3,3)
      REAL*8      TREPSD, COPLAN, SIGELP(6), SIGELD(6),UN
      REAL*8      EPS1(6), EPS2(6), D1, D2,CRIT,RTEMP
      REAL*8      TR(6),EDP(6),VECP(3,3),RAC2,CRITP
      REAL*8      FPD, P0, P1, P2, ETA, RAC(2), IND(4),EPM(3)
      REAL*8      E, NU, LAMBDA, MU, SEUIL, SEUREL,TREPSM
      REAL*8      K0,K1,K2,SICR,ALPHA
      ...
      REAL*8      B(6),D,REC(6),BR(6),VECB(3,3),VALB(3),CC(6),TOLE
