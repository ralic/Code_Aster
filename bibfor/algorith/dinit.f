...
C
      ...
      CHARACTER*24 POUGD(8),DEFICO,RESOCO
...
C -------------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ----------------
      ...
      CHARACTER*24 ROMK,MAESCL,ECPDON,KMUAP,K24BLA
      INTEGER      NRPASE, IAUX, JAUX, IECPCO
      INTEGER      JECPD,JVITM,JACCM,JDEPGM,JVITGM,JACCGM,JDEPGP
      INTEGER      JVITP,JACCP,JDEPKM,JVITKM,JACCKM,JROMKM,JROMK
      INTEGER      JDEPP,JDEPEN,JVITEN,JACCEN,JNODEP,JDEPDE
      INTEGER      JNOVIT,JNOACC,JMLTAP,JPSDEL,JCOSC,JCONI,JTFOR
      ...
      CHARACTER*16 KFORM
      CHARACTER*24 TFOR,CONI,CFSC,KBID,NDYNKK,KPRMO,MDECOL
      LOGICAL      NDYNLO,SCOTCH
      INTEGER      I,J,IE,IRET,IER,JMDECO
