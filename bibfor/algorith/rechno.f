...
C
      ...
      INTEGER      ZAPMEM
      PARAMETER    (ZAPMEM=4)
      CHARACTER*24 METHCO,NDIMCO,PZONE,PSURNO,CHAMCO,CONTNO,DDLCO,COEFCO
      INTEGER      JMETH,JDIM,JZONE,JSUNO,JCHAM,JNOCO,JDDL,JCOEF
      ...
      REAL*8       COORE(3),COORM(3),R8GAEM,DIST,PADIST,DMIN,CMULT
C
C ----------------------------------------------------------------------
C
      CALL INFNIV(IFM,NIV)
