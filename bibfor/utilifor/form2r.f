      SUBROUTINE FORM2R( SIDE, TRANS, M, N, K, A, LDA, TAU, C, LDC,
     &                   WORK, INFO )
...
C  =======
C
C  FORM2R OVERWRITES THE GENERAL REAL M BY N MATRIX C WITH
C
...
C
         AII = A( I, I )
         A( I, I ) = ONE
         CALL FLARF( SIDE, MI, NI, A( I, I ), 1, TAU( I ), C( IC, JC ),
     &               LDC, WORK )
         A( I, I ) = AII
   10 CONTINUE
 1000 CONTINUE
