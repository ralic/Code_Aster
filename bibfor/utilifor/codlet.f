...
C
C   ------------------------------------------------------------------
C   CODAGE D'UN ENTIER EN BASE 36 DANS UNE CHAINE DE CARACTERE
C   ------------------------------------------------------------------
...
C     ------------------------------------------------------------------
C     REMARQUES :
C      - EN CAS D'ERREUR (A LA TRANSCRIPTION OU DANS LE TYPE DE CADRAGE)
C        LA CHAINE EST REMPLIE D'ETOILE
C      - POUR LES ENTIERS NEGATIFS ==> VALEUR ABSOLUE
C     ------------------------------------------------------------------
...
C
      ...
      LG     = LEN(CHAINE)
C
C     ON CADRE A DROITE A PRIORI   CADRAGE A DROITE
      IL = LG + 1
  10  CONTINUE
        IL = IL - 1
        IF (IL .LE. 0) THEN
