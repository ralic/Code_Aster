...
C ======================================================================
C
C     SUBROUTINE LAPACK RETOURNANT UN VECTEUR ALEATOIRE A PARTIR D'UNE
...
C  =======
C
C  FLARUV RETURNS A VECTOR OF N RANDOM REAL NUMBERS FROM A UNIFORM (0,1)
C  DISTRIBUTION (N <= 128).
C
C  THIS IS AN AUXILIARY ROUTINE CALLED BY FLARNV AND ZLARNV.
C
C  ARGUMENTS
C  =========
C
