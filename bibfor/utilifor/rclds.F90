...
!A <> X      : SECOND MEMBRE COMPLEXE ECRASE PAR LA SOLUTION
!A -> NVES   : NOMBRE DE COLONNES DU SECOND MEMBRE
!A
!A    BUT :
!A    ---
!A    RESOLUTION DE  A * X = B ; B COMPLEXE ETANT STOCKE DANS X A
!A    L'APPEL
    real(kind=8) :: a(nmax, nordre)
    complex(kind=8) :: x(nmax, nves), c16val
!
!-----------------------------------------------------------------------
