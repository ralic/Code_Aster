      SUBROUTINE FLARNV( IDIST, ISEED, N, X )
...
C  =======
C
C  FLARNV RETURNS A VECTOR OF N RANDOM REAL NUMBERS FROM A UNIFORM OR
...
C
      DO 40 IV = 1, N, LV / 2
         ...
         END IF
C
C        CALL FLARUV TO GENERATE IL2 NUMBERS FROM A UNIFORM (0,1)
C        DISTRIBUTION (IL2 <= LV)
C
         CALL FLARUV( ISEED, IL2, U )
C
         IF( IDIST.EQ.1 ) THEN
C
