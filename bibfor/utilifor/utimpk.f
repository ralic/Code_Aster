      SUBROUTINE UTIMPK ( CH1 , TEXTC , NB , KVAL )
...
C     ------------------------------------------------------------------
      ...
      DO 1 K = 1,NB
        ...
        ENDIF
        COLCOU = (NBTB+1)*ITABU+LDEB
        IF ( COLCOU .GT. MXCOLS .OR. COLCOU+LONG .GT. MXCOLS ) THEN
           LIGCOU = LIGCOU + 1
           COLCOU = LDEB
           IF ( LIGCOU .GT. NT ) THEN
              CALL UTVTAM
