...
C MODIF SOUSTRUC  DATE 05/12/2001   AUTEUR VABHHTS J.PELLET 
C ======================================================================
...
C
C        -- NUME_DDL:
      CALL NUMDDL(NU,'G',1,MATEL,'RCMK','LIGN_CIEL')
C
...
C           AVANT DE CONSTRUIRE LE PROFIL :
      ...
      CALL PROLCI(NU,RTBLOC,'S','G')
C
C        -- ASSEMBLAGE:
      CALL ASSMAT('G',MATAS,1,MATEL,1.0D0,NU,'ZERO',1)
      CALL SSRIU2(NOMU)
C     CALL MTFEPS(EPSI,NPREC)
C     CALL FACLDL(MATAS,EPSI,NPREC)
C
