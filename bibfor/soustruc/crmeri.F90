...
! ======================================================================
!
! CALCUL DE LA PSEUDO-MATRICE RAIDEUR POUR LA MODIFICATION STRUCTURALE
!
...
!
    ...
    character(len=8) :: nomgd, vals, u, v, wks, modele, ma, vmasg, vomeg2
    character(len=16) :: nomchp, noresu, maelr, k16bid
...
!
    ...
    if (iexist .ne. 0) then
! VERIFICATION ORTHOGONALITE DES MODES OBTENUS
! (TIT*PHI)tr*KPEE*(TIT*PHI) = OMEGA2 (MATRICE SPECTRALE)
