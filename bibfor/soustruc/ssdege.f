...
C ---------------- COMMUNS NORMALISES  JEVEUX  -------------------------
      ...
      CHARACTER*8  KBI81,KBI82,NOMA,NOMO,NOMGD,KBID
      LOGICAL LOK,LMESS
      INTEGER ZI
      REAL*8 ZR,TIME
      COMPLEX*16 ZC
...
C
      ...
      NCHAR=-N1
C
      CALL WKVECT(NOMU//'.REFM','G V K8',8+NCHAR,IAREFM)
C
...
C     --------------------------------------------------------
 ...
 11   CONTINUE
      IF (LMESS) THEN
         CALL UTMESS('A','SSDEGE','L''EXTERIEUR DU MACR_ELEM_STAT'
     +   //' CONTIENT DES NOEUDS QUI NE PORTENT AUCUN DDL,'
     +   //' CES NOEUDS SONT ELIMINES.')
      END IF
C
C
...
C     ----------------------------------------------
      ...
      IF (NVALAP.NE.NBNOTO) THEN
         CALL UTMESS('A','SSDEGE','L''EXTERIEUR DU MACR_ELEM_STAT'
     +   //' CONTIENT DES NOEUDS EN DOUBLE. ILS SONT ELIMINES.')
      END IF
C
C
