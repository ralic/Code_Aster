...
C
      ...
      IF ( MA .NE. MA2 ) THEN
         CALL UTMESS('F',NOMCMD,'CET OPERATEUR MODIFIE UN MAILLAGE '//
...
C
      ...
      ELSE
         CALL JELIRA(GRPMAI,'NOMUTI',NBGMA,K1B)
         NBGMIN = NBGMA
         NBGRMN = NBGMA + NBGRMA
...
C
      ...
      ELSE
         CALL JELIRA(GRPNOE,'NOMUTI',NBGNO,K1B)
         NBGRNN = NBGNO + NBGRNO
         NBGNIN = NBGNO
