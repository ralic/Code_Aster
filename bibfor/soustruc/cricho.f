      SUBROUTINE CRICHO (NBMODE,RIGGEN,NBCHOC,DPLMOD,PARCHO,NOECHO,INFO,
     .    FIMPO,RFIMPO,PTCHOC,TRLOC,SOUPL,INDIC,NEQ,BMODAL,SEUIL,MARIG,
     .    NBNLI)
      IMPLICIT  REAL*8  (A-H,O-Z)
C ----------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF SOUSTRUC  DATE 01/07/2002   AUTEUR BOYERE E.BOYERE 
C ======================================================================
...
C     ----- FIN COMMUNS NORMALISES  JEVEUX  ----------------------------
      ...
      REAL*8             RIGGEN(*),SEUIL,
     +                   PARCHO(NBNLI,*),DPLMOD(NBCHOC,NBMODE,6)
      CHARACTER*8        NOECHO(NBNLI,*)
      REAL*8             TRLOC(NBMODE),SOUPL(NBMODE),TRLOCJ
      REAL*8             FIMPO(NEQ),RFIMPO(NEQ),PTCHOC(NEQ)
