...
C
      ...
      CALL JELIRA (JEXNOM(GRPNOE,NOGRNO),'LONMAX',NBNOEU,K8B)
...
C
         ...
         Z1  = Z0
C
C------- ECRITURE DES COORDONNEES DES NOEUDS DU PIQUAGE ROND -----------
C
C         IF ( ROND ) WRITE(6,200) 'ROND', X1, Y1, Z1
C
...
C
         ...
         Z1  = Z0
C 
C         IF ( ROTA )WRITE(6,200) 'ROTA', X1, Y1, Z1
C
