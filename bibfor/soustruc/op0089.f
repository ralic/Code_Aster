...
C ---------------- COMMUNS NORMALISES  JEVEUX  -------------------------
      ...
      CHARACTER*80 ZK80
C
      INTEGER ISMA,IAMACR,IAREFM,IBID,IE,N1
...
C
      ...
      CALL GETVID(' ','SUPER_MAILLE',1,1,1,MAIL,N1)

      CALL CHPVER('I',UG,'NOEU','DEPL_R',IE)
...
C UG DE TYPE RESULTAT (POUR MODIF STRUCTURALE)
     ...
     &   'NOM_PROJ_MESU',MACREL,'MACR_ELEM_STAT',IBID,PROMES,IE)
        ...
        CALL JELIRA(VRANGE,'ORIG',IBID,MODLMS)
...
C   ONT ETE CALCULEES
        ...
        CORRES = ' '
        CALL PJEFPR(UG,UL,MODLMS,CORRES)
