...
C MODIF SOUSTRUC  DATE 04/09/2012   AUTEUR PELLET J.PELLET 
C ======================================================================
...
C
      ...
      CHARACTER*8 OUIRI,OUIMA,AFFICK(2)
C
      INTEGER ISMA,IAMACR,IAREFM,IBID,IE,N1,LREF
      CHARACTER*8 NOMA,MACREL,PROMES,MODLMS,NOCA
      CHARACTER*19 METHOD
      CHARACTER*24 VREF
      INTEGER      IARG
C
...
C-----------------------------------------------------------------------
      ...
      CALL GETVID(' ','DEPL_GLOBAL',1,IARG,1,UG,N1)
      CALL GETVTX(' ','SUPER_MAILLE',1,IARG,1,MAIL,N1)
