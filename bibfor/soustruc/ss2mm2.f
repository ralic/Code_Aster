...
C MODIF SOUSTRUC  DATE 15/05/96   AUTEUR CIBHHRA R.MEDDOURI 
C ======================================================================
...
C
      CALL JECREC(VECEL//'.LISTE_CHAR','V V I','NO','CONTIG',
     +             'CONSTANT',1)
