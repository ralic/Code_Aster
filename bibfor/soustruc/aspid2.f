      SUBROUTINE ASPID2 ( UNITE, EPT1, DET1, D1, D2, EPT2, DET2, ZMAX,
     ...
     +                    ZETA, ITYPSO, DPENE, NIVMAG)
      IMPLICIT   NONE
      INTEGER             UNITE, NS, NC, NDT,NT,NSDT, ITYPSO, NIVMAG
      REAL*8              EPT1, DET1, D1, D2, EPT2, DET2, ZMAX, H,
     +                    ALPHA, JEU, EPC, DEC, XMAX, THETA, A, C,
     +                    EPS, RC0,RC1,RC2,RC3,ALP,BETA,ZETA,DPENE
...
C
     ...
     +'opti echo 0 ;                                                   '
      ...
      WRITE (UNITE,1010) 'rc1    = ' , RC1   , POIVIR
      WRITE (UNITE,1010) 'rc2    = ' , RC2   , POIVIR
      WRITE (UNITE,1010) 'rc3    = ' , RC3   , POIVIR
      WRITE (UNITE,1010) 'alpha  = ' , ALP   , POIVIR
      WRITE (UNITE,1010) 'beta   = ' , BETA  , POIVIR
      ...
      WRITE (UNITE,1015) 'nsdt   = ' , NSDT, POIVIR
      WRITE (UNITE,1020) 'typ_eque = MOT ' , 'FISS_COU' , POIVIR
