...
C --------------- FIN COMMUNS NORMALISES  JEVEUX  --------------------
      ...
      IF (MOCLE1.NE.'|TYPE_JEVEUX=') CALL UTMESS('F','LECOJB','STOP 1')
...
C     ----------------------------
         ...
         IF (MOCLE1.NE.'|NOM=')
     &        CALL UTMESS('F','LECOJB','STOP 2')
         IF (MOCLE2.NE.'|TYPE=')
     &        CALL UTMESS('F','LECOJB','STOP 3')
         IF (MOCLE3.NE.'|LONMAX=')
     &        CALL UTMESS('F','LECOJB','STOP 4')
...
C     ----------------------------
          READ (UNITE,1002) MOCLE1,OB1,MOCLE2,TYPE,MOCLE3,LONG
         IF (MOCLE1.NE.'|NOM=')
     &        CALL UTMESS('F','LECOJB','STOP 5')
         IF (MOCLE2.NE.'|TYPE=')
     &        CALL UTMESS('F','LECOJB','STOP 6')
         IF (MOCLE3.NE.'|NOMMAX=')
...
C     ----------------------------
     ...
     &         MOCLE4,MODLON,MOCLE4,LONMAX,MOCLE4,LONT
         ...
         IF (MOCLE1.NE.'|NOM=')
     &        CALL UTMESS('F','LECOJB','STOP 8')
         IF (MOCLE2.NE.'|TYPE=')
     &        CALL UTMESS('F','LECOJB','STOP 9')
         IF (MOCLE3.NE.'|NMAXOC=')
     &        CALL UTMESS('F','LECOJB','STOP A')
     ...
     &  CALL JEECRA(OB1,'LONMAX',LONMAX,KBID)
        DO 2,IOBJ=1,NUTIOC
         ...
         IF (MOCLE1.NE.'|NOM=')
     &        CALL UTMESS('F','LECOJB','STOP B')
         IF (MOCLE2.NE.'|LONMAX=')
     &        CALL UTMESS('F','LECOJB','STOP C')
