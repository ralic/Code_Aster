...
C        -- CONNECTIVITE DES SOUS-ELEMENTS :
         CALL ECLACO(1 ,MXNBN2,CONNX,NBNO2,  3, 7, 8, 4,19,23,24,20)
         CALL ECLACO(2 ,MXNBN2,CONNX,NBNO2,  2, 6, 7, 3,18,22,23,19)
         CALL ECLACO(3 ,MXNBN2,CONNX,NBNO2,  1, 5, 6, 2,17,21,22,18)
         CALL ECLACO(4 ,MXNBN2,CONNX,NBNO2,  7,11,12, 8,23,27,28,24)
         CALL ECLACO(5 ,MXNBN2,CONNX,NBNO2,  6,10,11, 7,22,26,27,23)
         CALL ECLACO(6 ,MXNBN2,CONNX,NBNO2,  5, 9,10, 6,21,25,26,22)
         CALL ECLACO(7 ,MXNBN2,CONNX,NBNO2, 11,15,16,12,27,31,32,28)
         CALL ECLACO(8 ,MXNBN2,CONNX,NBNO2, 10,14,15,11,26,30,31,27)
         CALL ECLACO(9 ,MXNBN2,CONNX,NBNO2,  9,13,14,10,25,29,30,26)
         CALL ECLACO(10,MXNBN2,CONNX,NBNO2, 19,23,24,20,35,39,40,36)
         CALL ECLACO(11,MXNBN2,CONNX,NBNO2, 18,22,23,19,34,38,39,35)
         CALL ECLACO(12,MXNBN2,CONNX,NBNO2, 17,21,22,18,33,37,38,34)
         CALL ECLACO(13,MXNBN2,CONNX,NBNO2, 23,27,28,24,39,43,44,40)
         CALL ECLACO(14,MXNBN2,CONNX,NBNO2, 22,26,27,23,38,42,43,39)
         CALL ECLACO(15,MXNBN2,CONNX,NBNO2, 21,25,26,22,37,41,42,38)
         CALL ECLACO(16,MXNBN2,CONNX,NBNO2, 27,31,32,28,43,47,48,44)
         CALL ECLACO(17,MXNBN2,CONNX,NBNO2, 26,30,31,27,42,46,47,43)
         CALL ECLACO(18,MXNBN2,CONNX,NBNO2, 25,29,30,26,41,45,46,42)
         CALL ECLACO(19,MXNBN2,CONNX,NBNO2, 35,39,40,36,51,55,56,52)
         CALL ECLACO(20,MXNBN2,CONNX,NBNO2, 34,38,39,35,50,54,55,51)
         CALL ECLACO(21,MXNBN2,CONNX,NBNO2, 33,37,38,34,49,53,54,50)
         CALL ECLACO(22,MXNBN2,CONNX,NBNO2, 39,43,44,40,55,59,60,56)
         CALL ECLACO(23,MXNBN2,CONNX,NBNO2, 38,42,43,39,54,58,59,55)
         CALL ECLACO(24,MXNBN2,CONNX,NBNO2, 37,41,42,38,53,57,58,54)
         CALL ECLACO(25,MXNBN2,CONNX,NBNO2, 43,47,48,44,59,63,64,60)
         CALL ECLACO(26,MXNBN2,CONNX,NBNO2, 42,46,47,43,58,62,63,59)
         CALL ECLACO(27,MXNBN2,CONNX,NBNO2, 41,45,46,42,57,61,62,58)
...
C        -- CONNECTIVITE DES SOUS-ELEMENTS :
         CALL ECLACO(1 ,MXNBN2,CONNX,NBNO2, 29,30,31,32,0,0,0,0)
         CALL ECLACO(2 ,MXNBN2,CONNX,NBNO2, 26,27,28,32,29,30,0,0)
         CALL ECLACO(3 ,MXNBN2,CONNX,NBNO2, 23,25,24,31,32,29,0,0)
         CALL ECLACO(4 ,MXNBN2,CONNX,NBNO2, 18,20,19,31,30,32,0,0)
         CALL ECLACO(5 ,MXNBN2,CONNX,NBNO2, 11,12,13,31,29,30,0,0)
         CALL ECLACO(6 ,MXNBN2,CONNX,NBNO2, 3,5,11,10,14,23,31,18)
         CALL ECLACO(7 ,MXNBN2,CONNX,NBNO2, 20,30,13,9,17,28,8,2)
         CALL ECLACO(8 ,MXNBN2,CONNX,NBNO2, 6,1,7,12,24,21,27,29)
         CALL ECLACO(9 ,MXNBN2,CONNX,NBNO2, 15,25,32,19,4,22,26,16)
         CALL ECLACO(10,MXNBN2,CONNX,NBNO2, 18,31,11,10,20,30,13,9)
         CALL ECLACO(11,MXNBN2,CONNX,NBNO2, 5,6,12,11,23,24,29,31)
         CALL ECLACO(12,MXNBN2,CONNX,NBNO2, 14,23,31,18,15,25,32,19)
         CALL ECLACO(13,MXNBN2,CONNX,NBNO2, 7,8,28,27,12,13,30,29)
         CALL ECLACO(14,MXNBN2,CONNX,NBNO2, 16,26,28,17,19,32,30,20)
         CALL ECLACO(15,MXNBN2,CONNX,NBNO2, 22,21,27,26,25,24,29,32)
...
C        LES SOUS-ELEMENTS SONT DES H8 SAUF 3 P6 :
         DO 60, K = 1, 21
           TYMA(K)  = IHEXA8
           NBNO2(K) = 8
 60      CONTINUE
...
C        -- CONNECTIVITE DES SOUS-ELEMENTS :
         CALL ECLACO(7 ,MXNBN2,CONNX,NBNO2,  2, 9,14, 8,26,30,35,29)
         CALL ECLACO(3 ,MXNBN2,CONNX,NBNO2,  9,10,15,14,30,31,36,35)
         CALL ECLACO(5 ,MXNBN2,CONNX,NBNO2, 10, 3,11,15,31,27,32,36)
         CALL ECLACO(4 ,MXNBN2,CONNX,NBNO2, 15,11,12,13,36,32,33,34)
         CALL ECLACO(6 ,MXNBN2,CONNX,NBNO2, 13,12, 1, 7,34,33,25,28)
         CALL ECLACO(2 ,MXNBN2,CONNX,NBNO2, 13, 7, 8,14,34,28,29,35)
         CALL ECLACO(1 ,MXNBN2,CONNX,NBNO2, 13,14,15,34,35,36, 0, 0)
         CALL ECLACO(14,MXNBN2,CONNX,NBNO2, 26,30,35,29,38,42,47,41)
         CALL ECLACO(10,MXNBN2,CONNX,NBNO2, 30,31,36,35,42,43,48,47)
         CALL ECLACO(12,MXNBN2,CONNX,NBNO2, 31,27,32,36,43,39,44,48)
         CALL ECLACO(11,MXNBN2,CONNX,NBNO2, 36,32,33,34,48,44,45,46)
         CALL ECLACO(13,MXNBN2,CONNX,NBNO2, 34,33,25,28,46,45,37,40)
         CALL ECLACO(9 ,MXNBN2,CONNX,NBNO2, 34,28,29,35,46,40,41,47)
         CALL ECLACO(8 ,MXNBN2,CONNX,NBNO2, 34,35,36,46,47,48, 0, 0)
         CALL ECLACO(21,MXNBN2,CONNX,NBNO2, 38,42,47,41,5,18,23,17)
         CALL ECLACO(17,MXNBN2,CONNX,NBNO2, 42,43,48,47,18,19,24,23)
         CALL ECLACO(19,MXNBN2,CONNX,NBNO2, 43,39,44,48,19,6,20,24)
         CALL ECLACO(18,MXNBN2,CONNX,NBNO2, 48,44,45,46,24,20,21,22)
         CALL ECLACO(20,MXNBN2,CONNX,NBNO2, 46,45,37,40,22,21,4,16)
         CALL ECLACO(16,MXNBN2,CONNX,NBNO2, 46,40,41,47,22,16,17,23)
         CALL ECLACO(15,MXNBN2,CONNX,NBNO2, 46,47,48,22,23,24, 0, 0)
