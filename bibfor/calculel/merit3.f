      SUBROUTINE MERIT3(MODELE,NCHAR,LCHAR,MATE,CARA,TIME,DECENT,MATEL,
     &                  PREFCH,NUMERO,BASE)
...
C     ----------
      ...
      CHARACTER*8 MODELE,CARA,MATEL,PREFCH,DECENT
      CHARACTER*24 TIME
      CHARACTER*1 BASE
...
C        DECENT : OPTION DECENTRE : 'OUI' OU 'NON'
