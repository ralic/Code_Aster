...
C---------------- COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      LOGICAL ZL
      CHARACTER*8 ZK8
      CHARACTER*16 ZK16,NOMOPT,CODVOI,NOMTE
      CHARACTER*24 ZK24
...
C     VARIABLES LOCALES:
      ...
      INTEGER DESC,GD,JNOLI,IER,IEL,IDESC
...
C     -- LE RESUELEM EST-IL "VOISIN_VF" ?
      LVOIVF=EVFINI.EQ.1
...
C        -- SI LE TYPE_ELEMENT NE CONNAIT PAS LE PARAMETRE:
        ...
        ELSE
          ...
          IF (LVOIVF) CALL JECROC(JEXNUM(NOCHOU//'.RSVI',IGR))
