...
C     ------------------------------------------
      ...
      DO 1, K=1,NBCVRC
        ...
        VARC=ZK8(JCVVAR-1+K)
        WRITE(6,*) 'AJACOT VARC=',VARC
        CART1 = CHMAT//'.'//VARC//'.1'
        CES1='&&VRCREF.CES1'
      CALL IMPRSD('CHAMP',CART1,6,'AJACOT CART1')
        CALL  CARCES(CART1,'ELEM',' ','V',CES1,IRET)
      CALL IMPRSD('CHAMP',CES1,6,'AJACOT CES1')
        CALL ASSERT(IRET.EQ.0)
...
69      CONTINUE
        ...
        WRITE(6,*) 'AJACOT IMA,NBPT,NBSP,NCMP=',IMA,NBPT,NBSP,NCMP
        WRITE(6,*) 'AJACOT IMA,IAD=',IMA,IAD
          IF (IAD.LE.0) GO TO 70
          VALREF=ZR(JCESV1-1+IAD)
        WRITE(6,*) 'AJACOT IMA,VALREF=',VALREF
