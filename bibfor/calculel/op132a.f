...
C ======================================================================
C   -------------------------------------------------------------------
C     COMMANDE :  CALC_SENSI / ANCIEN CALC_ELEM
...
C     ----- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      CHARACTER*6 NOMPRO
      PARAMETER(NOMPRO='OP132A')
C
      INTEGER IFM,NIV,N0,NUORD,NCHAR,IBID,IERD,JORDR,NP,NC
      INTEGER NBORDR,IRET,IEXI,IEXI2
      REAL*8 PREC
      CHARACTER*4 CTYP
...
C     --- TRAITEMENT DU PHENOMENE MECANIQUE ---
      IF (PHENO(1:4).EQ.'MECA') THEN
        ...
        CALL MSCALM(NEWCAL,TYSD,KNUM,KCHA,RESUCO,RESUC1,CONCEP,NBORDR,
...
C     --- TRAITEMENT DES PHENOMENES THERMIQUES ET ACOUSTIQUES ---
      ELSEIF ((PHENO(1:4).EQ.'THER') .OR. (PHENO(1:4).EQ.'ACOU')) THEN
        ...
        CALL TSACLM(NEWCAL,TYSD,KNUM,KCHA,PHENO,RESUCO,RESUC1,CONCEP,
