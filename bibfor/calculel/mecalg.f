...
C DECLARATION VARIABLES LOCALES
      ...
      CHARACTER*8 RESU,NOMA,REPK,LPAIN(30),LPAOUT(2),K8B,NOMCHS,NOMCH0
      CHARACTER*8 LCHARS(NCHAR)
      CHARACTER*16 OPTION
      CHARACTER*24 LIGRMO,TEMPE,CHGEOM,LCHIN(30),LCHOUT(2),CHTESE
      CHARACTER*24 CHTIME,CHTEMP,CHTREF,CHVOLU
      CHARACTER*24 CF1D2D,CF2D3D,CHPRES,CHROTA,CHPESA
      CHARACTER*24 CF12SS,CF23SS,CHPRSS,CHROSS,CHPESS,CHVOSS,CHEPSS
...
C - TRAITEMENT DES CHARGES DERIVEES
     ...
     &              CHEPSS,CHPESS,CHROSS,FONC,EPSI)
      ENDIF
     ...
     &(OPTION.EQ.'CALC_DG_E_F').OR. (OPTION.EQ.'CALC_DG_FORC_F')) THEN
...
C            A PASSER PEUVENT VARIER
     ...
     &          .OR.OPTION(1:12).EQ.'CALC_DG_FORC') THEN
