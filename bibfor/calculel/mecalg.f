...
C DECLARATION VARIABLES LOCALES
      ...
      INTEGER IBID,IRET,JTEMP,NRES,IFM,NIV,ICHA,NUMFON,VALI(2)
      INTEGER I,IERD,NCHIN,INCR,INIT,NSIG,NDEP,EXICHA,IAD
      REAL*8 G,VAL(2)
      COMPLEX*16 CBID
      LOGICAL EXIGEO,EXITHE,FONC,EPSI,GXFEM
      CHARACTER*8 RESU,NOMA,LPAIN(33),LPAOUT(2),K8B,NOMCHS,NOMCH0
      ...
      CHARACTER*24 CHTIME
      CHARACTER*24 PAVOLU,PA1D2D,PA2D3D,PAPRES,PEPSIN,OBVALE,CHENER
     ...
     &            CHPESA,CHROTA,FONC,EPSI,TIME,IORD)
      IF (FONC) THEN
        ...
        ELSE IF (OPTION.EQ.'CALC_G') THEN
          OPTION = 'CALC_G_F'
        ELSE IF (OPTION.EQ.'CALC_G_X') THEN
          OPTION = 'CALC_G_F'
