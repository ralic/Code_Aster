...
C
     ...
     &              IADRT4, IADRT5, ICODE, IFIC, N1, IBID, IER
      REAL*8        R8B, DIR(3), RINF, RSUP
      LOGICAL       LDIREC, ULEXIS
      CHARACTER*8   K8B, NOMA, MODELE, FOND, RESU, NOEUD, FORMAT, CONFIG
      CHARACTER*16  TYPE, OPER, FICHIE,VALK(2)
      CHARACTER*24  TRAV1, TRAV2, TRAV3, TRAV4, STOK4
      CHARACTER*24  OBJ1, NOMNO, COORN, OBJ2, TAILLR
...
C
         ...
         CALL GVERIG ( NOMA, NOCC3D, OBJ2, TAILLR, CONFIG, NBNO, NOMNO,
     &                 COORN, TRAV1, TRAV2, TRAV3, TRAV4 )
C
