...
C
      IF (NIV.GE.2) THEN
        CALL ARLIMP(IFM,'GRAPHE',NOMARL(1:8)//'.GRAPH')
      ENDIF      
C
...
C      
      IF (NIV.GE.2) THEN      
        IF (ISMED) THEN
          WRITE(IFM,*) '<ARLEQUIN> LE GROUPE DE MAILLE DE COLLAGE '//
     &                 'EST CELUI DES MULTIPLICATEURS'        
        ELSE
          WRITE(IFM,*) '<ARLEQUIN> LE GROUPE DE MAILLE DE COLLAGE '//
     &                 'N''EST PAS CELUI DES MULTIPLICATEURS'        
        ENDIF  
      ENDIF
C  
      IF (NIV.GE.2) THEN
...
C
      IF (NIV.GE.2) THEN
        CALL QUADIM(IFM,QUADRA,NOMGRP,NOMMED)
      ENDIF     
C     
