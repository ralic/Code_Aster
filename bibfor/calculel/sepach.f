...
C-----------------------------------------------------------------------
      ...
      CHARACTER*8 NOMGD,NOMRE,K8B,NOPAR2
...
C          ET CHIMAG AVEC DES SOUS-POINTS :
        ...
        IF (NBSP.GT.1) THEN
          ...
          CALL ALCHML(LIGREL,OPTION,PARAM,BASE,CHREEL,IRET1,CANBVA)
          CALL ALCHML(LIGREL,OPTION,PARAM,BASE,CHIMAG,IRET2,CANBVA)
          CALL DETRSD('CHAM_ELEM_S',CANBVA)
        ELSE
          CALL ALCHML(LIGREL,OPTION,PARAM,BASE,CHREEL,IRET1,' ')
          CALL ALCHML(LIGREL,OPTION,PARAM,BASE,CHIMAG,IRET2,' ')
        ENDIF
