...
C     ----- FIN COMMUNS NORMALISES  JEVEUX  --------------------------
     ...
     &  ' REEL'//NOMRE)
C        CALL U2MESK('F','CALCULEL4_81', 2 ,VALK)
...
C        CALL U2MESK('F','CALCULEL4_82', 2 ,VALK)
 ...
 45     CONTINUE
        ...
        CALL JEVEUO(REEL(1:19)//'.CELV','E',JCELVR)
        CALL JEVEUO(IMAG(1:19)//'.CELV','E',JCELVI)
