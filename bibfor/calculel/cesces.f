      SUBROUTINE CESCES(CESA,TYPCES,CESMOZ,MNOGAZ,MGANOZ,BASE,CESB)
...
C A_UTIL
      IMPLICIT NONE
      CHARACTER*(*) CESA,CESB,BASE,CESMOZ,TYPCES,MNOGAZ,MGANOZ
C ------------------------------------------------------------------
...
C                       MGANOZ N'EST UTILISE QUE SI ELGA->ELNO
...
C     ------------------------------------------------------------------
      ...
      CESMOD = CESMOZ
      MNOGA = MNOGAZ
C     MGANO = MGANOZ  INUTILISE POUR L'INSTANT
