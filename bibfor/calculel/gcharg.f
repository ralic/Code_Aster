...
C   
         ...
         IF(IF3D3D .NE. 0 .OR. IF2D2D .NE. 0 )THEN
           ...
           IF ( NVOLU .EQ. 0) THEN
             ...
             ENDIF
           ELSE
             IF(ISVOLU.EQ.2)CALL U2MESS('F','CALCULEL5_57')
...
C    
         ...
         IF ( IF1D2D .NE. 0 ) THEN
           ...
           IF ( N1D2D .EQ. 0 ) THEN
             ...
             ENDIF
           ELSE
             IF(IS1D2D.EQ.2)CALL U2MESS('F','CALCULEL5_57')
...
C    
         ...
         IF ( IF2D3D .NE. 0 ) THEN
           ...
           IF ( N2D3D .EQ. 0 ) THEN
             ...
             ENDIF
           ELSE
             IF(IS2D3D.EQ.2)CALL U2MESS('F','CALCULEL5_57')
...
C    
         ...
         IF ( IPRESS .NE. 0 ) THEN
           ...
           IF ( NPRESS .EQ. 0 ) THEN
             ...
             ENDIF
           ELSE
             IF(ISPRES.EQ.2)CALL U2MESS('F','CALCULEL5_57')
