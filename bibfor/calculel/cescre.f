...
C     ----------------------------------------------
      ...
      ELSE
        CALL UTMESS('F','CESCRE','TYPCES INVALIDE')
      END IF

      CALL JENONU(JEXNOM('&CATA.GD.NOMGD',NOMGD),GD)
      IF (GD.EQ.0) CALL UTMESS('F','CESCRE','GRANDEUR: '//NOMGD//
...
C     --------------------------------------------------
      IF (NCMPG.EQ.0) THEN
        IF (NOMGD(1:5).EQ.'VARI_') CALL UTMESS('F','CESCRE','STOP 1')
        NCMP2 = NCMPMX
   ...
   10   CONTINUE
      ...
      ELSE IF (NCMPG.GT.0) THEN
        ...
        IF (IRET.GT.0) CALL UTMESS('F','CESCRE','STOP')
   ...
   20   CONTINUE
      ...
      ELSE IF (NCMPG.LT.0) THEN
        IF (NOMGD(1:5).NE.'VARI_') CALL UTMESS('F','CESCRE','STOP 2')
        NCMP2 = -NCMPG
        CALL WKVECT('&&CESCRE.LICMP','V V K8',NCMP2,JLICMP)
        NOMCMP(1:1) = 'V'
        DO 30,K = 1,NCMP2
