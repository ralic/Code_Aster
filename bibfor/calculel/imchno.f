...
C
        CHNO = CHAMNO
        CALL JEIMPO('RESULTAT',CHNO//'.DESC',' ','DESCRIPTEUR')
        CALL JEIMPA('RESULTAT',CHNO//'.DESC','DESCRIPTEUR')
C
        CALL JEIMPO('RESULTAT',CHNO//'.REFE',' ','REFERENCE')
        CALL JEIMPA('RESULTAT',CHNO//'.REFE','REFERENCE')
C
        CALL JEIMPO('RESULTAT',CHNO//'.VALE',' ','VALEURS')
        CALL JEIMPA('RESULTAT',CHNO//'.VALE','VALEURS')
C
      END
