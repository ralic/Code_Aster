...
C     ------------------------------------------------------------------
      ...
      IF (I1*I2.NE.0) CALL UTMESS('A','CHSIMP','LE CHAMP_S: '//CHSA//
     &                            ' EST A LA FOIS CHAM_ELEM_S '//
     &                            'ET CHAM_NO_S.')
      IF (I1+I2.EQ.0) CALL UTMESS('A','CHSIMP','LE CHAMP_S: '//CHSA//
     &                            'N''EXISTE PAS. ')
...
C     2.2 : NOMGD1 ET LCMP1 SONT COHERENTS :
      ...
      IF (IRET.GT.0) CALL UTMESS('F','CHSUT1',
...
C      -------------------------
      ...
      DO 10,K = 1,NCMPCH
        ...
        IF (KK.EQ.0) CALL UTMESS('F','CHSUT1',
     &                           'ON NE SAIT PAS RENOMMER LA CMP: '//
     &                           NOCMP)
