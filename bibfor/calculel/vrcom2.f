...
C MODIF CALCULEL  DATE 07/11/2008   AUTEUR ASSIRE A.ASSIRE 
C ======================================================================
...
C     ------------------------------------------------------------------
      ...
      INTEGER IAD1,IAD2,NBMA,NBPG,NBSP,NBSP2,NBCM,IPG,ISP,ICM,NBCMP2
...
C     -----------------------------------
      ...
      DO 60,IMA = 1,NBMA
        ...
        NBCMP2 = ZI(JCEV1D-1+5+4* (IMA-1)+3)
...
C          ON NE VEUT PAS FAIRE D'ERREUR <F> :
        IF ((NBSP2.EQ.0).AND.(NBCMP2.EQ.0)) GO TO 60

        IF (NBSP.NE.NBSP2) THEN
           CALL JENUNO(JEXNUM(NOMA//'.NOMMAI',IMA),NOMAIL)
C           CALL U2MESS('F','CALCULEL5_40')
           VALI (1) = NBSP2
           VALI (2) = NBSP
           CALL U2MESG('F', 'CALCULEL5_40',1,NOMAIL,2,VALI,0,0.D0)
        ENDIF
