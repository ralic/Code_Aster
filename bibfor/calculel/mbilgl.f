...
C
      ...
      CHARACTER*24 UPEPSI,VPEPSI,OBJ1
      INTEGER      IARG
...
C- DEUXIEME METHODE: G_LAGRANGE ET THETA_LAGRANGE
     ...
     &            MILIEU,PAIR,ZR(IADRGS),ZR(IADABS),ZR(IADGI),.FALSE.)
     ...
     &              MILIEU,ZR(IADRGS),ZR(IADABS),ZR(IADGI),NUM,.FALSE.)
      END IF
