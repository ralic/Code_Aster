      SUBROUTINE CHSFUS(NBCHS,LICHS,LCUMUL,LCOEFR,BASE,CHS3)
...
C ---------------------------------------------------------------------
   ...
   10 CONTINUE
     ...
     &                            )
      ...
      IF (J1.GT.0) CALL CNSFUS(NBCHS,LICHS,LCUMUL,LCOEFR,BASE,CHS3)
      IF (J2.GT.0) CALL CESFUS(NBCHS,LICHS,LCUMUL,LCOEFR,BASE,CHS3)
      END
