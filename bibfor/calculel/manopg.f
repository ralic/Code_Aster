...
C     ------------------------------------------------------------------
      ...
      PARAMETER (NBPGMX=27,NBNOMX=27,NBFAMX=10,NBFLMX=10)
      ...
      INTEGER IERD,IFAM,NUMAIL,IGR,IEL,IALIEL,ILLIEL
      INTEGER JNBNO,JDIME,IRET,NCPMAX,NBFAM,KFAM,NBPGT,IAD0
      INTEGER NBLFPG,JNOLFP,NUFLPG,INDK32,NUFGPG
      CHARACTER*1 KBID
...
C          FAMILLE "LISTE" :
     ...
     &                 NBFAM,KBID)
           ...
           DO 18,K=1,NBFAM
              ...
              LIFAPG(K)=NOFPG(9:16)
C             WRITE(6,*) 'AJACOT LIFAPG(K)=',K,LIFAPG(K)
18         CONTINUE
...
C     CALL IMPRSD('CHAMP',MNOGAZ,6,'AJACOT FIN MANOPG')
      CALL JEDEMA()
      END
