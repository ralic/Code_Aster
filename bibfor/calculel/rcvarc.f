...
C ---------------- FIN COMMUNS NORMALISES  JEVEUX  --------------------
      ...
      INTEGER IADZI,IAZK24,KPGMAT,VALI(3),IISNAN
      INTEGER K ,ITABM(7),ITABP(7),ITABR(7)
      CHARACTER*24 VALK(4)
      CHARACTER*8 NOMAIL
      REAL*8 R8NNEM,VALVRM,VALVRP,VALR(3),TDEF
...
C        ON FAIT UNE EXCEPTION (COUPABLE) POUR "TEMP" :
C        ON REND TDEF POUR QUE LES ROUTINES TE00IJ N'AIENT PAS
C        A TESTER SYSTEMATIQUEMENT LA VALIDITE DE TEMP.
C        ALPHA(T-TREF) = 0 => C'EST NEUTRE.
      IF (KCVRC.EQ.0) THEN
