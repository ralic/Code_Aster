...
C MODIF CALCULEL  DATE 17/10/2005   AUTEUR VABHHTS J.PELLET 
...
C ---------------- FIN COMMUNS NORMALISES  JEVEUX  --------------------
      ...
      INTEGER KCVRC,ITAB(7),IBID,NBSP,NBPG,KPGVRC,INDIK8
...
C     3) CALCUL DE ITAB : ON CHERCHE A ECONOMISER L'APPEL A TECACH
C     ------------------------------------------------------------
      IF (POUM.EQ.'-') THEN
        IF (IEL.NE.KM) THEN
