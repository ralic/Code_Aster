      SUBROUTINE CCFNRN(OPTION,TYPESD,RESUIN,RESUOU,LISORD)
      IMPLICIT NONE
C     --- ARGUMENTS ---
...
C
      INTEGER      JORDR,NBORDR,JREF,IBID,IRET,IORDR,I,JINFC,NBCHAR,IC
      ...
      CHARACTER*24 VAPRIN,STYPSE,BIDON, CHACCE,K24B,MODELE,KPMF
      LOGICAL      EXITIM,FNOEVO,LBID,LPMF
C
...
C
      ...
      CALL JELIRA(LISORD,'LONMAX',NBORDR,CBID)
C
...
C     ON REGARDE S'IL Y A DES PMF POUR SAVOIR SI STRX_ELGA EXISTE
      STRX=' '
      CALL DISMOI('F','EXI_PMF',MODELE,'MODELE',IBID,KPMF,IERD)
      LPMF=(KPMF(1:3).EQ.'OUI')
C
      TIME=0.D0
      DO 290 I=1,NBORDR
        CALL JEMARQ()
