...
C  IN        NUTM3D(10) I  : NUMEROS DES 10 TYPES DE MAILLES 3D
C  IN        ELRF3D(10) K8 : NOMS DES 10 TYPES DE MAILLES 3D
C ----------------------------------------------------------------------
C
      LOGICAL            LEXT
      ...
      INTEGER     NBPG(NBFAMX)
      REAL*8      KSI,ETA,DZETA,X1,X2,X3,VOL
      REAL*8      CRREFE(3*NBNOMX), XR1(3),XR2(3),XR3(3)
      REAL*8      FF(NBNOMX),COOELE(3*NBNOMX)
      CHARACTER*8 ELREFA, M1, M2, KB, FAPG(NBFAMX),ALARME
      ...
      INTEGER I2COCF,I2COCO,IDECA1,ITYPM,NUTM,INDIIS,ITYP,NDIM,NNO
...
C       2.2.1 DETERMINATION DES COORDONNEES DE INO2 DANS L'ELEMENT
