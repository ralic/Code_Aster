...
C     -----------------------------------------------------------------
      ...
      INTEGER K,KK,JRSVI,JCRSVI,I1,ICH,IEL2,IGR2
...
C     DEB--------------------------------------------------------------
      ...
      ENDIF
C     -- POUR L'INSTANT, POUR CALVOI=1, IL FAUT QUE TOUS LES ELEMENTS
C        SOIENT DANS LE MEME GREL
      CALL ASSERT(IGR2.EQ.IGR)
...
C     -------------------------------------------------
      ...
      IF (ETENDU) THEN
        ...
        DEBUGR = ZI(JCELD-1+ZI(JCELD-1+4+IGR2)+8)
