...
C TOLE CRP_21
      ...
      INTEGER       IMATE,NDIM,KPG,KSP,IRET,ICOMP,NVI
      REAL*8        CRIT(*),ANGMAS(3),INSTAM,INSTAP,TAMPON(*)
...
C
      ...
      INTEGER     IRET0,IRET5
      REAL*8      DEPSTH(6),VALRES(3),EPSTHE,PM,CO,VAL0,DT,DEUXMU
      REAL*8      DEPSMO,SIGMMO,E,NU,TROISK,RPRIM,RP,AIRERP,P,DX
      ...
      REAL*8      ALFAFA,UNSURN,PRECR,DP0,XAP
