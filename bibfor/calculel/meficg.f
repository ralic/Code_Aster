     ...
     &                  LCHAR,SYMECH,FONDF,NOEUD,EXTIM,TIME,IORD,PULS,
     &                 NBPRUP,NOPRUP,NOPASE,TYPESE,CHDESE,CHEPSE,CHSISE,
...
C TOLE CRP_21
      ...
      INTEGER I,IBID,IFIC,INORMA,INIT,IFM,NIV,JNOR,VALI(2)
      ...
      CHARACTER*8 LPAIN(22),LPAOUT(1),K8BID,NOMCHS,NOMCH0
      ...
      CHARACTER*24 LCHIN(22),LCHOUT(1),LIGRMO,NOMNO,NORMA
...
C- RECUPERATION DU CHAMP GEOMETRIQUE
      ...
      NOMA = CHGEOM(1:8)
C      CALL DISMOI('F','MODELISATION',MODELE,'MODELE',IBID,TYPMO,IER)
...
C
C     CAS X-FEM
C  MOSAIN = MODELE SAIN AU DEBUT
      CALL GETVID ( 'THETA','FISSURE', 1,1,1, FISS, IXFEM )
      IF (IXFEM.GT.0) THEN
         CALL DISMOI('F','NOM_MODELE',FISS,'FISS_XFEM',
     &       IBID,MOSAIN,IER)
         CALL DISMOI('F','MODELISATION',MOSAIN,'MODELE',
     &       IBID,TYPMO,IER)
      ELSE
