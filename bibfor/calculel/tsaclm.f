...
C
C     --- VARIABLES LOCALES ---
      INTEGER IAUX,JORDR,IORDR,JCHA,IRET
      INTEGER IFM,NIV,LINST,JNMO,IAINST,IRET2,TYPESE,NRPASS
      ...
      REAL*8 TIME,COEF,PHASE
      REAL*8 RUNDF,R8VIDE
      CHARACTER*1 BASE
      CHARACTER*4 K4B,TYPE,TYPOPT
      CHARACTER*6 NOMPRO
      PARAMETER(NOMPRO='TSACLM')
      CHARACTER*8 K8B,NOMPA1,NOPASE,LERES0,BASENO
      CHARACTER*8 NOMA
      CHARACTER*13 INPSCO
      CHARACTER*16 OPTION,NOMCMD,K16B
      CHARACTER*19 DCEL,LERES1,INFCHA,MASSE
      CHARACTER*19 COMPOR,CHDYNR,REFE
      CHARACTER*24 CHCARA(18),CHSIG,CHELEM,K24B,CHTEMP
      CHARACTER*24 CHTREF,CHEPS
      ...
      LOGICAL EXICAR,LBID,EXITIM,EXIPOU,EXIPLA
      REAL*8 ZERO,UN
...
C    ------------------------------------------------------------------
     ...
     &            OPTION.EQ.'INTE_ELNO_REAC') THEN
                CALL CCPARA(OPTION,MODELE,RESUCO,IORDR)
