     ...
     &  CHGEOM,CHSOUR,PSOURC,IAUX)
C-----------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF CALCULEL  DATE 19/11/2012   AUTEUR SELLENET N.SELLENET 
C ======================================================================
...
C IN PSOURC : NOM DU PARAMETRE ASSOCIE A SOURCE
...
C LANCEMENT DES CALCULS ELEMENTAIRES-----------------------------------
      ...
      CALL CALCUL('S','ERTH_ELEM',LIGREL,NBIN,LCHIN,LPAIN,NBOUT,LCHOUT,
     &             LPAOUT,'G','OUI')
