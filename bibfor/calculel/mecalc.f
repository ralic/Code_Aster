...
C       'SIEF_ELNO_ELGA' (ET 'SIEF_SENO_SEGA')
     ...
     &                                               NBOUT,MAXOUT,'N')
        ...
        CALL AJCHCA('PCINFDI',CHCARA(18),LPAIN,LCHIN,NBIN,MAXIN,'N')
        CALL AJCHCA('PCADISK',CHCARA(2),LPAIN,LCHIN,NBIN,MAXIN,'N')
        CALL AJCHCA('PCADNSK',CHCARA(15),LPAIN,LCHIN,NBIN,MAXIN,'N')
        CALL AJCHCA('PCADISM',CHCARA(3),LPAIN,LCHIN,NBIN,MAXIN,'N')
        CALL AJCHCA('PCADNSM',CHCARA(16),LPAIN,LCHIN,NBIN,MAXIN,'N')
