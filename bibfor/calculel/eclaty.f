...
C MODIF CALCULEL  DATE 07/06/2001   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C     ---------------------------------------------------------
      ...
      IF (SCHEMA.EQ.'INCONNU') THEN
         CALL UTMESS('A','ECLATY','LE SCHEMA DES POINTS DE GAUSS'
...
C        -- CONNECTIVITE DES SOUS-ELEMENTS :
       ...
       ELSE
         ...
         NPG=0
         NPOINI=0
         CALL UTMESS('A','ECLATY','LE TYPE_ELEMENT : '//NOMTE
     &     //' N EST PAS ENCORE DECOUPE EN SOUS-ELEMENTS')
       END IF
