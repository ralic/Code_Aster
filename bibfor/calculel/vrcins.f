      SUBROUTINE VRCINS(MODELZ,CHMATZ,CARELZ,INST,CHVARC,CODRET)
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF CALCULEL  DATE 26/02/2013   AUTEUR DESROCHE X.DESROCHES 
C ======================================================================
...
C   CODRET (K2)  OUT : POUR CHAQUE RESULTAT, 'OK' SI ON A TROUVE,
C                                            'NO' SINON
