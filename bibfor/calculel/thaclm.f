...
C MODIF CALCULEL  DATE 17/10/2005   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C     --- VARIABLES LOCALES ---
      ...
      INTEGER JOPT,J,IFREQ,NP,III,L1,L2,L3,L4,L5,NC,IERD,LREFE
      INTEGER LMAT,IE,LVALE,IOCC,NBCHRE,N1,N2,N3,L6,IPUIS
      REAL*8 VALTHE,INSOLD,INST,TIME,ALPHA,COEF,PHASE
      CHARACTER*1  TYPCOE,BASE
      CHARACTER*4 BUFCH,K4B,TYPE
      CHARACTER*6 NOMPRO
      PARAMETER (NOMPRO='THACLM')
      CHARACTER*8 MA,K8B,NOMPA1,NOPASE,LERES0,BASENO
      CHARACTER*8  NOMA,CRIT
      CHARACTER*13 INPSCO
      CHARACTER*16 OPT1,OPTION,NOMCMD
