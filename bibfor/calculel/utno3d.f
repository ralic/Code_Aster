      SUBROUTINE UTNO3D(IFM,NIV,NSOMM,IFA,TYMVOL,IGEOM,XN,YN,ZN,JAC,
...
C REMARQUE : IL Y A DOUBLE EMPLOI AVEC UTNORM ET CALNOR
C            ET CERTAINEMENT AVEC D'AUTRES PROGRAMMES
C
C IN IFM/NIV  : PARAMETRES D'IMPRESSION
C IN NSOMM    : NOMBRE DE SOMMETS DE LA FACE
C IN IFA      : NUMERO DE FACE
C IN TYMVOL   : TYPE DE MAILLE VOLUMIQUE
C IN IGEOM    : ADRESSE JEVEUX DE LA GEOMETRIE
C IN IDFDX/DY : ADRESSES JEVEUX DES DERIVEES DES FFORMES DE LA FACE IFA
...
C DECLARATION PARAMETRES D'APPELS
      INCLUDE 'jeveux.h'
      INTEGER IFM,NIV,NSOMM,IFA,TYMVOL,IGEOM,IDFDX,IDFDY,NPGF,NOE(9,6,4)
...
C CALCUL DES NORMALES AUX SOMMETS IPG DE LA FACE IFA ET DE SON
C DIAMETRE
...
C DIAMETRE DE LA FACE
      ...
      CALL UTHK(NOMTEB,ZR(IGEOM),HF,0,NOE,NSOMM,TYMVOL,IFA,NIV,IFM)
