...
C     ------------------
      ...
      CHARACTER*8 MA1,MA2,MA3,NOMGD,NOMROU,PROMES,MACREL,K8BID
      CHARACTER*8 MODEL3,MODMES,KCMP,NONO,KCMP2
      CHARACTER*8 BASEMO,MAIL,NUMDDL,LICMP,KSTO
      CHARACTER*19 CNS1,CNS2,TRAV,VORIEN
      CHARACTER*24 VNOEUD,VRANGE,VNOEUM,VRANGM,VMES,VSU,BASEPR,K24BID
      ...
      INTEGER JREFD,IAMACR,ISMA,LORI
...
C MA1 : MAILLAGE DE LA MODIFICATION
      ...
      IF (ISMA.LE.0) CALL UTMESS('F',NOMROU,'LA SUPER_MAILLE : '
     &   //MAIL//' N EXISTE PAS DANS LE MAILLAGE : //MA1')
...
C MODEL3 : MODELE MESURE
      ...
      CALL JELIRA(VRANGE,'ORIG',IBID,MODEL3)
...
C LISTE DES NOEUDS DU MACRO ELEMENT
      VNOEUM = MACREL//'.VNOEUD'
      VRANGM = MACREL//'.VRANGE'
...
C INVERSE DE LA MATRICE DE PASSAGE : VSU = (TIT*PHI)-1
      ...
      CALL JELIRA(VSU,'ORIG',IBID,MODMES)
