...
C RESPONSABLE SELLENET N.SELLENET
      ...
      CHARACTER*1  TYPCOE
      CHARACTER*5  CH5
      CHARACTER*8  K8B,CURPAR,NCMPPE(4),TPF(11),CHARGE,TYPCHA
      CHARACTER*8  NCMPFO(11),MODELE,FMULT
      CHARACTER*16 TYPEMO
...
C           DANS KCHARG
         CALL GETVID('EXCIT','CHARGE',   IOCCUR,IARG,1,CHARGE,N1)
         IF ( N1.EQ.0 ) THEN
...
C              NORMALEMENT SEUL NMDOME DOIT CREER CETTE FONCTION
            ...
            L3 = 0
         ELSE
            CALL GETVID('EXCIT','FONC_MULT',IOCCUR,IARG,1,FMULT, L1)
            CALL GETVR8('EXCIT','COEF_MULT',IOCCUR,IARG,1,COEFF, L3)
            IF (L1+L3.NE.0) THEN
