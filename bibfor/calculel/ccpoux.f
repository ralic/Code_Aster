...
C     ----- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER      L1,L2,L3,L4,L5,L6,JCHA,N1,IPARA,IBID,IER,LINST
...
C          * UTILISATION DU MOT-CLE FACTEUR EXCIT
      IF (NBCHRE.NE.0) THEN
        ...
        CALL GETVID('EXCIT','FONC_MULT_C',IOCCUR,IARG,1,K8B,L2)
        CALL GETVR8('EXCIT','COEF_MULT',IOCCUR,IARG,1,COEF,L3)
        CALL GETVC8('EXCIT','COEF_MULT_C',IOCCUR,IARG,1,CCOEF,L4)
        CALL GETVR8('EXCIT','PHAS_DEG',IOCCUR,IARG,1,PHASE,L5)
        CALL GETVIS('EXCIT','PUIS_PULS',IOCCUR,IARG,1,IPUIS,L6)
