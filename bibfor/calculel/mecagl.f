...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      CHARACTER*2 CODRET
      CHARACTER*8 K8BID,RESU,NOEUD,NOMA1,FISS
      ...
      CHARACTER*24 CHSIG,CHEPSP,CHVARI,TYPE,PEPSIN,FONDNO,OBJ1
      INTEGER      IARG
C     ------------------------------------------------------------------
...
11      CONTINUE
     ...
     &              MILIEU,PAIR,ZR(IADRGS),ZR(IADABS),ZR(IADGI),LXFEM)
     ...
     &                ZR(IADRGS),ZR(IADABS),XL,ZR(IADGI),LXFEM)
        ELSE
          CALL GMETH3(MODELE,NNOFF,CHFOND,ZR(IADRG),
     &              MILIEU,ZR(IADRGS),ZR(IADABS),ZR(IADGI),NUM,LXFEM)
        END IF
      END IF
