...
C
     ...
     +                      PARA, CTYPE, VALI, VALR, VALC, VALK, IRET )
      ...
      ELSEIF ( IRET .EQ. 1 ) THEN
         CALL UTMESS('F','OP0173','LE NOM_PARA N''EXISTE PAS' )
      ELSEIF ( IRET .EQ. 2 ) THEN
         CALL UTMESS('F','OP0173','0 LIGNE TROUVEE POUR LE NOM_PARA')
      ELSEIF ( IRET .EQ. 3 ) THEN
         CALL UTMESS('F','OP0173','PLUSIEURS LIGNES TROUVEES')
      ELSE
         CALL UTMESS('F','OP0173','CODE RETOUR DE "TBLIVA" INCONNU')
      ENDIF
C
...
C
      ELSE
         CALL UTMESS('F','OP0173','TYPE_RESU INCONNU: '//TYPESD)
      ENDIF
C
      CALL TITRE()
C
