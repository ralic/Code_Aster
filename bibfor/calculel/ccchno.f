...
C     ----- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      INTEGER      IER,NBMA,JMAI,IBID,NGR,IGR,NMAXOB
      PARAMETER    (NMAXOB=30)
      INTEGER      ADOBJ(NMAXOB),NBOBJ
C
...
C     VERIFICATION DES REPERES LOCAUX
      ERDM = 'NON'
      CALL DISMOI('F','EXI_RDM',MODELE,'MODELE',IBID,ERDM,IER)
C
...
C         DE CHANGEMENT DE REPERE PROPRES AUX COQUES 3D
          CALL DISMOI('F','EXI_COQ3D',MODELE,'MODELE',IBID,ERDM,IER)
