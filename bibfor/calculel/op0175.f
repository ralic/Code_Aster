...
C ON S ASSURE QUE LA TEMPERATURE EST BIEN TRANSMISE PAR AFFE_VARC ET NON
C PAR TEMP_CALCULEE ( A RESORBER EN 9.02)
      DO 15 ICHA = 1,NCHAR
         CALL JEEXIN(ZK8(JCHA)(1:8)//'.CHME.TEMPE.TEMP',IRET)
         IF (IRET.NE.0) THEN
           CALL U2MESS('F','PREPOST5_11')
         ENDIF
 15   CONTINUE
