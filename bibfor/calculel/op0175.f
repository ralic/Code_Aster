...
C ======================================================================
      ...
      INTEGER IER
C ----------------------------------------------------------------------
C MODIF CALCULEL  DATE 03/11/2004   AUTEUR CIBHHPD L.SALMONA 
C TOLE CRP_20
C     COMMANDE :  POST_ZAC
...
C    DIMAKI = DIMENSION MAX DE LA LISTE DES RELMATIONS KIT
      ...
      CHARACTER*24 CHTZAC,CHSZAC,CHHZAC,CHCZAC,CHIZAC
...
C     CREATION DE CHAMPS DE SECHAGE, HYDRATATION, CORROSION, 
C     ------------------------------------------------------
C     IRRADIATION NULS :
C     ------------------
     ...
     &            0.D0,CBID,K8BID)
      CALL MECACT('V',CHIZAC,'MODELE',LIGREL,'IRRA_R',1,'IRRA',IBID,
     &            -1.D0,CBID,K8BID)
...
C    CHAMP DE TEMPERATURES ET TEMPERATURE DE REFERENCE EGAUX
      ...
      CALL NMVCAF('IRRA',CHIZAC,.FALSE.,COMMOI)
      CALL NMVCAF('IRRA',CHIZAC,.FALSE.,COMPLU)
