...
C  OUT  NBTROU     I  : NOMBRE DE SEG2 SOLUTIONS
C  OUT  ITR3       I  : NUMERO D'UN SEG2 SOLUTION
C  OUT  COBARY(2)  R  : COORDONNEES BARYCENTRIQUES DE INO2 DANS ITR3
C ----------------------------------------------------------------------
...
C --- FIN DECLARATIONS NORMALISEES JEVEUX ------------------------------
      REAL*8  COBAR2(2),DMIN,D2,R8MAEM,SURF,RTR3
        ...
        DO 21,P=P1,P2
          DO 22,Q=Q1,Q2
            DO 23,R=R1,R2
              ...
              DO 2,K=1,NTRBT
                 I=BTCO(IPOSI+K)
                 CALL PJ6DA2(INO2,GEOM2,I,GEOM1,SEG2,COBAR2,D2,SURF)
                 IF (D2.LT.DMIN) THEN
                   RTR3=SURF
                   ITR3=I
                   DMIN=D2
