...
C MODIF CALCULEL  DATE 25/01/2005   AUTEUR GENIAUT S.GENIAUT 
C ======================================================================
...
C     --------------------
     ...
     &    ELREFE.EQ.'X20' .OR. ELREFE.EQ.'X15' .OR.ELREFE.EQ.'X10') THEN
        NUJNI = 2
      ...
      ELSE IF (ELREFE.EQ.'MEDKQU4') THEN
        NUJNI = 79
      ELSE IF (ELREFE.EQ.'MEDKQG4') THEN
        NUJNI = 79
      ELSE IF (ELREFE.EQ.'MEDKTR3') THEN
        NUJNI = 79
      ELSE IF (ELREFE.EQ.'MEDKTG3') THEN
        NUJNI = 79
