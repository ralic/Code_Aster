...
C.......................................................................
      ...
      ELSE IF (ELREFE.EQ.'HEXA27') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'HEXA8') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'HEXA8L') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'HEXD20') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'HEXI20') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'HEXI8') THEN
        NUJNI = 10
      ...
      ELSE IF (ELREFE.EQ.'PENTA6') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'PENTA6L') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'PENTI15') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'PENTI6') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'PYRAI13') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'PYRAI5') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'PYRAM13') THEN
        NUJNI = 10
      ...
      ELSE IF (ELREFE.EQ.'TETRA4') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'TETRA4L') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'TETRI10') THEN
        NUJNI = 10
      ELSE IF (ELREFE.EQ.'TETRI4') THEN
        NUJNI = 10
