      SUBROUTINE CORDDL(IDPRN1,IDPRN2,ILI,MODE,NEC,NCMP,N,K,NDDLOC,POS)
      IMPLICIT REAL*8 (A-H,O-Z)
C
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF CALCULEL  DATE 23/06/99   AUTEUR CIBHHGB G.BERTRAND 
C ======================================================================
...
C ----------------------------------------------------------------------
      ...
      INTEGER PRNO
      INTEGER POS(1)
      INTEGER ECODG,ECODL,ENTCOD,SHIFTR
C
...
C --- PAR RAPPORT A LA VERSION NORMALE DE CORDDL , LES INSTRUCTIONS
...
C      ECODL = ENTCOD(NEC,MODE,K,1)
        ECODG = PRNO(ILI,N,2+IEC)
        ECODL = ENTCOD(NEC,MODE,K,IEC)
