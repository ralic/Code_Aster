      SUBROUTINE RESLOC ( MODELE, LIGREL, YATHM , 
     &                    LONGC , PRESC ,
     &                    CHTIME, SIGMAP, CHDEPP,
     &                    LCHAR , NCHAR , MATE  ,
     &                    CHVOIS, IATYMA, IAGD  ,
     &                    IACMP , ICONX1, ICONX2,
     &                    CHELEM)
...
C     LONGC  : LONGUEUR CARACTERISTIQUE (UTILISE SI MODELISATION HM)
C     PRESC  : PRESSION CARACTERISTIQUE (UTILISE SI MODELISATION HM)
...
C DECLARATION PARAMETRES D'APPELS
      ...
      CHARACTER*24  SIGMAP, CHDEPP
      CHARACTER*24  CHTIME, CHVOIS
      CHARACTER*24  CHELEM
...
C
      ...
      LOGICAL      EXIGEO
      CHARACTER*1  BASE
      CHARACTER*8  LICMP(NBCMP),LPAIN(NBCMPC),LPAOUT(1),KCMP
      CHARACTER*16 OPTION
      CHARACTER*19 CARTE1,CARTE2,CARTE3,NOMGD1,NOMGD2,NOMGD3
      CHARACTER*24 CHGEOM,LCHIN(NBCMPC),LCHOUT(1),CHFOR1,CHFOR2,CHFOR3
      COMPLEX*16   CCMP
C
      INTEGER NTYCHX
      PARAMETER ( NTYCHX = 9 )
...
C
      IF ( YATHM ) THEN
C
C 5.1. ==> ... ON CREE UNE CARTE CONTENANT
