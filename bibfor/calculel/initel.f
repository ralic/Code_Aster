...
C MODIF CALCULEL  DATE 02/11/2004   AUTEUR VABHHTS J.PELLET 
C ======================================================================
...
C     VARIABLES LOCALES:
C     ------------------
      INTEGER IGR,NGR,IBID,NMAXOB,NBOBJ,IERD
      ...
      CHARACTER*8 EXIELE,MA,PRIN,NOMAIL
      CHARACTER*16 NOMTE,KBID,NOMCMD
C ----------------------------------------------------------------------
      INTEGER ZI
      COMMON /IVARJE/ZI(1)
      REAL*8 ZR
