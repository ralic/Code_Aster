...
C        V(3+NBNO+1): TYPE_ELEMENT(K16)
C        V(3+NBNO+2): OPTION QUE L'ON CALCULE (K16)
C        V(3+NBNO+3): TYPE_MAILLE ASSOCIE AU TYPE_ELEMENT(K8)
C        V(3+NBNO+4): PHENOMENE ASSOCIE AU TYPE_ELEMENT(K16)
C        V(3+NBNO+5): NOM DE LA MODELISATION ASSOCIEE AU
C                     TYPE_ELEMENT(K16)
