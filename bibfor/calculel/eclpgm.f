...
C
     ...
     &                 'V',CEL,IRET1,' ')
           ...
           IF (IRET.EQ.1) THEN
             CALL UTMESS('F','ECLPGM','POUR LE MODELE '//MO
...
C     ---------------------------------------------------------------
      IF (NBPI.EQ.0) CALL UTMESS('F','ECLPGM','AUCUN ELEMENT DU MODELE'
     & //' N''EST VISUALISABLE AVEC ECLA_PG.')
      ...
      IF (NBPG.EQ.0) CALL UTMESS('F','ECLPGM','ON NE TROUVE '
     &   //'AUCUN POINT DE GAUSS.')
