      SUBROUTINE ARLCMO(NOMMOR,BASE  ,NDML    ,NNC   ,DIME)
C
...
C IN  NDML   : NOMBRE DE NOEUDS DE LA ZONE PRINCIPALE
...
C
     ...
     &            'VARIABLE',NNC)
      CALL JEECRA(NOMMOR(1:16)//'.INO','LONT',NDML,' ')
      CALL WKVECT(NOMMOR(1:16)//'.VALE',BASE//' V R',NDML*DIME,IBID)
C
