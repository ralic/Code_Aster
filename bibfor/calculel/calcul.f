...
C ----------------------------------------------------------------------
      ...
      CHARACTER*19 LIGREL
      CHARACTER*1 STOP
      INTEGER IACHII,IACHIK,IACHIX,IADSGD
      ...
      INTEGER NPIN,I,IPAR,NIN2,NIN3,NOU2,NOU3
     ...
     &       IAOPPA,NPARIO,NPARIN,IAMLOC,ILMLOC,IADSGD
      ...
      INTEGER NUTE,JNBELR,JNOELR,IACTIF,JTYPMA
...
C     6- ON DETRUIT LES OBJETS VOLATILES CREES PAR CALCUL:
  100 CONTINUE
      DO 110,I = 1,NBOBTR
