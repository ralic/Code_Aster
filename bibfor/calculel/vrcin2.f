...
170   CONTINUE
      ...
      CALL ALCHML(LIGRMO,'RAPH_MECA','PVARCPR','V',CELMOD,IRET,DCELI)
...
C         -- CALCUL DE ICHS :
          ...
          NBCHS=N1/4
          DO 71, ICHS=1,NBCHS
            TYSD2=ZK16(JLISSD-1+6*(ICHS-1)+1)(1:8)
            NOSD2=ZK16(JLISSD-1+6*(ICHS-1)+2)(1:8)
            NOSY2=ZK16(JLISSD-1+6*(ICHS-1)+3)
