      SUBROUTINE PJXXPR(RESU1,RESU2,MOA1,MOA2,CORRES,BASE,NOCA,
     &                                                  METHOD)
...
C
      ...
      CHARACTER*32 JEXNOM
      CHARACTER*1 BASE
      CHARACTER*8 RESU1,RESU2,MOA1,MOA2,NOCA
...
C       -- PROJECTION DU CHAMP SI POSSIBLE :
          ...
          IF (METHOD.EQ.'SOUS_POINT') THEN
            CALL PJSPMA(CORRES,CH1,CH2,PROL0,LIGREL,NOCA,BASE,IRET)
          ELSE
            CALL PJXXCH(CORRES,CH1,CH2,TYCHV,PRFCHN,PROL0,LIGREL,BASE,
     &                                                         IRET)
          ENDIF
