...
C          POUR LE NUMERO D'ORDRE IORDR
          ...
          TIME = ZR(IAINST)
C
C 6.2.7.1. ==> CALCUL DE L'ESTIMATEUR GLOBAL A PARTIR DES ESTIMATEURS
C             LOCAUX
...
C
     ...
     &                OPTION,IRET)
          ...
          END IF
C
          CALL RSEXC2(1,1,RESUCO,'SI'//OPTION(3:4)//'_ELGA',
