...
C MODIF CALCULEL  DATE 21/01/2013   AUTEUR GENIAUT S.GENIAUT 
C ======================================================================
...
C
     ...
     &        NBZO1,IMA,IZO,NUMA,NBZO2,JZCAR2,IZO1,IZO2,II,NBZO,
     &        NUZO1,NUZO2,JZCAR,JMA,JVAL,NCMPMX,JK24,ILIM,JMAZO,
     &        JNUMZ,NUZO,K,JVAL1,ICMP,JVAL2,KK
      CHARACTER*8 MA,K8B,VAL1,VAL2,NOMFCT,NOMS2F
