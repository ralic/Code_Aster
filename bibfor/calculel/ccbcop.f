      SUBROUTINE CCBCOP(NEWCAL,TYPESD,RESUCO,RESUC1,LISORD,
     &                  NBORDR,LISCHA,NBCHAR,TYPCHA,MODELE,
     &                  CHMATE,CARAEL)
      IMPLICIT NONE
      INTEGER      NBORDR,NBCHAR
      CHARACTER*4  TYPCHA
      CHARACTER*8  RESUC1,RESUCO,MODELE,CARAEL
      CHARACTER*16 TYPESD
...
C     RECUPERATION DE LA LISTE DE NUMEROS D'ORDRE
      ...
      IF (NEWCAL) THEN
        CALL RSCRSD('G',RESUC1,TYPESD,NBORDR)
        CALL TITRE
      ENDIF
C
...
C
        ...
        DO 40,IAUX=1,NBORDR
          ...
          DO 50 J=1,NBPARA
            CALL RSADPA(RESUCO,'L',1,ZK16(JPARA+J-1),IORDR,1,IADIN,TYPE)
            CALL RSADPA(RESUC1,'E',1,ZK16(JPARA+J-1),IORDR,1,IADOU,TYPE)
C
...
C     FABRICATION DE LA LISTE DES OPTIONS
      ...
      CALL CCLOPU(RESUCO,LISOPT,NBROPT)
...
C
        CALL CALCOP(OPTION,RESUCO,RESUC1,LISORD,NBORDR,
