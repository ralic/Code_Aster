      SUBROUTINE METNTH(MODELE,LCHAR,CARA,MATE,TIME,CHTNI,CHLAPM,METRNL)
...
C     ----------
      ...
      CHARACTER*24 MODELE,CARA,METRNL,PREFCH,TIME,CHTNI,CHLAPM
C ----------------------------------------------------------------------
...
C     -- ON VERIFIE LA PRESENCE PARFOIS NECESSAIRE DE CARA_ELEM
      ...
      IF (IRET.EQ.0) THEN
        METRNL = '&&METNTH.LISTE_RESU'
        CALL MEMARE('V',METRNL(1:8),MODELE(1:8),MATE,CARELE,
     &              'RIGI_THER_CONV_T')
        CALL WKVECT(METRNL,'G V K24',1,JLIRES)
      ELSE
        CALL JEVEUO(METRNL,'E',JLIRES)
      END IF
     ...
     &                                )
          ...
          CALL MEMARE('V',METRNL(1:8),MODELE(1:8),MATE,CARA,OPTION)
     ...
     &                'V')
          ...
          IF (IRET.NE.0) THEN
            ...
            CALL JEECRA(METRNL,'LONUTI',ILIRES,' ')
          ELSE
            ILIRES = ILIRES - 1
          END IF
