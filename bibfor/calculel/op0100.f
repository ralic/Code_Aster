...
C
      ...
      INTEGER IFF,IFOMUL,NUMFON,IDEPFI,IARRFI,IFON,NDIMTE,NCELAS
      PARAMETER (NBTYCH=17)
C
...
C
      ...
      CHARACTER*8 FOND,FISS,TYPRUP(10),SYMECH,NOPASE,MATERS,AFFCHA,CRIT
      CHARACTER*8 LATABL,LERES0,NOMA,THETAI,NOEUD,TYPEPS(-2:NBTYCH)
      CHARACTER*13 INPSCO
      CHARACTER*16 TYPCO,OPER,OPTION,TYSD, NOPRUP(10),OPTIO1,SUITE
...
C
C-------------------------------------------
C 2.3. ==> VERIFICATIONS : CALCUL_CONTRAINTE
C-------------------------------------------
      KCALC='OUI'
