...
C ======================================================================
C     COMMANDE DE CALC_ELEM SPECIFIQUE A L'OPTION ARCO_ELNO_SIGM
C
...
C     ----- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER      JCESV,JCESD,JCESK,JCESL,JCESC,NBNOMX
...
C --- ON VERIFIE QUE LES MAILLES FOURNIES SONT 2D
      ...
      DO 10 IMA=1,NBMA2D
         ...
         IF(TYPMA(1:4).NE.'QUAD'.AND.TYPMA(1:4).NE.'TRIA')THEN
           ...
           CALL UTMESS('F','MEARCC',
     &             'LA MAILLE '//NOMA//' DOIT ETRE UNE MAILLE'
     &           //' DE PEAU DE TYPE "QUAD" OU "TRIA" CAR ON'
     &           //' EST EN 3D ET ELLE EST DE TYPE : '//TYPMA)
         ENDIF
 10   CONTINUE
...
C     REMPLISSAGE DU CHAMP SIMPLE 3D
 ...
 200  CONTINUE
      ...
      CALL CESCEL(CHOUS,LIGRMO,OPTION,'PSIG3D','OUI',IBID,'G',CHOUT)
