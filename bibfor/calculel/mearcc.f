...
C MODIF CALCULEL  DATE 20/11/2012   AUTEUR DELMAS J.DELMAS 
C ======================================================================
...
C     -- IL FAUT SE PROTEGER DES MAILLES QUI NE FONT PAS
C        PARTIE DU MODELE :
      LIMAMO = '&&MEARCC.LIMAIL'
