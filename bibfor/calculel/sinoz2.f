...
C MODIF CALCULEL  DATE 22/11/2004   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C ----------------------- DECLARATIONS --------------------------------
      ...
      CHARACTER*1 K1BID
      CHARACTER*8  MODELE,VECEL,KBID,MA,TYPEMA,LICMP(4),VECASS,ELREFE
      CHARACTER*14 NUME
...
C     -- ON MET EN MEMOIRE LES OBJETS D'INTIALISATION DES ELEMENTS FINIS
C        POUR POUVOIR APPELER ELREF6 :
      LIGRMO=MODELE//'.MODELE'
      NGREL = NBGREL(LIGRMO)
      NBOBJ = 30
      CALL WKVECT('&&SINOZ2.NOMINEL','V V K24',NBOBJ,IBID1)
      CALL WKVECT('&&SINOZ2.IADINEL','V V I',NBOBJ,IBID2)
      DO 31 IGR = 1,NGREL
         CALL INIGRL(LIGRMO,IGR,NBOBJ,ZI(IBID2),ZK24(IBID1),NVAL)
 31   CONTINUE
...
C        RECUPERATION DES FCTS DE FORME DE L'ELEMENT
     ...
     &                                   TYPEMA )
              END IF
             CALL ELREF6 ( ELREFE,NOMTE,'RIGI',NDIM,NNO,NNOS,NPG,
     &                     IPOIDS,JCOOPG,IVF,IDFDE,JDFD2,JGANO)
