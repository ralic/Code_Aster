...
! In  l_jaco_upda      : .true. for updated jacobian 
! Out norm             : normal at integration point
!
! --------------------------------------------------------------------------------------------------
!
    real(kind=8) :: jcs1(3), jcs2(3), aux(3), elem_coot(3,9)
    real(kind=8) :: tau1(3), tau2(3), dxdk, dydk, dzdk, r
    integer :: i_node, i_dime, shift
!
! --------------------------------------------------------------------------------------------------
!
    do i_node = 1, nb_node
