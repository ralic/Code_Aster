      subroutine chemoplast3d(xmat,nmat,var0,varf,nvari,dt,depst,&
     nstrs,sigf,mfr,errb3d,teta1,teta2,fl3d,ifour,istep)
! ======================================================================
...
!      print*,'Av hydr_xmat endo3d',E00,e0,hydra1,hydras,0.66d0,erreur
      erreur=0
      call hydr_xmat(e0,e1,hydra1,hydras,0.5d0,erreur)
      call hydr_xmat(cohe0,cohe1,hydra1,hydras,1.d0,erreur)
!     initialisation cohesion minimale      
      cohemin1=cohe1/1000.d0 
      cohe2=cohe1      
      call hydr_xmat(delta0,delta1,hydra1,hydras,1.d0,erreur)
      delta2=delta1      
      call hydr_xmat(h0,h1,hydra1,hydras,1.d0,erreur)
      h2=h1      
      call hydr_xmat(beta0,beta1,hydra1,hydras,1.d0,erreur)
      beta2=beta1      
...
!     actualisation par l hydratation
      call hydr_vari(epse0,epse1,hydra0,hydra1,hydras,erreur)
...
!      et modif de la cohesion et des angles si necessaire
       call dp_3d(xj2d,xi1,cohe3,delta3,beta3,h3,cohemin1,&
      f0,cohe4,delta4,beta4,h4)
