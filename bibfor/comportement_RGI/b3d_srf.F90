...
!     declaration externes
      ...
      real(kind=8) :: wfeff3(3),wfm6(6),sige6(6),vss33t(3,3),sigaf6(6),d66(6,6)
      real(kind=8) :: ssl6(6),sigel6(6),eve6(6),sve6(6),vve6(6),vm6(6),deq3(3)
...
!     declaration locales
      real(kind=8) :: x33(3,3),sigal33(3,3),sigef33(3,3),spl33(3,3),sige33(3,3)
      real(kind=8) :: sigef6(6),sigaf33(3,3),wfm33(3,3),ssl33(3,3)
      real(kind=8) :: sigel33(3,3),eve33(3,3),sve33(3,3),vve33(3,3),vm33(3,3)
      integer :: i,j,k,l
      real(kind=8) :: xx,yy,zz,w2,s1,alpha,aw,srfmin,srfn,tmax
      real(kind=8) :: sigap,dwfmax,sigmapic, xloc,deps2,deps1,deps0,tkl
...
43       sigef33(i,i)=sigel33(i,i)-spl33(i,i)
!        sref1=0.d0         
...
20           if(sigef33(i,i).lt.srfmin) then
