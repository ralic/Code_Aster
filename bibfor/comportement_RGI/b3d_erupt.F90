subroutine b3d_erupt(local,i,l3,e23,r,beta,epic,fr,gf,e,dpic)
! ======================================================================
...
#include "asterf_types.h"
      ...
      t10 = fr * dpic
      t13 = fr * beta
      sef2 = (-0.2D1 * t2 - 0.6D1 * t4 * fr + t2 * fr + 0.2D1 * t2 * beta&
     + 0.6D1 * t4 * t10 - 0.4D1 * t2 * t13) / (-dpic * beta + 0.2D1 *&
      t10 * beta + dpic + t10 + beta - fr - 0.2D1 * t13 - 0.1D1) / r /& 
     li / 0.2D1
      e23(i)=sef2/e
       else
        e23(i)=e23(1)
