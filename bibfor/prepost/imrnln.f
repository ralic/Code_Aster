      SUBROUTINE IMRNLN(FICHIE,NOMSDZ,OPTIOZ,NBNO,LISNOZ,NBCMP,LISCMZ,
     &                  NBCHIF,EPS)
...
C      IMRNLN -- IMPRESSION DE LA MATR_ASSE DE NOM NOMSD, REELLE,
...
C         ------------------------------------------------------
   ...
   30     CONTINUE
          ...
          IF (NUBLOC.EQ.0) THEN
            CALL UTMESS('F','IMRNLN','PROBLEME DANS LA RECUPERATION'//
