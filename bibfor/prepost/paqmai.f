...
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF PREPOST  DATE 09/04/2003   AUTEUR F1BHHAJ J.ANGLES 
C ======================================================================
...
C-----------------------------------------------------------------------
      ...
      INTEGER       JSIGV, JSIGD, JSIGL, K, IMAP, NBPG, SOMPG, IPG, ICMP
      INTEGER       I
C
...
C
     ...
     &                 ZR( JSIGV + (ICMP-1) + (IPG-1)*6 + K*SOMPG*6 )
                     ENDIF
 280              CONTINUE
 260           CONTINUE
 240        CONTINUE
