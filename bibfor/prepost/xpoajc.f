      SUBROUTINE XPOAJC(NNM,INM,INMTOT,NBMAC,ISE,NPG,
...
C     ISE    : COMPTEUR DE SOUS ELEMENT
...
C     AU FAIT QUE L'ON EST SUR LE SOUS-TETRA ISE
C     COMME DANS XMEL3D
C     CE DECALAGE NE PEUT PAS ETRE DONNE PAR CESEXI !!
