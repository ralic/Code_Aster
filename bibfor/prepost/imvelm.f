      SUBROUTINE IMVELM ( FICHIE, NOMSDZ, NBCMP, LISCMZ, NBELEM,
     +                    LISMAZ, NBCHIF)
...
C
C      IMVELM -- IMPRESSION DU VECT_ELEM DE NOM NOMSD
C                DANS LE FICHIER DE NOM FICHIER.
C                LE GRAIN DE L'IMPRESSION EST 'MAILLE'
C                (I.E. ON IMPRIME TOUS LES TERMES DES VECTEURS
C                      ELEMENTAIRES)
C
C
...
C          -----------------------
  ...
  40        CONTINUE
C
C ---      NOMBRE DE DDL ASSOCIE AU VECT_ELEM OU AU VECT_ELEM :
C          --------------------------------------------------
            NBINCO = ICO
C
...
C
             WRITE(IFM,FORM1)
             WRITE(IFM,FORM2) EXCLAM, NOMAIL,EXCLAM, EXCLAM
             WRITE(IFM,FORM3)
C
