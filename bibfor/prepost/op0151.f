...
C MODIF PREPOST  DATE 31/01/2011   AUTEUR PELLET J.PELLET 
C ======================================================================
...
C       ---------------------------------------------------------------
        CHARACTER*2     CODRET,CODWO,CODBA,CODHS,CODMA
...
C
        IF(MDOMAG.EQ.'WOHLER') THEN
          ...
          PHENO = 'FATIGUE'
          CALL RCCOME (NOMMAT,PHENO,PHENOM,CODRET)
          IF(CODRET.EQ.'NO') CALL U2MESK('F','FATIGUE1_88', 1 ,'WOHLER')
          CALL RCPARE(NOMMAT,PHENO,'WOHLER',CODRET)
          IF(CODRET.EQ.'NO') CALL U2MESK('F','FATIGUE1_88', 1 ,'WOHLER')
        ENDIF
C
