...
C     ------------------------------------------------------------------
      ...
      CHARACTER*1  KBID
      CHARACTER*2  K2B(4)
      CHARACTER*8  MAXFEM,MO,MALINI,RESUCO,RESUX,MODVIS
      CHARACTER*16 TYSD,NOMCHA
      CHARACTER*19 CNS1,CNS2,CES1,CES2,CEL2,CH,CESVI1,CESVI2,K19
      CHARACTER*19 COMPS1,COMPS2
      CHARACTER*24 MAILX,MAILC,LICHAM,ORDR,LISTNO,LOGRMA,K24,LISTGR,K24B
C
      CALL JEMARQ()
      CALL INFMAJ()
      CALL INFNIV(IFM,NIV)
...
C
      ...
      CALL XPOINI(MAXFEM,MO,MALINI,MODVIS,LICHAM,RESUCO,RESUX,K2B,K24B)
...
C       ----------------------------------------------------------------
        ...
        CALL XPOMAX(MO,MALINI,MAILX,NBNOC,NBMAC,K2B,K24B,MAXFEM,
