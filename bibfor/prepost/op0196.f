...
C     ------------------------------------------------------------------
      ...
      INTEGER IRET,IBID,JLICHA,NBSY,NBORDR,IORD,JFISS,ICHA,JLON,
     ...
     &        NBGREL,NBMAGL,IMA,NBNIM,JINDMF,I1,IGREL,
     &        ID,NBTNIM,JLNONX,NUM,NUNXP,NUNXM,NBNOAJ,NUNX,NBCNS,
     &        JTYPMA,NBNOSO,NBHEAV,NBCTIP,NBHECT, JWXFEM, NBINMX,
     &        ICP,DIM,JMMF,J1,J2,J3,KMMF,
...
C     RECUPERATION DU NOMBRE DE FISSURES DANS MODELE
      ...
      PINTTO = MO(1:8)//'.TOPOSE.PIN'
      CNSETO = MO(1:8)//'.TOPOSE.CNS'
      HEAVTO = MO(1:8)//'.TOPOSE.HEA'
      LONCHA = MO(1:8)//'.TOPOSE.LON'
      BASLOC = MO(1:8)//'.BASLOC' 
      LTNO   = MO(1:8)//'.LTNO'
      LNNO   = MO(1:8)//'.LNNO'      
C
