...
C-----------------------------------------------------------------------
      ...
      INTEGER       JVPG1, JVPG2, JAXE1, JAXE2, JFLAG, JMIMA
...
C
      CALL WKVECT('&&AVGRMA.AXE1', 'V V R', 209*NBORDR, JAXE1)
      CALL WKVECT('&&AVGRMA.AXE2', 'V V R', 209*NBORDR, JAXE2)
...
C
            CALL JERAZO('&&AVGRMA.AXE1', NBVEC*NBORDR, 1)
            CALL JERAZO('&&AVGRMA.AXE2', NBVEC*NBORDR, 1)
...
C
      ...
      CALL JEDETR('&&AVGRMA.AXE1')
      CALL JEDETR('&&AVGRMA.AXE2')
