      SUBROUTINE IRCERS(IFI,NBEL,LIGREL,NBGREL,LONGR,NCMPMX,VALE,NOMGD,
...
C
        CALL ECRTES(NOMSD,TITR,NOMGS,IR,LOC,NBCMPT,2,ENTETE)
C
...
C
   ...
   19          CONTINUE
     ...
     +                                 '% MAILLE ',NOMEL(IEL)
                   IMPEL=0
                 ENDIF
                 WRITE (IFI,'(6(1PE13.5))') (ZR(IRVG-1+I),I=1,NBCMPT)
                 IMPRE=0
               ENDIF
            END IF
   13    CONTINUE
