      SUBROUTINE IMPFC6 (NOMAIL,LONLIS, NOMNOE,
...
C
C      IMPFC6 -- IMPRESSION D'UNE LIGNE D'UN VECTEUR ELEMENTAIRE
...
C -----  VARIABLES LOCALES
      ...
      CHARACTER*1   CROIX
      CHARACTER*1   KLONGM
      CHARACTER*2   KNBCH, KLVALR, KNCMP, KBLAN1, KBLAN2
      CHARACTER*3   KTIRET
      CHARACTER*8   M8BLAN
      CHARACTER*35  TIRE1
      CHARACTER*80  FORVAR
