      SUBROUTINE XPOCMP(ELREFP,CNS1,IMA,N,JCONX1,JCONX2,NDIM,DDLH,NFE,
     &                  DDLC,NBCMP,CMP)
...
C
      ...
      LOGICAL       EXIST(N,NBCMP),CONTAS,CONTAM
...
C     ON REGARDE LES COMPOSANTES ACTIVES EN CHAQUE NOEUD
 ...
 22         CONTINUE
            IF (NNOS.LT.N) THEN
              DO 23 K = NNOS+1,N
                IF (EXIST(K,I)) CONTAM=.TRUE.
 23           CONTINUE
            ENDIF
            IF (CONTAS .AND. .NOT.CONTAM) GOTO 1
        ENDIF
