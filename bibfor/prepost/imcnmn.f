      SUBROUTINE IMCNMN(FICHIE,NOMSDZ,OPTIOZ,NBNO,LISNOZ,NBCMP,LISCMZ,
     &                  NBCHIF,EPS)
...
C      IMCNMN -- IMPRESSION DE LA MATR_ASSE DE NOM NOMSD, COMPLEXE,
...
C         ------------------------------------------------------
   ...
   30     CONTINUE
          ...
          IF (NUBLOC.EQ.0) THEN
            CALL UTMESS('F','IMCNMN','PROBLEME DANS LA RECUPERATION'//
