      SUBROUTINE IRGNS2 ( IFI, NBORDR, COORD, CONNEX, POINT, NOCMP,
     +                    NJVSEG, NBSEG, CNSC, CNSL, CNSV, CNSD )
      IMPLICIT NONE
C
      INTEGER        NBSEG, IFI, NBORDR, CONNEX(*), POINT(*),
     +               CNSC(*), CNSL(*), CNSV(*), CNSD(*)
      REAL*8         COORD(*)
      CHARACTER*8    NOCMP
      CHARACTER*(*)  NJVSEG
...
C
      INTEGER      ISEG, IMA, IPOIN, LISTNO(2), J, JCNSC, JCNSL, JCNSV,
     +             JCNSD, NCMP, K, JSEG, IOR, INOE
      REAL*8       VALE
C     ------------------------------------------------------------------
C
      CALL JEMARQ()
...
C
      DO 10 ISEG = 1 , NBSEG
         ...
         DO 12 J = 1 , 3          
            WRITE(IFI,1000) (COORD(3*(LISTNO(INOE)-1)+J),INOE=1,2)
 12      CONTINUE
C
         DO 14 IOR = 1 , NBORDR
