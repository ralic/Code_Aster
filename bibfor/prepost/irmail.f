...
C MODIF PREPOST  DATE 05/10/2010   AUTEUR SELLENET N.SELLENET 
C ======================================================================
...
C       - TRAITEMENT DU FORMAT 'RESULTAT'
     ...
     &              NBGRN,ZK8(JNOGN),NBGRM,ZK8(JNOGM),ZK8(JNOMAI),
     &              ZK8(JNONOE))
C
...
C       - LE SOUS-PROGRAMME IRADHE TRAITE LES ADHERENCES ENSIGHT
     ...
     &              ZK8(JNOMAI),ZK8(JNONOE),ZI(JPOIN),ZI(JTYPM),
     &              ZI(JTYPL),ZK8(JNOMAE),ZI(JPERM2),MAXNOD,LMOD,LMASU,
     &              NBGRM,ZK8(JNOGM))
