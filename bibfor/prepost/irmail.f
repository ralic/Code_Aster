...
C       - TRAITEMENT DU FORMAT ECHANGE DE DONNEES 'MED'
     ...
     &              NOMA,ZI(JTYPM),ZK80(JTITR),NBTITR,NBGRN,ZK24(JNOGN),
     &              NBGRM,ZK24(JNOGM),ZK8(JNOMAI),ZK8(JNONOE),INFMAI)
C
      ELSEIF (FORM.EQ.'CASTEM') THEN
C       - TRAITEMENT DU FORMAT 'CASTEM'
        CALL IRMACA(IFI,NDIM,NBNOE,ZR(JCOOR),NBMAI,ZI(JCONX),ZI(JPOIN),
     &              NOMA,ZI(JTYPM),LMOD,NBGRN,ZK24(JNOGN),NBGRM,
     &              ZK24(JNOGM),NIVE)
C
...
C       - SOUS PROGRAMME : TRAITER LES ADHERENCES SUPERTAB
     ...
     &              ZI(JPERM),MAXNOD,LMOD,NOMA,NBGRN,ZK24(JNOGN),NBGRM,
     &              ZK24(JNOGM),LMASU,ZK8(JNOMAI),ZK8(JNONOE),VERSIO)
