      SUBROUTINE IRCECA(IFI,NBEL,LIGREL,NBGREL,LONGR,NCMPMX,VALE,NOMGD,
     &   NCMPGD,NOMEL,CELD,NBNOMA,MAXNOD,TYPMA,NOMSD,NOMSYM,NBMAT,
     &   NUMMAI,LRESU,NBCPUT,NCMPUT,IMODL,NCMPV,NUCMPV,NIVE)
      IMPLICIT REAL*8 (A-H,O-Z)
C
      INTEGER       IFI,NBEL,LIGREL(*),NBGREL,LONGR(*),NCMPMX,CELD(*)
      INTEGER       NBNOMA(*),TYPMA(*),NBMAT,NUMMAI(*),NBCPUT,IMODL
      INTEGER       NCMPV,NUCMPV(*),NIVE
      CHARACTER*(*) NOMGD,NCMPGD(*),NOMEL(*),NOMSYM,NOMSD,NCMPUT(*)
      REAL*8                                     VALE(*)
      LOGICAL       LRESU
C-----------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF PREPOST  DATE 08/08/2002   AUTEUR CIBHHLV L.VIVAN 
C ======================================================================
     ...
     +                                                 I=1,NBVAR*ICOMAX)
         ...
         DO 222 JV = 1 , NBVAR
           DO 224 ISP = 1 , ICOMAX
             ...
             ENDIF
             WRITE(IFI,'(1P,3E22.14))') (ZR(JVALE-1+I),
