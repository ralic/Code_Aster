subroutine cpqu04(main  , maout , inc   , jcoor , jcnnpa, conloc,&
...
#include "asterfort/cpnpq4.h"
#include "asterfort/cpncq4.h"
#include "asterfort/cpmpq4.h"
#include "asterfort/cpmcq4.h"
...
!
    ...
    call jeecra(jexnum(maout//'.PATCH',inc+1), 'LONMAX', ival=3)
    call jeecra(jexnum(maout//'.PATCH',inc+1), 'LONUTI', ival=3)
