...
C
      ...
      IF (ABS(CUO01P - CUON01) .LT. EPS) THEN
         CUON1 = CUON01
         CUON2 = CUON01
         CUON3 = CUON01
         A01 = 0.0D0
...
C
      ...
      IF (ABS(CUO02P - CUON02) .LT. EPS) THEN
         CUON1 = CUON02
         CUON2 = CUON02
         CUON3 = CUON02
         A02 = 0.0D0
...
C
      ...
      IF (ABS(CUO12P - CUON12) .LT. EPS) THEN
         CUON1 = CUON12
         CUON2 = CUON12
         CUON3 = CUON12
         A12 = 0.0D0
...
C ON VERIFIE QUE : CUON1 = CUON2 = CUON3 ET QUE : CVON1 = CVON2 = CVON3.
      ...
      IF ( ((CUON1-CUON2) .LT. EPS) .AND.
     &     ((CUON2-CUON3) .LT. EPS) .AND.
     &     ((CVON1-CVON2) .LT. EPS) .AND.
     &     ((CVON2-CVON3) .LT. EPS) ) THEN
         CUON = CUON1
         CVON = CVON1
         RAYON = SQRT((CUON - CUPN1)**2 + (CVON - CVPN1)**2)
      ELSE
         CALL UTMESS('F','CER3PT','LE POINT QUI DEVAIT ETRE A EGALES '//
     &               'DISTANCES DES TROIS POINTS NE L''EST PAS.')
      ENDIF
C
      CALL JEDEMA()
      END
