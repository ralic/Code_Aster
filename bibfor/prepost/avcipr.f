...
C ======================================================================
C TOLE CRP_21 CRS_1404 CRS_512
C---------------------------------------------------------------------
...
C ITRV   VECTEUR DE TRAVAIL ENTIER (POUR LES NUME_ORDRE)
      ...
      REAL*8        VECTRA(2*NBVEC*NBORDR)
      INTEGER       IFLAG(NBVEC), ITRV(2*(NBORDR+2))
      REAL*8        RMIMA(4*NBVEC),CUDOMX,NXM,NYM,NZM
      LOGICAL       LSIG0
...
C  PROJECTION DE L'HISTORIQUE DU CISAILLEMENT DANS UN PLAN
     ...
     &                   SOMMW, VWORK, TDISP, TSPAQ, IPGN,NOMCRI,FATSOC,
     &                   VECTRA )
