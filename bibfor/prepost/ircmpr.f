...
C     SORTIES :
C       NBRIMP : NOMBRE D'IMPRESSIONS A REALISER
...
C
      ...
      INTEGER IAUX,IMA,NBNO,NBMA,ISE2,ISE4
...
C       CENTRE (APPARTENANT AUX MAILLES DE TYPE TRIA7,QUAD9 OU HEXA27)
C
...
C
     ...
     &                NBVATO, NBENEC, LIENEC, ADSD, ADSL,
     &                NBIMPR, NCAIMI, NCAIMK,
     &                ZI(IAUX), ZI(ADTYP2), TYPGEO, NOMTYP,
