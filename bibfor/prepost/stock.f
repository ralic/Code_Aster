     ...
     +                 IOUF,NUMODE,MASGEN,TYPRES,PRCHNO)
      IMPLICIT NONE
...
C MODIF PREPOST  DATE 01/10/2002   AUTEUR BOYERE E.BOYERE 
C ======================================================================
...
C     &             PRCHNO//".PRNO",1,' ')
      IF (TYCHAS.EQ.'NOEU') THEN
        CALL CNSCNO(CHS,PRCHNO,'G',NOMCH)
      ELSE
        CALL CESCEL(CHS,LIGREL,' ',' ','OUI','G',NOMCH)
      END IF
