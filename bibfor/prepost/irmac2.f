...
C MODIF PREPOST  DATE 17/12/2001   AUTEUR CIBHHLV L.VIVAN 
C ======================================================================
...
C
      ...
      ELSEIF ( KTYPE .EQ. 'SEG4'   ) THEN
         NNOE = NNOE - 2
         CALL UTMESS('I','IRMACA','SEG4 ELEMENT INEXISTANT DANS '//
     +                            'CASTEM, CONVERTI EN SEG2')
         ITYCA = 2
         GTYPE = 'SEG2'
      ...
      ELSEIF ( KTYPE .EQ. 'TRIA7'   ) THEN
         NNOE = NNOE - 1
         CALL UTMESS('I','IRMACA','TRIA7 ELEMENT INEXISTANT DANS'
     +            //' CASTEM, CONVERTI EN TRIA6')
         ITYCA = 6
         GTYPE = 'TRI6'
      ...
      ELSEIF ( KTYPE .EQ. 'QUAD9'   ) THEN
         NNOE = NNOE - 1
         CALL UTMESS('I','IRMACA','QUAD9 ELEMENT INEXISTANT DANS '//
     +                            'CASTEM, CONVERTI EN QUAD8')
         ITYCA = 10
         GTYPE = 'QUA8'
CCC         ITYCA = 11
CCC         GTYPE = 'QUA9'
