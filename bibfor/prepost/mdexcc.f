...
C
      ...
      IF ( CODRET.NE.0 ) THEN
        VALK (1) = NOFIMD
        VALI (1) = CODRET
        CALL U2MESG('A','PREPOST5_89',1,VALK,1,VALI,0,0.D0)
...
C
      ...
      IF ( CODRET.NE.0 ) THEN
        ...
        VALI (1) = IAUX
        VALI (2) = CODRET
        CALL U2MESG('A','PREPOST5_90',1,VALK,2,VALI,0,0.D0)
...
C               12345678901234567890123456789012
     ...
     &              ZK16(ADNCMP), ZK16(ADUCMP), NBCMFI, CODRET )
      IF ( CODRET.NE.0 .OR. JAUX .NE. MFLOAT ) THEN
        ...
        VALK (2) = SAUX32
        VALI (1) = IAUX
        CALL U2MESG('A+','PREPOST5_91',2,VALK,1,VALI,0,0.D0)
        IF (CODRET.NE.0) THEN
          VALI (1) = CODRET
          CALL U2MESG('A+','PREPOST5_92',0,' ',1,VALI,0,0.D0)
        ENDIF
        IF (JAUX.NE.MFLOAT) THEN
          VALI (1) = JAUX
          CALL U2MESG('A+','PREPOST5_93',0,' ',1,VALI,0,0.D0)
        ENDIF
        CALL U2MESG('A','PREPOST5_94',0,' ',0,0,0,0.D0)
...
C
      ...
      IF ( CODRET.NE.0 ) THEN
        VALK (1) = NOFIMD
        VALI (1) = CODRET
        CALL U2MESG('A','PREPOST5_95',1,VALK,1,VALI,0,0.D0)
