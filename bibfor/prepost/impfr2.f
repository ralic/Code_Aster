      SUBROUTINE IMPFR2 (NOMNOZ, NBNOMA, LONLIS, NOMNOE, NOMCMP,
     +                   VALE, INDCMP, INDNOE, NOMCM2, VALE2,
     +                   NBCM2, NCMPMX, NBCMP1, NOMCM1,
     +                   NBCMP2, LISCMP, NOEMAZ, NBCHIF, IFM)
...
C
C      IMPFR2 -- IMPRESSION D'UNE LIGNE OU D'UNE COLONNE D'UNE
...
C -----  VARIABLES LOCALES
      ...
      CHARACTER*3   KTIRET
      CHARACTER*8   NOMNO1, NOCM1, M8BLAN, FORVAR
      CHARACTER*24  NOEUMA
      CHARACTER*32  JEXNOM
      CHARACTER*35  TIRE1
...
C             ----------------------------------------------
     ...
     +                        (VALE2(N+IJ),EXCLAM,IJ=1,NBCM2(ICMP1))
               ENDIF
                   N = N + NBCM2(ICMP1)
                 ENDIF
  70             CONTINUE
