...
C COORDONNES DES VECTEURS ET DISTANCES
     ...
     &        ( XO1A*YO1O2-YO1A*XO1O2 )**2 - R*R * DO1O2**2
            ...
            IF ( DELTA.LT.0.D0 ) THEN
              CALL UTMESS('F','DINTTC','DELTA NEGATIF '//
     &        'PB LORS DE RECHERCHE INTERSECTION')
            ENDIF
            IF ( A.EQ.0.0D0 ) THEN
...
C IL FAUT CHERCHER DE QUEL COTE DU CYLINDRE EST LE POINT A
            ...
            IF ( .NOT.LINTCY ) THEN
              ...
              ELSE IF ( DAO1.EQ.0.0D0 .OR. DAO2.EQ.0.0D0 ) THEN
                LAMBDA = 0.0D0
              ELSE
                CALL UTMESS('F','DINTTC','CAS IDIOT')
              ENDIF
              ...
              ELSE
                CALL UTMESS('F','DINTTC','PB EN DEHORS DES 2 POINTS')
              ENDIF
            ENDIF
          ENDIF
 30     CONTINUE
