      SUBROUTINE USPAS2 ( NBUSUR, PARUSU, IPAS, PAS )
      IMPLICIT   NONE
...
C           
         IF (                              DIFF3.LE.20.D0   ) THEN
            IPAS(I,3) = 40
         ELSEIF ( (DIFF3.GT.20.D0)  .AND. (DIFF3.LE.30.D0)  ) THEN
            IPAS(I,3) = 70
         ELSEIF ( (DIFF3.GT.30.D0)  .AND. (DIFF3.LE.40.D0)  ) THEN
            IPAS(I,3) = 90
         ELSEIF ( (DIFF3.GT.40.D0)  .AND. (DIFF3.LE.50.D0)  ) THEN
            IPAS(I,3) = 110
         ELSEIF ( (DIFF3.GT.50.D0)  .AND. (DIFF3.LE.60.D0)  ) THEN
            IPAS(I,3) = 140
         ELSEIF ( (DIFF3.GT.60.D0)  .AND. (DIFF3.LE.70.D0)  ) THEN
            IPAS(I,3) = 200
         ELSEIF ( (DIFF3.GT.70.D0)  .AND. (DIFF3.LE.100.D0) ) THEN
            IPAS(I,3) = 250
         ELSEIF ( (DIFF3.GT.100.D0) .AND. (DIFF3.LE.150.D0) ) THEN
            IPAS(I,3) = 300
         ELSEIF ( (DIFF3.GT.150.D0) .AND. (DIFF3.LE.250.D0) ) THEN
            IPAS(I,3) = 500
         ELSEIF ( (DIFF3.GT.250.D0) .AND. (DIFF3.LE.360.D0) ) THEN
            IPAS(I,3) = 720
         ENDIF 
         PAS(I,3) = DIFF3 / IPAS(I,3)
C
 140  CONTINUE
C
      END
