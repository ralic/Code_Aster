...
C MODIF PREPOST  DATE 30/04/2007   AUTEUR ABBAS M.ABBAS 
C ======================================================================
...
C     ------------------------------------------------------------------
     ...
     &        JFISS,NBNI,NBSE,JLON,NBTGMA,NBMAGP,JGPMA,KK,
     &        JMAGP,JGM,JTYP,JTYPF,NBNOMX,NBCO,NBTCO,JCO,JCOF,
     &        JREFE,NBMAGT,JNBNIM,JNBSEM,NBSEM,INUMA,
     &        NUMAF,NUMSE,JJ,ITET,JCNS,I1,I2,
     &        JPIN,NUMNI,INO,KTET,IMA,JC,NBNIM,ICNS,NBNONO,
     &        NBHEA,NTET,TYPSE,IC,DIM,JFACE,IFACE,JMMF,J1,J2,J3,KMMF,
     &        NXIS,NBNIS,JNIS,JCOFE,INIS,NUISP,NUISM,NBCNS,
     &        JCORF,ILOC,JNBSE,IIND,JSE,NBMAGL,JCOFL,
     &        JJCNS,JJPIN,IGREL,NBGREL,JWXFEM,JL,JDIMI,JJSE,
     &        JHTET,JINDNP,JINDNM,IIHEA,JJHEA,JNUNO,NUTYEL,
     ...
     &        NBNOSO,NBNOMI,JNX,NBHECT,NBCTIP,NBHEAV,DIMTO,
     ...
     &            NOMGNO,NXISM,NXISP,K8B,NOXIS
      ...
      CHARACTER*24 HEAV,GRPMA,CONNEX,LIEL,GRPNO,CTIP,HECT
      CHARACTER*24 VALK(2)
      CHARACTER*24 REPE
      LOGICAL LNIS,LMNIS
C
...
C     ON VERIFIE QUE LE MODELE EST COMPATIBLE AVEC LA METHODE XFEM
      ...
      IF(IRET.EQ.0)THEN
        VALK (1) = MO
        VALK (2) = KBID
        CALL U2MESG('F', 'PREPOST5_65',2,VALK,0,0,0,0.D0)
      ENDIF
C
