      SUBROUTINE USTUE2 ( DIMTUB, VOLTUB, TUBUSE, RCRAY, RCARTE, SECT,
     &                ARETE, ARETE2, NS, EPAIS, ECRAY, NOMCMD, NOMT19 )
      IMPLICIT   NONE
      INTEGER             DIMTUB, NS
      REAL*8              VOLTUB(*), TUBUSE(*), RCRAY, RCARTE, SECT(*),
     &                    ARETE, ARETE2, EPAIS, ECRAY
      CHARACTER*16        NOMCMD
      CHARACTER*19        NOMT19
C-----------------------------------------------------------------------
...
C ======================================================================
C-----------------------------------------------------------------------
C     CALCULE LES VOLUMES USES DE TUBE (GUIDAGE ENCO_2)
C ----------------------------------------------------------------------
      INTEGER  USURE(10,5), NBUSUR, I, J, L, IPAS(10,2), IFM, NIV
      INTEGER  N, NSS2
