     ...
     &                    JRWORK, TSPAQ, IPG, JVECPG )
      IMPLICIT   NONE
      INTEGER             NBVEC, JVECTN, JVECTU, JVECTV, NBORDR, JRWORK
      INTEGER             TSPAQ, IPG, JVECPG
...
C
         DO 20 IORDR=1, NBORDR
            SIXX = ZR(JRWORK + 0 + (IORDR-1)*TSPAQ + (IPG-1)*6)
            SIYY = ZR(JRWORK + 1 + (IORDR-1)*TSPAQ + (IPG-1)*6)
            SIZZ = ZR(JRWORK + 2 + (IORDR-1)*TSPAQ + (IPG-1)*6)
            SIXY = ZR(JRWORK + 3 + (IORDR-1)*TSPAQ + (IPG-1)*6)
            SIXZ = ZR(JRWORK + 4 + (IORDR-1)*TSPAQ + (IPG-1)*6)
            SIYZ = ZR(JRWORK + 5 + (IORDR-1)*TSPAQ + (IPG-1)*6)
C
