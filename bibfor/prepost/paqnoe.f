...
C MODIF PREPOST  DATE 07/05/2013   AUTEUR DESOZA T.DESOZA 
C ======================================================================
...
C
      REAL*8        R8B, VAL1, VAL2, RESU(7),VRESU(24),VALPAR(22),R8PREM
      COMPLEX*16    C16B
C
      CHARACTER*1   KBID
...
C BOUCLE SUR LES DEFORMATIONS TOTALES (6 COMPOSANTES)
 ...
 300        CONTINUE
     ...
     &                   NBNOP, TSPAQ, NOMMET, NOMCRI,NOMFOR,
