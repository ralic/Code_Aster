...
C     21  PENTA15   -->  21                             15
C     22  PYRAM5    -->  22   ( PYRAM5 EN PYRAM13 )     13
C     23  PYRAM13   -->  23                             13
C     24  HEXA8     -->  24   ( HEXA8 EN HEXA20 )       20
C     25  HEXA20    -->  26                             20
C     26  HEXA27    -->  26                             27
C
...
C --- LE NOEUD CENTRAL EST CREE PLUS TARD
      ...
      CALL WKVECT(MILIEU,'V V I',4*12*NBNO,   JMILIE)
      CALL WKVECT(NOMIPE,'V V I',4*6*NBMA,   JNOMIP)
      CALL JEVEUO(MAIN//'.TYPMAIL','L',JTYPMA)

      CALL CM27NA(NBMA,NBNO,LIMA,MAIN//'.CONNEX',ZI(JTYPMA),
