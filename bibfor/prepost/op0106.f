...
C 0.3. ==> VARIABLES LOCALES
      ...
      INTEGER INUME,IOPT,IORDR,IRET,J,JCGMP
...
C     ------------------------------------------------------------------
      ...
      CHARACTER*4 TYPCAL
      CHARACTER*6 NOMPRO
      CHARACTER*8 K8BID,CTYP,CRIT,NOPASE,NOMA,NOMCMP(3),CARA,MATE
      CHARACTER*8 KIORD
      CHARACTER*13 INPSCO
      ...
      CHARACTER*24 NUME,VFONO,VAFONO,SIGMA,CHDEPL,K24BID,CHELEM,STRX
      CHARACTER*24 CHACCE,VRENO,VARENO,COMPOR,CHVIVE,CHACVE,MASSE
      CHARACTER*24 MESMAI,BIDON,CHVARC,VAPRIN,STYPSE
      CHARACTER*24 NOOJB,K24B,NUMREF,VALK(3),KSTR
...
C     --------------------------------------------------------
      IF (RESUCO.EQ.RESUC1) THEN
        CALL CCVRPU(RESUCO(1:8),KNUM,NBORDR)
      ENDIF
...
C ------- MAILLES QUI PARTICIPENT A LA MOYENNE
   ...
   70   CONTINUE
        ...
        IF (OPTIO2.EQ.'EPSI_ELNO') OPTIO2='EPSI_ELNO'
