...
C
      INTEGER JDIM,NBTNO,JNON,I,JNOM,INOEU,NBNO,NBTGNO,NBNOGR,JNAME,
     &     JVAL1,JVAL2,J,JGNOI,JGNOU,K,KK,JNOGR,JNOMG,JREFE,IRET,IJ
      CHARACTER*1 KBID
...
C           DANS LA NOUVELLE SD MAILLAGE
            ...
            CALL JELIRA(JEXNOM(MAIN//'.GROUPENO',NOM),'LONMAX',
     &           NBNOGR,KBID)
...
C           ON AJOUTE DANS '.GROUPENO' LES NUMEROS DES NOEUDS
            IF(NBNOGR.NE.0)THEN
               ...
               CALL JEECRA(JEXNOM(GRPNO,NOM),'LONMAX',NBNOGR,KBID)
