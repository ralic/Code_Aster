...
C---------------- COMMUNS NORMALISES JEVEUX --------------------------
      ...
      CHARACTER*80 ZK80
C
      PARAMETER (MAXNOD=32,NBTYMX=35,MAXFA=6)
...
C
      CALL JENONU(JEXNOM('&CATA.TE.NOMTE','MEGRDKT'),IEL)
      IF (IEL.NE.0) ZI(JCOD2-1+IEL)=91
C
