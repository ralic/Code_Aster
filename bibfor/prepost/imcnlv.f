      SUBROUTINE IMCNLV(IFM,NOMSDZ,OPTIOZ,NBNO,LISNOZ,NBCMP,LISCMZ,
     &                  NBCHIF,EPS)
...
C     IMCNLV  -- IMPRESSION DE LA MATR_ASSE DE NOM NOMSD, COMPLEXE,
...
C --- BOUCLE SUR LES BLOCS INF (LIGNES OU SOUS_MATRICE)
C ---         OU LES BLOCS SUP (COLONNES) DE LA MATRICE :
C             -----------------------------------------
