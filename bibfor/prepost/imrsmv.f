      SUBROUTINE IMRSMV(IFM,NOMSDZ,OPTIOZ,NBNO,LISNOZ,NBCMP,LISCMZ,
     &                  NBCHIF,EPS)
...
C     IMRSMV  -- IMPRESSION DE LA MATR_ASSE DE NOM NOMSD, REELLE,
