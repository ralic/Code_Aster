...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX --------------------------
      ...
      CHARACTER*14 NUDDL
      CHARACTER*16 NOMCH,NOIDEA,CONCEP
      CHARACTER*19 CHS,LISTR8,LISTIS,LIGREL,PRCHNO
...
C  REEL OU COMPLEXE
      ...
      IF (.NOT.ZCMPLX) THEN
        IF (TYPRES.EQ.'DYNA_HARM' .OR. TYPRES.EQ.'HARM_GENE') THEN
