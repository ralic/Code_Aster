...
C MODIF PREPOST  DATE 14/11/2006   AUTEUR ANDRIAMBOLOLONA H.ANDRIAMBOLOLONA 
C ======================================================================
...
C  SI ON NE LE TROUVE PAS VIA NXXXX
          ...
          IF (INOAST.GT.NBNOEU) THEN
            CALL UTDEBM('F','LRIDEA','NOEUD INCONNU DANS LE FICHIER'//
     &                  ' IDEAS')
...
C  SI ON NE LE TROUVE PAS VIA MXXXX
          ...
          IF (IELAST.GT.NBELEM) THEN
            CALL UTDEBM('F','LRIDEA','ELEMENT INCONNU DANS LE'//
     &                  'FICHIER IDEAS')
...
C      IF ((TYPRES.EQ.'MODE_MECA').OR.(TYPRES.EQ.'MODE_MECA_C')) THEN
C       CALL RSADPA(RESU,'E',1,'AMOR_REDUIT',IORD,0,LAMRE,K8BID)
C       ZR(LAMRE) = ZERO
C      ENDIF
