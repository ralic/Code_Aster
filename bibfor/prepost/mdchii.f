...
C
      ...
      INTEGER TYPECH, NBCMP, JCMP, JUNIT
      LOGICAL ILOCAL
C
      CHARACTER*8 SAUX08
      CHARACTER*16 FIUNIN
...
C
      IF ( EXISTC.NE.1 ) THEN
        CALL MFNCHA( IDFIMD, 0, NCHMED, CODRET )
        CALL U2MESK('F+', 'MED_57', 1, NOCHMD(1:LNOCHM))
        DO 50, IAUX = 1, NCHMED
          CALL MFNCHA( IDFIMD, IAUX, NBCMP, CODRET )
...
C====
C
      CALL MFNPDT ( IDFIMD, NOCHMD, TYPENT, TYPGEO, NBTV, CODRET )
C
      IF ( CODRET.NE.0 ) THEN
        SAUX08='MFNPDT  '
        CALL U2MESG('F','DVP_97',1,SAUX08,1,CODRET,0,0.D0)
...
C
C         CALL MFPDTI ( IDFIMD, NOCHMD, TYPENT, TYPGEO, IAUX,
C      >                FIMAIL, FINBPG, FINUPT, FIUNIN, FIINST, FINUNO,
C      >                CODRET )
        CALL MFPDTI ( IDFIMD, NOCHMD, TYPENT, TYPGEO, IAUX,
