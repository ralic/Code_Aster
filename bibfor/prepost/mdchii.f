...
C MODIF PREPOST  DATE 20/06/2011   AUTEUR SELLENET N.SELLENET 
C ======================================================================
...
C
      ...
      INTEGER FINUPT, FINUNO
      INTEGER ADNUME, ADINST, NCHMED
      INTEGER TYPECH, NBCMP, JCMP, JUNIT, NSEQCA, NPRO
      LOGICAL ILOCAL
C
      CHARACTER*8 SAUX08
      CHARACTER*64 SAUX64,NOMCHA,NOMPRF,NOMLOC,NOMAM2
C
      REAL*8 FIINST
C
      CALL JEMARQ()
