...
!
    ...
    integer :: nbmato, nbma, nbno, lima(nbma), nbtyma, nbref(*), nofils(3, *)
...
! ======================================================================
! ----------------------------------------------------------------------
!           MISE A JOUR DES MAILLES (CREA_MAILLAGE PENTA15_18)
! ----------------------------------------------------------------------
...
20  end do
!
! --- IMPRESSION DU NOMBRE DE MAILLES PENTA15_18
!
    if (niv .ge. 1) then
        write(ifm,1000) 1
        do 30 m = 1, nbtyma
