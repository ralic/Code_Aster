      SUBROUTINE EXTCHN ( NCHMNO, NCHMNN, SENSOP, NNOEUD, NUMND, NCMP,
     &                    NBN, NBC, INDIC, NSSCHN, MCF, IOCC )
      IMPLICIT   NONE
      INTEGER             NBN, NBC, NUMND(*), IOCC
      CHARACTER*6         INDIC
      CHARACTER*8         NNOEUD(*), NCMP(*)
      CHARACTER*18 SENSOP
      CHARACTER*19        NCHMNO, NCHMNN, NSSCHN
      CHARACTER*(*)       MCF
C***********************************************************************
...
C                     ON EXTRAIT
C
C       NCHMNN (IN) : NOM DE LA SD NOMINALE DANS LE CAS DE SENSIBILITE
C
