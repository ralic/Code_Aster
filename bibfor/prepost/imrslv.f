      SUBROUTINE IMRSLV(IFM,NOMSDZ,OPTIOZ,NBNO,LISNOZ,NBCMP,LISCMZ,
     &                  NBCHIF,EPS)
...
C     IMRSLV  -- IMPRESSION DE LA MATR_ASSE DE NOM NOMSD, REELLE,
C                SYMETRIQUE ET STOCKEE EN LIGNE DE CIEL
C                DANS LE IFMR DE NOM IFMR.
