...
C MODIF PREPOST  DATE 14/10/2008   AUTEUR DELMAS J.DELMAS 
C ======================================================================
...
C       PREFERENCES POUR LE NOMAGE DES NOUVELLES ENTITES
        CALL GETVID(' ','PREF_NOEUD_X' ,1,1,1,PREFNO(1),IBID)
        CALL GETVID(' ','PREF_NOEUD_M' ,1,1,1,PREFNO(2),IBID)
        CALL GETVID(' ','PREF_NOEUD_P' ,1,1,1,PREFNO(3),IBID)
        CALL GETVID(' ','PREF_MAILLE_X',1,1,1,PREFNO(4),IBID)
