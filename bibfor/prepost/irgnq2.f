      SUBROUTINE IRGNQ2 ( IFI, NBORDR, COORD, CONNEX, POINT, NOCMP, 
     +                    NJVQUA, NBQUA, CNSC, CNSL, CNSV, CNSD )
      IMPLICIT NONE
C
      INTEGER        NBQUA, IFI, NBORDR, CONNEX(*), POINT(*),
     +               CNSC(*), CNSL(*), CNSV(*), CNSD(*)
      REAL*8         COORD(*)
      CHARACTER*8    NOCMP
      CHARACTER*(*)  NJVQUA
...
C
      INTEGER      IQUA, IMA, IPOIN, LISTNO(4), J, JCNSC, JCNSL, JCNSV,
     +             JCNSD, NCMP, K, JQUA, IOR, INOE
      REAL*8       VALE
C     ------------------------------------------------------------------
C
      CALL JEMARQ()
