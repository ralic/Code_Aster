      SUBROUTINE IMRSLN(FICHIE,NOMSDZ,OPTIOZ,NBNO,LISNOZ,NBCMP,LISCMZ,
     &                  NBCHIF,EPS)
...
C      IMRSLN -- IMPRESSION DE LA MATR_ASSE DE NOM NOMSD, REELLE,
...
C         ------------------------------------------------------
   ...
   30     CONTINUE
          ...
          IF (NUBLOC.EQ.0) THEN
            CALL UTMESS('F','IMRSLN','PROBLEME DANS LA RECUPERATION'//
...
C           -----------------------------------------------------
          CALL IMPFR2(NOMNO1,NOMCM1,NBNOMA,LONLI2,ZK8(IDNOMN),
