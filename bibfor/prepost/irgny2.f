      SUBROUTINE IRGNY2 ( IFI, NBORDR, COORD, CONNEX, POINT, NOCMP, 
     +                    NJVPYR, NBPYR, CNSC, CNSL, CNSV, CNSD )
      IMPLICIT NONE
C
      INTEGER        NBPYR, IFI, NBORDR, CONNEX(*), POINT(*),
     +               CNSC(*), CNSL(*), CNSV(*), CNSD(*)
      REAL*8         COORD(*)
      CHARACTER*8    NOCMP
      CHARACTER*(*)  NJVPYR
...
C
      INTEGER      IPYR, IMA, IPOIN, LISTNO(5), J, JCNSC, JCNSL, JCNSV,
     +             JCNSD, NCMP, K, JPYR, IOR, INOE
      REAL*8       VALE
C     ------------------------------------------------------------------
C
      CALL JEMARQ()
...
C
      DO 10 IPYR = 1 , NBPYR
         ...
         DO 12 J = 1 , 3          
            WRITE(IFI,1000) (COORD(3*(LISTNO(INOE)-1)+J),INOE=1,5)
 12      CONTINUE
C
         DO 14 IOR = 1 , NBORDR
