     ...
     &            VMIN,VMAX, OMIN, OMAX,POST,CUDOMX,VNORMX, NBPLAN)
...
C                     CYCLES ELEMENTAIRES POUR TOUS LES VECTEURS
C                     NORMAUX.
C  VNORMX   OUT  I  : NUMERO DU PREMIER VECTEUR NORMAL ASSOCIE AU 
C                     MAX DES CUMULS DE DOMMAGE.
C  VNORMX2   OUT  I : NUMERO DU DEUXIEME VECTEUR NORMAL ASSOCIE AU 
C                     MAX DES CUMULSDE DOMMAGE.
C  CUDOMX   OUT  R  : VALEUR DU MAX DES CUMULS DE DOMMAGE
C  NBPLAN   OUT  I  : NOMBRE DE PLAN MAX DOMMAGE
C ----------------------------------------------------------------------
C     ------------------------------------------------------------------
