     ...
     &                  LISTGR,DIRGRM,NIVGRM,RESUCO,NGFON,COMPS1,COMPS2)
...
C TOLE CRP_21
      ...
      CHARACTER*8   MO,MALINI,MAXFEM,RESUCO
      CHARACTER*19  CNS1,CNS2,CES1,CES2,CESVI1,CESVI2
      CHARACTER*19  COMPS1,COMPS2
      CHARACTER*24  MAILX,LISTGR,DIRGRM,NIVGRM,GPPTNN,NOGRFI
C
...
C       COMPS2 : CHAM_ELEM_S DU COMPORTEMENT EN SORTIE
      ...
      CHARACTER*8   K8B,TYPESE(6),ELREFP,LIREFE(10)
      CHARACTER*8   TYPMA,NOMA
      CHARACTER*16  TYSD,K16B,NOMCMD,NOTYPE
      CHARACTER*19  CHS(11)
      CHARACTER*24  DIRNO,GEOM,LINOFI,GRPNOE,LSN,LST,FISNO,HEA,NOGNO
      LOGICAL       OPMAIL,ISELLI,LMECA,XISMEC
...
C     LE RESULTAT EN ENTREE DE POST_CHAM_XFEM EST-IL MECANIQUE
...
C       ET RECUPERATION DES CONTRAINTES 1
     ...
     &             DDLC,NBCMP,CMP,LMECA)
          ...
          IF (TYSD(1:9).NE.'MODE_MECA'.AND.
     &        TYSD(1:9).NE.'EVOL_THER') THEN
...
C         BOUCLE D'INTEGRATION SUR LES NSE SOUS-ELEMENTS
 ...
 150      CONTINUE
     ...
     &            ELREFP,JLSN,JLST,TYPMA,IGEOM,JFISNO,ZI(JXC),
     &            CMP,NBCMP,NFH,NFE,DDLC,JCNSV1,JCNSV2,JCNSL2,LMECA)
          IF(.NOT.OPMAIL) THEN
            IF (TYSD(1:9).NE.'MODE_MECA'.AND.
     &          TYSD(1:9).NE.'EVOL_THER') THEN

C             ON AJOUTE DES CONTRAINTES
              CALL XPOAJC(NSE,INM,INMTOT,NBMAC,ISE,NPG,
     &                    JCESD1,JCESD2,JCVID1,JCVID2,IMA,NDIM,NDIME,
     &                    IADC,IADV,JCESV1,JCESL2,JCESV2,JCVIV1,
     &                    JCVIL2,JCVIV2)

             CALL XPOCOX(NBMAC,IMA,INMTOT,NBCMPC,JRESD1,JRESV1,JRESL1,
...
C      IF (.NOT.OPMAIL) CALL IMPRSD('CHAMP',COMPS2,6,'COMPS2')
