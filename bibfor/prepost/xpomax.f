...
C---------------- FIN COMMUNS NORMALISES  JEVEUX  ----------------------
      ...
      INTEGER       JCNSE,IAD4,HE(4),NSEMAX(3),IAD3,JMAIL,ITYPEL,NBELR
      ...
      CHARACTER*24  DIRNO,GEOM,LINOFI,GRPNOE,LSN,LST,FISNO
      LOGICAL       OPMAIL,ISMALI
      INTEGER       IAD9,IRESE,NNOSE,TABSE(6)
...
C         BOUCLE D'INTEGRATION SUR LES NSE SOUS-ELEMENTS
          DO 140 ISE=1,NSE
            ...
            DO 150 IFISS = 1,NFISS
              HE(IFISS) = ZI(JCESV(4)-1+IAD4-1+
     &                     (NSEMAX(NDIME)*(IT-1)+ISE-1)*NFISS +IFISS)
 150        CONTINUE
            JCNSE = JCESV(2)-1+IAD2
            CALL XPOAJM(MAXFEM,JTYPM2,ITYPSE(NDIME+IRESE),JCNSE,IM,N,
     &              NNOSE,PREFNO,JDIRNO,NNM,INM,INMTOT,NBMAC,HE,JNIVGR,
     ...
     &              ELREFP,JLSN,JLST,JCESV(5)+IAD5-1,TYPMA,IGEOM,JFISNO,
