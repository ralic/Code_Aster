...
C---------------- FIN COMMUNS NORMALISES  JEVEUX  ----------------------
      ...
      INTEGER       JCESD(8),JCESV(8),JCESL(8),IAD,JCONX1,JCONX2,NBNOMA
      ...
      INTEGER       IGEOM,DDLH,NFE,DDLC,CMP(50),JCNSD1,IAD7,NINTER,IAD8
      ...
      CHARACTER*19  CHS(8),CNSLN,CNSLT
...
C       1ER ELEMENT DE REFERENCE ASSOCIE A LA MAILLE
     ...
     &      .AND. NDIM.LE.2) THEN
        ...
        IF (NOTYPE(9:11).EQ.'XHC'.OR.NOTYPE(6:8).EQ.'XHC'
     &      .OR. NOTYPE(9:11).EQ.'XTC'.OR.NOTYPE(6:8).EQ.'XTC'
     &      .OR. NOTYPE(9:12).EQ.'XHTC'.OR.NOTYPE(6:9).EQ.'XHTC') THEN
          CHS(7)  = '&&XPOMAX.PLONCH'
          CALL CELCES(MO//'.TOPOFAC.LO','V', CHS(7))
          CALL JEVEUO(CHS(7)//'.CESD','L',JCESD(7))
          CALL JEVEUO(CHS(7)//'.CESV','E',JCESV(7))
          CALL JEVEUO(CHS(7)//'.CESL','L',JCESL(7))
          CHS(8)  = '&&XPOMAX.PAIN'
          CALL CELCES(MO//'.TOPOFAC.AI','V', CHS(8))
...
C       SUR LES MAILLES PORTEUSES DE DDL DE CONTACT
     ...
     &      .OR. NOTYPE(9:11).EQ.'XTC'.OR.NOTYPE(6:8).EQ.'XTC'
     &      .OR. NOTYPE(9:12).EQ.'XHTC'.OR.NOTYPE(6:9).EQ.'XHTC') THEN
          CALL CESEXI('C',JCESD(7),JCESL(7),IMA,1,1,1,IAD7)
          NINTER=ZI(JCESV(7)-1+IAD7)
          CALL CESEXI('C',JCESD(8),JCESL(8),IMA,1,1,1,IAD8)
        ENDIF
...
C         CONSERVE LA NUMEROTATION DES NOEUDS
     ...
     &                  TYPMA,J,CO,IGEOM,NINTER,JCESV(8),IAD8,
...
C       ON AJOUTE LES POINTS MILIEUX
     ...
     &                    TYPMA,J,CO,IGEOM,NINTER,JCESV(8),IAD8,
     &                    NDIME,NDIM,CMP,NBCMP,DDLH,NFE,DDLC,IMA,
     &                    JCONQ1,JCONQ2,JCNSV1,JCNSV2,JCNSL2,NBNOC,
     &                    INNTOT)
            ENDIF
 121      CONTINUE
        ENDIF
