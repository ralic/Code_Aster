      SUBROUTINE LRVCPG(IDFIMD,NBPGM,NBPGA,DIME,ELREFA,ELREFM,FAPG,NLOC,
     &                  PERMU,NUTYMA,CODRET)
C
...
C-----------------------------------------------------------------------
      ...
      INTEGER NBPGM,NBPGA,DIME,NLOC,NUTYMA,IDFIMD
      INTEGER PERMU(NBPGM),CODRET
      CHARACTER*8 ELREFA,ELREFM,FAPG
...
C -------------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ----------------
      INTEGER VALI(2),JCOPGA,JWPGA,NDIM,NBFPG,NUREF,JNUREF,ILOC
      INTEGER TYPGEO,IBID,IRET,NNOREF,NPGREF,JREFCO,JGSCOO,JWG,JCORRE
      INTEGER NCORRE,IGAU,IDIM,AD,IPGM,IPGA,ADA,IM,IFM,NIVINF,NDIM2
      CHARACTER*8 VALK(3)
      CHARACTER*64 LOCNAM
      INTEGER EDFUIN
      PARAMETER (EDFUIN=0)
...
C     -------------------------------
     ...
     &             NBPGA,JWPGA)
      CALL ELRAGA(ELREFA,FAPG,NDIM,NBFPG,ZR(JCOPGA),ZR(JWPGA))

C     NUMERO DU TYPE DE MAILLE DE L'ELEMENT DE REFERENCE : NUTYMA
      CALL JENONU(JEXNOM('&CATA.TM.NOELRF',ELREFA),NUREF)
      CALL JEVEUO('&CATA.TM.TMELRF','L',JNUREF)
      NUTYMA=ZI(JNUREF+NUREF-1)
...
C
      DO 130 ILOC=1,NLOC
         CALL MFGAUI(IDFIMD,ILOC,LOCNAM,TYPGEO,IBID,NDIM2,IRET)
