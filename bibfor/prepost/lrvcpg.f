      SUBROUTINE LRVCPG(IDFIMD,NBPGM,NBPGA,ELREFA,ELREFM,FAPG,NLOC,
     &                  PERMU,NUTYMA,CODRET)
C
...
C-----------------------------------------------------------------------
      ...
      INCLUDE 'jeveux.h'
      INTEGER NBPGM,NBPGA,NLOC,NUTYMA,IDFIMD
...
C
C
      INTEGER VALI(2),JCOPGA,JWPGA,NDIM,NBFPG,NUREF,JNUREF,ILOC,DIME
...
C
      DO 130 ILOC=1,NLOC
         CALL MFGAUI(IDFIMD,ILOC,LOCNAM,TYPGEO,IBID,NDIM,IRET)
