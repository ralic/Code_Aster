      SUBROUTINE IRGNE2 ( IFI, NBORDR, COORD, CONNEX, POINT, NOCMP,
     +                    NJVTET, NBTET, CNSC, CNSL, CNSV, CNSD )
      IMPLICIT NONE
C
      INTEGER        NBTET, IFI, NBORDR, CONNEX(*), POINT(*),
     +               CNSC(*), CNSL(*), CNSV(*), CNSD(*)
      REAL*8         COORD(*)
      CHARACTER*8    NOCMP
      CHARACTER*(*)  NJVTET
...
C
      INTEGER      ITET, IMA, IPOIN, LISTNO(4), J, JCNSC, JCNSL, JCNSV,
     +             JCNSD, NCMP, K, JTET, IOR, INOE
      REAL*8       VALE
C     ------------------------------------------------------------------
C
      CALL JEMARQ()
...
C
      DO 10 ITET = 1 , NBTET
         ...
         DO 12 J = 1 , 3          
            WRITE(IFI,1000) (COORD(3*(LISTNO(INOE)-1)+J),INOE=1,4)
 12      CONTINUE
C
         DO 14 IOR = 1 , NBORDR
