...
C         - NCMP : NOMBRE DE CMPS SUR LE NOEUD INO
  ...
  72    CONTINUE
        ...
        IF(NBCMPT.GT.0) THEN
          ...
          LGCOMP=LXLGUT(NOCMP)
          IF(.NOT.LRESU) THEN
            CALL UTMESS('A','IRDEEC',' IMPR_RESU FORMAT ENSIGHT :'//
...
C                 CHERCHER SON RANG DANS LE .NUEQ DU PROFIL AUX NOEUDS
  ...
  24      CONTINUE
          ...
          CLOSE(IFI3)
          IF(LNULSC) THEN
            CALL UTMESS('A','IRDEEC','IMPRESSION DE LA COMPOSANTE '
...
C           - IVAL : ADRESSE DU DEBUT DU NOEUD INO DANS .NUEQ
  ...
  34      CONTINUE
          ...
          IF(LNULVC) THEN
            ...
            LGCMP2=LXLGUT(NOCMP2)
            LGCMP3=LXLGUT(NOCMP3)
            CALL UTMESS('A','IRDEEC','IMPRESSION DES 3 COMPOSANTES '//
...
C           - ON ECRIT LES FICHIERS VIDES DE VALEURS QUI SUIVENT
 ...
 205          CONTINUE
  ...
  30    CONTINUE
      ...
      GOTO 999
 101  CONTINUE
      CALL UTMESS('E','IRDEEC','PROBLEME A L''OUVERTURE DU'//
