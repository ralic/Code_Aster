...
C MODIF PREPOST  DATE 03/10/2011   AUTEUR SELLENET N.SELLENET 
C ======================================================================
...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX --------------------------
      ...
      REAL*8 R8B
      CHARACTER*1 K1B
      CHARACTER*8 SAUX08,NOMAST(NTYMAX),NOMA,K8B
...
C     =================================
C
      CALL GETVIS(' ','UNITE',0,IARG,1,MFICH,IRET)
      ...
      ENDIF
      CALL MFMAAI( IDFIMD,INDIC, NOMAMD, KAUX, TYAUX, DAUX, IRET )
 ...
 20   CONTINUE
      ...
      CALL JEVEUO(NOMA//'.TYPMAIL','L',JTYMAS)
      DO 30 I=1,NBMA
