...
C       NOMCMC : SD DES NOMS DES COMPOSANTES A CONTROLER (K8)
...
C
        EXISTC = 1
C
C 2.3. ==> SI LE CHAMP EST CORECTEMENT CREE, COMBIEN A-T-IL DE VALEURS
...
C
      ELSE
C
        CALL UTMESS ( 'F', NOMPRO, 'PROBLEME DANS LE DIAGNOSTIC.' )
C
      ENDIF
C
      END
