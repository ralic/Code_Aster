      SUBROUTINE XPODIM(MALINI,MAILC,NSETOT,NNNTOT,NCOTOT,LISTNO,
     &                  CNS1,CNS2,CES1,CES2,CEL2,CESVI1,CESVI2,
...
C TOLE CRP_21
      ...
      CHARACTER*24  MAILC,LISTNO,LOGRMA,DIRGRM
...
C---------------- FIN COMMUNS NORMALISES  JEVEUX  ----------------------
      ...
      INTEGER       NDIM,JORD,IORD,I,IFM,NIV,NMAXSP,NMAXCM
      INTEGER       JCNSK1,JCVID1,JNBPT,JCESD2
      INTEGER       JCNSK2,JCNSD2,JCNSC2,JDIRGR
      INTEGER       IRET1,NBGMA,N,JLOGMA,NBGMA1,NBGMA2,CPTGR2
      CHARACTER*1   KBID
      CHARACTER*4   NOMCHA
      CHARACTER*8   K8B,LDEP3(6),LDEP2(4),MODVIS,NOGMA
      CHARACTER*16  TYSD,K16B,NOMCMD,NOMCH1
