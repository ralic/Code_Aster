      SUBROUTINE IMCNMV(FICHIE,NOMSDZ,OPTIOZ,NBNO,LISNOZ,NBCMP,LISCMZ,
     &                  NBCHIF,EPS)
...
C     IMCNMV  -- IMPRESSION DE LA MATR_ASSE DE NOM NOMSD, COMPLEXE,
