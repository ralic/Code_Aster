...
!   ----------------------
    ...
    if (poum .eq. 'REF') then
        ...
        valvrc=zr(itabr(1) -1 + (kpgvrc-1)*ca_nbcvrc_ + kcvrc)
        ...
        nbsp=itabp(7)
        kpgvrc=(kpgmat-1)*nbsp+ksp
        valvrc=zr(itabp(1) -1 + (kpgvrc-1)*ca_nbcvrc_ + kcvrc)
        ...
        nbsp=itabm(7)
        kpgvrc=(kpgmat-1)*nbsp+ksp
        valvrc=zr(itabm(1) -1 + (kpgvrc-1)*ca_nbcvrc_ + kcvrc)
        ...
        nbsp=itabm(7)
        kpgvrc=(kpgmat-1)*nbsp+ksp
        valvrm=zr(itabm(1) -1 + (kpgvrc-1)*ca_nbcvrc_ + kcvrc)
