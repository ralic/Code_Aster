...
!              -- C'EST OK
            else if ((dmpsk%infog(1).eq.-5).or.(dmpsk%infog(1).eq.-7))&
        then
...
! ---  ICNTL(14): ON MODIFIE DES PARAMETRES POUR LA NOUVELLE TENTATIVE
                        ...
                        if ((iaux.eq.-9) .or. (ifact.eq.(ifactm-1))) dmpsk%icntl(22)=1
