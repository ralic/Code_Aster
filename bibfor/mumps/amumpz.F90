...
!       -----------------------------------------------------
         if (.not.lpb13) call amumpu(1, 'Z', kxmps, usersm, ibid,lbid, k24bid, nbfact)
...
!       ------------------------------------------------
        call amumpu(2, 'Z', kxmps, k12bid, nprec, lresol, k24bid, ibid)
!
!       ------------------------------------------------
!        RECUPERATION DU DETERMINANT SI NECESSAIRE:
!       ------------------------------------------------
        call amumpu(4, 'Z', kxmps, k12bid, ibid, lbid, k24bid, ibid)
!
