      SUBROUTINE NMOP45(IER,MATRIG,MATGEO,DEFO,OPTION,RESULT,
     &                  NFREQ,BANDE,MOD45,PARTPS)
C-----------------------------------------------------------------------
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGELINE  DATE 22/10/2007   AUTEUR GREFFET N.GREFFET 
C ======================================================================
...
C VARIABLES LOCALES
     ...
     &        IADZ,IER1,IFM,ITEMAX,IADRH,IBID,IERD,IFREQ,NUMAR2
     ...
     &        LMATRA,LONWL,LMET,ITYP,IORDRE,NBVEC2,ICOEF,JINFO
      INTEGER NPIVOT,NBVECT,PRIRAM(8),MAXITR,NEQACT,MFREQ,NBORTO,NFREQ,
     &        NITV,NPARR,NBCINE,NITQRM,NBRSS,NITBAT,NIV,MXRESF,NBLAGR,
     &        NPERM,NITJAC,NNFREQ,NPREC,N1,NSTOC,NCONV,IEXIN,LBORFR
      CHARACTER*1 KTYP
      INTEGER LWORKR,LAUR,LAUC,LAUL,LJEVEU,NUMARC,IM
     ...
     &       R8MAEM,FREQA,FREQM,FREQV,FREQR
      ...
      CHARACTER*8 RESULT
      CHARACTER*16 TYPCON,NOMCMD,OPTION,TYPRES,K16BID,VARACC
...
C  ARCHIVAGE
   ...
   60 CONTINUE
      ...
      VALR = ZR(LJEVEU)
      VALI = IM
      CALL U2MESG('I', 'ALGELINE4_32',0,' ',1,VALI,1,VALR)
