...
!      alpha=-alpha
   ...
   10     continue
      ...
      if (alpha.lt.0.d0) then
          ...
          call vpgskp(nbeq,nconv,vect,alpha,lmatb,typeps,vaux,ddlexc,delta)
          goto 72
      endif
...
! gardes-fous
          ...
          if ((lcheck).or.(niv.ge.2)) write(ifm,*)'<vpgsmm> paquet modes multiples n',i,iauxi,nconvl
          call vpgskp(nbeq,nconvl,vect(1,iauxi),alpha,lmatb,typeps,vaux,ddlexc,delta)
