      SUBROUTINE RECTFR(NBMODE,NBVECT,NEQ,OMESHI,NPIVOT,NBLAGR,VALPRO,
     +                  NVPRO,RESUFI,RESUFR,NFREQ)
      IMPLICIT   NONE
      INTEGER           NBMODE,NBVECT,NEQ,NPIVOT,NBLAGR,NVPRO,NFREQ
      INTEGER           RESUFI(NFREQ,*)
      REAL*8            FSHIFT,VALPRO(NVPRO),RESUFR(NFREQ,*)
C     ------------------------------------------------------------------
...
C     IN  : NEQ     : NOMBRE D EQUATION DU SYSTEME TOTAL
