     ...
     &   DDLEXC, DDLLAG, VECDDL, NBDDL, NEQACT, MAXITR, 
     &   IFM, NIV, PRIRAM, ALPHA,OMECOR, NCONV, FLAGE, SOLVEU,  
     &   NSTA, DDLSTA, VSTAB, CSTA, REDEM)
C---------------------------------------------------------------------
...
C IN  VECDDL :    : VECTEUR POSITION DES DDLES A EXCLURE
C IN  NBDDL  : IS : NOMBRE TOTAL DE DDLS EXCLUS
...
C IN  VECDDL : IS : VECDDL(1..NBEQ) VECTEUR POSITION DE DDL.
C IN  NBDDL  : IS : NOMBRE DE DDL EXCLUS DE LA RECHERCHE DE VALEURS
C                   PROPRES
C
...
C IN  NSTA   : IS : NOMBRE DE DDL STAB
C IN  DDLSTA : IS : VECT(1..NBEQ) POSITION DES DDL STAB
C OUT VSTAB  : R8 : VECT(1..NBEQ) MODE DE STABILITE
C OUT CSTA   : R8 : VALEUR CRITERE DE STABILITE
C IN/OUT REDEM : IS : NOMBRE REDEMARRAGES METHODE SORENSEN
C
C----------------------------------------------------------------------
...
C CALCUL DES VALEURS PROPRES DE (OP)
     ...
     &   ALPHA,NSTA,DDLSTA,VSTAB,CSTA,LDYNFA,DDLEXC,REDEM)
...
C 
C--------------ELIMINATION DDL DANS RECHERCHE DE VP---------------- 
C     
        IF (NBDDL.NE.0) THEN
          DO 42 J=1,NBEQ
