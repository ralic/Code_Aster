...
C     ---------------------------------------------------------------
     ...
     +                 'MAILLAGE', K8B, IBID, R8B, C16B, NOMA, IRET )
      ENDIF
      IF ( IRET .NE. 0 ) CALL UTMESS('F','CHCOMA','Y A UN BUG 0' )
      CALL TBLIVA ( TABLE, 1, 'LIEU', IBID, R8B, C16B, NOMA, K8B,
     +              R8B, 'CDG_X', K8B, IBID, XG, C16B, K8B, IRET )
      IF ( IRET .NE. 0 ) CALL UTMESS('F','CHCOMA','Y A UN BUG 1' )
      CALL TBLIVA ( TABLE, 1, 'LIEU', IBID, R8B, C16B, NOMA, K8B,
     +              R8B, 'CDG_Y', K8B, IBID, YG, C16B, K8B, IRET )
      IF ( IRET .NE. 0 ) CALL UTMESS('F','CHCOMA','Y A UN BUG 2' )
C
...
C     ------------------------------------
     ...
     +              R8B, 'ALPHA', K8B, IBID, ALPHA, C16B, K8B, IRET )
      IF ( IRET .NE. 0 ) CALL UTMESS('F','CHCOMA','Y A UN BUG 3' )
C
