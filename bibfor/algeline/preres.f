...
C                   (CAS DE FETI OU DE MUMPS SI NPREC<0 ET SI LA FACTO
C                    EST OK)
...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
     ...
     &             IRET,NBSDF,IINF,IFCPU,ILIMPI,JREFA,IRETM
      REAL*8       TEMPS(6),RBID
      CHARACTER*24 METRES,SDFETI,INFOFE,K24B,OPT,KPIV
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
     ...
     &                    BASE,INFOFE)
            ...
            ELSE
              RENUM=' '
              IF (METRES.EQ.'MULT_FRO') RENUM=ZK24(ISLVK-1+4)
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
          ELSE IF (METRES.EQ.'PETSC') THEN
            ...
            CALL APETSC('DETR_MAT',' ',MATAS,RBID,' ',0,IRET)
            CALL APETSC('PRERES',SOLVEU,MATAS,RBID,' ',0,IRET)
            IRET=0
