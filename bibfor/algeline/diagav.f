      SUBROUTINE DIAGAV(NOMA19,NEQ,TYPVAR,TYPSYM,TYPSTO,EPS)
      IMPLICIT NONE
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGELINE  DATE 25/11/97   AUTEUR VABHHTS J.PELLET 
C ======================================================================
...
C     ------------------------------------------------------------------
      ...
      INTEGER NEQ,TYPVAR,TYPSYM,TYPSTO,IFM,NIV,IRET,IADIGS,IBID
