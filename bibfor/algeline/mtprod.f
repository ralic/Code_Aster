      SUBROUTINE MTPROD(A,DIMA,I1A,N1A,I2A,N2A,
     &                  B,DIMB,I1B,N1B,I2B,
     &                  C)

C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGELINE  DATE 09/01/2007   AUTEUR ABBAS M.ABBAS 
C ======================================================================
...
C A_UTIL
C ----------------------------------------------------------------------
C        CALCUL DU PRODUIT DE MATRICES C = A(I1A,I2A) * BT(I1B,I2B)
C ----------------------------------------------------------------------
...
C INTEGER  I1B(N1B)   : LISTE D'INDICES POUR LES LIGNES DE B
C                       I1B = 0 : TOUTES LES LIGNES
C INTEGER  N1B        : NOMBRE D'INDICES DANS I1B OU NOMBRE DE COLONNES
C INTEGER  I2B(N2A)   : LISTE D'INDICES POUR LES COLONNES DE B
C                       I2B = 0 : TOUTES LES COLONNES
C
C VARIABLE DE SORTIE
C REAL*8   C(N1A,N1B) : A(I1A,I2A) * BT(I1B,I2B)
C ----------------------------------------------------------------------

      IMPLICIT NONE

C --- VARIABLES
      INTEGER I1A(*),I2A(*),I1B(*),I2B(*),DIMA,DIMB,N1A,N2A,N1B
      INTEGER I,J,K,I0,J0
