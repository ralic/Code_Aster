...
C ======================================================================
      ...
      REAL*8 EPS
      COMPLEX*16  FRONTL(*),T1(*),FRONTU(*),T2(*),ALPHA,BETA
...
C
          ...
          CALL SSPMVC(N-K+1,K-1,FRONTL,AD,T1,FRONTL(ADPER(K)))
          CALL SSPMVC(N-K+1,K-1,FRONTU,AD,T2,FRONTU(ADPER(K)))
          ELSE
          CALL ZGEMV(TRA,NN,KK,ALPHA,FRONTL(K),LDA,T1,INCX,BETA,
     &               FRONTL(ADPER(K)),INCY)
          CALL ZGEMV(TRA,NN,KK,ALPHA,FRONTU(K),LDA,T2,INCX,BETA,
     &               FRONTU(ADPER(K)),INCY)
          ENDIF
       ENDIF
