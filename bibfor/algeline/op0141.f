...
C MATRICE GENERALISEE EN PLUS POUR LES MODES REELS
     ...
     &             IDVEC3)
        ...
        CALL COPMOD(BASE1,'DEPL',NEQ,NU,NBMOD1,'C',RBID,ZC(IDBAS1))
        CALL COPMOD(BASE2,'DEPL',NEQ,NU,NBMOD2,'C',RBID,ZC(IDBAS2))
...
C PB AVEC ZDOTC DE BLAS POUR CERTAIN COMPILO -> CALCUL DIRECT
 ...
 30     CONTINUE
     ...
     &             IDVEC3)
        ...
        CALL COPMOD(BASE1,'DEPL',NEQ,NU,NBMOD1,'R',ZR(IDBAS1),CBID)
        CALL COPMOD(BASE2,'DEPL',NEQ,NU,NBMOD2,'R',ZR(IDBAS2),CBID)
