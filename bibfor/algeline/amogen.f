...
C MODIF ALGELINE  DATE 17/01/2008   AUTEUR ZENTNER I.ZENTNER 
C ======================================================================
...
C     CALL CHEKSD('sd_matr_asse',MASSE,IRET)
C     CALL CHEKSD('sd_matr_asse',RAID,IRET)
...
9999  CONTINUE
      CALL JEDEMA()
C     CALL CHEKSD('sd_matr_asse',MAT19,IRET)
      END
