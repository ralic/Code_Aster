...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      INTEGER IBLO,IDESC,IALIME,IACONL,IAREFE,IAREFA,IADESC,N2,N1
...
41         CONTINUE
     ...
     &                 )
      ...
      NBLOC=1
      IBLO=1
      CALL JEVEUO(MASSE//'           .REFA','E',IAREFA)
C
...
C
     ...
     &                     'CONSTANT',NBLOC)
      ...
      CALL JEECRA(NOMRES//'           .VALE','LONMAX',M,K8BID)
...
170   CONTINUE
      ...
      IBLO=1
      CALL JEVEUO(JEXNUM(MASSE//'           .VALE',IBLO),'L',IAM)
      CALL JEVEUO(JEXNUM(RAID//'           .VALE',IBLO),'L',IAK)
      CALL JEVEUO(JEXNUM(NOMRES//'           .VALE',IBLO),'E',IAMAT)
      DO 180 I=1,M
         ZR(IAMAT-1+I)=0D0
180   CONTINUE
      DO 190 I=1,N
