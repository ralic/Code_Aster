      SUBROUTINE RCISSL(IABLO, IHCOL, IDLEXC, COEF, MATIN, MATRES)
      IMPLICIT REAL*8 (A-H,O-Z)
      INTEGER          IABLO(*), IHCOL(1), IDLEXC(1)
      REAL*8           COEF, MATRES(1)
      COMPLEX*16       MATIN(1)
C     ------------------------------------------------------------------
...
C     STOCKEES EN LIGNE DE CIEL DONT LES VALEURS SONT COMPLEXES 
C     DANS UNE MATRICE RESULTAT A VALEURS REELLES.
C     LE FACTEUR MULTIPLICATIF DE LA COMBINAISON ETANT IMAGINAIRE
C     PUR
C -------------------------------------------------------
...
C                -       -    -   MATRICE MATIN
C                -       -    -   LE COEFFICIENT EST EN FAIT IMAGINAIRE
C                -       -    -   PUR ET C'EST LE COEF REEL DE I QUI
C                -       -    -   PASSE EN ARGUMENT
C -------------------------------------------------------
...
C
             DO 20 IND = 1,ILONG
                    KIN = KIN+1
                    MATRES(KIN) = MATRES(KIN) + COEF*DIMAG(MATIN(KIN))*
