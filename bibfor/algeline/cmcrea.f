...
C ----------------------------------------------------------------------
      ...
      CHARACTER*8  K8B,KNUM8,PREFIX,NOMMA
      CHARACTER*24 LINOMA, LICONN, LITYMA, LINGMA, LIGPMA, GMATPR
      CHARACTER*24 VALK,GNO1,GNO2
      CHARACTER*24 DIMIN,DIMOUT,NMAIN,NMAOUT,TMAIN,TMAOUT,CONIN,CONOUT
      CHARACTER*24 GMAIN,GMAOUT,NOMGMA,GMAPTR
      INTEGER      IARG
...
C    OBJET .GROUPMA
      ...
      CALL JECREC(GMAOUT,'G V I','NO '//GMAPTR,
     &            'DISPERSE','VARIABLE',NBGMTO)
      DO 140 GM = 1,NBGMIN
