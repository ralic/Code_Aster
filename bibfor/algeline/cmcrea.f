...
C ----------------------------------------------------------------------
      ...
      DO 20 I = 1, NBOCC
        ...
        IF (MOTFAC(I) .EQ. 'CREA_FISS') THEN
          ...
          CALL GETVTX(MOTFAC(I),'GROUP_NO_1' ,NUMOCC(I),1,1,GNO1  ,IB)
          CALL GETVTX(MOTFAC(I),'GROUP_NO_2' ,NUMOCC(I),1,1,GNO2  ,IB)
          CALL GETVTX(MOTFAC(I),'NOM'        ,NUMOCC(I),1,1,NOMGMA,IB)
...
C    OBJET .GROUPMA
      ...
      DO 140 GM = 1,NBGMIN
        ...
        CALL JELIRA(JEXNUM(GMAIN ,GM),'LONMAX',NBMA,K8B)
