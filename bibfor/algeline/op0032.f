...
C
      ...
      REAL*8       FMIN,FMAX,PRECDC,FREQOM,MANTIS
      INTEGER       N1, ISLVK, ISLVI, JREFA, NPREC
      INTEGER      EXPO  , PIVOT1, PIVOT2, MXDDL, NBRSS,IERD
      INTEGER      NBLAGR, NBCINE, NEQACT, NEQ
      INTEGER      LTYPRE, L, LBRSS, LMASSE, LRAIDE, LDDL, LDYNAM,
...
C     TYPE_RESU : 'DYNAMIQUE' OU 'FLAMBEMENT'
      ...
      ENDIF
      CALL GETVR8(' ','SEUIL_FREQ',1,IARG,1,FCORIG,L)
      CALL GETVR8(' ','PREC_SHIFT',1,IARG,1,PRECDC,L)
CC
C     --- RECUPERATION DES ARGUMENTS CONCERNANT LA NOMBRE DE SHIFT ---
      CALL GETVIS(' ','NMAX_ITER_SHIFT',1,IARG,1,NBRSS,LBRSS)
C
