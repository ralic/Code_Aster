      SUBROUTINE RLDUR8 ( NOMMAT, HCOL, ADIA , ABLO ,
...
C
         IDERBL=IBLOC+NBBLOC
         CALL JEVEUO( JEXNUM(VALE,IBLOC+NBBLOC),'L',LMAT )
...
C                    XSOL(IXX+I,ISOL)=XSOL(IXX+I,ISOL)+R8VAL*ZR(IDE+I)/
C     1              ZR(LDIAG+IXX+I-1)
 330             CONTINUE
               ENDIF
 320        CONTINUE
 310     CONTINUE
