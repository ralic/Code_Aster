...
C MODIF ALGELINE  DATE 01/04/2008   AUTEUR ABBAS M.ABBAS 
C ======================================================================
...
C ----------------------------------------------------------------------
C
C ROUTINE CONTACT (METHODE DISCRETE - UTILITAIRE)
C
C RETOURNE LE NOMBRE DE NOEUDS MILIEUX POUR UN TYPE D'ELEMENT DONNE
C      
C ----------------------------------------------------------------------
C
C
C IN  NOMTYP : TYPE DE L'ELEMENT
C OUT NBNOMI : NOMBRE DE NOEUDS MILIEUX
C
C ----------------------------------------------------------------------
C
      CHARACTER*8 NOMTYP
