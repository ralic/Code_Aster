      SUBROUTINE IRGMM4 ( NOMAIN, NOMAOU, NBMAT, NUMMAI, BASZ, NJVPOI,
...
C
 ...
 10   CONTINUE
C
      NBMAIL = NBPOI + NBSEG + NBTRI + NBQUA + NBTET + NBPYR
     +      +  NBPRI + NBHEX
C
...
C                 ------------------
               ...
               CALL JEECRA ( JEXNUM( '&&IRGMMA.LISMA', IMA ), 'LONMAX',
     +                    1, K8B )
               CALL JEVEUO ( JEXNUM( '&&IRGMMA.LISMA', IMA), 'E', 
     +                       IDLIMA)
               IMAV = IMAV + 1
               NOMG = 'MA      '
               CALL CODENT ( IMAV, 'G', NOMG(3:8) )
