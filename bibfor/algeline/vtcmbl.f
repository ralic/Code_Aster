...
C DECLARATION VARIABLES LOCALES
     ...
     &             KVALE,KREFE,LVALE,ICONST,JVALE,IVAL,ILIMPI,IFETI
      REAL*8       DIMAG
      COMPLEX*16   C8CST
      CHARACTER*4  DOCU,TYPE,KBID
      CHARACTER*5  REFE,DESC,VALE,FETC
      CHARACTER*8  K8B
...
C OBTENIR LE NOM DU CHAM_NO LOCAL CORRESPONDANT (CH19)  
...
C CHAM_NO RESULTAT A CREER
          ...
          ELSE
C CHAM_NO RESULTAT DEJA EXISTANT A ECRASER
