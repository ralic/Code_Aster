...
C MODIF ALGELINE  DATE 04/05/99   AUTEUR CIBHHGB G.BERTRAND 
C ======================================================================
...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      INTEGER      IBID
      REAL*8       XNORM, DEPL(6)
      CHARACTER*8  MASSE, MODSTA, MAILLA, NOMGR, NOMNOE
...
C
      CALL GETVID(' ','MODE_STAT',0,1,1,MODSTA,NBV)
C
