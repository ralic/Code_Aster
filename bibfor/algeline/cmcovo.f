...
C ----------------------------------------------------------------------
      ...
      CHARACTER*1  K1B
      CHARACTER*8  K8B,KNUME,CDIM,TYPM,MA1,MA2
      CHARACTER*10 KANGL
      ...
      CHARACTER*24 LISMA,NEWMA,GRPNNO,GRPNMA,NOMG
...
C  -------------------------------------------------------------
      ...
      IF (NBGRMN.NE.0) THEN
        ...
        CALL JECREC(GRPMAI,'G V I','NO '//GRPNMA,
...
C  -------------------------------------------------------------
      ...
      IF (IRET.NE.0) THEN
        ...
        CALL JECREC(GRPNOE,'G V I','NO '//GRPNNO,
