...
C         REMONTEE COLONNE PAR COLONNE
          CALL RLTFR8(ZK24(ZI(LMAT+1)),NEQ,NBBLOC,XSOL,NBSOL,TYPSYM)
          ELSE
C         REMONTEE PAR BLOCS
          CALL RLBFR8(ZK24(ZI(LMAT+1)),NEQ,NBBLOC,XSOL,NBSOL,TYPSYM)
          ENDIF
        ELSE IF (TYPVAR.EQ.2) THEN
C                        MULTIFRONTALE COMPLEXE SYMETRIQUE OU NON
          CALL RLFC16(ZK24(ZI(LMAT+1)),NEQ,NBBLOC,XSOL,CXSOL,NBSOL,
     &                TYPSYM)
        END IF
      END IF
   10 CONTINUE
