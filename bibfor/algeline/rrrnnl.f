      SUBROUTINE RRRNNL(IABLO, IHCOL, IDLEXC, COEF, MATINS, MATINI,
     +                  MATRES, MATREI)
...
C MODIF ALGELINE  DATE 02/09/96   AUTEUR CIBHHGB G.BERTRAND 
C ======================================================================
...
C ======================================================================
C -------------------------------------------------------
C     COMBINAISON LINEAIRE DU BLOC COURANT D'UNE MATRICE 
C     NON-SYMETRIQUE DANS UNE MATRICE NON-SYMETRIQUE.
C     LES MATRICES SONT STOCKEES EN LIGNE DE CIEL
C     LES VALEURS DES MATRICES SONT REELLES,
C     LE FACTEUR MULTIPLICATIF DE LA COMBINAISON EST REEL
C -------------------------------------------------------
...
C                -       -    -   DE LA COMBINAISON LINEAIRE
C -------------------------------------------------------
C  MATRES(1)     - VAR   - R  - : BLOC SUP DE LA MATRICE RESULTAT  
C                -       -    -   DE LA COMBINAISON LINEAIRE
C -------------------------------------------------------
C  MATREI(1)     - VAR   - R  - : BLOC INF DE LA MATRICE RESULTAT 
C                -       -    -   DE LA COMBINAISON LINEAIRE
C -------------------------------------------------------
C
...
C
             DO 20 IND = 1,ILONG
                    KIN1 = KIN1+1
                    MATRES(KIN1) = MATRES(KIN1) + COEF*MATINS(KIN1)*
...
C
             DO 30 IND = 1,ILONG
                    KIN2 = KIN2+1
                    MATREI(KIN2) = MATREI(KIN2) + COEF*MATINI(KIN2)*
     +                              (1-IDLEXC(IEQUA-ILONG+IND))*
     +                              (1-IDLEXC(IEQUA))
  30         CONTINUE
C
