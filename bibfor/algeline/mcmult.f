...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      CALL UTMESS('F','MCMULT','STOCKAGE NON PREVU')
      GO TO 110
...
C          -------------------------------------------------------------
      CALL UTMESS('F','MCMULT','COEFFICIENT DE TYPE NON PREVU')
      GO TO 110
C          -------------------------------------------------------------
   20 CONTINUE
C          MATRICE REELLE
...
C             MATRICE SYMETRIQUE
        IF (ZI(LMAT+4).EQ.1) THEN
          ...
          CALL MCMPVR(CUMUL,ZK24(ZI(LMAT+1)),ZI(JJADIA),ZI(IDHCOL),
...
C             MATRICE NON-SYMETRIQUE
        ELSE IF (ZI(LMAT+4).EQ.0) THEN
          CALL MTDSC2(ZK24(ZI(LMAT+1)),'ABLO','L',JJABLO)
          CALL MTDSC2(ZK24(ZI(LMAT+1)),'ADIA','L',JJADIA)
          CALL MCNPVR(CUMUL,ZK24(ZI(LMAT+1)),ZI(JJADIA),ZI(IDHCOL),
     &                ZI(JJABLO),ZI(LMAT+02),ZI(LMAT+13),VECT,XSOL,
     &                NBVECT)
        END IF
      ELSE IF (TYPVEC.EQ.'C') THEN
        CALL MTDSC2(ZK24(ZI(LMAT+1)),'ABLO','L',JJABLO)
        CALL MTDSC2(ZK24(ZI(LMAT+1)),'ADIA','L',JJADIA)
        CALL MCMPVS(CUMUL,ZK24(ZI(LMAT+1)),ZI(JJADIA),ZI(IDHCOL),
     &              ZI(JJABLO),ZI(LMAT+02),ZI(LMAT+13),VECT,XSOL,NBVECT)
      ELSE
        CALL UTMESS('F','MCMULT','TYPE DE VECTEUR NON PREVU')
      END IF
      GO TO 110
C          -------------------------------------------------------------
   30 CONTINUE
...
C             ----------------------------------------------------------
      CALL UTMESS('F','MCMULT','CARACT. DE MATRICE NON PREVUE')
      GO TO 110
C             ----------------------------------------------------------
   40 CONTINUE
...
C             MATRICE COMPLEXE HERMITIENNE
      CALL MTDSC2(ZK24(ZI(LMAT+1)),'ABLO','L',JJABLO)
      CALL MTDSC2(ZK24(ZI(LMAT+1)),'ADIA','L',JJADIA)
      CALL MCMPVZ(CUMUL,ZK24(ZI(LMAT+1)),ZI(JJADIA),ZI(IDHCOL),
     &            ZI(JJABLO),ZI(LMAT+02),ZI(LMAT+13),VECT,XSOL,NBVECT)
      GO TO 110
C       ----------------------------------------------------------------
   60 CONTINUE
...
C          MATRICE REELLE
      CALL MTDSC2(ZK24(ZI(LMAT+1)),'ADIA','L',JJADIA)
      CALL MCMMVR(CUMUL,ZK24(ZI(LMAT+1)),ZI(JJADIA),ZI(IDHCOL),
...
C             MATRICE COMPLEXE SYMETRIQUE
      CALL MTDSC2(ZK24(ZI(LMAT+1)),'ADIA','L',JJADIA)
      CALL MCMMVC(CUMUL,ZK24(ZI(LMAT+1)),ZI(JJADIA),ZI(IDHCOL),
     &            ZI(LMAT+02),VECT,XSOL,NBVECT)
      GO TO 110
C             ----------------------------------------------------------
  100 CONTINUE
C             MATRICE COMPLEXE HERMITIENNE
      CALL MTDSC2(ZK24(ZI(LMAT+1)),'ADIA','L',JJADIA)
      CALL MCMMVZ(CUMUL,ZK24(ZI(LMAT+1)),ZI(JJADIA),ZI(IDHCOL),
     &            ZI(LMAT+02),VECT,XSOL,NBVECT)
      GO TO 110
C             ----------------------------------------------------------
