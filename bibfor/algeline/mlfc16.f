      SUBROUTINE MLFC16(NOMMAT,NPIVOT,NEQ,NBBLOC,ILDEB,ILFIN,TYPSYM,EPS)
      IMPLICIT NONE
...
C ======================================================================
      CHARACTER*(*) NOMMAT
      INTEGER NPIVOT,NEQ,NBBLOC,ILDEB,ILFIN,IRET
      REAL*8 EPS
      INTEGER TYPSYM
      LOGICAL PILMEM
C     ------------------------------------------------------------------
C VERSION COMPLEXE DE MULFR8
...
C--------------------------------------------------------------------
      ...
      CALL WKVECT(NMPRVR,' V V C ',LTEMPR,TEMPR)
...
C     APPEL A MLTFAS1
      IF (PILMEM) THEN
         CALL JEDETR(NOMPR1)
          CALL MLTCC1(NBLOC,ZI(NCBLOC),ZI(DECAL),ZI(LGBLOC),NBSN,
     +                ZI(FILS),ZI(FRERE),ZI(SEQ),ZI(LGSN),ZI(LFRONT),
     +                ZI(ADRESS),ZI(LOCAL),ZI(ADPILE),ZI(NBASS),
     +                ZC(PILE),LGPILE,ZI(TEMPI),ZC(TEMPR),ZC(TABR2),
...
C     ON ALLOUERA UNE COLLECTION DISPERSEE DANS MLTFCB
         SBLOC=1
          CALL MLTCCB(NBLOC,ZI(NCBLOC),ZI(DECAL),ZI(LGBLOC),NBSN,
     +                ZI(FILS),ZI(FRERE),ZI(SEQ),ZI(LGSN),ZI(LFRONT),
     +                ZI(ADRESS),ZI(LOCAL),ZI(ADPILE),ZI(NBASS),
     +                ZI(TEMPI),ZC(TEMPR),ZC(TABR2),FACTOL,FACTOU,
