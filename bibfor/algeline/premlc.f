      SUBROUTINE PREMLC(N1,N2,DIAG,COL,
     +                  PARENT,PAREND,ANC,NOUV,
     +                  SUPND,SUPND2,NOUVSN,ANCSN,P,Q,LBD1,
     +                  LBD2,RL,RL1,RL2,NRL,INVP,PERM,
     +                  INVSUP,LGIND,DDLMOY,NBSND)
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGELINE  DATE 25/03/2002   AUTEUR JFBHHUC C.ROSE 
...
C
      ...
      INTEGER INVP(N1),PERM(N1),INVSUP(N1)
      INTEGER RL(4,*),RL1(*),RL2(*)
C     VARIABLES LOCALES
      INTEGER I,J,T,NADJ,LMAT,IER,IFM,NIV
      INTEGER I1,I2,IDDL,IDDL1,IDDL2,N2,NUM,ISN
