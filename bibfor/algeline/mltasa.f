...
C COMPIL PARAL
      ...
      CHARACTER*(*) NOMMAT
      INTEGER FIN,DEB,MATI,MATS,  IBID , IP,IREFAC,  LGBLIB,IT(1)
C===============================================================
...
C     VERIFICATION DES LONGUEURS
      CALL JEDISP(1,IT)
      IF(LOISEM().EQ.4) IT(1)=IT(1)/2

        DO 5 IB = 1,NBLOC

         LGBLIB = LGBLOC(IB) 

         IF(LGBLIB.GT.IT(1)) THEN
            NI=3
         VALI(1)=IB
         VALI(2)=LGBLIB
         VALI(3)= IT(1)
         CALL U2MESI('F','ALGELINE2_22',NI,VALI)
         ENDIF
