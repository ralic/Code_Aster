...
C     CAS NON-SYMETRIQUE
 ...
 110        CONTINUE
            ...
            FIN = DEB + LGBLOC(IB)
            DEB = DEB + 1
CMIC$ DO ALL SHARED (ADINIT, DEB, FIN, IFACL, IFACU,LONMAT, ZR)
CMIC$*       PRIVATE (I1,CODE,ADPROV) SHARED (MATI,MATS)
            DO 120 I1 = 1,LONMAT
...
C        CAS SYMETRIQUE
 ...
 115        CONTINUE
            ...
            FIN = DEB + LGBLOC(IB)
            DEB = DEB + 1
CMIC$ DO ALL SHARED (ADINIT, DEB, FIN, IFACL, LONMAT, ZR)
CMIC$*       PRIVATE (I1,CODE,ADPROV) SHARED (MATI)
CCDIR$ IVDEP
            DO 125 I1 = 1,LONMAT
               ADPROV = ADINIT(I1)
