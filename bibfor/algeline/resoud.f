...
C --------- FIN  DECLARATIONS  NORMALISEES  JEVEUX ---------------------
      ...
      INTEGER IRET,IRESOL,NITER,LMAT,JVALS,JTRAV,JVAL2
      REAL*8 EPSI,RBID
      LOGICAL DBG
      CHARACTER*1 FTYPE(2)
      DATA FTYPE/'R','C'/
...
C     ----------------------------------
        IF (NSECM.GE.1) CALL U2MESS('F','FACTOR_12')
C       -- ATTENTION : QUAND APETSC SAURA TRAITER RSOLU
C          IL FAUDRA RETIRER LE GOTO 12 (PLUS BAS)
        CALL APETSC('RESOUD',SOLV19,MATR19,SECM19,CSOL19,CINE19)
