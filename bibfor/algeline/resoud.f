...
C     ----------------------------------
     ...
     &       TEMPS(6)
      ...
      IF (DBG) THEN
        OJB=CHSECM//'.VALE'
        CALL DBGOBJ(OJB,'OUI',6,'&&RESOUD 2ND MEMBRE')
        OJB=CHCINE//'.VALE'
        CALL DBGOBJ(OJB,'OUI',6,'&&RESOUD CHCINE')
        OJB=CHSOL//'.VALE'
        CALL DBGOBJ(OJB,'OUI',6,'&&RESOUD SOLU')
C       -- SI ON VEUT VOIR LE CHAMP SOLU COMPLET :
C       CALL IMPRSD('CHAMP',CHSOL,6,'&&RESOUD SOLU')
      ENDIF
