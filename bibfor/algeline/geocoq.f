...
C
      ...
      CHARACTER*32  JEXNOM
C
      INTEGER       IAS,IASCQI,IASCQX,IASEDI,IASMAX,ICMP,ICODE,INDIK8
...
C
      ...
      REAL*8        REXT,RINT,RMOY,TOLE,X2,X3,Z0,LONG
      REAL*8        Z0EXT,Z0INT,Z1,Z1EXT,Z1INT,ZNO
C
      CHARACTER*1   K1BID
      CHARACTER*8   NOMCMP,K8BID
      CHARACTER*24  GRPMA,COORNO,CARTE,CADESC,CAVALE
      CHARACTER*24  COQUEI,COQUEX
      CHARACTER*32  GRPNO,KJEXN
C-----------------------------------------------------------------------
      CALL JEMARQ()
C
...
C
C --- 3.1. CARTE DES CARACTERISTIQUES DES ELEMENTS DE COQUE
...
C
C --- 3.2. GROUPES DE MAILLES ASSOCIES AUX COQUES INTERNE ET EXTERNE
...
C
C --- 3.3. RANG DE LA COMPOSANTE <EP> DANS LA GRANDEUR
...
C
C --- 3.4. VALEUR DE L'EPAISSEUR DE LA COQUE INTERNE
...
50    CONTINUE
      ...
      GEOM(6) = EPINT
C
C --- 3.5. VALEUR DE L'EPAISSEUR DE LA COQUE EXTERNE
