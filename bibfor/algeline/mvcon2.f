      SUBROUTINE MVCON2(MAT,NEQ2,TYPEV,RVECT,NVECT)
...
C ======================================================================
C     SUPPRIMER LE CONDITIONNEMENT DES LAGRANGE SUR LE SECOND MEMBRE
C     ------------------------------------------------------------------
...
C
      IF (TYPEV .EQ. ' ' ) THEN
        CALL JELIRA(JEXNUM(KMAT//'.VALM',1),'TYPE',IBID,TYPE)
      ELSE
        TYPE = TYPEV
      ENDIF
