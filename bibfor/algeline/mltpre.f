...
C
     ...
     &            ZI(PERM),ZI(INVSUP),LGIND,DDLMOY,NBSN,OPTNUM,LGADJN,
     &            LT,NRL,ZI(DEB),ZI(VOIS),ZI(SUIT),IER,NEC,ZI(IPRNO),
...
C     NOUV, ANC : RENUMEROTATION ISSUE DU MD ENTRE TOUS LES DDL.
      ...
      CALL PREMLC(NEQ,N2,ZI(DIAG),ZI(IHCOL),ZI(SEQ),ZI(PAREND),ZI(ANC),
     &            ZI(NOUV),ZI(SUPND),ZI(SUPND2),ZI(TRAV1),ZI(TRAV4),
     &            ZI(P),ZI(Q),ZI(LBD1),ZI(LBD2),ZI(RL),ZI(RL1),ZI(RL2),
     &            NRL,ZI(INVP),ZI(PERM),ZI(INVSUP),LGIND,DDLMOY,NBSN)
      CALL JEDETR(NOMT15)
      CALL JEDETR(NOMT17)
      CALL JEDETR(NOMT18)
      CALL JEDETR(NOMT19)
...
C-----------------------------------------------------------------
      CALL PREMLD(NEQ,N2,ZI(DIAG),ZI(IHCOL),ZI(XADJ1),ZI(ADJNC1),
...
C     QUI SERONT DANS NOMADI A LA PLACE DE COL
   ...
   90 CONTINUE
     ...
     &            NBSN,IER)
      ...
      CALL JELIBE(NUZ(1:14)//'.NUME.DELG')
