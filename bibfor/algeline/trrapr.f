      SUBROUTINE TRRAPR(CLEF,TAB,NTAB,N,G,D,M)
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGELINE  DATE 22/02/2010   AUTEUR MEUNIER S.MEUNIER 
C ======================================================================
...
C REAL    TAB(N,NTAB)     : TABLEAU A TRIER EN MEME TEMPS QUE CLEF
