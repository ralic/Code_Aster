...
C MODIF ALGELINE  DATE 02/10/2012   AUTEUR LEFEBVRE J-P.LEFEBVRE 
...
C     VERSION RENUMEROTATION PAR NOEUD
      ...
      INTEGER NBSD,IAUX
      INTEGER VALI(2)
      INTEGER*4 NBND4,NADJ4,NBSN4,FCTNZ4,LGIND4
      CHARACTER*24 NOXADJ,NOADJN,NOPERM,NOINVP,NOPARE,NOSPND
...
C     COPIE EN INTEGER*4
 ...
 402     CONTINUE
         CALL ONMETL(NBND4,NADJ4,ZI4(XADJD4),ZI4(ADJNC4),
     &ZI4(INVPN4),ZI4(PERMN4),ZI4(SPNDN4),ZI4(PAREN4),NBSN4,
     &NBOPS, FCTNZ4,LGIND4,NIV)
         NBSN=NBSN4
         FCTNZS=FCTNZ4
         LGIND=LGIND4
         DO 403 I=1,NBND
