...
C DECLARATION PARAMETRES D'APPELS
      ...
      CHARACTER*24 TYREOR,PRECO,SCALIN,STOGI,ACMA,ACSM,OPT
...
C DECLARATION VARIABLES LOCALES
     ...
     &             IPSRO,IDDRO,NBREO2,IDDFRO,IAUX1,IAUX2,
     &             NBREO1,IAUX3,IR3,IRH,DIMGI,IPRJ,ITPS,IFETC,
     &             LONG,MOD,IFIV,IINF,IREX,IFETI,ILIMPI,IFETPT,
     &             NBTOT,IFET1,NBI2,IPIV,MAMOY,RANG,IBID,NIVMPI,NBSD1,
     &             NBPROC,IMSMK,IMSMI,DIMTET,NBDDSM,NBREOA,IDEEQ,
     &             ASSMAT,IACSM,IRET1,IRET2,IFM17,IITER,
     &             NMOYRE,NINFRE,NINFMA,NITER1,ITERM,ITERI,IRG1,IREFE,
     &             NBDDL,IADVAL
      REAL*8       DNRM2,ANORM,ANORMK,ANORM0,EPSIK,PARAAF,DDOT,ALPHA,
     &             ALPHAN,ALPHAD,R8MIEM,RMIN,
     &             TEMPS(6),RBID,ANORMD,RESMIN,GAINRE,VALR(2)
      CHARACTER*8  NOMSD,K8BID,K8BID1
      CHARACTER*19 MATDD,K19BID,CRIT19
...
C----  4.1 NON CONVERGENCE
      IF (RANG.EQ.0) THEN
        VALR (1) = ANORM
        VALR (2) = ANORM/ANORM0
        CALL U2MESG('F', 'ALGELINE4_8',0,' ',1,ITER,2,VALR)
      ENDIF
