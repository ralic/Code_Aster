      SUBROUTINE VTGAXP ( GEOMI, ALPHA, DEPLA)
      IMPLICIT   NONE
      CHARACTER*(*)       GEOMI,        DEPLA
      REAL*8                     ALPHA
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ALGELINE  DATE 19/02/2008   AUTEUR DESOZA T.DESOZA 
C ======================================================================
...
C ======================================================================
C
C     BUT: FAIRE CHA_GEOM + ALPHA*CH_DEPLA --> CHA_GEOM ACTUALISE
C
C          == CECI EST UNE COPIE DE VTGPLD.F     ==
C          == SAUF QUE L'ON NE DUPLIQUE PAS LE   ==
C          == CHAMP DE GEOMETRIE, ON LE MODIFIE  ==
C
...
C
      ...
      CALL JEVEUO (GEOMI2//'.VALE','E',IAVALI)
C
