...
C MODIF ALGELINE  DATE 14/11/2001   AUTEUR PABHHHH N.TARDIEU 
C ======================================================================
...
C     LA DIAGONALE "AVANT" ET LA DIAGONALE "APRES" :
      CALL DIAGAV(NOMA19,NEQ,TYPVAR,TYPSYM,TYPSTO,EPS)
...
C      -----------------   STOCKAGE MORSE (MULT_FRONT):
      ELSE IF (TYPSTO.EQ.2) THEN
        IF (TYPVAR.EQ.1) THEN
          CALL MULFR8(NOMA19,NPIVOT,NEQ,NBBLOC,ILDEB,ILFIN1,TYPSYM,EPS)
        ELSE IF (TYPVAR.EQ.2) THEN
          CALL MLFC16(NOMA19,NPIVOT,NEQ,NBBLOC,ILDEB,ILFIN1,TYPSYM,EPS)
        END IF
