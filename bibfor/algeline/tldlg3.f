      SUBROUTINE TLDLG3(METRES,RENUM,ISTOP,LMAT,ILDEB,ILFIN,NDIGIT,
...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      CHARACTER*14 NU
      CHARACTER*(*) METRES,RENUM
      CHARACTER*8 NOMNO,NOMCMP,TARDIF,METRE2
      CHARACTER*40 INFOBL,MESSAG
      INTEGER ISTOP,LMAT,ILDEB,ILFIN,NDIGIT,NDIGI2,IRET,NPVNEG
      INTEGER IFM,NIV,JREFA,NOM,NEQ,ISCBL,ISCDI,LLIAI
      INTEGER TYPVAR,TYPSYM,NBBLOC,ILFIN1,IBID
      INTEGER IEQ3,ISINGU,ISCHC,IEQ,NDECI,IADIGS,NPIVOT
      INTEGER NDECI1,NDECI2,IEQ4,NZERO
...
C    -- ATTENTION : NU EST PEUT ETRE ' ' (MATR_ASSE_GENE)
      ...
      IF (NIV.EQ.2) THEN
        ...
        METRE2=METRES
        WRITE (IFM,*) '<FACTOR> METHODE '//METRE2
      END IF
...
C          DE .VALM DANS .UALF
        IF (NOMA19.NE.'&&OP0070.RESOC.MATR') CALL UALFCR(NOMA19,' ')
