...
! IN  VECDDL :    : VECTEUR POSITION DES DDLES A EXCLURE
! IN  NBDDL  : IS : NOMBRE TOTAL DE DDLS EXCLUS
...
! IN  VECDDL : IS : VECDDL(1..NBEQ) VECTEUR POSITION DE DDL.
! IN  NBDDL  : IS : NOMBRE DE DDL EXCLUS DE LA RECHERCHE DE VALEURS
!                   PROPRES
!
...
! IN  NSTA   : IS : NOMBRE DE DDL STAB
! IN  DDLSTA : IS : VECT(1..NBEQ) POSITION DES DDL STAB
! OUT VSTAB  : R8 : VECT(1..NBEQ) MODE DE STABILITE
! OUT CSTA   : R8 : VALEUR CRITERE DE STABILITE
! IN/OUT REDEM : IS : NOMBRE REDEMARRAGES METHODE SORENSEN
!
!----------------------------------------------------------------------
! CORPS DU PROGRAMME
...
! RE-ORTHONORMALISATION SUIVANT IGS PAR RAPPORT A B
    call vpgskp(nbeq, nconv, vect, alpha, ldynfa,&
                1, vaux, ddlexc, workv)
!
! FIN DE VPSORN
!
