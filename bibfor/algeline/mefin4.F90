...
!
    ...
    real(kind=8) :: z(*), f1(nbz*nbgrp, *), f2(nbz*nbgrp, *), f3(*), f4(*)
    real(kind=8) :: g(*)
! ----------------------------------------------------------------------
! ======================================================================
...
! ======================================================================
! ----------------------------------------------------------------------
!     CALCUL DE L'INTEGRALE SUR (0,L) DE F3(Z)*F4(Z)*F1(Z)*F2'(Z)
...
! IN  : F4     : TROISIEME FONCTION
! --  : G      : TABLEAU DE TRAVAIL
! OUT : MEFIN4 : INTEGRALE CALCULEE
! ----------------------------------------------------------------------
    real(kind=8) :: mefin4
! ----------------------------------------------------------------------
!
