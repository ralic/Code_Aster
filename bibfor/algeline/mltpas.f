...
C     IMPLICIT REAL*8 (A-H,O-Z)
      ...
      INTEGER XADJ(NBND+1),ADJNCY(*),LMAT,COL(*)
      INTEGER ANC(NBND),NOUV(NBND),RL(4,1),NRL
      INTEGER GLOBAL(*),ADRESS(NBSN+1)
      INTEGER NBLIGN(NBSN),LGSN(NBSN),IDDL2
      INTEGER DELG(*),PRNO(1),DEEQ(1),NEC,LBD2(1)
C
C=========================================================
...
C==========================================================
      INTEGER PLACE(NBND)
      INTEGER I,J,K,NDJ,SNI,ANDI,ANDJ,NJ,NP,CODE,HAUT
      INTEGER NDI,LFAC,DEPART,AD,ISN,LONGB,IB,IC,INO,NUM,ANCNO,NO
      ISN = 0
      LONGB = 0
      LMAT=DIAG(NBND)
      DO 290 IB = 1,NBLOC
