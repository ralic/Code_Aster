...
C VERSION COMPLEXE DE MLTASA
      ...
      CHARACTER*24 FACTOL,FACTOU,VALE
      CHARACTER*(*) NOMMAT
...
C     -----  FIN  COMMUNS NORMALISES  JEVEUX  --------------------------
      ...
      IF(TYPSYM.EQ.1) THEN
         IP = 1
         CALL JEVEUO(JEXNUM(VALE,IP),'L',MATI)
         DO 10 I=1,LONMAT
            IF(ADINIT(I).LE.0) ADINIT(I) = - ADINIT(I)
 10      CONTINUE
      ELSE
         IP = 1
         CALL JEVEUO(JEXNUM(VALE,IP),'L',MATS)
         IP = 2
         CALL JEVEUO(JEXNUM(VALE,IP),'L',MATI)
      ENDIF
C===================================================================
...
C
      ...
      IF (IREFAC.GT.0) THEN
         CALL JEDETR(FACTOL)
      END IF
      CALL JELIRA(JEXNUM(VALE,IP),'CLAS',IBID,BASE)
