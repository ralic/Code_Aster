...
C ======================================================================
C-----------------------------------------------------------------------
C               CALCUL LE PRODUIT DE DEUX VECTEURS COMPLEXES (X*Y)
C-----------------------------------------------------------------------
...
C     : INCY : DEPLACEMENT ENTRE LES ELEMENTS DE ZY.
C              Y(I) EST DEFINI PAR
C                 ZY(1+(I-1)*INCY) SI INCY.GE.0  OU
C                 ZY(1+(I-N)*INCY) SI INCY.LT.0.
C OUT : ZDOTU: SOMME POUR I=1 A N DE X(I)*Y(I).
C-----------------------------------------------------------------------
      INTEGER    I, IX, IY
C
      ZDOTU = (0.0D0,0.0D0)
