...
C ======================================================================
      IMPLICIT NONE
C======================================================================
C     OPERATEUR : FACT_GRAD
C       PRECONDITIONNEMENT SUR UNE MATR_ASSE EN VUE
C       D'UNE RESOLUTION PAR L'OPERATEUR RESO_GRAD (OP0084)
C======================================================================
      CHARACTER*8 MATAS,MATFAC
      CHARACTER*24 PREC
      CHARACTER*19 MAT,MATF
...
C---- MATRICE ASSEMBLEE
      CALL GETVID(' ','MATR_ASSE',0,1,1, MATAS,L)
      MAT = MATAS
