      SUBROUTINE CRSVPE(SOLVEZ,SYMZ,KVARZ,KPRECZ,EPS,MXITER,RENUMZ)
...
C ======================================================================
      IMPLICIT   NONE
      CHARACTER*(*) SOLVEZ,SYMZ,KVARZ,KPRECZ,RENUMZ
      INTEGER MXITER
      REAL*8 EPS
C ----------------------------------------------------------
...
C IN K   KVARZ   : VARIANTE PETSC : 'GEMRES', ...
C IN K   KPRECZ  : TYPE DE PRE-CONDITIONNEMENT : 'LU_INC', ...
C IN R   EPS     : ERREUR MAX RELATIVE ACCEPTEE POUR LA SOLUTION
C IN I   MXITER  : NB ITER MAX AUTORISE
...
C --- FIN DECLARATIONS NORMALISEES JEVEUX --------------------
      ...
      CHARACTER*3  SYME
      CHARACTER*8  K8BID,KVARI,KPREC,RENUM
      CHARACTER*19 SOLVEU
