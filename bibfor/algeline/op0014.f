...
C---- PASSAGE DU NOM DE LA MATRICE FACTORISEE EN K19
      MFAC = MATFAC
...
C     --- RECUPERATION DU NOM DE LA MATRICE ASSEMBLEE ---
      CALL GETVID('  ','MATR_ASSE',0,1,1,MATASS,IBID)
C---- PASSAGE DU NOM DE LA MATRICE ASSEMBLEE EN K19
      MASS = MATASS
...
C     --- CHARGEMENT DES DESCRIPTEURS DE LA MATRICE A FACTORISER ---
     ...
     &              'DE LA MATRICE "'//MATFAC//'" ')
      END IF
      CALL MTDSC2(ZK24(ZI(IATFAC+1)),'ADIA','L',JADIA)
