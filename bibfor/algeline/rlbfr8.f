      SUBROUTINE RLBFR8(NOMMAT,NEQ,NBBLOC,XSOL,NBSM,TYPSYM)
...
C ======================================================================
      IMPLICIT NONE
      INTEGER NEQ,NBBLOC,NBSM,TYPSYM,J
C
      CHARACTER*(*) NOMMAT
      REAL*8 XSOL(NEQ,*)
C     ------------------------------------------------------------------
...
C                                ALLOCATION TABLEAU REEL PROVISOIRE
      CALL WKVECT('&&RLTFR8.POINTER.REELS ',' V V R ',NEQ*NBSM,POINTR)
...
C
      ...
      CALL MLTDRB(NBLOC,ZI(LGBLOC),ZI(NCBLOC),ZI(DECAL),ZI(SEQ),
