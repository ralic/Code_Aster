      SUBROUTINE RRRNSL(IABLO, IHCOL, IDLEXC, COEF, MATIN, MATRES,
     +                  MATREI)
      IMPLICIT REAL*8 (A-H,O-Z)
      INTEGER          IABLO(1), IHCOL(1), IDLEXC(1)
      REAL*8           COEF, MATIN(1), MATRES(1), MATREI(1)
C     ------------------------------------------------------------------
...
C ======================================================================
C -------------------------------------------------------
C     COMBINAISON LINEAIRE DU BLOC COURANT D'UNE MATRICE SYMETRIQUE
C     DANS UNE MATRICE NON-SYMETRIQUE.
C     LES MATRICES SONT STOCKEES EN LIGNE DE CIEL
C     LES VALEURS DES MATRICES SONT RELLES,
...
C
     ...
     +                              (1-IDLEXC(IEQUA))
C
                    MATREI(KIN) = MATREI(KIN) + COEF*MATIN(KIN)*
     +                              (1-IDLEXC(IEQUA-ILONG+IND))*
     +                              (1-IDLEXC(IEQUA))
  20         CONTINUE
C
