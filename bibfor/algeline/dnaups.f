     ...
     &   IPNTR, WORKD, WORKL, LWORKL, INFO, NEQACT, ALPHA, NSTA,
     &   DDLSTA,VSTAB,CSTA,LDYNFA,DDLEXC,REDEM)
...
C
C  NSTA   INTEGER (INPUT) NOMBRE DE DDLS STAB
C
...
C     %-------------------------------------------------------%
     ...
     &   IPNTR, WORKD, INFO, NEQACT, ALPHA,NSTA,DDLSTA,VSTAB,
     &   CSTA,LDYNFA,DDLEXC,REDEM)
