      SUBROUTINE RECFOR(NUMPAS,NBPAL,NUMDDL,FORCE,
...
C     NNO ET NDDL RECU DE POSDDL (ASTER => I8 SUR MACHINE ASTER)      
      INTEGER       NNO,NDDL
      
      INTEGER*4     IPAT,IPAL,INFO,IDIM,ICOMP,NPAS,NLU
      REAL*8        PARAMR(6),TR8,CFRTA
