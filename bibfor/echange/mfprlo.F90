subroutine mfprlo(fid, cha, numdt, numo, typent,&
...
!
    ...
    integer :: fid, typent, typgeo, n, cret, numdt, numo, iterma
...
! BEGIN MED
    ...
    integer(kind=4) :: fid4, typen4, typge4, n4, cret4, numdt4, numo4, iterm4
#ifdef _DEBUG_MED
    print *,'=== MFPROI ==='
#endif
    fid4 = fid
