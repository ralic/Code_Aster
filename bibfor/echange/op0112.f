...
C     ! ========================== !
      ...
      NUMPA4 = NUMPAS
      CALL GETVID(' ', 'CHAR_MECA', 1, 1, 1, CHARG,  IBID)
      CALL GETVID(' ', 'MATR_PROJECTION',     1, 1, 1, CORRES, IBID)
      CALL GETVTX(' ', 'NOM_CMP_IFS', 1, 1, 3, NOMCMP, IBID)
...
C     ! ====================================== !
 ...
 30   CONTINUE
      GRPMA = MA1//'.GROUPEMA'
      DO 50 IOCC = 1, NBOCC
C        CALL GETVID('VIS_A_VIS','GROUP_MA_1',IOCC,1,1,NOMGMA,IBID)
        CALL GETVTX('VIS_A_VIS','GROUP_MA_1',IOCC,1,1,NOMGMA,IBID)
...
C     ! =============================================== !
      ...
      GRPNO = MA2//'.GROUPENO'
      DO 80 IOCC = 1,NBOCC
C        CALL GETVID('VIS_A_VIS','GROUP_NO_2',IOCC,1,1,NOMGNO,IBID)
