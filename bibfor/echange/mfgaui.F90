subroutine mfgaui(fid, nordr, k64, ityp, nbn,&
                  ndim, nomasu, cret)
...
!
    ...
    integer :: fid, nordr, ityp, nbn, cret, ndim, tymasu, nbmasu
...
! BEGIN MED
    ...
    integer(kind=4) :: fid4, nordr4, ityp4, nbn4, cret4, ndim4, tymas4, nbmas4
#ifdef _DEBUG_MED
    print *,'=== MFGAUI ==='
#endif
    fid4 = fid
