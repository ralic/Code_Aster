...
!
    ...
    integer :: idfimd, imasup, nvtymd, dimest, medcel, nbnosu
    integer :: nbmssu, tygems, nbattc, prespr, nbattv, codret
#ifdef _DISABLE_MED
    call u2mess('F', 'FERMETUR_2')
#else
! BEGIN MED
#ifdef _USE_MED_SHORT_INT
    integer(kind=4) :: idfim4, imasu4, nvtym4, dimes4, medce4, nbnos4
    integer(kind=4) :: nbmss4, tygem4, nbatc4, presp4, nbatv4, codre4
#ifdef _DEBUG_MED
    print *,'=== MFESLR ==='
#endif
    idfim4 = idfimd
