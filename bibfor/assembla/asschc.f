...
C
      ...
      IF (NIV.GT.2) THEN
        IFR = IUNIFI( 'RESULTAT' )
        CALL JEIMPO(IFR,MAT//'.CONI',' ','TABLE D"ELIMINATION')
        CALL JEIMPA(IFR,MAT//'.CONI',' ')
        CALL JEIMPO(IFR,MAT//'.LLIG',' ','LARGEUR DES LIGNES ELIMINEES')
        CALL JEIMPA(IFR,MAT//'.LLIG',' ')
        CALL JEIMPO(IFR,MAT//'.ALIG',' ','AD. DE DEBUT DE LIGNE')
        CALL JEIMPA(IFR,MAT//'.ALIG',' ')
        CALL JEIMPO(IFR,MAT//'.VALI',' ','VALEURS DES LIGNES ELIMINEES')
        CALL JEIMPA(IFR,MAT//'.VALI',' ')
      ENDIF
