     ...
     &                  IIMAX,IIPAS)
      ...
      INTEGER J,N,IDIL,IDIICH,IDSUIV,IDIP,IILIB,IIMAX,IIPAS
      CHARACTER*24 NOSUIV,NOIP
C     -----------------------------------------------------------------
...
C IN  IIPAS     PAS DE L'EXTENSION DES VECTEURS (ON PEUT ETRE AMMENER A
C               LES AGRANDIR PLUSIEURS FOIS)
C     ATTENTION : IIPAS NE PEUT PAS ETRE AUSSI PETIT QUE L'ON VEUT.
C       PEUT ETRE QUE IIPAS=NDDLS EST UNE BONNE IDEE ??
C
C------------------------------------------------------------------
