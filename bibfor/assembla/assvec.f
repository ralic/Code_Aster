...
C MODIF ASSEMBLA  DATE 02/02/2010   AUTEUR PELLET J.PELLET 
C ======================================================================
...
C ---------------------------------------------------------------------
     ...
     &             LSAUTE,LBID,LGOTO,LDIST,LARLQ
      ...
      INTEGER IER,IERD,IGR,IGREL,IL,ILI,ILIM,ILIMNU
      INTEGER ILINU,ILIVE,ILIVEC,IMA,IMAIL,IMAT,INDIK8,INOLD
      INTEGER IRESU,IRET,J,JEC,JNUMSD,JVALE,K1,L
      INTEGER LGNCMP,MODE,N1,NBCHAR,NBELM,NBNO,NBNOSS
      INTEGER NBRESU,NBSMA,NBSSA,NCMP,NCMPEL,NDDL1,NEL,NEQUA
      INTEGER NM,NMXCMP,NNOE,NUGD,NUMA,NUNOEL,IEXI,JRELR,K,JVALE1,JVALE2
...
C        -- REDUCTION + DIFFUSION DE VECAS A TOUS LES PROC
      IF (LDIST) CALL MUMMPI(5,IFM,NIV,KVALE,NEQUA,IBID)
