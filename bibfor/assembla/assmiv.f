...
C            CONFIGURATION MANAGEMENT OF EDF VERSION
C MODIF ASSEMBLA  DATE 25/03/2003   AUTEUR JMBHH01 J.M.PROIX 
C ======================================================================
...
C             -- ON N'ASSEMBLE QUE LES SSS VRAIMENT ACTIVES :
   ...
   40             CONTINUE
                ...
                CALL CORDD2(IDPRN1,IDPRN2,ILIMNU,ICODGE,NEC,NCMP,N1,K1,
     &                      NDDL1,ZI(IAPSDL))
...
C------------------------------
     ...
     &                            K1,NDDL1,ZI(IAPSDL))
                      ...
                      IF (IAD1.EQ.0) THEN
                        ...
                        CALL UTIMPK('L','   N''A PAS D''ADRESSE DANS  :'
     &                              ,1,NUDEV)
                        CALL UTFINM
                      END IF
     ...
     &                     ZI(ZI(IADNEM+3* (ILIVE-1)+2)+NUMA-1)+K1-1)
                      IF (N1.LT.0) THEN
                        ...
                        IF (ILINU.EQ.0) THEN
                          ...
                          CALL UTIMPI('S',' REF. PAR LE NOEUD SUPL.  :',
     &                                1,N1)
