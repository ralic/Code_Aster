...
C        * DISTRIBUE AVEC MUMPS + OPTION MATR_DISTIBUEE: LDIST
C
...
C         DANS LE TROISIEME CAS DE FIGURE (MATR_DISTRIBUEE), ON RETAIL
C         LE AU PLUS JUSTE LEUR DIMENSION PAR PROC POUR GAGNER EN ME
C         MOIRE. ON NE PEUT PLUS COMPLETER SI SIMPLEMENT, CE CAS DE FI
C         GURE EST TAGGE PAR REFA(11)='MATR_DISTR'
C
