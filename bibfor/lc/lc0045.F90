subroutine lc0045(fami, kpg, ksp, ndim, imate,&
                  compor, crit, instam, instap, epsm,&
                  deps, sigm, vim, option, angmas,&
                  sigp, vip, coorot, typmod, icomp,&
                  nvi, dsidep, codret)
!
! ======================================================================
...
!               COOROT COORDONEES ET MATRICE DE ROT DU PG COURANT
...
! ======================================================================
    call lcejmr(fami, kpg, ksp, ndim, imate,&
