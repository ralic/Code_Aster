...
!
    ...
    integer, parameter :: nb_cont_reso = 42
!
...
!
    character(len=8), parameter, dimension(nb_cont_reso) :: list_cont_elem = (/&
        'LACS2S2C','LACS3S3C','LACS2S3C','LACS3S2C','LACS2S2D',&
        'LACS2S2E','LACS2S3E','LACQ4Q4D','LACQ4T3D','LACQ4T6D',&
        'LACQ4Q8D','LACQ4Q9D','LACQ8Q8D','LACQ8T6D','LACQ8T3D',&
        'LACQ8Q4D','LACQ8Q9D','LACT3T3D','LACT3T6D','LACT3Q4D',&
        'LACT3Q8D','LACT3Q9D','LACT6Q9D','LACT6T6D','LACT6T3D',&
        'LACT6Q4D','LACT6Q8D','LACQ9Q9D','LACQ9T3D','LACQ9T6D',&
        'LACQ9Q4D','LACQ9Q8D','LACQ4Q4E','LACQ4T3E','LACQ4T6E',&
        'LACQ4Q8E','LACQ4Q9E','LACQ8Q8E','LACQ8T6E','LACQ8T3E',&
        'LACQ8Q4E','LACQ8Q9E'/)
!
