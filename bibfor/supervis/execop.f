...
C MODIF SUPERVIS  DATE 13/04/2010   AUTEUR BOITEAU O.BOITEAU 
C ======================================================================
...
C     COMMON POUR INDIQUER SI LES CALCULS ELEMENTAIRES SONT DISTRIBUES
...
C     -- ON INITIALISATION DES COMPTEURS DE TEMPS :
      IF (ICOND .EQ. 0) CALL UTTCPG ('INIT',' ')
...
C        (IL FAUT LE FAIRE AVANT LA DESTRUCTION DES OBJETS VOLATILES)
      IF (ICOND .EQ. 0) CALL UTTCPG ('IMPR','CUMU')
