...
! --- INITIALISE L'OBJET 'COOMUNICATEUR_MPI.REFE' QUI STOCKE LE NUMERO
! --- DU MPI_COMM_WORLD ET CELUI DU COMMUNICATEUR COURANT (AU DEBUT ILS
! --- SONT IDENTIQUES ET PEUVENT LE RESTER SUIVANT LE TYPE DE CALCUL)
