...
interface
    subroutine xfem_over_write_2(matas1, bas1, nbnomax, ino_xfem, neq, &
        ...
        real(kind=8) :: coef
        integer :: nvale
        integer :: size_vect_col_2
        integer :: size_vect_raw_2
        real(kind=8) :: vect_col_2(size_vect_col_2)
        real(kind=8) :: vect_raw_2(size_vect_raw_2)
    end subroutine xfem_over_write_2
end interface
