        interface
          subroutine equthm(imate,option,ta,ta1,ndim,compor,typmod,kpi&
     &,npg,dimdef,dimcon,nbvari,defgem,congem,vintm,defgep,congep,vintp,&
     &mecani,press1,press2,tempe,crit,rinstm,rinstp,dt,r,drds,dsde,&
     &retcom)
            integer :: nbvari
            integer :: dimcon
            integer :: dimdef
