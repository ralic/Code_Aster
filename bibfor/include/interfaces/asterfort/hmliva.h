        interface
          subroutine hmliva(yachai,option,meca,ther,hydr,imate,ndim,&
     &dimdef,dimcon,nbvari,yamec,yate,addeme,adcome,advihy,advico,vihrho&
     &,vicphi,vicpvp,vicsat,addep1,adcp11,adcp12,addete,adcote,congem,&
     &congep,vintm,vintp,dsde,epsv,depsv,p1,dp1,t,dt,phi,pvp,h11,h12,&
