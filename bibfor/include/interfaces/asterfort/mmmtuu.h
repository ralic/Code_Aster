        interface
          subroutine mmmtuu(phasep,lnewtg,ndim,nne,nnm,mprojn,mprojt,&
     &wpg,ffe,ffm,dffm,jacobi,coefac,coefaf,coefff,rese,nrese,lambda,jeu&
     &,dlagrc,h11t1n,h12t2n,h21t1n,h22t2n,matree,matrmm,matrem,matrme)
