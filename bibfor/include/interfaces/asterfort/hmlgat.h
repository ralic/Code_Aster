        interface
          subroutine hmlgat(yachai,option,meca,ther,hydr,imate,ndim,&
     &dimdef,dimcon,nbvari,yamec,yate,addeme,adcome,advihy,advico,vihrho&
     &,vicphi,vicsat,addep1,adcp11,addete,adcote,congem,congep,vintm,&
     &vintp,dsde,epsv,depsv,p1,dp1,t,dt,phi,rho11,phi0,sat,retcom,thmc,&
     &biot,rinstp)
            integer :: nbvari
            integer :: dimcon
            integer :: dimdef
