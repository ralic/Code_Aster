        interface
          subroutine mmmtmm(phasep,lnewtg,ndim,nnm,mprojn,mprojt,wpg,&
     &ffm,dffm,jacobi,coefac,coefaf,coefff,rese,nrese,lambda,dlagrc,jeu,&
     &h11t1n,h12t2n,h21t1n,h22t2n,matrmm)
