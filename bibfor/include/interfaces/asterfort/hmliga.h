        interface
          subroutine hmliga(yachai,option,meca,ther,hydr,imate,ndim,&
     &dimdef,dimcon,nbvari,yamec,yate,addeme,adcome,advihy,advico,vihrho&
     &,vicphi,vicsat,addep1,adcp11,addep2,adcp21,addete,adcote,congem,&
     &congep,vintm,vintp,dsde,deps,epsv,depsv,p1,p2,dp1,dp2,t,dt,phi,&
