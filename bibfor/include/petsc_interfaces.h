...
! -------------
        ...
        subroutine MatCreateSeqAIJ(comm, m, n, nz, nnz, a, ierr)
       mpi_int comm ! MPI_Comm
       PETSC_INT_SCAL_IN m
       PETSC_INT_SCAL_IN n
...
! -------------
       ...
       subroutine MatGetRow(mat, ilig, nterm, irow, vrow ,ierr)
       Mat mat ! Mat
...
! -------------
        ...
        subroutine MatMPIAIJSetPreallocation(A, d_nz, d_nnz, o_nz ,o_nnz, ierr)
       Mat A
...
! -------------
        ...
        subroutine MatRestoreRow(mat ,row, ncols, cols, vals, ierr)
       Mat mat
...
! -------------
        ...
        subroutine MatSetValue(m, row, col, value ,addv, ierr)
       Mat m ! Mat
       PETSC_INT_SCAL_IN row
...
! -------------
        ...
        subroutine MatZeroRows(mat ,nbrow, rows, diag, x, b, ierr)
       Mat mat ! Mat
