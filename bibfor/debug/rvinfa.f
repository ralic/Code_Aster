...
C MODIF DEBUG DATE 11/03/2003 AUTEUR DURAND C.DURAND
C ======================================================================
...
C
      IF ( OPR(1:1) .EQ. 'S' .AND. MCF(1:6) .EQ. 'ACTION' ) THEN
         CALL GETVR8(MCF,'POINT',IOCC,1,0,POIN,N1)
         IF ( N1 .EQ. -2 ) THEN
            CALL GETVR8(MCF,'POINT',IOCC,1,2,POIN,N1)
            WRITE(IFM,1000) POIN(1) , POIN(2)
         ELSEIF ( N1 .EQ. -3 ) THEN
            CALL GETVR8(MCF,'POINT',IOCC,1,3,POIN,N1)
