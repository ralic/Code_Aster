...
C     --- CHOIX DE L'ABSCISSE CURVILIGNE 0. ---
      ...
      ELSE
        ...
        IF (N1.NE.0) THEN
          ...
          IF (IRET.EQ.10) THEN
            CALL UTMESS('F','I2CHEM','LE GROUP_NO : '//NOEUD//
     &                  'N''EXISTE PAS.')
  ...
  120   CONTINUE
        IF (OUVERT .AND. TROUVE.NE.1) THEN
          CALL UTMESS('F','I2CHEM','ON A UN ARC OUVERT ET LE '//
     &                '"NOEUD_ORIG" N''EST PAS UNE EXTREMITE')
        END IF
        IF (TROUVE.EQ.0) THEN
          CALL UTMESS('F','I2CHEM','LE "NOEUD_ORIG" NE FAIT PAS '//
     &                'PARTI DU CHEMIN')
        END IF
