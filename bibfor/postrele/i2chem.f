        ...
        IF (N1.NE.0) THEN
          ...
          DO 10,IM = 1,N1,1
            ...
            IF (EXISTE.EQ.0) THEN
              ...
              VALK (1) = 'DEFI_CHEMIN'
              VALK (2) = NOMMA
              CALL U2MESG('E', 'INTEMAIL_12',2,VALK,1,OCC,0,0.D0)
            ELSE
              ...
              IF (TYPM.NE.'SEG2' .AND. TYPM.NE.'SEG3') THEN
                ...
                VALK (1) = 'DEFI_CHEMIN'
                VALK (2) = NOMMA
                CALL U2MESG('E', 'INTEMAIL_15',2,VALK,1,OCC,0,0.D0)
              END IF
            END IF
   10     CONTINUE
          NBTM = NBTM + N1
            ...
            ELSE
              ...
              DO 20,IM = 1,NBM,1
                ...
                IF (TYPM.NE.'SEG2' .AND. TYPM.NE.'SEG3') THEN
                  ...
                  VALK (1) = 'DEFI_CHEMIN'
                  VALK (2) = NOMGR
                  CALL U2MESG('E', 'INTEMAIL_13',2,VALK,1,OCC,0,0.D0)
                END IF
   20         CONTINUE
              NBTM = NBTM + NBM
            END IF
  ...
  100 CONTINUE
      DO 110 IN = 1,NBTNOE
        IF (ZI(JNOE+IN-1).GT.2) THEN
          ...
          VALK (1) = NOMSE
          VALI (1) = ZI(JNOE+IN-1)
          CALL U2MESG('F', 'INTEMAIL_17',1,VALK,1,VALI,0,0.D0)
        END IF
  110 CONTINUE
