      SUBROUTINE RVPOST(MCF,IOCC,DIM,I1,I2,NCHEFF,XNOMCP,XNUMCP,NRESU,
     +                  NCH19,VCODOP,NLSMAC,NLSNAC,NOMTAB,XNOVAR)
      IMPLICIT   NONE
      INTEGER               IOCC,    I1,I2
      CHARACTER*2            DIM
      CHARACTER*8            NRESU
      ...
      CHARACTER*24         XNOMCP,XNUMCP,VCODOP,NLSMAC,NLSNAC,XNOVAR
      CHARACTER*(*)     MCF
      INTEGER NY
      REAL*8 VECTY(3)
      LOGICAL TRIDIM
...
C IN  XNUMCP : K : NOM DE LA COLLECTION DES NUMEROS DE CMP
C IN  NCH19  : K : NOM DU CHAMP A TRAITER
C IN  VCODOP : K : NOM DU VECTEUR DES CODES_OP DE POST-TRAITEMENT
