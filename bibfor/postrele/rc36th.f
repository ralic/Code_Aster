...
C
            CALL GETVIS ( MOTCLF, 'NUME_RESU_THER', IOCC,IARG,1,ITH,N1)
C
            ITHS = LITHS(IT1)
...
14       CONTINUE
         ...
         CALL GETVID ( MOTCLF,'TABL_RESU_THER' ,IOCC,IARG,1,TBTHER,N1)
...
C
         CALL GETVID ( MOTCLF,'TABL_MOYE_THER' ,IOCC,IARG,1,TBMOYE,N1)
C
