      SUBROUTINE RC32FU ( NBSIG1, NOC1, SIT1, NBSIG2, NOC2, SIT2, 
     +                    SALTIJ, NPASS, NOMMAT, UG, FACTUS )    
      IMPLICIT   NONE
...
C
C     ------------------------------------------------------------------
      INTEGER      IS1, IS2, I, K, L, NK, NL, N0, I1, I2, I3, 
     +             IFM, NIV, ICOMPT
...
C
         ...
         IF ( ICOMPT .LE. 49 ) THEN
            ICOMPT = ICOMPT + 1
            FACTUS(4*(ICOMPT-1)+1) = I3
            FACTUS(4*(ICOMPT-1)+2) = SIT1(2*(IS1-1)+1)
            FACTUS(4*(ICOMPT-1)+3) = SIT2(2*(IS2-1)+1)
