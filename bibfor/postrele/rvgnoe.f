      SUBROUTINE RVGNOE ( MCF, IOCC, NMAILA, NLSTND )
      IMPLICIT NONE
      INTEGER                  IOCC
      CHARACTER*(*)       MCF
      CHARACTER*8                    NMAILA
...
C
      ...
      INTEGER      I,J,LIBRE,NUMND,NBTND,N1,NBN,IRET,IERA
...
C
     ...
     +       IOCC,1,NBRGPN,ZK8(AGRPN),N1)
         DO 10, I = 1, NBRGPN, 1
            CALL JELIRA(JEXNOM(NREPGN,ZK8(AGRPN + I-1)),
     +                         'LONMAX',N1,K1BID)
            NBTND = NBTND + N1
10       CONTINUE
      ENDIF
...
200      CONTINUE
      ...
      IF ( NBRGPN .NE. 0 ) THEN
         DO 100, I = 1, NBRGPN, 1
            ...
            CALL JELIRA(JEXNOM(NREPGN,NOMGRN),'LONMAX',NBN,K1BID)
...
C     VERIFICATIONS PRELIMINAIRES
     ...
     +   'DOIT CONTENIR PLUSIEURS NOEUDS')
        ...
        ELSE
          CALL UTMESS('F','POST_RELEVE_T',
     +   'AVEC VECT_Y IL FAUT PRECISER SOIT UN SEUL GROUPE DE NOEUDS '//
