      SUBROUTINE RC3200 ( PMPB, SN, SNET, FATIGU, LROCHT, MATER, SYMAX )
      IMPLICIT   NONE
      REAL*8              SYMAX
...
C     -------------------------
C
      CALL RC32AC ( PMPB, SN, SNET, FATIGU, LROCHT, MATER )
C
C
C --- STOCKAGE DES RESULTATS
C     ----------------------
C
      CALL RC32RS ( PMPB, SN, SNET, FATIGU, LROCHT, MATER, SYMAX )
C
