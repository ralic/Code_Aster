...
C
 ...
 20   CONTINUE
C
      IF ( NBPAR    .GT. 15 ) CALL UTMESS('F','RVTASO','Y A UN BUG 0')
      IF ( II+2     .GT. 10 ) CALL UTMESS('F','RVTASO','Y A UN BUG 1')
      IF ( IR+NBCMP .GT. 10 ) CALL UTMESS('F','RVTASO','Y A UN BUG 2')
      IF ( IK       .GT. 10 ) CALL UTMESS('F','RVTASO','Y A UN BUG 3')
C
      LS = NBCMP
      LC = NBSP * LS
      ILIGN = 0
