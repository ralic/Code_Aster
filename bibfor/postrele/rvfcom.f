...
C
         F2 = F2 + 1
C
         IF ( F2 .GT. 12 ) CALL UTMESS('F','RVFCOM',
     +          'MAUVAISE DEFINITION DU CHEMIN, '//
     +          'PROBLEME DE CONTINUITE DU CHEMIN SUR UNE MAILLE, '//
     +          'DIMINUER LA PRECISION DANS L''OPERATEUR INTE_MAIL')
C
