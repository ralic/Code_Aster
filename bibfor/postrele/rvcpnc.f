...
C
      ...
      IF ( MCF(1:6) .EQ. 'ACTION' ) THEN
         ...
         CALL GETVTX(MCF,'NOM_CMP'        ,IOCC,IARG,0,K8B,NNC)
         CALL GETVTX(MCF,'INVARIANT'      ,IOCC,IARG,0,K8B,NIN)
         CALL GETVTX(MCF,'ELEM_PRINCIPAUX',IOCC,IARG,0,K8B,NEP)
         CALL GETVTX(MCF,'TRAC_NOR'       ,IOCC,IARG,0,K8B,NTN2)
         CALL GETVTX(MCF,'TRAC_DIR'       ,IOCC,IARG,0,K8B,NTD2)
         CALL GETVTX(MCF,'RESULTANTE'     ,IOCC,IARG,0,K8B,NSO)
         CALL GETVTX(MCF,'REPERE'         ,IOCC,IARG,1,REPERE,I)
...
C
         CALL GETVR8(MCF,'DIRECTION',IOCC,IARG,3,DIR,IBID)
