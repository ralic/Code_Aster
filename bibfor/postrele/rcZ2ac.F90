...
!         * 7 QUANTITES AVEC LA PRISE EN COMPTE DU SEISME
!         * 7 QUANTITES SANS LA PRISE EN COMPTE DU SEISME
!         1  : SN
!         2  : SN*
!         3  : SP
!         4  : KE_MECA
...
!
            ...
            call jeecra(jexnum(k24as, ig), 'LONMAX', 7*nbsigr)
            call jeveuo(jexnum(k24as, ig), 'E', jreas)
!
            call jecroc(jexnum(k24ss, ig))
            call jeecra(jexnum(k24ss, ig), 'LONMAX', 7*nbsigr)
...
!
                ...
                call rcZ2sp('SP_SITU', lieu(im), nsitup, ppi, mpi,&
                            nsituq, ppj, mpj, seisme, mse,&
                            sp, typeke, spmeca, spther, transip, transif)
...
!
                ...
                zr(jress-1+7*(is1-1)+4) = kemeca
                zr(jress-1+7*(is1-1)+5) = kether
                zr(jress-1+7*(is1-1)+6) = saltij(1)
!
