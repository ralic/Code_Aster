...
C     ------------------------------------------------------------------
      ...
      CHARACTER*24 NREFEL,NDESCL,NNOCPQ,NPNCOE,NPNSPE
      CHARACTER*4 DOCU,DOCUL,K4
      CHARACTER*2 TQ
      CHARACTER*1 K1

      INTEGER NBPT,LPADR,LPNBN,APNBNQ,AVALEQ,APADRQ,IBID,ANOCPQ,APNCOE
      INTEGER APNBNE,AVALEE,APADRE,IDECQ,IDECE,ORD1,ORD2,NVP,N,NBOC
      INTEGER ADRE,ADRQ,LL,I,J,K,IOC,APCMPE,ANUMCP,IADR,ACPGD,APNSPE
      INTEGER AVEC1,AVEC2,AV1X,AV2X,AV1Y,AV2Y,IPADR,APNSPQ
      INTEGER KD1,KD2,KD3,KD4,KD5,KD6,IDEC,NY,IV,IL
      INTEGER L,LNQ,LNE,M,MDER,NBADRQ,NBND,NBVAL,NC,NUM,PT,APNCOQ
      INTEGER NPERM,RANG(3),ITYPE,IORDRE, IFM, NIV
...
C         -- VECTEUR TANGENT
 ...
 1002        FORMAT( 1P, A5, E12.5, 2X, E12.5, 2X, E12.5 )
  ...
  362             CONTINUE
                ELSE 
                  CALL UTMESS('F','POST_RELEVE_T',
     &              'EN REPERE LOCAL, ON NE TRAITE PAS LE CHAMP '//K4)
                END IF
  370         CONTINUE
  380       CONTINUE
  390     CONTINUE
