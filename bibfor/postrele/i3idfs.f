      SUBROUTINE I3IDFS(EPSI,K,F,NBA,DESC,DESCTM,SGT,ATRV,BTRV,COORSM,
     +                  NBPT,LSTPT,FINK,FIND)
      IMPLICIT REAL*8 (A-H,O-Z)
C
      INTEGER K,F,DESC(*),DESCTM(*),NBPT,LSTPT(*),NBA
      REAL*8  EPSI,SGT(*),COORSM(3,*)
      LOGICAL ATRV,BTRV,FINK,FIND
C
C     ------------------------------------------------------------------
...
C     /* SGT INTER FACE INCLUS DANS FRONTIERE FACE */
            ...
            NBPT = -NBPT
         ELSE
            CALL UTMESS('F','I3IDFS','INTERSECTION DE TYPE INCONNU')
         ENDIF
