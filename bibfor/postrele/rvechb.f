      SUBROUTINE RVECHB (EPSI,TYPMAI,NDFAC,NBNF,R,NBRND,VALCPM,NBCP,
     +                   NBNM,NBSO,NBSI,VALCP)
...
C
      CHARACTER*8 TYPMAI
      INTEGER     NDFAC(*),NBNF,NBRND,NBCP,NBNM,NBSO,NBSI
