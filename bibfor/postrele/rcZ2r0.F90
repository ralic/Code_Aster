subroutine rcZ2r0(nomres, sn, snet)
    implicit none
...
!
    ...
    parameter    ( npar0 = 9 , npar1 = 4 , npar2 = 7 )
    real(kind=8) :: valer(2)
    complex(kind=8) :: c16b
...
!
    data nopar0 / 'TYPE','SEISME', 'NUME_GROUPE', 'LIEU', 'NUME_SITU',&
     &            'SN', 'SN*', 'SN_MAX' , 'SN*_MAX' /
    data typar0 / 'K8', 'K8', 'I', 'K8', 'I',&
     &            'R' ,'R', 'R' , 'R'  /
!
    data nopar1 / 'TYPE', 'LIEU', 'SN_MAX', 'SN*_MAX' /
    data typar1 / 'K8', 'K8', 'R' , 'R'  /
!
