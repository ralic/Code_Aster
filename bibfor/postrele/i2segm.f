...
C MODIF POSTRELE  DATE 16/01/2002   AUTEUR DURAND C.DURAND 
C ======================================================================
...
C     ------------------------------------------------------------------
     ...
     &        VMAIL1,VMAIL2
      ...
      CHARACTER*16 OPERA,TYPCRB,MOTCLE(3)
...
C     --- TRAITEMENT DES GROUP_MA ET MAILLE ---
      ...
      IF ((N1+N2).EQ.0) THEN
        CALL WKVECT('&&OP0050.NUME_MAIL','V V I',NBMAIL,JNUMA)
        DO 10,I = 1,NBMAIL,1
          ZI(JNUMA+I-1) = I
   10   CONTINUE
      ELSE
        LISMAI = '&&OP0050.NOM_MAIL'
        INDMOT = 0
        CALL RECMAI(' ',0,INDMOT,NOMAIL,LISMAI,LONLIS)
        NBMAIL = LONLIS
     ...
     &                ZR(VPAREX))
        ELSE
          ...
          IF (N1.NE.0) THEN
            ...
            R = POINT(1)
            IF (R.LE.0.D0) CALL UTMESS('F','DEFI_ARC',
