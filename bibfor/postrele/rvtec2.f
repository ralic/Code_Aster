...
C
      ...
      ELSE
         NBCMP2 = NBVARI
      ENDIF
      IF ( NBCMP2.GT.3000) CALL UTMESS('F','RCTEC2','+ DE 3000 CMPS!')
C
...
C
      LC = IR+4+NBCMP2
      IF ( NBPAR .GT. LCK ) CALL UTMESS('F','RVTEC2','Y A UN BUG 0')
      IF ( II+1  .GT. 10  ) CALL UTMESS('F','RVTEC2','Y A UN BUG 1')
      IF ( LC    .GT. LCR ) CALL UTMESS('F','RVTEC2','Y A UN BUG 2')
      IF ( IK    .GT. 10  ) CALL UTMESS('F','RVTEC2','Y A UN BUG 3')
C
      ILIGN = 0
C
      IK = IK + 1
