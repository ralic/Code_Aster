...
C MODIF FROM_C  DATE 03/04/2006   AUTEUR BOITEAU O.BOITEAU 
C ======================================================================
...
C <1 OU >10 OU DIFFERENT DE 71
      ELSE
        CALL MPI_COMM_RANK(MPI_COMM_WORLD,RANG4,IERMPI)
        RANG=RANG4
        CALL UTDEBM('F','FETAM','OPTION NON PREVUE EN COMPILE MPI')
        CALL UTIMPI('L','OPTION APPELEE: ',1,OPTMPI)
        CALL UTIMPI('L','RANG DU PROCESSEUR: ',1,RANG)
        CALL UTFINM()
      ENDIF
      CALL JEDEMA()       
      END
