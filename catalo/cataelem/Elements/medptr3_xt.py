...
ele.addCalcul(OP.CALC_GTP, te=288,
    para_in=((OP.CALC_GTP.PAINTER, LC.E35NEUTR), (OP.CALC_GTP.PBASECO, LC.E28NEUTR),
             ...
             (OP.CALC_GTP.PPMILTO, LC.E22NEUTR), (SP.PPRESSR, EPRESNO),
...
ele.addCalcul(OP.CALC_GTP_F, te=288,
    para_in=((OP.CALC_GTP_F.PAINTER, LC.E35NEUTR), (OP.CALC_GTP_F.PBASECO, LC.E28NEUTR),
             ...
             (OP.CALC_GTP_F.PPMILTO, LC.E22NEUTR), (SP.PPRESSF, CPRESSF),
             (SP.PROTATR, LC.CROTATR), (SP.PSIGISE, ECONTSE),
...
ele.addCalcul(OP.CALC_G_F, te=288,
    para_in=((OP.CALC_G_F.PAINTER, LC.E35NEUTR), (OP.CALC_G_F.PBASECO, LC.E28NEUTR),
             ...
             (OP.CALC_G_F.PHEAVTO, E6NEUTI), (OP.CALC_G_F.PLONCHA, LC.E10NEUTI),
...
ele.addCalcul(OP.CALC_K_G, te=297,
    para_in=((OP.CALC_K_G.PAINTER, LC.E35NEUTR), (OP.CALC_K_G.PBASECO, LC.E28NEUTR),
             ...
             (OP.CALC_K_G.PPMILTO, LC.E22NEUTR), (SP.PPRESSR, EPRESNO),
...
ele.addCalcul(OP.CALC_K_G_F, te=297,
    para_in=((OP.CALC_K_G_F.PAINTER, LC.E35NEUTR), (OP.CALC_K_G_F.PBASECO, LC.E28NEUTR),
             ...
             (OP.CALC_K_G_F.PPMILTO, LC.E22NEUTR), (SP.PPRESSF, CPRESSF),
             (SP.PPULPRO, LC.CFREQR), (SP.PROTATR, LC.CROTATR),
             (SP.PSIGISE, ECONTSE), (SP.PTEMPSR, CTEMPSR),
...
ele.addCalcul(OP.EPSI_ELGA, te=-2)

ele.addCalcul(OP.EPSP_ELGA, te=-2)

ele.addCalcul(OP.EPSP_ELNO, te=-2)

ele.addCalcul(OP.ERME_ELEM, te=382,
...
ele.addCalcul(OP.FULL_MECA, te=539,
    para_in=((OP.FULL_MECA.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
             ...
             (OP.FULL_MECA.PPINTTO, LC.E6NEUTR), (OP.FULL_MECA.PPMILTO, LC.E22NEUTR),
...
ele.addCalcul(OP.MASS_MECA, te=538,
    para_in=((OP.MASS_MECA.PBASLOR, LC.N6NEUT_R), (OP.MASS_MECA.PCNSETO, LC.E36NEUI),
             ...
             (OP.MASS_MECA.PPINTTO, LC.E6NEUTR), (OP.MASS_MECA.PSTANO, STANO_I),
...
ele.addCalcul(OP.RAPH_MECA, te=539,
    para_in=((OP.RAPH_MECA.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
             ...
             (OP.RAPH_MECA.PPINTTO, LC.E6NEUTR), (OP.RAPH_MECA.PPMILTO, LC.E22NEUTR),
...
ele.addCalcul(OP.RIGI_MECA, te=539,
    para_in=((OP.RIGI_MECA.PBASLOR, LC.N6NEUT_R), (OP.RIGI_MECA.PCNSETO, LC.E36NEUI),
             ...
             (OP.RIGI_MECA.PPINTTO, LC.E6NEUTR), (OP.RIGI_MECA.PPMILTO, LC.E22NEUTR),
             (OP.RIGI_MECA.PSTANO, STANO_I), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.RIGI_MECA_GE, te=536,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=539,
    para_in=((OP.RIGI_MECA_TANG.PBASLOR, LC.N6NEUT_R), (SP.PCAMASS, CCAMASS),
             ...
             (OP.RIGI_MECA_TANG.PPINTTO, LC.E6NEUTR), (OP.RIGI_MECA_TANG.PPMILTO, LC.E22NEUTR),
...
ele.addCalcul(OP.SIEF_ELNO, te=289,
...
ele.addCalcul(OP.SIGM_ELNO, te=289,
...
ele.addCalcul(OP.SISE_ELNO, te=289,
...
ele.addCalcul(OP.VARI_ELNO, te=-2)
...
#------------------------------------------------------------
MEDPTR3_XT = Element(modele=abstractElement)
ele = MEDPTR3_XT
...
ele.elrefe=(
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG3','MASS=FPG3','XINT=FPG12','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM36','FPG1=FPG1',), mater=('XFEM','NOEU',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2','MASS=FPG3',),),
    )


#------------------------------------------------------------
MEDPQU4_XT = Element(modele=abstractElement)
ele = MEDPQU4_XT
...
ele.elrefe=(
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','MASS=FPG4','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM72','FPG1=FPG1',), mater=('XFEM','NOEU',),),
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG3','MASS=FPG3','XINT=FPG12',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2','MASS=FPG3',),),
    )


#------------------------------------------------------------
MEDPTR6_XT = Element(modele=abstractElement)
ele = MEDPTR6_XT
...
ele.elrefe=(
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG3','MASS=FPG3','XINT=FPG12','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM72','FPG1=FPG1',), mater=('XFEM','NOEU',),),
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG6','MASS=FPG6','XINT=FPG12',),),
    )


#------------------------------------------------------------
MEDPQU8_XT = Element(modele=abstractElement)
ele = MEDPQU8_XT
