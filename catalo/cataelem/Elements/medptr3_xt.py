# coding=utf-8
# CATALOGUES DES ELEMENTS 2D_DP X-FEM CRACKTIP SANS CONTACT (QUE LINEAIRES ET QUADRATIQUES)
    ...
    calculs = (
        ...
        OP.CALC_G_F(te=288,
            para_in=((OP.CALC_G_F.PAINTER, LC.E35NEUTR), (OP.CALC_G_F.PBASECO, LC.E28NEUTR),
                     ...
                     (SP.PVARCRR, LC.ZVARCPG), (OP.CALC_G_F.PSTANO, STANO_I),),
            para_out=((SP.PGTHETA, LC.EGTHETA), ),
        ),
        ...
        OP.MASS_MECA(te=538,
            para_in=((OP.MASS_MECA.PBASLOR, LC.N6NEUT_R), (OP.MASS_MECA.PCNSETO, LC.E36NEUI),
                     ...
                     (OP.MASS_MECA.PVARCPR, LC.ZVARCPG), (OP.MASS_MECA.PPMILTO, LC.E22NEUTR),),
        ...
        OP.RIGI_MECA(te=539,
            para_in=((OP.RIGI_MECA.PBASLOR, LC.N6NEUT_R), (OP.RIGI_MECA.PCNSETO, LC.E36NEUI),
                     ...
                     (OP.RIGI_MECA.PSTANO, STANO_I), (OP.RIGI_MECA.PVARCPR, LC.ZVARCPG), ),
            para_out=((SP.PMATUUR, MMATUUR), ),
        ),
...
class MEDPQU8_XT(MEDPTR3_XT):
    ...
    elrefe =(
            ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','MASS=FPG9','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM72','FPG1=FPG1',), mater=('XFEM','NOEU',),),
