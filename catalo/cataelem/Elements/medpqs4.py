...
ECONTPC  = LocatedComponents(phys=PHY.SIEF_C, type='ELGA', location='RIGI',
    components=('SIXX','SIYY','SIZZ','SIXY','QXX',
          'QXY','QYX','QYY','QZX','QZY',))
...
ele.elrefe=(
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG1','MASS=FPG4','FPG1=FPG1','NOEU=NOEU',), mater=('RIGI','NOEU','FPG1',),),
...
ele.addCalcul(OP.CALC_ESTI_ERRE, te=291,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.CALC_ESTI_ERRE.PSIEF_R, ECONTPG), (SP.PSIGMA, ESIGMNO),
             (OP.CALC_ESTI_ERRE.PVARCPR, LC.ZVARCPG), ),
    para_out=((OP.CALC_ESTI_ERRE.PERREUR, EERREUR), ),
)

ele.addCalcul(OP.CALC_G, te=96,
    para_in=((OP.CALC_G.PCOMPOR, CCOMPOR), (SP.PCONTGR, ECONTPG),
             (OP.CALC_G.PCONTRR, ECONTPG), (SP.PDEFOPL, LC.EDEFPNO),
...
ele.addCalcul(OP.CALC_GTP, te=96,
    para_in=((OP.CALC_GTP.PCOMPOR, CCOMPOR), (SP.PCONTGR, ECONTPG),
             (OP.CALC_GTP.PCONTRR, ECONTPG), (SP.PDEFOPL, LC.EDEFPNO),
             (SP.PDEPLAR, DDL_MECA), (SP.PEPSINR, CEPSINR),
             (SP.PFRVOLU, NFORCER), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
             (SP.PROTATR, LC.CROTATR), (SP.PSIGINR, ESIGMNO),
             (SP.PTHETAR, DDL_MECA), (OP.CALC_GTP.PVARCPR, LC.ZVARCPG),
             (SP.PVARCRR, LC.ZVARCPG), (OP.CALC_GTP.PVARIPR, LC.ZVARINO),
             ),
    para_out=((SP.PGTHETA, LC.EGTHETA), ),
)

ele.addCalcul(OP.CALC_GTP_F, te=96,
    para_in=((OP.CALC_GTP_F.PCOMPOR, CCOMPOR), (SP.PCONTGR, ECONTPG),
             (OP.CALC_GTP_F.PCONTRR, ECONTPG), (SP.PDEFOPL, LC.EDEFPNO),
...
ele.addCalcul(OP.CALC_G_F, te=96,
    para_in=((OP.CALC_G_F.PCOMPOR, CCOMPOR), (SP.PCONTGR, ECONTPG),
             (OP.CALC_G_F.PCONTRR, ECONTPG), (SP.PDEFOPL, LC.EDEFPNO),
             (SP.PDEPLAR, DDL_MECA), (SP.PEPSINF, CEPSINF),
             (SP.PFFVOLU, CFORCEF), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
             (SP.PROTATR, LC.CROTATR), (SP.PSIGINR, ESIGMNO),
...
ele.addCalcul(OP.CALC_K_G, te=299,
...
ele.addCalcul(OP.CALC_K_G_F, te=299,
...
ele.addCalcul(OP.CALC_NOEU_BORD, te=290,
    para_in=((SP.PGEOMER, NGEOMER), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_EPSA_R, te=421,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.CHAR_MECA_EPSI_F, te=284,
...
ele.addCalcul(OP.CHAR_MECA_EPSI_R, te=284,
...
ele.addCalcul(OP.CHAR_MECA_FF2D2D, te=94,
    para_in=((SP.PFF2D2D, CFORCEF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_FR2D2D, te=93,
...
ele.addCalcul(OP.CHAR_MECA_META_Z, te=353,
...
ele.addCalcul(OP.CHAR_MECA_PESA_R, te=85,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.CHAR_MECA_PTOT_R, te=492,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (SP.PTEMPSR, CTEMPSR),
             (OP.CHAR_MECA_PTOT_R.PVARCPR, LC.ZVARCPG), (SP.PVARCRR, LC.ZVARCPG),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_ROTA_R, te=84,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.CHAR_MECA_TEMP_R, te=83,
...
ele.addCalcul(OP.ECIN_ELEM, te=82,
...
ele.addCalcul(OP.ENEL_ELEM, te=490,
...
ele.addCalcul(OP.ENEL_ELGA, te=575,
...
ele.addCalcul(OP.ENER_TOTALE, te=490,
...
ele.addCalcul(OP.EPME_ELGA, te=87,
...
ele.addCalcul(OP.EPMG_ELGA, te=87,
...
ele.addCalcul(OP.EPOT_ELEM, te=286,
...
ele.addCalcul(OP.EPSG_ELGA, te=87,
    para_in=((SP.PDEPLAR, DDL_MECA), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (SP.PTEMPSR, CTEMPSR),
...
ele.addCalcul(OP.EPSI_ELGA, te=87,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.EPSP_ELGA, te=334,
...
ele.addCalcul(OP.ERME_ELEM, te=377,
...
ele.addCalcul(OP.ERRE_QIZZ, te=292,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             ...
             (SP.PSIGMAD, ESIGMNO), (SP.PSIGMAP, ESIGMNO),
             (OP.ERRE_QIZZ.PVARCPR, LC.ZVARCPG), ),
    para_out=((OP.ERRE_QIZZ.PERREUR, EERREUR), ),
)

ele.addCalcul(OP.ETOT_ELEM, te=575,
...
ele.addCalcul(OP.ETOT_ELGA, te=575,
...
ele.addCalcul(OP.FORC_NODA, te=351,
...
ele.addCalcul(OP.FULL_MECA, te=350,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=350,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.INDIC_ENER, te=490,
...
ele.addCalcul(OP.INDIC_SEUIL, te=490,
...
ele.addCalcul(OP.QIRE_ELEM, te=378,
...
ele.addCalcul(OP.RAPH_MECA, te=350,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RICE_TRACEY, te=332,
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=350,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_GE, te=92,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=350,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.TOU_INI_ELNO, te=99,
    para_out=((OP.TOU_INI_ELNO.PDOMMAG, LC.EDOMGNO), (OP.TOU_INI_ELNO.PEPSI_R, EDEFONO),
             ...
             (OP.TOU_INI_ELNO.PSIEF_R, ESIGMNO), (OP.TOU_INI_ELNO.PVARI_R, LC.ZVARINO),
             ),
)
...
ele.addCalcul(OP.WEIBULL, te=331,
