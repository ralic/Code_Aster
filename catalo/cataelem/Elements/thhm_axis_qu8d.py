...
#------------------------------------------------------------
THHM_AXIS_QU8D = Element(modele=abstractElement)
ele = THHM_AXIS_QU8D
...
#------------------------------------------------------------
THHM_AXIS_TR6D = Element(modele=abstractElement)
ele = THHM_AXIS_TR6D
...
#------------------------------------------------------------
THHM_AXIS_QU8S = Element(modele=abstractElement)
ele = THHM_AXIS_QU8S
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
THHM_AXIS_TR6S = Element(modele=abstractElement)
ele = THHM_AXIS_TR6S
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
