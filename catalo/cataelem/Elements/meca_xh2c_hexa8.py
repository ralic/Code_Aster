...
#------------------------------------------------------------
MECA_XH2C_HEXA8 = Element(modele=abstractElement)
ele = MECA_XH2C_HEXA8
...
#------------------------------------------------------------
MECA_XH3C_HEXA8 = Element(modele=abstractElement)
ele = MECA_XH3C_HEXA8
ele.meshType = MT.HEXA8
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH4C_HEXA8 = Element(modele=abstractElement)
ele = MECA_XH4C_HEXA8
ele.meshType = MT.HEXA8
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH2C_PENTA6 = Element(modele=abstractElement)
ele = MECA_XH2C_PENTA6
...
#------------------------------------------------------------
MECA_XH3C_PENTA6 = Element(modele=abstractElement)
ele = MECA_XH3C_PENTA6
ele.meshType = MT.PENTA6
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH4C_PENTA6 = Element(modele=abstractElement)
ele = MECA_XH4C_PENTA6
ele.meshType = MT.PENTA6
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH2C_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XH2C_PYRAM5
...
#------------------------------------------------------------
MECA_XH3C_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XH3C_PYRAM5
ele.meshType = MT.PYRAM5
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH4C_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XH4C_PYRAM5
ele.meshType = MT.PYRAM5
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH2C_TETRA4 = Element(modele=abstractElement)
ele = MECA_XH2C_TETRA4
...
#------------------------------------------------------------
MECA_XH3C_TETRA4 = Element(modele=abstractElement)
ele = MECA_XH3C_TETRA4
ele.meshType = MT.TETRA4
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH4C_TETRA4 = Element(modele=abstractElement)
ele = MECA_XH4C_TETRA4
ele.meshType = MT.TETRA4
ele.nodes = (
