...
#------------------------------------------------------------
MNVG_HEXA20 = Element(modele=abstractElement)
ele = MNVG_HEXA20
...
#------------------------------------------------------------
MNVG_TETRA10 = Element(modele=abstractElement)
ele = MNVG_TETRA10
...
#------------------------------------------------------------
MNVG_PENTA15 = Element(modele=abstractElement)
ele = MNVG_PENTA15
...
#------------------------------------------------------------
MNVG_PYRAM13 = Element(modele=abstractElement)
ele = MNVG_PYRAM13
