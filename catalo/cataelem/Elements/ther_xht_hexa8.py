...
#------------------------------------------------------------
THER_XHT_HEXA8 = Element(modele=abstractElement)
ele = THER_XHT_HEXA8
...
#------------------------------------------------------------
THER_XHT_PENTA6 = Element(modele=abstractElement)
ele = THER_XHT_PENTA6
...
#------------------------------------------------------------
THER_XHT_PYRAM5 = Element(modele=abstractElement)
ele = THER_XHT_PYRAM5
...
#------------------------------------------------------------
THER_XHT_TETRA4 = Element(modele=abstractElement)
ele = THER_XHT_TETRA4
