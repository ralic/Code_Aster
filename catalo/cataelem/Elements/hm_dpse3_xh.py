...
ele.addCalcul(OP.CHAR_MECA_FLUX_F, te=579,
    para_in=((OP.CHAR_MECA_FLUX_F.PCNSETO, E6NEUTI), (SP.PFLUXF, CFLUXF),
             (SP.PGEOMER, NGEOMER), (OP.CHAR_MECA_FLUX_F.PHEAVTO, LC.E2NEUTI),
             (OP.CHAR_MECA_FLUX_F.PHEA_NO, LC.N5NEUTI), (OP.CHAR_MECA_FLUX_F.PHEA_SE, LC.E2NEUTI),
             (OP.CHAR_MECA_FLUX_F.PLONCHA, LC.E10NEUTI), (OP.CHAR_MECA_FLUX_F.PLSN, LC.N1NEUT_R),
             (OP.CHAR_MECA_FLUX_F.PPINTTO, LC.E6NEUTR), (OP.CHAR_MECA_FLUX_F.PPMILTO, LC.E4NEUTR),
...
ele.addCalcul(OP.CHAR_MECA_FLUX_R, te=579,
    para_in=((OP.CHAR_MECA_FLUX_R.PCNSETO, E6NEUTI), (SP.PFLUXR, EFLUXE),
             (SP.PGEOMER, NGEOMER), (OP.CHAR_MECA_FLUX_R.PHEAVTO, LC.E2NEUTI),
             (OP.CHAR_MECA_FLUX_R.PHEA_NO, LC.N5NEUTI), (OP.CHAR_MECA_FLUX_R.PHEA_SE, LC.E2NEUTI),
             (OP.CHAR_MECA_FLUX_R.PLONCHA, LC.E10NEUTI), (OP.CHAR_MECA_FLUX_R.PLSN, LC.N1NEUT_R),
             (OP.CHAR_MECA_FLUX_R.PPINTTO, LC.E6NEUTR), (OP.CHAR_MECA_FLUX_R.PPMILTO, LC.E4NEUTR),
...
#------------------------------------------------------------
HM_DPSE3_XH = Element(modele=abstractElement)
ele = HM_DPSE3_XH
