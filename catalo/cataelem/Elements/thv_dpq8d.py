...
#------------------------------------------------------------
THV_DPQ8D = Element(modele=abstractElement)
ele = THV_DPQ8D
...
#------------------------------------------------------------
THV_DPTR6D = Element(modele=abstractElement)
ele = THV_DPTR6D
...
#------------------------------------------------------------
THV_DPQ8S = Element(modele=abstractElement)
ele = THV_DPQ8S
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
THV_DPTR6S = Element(modele=abstractElement)
ele = THV_DPTR6S
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
