...
ele.addCalcul(OP.CALC_G, te=118,
...
#------------------------------------------------------------
MECA_XHT_FACE3 = Element(modele=abstractElement)
ele = MECA_XHT_FACE3
...
#------------------------------------------------------------
MECA_XHT_FACE4 = Element(modele=abstractElement)
ele = MECA_XHT_FACE4
...
#------------------------------------------------------------
MECA_XHT_FACE6 = Element(modele=abstractElement)
ele = MECA_XHT_FACE6
...
#------------------------------------------------------------
MECA_XHT_FACE8 = Element(modele=abstractElement)
ele = MECA_XHT_FACE8
