# coding=utf-8
# CATALOGUES DES ELEMENTS 3D X-FEM HEAVISIDE-CRACKTIP DE BORD SANS CONTACT (LINEAIRES ET QUADRATIQUES)
    ...
    calculs = (
        ...
        OP.CALC_G(te=118,
            para_in=((OP.CALC_G.PCNSETO, LC.E36NEUI), (SP.PDEPLAR, DDL_MECA),
                     ...
                     (OP.CALC_G.PSTANO, STANO_I),(OP.CALC_G.PPMILTO, E33NEUTR),),
...
#------------------------------------------------------------
class MECA_XHT_FACE4(MECA_XHT_FACE3):
    """Please document this element"""
    meshType = MT.QUAD4
    elrefe =(
...
#------------------------------------------------------------
class MECA_XHT_FACE6(MECA_XHT_FACE3):
    """Please document this element"""
    meshType = MT.TRIA6
    elrefe =(
...
#------------------------------------------------------------
class MECA_XHT_FACE8(MECA_XHT_FACE3):
    """Please document this element"""
    meshType = MT.QUAD8
    elrefe =(
