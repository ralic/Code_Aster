...
ele.addCalcul(OP.CHAR_MECA_PRES_F, te=37,
    para_in=((OP.CHAR_MECA_PRES_F.PAINTER, E65NEUTR), (OP.CHAR_MECA_PRES_F.PBASECO, E52NEUTR),
             (OP.CHAR_MECA_PRES_F.PCFACE, E21NEUTI), (OP.CHAR_MECA_PRES_F.PFISNO, LC.FISNO_I),
             (SP.PGEOMER, NGEOMER), (OP.CHAR_MECA_PRES_F.PHEA_FA, E14NEUI),
             ...
             (OP.CHAR_MECA_PRES_F.PPINTER, E26NEUTR), (SP.PPRESSF, CPRESSF),
...
ele.addCalcul(OP.CHAR_MECA_PRES_R, te=37,
    para_in=((OP.CHAR_MECA_PRES_R.PAINTER, E65NEUTR), (OP.CHAR_MECA_PRES_R.PBASECO, E52NEUTR),
             (OP.CHAR_MECA_PRES_R.PCFACE, E21NEUTI), (OP.CHAR_MECA_PRES_R.PFISNO, LC.FISNO_I),
             (SP.PGEOMER, NGEOMER), (OP.CHAR_MECA_PRES_R.PHEA_FA, E14NEUI),
             ...
             (OP.CHAR_MECA_PRES_R.PPINTER, E26NEUTR), (SP.PPRESSR, EPRESNO),
             (OP.CHAR_MECA_PRES_R.PSTANO, STANO_I), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_ROTA_R, te=441,
    para_in=((OP.CHAR_MECA_ROTA_R.PCNSETO, LC.E144NEUI), (SP.PGEOMER, NGEOMER),
             ...
             (OP.CHAR_MECA_ROTA_R.PPINTTO, LC.E24NEUTR), (OP.CHAR_MECA_ROTA_R.PPMILTO, LC.E88NEUTR),
...
ele.addCalcul(OP.CHVOIS_XFEM, te=400,
    para_in=((OP.CHVOIS_XFEM.PCNSETO, LC.E144NEUI), (OP.CHVOIS_XFEM.PLONCHA, LC.E10NEUTI),
             ),
...
ele.addCalcul(OP.MASS_MECA, te=82,
    para_in=((OP.MASS_MECA.PBASLOR, LC.N6NEUT_R), (OP.MASS_MECA.PCNSETO, LC.E144NEUI),
             ...
             (SP.PMATERC, LC.CMATERC), (OP.MASS_MECA.PPINTTO, LC.E24NEUTR),
             (OP.MASS_MECA.PPMILTO, LC.E88NEUTR), (OP.MASS_MECA.PSTANO, STANO_I),
             ),
...
ele.addCalcul(OP.XFEM_XPG, te=46,
    para_in=((OP.XFEM_XPG.PCNSETO, LC.E144NEUI), (SP.PGEOMER, NGEOMER),
             (OP.XFEM_XPG.PHEAVTO, E24NEUI), (OP.XFEM_XPG.PLONCHA, LC.E10NEUTI),
             (OP.XFEM_XPG.PPINTTO, LC.E24NEUTR), (OP.XFEM_XPG.PPMILTO, LC.E88NEUTR),
             ),
...
#------------------------------------------------------------
HM_DPTR6_XH1 = Element(modele=abstractElement)
ele = HM_DPTR6_XH1
...
#------------------------------------------------------------
HM_DPTR6_XH2 = Element(modele=abstractElement)
ele = HM_DPTR6_XH2
ele.meshType = MT.TRIA6
ele.nodes = (
...
#------------------------------------------------------------
HM_DPTR6_XH3 = Element(modele=abstractElement)
ele = HM_DPTR6_XH3
ele.meshType = MT.TRIA6
ele.nodes = (
...
#------------------------------------------------------------
HM_DPQ8_XH1 = Element(modele=abstractElement)
ele = HM_DPQ8_XH1
...
#------------------------------------------------------------
HM_DPQ8_XH2 = Element(modele=abstractElement)
ele = HM_DPQ8_XH2
ele.meshType = MT.QUAD8
ele.nodes = (
...
#------------------------------------------------------------
HM_DPQ8_XH3 = Element(modele=abstractElement)
ele = HM_DPQ8_XH3
ele.meshType = MT.QUAD8
ele.nodes = (
