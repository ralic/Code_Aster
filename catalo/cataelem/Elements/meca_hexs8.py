...
ele.elrefe=(
        ElrefeLoc(MT.HE8, gauss = ('RIGI=FPG1','MASS=FPG8','FPG1=FPG1','NOEU=NOEU',), mater=('RIGI','FPG1',),),
...
ele.addCalcul(OP.CALC_ESTI_ERRE, te=291,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.CALC_ESTI_ERRE.PSIEF_R, ESIGMPG), (SP.PSIGMA, ESIGMNO),
...
ele.addCalcul(OP.CALC_G, te=27,
    para_in=((SP.PACCELE, DDL_MECA), (OP.CALC_G.PCOMPOR, CCOMPOR),
             ...
             (SP.PSIGINR, ESIGMNO), (SP.PTHETAR, DDL_MECA),
...
ele.addCalcul(OP.ENDO_ELGA, te=512,
    para_in=((OP.ENDO_ELGA.PCOMPOR, CCOMPOR), (SP.PCONTGP, ESIGMPG),
...
ele.addCalcul(OP.FORC_NODA, te=395,
...
ele.addCalcul(OP.FULL_MECA, te=407,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=407,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RAPH_MECA, te=407,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.REFE_FORC_NODA, te=395,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PREFCO, EREFCO), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)
...
ele.addCalcul(OP.RIGI_MECA, te=392,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=407,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=407,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
