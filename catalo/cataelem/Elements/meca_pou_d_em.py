...
ele.addCalcul(OP.EPSI_ELGA, te=537,
...
ele.addCalcul(OP.FULL_MECA, te=535,
...
ele.addCalcul(OP.RAPH_MECA, te=535,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=535,
...
ele.addCalcul(OP.SIEF_ELGA, te=537,
...
ele.addCalcul(OP.STRX_ELGA, te=537,
...
#------------------------------------------------------------
MECA_POU_D_EM = Element(modele=abstractElement)
ele = MECA_POU_D_EM
