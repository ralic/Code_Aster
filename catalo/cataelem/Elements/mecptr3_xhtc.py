...
ele.addCalcul(OP.CALC_GTP, te=288,
    para_in=((OP.CALC_GTP.PAINTER, LC.E35NEUTR), (OP.CALC_GTP.PBASECO, LC.E28NEUTR),
             ...
             (OP.CALC_GTP.PPINTTO, LC.E6NEUTR), (SP.PPRESSR, EPRESNO),
             (SP.PROTATR, LC.CROTATR), (SP.PTHETAR, DDL_MECC),
...
ele.addCalcul(OP.CALC_GTP_F, te=288,
    para_in=((OP.CALC_GTP_F.PAINTER, LC.E35NEUTR), (OP.CALC_GTP_F.PBASECO, LC.E28NEUTR),
             ...
             (OP.CALC_GTP_F.PPINTTO, LC.E6NEUTR), (SP.PPRESSF, CPRESSF),
...
ele.addCalcul(OP.CHAR_MECA_PRES_F, te=37,
    para_in=((OP.CHAR_MECA_PRES_F.PAINTER, LC.E35NEUTR), (OP.CHAR_MECA_PRES_F.PBASECO, LC.E28NEUTR),
             ...
             (OP.CHAR_MECA_PRES_F.PLONGCO, LC.E3NEUTI), (OP.CHAR_MECA_PRES_F.PLSN, LC.N1NEUT_R),
...
#------------------------------------------------------------
MECPTR3_XHTC = Element(modele=abstractElement)
ele = MECPTR3_XHTC
...
#------------------------------------------------------------
MECPQU4_XHTC = Element(modele=abstractElement)
ele = MECPQU4_XHTC
