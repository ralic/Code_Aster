...
ele.addCalcul(OP.CHAR_MECA_FF1D2D, te=36,
...
ele.addCalcul(OP.CHAR_MECA_FR1D2D, te=36,
...
#------------------------------------------------------------
MEAXSE2_XH = Element(modele=abstractElement)
ele = MEAXSE2_XH
...
#------------------------------------------------------------
MEAXSE3_XH = Element(modele=abstractElement)
ele = MEAXSE3_XH
