...
ele.addCalcul(OP.AMOR_MECA, te=41,
...
ele.addCalcul(OP.CHAR_MECA_PESA_R, te=43,
...
ele.addCalcul(OP.CHAR_MECA_ROTA_R, te=43,
    para_in=((SP.PCINFDI, LC.CCINFDI), (SP.PROTATR, LC.CROTATR),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_TEMP_R, te=99,
...
ele.addCalcul(OP.ECIN_ELEM, te=44,
...
ele.addCalcul(OP.EPOT_ELEM, te=44,
...
ele.addCalcul(OP.FONL_NOEU, te=39,
...
ele.addCalcul(OP.FORC_NODA, te=39,
...
ele.addCalcul(OP.FULL_MECA, te=47,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=47,
...
ele.addCalcul(OP.MASS_FLUI_STRU, te=41,
...
ele.addCalcul(OP.MASS_INER, te=45,
...
ele.addCalcul(OP.MASS_MECA, te=41,
...
ele.addCalcul(OP.MASS_MECA_DIAG, te=41,
...
ele.addCalcul(OP.MASS_MECA_EXPLI, te=41,
...
ele.addCalcul(OP.MECA_GYRO, te=9,
    para_in=((SP.PCADISM, CCADISM), (OP.MECA_GYRO.PCAORIE, CCAORIE),
             (SP.PCINFDI, LC.CCINFDI), (SP.PGEOMER, NGEOMER),
             ),
    para_out=((SP.PMATUNS, MMATUNS), ),
)

ele.addCalcul(OP.M_GAMMA, te=41,
...
ele.addCalcul(OP.RAPH_MECA, te=47,
...
ele.addCalcul(OP.REFE_FORC_NODA, te=39,
...
ele.addCalcul(OP.RIGI_FLUI_STRU, te=41,
...
ele.addCalcul(OP.RIGI_GYRO, te=464,
    para_in=((SP.PCADISM, CCADISM), (OP.RIGI_GYRO.PCAORIE, CCAORIE),
             (SP.PCINFDI, LC.CCINFDI), (SP.PGEOMER, NGEOMER),
             ),
    para_out=((SP.PMATUNS, MMATUNS), ),
)

ele.addCalcul(OP.RIGI_MECA, te=41,
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=47,
...
ele.addCalcul(OP.SIEF_ELGA, te=42,
...
#------------------------------------------------------------
MECA_DIS_TR_N = Element(modele=abstractElement)
ele = MECA_DIS_TR_N
