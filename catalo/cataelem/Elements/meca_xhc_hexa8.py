...
class TemplateElement(Element):
    ...
    calculs = (
        ...
        OP.CALC_K_G_COHE(te=297,
            para_in=((OP.CALC_K_G_COHE.PAINTER, LC.E200NEUT), (OP.CALC_K_G_COHE.PBASECO, LC.E360NEUT),
                     ...
                     (OP.CALC_K_G_COHE.PPINTER, LC.E120NEUT), (SP.PTHETAR, DDL_MECC),
                     ),
            para_out=((SP.PGTHETA, EKTHETA), ),
        ),
        ...
        OP.CHAR_MECA_FROT(te=534,
            para_in=((OP.CHAR_MECA_FROT.PAINTER, LC.E200NEUT), (OP.CHAR_MECA_FROT.PBASECO, LC.E360NEUT),
                     ...
                     (SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_FROT.PPINTER, LC.E120NEUT),
        ...
        OP.PILO_PRED_ELAS(te=547,
            para_in=((OP.PILO_PRED_ELAS.PAINTER, LC.E200NEUT), (OP.PILO_PRED_ELAS.PBASECO, LC.E360NEUT),
                     ...
                     (OP.PILO_PRED_ELAS.PPINTER, LC.E120NEUT), ),
            para_out=((OP.PILO_PRED_ELAS.PCOPILO, ECOPILO), ),
        ),

        OP.PILO_PRED_ELAS_M(te=547,
            para_in=((OP.PILO_PRED_ELAS_M.PAINTER, LC.E200NEUT), (OP.PILO_PRED_ELAS_M.PBASECO, LC.E360NEUT),
                     ...
                     (OP.PILO_PRED_ELAS_M.PPINTER, LC.E120NEUT), ),
        ...
        OP.REFE_FORC_NODA(te=542,
            para_in=((OP.REFE_FORC_NODA.PAINTER, LC.E200NEUT), (OP.REFE_FORC_NODA.PBASECO, LC.E360NEUT),
                     ...
                     (OP.REFE_FORC_NODA.PPINTER, LC.E120NEUT), (OP.REFE_FORC_NODA.PPINTTO, E33NEUTR),
        ...
        OP.RIGI_CONT_M(te=533,
            para_in=((OP.RIGI_CONT_M.PAINTER, LC.E200NEUT), (OP.RIGI_CONT_M.PBASECO, LC.E360NEUT),
                     ...
                     (OP.RIGI_CONT_M.PPINTER, LC.E120NEUT), (OP.RIGI_CONT_M.PSEUIL, LC.E1NEUTR),
        ...
        OP.XCVBCA_MORTAR(te=532,
            para_in=((OP.XCVBCA_MORTAR.PAINTER, LC.E200NEUT), (OP.XCVBCA_MORTAR.PBASECO, LC.E360NEUT),
                     ...
                     (SP.PMEMCON, LC.E1NEUTI), (OP.XCVBCA_MORTAR.PPINTER, LC.E120NEUT),
                     ),
