...
DDL_MECA = LocatedComponents(phys=PHY.DEPL_R, type='ELNO', diff=True,
    ...
    ('EN3',('DX','DY','DZ','H1X','H1Y',
          'H1Z','LAGS_C','LAGS_F[2]','LAG2_C','LAG2_F[2]',
          'LAG3_C','LAG3_F[2]',)),))
...
ECOPILO  = LocatedComponents(phys=PHY.PILO_R, type='ELGA', location='XFEM',
...
ele.addCalcul(OP.CALC_K_G_COHE, te=297,
    para_in=((OP.CALC_K_G_COHE.PAINTER, LC.E170NEUT), (OP.CALC_K_G_COHE.PBASECO, LC.E306NEUT),
             (OP.CALC_K_G_COHE.PBASLOR, LC.N9NEUT_R), (OP.CALC_K_G_COHE.PCFACE, LC.E90NEUTI),
             (SP.PDEPLAR, DDL_MECA), (SP.PGEOMER, NGEOMER),
             (OP.CALC_K_G_COHE.PHEA_NO, LC.N5NEUTI), (OP.CALC_K_G_COHE.PLONGCO, LC.E3NEUTI),
             (OP.CALC_K_G_COHE.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
             (OP.CALC_K_G_COHE.PPINTER, LC.E102NEUT), (SP.PTHETAR, DDL_MECC),
             ),
    para_out=((SP.PGTHETA, EKTHETA), ),
)
...
ele.addCalcul(OP.CHAR_MECA_CONT, te=534,
    para_in=((OP.CHAR_MECA_CONT.PAINTER, LC.E170NEUT), (OP.CHAR_MECA_CONT.PBASECO, LC.E306NEUT),
             (OP.CHAR_MECA_CONT.PCFACE, LC.E90NEUTI), (SP.PCOHES, LC.E3NEUTR),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.CHAR_MECA_CONT.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.E1NEUTI),
             (OP.CHAR_MECA_CONT.PLONGCO, LC.E3NEUTI), (OP.CHAR_MECA_CONT.PLST, LC.N1NEUT_R),
             (SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_CONT.PPINTER, LC.E102NEUT),
             (OP.CHAR_MECA_CONT.PSEUIL, LC.E1NEUTR), (OP.CHAR_MECA_CONT.PSTANO, STANO_I),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_CONT_M, te=534,
    para_in=((OP.CHAR_MECA_CONT_M.PAINTER, LC.E170NEUT), (OP.CHAR_MECA_CONT_M.PBASECO, LC.E306NEUT),
             (OP.CHAR_MECA_CONT_M.PCFACE, LC.E90NEUTI), (SP.PCOHES, LC.N3NEUT_R),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.CHAR_MECA_CONT_M.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.E1NEUTI),
             (OP.CHAR_MECA_CONT_M.PLONGCO, LC.E3NEUTI), (OP.CHAR_MECA_CONT_M.PLST, LC.N1NEUT_R),
             (SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_CONT_M.PPINTER, LC.E102NEUT),
...
ele.addCalcul(OP.CHAR_MECA_FROT, te=534,
    para_in=((OP.CHAR_MECA_FROT.PAINTER, LC.E170NEUT), (OP.CHAR_MECA_FROT.PBASECO, LC.E306NEUT),
             (OP.CHAR_MECA_FROT.PCFACE, LC.E90NEUTI), (SP.PCOHES, LC.E3NEUTR),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.CHAR_MECA_FROT.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.E1NEUTI),
             (OP.CHAR_MECA_FROT.PLONGCO, LC.E3NEUTI), (OP.CHAR_MECA_FROT.PLST, LC.N1NEUT_R),
             (SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_FROT.PPINTER, LC.E102NEUT),
...
ele.addCalcul(OP.GEOM_FAC, te=519,
    para_in=((SP.NOMFIS, E1NEUTK), (SP.PDEPLA, DDL_MECA),
             ...
             (OP.GEOM_FAC.PPINTER, LC.E102NEUT), ),
...
ele.addCalcul(OP.PILO_PRED_ELAS, te=547,
    para_in=((OP.PILO_PRED_ELAS.PAINTER, LC.E170NEUT), (OP.PILO_PRED_ELAS.PBASECO, LC.E306NEUT),
             (SP.PCDTAU, LC.CCDTAU), (OP.PILO_PRED_ELAS.PCFACE, LC.E90NEUTI),
             ...
             (OP.PILO_PRED_ELAS.PLONGCO, LC.E3NEUTI), (OP.PILO_PRED_ELAS.PLSN, LC.N1NEUT_R),
             (OP.PILO_PRED_ELAS.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
             (OP.PILO_PRED_ELAS.PPINTER, LC.E102NEUT), ),
    para_out=((OP.PILO_PRED_ELAS.PCOPILO, ECOPILO), ),
)

ele.addCalcul(OP.PILO_PRED_ELAS_M, te=547,
    para_in=((OP.PILO_PRED_ELAS_M.PAINTER, LC.E170NEUT), (OP.PILO_PRED_ELAS_M.PBASECO, LC.E306NEUT),
             (SP.PCDTAU, LC.CCDTAU), (OP.PILO_PRED_ELAS_M.PCFACE, LC.E90NEUTI),
             (SP.PCOHES, LC.N3NEUT_R), (SP.PDDEPLR, DDL_MECA),
             (SP.PDEPL0R, DDL_MECA), (SP.PDEPL1R, DDL_MECA),
             (SP.PDEPLMR, DDL_MECA), (SP.PDONCO, CONTX_R),
             (SP.PGEOMER, NGEOMER), (SP.PINDCOI, LC.E1NEUTI),
             (OP.PILO_PRED_ELAS_M.PLONGCO, LC.E3NEUTI), (OP.PILO_PRED_ELAS_M.PLSN, LC.N1NEUT_R),
             (OP.PILO_PRED_ELAS_M.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
             (OP.PILO_PRED_ELAS_M.PPINTER, LC.E102NEUT), ),
...
ele.addCalcul(OP.REFE_FORC_NODA, te=542,
    para_in=((OP.REFE_FORC_NODA.PAINTER, LC.E170NEUT), (OP.REFE_FORC_NODA.PBASECO, LC.E306NEUT),
             (OP.REFE_FORC_NODA.PBASLOR, LC.N9NEUT_R), (OP.REFE_FORC_NODA.PCFACE, LC.E90NEUTI),
             (OP.REFE_FORC_NODA.PCNSETO, LC.E320NEUI), (OP.REFE_FORC_NODA.PCOMPOR, CCOMPOR),
             (SP.PDEPLMR, DDL_MECA), (SP.PGEOMER, NGEOMER),
             (OP.REFE_FORC_NODA.PHEAVTO, LC.E32NEUTI), (OP.REFE_FORC_NODA.PHEA_NO, LC.N5NEUTI),
             (OP.REFE_FORC_NODA.PLONCHA, LC.E10NEUTI), (SP.PLONFA, LC.E3NEUTI),
             (OP.REFE_FORC_NODA.PLSN, LC.N1NEUT_R), (OP.REFE_FORC_NODA.PLST, LC.N1NEUT_R),
             (OP.REFE_FORC_NODA.PPINTER, LC.E102NEUT), (OP.REFE_FORC_NODA.PPINTTO, E33NEUTR),
             (OP.REFE_FORC_NODA.PPMILTO, LC.E198NEUT), (SP.PREFCO, EREFCO),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)
...
ele.addCalcul(OP.RIGI_CONT, te=533,
    para_in=((OP.RIGI_CONT.PAINTER, LC.E170NEUT), (OP.RIGI_CONT.PBASECO, LC.E306NEUT),
             (OP.RIGI_CONT.PCFACE, LC.E90NEUTI), (SP.PCOHES, LC.E3NEUTR),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.RIGI_CONT.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.E1NEUTI),
             (OP.RIGI_CONT.PLONGCO, LC.E3NEUTI), (OP.RIGI_CONT.PLSN, LC.N1NEUT_R),
             (OP.RIGI_CONT.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
             (OP.RIGI_CONT.PPINTER, LC.E102NEUT), (OP.RIGI_CONT.PSEUIL, LC.E1NEUTR),
             (OP.RIGI_CONT.PSTANO, STANO_I), ),
    para_out=((OP.RIGI_CONT.PCOHESO, LC.E3NEUTR), (SP.PMATUNS, MMATUNS),
             (SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.RIGI_CONT_M, te=533,
    para_in=((OP.RIGI_CONT_M.PAINTER, LC.E170NEUT), (OP.RIGI_CONT_M.PBASECO, LC.E306NEUT),
             (OP.RIGI_CONT_M.PCFACE, LC.E90NEUTI), (SP.PCOHES, LC.N3NEUT_R),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.RIGI_CONT_M.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.E1NEUTI),
             (OP.RIGI_CONT_M.PLONGCO, LC.E3NEUTI), (OP.RIGI_CONT_M.PLSN, LC.N1NEUT_R),
             (OP.RIGI_CONT_M.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
             (OP.RIGI_CONT_M.PPINTER, LC.E102NEUT), (OP.RIGI_CONT_M.PSEUIL, LC.E1NEUTR),
             (OP.RIGI_CONT_M.PSTANO, STANO_I), ),
    para_out=((OP.RIGI_CONT_M.PCOHESO, LC.N3NEUT_R), (SP.PMATUNS, MMATUNS),
             (SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.RIGI_FROT, te=533,
    para_in=((OP.RIGI_FROT.PAINTER, LC.E170NEUT), (OP.RIGI_FROT.PBASECO, LC.E306NEUT),
             (OP.RIGI_FROT.PCFACE, LC.E90NEUTI), (SP.PCOHES, LC.E3NEUTR),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.RIGI_FROT.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.E1NEUTI),
             (OP.RIGI_FROT.PLONGCO, LC.E3NEUTI), (OP.RIGI_FROT.PLSN, LC.N1NEUT_R),
             (OP.RIGI_FROT.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
             (OP.RIGI_FROT.PPINTER, LC.E102NEUT), (OP.RIGI_FROT.PSEUIL, LC.E1NEUTR),
...
ele.addCalcul(OP.XCVBCA, te=532,
    para_in=((OP.XCVBCA.PAINTER, LC.E170NEUT), (OP.XCVBCA.PBASECO, LC.E306NEUT),
             (OP.XCVBCA.PCFACE, LC.E90NEUTI), (SP.PCOHES, LC.E3NEUTR),
             (SP.PDEPL_P, DDL_MECA), (SP.PDONCO, CONTX_R),
             (SP.PGEOMER, NGEOMER), (SP.PGLISS, LC.E1NEUTI),
             (OP.XCVBCA.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.E1NEUTI),
             (OP.XCVBCA.PLONGCO, LC.E3NEUTI), (OP.XCVBCA.PLST, LC.N1NEUT_R),
             (SP.PMATERC, LC.CMATERC), (SP.PMEMCON, LC.E1NEUTI),
             (OP.XCVBCA.PPINTER, LC.E102NEUT), ),
    para_out=((OP.XCVBCA.PCOHESO, LC.E3NEUTR), (SP.PINCOCA, LC.E1NEUTI),
             (SP.PINDCOO, LC.E1NEUTI), (SP.PINDMEM, LC.E1NEUTI),
             ),
)

ele.addCalcul(OP.XCVBCA_MORTAR, te=532,
    para_in=((OP.XCVBCA_MORTAR.PAINTER, LC.E170NEUT), (OP.XCVBCA_MORTAR.PBASECO, LC.E306NEUT),
             (OP.XCVBCA_MORTAR.PCFACE, LC.E90NEUTI), (SP.PCOHES, LC.N3NEUT_R),
             (SP.PDEPL_P, DDL_MECA), (SP.PDONCO, CONTX_R),
             (SP.PGEOMER, NGEOMER), (SP.PGLISS, LC.E1NEUTI),
             (SP.PINDCOI, LC.E1NEUTI), (OP.XCVBCA_MORTAR.PLONGCO, LC.E3NEUTI),
             (OP.XCVBCA_MORTAR.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
             (SP.PMEMCON, LC.E1NEUTI), (OP.XCVBCA_MORTAR.PPINTER, LC.E102NEUT),
             ),
    para_out=((OP.XCVBCA_MORTAR.PCOHESO, LC.N3NEUT_R), (SP.PINCOCA, LC.E1NEUTI),
             (SP.PINDCOO, LC.E1NEUTI), (SP.PINDMEM, LC.E1NEUTI),
             ),
)
...
ele.addCalcul(OP.XREACL, te=548,
    para_in=((OP.XREACL.PAINTER, LC.E170NEUT), (OP.XREACL.PBASECO, LC.E306NEUT),
             ...
             (OP.XREACL.PPINTER, LC.E102NEUT), ),
    para_out=((OP.XREACL.PSEUIL, LC.E1NEUTR), ),
)


#------------------------------------------------------------
MECA_XHC_HEXA8 = Element(modele=abstractElement)
ele = MECA_XHC_HEXA8
...
ele.modifyCalcul(OP.CALC_K_G_COHE, te=-1)

ele.modifyCalcul(OP.CHAR_MECA_CONT_M, te=-1)

ele.modifyCalcul(OP.PILO_PRED_ELAS_M, te=-1)

ele.modifyCalcul(OP.RIGI_CONT_M, te=-1)

ele.modifyCalcul(OP.XCVBCA_MORTAR, te=-1)


#------------------------------------------------------------
MECA_XHC_PENTA6 = Element(modele=abstractElement)
ele = MECA_XHC_PENTA6
...
#------------------------------------------------------------
MECA_XHC_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XHC_PYRAM5
...
#------------------------------------------------------------
MECA_XHC_TETRA4 = Element(modele=abstractElement)
ele = MECA_XHC_TETRA4
...
ele.elrefe=(
        ElrefeLoc(MT.TE4, gauss = ('RIGI=FPG1','NOEU=NOEU','XINT=FPG15','XFEM=XFEM90','FPG1=FPG1',), mater=('RIGI','XFEM',),),
        ElrefeLoc(MT.TR3, gauss = ('FPG4=FPG4','NOEU=NOEU','FPG6=FPG6','FPG7=FPG7','XCON=FPG12','SIMP=SIMP','GAUSS=FPG12',),),
    )
...
#------------------------------------------------------------
MECA_XHC_HEXA20 = Element(modele=abstractElement)
ele = MECA_XHC_HEXA20
...
#------------------------------------------------------------
MECA_XHC_PENTA15 = Element(modele=abstractElement)
ele = MECA_XHC_PENTA15
...
#------------------------------------------------------------
MECA_XHC_PYRAM13 = Element(modele=abstractElement)
ele = MECA_XHC_PYRAM13
...
#------------------------------------------------------------
MECA_XHC_TETRA10 = Element(modele=abstractElement)
ele = MECA_XHC_TETRA10
...
ele.elrefe=(
        ElrefeLoc(MT.T10, gauss = ('RIGI=FPG5','NOEU=NOEU','XINT=FPG15','XFEM=XFEM90','FPG1=FPG1',), mater=('RIGI','XFEM',),),
        ElrefeLoc(MT.TE4, gauss = ('XINT=FPG15','NOEU=NOEU',),),
        ElrefeLoc(MT.TR3, gauss = ('FPG4=FPG4','NOEU=NOEU','FPG6=FPG6','FPG7=FPG7','XCON=FPG12','SIMP=SIMP','GAUSS=FPG12',),),
    )
...
#------------------------------------------------------------
MECA_XHC3_HEXA8 = Element(modele=abstractElement)
ele = MECA_XHC3_HEXA8
ele.meshType = MT.HEXA8
ele.nodes = (
...
ele.modifyCalcul(OP.CALC_G_F, te=-1)

ele.modifyCalcul(OP.CALC_G, te=-1)

ele.modifyCalcul(OP.CALC_GTP, te=-1)

ele.modifyCalcul(OP.CALC_GTP_F, te=-1)

ele.modifyCalcul(OP.CALC_K_G_F, te=-1)

ele.modifyCalcul(OP.CHAR_MECA_CONT, te=-1)

ele.modifyCalcul(OP.PILO_PRED_ELAS, te=-1)

ele.modifyCalcul(OP.REFE_FORC_NODA, te=-1)

ele.modifyCalcul(OP.RIGI_CONT, te=-1)

ele.modifyCalcul(OP.XCVBCA, te=-1)

ele.modifyCalcul(OP.XREACL, te=-1)


#------------------------------------------------------------
MECA_XHC3_PENTA6 = Element(modele=abstractElement)
ele = MECA_XHC3_PENTA6
ele.meshType = MT.PENTA6
ele.nodes = (
...
#------------------------------------------------------------
MECA_XHC3_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XHC3_PYRAM5
ele.meshType = MT.PYRAM5
ele.nodes = (
...
#------------------------------------------------------------
MECA_XHC3_TETRA4 = Element(modele=abstractElement)
ele = MECA_XHC3_TETRA4
ele.meshType = MT.TETRA4
ele.nodes = (
