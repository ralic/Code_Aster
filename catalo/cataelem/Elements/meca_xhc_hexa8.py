# coding=utf-8
# CATALOGUES DES ELEMENTS X-FEM HEAVISIDE AVEC CONTACT (QUE LINEAIRES)
...
class MECA_XHC_HEXA8(TemplateElement):
...
#------------------------------------------------------------
class MECA_XHC_PENTA6(TemplateElement):
    """Please document this element"""
    meshType = MT.PENTA6
    nodes = (
...
#------------------------------------------------------------
class MECA_XHC_PYRAM5(TemplateElement):
    """Please document this element"""
    meshType = MT.PYRAM5
    nodes = (
...
#------------------------------------------------------------
class MECA_XHC_TETRA4(TemplateElement):
    """Please document this element"""
    meshType = MT.TETRA4
    nodes = (
...
#------------------------------------------------------------
class MECA_XHC_HEXA20(TemplateElement):
    """Please document this element"""
    meshType = MT.HEXA20
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,5,6,7,8,)),
...
#------------------------------------------------------------
class MECA_XHC_PENTA15(TemplateElement):
    """Please document this element"""
    meshType = MT.PENTA15
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,5,6,)),
...
#------------------------------------------------------------
class MECA_XHC_PYRAM13(TemplateElement):
    """Please document this element"""
    meshType = MT.PYRAM13
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,5,)),
...
#------------------------------------------------------------
class MECA_XHC_TETRA10(TemplateElement):
    """Please document this element"""
    meshType = MT.TETRA10
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,)),
...
#------------------------------------------------------------
class MECA_XHC3_HEXA8(TemplateElement):
    """Please document this element"""
    meshType = MT.HEXA8
    nodes = (
...
#------------------------------------------------------------
class MECA_XHC3_PENTA6(TemplateElement):
    """Please document this element"""
    meshType = MT.PENTA6
    nodes = (
...
#------------------------------------------------------------
class MECA_XHC3_PYRAM5(TemplateElement):
    """Please document this element"""
    meshType = MT.PYRAM5
    nodes = (
...
#------------------------------------------------------------
class MECA_XHC3_TETRA4(TemplateElement):
    """Please document this element"""
    meshType = MT.TETRA4
    nodes = (
