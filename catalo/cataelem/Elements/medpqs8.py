...
ele.addCalcul(OP.FULL_MECA, te=100,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=100,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.PDIL_ELGA, te=511,
    para_in=((OP.PDIL_ELGA.PCOMPOR, CCOMPOR), (OP.PDIL_ELGA.PCONTPR, ECONTPG),
...
ele.addCalcul(OP.RAPH_MECA, te=100,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=100,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_IMPLEX, te=100,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=100,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.TOU_INI_ELEM, te=99,
    para_out=((OP.TOU_INI_ELEM.PERREUR, EERREUR), (OP.TOU_INI_ELEM.PGEOM_R, CGEOMER),
             ),
)
...
#------------------------------------------------------------
MEDPQS8 = Element(modele=abstractElement)
ele = MEDPQS8
...
#------------------------------------------------------------
MEDPQU4 = Element(modele=abstractElement)
ele = MEDPQU4
...
#------------------------------------------------------------
MDDPQU4 = Element(modele=abstractElement)
ele = MDDPQU4
ele.meshType = MT.QUAD4
ele.nodes = (
        SetOfNodes('EN1', (1,2,3,4,)),
...
#------------------------------------------------------------
MEDPTR3 = Element(modele=abstractElement)
ele = MEDPTR3
...
#------------------------------------------------------------
MEDPTR6 = Element(modele=abstractElement)
ele = MEDPTR6
...
#------------------------------------------------------------
MEDPQU8 = Element(modele=abstractElement)
ele = MEDPQU8
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN1', (1,2,3,4,5,6,7,8,)),
...
#------------------------------------------------------------
MEDPQU9 = Element(modele=abstractElement)
ele = MEDPQU9
