...
ele.addCalcul(OP.CARA_SECT_POUT5, te=570,
...
ele.addCalcul(OP.CHAR_MECA_FF1D3D, te=418,
    para_in=((SP.PFF1D3D, MFORCEF), (SP.PGEOMER, MGEOMER),
             (SP.PTEMPSR, LC.MTEMPSR), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_FR1D3D, te=418,
...
#------------------------------------------------------------
MEBOCQ3 = Element(modele=abstractElement)
ele = MEBOCQ3
