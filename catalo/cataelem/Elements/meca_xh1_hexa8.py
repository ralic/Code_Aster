...
#------------------------------------------------------------
MECA_XH1_HEXA8 = Element(modele=abstractElement)
ele = MECA_XH1_HEXA8
...
#------------------------------------------------------------
MECA_XH2_HEXA8 = Element(modele=abstractElement)
ele = MECA_XH2_HEXA8
ele.meshType = MT.HEXA8
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH3_HEXA8 = Element(modele=abstractElement)
ele = MECA_XH3_HEXA8
ele.meshType = MT.HEXA8
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH4_HEXA8 = Element(modele=abstractElement)
ele = MECA_XH4_HEXA8
ele.meshType = MT.HEXA8
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH1_PENTA6 = Element(modele=abstractElement)
ele = MECA_XH1_PENTA6
...
#------------------------------------------------------------
MECA_XH2_PENTA6 = Element(modele=abstractElement)
ele = MECA_XH2_PENTA6
ele.meshType = MT.PENTA6
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH3_PENTA6 = Element(modele=abstractElement)
ele = MECA_XH3_PENTA6
ele.meshType = MT.PENTA6
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH4_PENTA6 = Element(modele=abstractElement)
ele = MECA_XH4_PENTA6
ele.meshType = MT.PENTA6
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH1_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XH1_PYRAM5
...
#------------------------------------------------------------
MECA_XH2_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XH2_PYRAM5
ele.meshType = MT.PYRAM5
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH3_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XH3_PYRAM5
ele.meshType = MT.PYRAM5
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH4_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XH4_PYRAM5
ele.meshType = MT.PYRAM5
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH1_TETRA4 = Element(modele=abstractElement)
ele = MECA_XH1_TETRA4
...
#------------------------------------------------------------
MECA_XH2_TETRA4 = Element(modele=abstractElement)
ele = MECA_XH2_TETRA4
ele.meshType = MT.TETRA4
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH3_TETRA4 = Element(modele=abstractElement)
ele = MECA_XH3_TETRA4
ele.meshType = MT.TETRA4
ele.nodes = (
...
#------------------------------------------------------------
MECA_XH4_TETRA4 = Element(modele=abstractElement)
ele = MECA_XH4_TETRA4
ele.meshType = MT.TETRA4
ele.nodes = (
