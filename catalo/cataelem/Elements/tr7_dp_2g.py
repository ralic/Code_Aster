...
ele.addCalcul(OP.CHAR_MECA_PESA_R, te=6,
...
ele.addCalcul(OP.EPSI_ELGA, te=6,
...
ele.addCalcul(OP.FORC_NODA, te=6,
...
ele.addCalcul(OP.FULL_MECA, te=6,
...
ele.addCalcul(OP.RAPH_MECA, te=6,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=6,
...
#------------------------------------------------------------
TR7_DP_2G = Element(modele=abstractElement)
ele = TR7_DP_2G
...
ele.elrefe=(
        ElrefeLoc(MT.TR7, gauss = ('RIGI=FPG3','FPG1=FPG1',), mater=('RIGI','FPG1',),),
...
#------------------------------------------------------------
QU9_DP_2G = Element(modele=abstractElement)
ele = QU9_DP_2G
...
ele.elrefe=(
        ElrefeLoc(MT.QU9, gauss = ('RIGI=FPG4','FPG1=FPG1',), mater=('RIGI','FPG1',),),
