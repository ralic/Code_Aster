...
ele.addCalcul(OP.AMOR_AJOU, te=327,
    para_in=((SP.PACCELR, NACCELR), (SP.PGEOMER, NGEOMER),
             ),
    para_out=((OP.AMOR_AJOU.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.CHAR_THER_ACCE_R, te=325,
    para_in=((SP.PACCELR, NACCELR), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_ACCE_X, te=325,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PTEMPER, DDL_THER), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_ACCE_Y, te=325,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PTEMPER, DDL_THER), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_ACCE_Z, te=325,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PTEMPER, DDL_THER), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_FLUNL, te=273,
...
ele.addCalcul(OP.CHAR_THER_FLUN_F, te=58,
    para_in=((SP.PFLUXNF, CFLUXNF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_FLUN_R, te=57,
    para_in=((SP.PFLUXNR, CFLUXNR), (SP.PGEOMER, NGEOMER),
             ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_FLUTNL, te=526,
    para_in=((SP.PFLUXNL, CFLUXNF), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.CHAR_THER_PHID_R, te=326,
    para_in=((SP.PACCELR, NACCELR), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.CHAR_THER_RAYO_F, te=60,
...
ele.addCalcul(OP.CHAR_THER_RAYO_R, te=59,
...
ele.addCalcul(OP.CHAR_THER_TEXT_F, te=60,
...
ele.addCalcul(OP.CHAR_THER_TEXT_R, te=59,
...
ele.addCalcul(OP.FLUX_FLUI_X, te=309,
    para_in=((SP.PGEOMER, NGEOMER), ),
    para_out=((OP.FLUX_FLUI_X.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.FLUX_FLUI_Y, te=309,
    para_in=((SP.PGEOMER, NGEOMER), ),
    para_out=((OP.FLUX_FLUI_Y.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.FLUX_FLUI_Z, te=309,
    para_in=((SP.PGEOMER, NGEOMER), ),
    para_out=((OP.FLUX_FLUI_Z.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.MTAN_THER_COEF_F, te=131,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.MTAN_THER_COEF_F.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.MTAN_THER_COEF_R, te=130,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.MTAN_THER_COEF_R.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.MTAN_THER_FLUXNL, te=132,
    para_in=((SP.PFLUXNL, CFLUXNF), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.MTAN_THER_RAYO_F, te=131,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PRAYONF, LC.CRAYONF),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
...
ele.addCalcul(OP.MTAN_THER_RAYO_R, te=130,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PRAYONR, LC.CRAYONR),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
...
ele.addCalcul(OP.RESI_THER_COEF_F, te=128,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_COEF_R, te=127,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_COEH_F, te=308,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_COEH_R, te=306,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_FLUXNL, te=129,
    para_in=((SP.PFLUXNL, CFLUXNF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_RAYO_F, te=128,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PRAYONF, LC.CRAYONF),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_RAYO_R, te=127,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PRAYONR, LC.CRAYONR),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RIGI_THER_COEH_F, te=53,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.RIGI_THER_COEH_F.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.RIGI_THER_COEH_R, te=52,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.RIGI_THER_COEH_R.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.RIGI_THER_COET_F, te=527,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.RIGI_THER_COET_F.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.RIGI_THER_COET_R, te=523,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.RIGI_THER_COET_R.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.RIGI_THER_FLUTNL, te=524,
    para_in=((SP.PFLUXNL, CFLUXNF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPER, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
...
#------------------------------------------------------------
THER_FACE3 = Element(modele=abstractElement)
ele = THER_FACE3
...
#------------------------------------------------------------
THER_FACE4 = Element(modele=abstractElement)
ele = THER_FACE4
...
#------------------------------------------------------------
THER_FACE6 = Element(modele=abstractElement)
ele = THER_FACE6
ele.meshType = MT.TRIA6
ele.elrefe=(
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG6','NOEU=NOEU','FPG1=FPG1',), mater=('FPG1',),),
    )


#------------------------------------------------------------
THER_FACE8 = Element(modele=abstractElement)
ele = THER_FACE8
...
#------------------------------------------------------------
THER_FACE9 = Element(modele=abstractElement)
ele = THER_FACE9
