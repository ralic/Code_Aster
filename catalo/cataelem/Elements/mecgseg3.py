...
ele.addCalcul(OP.CHAR_MECA_PESA_R, te=345,
...
ele.addCalcul(OP.EPSI_ELGA, te=438,
...
ele.addCalcul(OP.FORC_NODA, te=341,
...
ele.addCalcul(OP.FULL_MECA, te=340,
    para_in=((SP.PCAGNBA, LC.CCAGNBA), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=340,
...
ele.addCalcul(OP.RAPH_MECA, te=340,
    para_in=((SP.PCAGNBA, LC.CCAGNBA), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.REFE_FORC_NODA, te=341,
    para_in=((SP.PCAGNBA, LC.CCAGNBA), (SP.PGEOMER, NGEOMER),
             (SP.PREFCO, EREFCO), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.RIGI_MECA_ELAS, te=340,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=340,
    para_in=((SP.PCAGNBA, LC.CCAGNBA), (SP.PCARCRI, CCARCRI),
...
#------------------------------------------------------------
MECGSEG3 = Element(modele=abstractElement)
ele = MECGSEG3
