...
#------------------------------------------------------------
class THH_PENTA15D(THH_HEXA20D):
    """Please document this element"""
    meshType = MT.PENTA15
    nodes = (
...
#------------------------------------------------------------
class THH_TETRA10D(THH_HEXA20D):
    """Please document this element"""
    meshType = MT.TETRA10
    nodes = (
...
#------------------------------------------------------------
class THH_PENTA15S(THH_HEXA20D):
    """Please document this element"""
    meshType = MT.PENTA15
    nodes = (
            SetOfNodes('EN2', (7,8,9,10,11,12,13,14,15,)),
...
#------------------------------------------------------------
class THH_TETRA10S(THH_HEXA20D):
    """Please document this element"""
    meshType = MT.TETRA10
    nodes = (
            SetOfNodes('EN2', (5,6,7,8,9,10,)),
