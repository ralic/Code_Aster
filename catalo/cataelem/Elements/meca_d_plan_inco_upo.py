...
#------------------------------------------------------------
class MIPLOSQU4(Element):
    """Mechanics - Plane strain - Incompressible - UPO model - QUAD4"""
    meshType = MT.QUAD4
    nodes = (
...
#------------------------------------------------------------
class MIPLOSTR3(MIPLOSQU4):
    """Mechanics - Plane strain - Incompressible - UPO model - TRIA3"""
    meshType = MT.TRIA3
    nodes = (
