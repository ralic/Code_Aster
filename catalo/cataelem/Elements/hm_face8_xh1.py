...
#------------------------------------------------------------
HM_FACE8_XH1 = Element(modele=abstractElement)
ele = HM_FACE8_XH1
...
#------------------------------------------------------------
HM_FACE6_XH1 = Element(modele=abstractElement)
ele = HM_FACE6_XH1
...
#------------------------------------------------------------
HM_FACE8_XH2 = Element(modele=abstractElement)
ele = HM_FACE8_XH2
ele.meshType = MT.QUAD8
ele.nodes = (
...
#------------------------------------------------------------
HM_FACE6_XH2 = Element(modele=abstractElement)
ele = HM_FACE6_XH2
ele.meshType = MT.TRIA6
ele.nodes = (
...
#------------------------------------------------------------
HM_FACE8_XH3 = Element(modele=abstractElement)
ele = HM_FACE8_XH3
ele.meshType = MT.QUAD8
ele.nodes = (
...
#------------------------------------------------------------
HM_FACE6_XH3 = Element(modele=abstractElement)
ele = HM_FACE6_XH3
ele.meshType = MT.TRIA6
ele.nodes = (
