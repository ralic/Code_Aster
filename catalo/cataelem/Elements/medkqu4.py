...
CCACOQU  = LocatedComponents(phys=PHY.CACOQU, type='ELEM',
    components=('EP','ALPHA','BETA','CTOR','EXCENT',
          'INERTIE',))


CCAORIE  = LocatedComponents(phys=PHY.CAORIE, type='ELEM',
    components=('ALPHA','BETA','REP','AXE_X','AXE_Y',
          'AXE_Z','O_X','O_Y','O_Z',))
...
ele.addCalcul(OP.ACCEPTANCE, te=329,
...
ele.addCalcul(OP.CARA_SECT_POUT3, te=513,
    para_in=((SP.PGEOMER, NGEOMER), ),
    para_out=((SP.PCASECT, ECASECT), ),
)

ele.addCalcul(OP.CARA_SECT_POUT4, te=513,
...
ele.addCalcul(OP.CHAR_MECA_EPSI_R, te=35,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PEPSINR, CEPSINR),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.CHAR_MECA_EPSI_R.PNBSP_I, ENBSP_I), (OP.CHAR_MECA_EPSI_R.PVARCPR, LC.ZVARCPG),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_FFCO3D, te=32,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PFFCO3D, CFORCEF),
             (SP.PGEOMER, NGEOMER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_FRCO3D, te=32,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PFRCO3D, EFORCNO),
             (SP.PGEOMER, NGEOMER), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_HYDR_R, te=312,
    para_in=((SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_HYDR_R.PVARCPR, LC.ZVARCPG),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_PESA_R, te=32,
...
ele.addCalcul(OP.CHAR_MECA_PRES_F, te=32,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.CHAR_MECA_PRES_R, te=32,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
             (SP.PPRESSR, EPRESNO), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_PRSU_F, te=580,
    para_in=((SP.PPRESSF, CPRESSF), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_PRSU_R, te=580,
    para_in=((SP.PPRESSR, EPRESNO), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_SECH_R, te=312,
    para_in=((SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_SECH_R.PVARCPR, LC.ZVARCPG),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_SFCO3D, te=580,
    para_in=((SP.PFFCO3D, CFORCEF), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_SRCO3D, te=580,
    para_in=((SP.PFRCO3D, EFORCNO), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_TEMP_R, te=35,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.DEGE_ELGA, te=33,
...
ele.addCalcul(OP.DEGE_ELNO, te=33,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.ECIN_ELEM, te=31,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.ECIN_ELEM.PNBSP_I, ENBSP_I), (SP.POMEGA2, LC.COMEG2R),
             (OP.ECIN_ELEM.PVARCPR, LC.ZVARCPG), (SP.PVITESR, DDL_MECA),
             ),
    para_out=((SP.PENERCR, EENERR), ),
)

ele.addCalcul(OP.EFGE_ELGA, te=451,
...
ele.addCalcul(OP.EFGE_EXCENT, te=452,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PEFFOGC, EEFGEPGC),
             (SP.PEFFOGR, EEFGEPGR), (SP.PEFFONC, EEFGENOC),
             (SP.PEFFONR, EEFGENOR), ),
    para_out=((SP.PEFFOEGC, EEFGEPGC), (SP.PEFFOEGR, EEFGEPGR),
             (SP.PEFFOENC, EEFGENOC), (SP.PEFFOENR, EEFGENOR),
             ),
)

ele.addCalcul(OP.ENEL_ELEM, te=412,
    para_in=((SP.PCACOQU, CCACOQU), (OP.ENEL_ELEM.PCOMPOR, CCOMPOR),
             (OP.ENEL_ELEM.PCONTPR, ECONTPG), (SP.PDEPLR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.ENEL_ELEM.PNBSP_I, ENBSP_I), (OP.ENEL_ELEM.PVARCPR, LC.ZVARCPG),
             (SP.PVARCRR, LC.ZVARCPG), (OP.ENEL_ELEM.PVARIPR, ZVARIPG),
             ),
    para_out=((SP.PENERD1, EENERR), ),
)

ele.addCalcul(OP.ENEL_ELGA, te=412,
    para_in=((SP.PCACOQU, CCACOQU), (OP.ENEL_ELGA.PCOMPOR, CCOMPOR),
...
ele.addCalcul(OP.EPOT_ELEM, te=31,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.EPSI_ELGA, te=33,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.FULL_MECA, te=31,
...
ele.addCalcul(OP.INI_SP_RIGI, te=99,
    para_out=((OP.INI_SP_RIGI.PCONTPR, ECONTPG), ),
)

ele.addCalcul(OP.MASS_INER, te=31,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (OP.MASS_INER.PNBSP_I, ENBSP_I),
             (OP.MASS_INER.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMASSINE, LC.EMASSINE), ),
)

ele.addCalcul(OP.MASS_MECA, te=31,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (OP.MASS_MECA.PNBSP_I, ENBSP_I),
             (OP.MASS_MECA.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.MASS_MECA_EXPLI, te=31,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (OP.MASS_MECA_EXPLI.PNBSP_I, ENBSP_I),
...
ele.addCalcul(OP.MODI_REPERE, te=63,
    para_in=((OP.MODI_REPERE.PMATPASS, ECHGREP), (SP.PSIEFR, ECONTPG),
             ),
    para_out=((OP.MODI_REPERE.PCONTPR, ECONTPG), ),
)

ele.addCalcul(OP.M_GAMMA, te=31,
    para_in=((SP.PACCELR, DDL_MECA), (SP.PCACOQU, CCACOQU),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.M_GAMMA.PNBSP_I, ENBSP_I), (OP.M_GAMMA.PVARCPR, LC.ZVARCPG),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)
...
ele.addCalcul(OP.PREP_VRC, te=408,
...
ele.addCalcul(OP.RAPH_MECA, te=31,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PCARCRI, CCARCRI),
             (OP.RAPH_MECA.PCOMPOR, CCOMPOR), (OP.RAPH_MECA.PCONTMR, ECONTPG),
             (SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PINSTMR, CTEMPSR),
             (SP.PINSTPR, CTEMPSR), (SP.PITERAT, LC.CITERAT),
             (SP.PMATERC, LC.CMATERC), (OP.RAPH_MECA.PNBSP_I, ENBSP_I),
...
ele.addCalcul(OP.REFE_FORC_NODA, te=31,
...
ele.addCalcul(OP.REPERE_LOCAL, te=134,
    ...
    para_out=((OP.REPERE_LOCAL.PMATPASS, ECHGREP), (SP.PREPLO1, CGEOMER),
             (SP.PREPLO2, CGEOMER), (SP.PREPLO3, CGEOMER),
             ),
)

ele.addCalcul(OP.REPE_GENE, te=442,
...
ele.addCalcul(OP.REPE_TENS, te=442,
    para_in=((SP.PANGREP, CCAORIE), (SP.PCACOQU, CCACOQU),
             (SP.PCOGAIN, ECONTPG), (SP.PCONOIN, ECONTNO),
             (SP.PDEGAIN, EDEFOPG), (SP.PDENOIN, EDEFONO),
             (SP.PGEOMER, NGEOMER), (OP.REPE_TENS.PNBSP_I, ENBSP_I),
             ),
...
ele.addCalcul(OP.RIGI_MECA, te=31,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=31,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_GE, te=428,
    para_in=((SP.PCACOQU, CCACOQU), (OP.RIGI_MECA_GE.PCONTRR, ECONTPG),
             (SP.PGEOMER, NGEOMER), (OP.RIGI_MECA_GE.PNBSP_I, ENBSP_I),
             ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)
...
ele.addCalcul(OP.RIGI_MECA_PRSU_F, te=580,
    para_in=((SP.PPRESSF, CPRESSF), ),
    para_out=((SP.PMATUNS, MMATUNS), ),
)

ele.addCalcul(OP.RIGI_MECA_PRSU_R, te=580,
    para_in=((SP.PPRESSR, EPRESNO), ),
    para_out=((SP.PMATUNS, MMATUNS), ),
)

ele.addCalcul(OP.RIGI_MECA_SFCO3D, te=580,
    para_in=((SP.PFFCO3D, CFORCEF), ),
    para_out=((SP.PMATUNS, MMATUNS), ),
)

ele.addCalcul(OP.RIGI_MECA_SRCO3D, te=580,
    para_in=((SP.PFRCO3D, EFORCNO), ),
    para_out=((SP.PMATUNS, MMATUNS), ),
)

ele.addCalcul(OP.RIGI_MECA_TANG, te=31,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.SIEF_ELGA, te=33,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.VERI_CARA_ELEM, te=119,
...
#------------------------------------------------------------
MEDKQU4 = Element(modele=abstractElement)
ele = MEDKQU4
ele.meshType = MT.QUAD4
ele.elrefe=(
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','MASS=FPG9','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','NOEU','FPG1',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2',),),
    )


#------------------------------------------------------------
MEDKTR3 = Element(modele=abstractElement)
ele = MEDKTR3
ele.meshType = MT.TRIA3
ele.elrefe=(
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG3','MASS=FPG4','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','NOEU','FPG1',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2',),),
    )

ele.modifyCalcul(OP.ACCEPTANCE, te=-1)


#------------------------------------------------------------
MEDSQU4 = Element(modele=abstractElement)
ele = MEDSQU4
ele.meshType = MT.QUAD4
ele.elrefe=(
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','MASS=FPG9','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','NOEU','FPG1',),),
...
ele.modifyCalcul(OP.FULL_MECA, te=-1)

ele.modifyCalcul(OP.RAPH_MECA, te=-1)

ele.modifyCalcul(OP.RIGI_MECA_TANG, te=-1)

ele.modifyCalcul(OP.RIGI_MECA_GE, te=-1)

ele.modifyCalcul(OP.VARI_ELNO, te=-1)

ele.modifyCalcul(OP.MASS_MECA_EXPLI, te=-1)

ele.modifyCalcul(OP.COOR_ELGA_MATER, te=-1)

ele.modifyCalcul(OP.INI_SP_MATER, te=-1)

ele.modifyCalcul(OP.INI_SP_RIGI, te=-1)

ele.modifyCalcul(OP.MODI_REPERE, te=-1)

ele.modifyCalcul(OP.EPSP_ELGA, te=-1)

ele.modifyCalcul(OP.EPSP_ELNO, te=-1)


#------------------------------------------------------------
MEDSTR3 = Element(modele=abstractElement)
ele = MEDSTR3
ele.meshType = MT.TRIA3
ele.elrefe=(
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG3','MASS=FPG4','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','NOEU','FPG1',),),
...
#------------------------------------------------------------
MEQ4QU4 = Element(modele=abstractElement)
ele = MEQ4QU4
ele.meshType = MT.QUAD4
ele.elrefe=(
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','MASS=FPG9','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','NOEU','FPG1',),),
...
#------------------------------------------------------------
MET3TR3 = Element(modele=abstractElement)
ele = MET3TR3
ele.meshType = MT.TRIA3
ele.elrefe=(
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG1','MASS=FPG4','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','NOEU','FPG1',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2',),),
    )
