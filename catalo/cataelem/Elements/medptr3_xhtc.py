# coding=utf-8
# CATALOGUES DES ELEMENTS 2D_DP X-FEM HEAVISIDE-CRACKTIP AVEC CONTACT (QUE LINEAIRES)
...
class MEDPTR3_XHTC(Element):
    ...
    elrefe =(
            ElrefeLoc(MT.TR3, gauss = ('XINT=FPG12','RIGI=FPG3','FPG1=FPG1','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM36',), mater=('RIGI','XFEM',),),
    ...
    calculs = (
        ...
        OP.CALC_K_G_F(te=297,
            para_in=((OP.CALC_K_G_F.PAINTER, LC.E35NEUTR), (OP.CALC_K_G_F.PBASECO, LC.E28NEUTR),
                     ...
                     (OP.CALC_G.PSTANO, STANO_I), (SP.PSIGISE, ECONTSE),
...
#------------------------------------------------------------
class MEDPQU4_XHTC(MEDPTR3_XHTC):
    """Please document this element"""
    meshType = MT.QUAD4
    nodes = (
...
#------------------------------------------------------------
class MEDPTR6_XHTC(MEDPTR3_XHTC):
    """Please document this element"""
    meshType = MT.TRIA6
    nodes = (
...
#------------------------------------------------------------
class MEDPQU8_XHTC(MEDPTR3_XHTC):
    """Please document this element"""
    meshType = MT.QUAD8
    nodes = (
