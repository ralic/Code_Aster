...
ele.addCalcul(OP.ERME_ELEM, te=382,
    para_in=((OP.ERME_ELEM.PCNSETO, LC.E36NEUI), (SP.PCONTNO, ECONTNO),
             ...
             (SP.PTEMPSR, CTEMPSR), (OP.ERME_ELEM.PVOISIN, LC.EVOISIN),
             ),
...
#------------------------------------------------------------
MECPTR3_XT = Element(modele=abstractElement)
ele = MECPTR3_XT
...
#------------------------------------------------------------
MECPQU4_XT = Element(modele=abstractElement)
ele = MECPQU4_XT
...
ele.elrefe=(
        ...
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG3','MASS=FPG3','XINT=FPG12','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM36',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2','MASS=FPG3',),),
    )


#------------------------------------------------------------
MECPTR6_XT = Element(modele=abstractElement)
ele = MECPTR6_XT
...
ele.elrefe=(
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG3','MASS=FPG3','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM72','FPG1=FPG1',), mater=('XFEM','NOEU',),),
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG6','MASS=FPG6','XINT=FPG12',),),
    )


#------------------------------------------------------------
MECPQU8_XT = Element(modele=abstractElement)
ele = MECPQU8_XT
