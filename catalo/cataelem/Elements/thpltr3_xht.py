...
#------------------------------------------------------------
THPLTR3_XHT = Element(modele=abstractElement)
ele = THPLTR3_XHT
...
#------------------------------------------------------------
THPLQU4_XHT = Element(modele=abstractElement)
ele = THPLQU4_XHT
...
#------------------------------------------------------------
THAXTR3_XHT = Element(modele=abstractElement)
ele = THAXTR3_XHT
ele.meshType = MT.TRIA3
ele.elrefe=(
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG3','XINT=FPG12','XFEM=XFEM36',), mater=('XFEM',),),
...
#------------------------------------------------------------
THAXQU4_XHT = Element(modele=abstractElement)
ele = THAXQU4_XHT
ele.meshType = MT.QUAD4
ele.elrefe=(
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','XFEM=XFEM72',), mater=('XFEM',),),
