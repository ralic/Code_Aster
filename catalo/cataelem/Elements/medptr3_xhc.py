...
#------------------------------------------------------------
MEDPTR3_XHC = Element(modele=abstractElement)
ele = MEDPTR3_XHC
...
#------------------------------------------------------------
MEDPQU4_XHC = Element(modele=abstractElement)
ele = MEDPQU4_XHC
...
ele.elrefe=(
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','NOEU_S=NOEU_S','FPG1=FPG1','NOEU=NOEU','XFEM=XFEM72',), mater=('RIGI','XFEM',),),
...
#------------------------------------------------------------
MEDPTR6_XHC = Element(modele=abstractElement)
ele = MEDPTR6_XHC
...
#------------------------------------------------------------
MEDPQU8_XHC = Element(modele=abstractElement)
ele = MEDPQU8_XHC
...
#------------------------------------------------------------
MEDPTR3_XHC3 = Element(modele=abstractElement)
ele = MEDPTR3_XHC3
ele.meshType = MT.TRIA3
ele.nodes = (
...
#------------------------------------------------------------
MEDPQU4_XHC3 = Element(modele=abstractElement)
ele = MEDPQU4_XHC3
ele.meshType = MT.QUAD4
ele.nodes = (
