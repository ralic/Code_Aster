...
class MEDPTR3_XHC(TemplateElement):
...
#------------------------------------------------------------
class MEDPQU4_XHC(TemplateElement):
    """Please document this element"""
    meshType = MT.QUAD4
    nodes = (
...
#------------------------------------------------------------
class MEDPTR6_XHC(TemplateElement):
    """Please document this element"""
    meshType = MT.TRIA6
    nodes = (
...
#------------------------------------------------------------
class MEDPQU8_XHC(TemplateElement):
    """Please document this element"""
    meshType = MT.QUAD8
    nodes = (
...
#------------------------------------------------------------
class MEDPTR3_XHC3(TemplateElement):
    """Please document this element"""
    meshType = MT.TRIA3
    nodes = (
...
#------------------------------------------------------------
class MEDPQU4_XHC3(TemplateElement):
    """Please document this element"""
    meshType = MT.QUAD4
    nodes = (
