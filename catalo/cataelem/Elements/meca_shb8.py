...
ele.addCalcul(OP.FORC_NODA, te=484,
...
ele.addCalcul(OP.FULL_MECA, te=477,
...
ele.addCalcul(OP.NORME_L2, te=563,
    para_in=((SP.PCALCI, LC.EMNEUT_I), (SP.PCHAMPG, EGNEUT_R),
             (SP.PCOEFR, EMNEUT_R), (OP.NORME_L2.PCOORPG, EGGEOM_R),
             ),
...
ele.addCalcul(OP.RAPH_MECA, te=477,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA, te=473,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.RIGI_MECA_GE, te=474,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=477,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.SIEF_ELGA, te=485,
...
ele.addCalcul(OP.TOU_INI_ELGA, te=99,
    para_out=((OP.TOU_INI_ELGA.PDOMMAG, LC.EDOMGGA), (SP.PFACY_R, EFACY_R),
...
#------------------------------------------------------------
MECA_SHB8 = Element(modele=abstractElement)
ele = MECA_SHB8
ele.meshType = MT.HEXA8
ele.elrefe=(
        ElrefeLoc(MT.HE8, gauss = ('RIGI=SHB5','MASS=SHB5','FPG1=FPG1',), mater=('RIGI','FPG1',),),
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','MASS=FPG4',),),
    )


#------------------------------------------------------------
MECA_SHB6 = Element(modele=abstractElement)
ele = MECA_SHB6
ele.meshType = MT.PENTA6
ele.elrefe=(
        ElrefeLoc(MT.PE6, gauss = ('RIGI=SHB6','MASS=SHB6','FPG1=FPG1',), mater=('RIGI','FPG1',),),
...
#------------------------------------------------------------
MECA_SHB15 = Element(modele=abstractElement)
ele = MECA_SHB15
ele.meshType = MT.PENTA15
ele.elrefe=(
        ElrefeLoc(MT.P15, gauss = ('RIGI=SHB15','MASS=SHB15','FPG1=FPG1',), mater=('RIGI','FPG1',),),
...
#------------------------------------------------------------
MECA_SHB20 = Element(modele=abstractElement)
ele = MECA_SHB20
ele.meshType = MT.HEXA20
ele.elrefe=(
        ElrefeLoc(MT.H20, gauss = ('RIGI=SHB20','MASS=SHB20','FPG1=FPG1',), mater=('RIGI','FPG1',),),
        ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','MASS=FPG9',),),
    )
