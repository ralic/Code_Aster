...
ele.addCalcul(OP.FULL_MECA_ELAS, te=201,
...
ele.addCalcul(OP.PILO_PRED_ELAS, te=203,
...
ele.addCalcul(OP.RAPH_MECA, te=201,
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=201,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=201,
