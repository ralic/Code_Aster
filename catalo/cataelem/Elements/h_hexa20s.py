...
ECONTNC  = LocatedComponents(phys=PHY.SIEF_C, type='ELNO',
    components=('M11','FH11X','FH11Y','FH11Z',))
...
#------------------------------------------------------------
H_HEXA20S = Element(modele=abstractElement)
ele = H_HEXA20S
...
#------------------------------------------------------------
H_PENTA15S = Element(modele=abstractElement)
ele = H_PENTA15S
...
#------------------------------------------------------------
H_TETRA10S = Element(modele=abstractElement)
ele = H_TETRA10S
