...
#------------------------------------------------------------
MECA_XHT_HEXA8 = Element(modele=abstractElement)
ele = MECA_XHT_HEXA8
...
#------------------------------------------------------------
MECA_XHT_PENTA6 = Element(modele=abstractElement)
ele = MECA_XHT_PENTA6
...
#------------------------------------------------------------
MECA_XHT_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XHT_PYRAM5
...
#------------------------------------------------------------
MECA_XHT_TETRA4 = Element(modele=abstractElement)
ele = MECA_XHT_TETRA4
...
#------------------------------------------------------------
MECA_XHT_HEXA20 = Element(modele=abstractElement)
ele = MECA_XHT_HEXA20
...
#------------------------------------------------------------
MECA_XHT_PENTA15 = Element(modele=abstractElement)
ele = MECA_XHT_PENTA15
...
#------------------------------------------------------------
MECA_XHT_PYRAM13 = Element(modele=abstractElement)
ele = MECA_XHT_PYRAM13
...
#------------------------------------------------------------
MECA_XHT_TETRA10 = Element(modele=abstractElement)
ele = MECA_XHT_TETRA10
