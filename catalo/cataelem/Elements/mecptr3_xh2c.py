...
#------------------------------------------------------------
MECPTR3_XH2C = Element(modele=abstractElement)
ele = MECPTR3_XH2C
...
#------------------------------------------------------------
MECPTR3_XH3C = Element(modele=abstractElement)
ele = MECPTR3_XH3C
ele.meshType = MT.TRIA3
ele.nodes = (
...
#------------------------------------------------------------
MECPTR3_XH4C = Element(modele=abstractElement)
ele = MECPTR3_XH4C
ele.meshType = MT.TRIA3
ele.nodes = (
...
#------------------------------------------------------------
MECPQU4_XH2C = Element(modele=abstractElement)
ele = MECPQU4_XH2C
...
#------------------------------------------------------------
MECPQU4_XH3C = Element(modele=abstractElement)
ele = MECPQU4_XH3C
ele.meshType = MT.QUAD4
ele.nodes = (
...
#------------------------------------------------------------
MECPQU4_XH4C = Element(modele=abstractElement)
ele = MECPQU4_XH4C
ele.meshType = MT.QUAD4
ele.nodes = (
