# coding=utf-8
# CATALOGUES DES ELEMENTS 2D_CP X-FEM MULTI HEAVISIDE AVEC CONTACT
...
#------------------------------------------------------------
class MECPTR3_XH3C(MECPTR3_XH2C):
    """Please document this element"""
    meshType = MT.TRIA3
    nodes = (
...
#------------------------------------------------------------
class MECPTR3_XH4C(MECPTR3_XH2C):
    """Please document this element"""
    meshType = MT.TRIA3
    nodes = (
...
#------------------------------------------------------------
class MECPQU4_XH2C(MECPTR3_XH2C):
    """Please document this element"""
    meshType = MT.QUAD4
    nodes = (
...
#------------------------------------------------------------
class MECPQU4_XH3C(MECPTR3_XH2C):
    """Please document this element"""
    meshType = MT.QUAD4
    nodes = (
...
#------------------------------------------------------------
class MECPQU4_XH4C(MECPTR3_XH2C):
    """Please document this element"""
    meshType = MT.QUAD4
    nodes = (
