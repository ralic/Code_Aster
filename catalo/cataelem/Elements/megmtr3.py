...
ele.addCalcul(OP.RIGI_MECA_IMPLEX, te=431,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PCARCRI, CCARCRI),
...
#------------------------------------------------------------
MEGMTR3 = Element(modele=abstractElement)
ele = MEGMTR3
...
#------------------------------------------------------------
MEGMTR6 = Element(modele=abstractElement)
ele = MEGMTR6
...
#------------------------------------------------------------
MEGMQU4 = Element(modele=abstractElement)
ele = MEGMQU4
...
#------------------------------------------------------------
MEGMQU8 = Element(modele=abstractElement)
ele = MEGMQU8
