...
ele.addCalcul(OP.CHAR_MECA_PESA_R, te=441,
    para_in=((OP.CHAR_MECA_PESA_R.PCNSETO, LC.E72NEUI), (SP.PGEOMER, NGEOMER),
             (OP.CHAR_MECA_PESA_R.PHEAVTO, E24NEUI), (OP.CHAR_MECA_PESA_R.PLONCHA, LC.E10NEUTI),
             (OP.CHAR_MECA_PESA_R.PLSN, LC.N1NEUT_R), (OP.CHAR_MECA_PESA_R.PLST, LC.N1NEUT_R),
             (SP.PMATERC, LC.CMATERC), (SP.PPESANR, LC.CPESANR),
             (OP.CHAR_MECA_PESA_R.PPINTTO, LC.E24NEUTR), (OP.CHAR_MECA_PESA_R.PPMILTO, LC.E22NEUTR),
...
ele.addCalcul(OP.CHAR_MECA_ROTA_R, te=441,
    para_in=((OP.CHAR_MECA_ROTA_R.PCNSETO, LC.E72NEUI), (SP.PGEOMER, NGEOMER),
             (OP.CHAR_MECA_ROTA_R.PHEAVTO, E24NEUI), (OP.CHAR_MECA_ROTA_R.PLONCHA, LC.E10NEUTI),
             (OP.CHAR_MECA_ROTA_R.PLSN, LC.N1NEUT_R), (OP.CHAR_MECA_ROTA_R.PLST, LC.N1NEUT_R),
             (SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_ROTA_R.PPINTTO, LC.E24NEUTR),
...
#------------------------------------------------------------
MEDPTR3_XH1 = Element(modele=abstractElement)
ele = MEDPTR3_XH1
...
#------------------------------------------------------------
MEDPTR3_XH2 = Element(modele=abstractElement)
ele = MEDPTR3_XH2
ele.meshType = MT.TRIA3
ele.nodes = (
...
#------------------------------------------------------------
MEDPTR3_XH3 = Element(modele=abstractElement)
ele = MEDPTR3_XH3
ele.meshType = MT.TRIA3
ele.nodes = (
...
#------------------------------------------------------------
MEDPTR3_XH4 = Element(modele=abstractElement)
ele = MEDPTR3_XH4
ele.meshType = MT.TRIA3
ele.nodes = (
...
#------------------------------------------------------------
MEDPQU4_XH1 = Element(modele=abstractElement)
ele = MEDPQU4_XH1
...
#------------------------------------------------------------
MEDPQU4_XH2 = Element(modele=abstractElement)
ele = MEDPQU4_XH2
ele.meshType = MT.QUAD4
ele.nodes = (
...
#------------------------------------------------------------
MEDPQU4_XH3 = Element(modele=abstractElement)
ele = MEDPQU4_XH3
ele.meshType = MT.QUAD4
ele.nodes = (
...
#------------------------------------------------------------
MEDPQU4_XH4 = Element(modele=abstractElement)
ele = MEDPQU4_XH4
ele.meshType = MT.QUAD4
ele.nodes = (
