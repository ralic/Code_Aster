...
#------------------------------------------------------------
for nomte in ('MET3SEG3', 'MET3SEG4', 'MET6SEG3') :
    if nomte == 'MET3SEG3' :
        MET3SEG3 = Element()
        ele = MET3SEG3
...
#------------------------------------------------------------
# Fin de ce qui distingue les 3 elements de tuyau :
#------------------------------------------------------------



#   modes locaux qui dependent des modes locaux differents :
#   ---------------------------------------------------------
...
#   ---------------------------------------------------------
    ...
    ele.addCalcul(OP.CHAR_MECA_FR1D1D, te=583,
    ...
    ele.addCalcul(OP.CHAR_MECA_PESA_R, te=583,
    ...
    ele.addCalcul(OP.CHAR_MECA_PRES_F, te=583,
    ...
    ele.addCalcul(OP.CHAR_MECA_PRES_R, te=583,
    ...
    ele.addCalcul(OP.CHAR_MECA_TEMP_R, te=589,
    ...
    ele.addCalcul(OP.DEGE_ELGA, te=584,
    ...
    ele.addCalcul(OP.DEGE_ELNO, te=584,
    ...
    ele.addCalcul(OP.EFGE_ELGA, te=587,
    ...
    ele.addCalcul(OP.EPSI_ELGA, te=584,
    ...
    ele.addCalcul(OP.FORC_NODA, te=585,
    ...
    ele.addCalcul(OP.FULL_MECA, te=586,
    ...
    ele.addCalcul(OP.MASS_MECA, te=582,
    ...
    ele.addCalcul(OP.M_GAMMA, te=582,
    ...
    ele.addCalcul(OP.RAPH_MECA, te=586,
        para_in=((SP.PCAGEPO, CCAGEPO), (SP.PCAMASS, CCAMASS),
    ...
    ele.addCalcul(OP.REFE_FORC_NODA, te=585,
    ...
    ele.addCalcul(OP.RIGI_MECA, te=582,
    ...
    ele.addCalcul(OP.RIGI_MECA_TANG, te=586,
        para_in=((SP.PCAGEPO, CCAGEPO), (SP.PCAMASS, CCAMASS),
    ...
    ele.addCalcul(OP.SIEF_ELGA, te=584,
