...
#------------------------------------------------------------
class THM_AXIS_TR6(THM_AXIS_QU8):
    """Please document this element"""
    meshType = MT.TRIA6
    nodes = (
...
#------------------------------------------------------------
class THM_AXIS_QU8D(THM_AXIS_QU8):
    """Please document this element"""
    meshType = MT.QUAD8
    nodes = (
            SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
class THM_AXIS_TR6D(THM_AXIS_QU8):
    """Please document this element"""
    meshType = MT.TRIA6
    nodes = (
            SetOfNodes('EN2', (4,5,6,)),
...
#------------------------------------------------------------
class THM_AXIS_QU8S(THM_AXIS_QU8):
    """Please document this element"""
    meshType = MT.QUAD8
    nodes = (
            SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
class THM_AXIS_TR6S(THM_AXIS_QU8):
    """Please document this element"""
    meshType = MT.TRIA6
    nodes = (
            SetOfNodes('EN2', (4,5,6,)),
