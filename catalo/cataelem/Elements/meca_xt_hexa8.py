# coding=utf-8
# CATALOGUES DES ELEMENTS X-FEM CRACKTIP SANS CONTACT (LINEAIRES ET QUADRATIQUES)
...
#------------------------------------------------------------
class MECA_XT_PENTA6(MECA_XT_HEXA8):
    """Please document this element"""
    meshType = MT.PENTA6
    nodes = (
...
#------------------------------------------------------------
class MECA_XT_PYRAM5(MECA_XT_HEXA8):
    """Please document this element"""
    meshType = MT.PYRAM5
    nodes = (
...
#------------------------------------------------------------
class MECA_XT_TETRA4(MECA_XT_HEXA8):
    """Please document this element"""
    meshType = MT.TETRA4
    nodes = (
...
#------------------------------------------------------------
class MECA_XT_HEXA20(MECA_XT_HEXA8):
    """Please document this element"""
    meshType = MT.HEXA20
    nodes = (
...
#------------------------------------------------------------
class MECA_XT_PENTA15(MECA_XT_HEXA8):
    """Please document this element"""
    meshType = MT.PENTA15
    nodes = (
...
#------------------------------------------------------------
class MECA_XT_PYRAM13(MECA_XT_HEXA8):
    """Please document this element"""
    meshType = MT.PYRAM13
    nodes = (
...
#------------------------------------------------------------
class MECA_XT_TETRA10(MECA_XT_HEXA8):
    """Please document this element"""
    meshType = MT.TETRA10
    nodes = (
