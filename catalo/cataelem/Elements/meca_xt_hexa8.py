...
ele.addCalcul(OP.CHAR_MECA_PESA_R, te=441,
    para_in=((OP.CHAR_MECA_PESA_R.PCNSETO, LC.E320NEUI), (SP.PGEOMER, NGEOMER),
             (OP.CHAR_MECA_PESA_R.PHEAVTO, LC.E32NEUTI), (OP.CHAR_MECA_PESA_R.PLONCHA, LC.E10NEUTI),
...
ele.addCalcul(OP.FULL_MECA, te=539,
    para_in=((OP.FULL_MECA.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
             ...
             (OP.FULL_MECA.PPINTTO, E33NEUTR), (OP.FULL_MECA.PPMILTO, LC.E198NEUT),
...
#------------------------------------------------------------
MECA_XT_HEXA8 = Element(modele=abstractElement)
ele = MECA_XT_HEXA8
...
#------------------------------------------------------------
MECA_XT_PENTA6 = Element(modele=abstractElement)
ele = MECA_XT_PENTA6
...
#------------------------------------------------------------
MECA_XT_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XT_PYRAM5
...
#------------------------------------------------------------
MECA_XT_TETRA4 = Element(modele=abstractElement)
ele = MECA_XT_TETRA4
...
#------------------------------------------------------------
MECA_XT_HEXA20 = Element(modele=abstractElement)
ele = MECA_XT_HEXA20
...
#------------------------------------------------------------
MECA_XT_PENTA15 = Element(modele=abstractElement)
ele = MECA_XT_PENTA15
...
#------------------------------------------------------------
MECA_XT_PYRAM13 = Element(modele=abstractElement)
ele = MECA_XT_PYRAM13
...
#------------------------------------------------------------
MECA_XT_TETRA10 = Element(modele=abstractElement)
ele = MECA_XT_TETRA10
