...
ele.addCalcul(OP.EPSI_ELGA, te=87,
    para_in=((OP.EPSI_ELGA.PCOMPOR, CCOMPOR), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
#------------------------------------------------------------
MEAXQS8 = Element(modele=abstractElement)
ele = MEAXQS8
...
ele.elrefe=(
        ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG4','FPG1=FPG1','MASS=FPG9','NOEU=NOEU',), mater=('RIGI','NOEU','FPG1',),),
