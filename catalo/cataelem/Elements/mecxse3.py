...
ele.addCalcul(OP.CHAR_MECA_FFCO2D, te=224,
    para_in=((SP.PFFCO2D, CFORCEF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_FRCO2D, te=223,
...
ele.addCalcul(OP.CHAR_MECA_PESA_R, te=233,
...
ele.addCalcul(OP.CHAR_MECA_PRES_F, te=397,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PPRESSF, CPRESSF),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_PRES_R, te=397,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PPRESSR, EPRESNO),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_ROTA_R, te=232,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.CHAR_MECA_TEMP_R, te=225,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.EPSI_ELGA, te=237,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
...
ele.addCalcul(OP.FORC_NODA, te=234,
...
ele.addCalcul(OP.FULL_MECA, te=239,
...
ele.addCalcul(OP.MASS_INER, te=227,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.MASS_MECA, te=226,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.M_GAMMA, te=226,
...
ele.addCalcul(OP.RAPH_MECA, te=239,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA, te=221,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=239,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.SIEF_ELGA, te=237,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
#------------------------------------------------------------
MECXSE3 = Element(modele=abstractElement)
ele = MECXSE3
