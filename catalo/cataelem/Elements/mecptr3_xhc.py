...
ele.addCalcul(OP.CALC_G, te=288,
    para_in=((OP.CALC_G.PAINTER, LC.E35NEUTR), (OP.CALC_G.PBASECO, LC.E28NEUTR),
             ...
             (OP.CALC_G.PPINTTO, LC.E6NEUTR), (OP.CALC_G.PPMILTO, LC.E22NEUTR),
...
ele.addCalcul(OP.CALC_G_F, te=288,
    para_in=((OP.CALC_G_F.PAINTER, LC.E35NEUTR), (OP.CALC_G_F.PBASECO, LC.E28NEUTR),
             ...
             (OP.CALC_G_F.PPINTTO, LC.E6NEUTR), (OP.CALC_G_F.PPMILTO, LC.E22NEUTR),
             (SP.PPRESSF, CPRESSF), (SP.PROTATR, LC.CROTATR),
             (SP.PTEMPSR, CTEMPSR), (SP.PTHETAR, DDL_MECC),
...
ele.addCalcul(OP.CHAR_MECA_CONT, te=534,
    para_in=((OP.CHAR_MECA_CONT.PAINTER, LC.E35NEUTR), (OP.CHAR_MECA_CONT.PBASECO, LC.E28NEUTR),
             (OP.CHAR_MECA_CONT.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.E3NEUTR),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.CHAR_MECA_CONT.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.I1NEUT_I),
             (OP.CHAR_MECA_CONT.PLONGCO, LC.E3NEUTI), (OP.CHAR_MECA_CONT.PLST, LC.N1NEUT_R),
             (SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_CONT.PPINTER, LC.E14NEUTR),
...
ele.addCalcul(OP.CHAR_MECA_CONT_M, te=534,
    para_in=((OP.CHAR_MECA_CONT_M.PAINTER, LC.E35NEUTR), (OP.CHAR_MECA_CONT_M.PBASECO, LC.E28NEUTR),
             (OP.CHAR_MECA_CONT_M.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.N3NEUT_R),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.CHAR_MECA_CONT_M.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.I1NEUT_I),
             (OP.CHAR_MECA_CONT_M.PLONGCO, LC.E3NEUTI), (OP.CHAR_MECA_CONT_M.PLST, LC.N1NEUT_R),
             (SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_CONT_M.PPINTER, LC.E14NEUTR),
             (OP.CHAR_MECA_CONT_M.PSEUIL, LC.E1NEUTR), (OP.CHAR_MECA_CONT_M.PSTANO, STANO_I),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_FF2D2D, te=440,
    para_in=((SP.PFF2D2D, CFORCEF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_FR2D2D, te=440,
...
ele.addCalcul(OP.CHAR_MECA_FROT, te=534,
    para_in=((OP.CHAR_MECA_FROT.PAINTER, LC.E35NEUTR), (OP.CHAR_MECA_FROT.PBASECO, LC.E28NEUTR),
             (OP.CHAR_MECA_FROT.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.E3NEUTR),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.CHAR_MECA_FROT.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.I1NEUT_I),
             (OP.CHAR_MECA_FROT.PLONGCO, LC.E3NEUTI), (OP.CHAR_MECA_FROT.PLST, LC.N1NEUT_R),
             (SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_FROT.PPINTER, LC.E14NEUTR),
...
ele.addCalcul(OP.PILO_PRED_ELAS, te=547,
    para_in=((OP.PILO_PRED_ELAS.PAINTER, LC.E35NEUTR), (OP.PILO_PRED_ELAS.PBASECO, LC.E28NEUTR),
             (SP.PCDTAU, LC.CCDTAU), (OP.PILO_PRED_ELAS.PCFACE, LC.E9NEUTI),
...
ele.addCalcul(OP.PILO_PRED_ELAS_M, te=547,
    para_in=((OP.PILO_PRED_ELAS_M.PAINTER, LC.E35NEUTR), (OP.PILO_PRED_ELAS_M.PBASECO, LC.E28NEUTR),
             (SP.PCDTAU, LC.CCDTAU), (OP.PILO_PRED_ELAS_M.PCFACE, LC.E9NEUTI),
...
ele.addCalcul(OP.REFE_FORC_NODA, te=542,
    para_in=((OP.REFE_FORC_NODA.PAINTER, LC.E35NEUTR), (OP.REFE_FORC_NODA.PBASECO, LC.E28NEUTR),
             (OP.REFE_FORC_NODA.PBASLOR, LC.N6NEUT_R), (OP.REFE_FORC_NODA.PCFACE, LC.E9NEUTI),
             (OP.REFE_FORC_NODA.PCNSETO, LC.E36NEUI), (OP.REFE_FORC_NODA.PCOMPOR, CCOMPOR),
             (SP.PDEPLMR, DDL_MECA), (SP.PGEOMER, NGEOMER),
             (OP.REFE_FORC_NODA.PHEAVTO, E6NEUTI), (OP.REFE_FORC_NODA.PHEA_NO, LC.N5NEUTI),
             ...
             (OP.REFE_FORC_NODA.PPINTER, LC.E14NEUTR), (OP.REFE_FORC_NODA.PPINTTO, LC.E6NEUTR),
             (OP.REFE_FORC_NODA.PPMILTO, LC.E22NEUTR), (SP.PREFCO, EREFCO),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)
...
ele.addCalcul(OP.RIGI_CONT, te=533,
    para_in=((OP.RIGI_CONT.PAINTER, LC.E35NEUTR), (OP.RIGI_CONT.PBASECO, LC.E28NEUTR),
             (OP.RIGI_CONT.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.E3NEUTR),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.RIGI_CONT_M, te=533,
    para_in=((OP.RIGI_CONT_M.PAINTER, LC.E35NEUTR), (OP.RIGI_CONT_M.PBASECO, LC.E28NEUTR),
             (OP.RIGI_CONT_M.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.N3NEUT_R),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             ...
             (OP.RIGI_CONT_M.PPINTER, LC.E14NEUTR), (OP.RIGI_CONT_M.PSEUIL, LC.E1NEUTR),
...
ele.addCalcul(OP.RIGI_FROT, te=533,
    para_in=((OP.RIGI_FROT.PAINTER, LC.E35NEUTR), (OP.RIGI_FROT.PBASECO, LC.E28NEUTR),
             (OP.RIGI_FROT.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.E3NEUTR),
             (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
             (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
             (OP.RIGI_FROT.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.I1NEUT_I),
...
ele.addCalcul(OP.RIGI_MECA, te=81,
...
ele.addCalcul(OP.XCVBCA, te=532,
    para_in=((OP.XCVBCA.PAINTER, LC.E35NEUTR), (OP.XCVBCA.PBASECO, LC.E28NEUTR),
             ...
             (OP.XCVBCA.PHEA_NO, LC.N5NEUTI), (SP.PINDCOI, LC.I1NEUT_I),
    ...
    para_out=((OP.XCVBCA.PCOHESO, LC.E3NEUTR), (SP.PINCOCA, LC.I1NEUT_I),
             (SP.PINDCOO, LC.I1NEUT_I), (SP.PINDMEM, LC.I1NEUT_I),
             ),
)

ele.addCalcul(OP.XCVBCA_MORTAR, te=532,
    para_in=((OP.XCVBCA_MORTAR.PAINTER, LC.E35NEUTR), (OP.XCVBCA_MORTAR.PBASECO, LC.E28NEUTR),
             (OP.XCVBCA_MORTAR.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.N3NEUT_R),
             (SP.PDEPL_P, DDL_MECA), (SP.PDONCO, CONTX_R),
             (SP.PGEOMER, NGEOMER), (SP.PGLISS, LC.I1NEUT_I),
             (SP.PINDCOI, LC.I1NEUT_I), (OP.XCVBCA_MORTAR.PLONGCO, LC.E3NEUTI),
             (OP.XCVBCA_MORTAR.PLST, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
             (SP.PMEMCON, LC.I1NEUT_I), (OP.XCVBCA_MORTAR.PPINTER, LC.E14NEUTR),
             ),
    para_out=((OP.XCVBCA_MORTAR.PCOHESO, LC.N3NEUT_R), (SP.PINCOCA, LC.I1NEUT_I),
             (SP.PINDCOO, LC.I1NEUT_I), (SP.PINDMEM, LC.I1NEUT_I),
             ),
)
...
#------------------------------------------------------------
MECPTR3_XHC = Element(modele=abstractElement)
ele = MECPTR3_XHC
...
#------------------------------------------------------------
MECPQU4_XHC = Element(modele=abstractElement)
ele = MECPQU4_XHC
...
ele.elrefe=(
        ...
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG3','XINT=FPG12','NOEU_S=NOEU_S','NOEU=NOEU',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2','MASS=NOEU','FPG2=FPG2','FPG3=FPG3','FPG4=FPG4','NOEU=NOEU','GAUSS=FPG3',),),
    )
...
#------------------------------------------------------------
MECPTR6_XHC = Element(modele=abstractElement)
ele = MECPTR6_XHC
...
ele.elrefe=(
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG3','XINT=FPG12','FPG1=FPG1','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM72',), mater=('RIGI','XFEM',),),
        ElrefeLoc(MT.SE3, gauss = ('RIGI=FPG4','MASS=NOEU','FPG2=FPG2','FPG3=FPG3','FPG4=FPG4','NOEU=NOEU','GAUSS=FPG3',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2','MASS=NOEU','FPG2=FPG2','FPG3=FPG3','FPG4=FPG4','NOEU=NOEU','GAUSS=FPG3',),),
    )
...
#------------------------------------------------------------
MECPQU8_XHC = Element(modele=abstractElement)
ele = MECPQU8_XHC
...
ele.elrefe=(
        ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','FPG1=FPG1','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM144',), mater=('RIGI','XFEM',),),
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4',),),
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG3','XINT=FPG12','NOEU_S=NOEU_S','NOEU=NOEU',),),
        ElrefeLoc(MT.SE3, gauss = ('RIGI=FPG4','MASS=NOEU','FPG2=FPG2','FPG3=FPG3','FPG4=FPG4','NOEU=NOEU','GAUSS=FPG3',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2','MASS=NOEU','FPG2=FPG2','FPG3=FPG3','FPG4=FPG4','NOEU=NOEU','GAUSS=FPG3',),),
...
#------------------------------------------------------------
MECPTR3_XHC3 = Element(modele=abstractElement)
ele = MECPTR3_XHC3
ele.meshType = MT.TRIA3
ele.nodes = (
...
#------------------------------------------------------------
MECPQU4_XHC3 = Element(modele=abstractElement)
ele = MECPQU4_XHC3
ele.meshType = MT.QUAD4
ele.nodes = (
