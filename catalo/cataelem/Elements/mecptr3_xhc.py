...
class MECPTR3_XHC(TemplateElement):
...
#------------------------------------------------------------
class MECPQU4_XHC(TemplateElement):
    """Please document this element"""
    meshType = MT.QUAD4
    nodes = (
...
#------------------------------------------------------------
class MECPTR6_XHC(TemplateElement):
    """Please document this element"""
    meshType = MT.TRIA6
    nodes = (
...
#------------------------------------------------------------
class MECPQU8_XHC(TemplateElement):
    """Please document this element"""
    meshType = MT.QUAD8
    nodes = (
...
#------------------------------------------------------------
class MECPTR3_XHC3(TemplateElement):
    """Please document this element"""
    meshType = MT.TRIA3
    nodes = (
