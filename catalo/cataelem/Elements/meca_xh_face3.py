...
#------------------------------------------------------------
MECA_XH_FACE3 = Element(modele=abstractElement)
ele = MECA_XH_FACE3
...
#------------------------------------------------------------
MECA_XH_FACE4 = Element(modele=abstractElement)
ele = MECA_XH_FACE4
...
#------------------------------------------------------------
MECA_XH_FACE6 = Element(modele=abstractElement)
ele = MECA_XH_FACE6
...
#------------------------------------------------------------
MECA_XH_FACE8 = Element(modele=abstractElement)
ele = MECA_XH_FACE8
