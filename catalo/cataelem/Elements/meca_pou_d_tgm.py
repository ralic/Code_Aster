...
ele.addCalcul(OP.CHAR_MECA_ROTA_R, te=150,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.CHAR_MECA_ROTA_R.PCAORIE, CCAORIE),
             (OP.CHAR_MECA_ROTA_R.PCOMPOR, CCOMPOR), (SP.PFIBRES, LC.ECAFIEL),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.CHAR_MECA_ROTA_R.PNBSP_I, ENBSP_I), (SP.PROTATR, LC.CROTATR),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)
...
ele.addCalcul(OP.COOR_ELGA_MATER, te=463,
...
ele.addCalcul(OP.EFGE_ELNO, te=185,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.EFGE_ELNO.PCAORIE, CCAORIE),
             ...
             (OP.EFGE_ELNO.PSTRXRR, ESTRAUX), (OP.EFGE_ELNO.PVARCPR, LC.ZVARCPG),
             ),
...
ele.addCalcul(OP.FORC_NODA, te=517,
...
ele.addCalcul(OP.FULL_MECA, te=516,
    para_in=((SP.PCAGNPO, CCAGNP2), (OP.FULL_MECA.PCAORIE, CCAORIE),
...
ele.addCalcul(OP.MASS_MECA_EXPLI, te=141,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.MASS_MECA_EXPLI.PCAORIE, CCAORIE),
             (OP.MASS_MECA_EXPLI.PCOMPOR, CCOMPOR), (SP.PFIBRES, LC.ECAFIEL),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.MASS_MECA_EXPLI.PNBSP_I, ENBSP_I), (OP.MASS_MECA_EXPLI.PVARCPR, LC.ZVARCPG),
             ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)
...
ele.addCalcul(OP.RAPH_MECA, te=516,
    para_in=((SP.PCAGNPO, CCAGNP2), (OP.RAPH_MECA.PCAORIE, CCAORIE),
...
ele.addCalcul(OP.REFE_FORC_NODA, te=517,
...
ele.addCalcul(OP.RIGI_MECA_GE, te=143,
    para_in=((SP.PCAGNPO, LC.CCAGNP1), (OP.RIGI_MECA_GE.PCAORIE, CCAORIE),
             (OP.RIGI_MECA_GE.PEFFORR, ECONTPG), (SP.PFIBRES, LC.ECAFIEL),
...
ele.addCalcul(OP.RIGI_MECA_RO, te=235,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.RIGI_MECA_RO.PCAORIE, CCAORIE),
             (OP.RIGI_MECA_RO.PCOMPOR, CCOMPOR), (SP.PFIBRES, LC.ECAFIEL),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.RIGI_MECA_RO.PNBSP_I, ENBSP_I), (SP.PROTATR, LC.CROTATR),
             (OP.RIGI_MECA_RO.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.RIGI_MECA_TANG, te=516,
    para_in=((SP.PCAGNPO, CCAGNP2), (OP.RIGI_MECA_TANG.PCAORIE, CCAORIE),
             (SP.PCARCRI, CCARCRI), (OP.RIGI_MECA_TANG.PCOMPOR, CCOMPOR),
             (OP.RIGI_MECA_TANG.PCONTMR, ECONTPG), (SP.PDDEPLA, DDL_MECA),
             (SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
             (SP.PFIBRES, LC.ECAFIEL), (SP.PGEOMER, NGEOMER),
             (SP.PINSTMR, CTEMPSR), (SP.PINSTPR, CTEMPSR),
             (SP.PITERAT, LC.CITERAT), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.TOU_INI_ELEM, te=99,
    para_out=((SP.PCAFI_R, LC.ECAFIEL), (OP.TOU_INI_ELEM.PGEOM_R, CGEOMER),
...
#------------------------------------------------------------
MECA_POU_D_TGM = Element(modele=abstractElement)
ele = MECA_POU_D_TGM
