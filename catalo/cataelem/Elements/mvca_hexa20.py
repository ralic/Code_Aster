...
ECONTNC  = LocatedComponents(phys=PHY.SIEF_C, type='ELNO',
    components=('SIXX','SIYY','SIZZ','SIXY','SIXZ',
          'SIYZ','SIGV_A','SIGV_L','SIGV_GX','SIGV_GY',
          'SIGV_GZ',))
...
#------------------------------------------------------------
MVCA_HEXA20 = Element(modele=abstractElement)
ele = MVCA_HEXA20
...
#------------------------------------------------------------
MVCA_TETRA10 = Element(modele=abstractElement)
ele = MVCA_TETRA10
...
#------------------------------------------------------------
MVCA_PENTA15 = Element(modele=abstractElement)
ele = MVCA_PENTA15
...
#------------------------------------------------------------
MVCA_PYRAM13 = Element(modele=abstractElement)
ele = MVCA_PYRAM13
