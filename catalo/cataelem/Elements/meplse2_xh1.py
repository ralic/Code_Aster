...
#------------------------------------------------------------
MEPLSE2_XH1 = Element(modele=abstractElement)
ele = MEPLSE2_XH1
...
#------------------------------------------------------------
MEPLSE2_XH2 = Element(modele=abstractElement)
ele = MEPLSE2_XH2
ele.meshType = MT.SEG2
ele.nodes = (
        SetOfNodes('EN2', (1,2,)),
...
#------------------------------------------------------------
MEPLSE2_XH3 = Element(modele=abstractElement)
ele = MEPLSE2_XH3
ele.meshType = MT.SEG2
ele.nodes = (
        SetOfNodes('EN3', (1,2,)),
...
#------------------------------------------------------------
MEPLSE2_XH4 = Element(modele=abstractElement)
ele = MEPLSE2_XH4
ele.meshType = MT.SEG2
ele.nodes = (
        SetOfNodes('EN4', (1,2,)),
