...
EERREUR = LocatedComponents(phys=PHY.ERRE_R, type='ELEM',
                            components=(
                                'ESTERG1', 'ERHMME_L', 'ERHMMEDL', 'ERHMHY_L', 'ERHMME_G',
                            'ERHMMEDG', 'ERHMHY_G',))
...
#       -- te0580 : ne resout que les cas triviaux : 0.
        ...
        OP.ERRE_TEMPS_THM(te=500,
                          para_in=(
                              (SP.PCONTGM, ECONTPG), (SP.PCONTGP, ECONTPG),
                          (SP.PGEOMER, NGEOMER), (SP.PGRDCA, LC.E2NEUTR),
...
class HM_DPQ8D(HM_DPQ8):
    ...
    elrefe = (
        ElrefeLoc(MT.QU8, gauss=('RIGI=NOEU_S', 'MASS=NOEU_S',
                                 'FPG1=FPG1', 'NOEU=NOEU',), mater=('RIGI', 'FPG1',),),
...
class HM_DPTR6D(HM_DPQ8):
    ...
    elrefe = (
        ElrefeLoc(MT.TR6, gauss=('RIGI=NOEU_S', 'MASS=NOEU_S',
                                 'FPG1=FPG1', 'NOEU=NOEU',), mater=('RIGI', 'FPG1',),),
...
class HM_DPQ8S(HM_DPQ8):
    ...
    elrefe = (
        ElrefeLoc(MT.QU8, gauss=('RIGI=FPG4NOS', 'MASS=FPG4',
                                 'NOEU_S=NOEU_S', 'NOEU=NOEU', 'FPG1=FPG1',), mater=('RIGI', 'FPG1',),),
        ElrefeLoc(
            MT.QU4, gauss = (
