...
ele.addCalcul(OP.CHAR_LIMITE, te=483,
...
ele.addCalcul(OP.EPSI_ELGA, te=453,
    para_in=((SP.PDEPLAR, NDEPLAR), (SP.PGEOMER, NGEOMER),
...
#------------------------------------------------------------
MINCOS_HEXA8 = Element(modele=abstractElement)
ele = MINCOS_HEXA8
...
ele.elrefe=(
        ElrefeLoc(MT.HE8, gauss = ('RIGI=FPG8','MASS=FPG8','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','MASS','NOEU','FPG1',),),
...
#------------------------------------------------------------
MINCOS_TETRA4 = Element(modele=abstractElement)
ele = MINCOS_TETRA4
...
ele.elrefe=(
        ElrefeLoc(MT.TE4, gauss = ('RIGI=FPG4','MASS=FPG4','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','MASS','NOEU','FPG1',),),
...
#------------------------------------------------------------
MINCOS_PENTA6 = Element(modele=abstractElement)
ele = MINCOS_PENTA6
...
ele.elrefe=(
        ElrefeLoc(MT.PE6, gauss = ('RIGI=FPG6','MASS=FPG6','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','MASS','NOEU','FPG1',),),
...
#------------------------------------------------------------
MINCOS_PYRAM5 = Element(modele=abstractElement)
ele = MINCOS_PYRAM5
...
ele.elrefe=(
        ElrefeLoc(MT.PY5, gauss = ('RIGI=FPG5','MASS=FPG5','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','MASS','NOEU','FPG1',),),
