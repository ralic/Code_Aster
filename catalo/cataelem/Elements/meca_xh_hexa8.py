...
ele.addCalcul(OP.CHAR_MECA_FR3D3D, te=440,
    para_in=((OP.CHAR_MECA_FR3D3D.PCNSETO, LC.E320NEUI), (SP.PFR3D3D, NFORCER),
             ...
             (OP.CHAR_MECA_FR3D3D.PPINTTO, E33NEUTR), (OP.CHAR_MECA_FR3D3D.PPMILTO, LC.E198NEUT),
...
ele.addCalcul(OP.REFE_FORC_NODA, te=542,
    para_in=((OP.REFE_FORC_NODA.PBASLOR, LC.N9NEUT_R), (OP.REFE_FORC_NODA.PCNSETO, LC.E320NEUI),
             (SP.PGEOMER, NGEOMER), (OP.REFE_FORC_NODA.PHEAVTO, LC.E32NEUTI),
             ...
             (OP.REFE_FORC_NODA.PPINTTO, E33NEUTR), (OP.REFE_FORC_NODA.PPMILTO, LC.E198NEUT),
             (SP.PREFCO, EREFCO), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)
...
#------------------------------------------------------------
MECA_XH_HEXA8 = Element(modele=abstractElement)
ele = MECA_XH_HEXA8
...
#------------------------------------------------------------
MECA_XH_PENTA6 = Element(modele=abstractElement)
ele = MECA_XH_PENTA6
...
ele.elrefe=(
        ...
        ElrefeLoc(MT.TE4, gauss = ('XINT=FPG15','NOEU=NOEU',),),
        ElrefeLoc(MT.TR3, gauss = ('FPG4=FPG4','MASS=FPG4','NOEU=NOEU','FPG6=FPG6','FPG7=FPG7','XCON=FPG12',),),
    )


#------------------------------------------------------------
MECA_XH_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XH_PYRAM5
...
#------------------------------------------------------------
MECA_XH_TETRA4 = Element(modele=abstractElement)
ele = MECA_XH_TETRA4
...
#------------------------------------------------------------
MECA_XH_HEXA20 = Element(modele=abstractElement)
ele = MECA_XH_HEXA20
...
#------------------------------------------------------------
MECA_XH_PENTA15 = Element(modele=abstractElement)
ele = MECA_XH_PENTA15
...
#------------------------------------------------------------
MECA_XH_PYRAM13 = Element(modele=abstractElement)
ele = MECA_XH_PYRAM13
...
#------------------------------------------------------------
MECA_XH_TETRA10 = Element(modele=abstractElement)
ele = MECA_XH_TETRA10
