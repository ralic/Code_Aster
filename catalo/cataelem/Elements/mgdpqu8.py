...
ele.addCalcul(OP.FORC_NODA, te=7,
...
ele.addCalcul(OP.FULL_MECA, te=113,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=113,
...
ele.addCalcul(OP.MASS_MECA, te=113,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.MASS_MECA.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.MASS_MECA_DIAG, te=113,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.MASS_MECA_DIAG.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.MASS_MECA_EXPLI, te=113,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.PILO_PRED_ELAS, te=544,
...
ele.addCalcul(OP.RAPH_MECA, te=113,
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=113,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=113,
...
#------------------------------------------------------------
MGDPQU8 = Element(modele=abstractElement)
ele = MGDPQU8
...
#------------------------------------------------------------
MGCPQU8 = Element(modele=abstractElement)
ele = MGCPQU8
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
MGDPTR6 = Element(modele=abstractElement)
ele = MGDPTR6
...
#------------------------------------------------------------
MGCPTR6 = Element(modele=abstractElement)
ele = MGCPTR6
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
