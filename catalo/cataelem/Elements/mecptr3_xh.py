...
ele.addCalcul(OP.REFE_FORC_NODA, te=542,
    para_in=((OP.REFE_FORC_NODA.PBASLOR, LC.N6NEUT_R), (OP.REFE_FORC_NODA.PCNSETO, LC.E36NEUI),
             (OP.REFE_FORC_NODA.PCOMPOR, CCOMPOR), (SP.PDEPLMR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (OP.REFE_FORC_NODA.PHEAVTO, E6NEUTI),
             (OP.REFE_FORC_NODA.PHEA_NO, LC.N5NEUTI), (OP.REFE_FORC_NODA.PLONCHA, LC.E10NEUTI),
...
#------------------------------------------------------------
MECPTR3_XH = Element(modele=abstractElement)
ele = MECPTR3_XH
...
#------------------------------------------------------------
MECPQU4_XH = Element(modele=abstractElement)
ele = MECPQU4_XH
...
ele.elrefe=(
        ...
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG3','MASS=FPG3','XINT=FPG12','NOEU_S=NOEU_S','NOEU=NOEU',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2','MASS=FPG3',),),
    )


#------------------------------------------------------------
MECPTR6_XH = Element(modele=abstractElement)
ele = MECPTR6_XH
...
ele.elrefe=(
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG3','MASS=FPG6','XINT=FPG12','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM72','FPG1=FPG1',), mater=('XFEM','NOEU',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG2','MASS=FPG3',),),
...
#------------------------------------------------------------
MECPQU8_XH = Element(modele=abstractElement)
ele = MECPQU8_XH
...
ele.elrefe=(
        ...
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG3','MASS=FPG3','XINT=FPG12',),),
