...
#------------------------------------------------------------
HH2_AXIS_QU8D = Element(modele=abstractElement)
ele = HH2_AXIS_QU8D
...
#------------------------------------------------------------
HH2_AXIS_TR6D = Element(modele=abstractElement)
ele = HH2_AXIS_TR6D
...
#------------------------------------------------------------
HH2_AXIS_QU8S = Element(modele=abstractElement)
ele = HH2_AXIS_QU8S
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
HH2_AXIS_TR6S = Element(modele=abstractElement)
ele = HH2_AXIS_TR6S
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
