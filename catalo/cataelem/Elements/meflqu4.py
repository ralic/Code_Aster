...
ele.addCalcul(OP.FORC_NODA, te=253,
...
ele.addCalcul(OP.FULL_MECA, te=253,
...
ele.addCalcul(OP.RAPH_MECA, te=253,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=253,
...
#------------------------------------------------------------
MEFLQU4 = Element(modele=abstractElement)
ele = MEFLQU4
...
#------------------------------------------------------------
MEFLQU8 = Element(modele=abstractElement)
ele = MEFLQU8
...
#------------------------------------------------------------
MEFLQU9 = Element(modele=abstractElement)
ele = MEFLQU9
...
#------------------------------------------------------------
MEFLTR3 = Element(modele=abstractElement)
ele = MEFLTR3
...
#------------------------------------------------------------
MEFLTR6 = Element(modele=abstractElement)
ele = MEFLTR6
