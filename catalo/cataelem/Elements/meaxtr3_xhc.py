# coding=utf-8
# CATALOGUES DES ELEMENTS 2D_AXIS X-FEM HEAVISIDE AVEC CONTACT (LINEAIRE ET QUADRATIQUE)
...
class MEAXQU4_XHC(MEAXTR3_XHC):
    ...
    elrefe = (
        ElrefeLoc(MT.QU4, gauss=('RIGI=FPG4', 'NOEU_S=NOEU_S',
