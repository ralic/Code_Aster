# coding=utf-8
# CATALOGUES DES ELEMENTS X-FEM HEAVISIDE-CRACKTIP AVEC CONTACT (QUE LINEAIRES ET QUADRATIQUES)
    ...
    calculs = (
        ...
        OP.CHAR_MECA_CONT(te=534,
            para_in=((OP.CHAR_MECA_CONT.PAINTER, LC.E170NEUT), (OP.CHAR_MECA_CONT.PBASECO, LC.E306NEUT),
                     ...
                     (OP.CHAR_MECA_CONT.PLST, LC.N1NEUT_R), (OP.CHAR_MECA_CONT.PPINTER, LC.E102NEUT),
        ...
        OP.CHAR_MECA_FROT(te=534,
            para_in=((OP.CHAR_MECA_FROT.PAINTER, LC.E170NEUT), (OP.CHAR_MECA_FROT.PBASECO, LC.E306NEUT),
                     ...
                     (OP.CHAR_MECA_FROT.PLST, LC.N1NEUT_R), (OP.CHAR_MECA_FROT.PPINTER, LC.E102NEUT),
        ...
        OP.GEOM_FAC(te=519,
            para_in=((SP.NOMFIS, E1NEUTK), (SP.PDEPLA, DDL_MECA),
                     ...
                     (OP.GEOM_FAC.PPINTER, LC.E102NEUT), (OP.GEOM_FAC.PBASLOR, LC.N9NEUT_R),
...
#------------------------------------------------------------
class MECA_XHTC_PENTA6(MECA_XHTC_HEXA8):
    """Please document this element"""
    meshType = MT.PENTA6
    nodes = (
...
#------------------------------------------------------------
class MECA_XHTC_PYRAM5(MECA_XHTC_HEXA8):
    """Please document this element"""
    meshType = MT.PYRAM5
    nodes = (
...
#------------------------------------------------------------
class MECA_XHTC_TETRA4(MECA_XHTC_HEXA8):
    """Please document this element"""
    meshType = MT.TETRA4
    nodes = (
...
#------------------------------------------------------------
class MECA_XHTC_HE20(MECA_XHTC_HEXA8):
    """Please document this element"""
    meshType = MT.HEXA20
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,5,6,7,8,)),
...
#------------------------------------------------------------
class MECA_XHTC_PE15(MECA_XHTC_HEXA8):
    """Please document this element"""
    meshType = MT.PENTA15
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,5,6,)),
...
#------------------------------------------------------------
class MECA_XHTC_PY13(MECA_XHTC_HEXA8):
    """Please document this element"""
    meshType = MT.PYRAM13
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,5,)),
...
#------------------------------------------------------------
class MECA_XHTC_TE10(MECA_XHTC_HEXA8):
    """Please document this element"""
    meshType = MT.TETRA10
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,)),
