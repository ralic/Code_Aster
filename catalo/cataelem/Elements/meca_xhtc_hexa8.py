...
#------------------------------------------------------------
MECA_XHTC_HEXA8 = Element(modele=abstractElement)
ele = MECA_XHTC_HEXA8
...
#------------------------------------------------------------
MECA_XHTC_PENTA6 = Element(modele=abstractElement)
ele = MECA_XHTC_PENTA6
...
#------------------------------------------------------------
MECA_XHTC_PYRAM5 = Element(modele=abstractElement)
ele = MECA_XHTC_PYRAM5
...
#------------------------------------------------------------
MECA_XHTC_TETRA4 = Element(modele=abstractElement)
ele = MECA_XHTC_TETRA4
...
#------------------------------------------------------------
MECA_XHTC_HE20 = Element(modele=abstractElement)
ele = MECA_XHTC_HE20
...
#------------------------------------------------------------
MECA_XHTC_PE15 = Element(modele=abstractElement)
ele = MECA_XHTC_PE15
...
#------------------------------------------------------------
MECA_XHTC_PY13 = Element(modele=abstractElement)
ele = MECA_XHTC_PY13
...
#------------------------------------------------------------
MECA_XHTC_TE10 = Element(modele=abstractElement)
ele = MECA_XHTC_TE10
