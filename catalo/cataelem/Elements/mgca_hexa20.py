...
ele.addCalcul(OP.FORC_NODA, te=437,
...
#------------------------------------------------------------
MGCA_HEXA20 = Element(modele=abstractElement)
ele = MGCA_HEXA20
...
ele.elrefe=(
        ElrefeLoc(MT.H20, gauss = ('RIGI=FPG8','FPG1=FPG1','MASS=FPG27',), mater=('RIGI','FPG1',),),
...
#------------------------------------------------------------
MGCA_TETRA10 = Element(modele=abstractElement)
ele = MGCA_TETRA10
...
ele.elrefe=(
        ElrefeLoc(MT.T10, gauss = ('RIGI=FPG4','FPG1=FPG1','MASS=FPG15',), mater=('RIGI','FPG1',),),
...
#------------------------------------------------------------
MGCA_PENTA15 = Element(modele=abstractElement)
ele = MGCA_PENTA15
...
ele.elrefe=(
        ElrefeLoc(MT.P15, gauss = ('RIGI=FPG6','FPG1=FPG1','MASS=FPG21',), mater=('RIGI','FPG1',),),
...
#------------------------------------------------------------
MGCA_PYRAM13 = Element(modele=abstractElement)
ele = MGCA_PYRAM13
...
ele.elrefe=(
        ElrefeLoc(MT.P13, gauss = ('RIGI=FPG5','FPG1=FPG1','MASS=FPG27',), mater=('RIGI','FPG1',),),
