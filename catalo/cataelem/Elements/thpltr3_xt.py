...
ele.addCalcul(OP.CHAR_THER_EVOL, te=577,
    para_in=((OP.CHAR_THER_EVOL.PBASLOR, LC.N6NEUT_R), (OP.CHAR_THER_EVOL.PCNSETO, LC.E36NEUI),
             ...
             (OP.CHAR_THER_EVOL.PPINTTO, LC.E6NEUTR), (OP.CHAR_THER_EVOL.PSTANO, STANO_I),
...
ele.addCalcul(OP.CHAR_THER_PARO_F, te=599,
    para_in=((OP.CHAR_THER_PARO_F.PAINTER, LC.E35NEUTR), (OP.CHAR_THER_PARO_F.PBASECO, LC.E28NEUTR),
             ...
             (OP.CHAR_THER_PARO_F.PPINTER, LC.E14NEUTR), (OP.CHAR_THER_PARO_F.PSTANO, STANO_I),
             (SP.PTEMPER, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)
...
ele.addCalcul(OP.CHAR_THER_PARO_R, te=599,
    para_in=((OP.CHAR_THER_PARO_R.PAINTER, LC.E35NEUTR), (OP.CHAR_THER_PARO_R.PBASECO, LC.E28NEUTR),
             ...
             (OP.CHAR_THER_PARO_R.PPINTER, LC.E14NEUTR), (OP.CHAR_THER_PARO_R.PSTANO, STANO_I),
             (SP.PTEMPER, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)
...
ele.addCalcul(OP.MASS_THER, te=572,
    para_in=((OP.MASS_THER.PBASLOR, LC.N6NEUT_R), (OP.MASS_THER.PCNSETO, LC.E36NEUI),
             ...
             (OP.MASS_THER.PPINTTO, LC.E6NEUTR), (OP.MASS_THER.PSTANO, STANO_I),
...
ele.addCalcul(OP.RIGI_THER, te=571,
    para_in=((OP.RIGI_THER.PBASLOR, LC.N6NEUT_R), (OP.RIGI_THER.PCNSETO, LC.E36NEUI),
             ...
             (OP.RIGI_THER.PPINTTO, LC.E6NEUTR), (OP.RIGI_THER.PSTANO, STANO_I),
...
ele.addCalcul(OP.RIGI_THER_PARO_F, te=594,
    para_in=((OP.RIGI_THER_PARO_F.PAINTER, LC.E35NEUTR), (OP.RIGI_THER_PARO_F.PBASECO, LC.E28NEUTR),
             ...
             (OP.RIGI_THER_PARO_F.PPINTER, LC.E14NEUTR), (OP.RIGI_THER_PARO_F.PSTANO, STANO_I),
             (SP.PTEMPSR, CTEMPSR), ),
...
ele.addCalcul(OP.RIGI_THER_PARO_R, te=594,
    para_in=((OP.RIGI_THER_PARO_R.PAINTER, LC.E35NEUTR), (OP.RIGI_THER_PARO_R.PBASECO, LC.E28NEUTR),
             ...
             (OP.RIGI_THER_PARO_R.PPINTER, LC.E14NEUTR), (OP.RIGI_THER_PARO_R.PSTANO, STANO_I),
             (SP.PTEMPSR, CTEMPSR), ),
...
#------------------------------------------------------------
THPLTR3_XT = Element(modele=abstractElement)
ele = THPLTR3_XT
...
#------------------------------------------------------------
THPLQU4_XT = Element(modele=abstractElement)
ele = THPLQU4_XT
...
#------------------------------------------------------------
THAXTR3_XT = Element(modele=abstractElement)
ele = THAXTR3_XT
ele.meshType = MT.TRIA3
ele.elrefe=(
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG3','XINT=FPG12','XFEM=XFEM36',), mater=('XFEM',),),
...
#------------------------------------------------------------
THAXQU4_XT = Element(modele=abstractElement)
ele = THAXQU4_XT
ele.meshType = MT.QUAD4
ele.elrefe=(
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','XFEM=XFEM72',), mater=('XFEM',),),
