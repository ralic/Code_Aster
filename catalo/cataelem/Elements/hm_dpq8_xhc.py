...
DDL_MECA = LocatedComponents(phys=PHY.DEPL_R, type='ELNO', diff=True,
    ...
    ('EN1',('DX','DY','PRE1','H1X','H1Y',
          'H1PRE1','PRE_FLU','LAG_FLI',
          'LAG_FLS','LAGS_C','LAGS_F1')),
    ('EN2',('DX','DY','H1X','H1Y',)),
    ...
    calculs = (
        ...
        OP.CHAR_MECA_CONT(te=557,
            para_in=((OP.CHAR_MECA_CONT.PAINTER, LC.E35NEUTR), (OP.CHAR_MECA_CONT.PBASECO, LC.E28NEUTR),
                     (OP.CHAR_MECA_CONT.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.E5NEUTR),
        ...
        OP.CHAR_MECA_CONT_M(te=557,
            para_in=((OP.CHAR_MECA_CONT_M.PAINTER, LC.E35NEUTR), (OP.CHAR_MECA_CONT_M.PBASECO, LC.E28NEUTR),
                     (OP.CHAR_MECA_CONT_M.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.N5NEUTR),
                     (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA), (SP.PDONCO, CONTX_R), 
        ...
        OP.RIGI_CONT(te=556,
            para_in=((OP.RIGI_CONT.PAINTER, LC.E35NEUTR), (OP.RIGI_CONT.PBASECO, LC.E28NEUTR),
                     (OP.RIGI_CONT.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.E5NEUTR),
        ...
        OP.RIGI_CONT_M(te=556,
            para_in=((OP.RIGI_CONT_M.PAINTER, LC.E35NEUTR), (OP.RIGI_CONT_M.PBASECO, LC.E28NEUTR),
                     (OP.RIGI_CONT_M.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.N5NEUTR),
                     (SP.PDEPL_M, DDL_MECA), (SP.PDEPL_P, DDL_MECA),
                     (SP.PDONCO, CONTX_R), (SP.PGEOMER, NGEOMER),
        ...
        OP.XCVBCA(te=558,
            para_in=((OP.XCVBCA.PAINTER, LC.E35NEUTR), (OP.XCVBCA.PBASECO, LC.E28NEUTR),
                     (OP.XCVBCA.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.E5NEUTR),
                     ...
                     (SP.PMATERC, LC.CMATERC), (OP.XCVBCA.PPINTER, LC.E14NEUTR),
        ...
        OP.XCVBCA_MORTAR(te=558,
            para_in=((OP.XCVBCA_MORTAR.PAINTER, LC.E35NEUTR), (OP.XCVBCA_MORTAR.PBASECO, LC.E28NEUTR),
                     (OP.XCVBCA_MORTAR.PCFACE, LC.E9NEUTI), (SP.PCOHES, LC.N5NEUTR),
                     (SP.PDEPL_P, DDL_MECA), (SP.PDONCO, CONTX_R),
                     (SP.PGEOMER, NGEOMER), (SP.PINDCOI, LC.I1NEUT_I),
                     (OP.XCVBCA_MORTAR.PLONGCO, LC.E3NEUTI), (OP.XCVBCA_MORTAR.PLST, LC.N1NEUT_R),
                     (SP.PMATERC, LC.CMATERC), (OP.XCVBCA_MORTAR.PPINTER, LC.E14NEUTR),
...
#------------------------------------------------------------
class HM_DPQ8_XHC(TemplateElement):
    ...
    elrefe =(
            ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','MASS=FPG9','XFEM=XFEM72','FPG1=FPG1',), mater=('XFEM',),),
...
#------------------------------------------------------------
class HM_DPTR6_XHC(TemplateElement):
    """Please document this element"""
    meshType = MT.TRIA6
    nodes = (
...
#------------------------------------------------------------
class HM_DPQ8_XHC3(TemplateElement):
    """Please document this element"""
    meshType = MT.QUAD8
    nodes = (
            SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
class HM_DPTR6_XHC3(TemplateElement):
    """Please document this element"""
    meshType = MT.TRIA6
    nodes = (
            SetOfNodes('EN2', (4,5,6,)),
