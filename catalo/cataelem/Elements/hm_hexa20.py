...
class HM_HEXA20(Element):
    ...
    elrefe = (
        ElrefeLoc(MT.H20, gauss=('RIGI=FPG27', 'MASS=FPG27',
...
class HM_PENTA15(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(MT.P15, gauss=('RIGI=FPG21', 'MASS=FPG21',
                                 'FPG1=FPG1', 'NOEU=NOEU',), mater=('RIGI', 'FPG1',),),
...
class HM_TETRA10(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(MT.T10, gauss=('RIGI=FPG15', 'MASS=FPG15',
                                 'FPG1=FPG1', 'NOEU=NOEU',), mater=('RIGI', 'FPG1',),),
...
class HM_HEXA20D(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(MT.H20, gauss=('RIGI=NOEU_S', 'MASS=NOEU_S',
                                 'FPG1=FPG1', 'NOEU=NOEU',), mater=('RIGI', 'FPG1',),),
...
class HM_PENTA15D(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(MT.P15, gauss=('RIGI=NOEU_S', 'MASS=NOEU_S',
                                 'FPG1=FPG1', 'NOEU=NOEU',), mater=('RIGI', 'FPG1',),),
...
class HM_TETRA10D(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(MT.T10, gauss=('RIGI=NOEU_S', 'MASS=NOEU_S',
                                 'FPG1=FPG1', 'NOEU=NOEU',), mater=('RIGI', 'FPG1',),),
...
class HM_HEXA20S(HM_HEXA20):
    ...
    elrefe = (
        ElrefeLoc(MT.H20, gauss=('RIGI=FPG8NOS', 'MASS=FPG8',
                                 'NOEU_S=NOEU_S', 'FPG1=FPG1', 'NOEU=NOEU',), mater=('RIGI', 'FPG1',),),
        ElrefeLoc(
            MT.HE8, gauss = (
