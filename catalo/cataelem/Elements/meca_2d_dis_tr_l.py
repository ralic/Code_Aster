...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=41,
    para_in=((SP.PCADISK, CCADISK), (OP.RIGI_MECA_ELAS.PCAORIE, CCAORIE),
             (SP.PCINFDI, LC.CCINFDI), (SP.PVARCMR, LC.ZVARCPG),
...
#------------------------------------------------------------
MECA_2D_DIS_TR_L = Element(modele=abstractElement)
ele = MECA_2D_DIS_TR_L
