...
#------------------------------------------------------------
HH2M_DPQ8M = Element(modele=abstractElement)
ele = HH2M_DPQ8M
...
#------------------------------------------------------------
HH2M_DPTR6M = Element(modele=abstractElement)
ele = HH2M_DPTR6M
...
#------------------------------------------------------------
HH2M_DPQ8D = Element(modele=abstractElement)
ele = HH2M_DPQ8D
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
HH2M_DPTR6D = Element(modele=abstractElement)
ele = HH2M_DPTR6D
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
...
#------------------------------------------------------------
HH2M_DPQ8S = Element(modele=abstractElement)
ele = HH2M_DPQ8S
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
HH2M_DPTR6S = Element(modele=abstractElement)
ele = HH2M_DPTR6S
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
