...
#------------------------------------------------------------
MEAXTR3_XH = Element(modele=abstractElement)
ele = MEAXTR3_XH
...
#------------------------------------------------------------
MEAXQU4_XH = Element(modele=abstractElement)
ele = MEAXQU4_XH
...
#------------------------------------------------------------
MEAXTR6_XH = Element(modele=abstractElement)
ele = MEAXTR6_XH
...
#------------------------------------------------------------
MEAXQU8_XH = Element(modele=abstractElement)
ele = MEAXQU8_XH
