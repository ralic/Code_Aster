    ...
    calculs = (
        ...
        OP.CALC_G(te=288,
            para_in=((OP.CALC_G.PAINTER, LC.E200NEUT), (OP.CALC_G.PBASECO, LC.E360NEUT),
                     ...
                     (OP.CALC_G.PPINTER, LC.E120NEUT), (OP.CALC_G.PPINTTO, E33NEUTR),
        ...
        OP.CALC_G_F(te=288,
            para_in=((OP.CALC_G_F.PAINTER, LC.E200NEUT), (OP.CALC_G_F.PBASECO, LC.E360NEUT),
                     ...
                     (SP.PPESANR, LC.CPESANR), (OP.CALC_G_F.PPINTER, LC.E120NEUT),
        ...
        OP.CHAR_MECA_CONT(te=534,
            para_in=((OP.CHAR_MECA_CONT.PAINTER, LC.E200NEUT), (OP.CHAR_MECA_CONT.PBASECO, LC.E360NEUT),
                     ...
                     (OP.CHAR_MECA_CONT.PPINTER, LC.E120NEUT), (OP.CHAR_MECA_CONT.PSEUIL, LC.E1NEUTR),
                     (SP.PMATERC, LC.CMATERC), (OP.CHAR_MECA_CONT.PLSN, LC.N1NEUT_R),
                     (OP.CHAR_MECA_CONT.PBASLOR, LC.N9NEUT_R), (OP.CHAR_MECA_CONT.PSTANO, STANO_I),
                     ),
        ...
        OP.CHAR_MECA_FROT(te=534,
            para_in=((OP.CHAR_MECA_FROT.PAINTER, LC.E200NEUT), (OP.CHAR_MECA_FROT.PBASECO, LC.E360NEUT),
                     ...
                     (OP.CHAR_MECA_FROT.PPINTER, LC.E120NEUT), (OP.CHAR_MECA_FROT.PSEUIL, LC.E1NEUTR),
                     (OP.CHAR_MECA_FROT.PLSN, LC.N1NEUT_R), (SP.PMATERC, LC.CMATERC),
                     (OP.RIGI_FROT.PBASLOR, LC.N9NEUT_R), (OP.CHAR_MECA_FROT.PSTANO, STANO_I),),
            para_out=((SP.PVECTUR, MVECTUR), ),
        ),
        ...
        OP.FULL_MECA(te=539,
            para_in=((OP.FULL_MECA.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     ...
                     (OP.FULL_MECA.PVARIMR, ZVARIPG), (OP.FULL_MECA.PPMILTO, LC.E198NEUT),),
        ...
        OP.GEOM_FAC(te=519,
            para_in=((SP.NOMFIS, E1NEUTK), (SP.PDEPLA, DDL_MECA),
                     (OP.GEOM_FAC.PGESCLO, LC.E120NEUT), (OP.GEOM_FAC.PLONGCO, LC.E3NEUTI),
                     (OP.GEOM_FAC.PLST, LC.N1NEUT_R), (OP.GEOM_FAC.PPINTER, LC.E120NEUT),
        ...
        OP.RIGI_CONT(te=533,
            para_in=((OP.RIGI_CONT.PAINTER, LC.E200NEUT), (OP.RIGI_CONT.PBASECO, LC.E360NEUT),
                     ...
                     (OP.RIGI_CONT.PLST, LC.N1NEUT_R), (OP.RIGI_CONT.PPINTER, LC.E120NEUT),
                     (OP.RIGI_CONT.PSEUIL, LC.E1NEUTR), (SP.PMATERC, LC.CMATERC),
                     (OP.RIGI_CONT.PBASLOR, LC.N9NEUT_R), (OP.RIGI_CONT.PSTANO, STANO_I),),
        ...
        OP.RIGI_FROT(te=533,
            para_in=((OP.RIGI_FROT.PAINTER, LC.E200NEUT), (OP.RIGI_FROT.PBASECO, LC.E360NEUT),
                     ...
                     (OP.RIGI_FROT.PLST, LC.N1NEUT_R), (OP.RIGI_FROT.PPINTER, LC.E120NEUT),
                     (OP.RIGI_FROT.PSEUIL, LC.E1NEUTR), (SP.PMATERC, LC.CMATERC),
                     (OP.RIGI_FROT.PBASLOR, LC.N9NEUT_R), (OP.RIGI_FROT.PSTANO, STANO_I),),
            para_out=((SP.PMATUNS, MMATUNS), (SP.PMATUUR, MMATUUR),
                     ),
        ),
        ...
        OP.RIGI_MECA_TANG(te=539,
            para_in=((OP.RIGI_MECA_TANG.PBASLOR, LC.N9NEUT_R), (SP.PCAMASS, CCAMASS),
                     ...
                     (OP.RIGI_MECA_TANG.PPINTTO, E33NEUTR), (OP.RIGI_MECA_TANG.PPMILTO, LC.E198NEUT),
        ...
        OP.XCVBCA(te=532,
            para_in=((OP.XCVBCA.PAINTER, LC.E200NEUT), (OP.XCVBCA.PBASECO, LC.E360NEUT),
                     ...
                     (SP.PMEMCON, LC.E1NEUTI), (OP.XCVBCA.PPINTER, LC.E120NEUT),
...
#------------------------------------------------------------
class MECA_XTC_PENTA6(MECA_XTC_HEXA8):
    """Please document this element"""
    meshType = MT.PENTA6
    nodes = (
...
#------------------------------------------------------------
class MECA_XTC_PYRAM5(MECA_XTC_HEXA8):
    """Please document this element"""
    meshType = MT.PYRAM5
    nodes = (
...
#------------------------------------------------------------
class MECA_XTC_TETRA4(MECA_XTC_HEXA8):
    """Please document this element"""
    meshType = MT.TETRA4
    nodes = (
    ...
    elrefe =(
            ElrefeLoc(MT.TE4, gauss = ('RIGI=FPG1','NOEU=NOEU','XINT=FPG15','XGEO=FPG5','FPG1=FPG1','XFEM=XFEM90',), mater=('RIGI','XFEM',),),
            ElrefeLoc(MT.TR3, gauss = ('FPG4=FPG4','NOEU=NOEU','FPG6=FPG6','FPG7=FPG7','XCON=FPG12','GAUSS=FPG12','SIMP=SIMP',),),
        )
...
class MECA_XTC_HEXA20(MECA_XTC_HEXA8):
    ...
    elrefe =(
            ...
            ElrefeLoc(MT.TE4, gauss = ('XINT=FPG15','XGEO=FPG5','NOEU=NOEU',),),
            ElrefeLoc(MT.T10, gauss = ('XINT=FPG15','XGEO=FPG5','NOEU=NOEU',),),
            ElrefeLoc(MT.TR6, gauss = ('FPG4=FPG4','NOEU=NOEU','FPG6=FPG6','FPG7=FPG7','XCON=FPG12','SIMP=SIMP','GAUSS=FPG12',),),
            ElrefeLoc(MT.TR3, gauss = ('FPG4=FPG4','NOEU=NOEU','FPG6=FPG6','FPG7=FPG7','XCON=FPG12','SIMP=SIMP','GAUSS=FPG12',),),
        )


#------------------------------------------------------------
class MECA_XTC_PENTA15(MECA_XTC_HEXA8):
    """Please document this element"""
    meshType = MT.PENTA15
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,5,6,)),
...
#------------------------------------------------------------
class MECA_XTC_PYRAM13(MECA_XTC_HEXA8):
    """Please document this element"""
    meshType = MT.PYRAM13
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,5,)),
...
#------------------------------------------------------------
class MECA_XTC_TETRA10(MECA_XTC_HEXA8):
    """Please document this element"""
    meshType = MT.TETRA10
    nodes = (
            SetOfNodes('EN1', (1,2,3,4,)),
