...
ele.addCalcul(OP.CHAR_LIMITE, te=482,
...
ele.addCalcul(OP.EPSI_ELGA, te=447,
    para_in=((SP.PDEPLAR, NDEPLAR), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.FORC_NODA, te=596,
...
ele.addCalcul(OP.FULL_MECA, te=595,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=595,
...
ele.addCalcul(OP.RAPH_MECA, te=595,
...
ele.addCalcul(OP.REFE_FORC_NODA, te=598,
...
ele.addCalcul(OP.RIGI_MECA, te=597,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=595,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=595,
...
ele.addCalcul(OP.SIEF_ELGA, te=97,
...
ele.addCalcul(OP.TOU_INI_ELNO, te=99,
    para_out=((OP.TOU_INI_ELNO.PEPSI_R, EDEFONO), (OP.TOU_INI_ELNO.PGEOM_R, NGEOMER),
...
#------------------------------------------------------------
MUPLQU8 = Element(modele=abstractElement)
ele = MUPLQU8
...
#------------------------------------------------------------
MUPLTR6 = Element(modele=abstractElement)
ele = MUPLTR6
...
#------------------------------------------------------------
MUPLTR3 = Element(modele=abstractElement)
ele = MUPLTR3
