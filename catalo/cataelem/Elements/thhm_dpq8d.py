...
#------------------------------------------------------------
THHM_DPQ8D = Element(modele=abstractElement)
ele = THHM_DPQ8D
...
#------------------------------------------------------------
THHM_DPTR6D = Element(modele=abstractElement)
ele = THHM_DPTR6D
...
#------------------------------------------------------------
THHM_DPQ8S = Element(modele=abstractElement)
ele = THHM_DPQ8S
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
THHM_DPTR6S = Element(modele=abstractElement)
ele = THHM_DPTR6S
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
