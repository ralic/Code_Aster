...
ele.addCalcul(OP.DEGE_ELNO, te=158,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.DEGE_ELNO.PCAORIE, CCAORIE),
             ...
             (SP.PMATERC, LC.CMATERC), (OP.DEGE_ELNO.PVARCPR, LC.ZVARCPG),
             (SP.PVARCRR, LC.ZVARCPG), ),
...
ele.addCalcul(OP.EFGE_ELNO, te=185,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.EFGE_ELNO.PCAORIE, CCAORIE),
             (OP.EFGE_ELNO.PCOMPOR, CCOMPOR), (OP.EFGE_ELNO.PCONTRR, EEFGEGA),
             (SP.PDEPLAR, DDL_MECA), (SP.PFF1D1D, CFORCEF),
             (SP.PFR1D1D, CFORCER), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (SP.PNONLIN, LC.ENONLIN),
             (SP.PPESANR, LC.CPESANR), (SP.PTEMPSR, CTEMPSR),
...
ele.addCalcul(OP.FULL_MECA, te=346,
    para_in=((SP.PCAGNPO, LC.CCAGNP1), (OP.FULL_MECA.PCAORIE, CCAORIE),
...
ele.addCalcul(OP.MASS_INER, te=38,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.MASS_INER.PCAORIE, CCAORIE),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.RAPH_MECA, te=346,
    para_in=((SP.PCAGNPO, LC.CCAGNP1), (OP.RAPH_MECA.PCAORIE, CCAORIE),
...
ele.addCalcul(OP.RIGI_MECA_GE, te=143,
    para_in=((SP.PCAGNPO, LC.CCAGNP1), (OP.RIGI_MECA_GE.PCAORIE, CCAORIE),
...
ele.addCalcul(OP.RIGI_MECA_RO, te=235,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.RIGI_MECA_RO.PCAORIE, CCAORIE),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=346,
    para_in=((SP.PCAGNPO, LC.CCAGNP1), (OP.RIGI_MECA_TANG.PCAORIE, CCAORIE),
...
ele.addCalcul(OP.SIEF_ELGA, te=342,
...
ele.addCalcul(OP.SIPM_ELNO, te=344,
    para_in=((SP.PCAGEPO, LC.CCAGRPO), (SP.PCAGNPO, CCAGNPO),
             (OP.SIPM_ELNO.PCAORIE, CCAORIE), (SP.PDEPLAR, DDL_MECA),
             (SP.PFF1D1D, CFORCEF), (SP.PFR1D1D, CFORCER),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PPESANR, LC.CPESANR), (SP.PTEMPSR, CTEMPSR),
             (OP.SIPM_ELNO.PVARCPR, LC.ZVARCPG), (SP.PVARCRR, LC.ZVARCPG),
             ),
    para_out=((SP.PSIMXRC, LC.ESIMXNC), (SP.PSIMXRR, LC.ESIMXNO),
             ),
)

ele.addCalcul(OP.SIPO_ELNO, te=344,
    para_in=((SP.PCAGEPO, LC.CCAGRPO), (SP.PCAGNPO, CCAGNPO),
             (OP.SIPO_ELNO.PCAORIE, CCAORIE), (SP.PDEPLAR, DDL_MECA),
             (SP.PFF1D1D, CFORCEF), (SP.PFR1D1D, CFORCER),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PTEMPSR, CTEMPSR), (OP.SIPO_ELNO.PVARCPR, LC.ZVARCPG),
             (SP.PVARCRR, LC.ZVARCPG), ),
...
#------------------------------------------------------------
MECA_POU_D_TG = Element(modele=abstractElement)
ele = MECA_POU_D_TG
ele.meshType = MT.SEG2
ele.elrefe=(
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG3','FPG1=FPG1',), mater=('RIGI','FPG1',),),
    )
