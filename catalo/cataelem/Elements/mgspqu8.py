...
ele.addCalcul(OP.FULL_MECA, te=123,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=123,
...
ele.addCalcul(OP.MASS_MECA, te=123,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.MASS_MECA.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.MASS_MECA_DIAG, te=123,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.MASS_MECA_DIAG.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.MASS_MECA_EXPLI, te=123,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.RAPH_MECA, te=123,
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=123,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=123,
...
#------------------------------------------------------------
MGSPQU8 = Element(modele=abstractElement)
ele = MGSPQU8
...
#------------------------------------------------------------
MGSPTR6 = Element(modele=abstractElement)
ele = MGSPTR6
