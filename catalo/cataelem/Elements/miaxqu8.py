...
ele.addCalcul(OP.FORC_NODA, te=591,
...
ele.addCalcul(OP.FULL_MECA, te=590,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=590,
...
ele.addCalcul(OP.RAPH_MECA, te=590,
...
ele.addCalcul(OP.REFE_FORC_NODA, te=593,
...
ele.addCalcul(OP.RIGI_MECA, te=592,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=590,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=590,
...
#------------------------------------------------------------
MIAXQU8 = Element(modele=abstractElement)
ele = MIAXQU8
...
#------------------------------------------------------------
MIAXTR6 = Element(modele=abstractElement)
ele = MIAXTR6
