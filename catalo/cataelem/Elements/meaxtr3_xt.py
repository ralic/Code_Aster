...
#------------------------------------------------------------
MEAXTR3_XT = Element(modele=abstractElement)
ele = MEAXTR3_XT
...
#------------------------------------------------------------
MEAXQU4_XT = Element(modele=abstractElement)
ele = MEAXQU4_XT
...
#------------------------------------------------------------
MEAXTR6_XT = Element(modele=abstractElement)
ele = MEAXTR6_XT
...
#------------------------------------------------------------
MEAXQU8_XT = Element(modele=abstractElement)
ele = MEAXQU8_XT
...
ele.elrefe=(
        ...
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG6','MASS=FPG6','XINT=FPG12',),),
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG6','MASS=FPG6','XINT=FPG12',),),
    )
