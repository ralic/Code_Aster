...
ECONTNC  = LocatedComponents(phys=PHY.SIEF_C, type='ELNO',
    components=('SIXX','SIYY','SIZZ','SIXY','SIXZ',
          ...
          'M21','FH21X','FH21Y','ENT21','M22',
          'FH22X','FH22Y','ENT22','QPRIM','FHTX',
          'FHTY',))
...
#------------------------------------------------------------
THH2M_AXIS_QU8D = Element(modele=abstractElement)
ele = THH2M_AXIS_QU8D
...
#------------------------------------------------------------
THH2M_AXIS_TR6D = Element(modele=abstractElement)
ele = THH2M_AXIS_TR6D
...
#------------------------------------------------------------
THH2M_AXIS_QU8S = Element(modele=abstractElement)
ele = THH2M_AXIS_QU8S
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
THH2M_AXIS_TR6S = Element(modele=abstractElement)
ele = THH2M_AXIS_TR6S
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
