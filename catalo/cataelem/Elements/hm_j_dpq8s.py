...
ECONTNC  = LocatedComponents(phys=PHY.SIEF_C, type='ELNO', diff=True,
    components=(
    ('EN1',()),
    ('EN2',()),
...
ECONTPG  = LocatedComponents(phys=PHY.SIEF_R, type='ELGA', location='RIGI',
    components=('SIGN','SITX','SIP','M11','FH11X',
          'LH1P','LH1M','DPRE1P','DPRE1M',))
...
ele.addCalcul(OP.FORC_NODA, te=313,
    para_in=((SP.PCAMASS, CCAMASS), (OP.FORC_NODA.PCONTMR, ECONTPG),
...
ele.addCalcul(OP.FULL_MECA, te=313,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=313,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RAPH_MECA, te=313,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=313,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=313,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.SIEF_ELNO, te=313,
...
ele.addCalcul(OP.VARI_ELNO, te=313,
...
#------------------------------------------------------------
HM_J_DPQ8S = Element(modele=abstractElement)
ele = HM_J_DPQ8S
...
ele.elrefe=(
        ElrefeLoc(MT.SE3, gauss = ('RIGI=FPG3NOS','MASS=FPG3','NOEU_S=NOEU_S','FPG1=FPG1',), mater=('RIGI','FPG1',),),
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG3NOS','MASS=FPG3','NOEU_S=NOEU_S',),),
    )
