...
#------------------------------------------------------------
MECPQS8 = Element(modele=abstractElement)
ele = MECPQS8
...
#------------------------------------------------------------
MECPQU4 = Element(modele=abstractElement)
ele = MECPQU4
...
#------------------------------------------------------------
MECPQU8 = Element(modele=abstractElement)
ele = MECPQU8
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN1', (1,2,3,4,5,6,7,8,)),
...
#------------------------------------------------------------
MECPQU9 = Element(modele=abstractElement)
ele = MECPQU9
...
#------------------------------------------------------------
MECPTR3 = Element(modele=abstractElement)
ele = MECPTR3
...
#------------------------------------------------------------
MECPTR6 = Element(modele=abstractElement)
ele = MECPTR6
...
ele.elrefe=(
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG3','FPG1=FPG1','MASS=FPG6','NOEU_S=NOEU_S','NOEU=NOEU',), mater=('RIGI','NOEU','FPG1',),),
        ElrefeLoc(MT.SE3, gauss = ('RIGI=FPG4',),),
    )
