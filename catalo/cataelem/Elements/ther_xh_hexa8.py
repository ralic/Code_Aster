...
# CATALOGUES DES ELEMENTS THERMIQUES 3D X-FEM HEAVISIDE (LINEAIRES)
...
#------------------------------------------------------------
class THER_XH_PENTA6(THER_XH_HEXA8):
    """Please document this element"""
    meshType = MT.PENTA6
    elrefe =(
...
#------------------------------------------------------------
class THER_XH_PYRAM5(THER_XH_HEXA8):
    """Please document this element"""
    meshType = MT.PYRAM5
    elrefe =(
...
#------------------------------------------------------------
class THER_XH_TETRA4(THER_XH_HEXA8):
    """Please document this element"""
    meshType = MT.TETRA4
    elrefe =(
