...
#------------------------------------------------------------
THER_XH_HEXA8 = Element(modele=abstractElement)
ele = THER_XH_HEXA8
...
#------------------------------------------------------------
THER_XH_PENTA6 = Element(modele=abstractElement)
ele = THER_XH_PENTA6
...
#------------------------------------------------------------
THER_XH_PYRAM5 = Element(modele=abstractElement)
ele = THER_XH_PYRAM5
...
#------------------------------------------------------------
THER_XH_TETRA4 = Element(modele=abstractElement)
ele = THER_XH_TETRA4
