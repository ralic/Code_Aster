...
ele.addCalcul(OP.FORC_NODA, te=508,
...
ele.addCalcul(OP.FULL_MECA, te=545,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=545,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.MASS_MECA, te=562,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.MASS_MECA.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.MASS_MECA_DIAG, te=562,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.MASS_MECA_DIAG.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.MASS_MECA_EXPLI, te=562,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.PILO_PRED_DEFO, te=518,
...
ele.addCalcul(OP.PILO_PRED_ELAS, te=518,
...
ele.addCalcul(OP.RAPH_MECA, te=545,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.REFE_FORC_NODA, te=508,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PREFCO, EREFCO), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=545,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=545,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PCARCRI, CCARCRI),
...
#------------------------------------------------------------
MVDPTR6 = Element(modele=abstractElement)
ele = MVDPTR6
...
#------------------------------------------------------------
MVDPQS8 = Element(modele=abstractElement)
ele = MVDPQS8
...
#------------------------------------------------------------
MVAXTR6 = Element(modele=abstractElement)
ele = MVAXTR6
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
...
#------------------------------------------------------------
MVAXQS8 = Element(modele=abstractElement)
ele = MVAXQS8
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
