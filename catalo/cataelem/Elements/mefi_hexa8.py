...
ele.addCalcul(OP.FULL_MECA_ELAS, te=206,
...
ele.addCalcul(OP.PILO_PRED_ELAS, te=208,
...
ele.addCalcul(OP.RAPH_MECA, te=206,
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=206,
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=206,
