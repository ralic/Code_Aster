...
#------------------------------------------------------------
MEAXTR3_XHT = Element(modele=abstractElement)
ele = MEAXTR3_XHT
...
#------------------------------------------------------------
MEAXQU4_XHT = Element(modele=abstractElement)
ele = MEAXQU4_XHT
...
#------------------------------------------------------------
MEAXTR6_XHT = Element(modele=abstractElement)
ele = MEAXTR6_XHT
...
#------------------------------------------------------------
MEAXQU8_XHT = Element(modele=abstractElement)
ele = MEAXQU8_XHT
