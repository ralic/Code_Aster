...
#------------------------------------------------------------
MECA_XT_FACE3 = Element(modele=abstractElement)
ele = MECA_XT_FACE3
...
#------------------------------------------------------------
MECA_XT_FACE4 = Element(modele=abstractElement)
ele = MECA_XT_FACE4
...
#------------------------------------------------------------
MECA_XT_FACE6 = Element(modele=abstractElement)
ele = MECA_XT_FACE6
...
#------------------------------------------------------------
MECA_XT_FACE8 = Element(modele=abstractElement)
ele = MECA_XT_FACE8
