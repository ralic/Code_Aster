...
#------------------------------------------------------------
PR_G_QUAD8 = Element(modele=abstractElement)
ele = PR_G_QUAD8
...
#------------------------------------------------------------
PR_G_QUAD4 = Element(modele=abstractElement)
ele = PR_G_QUAD4
...
#------------------------------------------------------------
PR_G_TRIA6 = Element(modele=abstractElement)
ele = PR_G_TRIA6
...
#------------------------------------------------------------
PR_G_TRIA3 = Element(modele=abstractElement)
ele = PR_G_TRIA3
