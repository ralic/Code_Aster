...
#------------------------------------------------------------
MIAXOSQU4 = Element(modele=abstractElement)
ele = MIAXOSQU4
...
#------------------------------------------------------------
MIAXOSTR3 = Element(modele=abstractElement)
ele = MIAXOSTR3
...
#------------------------------------------------------------
MIPLOSQU4 = Element(modele=abstractElement)
ele = MIPLOSQU4
ele.meshType = MT.QUAD4
ele.nodes = (
        SetOfNodes('EN1', (1,2,3,4,)),
...
#------------------------------------------------------------
MIPLOSTR3 = Element(modele=abstractElement)
ele = MIPLOSTR3
ele.meshType = MT.TRIA3
ele.nodes = (
        SetOfNodes('EN1', (1,2,3,)),
