...
ele.addCalcul(OP.CHAR_THER_ACCE_R, te=315,
    para_in=((SP.PACCELR, NACCELR), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_ACCE_X, te=315,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PTEMPER, DDL_THER), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_ACCE_Y, te=315,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PTEMPER, DDL_THER), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_FLUNL, te=274,
...
ele.addCalcul(OP.CHAR_THER_FLUN_F, te=75,
    para_in=((SP.PFLUXNF, CFLUXNF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_FLUN_R, te=74,
    para_in=((SP.PFLUXNR, CFLUXNR), (SP.PGEOMER, NGEOMER),
             ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_FLUTNL, te=506,
    para_in=((SP.PFLUXNL, CFLUXNF), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.CHAR_THER_FLUX_F, te=68,
    para_in=((SP.PFLUXVF, LC.CFLUXVF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_RAYO_F, te=73,
...
ele.addCalcul(OP.CHAR_THER_RAYO_R, te=72,
...
ele.addCalcul(OP.CHAR_THER_TEXT_F, te=73,
...
ele.addCalcul(OP.CHAR_THER_TEXT_R, te=72,
...
ele.addCalcul(OP.FLUX_FLUI_X, te=316,
    para_in=((SP.PGEOMER, NGEOMER), ),
    para_out=((OP.FLUX_FLUI_X.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.FLUX_FLUI_Y, te=317,
    para_in=((SP.PGEOMER, NGEOMER), ),
    para_out=((OP.FLUX_FLUI_Y.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.MTAN_THER_COEF_F, te=250,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.MTAN_THER_COEF_F.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.MTAN_THER_COEF_R, te=249,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.MTAN_THER_COEF_R.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.MTAN_THER_FLUXNL, te=251,
    para_in=((SP.PFLUXNL, CFLUXNF), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.MTAN_THER_RAYO_F, te=250,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PRAYONF, LC.CRAYONF),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
...
ele.addCalcul(OP.MTAN_THER_RAYO_R, te=249,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PRAYONR, LC.CRAYONR),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
...
ele.addCalcul(OP.RESI_THER_COEF_F, te=137,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_COEF_R, te=136,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_COEH_F, te=307,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_COEH_R, te=305,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_FLUXNL, te=138,
    para_in=((SP.PFLUXNL, CFLUXNF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_RAYO_F, te=137,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PRAYONF, LC.CRAYONF),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RESI_THER_RAYO_R, te=136,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PRAYONR, LC.CRAYONR),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
    para_out=((SP.PRESIDU, MVECTTR), ),
...
ele.addCalcul(OP.RIGI_THER_COEH_F, te=71,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.RIGI_THER_COEH_F.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.RIGI_THER_COEH_R, te=70,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.RIGI_THER_COEH_R.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.RIGI_THER_COET_F, te=507,
    para_in=((SP.PCOEFHF, CCOEFHF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.RIGI_THER_COET_F.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.RIGI_THER_COET_R, te=503,
    para_in=((SP.PCOEFHR, CCOEFHR), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((OP.RIGI_THER_COET_R.PMATTTR, MMATTTR), ),
)

ele.addCalcul(OP.RIGI_THER_FLUTNL, te=504,
    para_in=((SP.PFLUXNL, CFLUXNF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPER, DDL_THER), (SP.PTEMPSR, CTEMPSR),
             ),
...
#------------------------------------------------------------
THPLSL2 = Element(modele=abstractElement)
ele = THPLSL2
...
#------------------------------------------------------------
THPLSL3 = Element(modele=abstractElement)
ele = THPLSL3
...
ele.modifyCalcul(OP.CHAR_THER_ACCE_R, te=-1)

ele.modifyCalcul(OP.CHAR_THER_ACCE_X, te=-1)

ele.modifyCalcul(OP.CHAR_THER_ACCE_Y, te=-1)

ele.modifyCalcul(OP.CHAR_THER_FLUTNL, te=-1)

ele.modifyCalcul(OP.FLUX_FLUI_X, te=-1)

ele.modifyCalcul(OP.FLUX_FLUI_Y, te=-1)

ele.modifyCalcul(OP.RESI_THER_COEH_F, te=-1)

ele.modifyCalcul(OP.RESI_THER_COEH_R, te=-1)

ele.modifyCalcul(OP.RIGI_THER_FLUTNL, te=-1)
