...
#------------------------------------------------------------
MEDPTR3_XH = Element(modele=abstractElement)
ele = MEDPTR3_XH
...
#------------------------------------------------------------
MEDPQU4_XH = Element(modele=abstractElement)
ele = MEDPQU4_XH
...
#------------------------------------------------------------
MEDPTR6_XH = Element(modele=abstractElement)
ele = MEDPTR6_XH
...
#------------------------------------------------------------
MEDPQU8_XH = Element(modele=abstractElement)
ele = MEDPQU8_XH
