...
#------------------------------------------------------------
class THV_PENTA15D(THV_HEXA20D):
    """Please document this element"""
    meshType = MT.PENTA15
    nodes = (
...
#------------------------------------------------------------
class THV_TETRA10D(THV_HEXA20D):
    """Please document this element"""
    meshType = MT.TETRA10
    nodes = (
...
#------------------------------------------------------------
class THV_PENTA15S(THV_HEXA20D):
    """Please document this element"""
    meshType = MT.PENTA15
    nodes = (
            SetOfNodes('EN2', (7,8,9,10,11,12,13,14,15,)),
...
#------------------------------------------------------------
class THV_TETRA10S(THV_HEXA20D):
    """Please document this element"""
    meshType = MT.TETRA10
    nodes = (
            SetOfNodes('EN2', (5,6,7,8,9,10,)),
