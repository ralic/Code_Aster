...
#------------------------------------------------------------
HHM_AXIS_QU8 = Element(modele=abstractElement)
ele = HHM_AXIS_QU8
...
ele.elrefe=(
        ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','MASS=FPG9','FPG1=FPG1',), mater=('RIGI','FPG1',),),
...
#------------------------------------------------------------
HHM_AXIS_TR6 = Element(modele=abstractElement)
ele = HHM_AXIS_TR6
...
ele.elrefe=(
        ElrefeLoc(MT.TR6, gauss = ('RIGI=FPG6','MASS=FPG6','FPG1=FPG1',), mater=('RIGI','FPG1',),),
...
#------------------------------------------------------------
HHM_AXIS_QU8D = Element(modele=abstractElement)
ele = HHM_AXIS_QU8D
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
HHM_AXIS_TR6D = Element(modele=abstractElement)
ele = HHM_AXIS_TR6D
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
...
#------------------------------------------------------------
HHM_AXIS_QU8S = Element(modele=abstractElement)
ele = HHM_AXIS_QU8S
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
HHM_AXIS_TR6S = Element(modele=abstractElement)
ele = HHM_AXIS_TR6S
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
