...
EERREUR = LocatedComponents(phys=PHY.ERRE_R, type='ELEM',
                            components=(
                                'ERREST', 'NUEST', 'SIGCAL', 'TERMRE', 'TERMR2',
...
class MBAXQU8(Element):
    ...
    calculs = (
        ...
        OP.CALC_GTP(te=96,
                    para_in=(
                        (SP.PACCELE, NDEPLAR), (OP.CALC_GTP.PCOMPOR, CCOMPOR),
        ...
        OP.CALC_G_F(te=96,
                    para_in=(
                        (SP.PACCELE, NDEPLAR), (OP.CALC_G_F.PCOMPOR, CCOMPOR),
        ...
        OP.CALC_K_G(te=299,
                    para_in=(
                        (OP.CALC_K_G.PCOMPOR, CCOMPOR), (SP.PDEPLAR, NDEPLAR),
        ...
        OP.CHAR_MECA_FF2D2D(te=94,
                            para_in=(
                                (SP.PFF2D2D, CFORCEF), (SP.PGEOMER, NGEOMER),
                            (SP.PTEMPSR, CTEMPSR), ),
...
class MBAXTR6(MBAXQU8):
    ...
    elrefe = (
        ElrefeLoc(
            MT.TR6, gauss=(
                'RIGI=FPG3', 'MASS=FPG6', 'NOEU=NOEU', 'FPG1=FPG1',),
            mater=('RIGI', 'MASS', 'NOEU', 'FPG1',),),
