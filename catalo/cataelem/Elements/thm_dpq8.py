...
#------------------------------------------------------------
THM_DPQ8 = Element(modele=abstractElement)
ele = THM_DPQ8
...
#------------------------------------------------------------
THM_DPTR6 = Element(modele=abstractElement)
ele = THM_DPTR6
...
#------------------------------------------------------------
THM_DPQ8D = Element(modele=abstractElement)
ele = THM_DPQ8D
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
THM_DPTR6D = Element(modele=abstractElement)
ele = THM_DPTR6D
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
...
#------------------------------------------------------------
THM_DPQ8S = Element(modele=abstractElement)
ele = THM_DPQ8S
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
THM_DPTR6S = Element(modele=abstractElement)
ele = THM_DPTR6S
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
