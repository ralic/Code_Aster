...
CCAARPO  = LocatedComponents(phys=PHY.CAARPO, type='ELEM',
...
EDEPLCPG = LocatedComponents(phys=PHY.DEPL_C, type='ELGA', location='RIGI',
    components=('DX','DY','DZ','DRX','DRY',
          'DRZ',))
...
EDEPLRPG = LocatedComponents(phys=PHY.DEPL_R, type='ELGA', location='RIGI',
    components=('DX','DY','DZ','DRX','DRY',
          'DRZ',))
...
ele.addCalcul(OP.ARLQ_MATR, te=399,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.ARLQ_MATR.PCAORIE, CCAORIE),
             (SP.PCOOR1R, LC.ECOOR1R), (SP.PCOOR2R, LC.ECOOR1R),
...
ele.addCalcul(OP.CHAR_MECA_EPSI_R, te=20,
...
ele.addCalcul(OP.CHAR_MECA_FC1D1D, te=150,
...
ele.addCalcul(OP.CHAR_MECA_FF1D1D, te=150,
...
ele.addCalcul(OP.CHAR_MECA_FR1D1D, te=150,
...
ele.addCalcul(OP.CHAR_MECA_FRELEC, te=145,
    para_in=((SP.PFRELEC, LC.CFRELEC), (SP.PGEOMER, NGEOMER),
             ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_FRLAPL, te=148,
    para_in=((SP.PFLAPLA, LC.CFLAPLA), (SP.PGEOMER, NGEOMER),
             (SP.PLISTMA, LC.CLISTMA), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_HYDR_R, te=150,
...
ele.addCalcul(OP.CHAR_MECA_PESA_R, te=150,
...
ele.addCalcul(OP.CHAR_MECA_ROTA_R, te=150,
...
ele.addCalcul(OP.CHAR_MECA_SECH_R, te=150,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.CHAR_MECA_SECH_R.PCAORIE, CCAORIE),
             (OP.CHAR_MECA_SECH_R.PCOMPOR, CCOMPOR), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.CHAR_MECA_SF1D1D, te=150,
...
ele.addCalcul(OP.CHAR_MECA_SR1D1D, te=150,
...
ele.addCalcul(OP.CHAR_MECA_TEMP_R, te=150,
    para_in=((SP.PCAARPO, CCAARPO), (SP.PCAGNPO, CCAGNPO),
             (OP.CHAR_MECA_TEMP_R.PCAORIE, CCAORIE), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.DEGE_ELNO, te=158,
    para_in=((SP.PCAGEPO, CCAGEPO), (SP.PCAGNPO, CCAGNPO),
             (OP.DEGE_ELNO.PCAORIE, CCAORIE), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.ECIN_ELEM, te=151,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.ECIN_ELEM.PCAORIE, CCAORIE),
...
ele.addCalcul(OP.EFGE_ELNO, te=185,
    para_in=((SP.PCAARPO, CCAARPO), (SP.PCAGEPO, CCAGEPO),
             (SP.PCAGNPO, CCAGNPO), (OP.EFGE_ELNO.PCAORIE, CCAORIE),
...
ele.addCalcul(OP.EPOT_ELEM, te=151,
...
ele.addCalcul(OP.FORC_NODA, te=347,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.FORC_NODA.PCAORIE, CCAORIE),
             (OP.FORC_NODA.PCOMPOR, CCOMPOR), (OP.FORC_NODA.PCONTMR, EEFGEGA),
             (SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.FULL_MECA, te=247,
...
ele.addCalcul(OP.INI_STRX, te=23,
    para_in=((OP.INI_STRX.PCAORIE, CCAORIE), ),
    para_out=((SP.PSTRX_R, ESTRAUX), ),
)

ele.addCalcul(OP.MASS_FLUI_STRU, te=141,
...
ele.addCalcul(OP.MASS_INER, te=38,
    para_in=((SP.PCAARPO, CCAARPO), (SP.PCAGNPO, CCAGNPO),
             (OP.MASS_INER.PCAORIE, CCAORIE), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (OP.MASS_INER.PVARCPR, LC.ZVARCPG),
             ),
    para_out=((SP.PMASSINE, LC.EMASSINE), ),
)

ele.addCalcul(OP.MASS_MECA, te=141,
...
ele.addCalcul(OP.MASS_MECA_DIAG, te=141,
...
ele.addCalcul(OP.MASS_MECA_EXPLI, te=141,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.MASS_MECA_EXPLI.PCAORIE, CCAORIE),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (OP.MASS_MECA_EXPLI.PVARCPR, LC.ZVARCPG), ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.MECA_GYRO, te=259,
...
ele.addCalcul(OP.M_GAMMA, te=141,
...
ele.addCalcul(OP.RAPH_MECA, te=247,
    para_in=((SP.PCAARPO, CCAARPO), (SP.PCAGNPO, CCAGNPO),
...
ele.addCalcul(OP.REFE_FORC_NODA, te=347,
...
ele.addCalcul(OP.RIGI_FLUI_STRU, te=140,
...
ele.addCalcul(OP.RIGI_GYRO, te=262,
...
ele.addCalcul(OP.RIGI_MECA, te=140,
    para_in=((SP.PCAARPO, CCAARPO), (SP.PCAGNPO, CCAGNPO),
             (OP.RIGI_MECA.PCAORIE, CCAORIE), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (OP.RIGI_MECA.PVARCPR, LC.ZVARCPG),
             ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)

ele.addCalcul(OP.RIGI_MECA_GE, te=143,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.RIGI_MECA_GE.PCAORIE, CCAORIE),
             (OP.RIGI_MECA_GE.PEFFORR, EEFGEGA), (SP.PGEOMER, NGEOMER),
             ),
    para_out=((SP.PMATUUR, MMATUUR), ),
)
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=247,
    para_in=((SP.PCAARPO, CCAARPO), (SP.PCAGNPO, CCAGNPO),
...
ele.addCalcul(OP.SIEF_ELGA, te=144,
    para_in=((SP.PCAARPO, CCAARPO), (SP.PCAGNPO, CCAGNPO),
...
ele.addCalcul(OP.SIEF_ELNO, te=347,
    para_in=((SP.PCAGNPO, CCAGNPO), (OP.SIEF_ELNO.PCAORIE, CCAORIE),
             (OP.SIEF_ELNO.PCOMPOR, CCOMPOR), (OP.SIEF_ELNO.PCONTRR, EEFGEGA),
             (SP.PDEPPLU, DDL_MECA), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (OP.SIEF_ELNO.PVARCPR, LC.ZVARCPG),
             ),
    para_out=((SP.PSIEFNOC, EEFGENC), (OP.SIEF_ELNO.PSIEFNOR, EEFGENO),
             ),
)

ele.addCalcul(OP.SIPM_ELNO, te=149,
    para_in=((SP.PCAARPO, CCAARPO), (SP.PCAGEPO, LC.CCAGRPO),
             (SP.PCAGNPO, CCAGNPO), (OP.SIPM_ELNO.PCAORIE, CCAORIE),
             (SP.PCHDYNR, DDL_MECA), (SP.PCOEFFC, LC.CCOEFC),
             (SP.PCOEFFR, LC.CCOEFR), (SP.PDEPLAR, DDL_MECA),
             (SP.PFF1D1D, CFORCEF), (SP.PFR1D1D, CFORCER),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PPESANR, LC.CPESANR), (SP.PSUROPT, LC.CSUROPT),
             (SP.PTEMPSR, CTEMPSR), (OP.SIPM_ELNO.PVARCPR, LC.ZVARCPG),
             (SP.PVARCRR, LC.ZVARCPG), ),
    para_out=((SP.PSIMXRC, LC.ESIMXNC), (SP.PSIMXRR, LC.ESIMXNO),
             ),
)

ele.addCalcul(OP.SIPO_ELNO, te=149,
    para_in=((SP.PABSCUR, CABSCUR), (SP.PCAARPO, CCAARPO),
             (SP.PCAGEPO, LC.CCAGRPO), (SP.PCAGNPO, CCAGNPO),
             (OP.SIPO_ELNO.PCAORIE, CCAORIE), (SP.PCHDYNR, DDL_MECA),
             ...
             (SP.PSUROPT, LC.CSUROPT), (SP.PTEMPSR, CTEMPSR),
             (OP.SIPO_ELNO.PVARCPR, LC.ZVARCPG), (SP.PVARCRR, LC.ZVARCPG),
             ),
...
ele.addCalcul(OP.TOU_INI_ELGA, te=99,
    para_out=((SP.PDEPL_C, EDEPLCPG), (OP.TOU_INI_ELGA.PDEPL_R, EDEPLRPG),
...
ele.addCalcul(OP.VARI_ELNO, te=347,
...
#------------------------------------------------------------
MECA_POU_D_T = Element(modele=abstractElement)
ele = MECA_POU_D_T
ele.meshType = MT.SEG2
ele.elrefe=(
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG3','NOEU=NOEU','FPG1=FPG1','ARLQ_1=FPG3',), mater=('RIGI','NOEU','FPG1',),),
    )
