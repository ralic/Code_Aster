...
ele.addCalcul(OP.CHAR_THER_EVOL, te=61,
...
ele.addCalcul(OP.CHAR_THER_EVOLNI, te=281,
...
ele.addCalcul(OP.CHAR_THER_GRAI_F, te=217,
...
ele.addCalcul(OP.CHAR_THER_GRAI_R, te=217,
...
ele.addCalcul(OP.CHAR_THER_SOUR_F, te=56,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PSOURCF, LC.CSOURCF),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_SOUR_R, te=55,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PSOURCR, ESOURCR),
             ),
    para_out=((SP.PVECTTR, MVECTTR), ),
)

ele.addCalcul(OP.CHAR_THER_TNL, te=525,
...
ele.addCalcul(OP.ETHE_ELEM, te=66,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (SP.PTEMPER, DDL_THER),
...
ele.addCalcul(OP.FLUX_ELGA, te=62,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (SP.PTEMPER, DDL_THER),
...
ele.addCalcul(OP.MASS_THER, te=54,
...
ele.addCalcul(OP.META_ELNO, te=64,
...
ele.addCalcul(OP.META_INIT_ELNO, te=321,
...
ele.addCalcul(OP.MTAN_RIGI_MASS, te=279,
...
ele.addCalcul(OP.RESI_RIGI_MASS, te=283,
...
ele.addCalcul(OP.RIGI_THER, te=51,
    para_in=((SP.PCAMASS, CCAMASS), (SP.PGEOMER, NGEOMER),
             (SP.PMATERC, LC.CMATERC), (SP.PTEMPSR, CTEMPSR),
...
ele.addCalcul(OP.RIGI_THER_CONV_T, te=522,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.RIGI_THER_TRANS, te=521,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PTEMPEI, DDL_THER), (SP.PTEMPER, DDL_THER),
             (SP.PTEMPSR, CTEMPSR), ),
...
ele.addCalcul(OP.SOUR_ELGA, te=319,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
             (SP.PTEMPER, DDL_THER), (SP.PTEMPSR, CTEMPSR),
...
#------------------------------------------------------------
THER_HEXA20 = Element(modele=abstractElement)
ele = THER_HEXA20
...
#------------------------------------------------------------
THER_HEXA27 = Element(modele=abstractElement)
ele = THER_HEXA27
...
#------------------------------------------------------------
THER_HEXA8 = Element(modele=abstractElement)
ele = THER_HEXA8
...
#------------------------------------------------------------
THER_PENTA15 = Element(modele=abstractElement)
ele = THER_PENTA15
...
#------------------------------------------------------------
THER_PENTA6 = Element(modele=abstractElement)
ele = THER_PENTA6
...
#------------------------------------------------------------
THER_PYRAM13 = Element(modele=abstractElement)
ele = THER_PYRAM13
...
ele.modifyCalcul(OP.CHAR_THER_GRAI_F, te=-1)

ele.modifyCalcul(OP.CHAR_THER_GRAI_R, te=-1)
...
ele.modifyCalcul(OP.ERTH_ELEM, te=-1)

ele.modifyCalcul(OP.ERTH_ELNO, te=-1)


#------------------------------------------------------------
THER_PYRAM5 = Element(modele=abstractElement)
ele = THER_PYRAM5
...
#------------------------------------------------------------
THER_TETRA10 = Element(modele=abstractElement)
ele = THER_TETRA10
...
#------------------------------------------------------------
THER_TETRA4 = Element(modele=abstractElement)
ele = THER_TETRA4
...
#------------------------------------------------------------
THER_HEXA8_D = Element(modele=abstractElement)
ele = THER_HEXA8_D
ele.meshType = MT.HEXA8
ele.elrefe=(
...
#------------------------------------------------------------
THER_PENTA6_D = Element(modele=abstractElement)
ele = THER_PENTA6_D
ele.meshType = MT.PENTA6
ele.elrefe=(
...
#------------------------------------------------------------
THER_TETRA4_D = Element(modele=abstractElement)
ele = THER_TETRA4_D
ele.meshType = MT.TETRA4
ele.elrefe=(
