...
#------------------------------------------------------------
MEDPTR3_XH2C = Element(modele=abstractElement)
ele = MEDPTR3_XH2C
...
#------------------------------------------------------------
MEDPTR3_XH3C = Element(modele=abstractElement)
ele = MEDPTR3_XH3C
ele.meshType = MT.TRIA3
ele.nodes = (
...
#------------------------------------------------------------
MEDPTR3_XH4C = Element(modele=abstractElement)
ele = MEDPTR3_XH4C
ele.meshType = MT.TRIA3
ele.nodes = (
...
#------------------------------------------------------------
MEDPQU4_XH2C = Element(modele=abstractElement)
ele = MEDPQU4_XH2C
...
#------------------------------------------------------------
MEDPQU4_XH3C = Element(modele=abstractElement)
ele = MEDPQU4_XH3C
ele.meshType = MT.QUAD4
ele.nodes = (
...
#------------------------------------------------------------
MEDPQU4_XH4C = Element(modele=abstractElement)
ele = MEDPQU4_XH4C
ele.meshType = MT.QUAD4
ele.nodes = (
