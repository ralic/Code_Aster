...
#------------------------------------------------------------
MEDPTR3_XHT = Element(modele=abstractElement)
ele = MEDPTR3_XHT
...
#------------------------------------------------------------
MEDPQU4_XHT = Element(modele=abstractElement)
ele = MEDPQU4_XHT
...
#------------------------------------------------------------
MEDPTR6_XHT = Element(modele=abstractElement)
ele = MEDPTR6_XHT
...
#------------------------------------------------------------
MEDPQU8_XHT = Element(modele=abstractElement)
ele = MEDPQU8_XHT
...
ele.elrefe=(
        ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','MASS=FPG4','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM144','FPG1=FPG1',), mater=('XFEM','NOEU',),),
