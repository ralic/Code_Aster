...
#------------------------------------------------------------
MECPTR3_XHT = Element(modele=abstractElement)
ele = MECPTR3_XHT
...
#------------------------------------------------------------
MECPQU4_XHT = Element(modele=abstractElement)
ele = MECPQU4_XHT
...
#------------------------------------------------------------
MECPTR6_XHT = Element(modele=abstractElement)
ele = MECPTR6_XHT
...
#------------------------------------------------------------
MECPQU8_XHT = Element(modele=abstractElement)
ele = MECPQU8_XHT
