# coding=utf-8
# CATALOGUES DES ELEMENTS 2D_CP X-FEM HEAVISIDE-CRACKTIP SANS CONTACT (QUE LINEAIRES ET QUADRATIQUES)
...
#       -- te0580 : ne resout que les cas triviaux : 0.
        ...
        OP.CALC_K_G_F(te=297,
            para_in=((OP.CALC_K_G_F.PAINTER, LC.E35NEUTR), (OP.CALC_K_G_F.PBASECO, LC.E28NEUTR),
                     ...
                     (SP.PROTATR, LC.CROTATR), (SP.PSIGISE, ECONTSE),
                     (SP.PTEMPSR, CTEMPSR), (SP.PTHETAR, DDL_MECC), (OP.CALC_K_G_F.PSTANO, STANO_I),
        ...
        OP.CHAR_MECA_PESA_R(te=441,
            para_in=((OP.CHAR_MECA_PESA_R.PCNSETO, LC.E36NEUI), (SP.PGEOMER, NGEOMER),
                     ...
                     (OP.CHAR_MECA_PESA_R.PVARCPR, LC.ZVARCPG), (OP.CHAR_MECA_PESA_R.PBASLOR, LC.N6NEUT_R),),
            para_out=((SP.PVECTUR, MVECTUR), ),
        ),
        ...
        OP.CHAR_MECA_PRES_R(te=37,
            para_in=((OP.CHAR_MECA_PRES_R.PAINTER, LC.E35NEUTR), (OP.CHAR_MECA_PRES_R.PBASECO, LC.E28NEUTR),
                     ...
                     (OP.CHAR_MECA_PRES_R.PBASLOR, LC.N6NEUT_R),(OP.CHAR_MECA_PRES_F.PLSN, LC.N1NEUT_R),
                     ),
            para_out=((SP.PVECTUR, MVECTUR), ),
        ),
        ...
        OP.CHAR_MECA_ROTA_R(te=441,
            para_in=((OP.CHAR_MECA_ROTA_R.PCNSETO, LC.E36NEUI), (SP.PGEOMER, NGEOMER),
                     ...
                     (OP.CHAR_MECA_ROTA_R.PBASLOR, LC.N6NEUT_R),
                     ),
            para_out=((SP.PVECTUR, MVECTUR), ),
        ),
        ...
        OP.DEPL_XPG(te=566,
            para_in=((OP.DEPL_XPG.PBASLOR, LC.N6NEUT_R), (SP.PDEPLNO, DDL_MECA),
                     ...
                     (OP.DEPL_XPG.PSTANO, STANO_I),(SP.PMATERC, LC.CMATERC),
                     (SP.PGEOMER, NGEOMER),),
...
class MECPQU8_XHT(MECPTR3_XHT):
    ...
    elrefe =(
            ElrefeLoc(MT.QU8, gauss = ('RIGI=FPG9','MASS=FPG4','NOEU_S=NOEU_S','NOEU=NOEU','XFEM=XFEM72','FPG1=FPG1',), mater=('XFEM','NOEU',),),
