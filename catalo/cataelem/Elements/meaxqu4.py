...
#------------------------------------------------------------
MEAXQU4 = Element(modele=abstractElement)
ele = MEAXQU4
...
#------------------------------------------------------------
MDAXQU4 = Element(modele=abstractElement)
ele = MDAXQU4
ele.meshType = MT.QUAD4
ele.elrefe=(
        ElrefeLoc(MT.QU4, gauss = ('RIGI=FPG4','FPG1=FPG1','MASS=FPG4','NOEU_S=NOEU_S','NOEU=NOEU',), mater=('RIGI','NOEU','FPG1',),),
...
#------------------------------------------------------------
MEAXQU8 = Element(modele=abstractElement)
ele = MEAXQU8
...
#------------------------------------------------------------
MEAXQU9 = Element(modele=abstractElement)
ele = MEAXQU9
...
#------------------------------------------------------------
MEAXTR3 = Element(modele=abstractElement)
ele = MEAXTR3
...
#------------------------------------------------------------
MEAXTR6 = Element(modele=abstractElement)
ele = MEAXTR6
