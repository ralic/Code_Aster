...
#------------------------------------------------------------
MIUP_HEXA20 = Element(modele=abstractElement)
ele = MIUP_HEXA20
...
#------------------------------------------------------------
MIUP_TETRA10 = Element(modele=abstractElement)
ele = MIUP_TETRA10
...
#------------------------------------------------------------
MIUP_PENTA15 = Element(modele=abstractElement)
ele = MIUP_PENTA15
...
#------------------------------------------------------------
MIUP_TETRA4 = Element(modele=abstractElement)
ele = MIUP_TETRA4
