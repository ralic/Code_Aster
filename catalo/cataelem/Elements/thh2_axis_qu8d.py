...
ECONTNC  = LocatedComponents(phys=PHY.SIEF_C, type='ELNO',
    components=('M11','FH11X','FH11Y','ENT11','M12',
          'FH12X','FH12Y','ENT12','M21','FH21X',
          'FH21Y','ENT21','M22','FH22X','FH22Y',
          'ENT22','QPRIM','FHTX','FHTY',))
...
#------------------------------------------------------------
THH2_AXIS_QU8D = Element(modele=abstractElement)
ele = THH2_AXIS_QU8D
...
#------------------------------------------------------------
THH2_AXIS_TR6D = Element(modele=abstractElement)
ele = THH2_AXIS_TR6D
...
#------------------------------------------------------------
THH2_AXIS_QU8S = Element(modele=abstractElement)
ele = THH2_AXIS_QU8S
ele.meshType = MT.QUAD8
ele.nodes = (
        SetOfNodes('EN2', (5,6,7,8,)),
...
#------------------------------------------------------------
THH2_AXIS_TR6S = Element(modele=abstractElement)
ele = THH2_AXIS_TR6S
ele.meshType = MT.TRIA6
ele.nodes = (
        SetOfNodes('EN2', (4,5,6,)),
