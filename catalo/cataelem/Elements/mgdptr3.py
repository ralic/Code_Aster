...
DDL_MECA = LocatedComponents(phys=PHY.DEPL_R, type='ELNO',
    components=('DX','DY','EPXX','EPYY','EPZZ',
          'EPXY',))
...
#------------------------------------------------------------
MGDPTR3 = Element(modele=abstractElement)
ele = MGDPTR3
ele.meshType = MT.TRIA3
ele.elrefe=(
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG1','FPG1=FPG1','MASS=FPG3','NOEU=NOEU',), mater=('RIGI','FPG1',),),
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG1','MASS=FPG3','NOEU=NOEU',),),
    )


#------------------------------------------------------------
MGCPTR3 = Element(modele=abstractElement)
ele = MGCPTR3
ele.meshType = MT.TRIA3
ele.elrefe=(
        ElrefeLoc(MT.TR3, gauss = ('RIGI=FPG1','FPG1=FPG1','MASS=FPG3','NOEU=NOEU',), mater=('RIGI','FPG1',),),
