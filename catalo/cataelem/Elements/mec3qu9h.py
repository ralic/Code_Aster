...
ele.addCalcul(OP.CHAR_MECA_FFCO3D, te=403,
    para_in=((SP.PFFCO3D, CFORCEF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_FRCO3D, te=403,
...
ele.addCalcul(OP.CHAR_MECA_PESA_R, te=403,
...
ele.addCalcul(OP.CHAR_MECA_PRES_F, te=403,
    para_in=((SP.PGEOMER, NGEOMER), (SP.PPRESSF, CPRESSF),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_PRES_R, te=403,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
             (SP.PPRESSR, EPRESNO), ),
    para_out=((SP.PVECTUR, MVECTUR), ),
)

ele.addCalcul(OP.CHAR_MECA_PRSU_F, te=486,
...
ele.addCalcul(OP.CHAR_MECA_PRSU_R, te=486,
    para_in=((SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
...
ele.addCalcul(OP.CHAR_MECA_ROTA_R, te=403,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.CHAR_MECA_SFCO3D, te=486,
    para_in=((SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
...
ele.addCalcul(OP.CHAR_MECA_SRCO3D, te=486,
    para_in=((SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
...
ele.addCalcul(OP.CHAR_MECA_TEMP_R, te=419,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.DEGE_ELGA, te=410,
...
ele.addCalcul(OP.DEGE_ELNO, te=410,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.ECIN_ELEM, te=406,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.EPOT_ELEM, te=401,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.EPSI_ELGA, te=410,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.EPSI_ELNO, te=40,
...
ele.addCalcul(OP.FORC_NODA, te=416,
...
ele.addCalcul(OP.FULL_MECA, te=414,
...
ele.addCalcul(OP.FULL_MECA_ELAS, te=414,
...
ele.addCalcul(OP.MASS_INER, te=417,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.MASS_MECA, te=406,
...
ele.addCalcul(OP.M_GAMMA, te=406,
...
ele.addCalcul(OP.RAPH_MECA, te=414,
...
ele.addCalcul(OP.REFE_FORC_NODA, te=416,
...
ele.addCalcul(OP.REPE_GENE, te=443,
...
ele.addCalcul(OP.REPE_TENS, te=443,
    para_in=((SP.PANGREP, CCAORIE), (SP.PCACOQU, CCACOQU),
...
ele.addCalcul(OP.RIGI_MECA, te=401,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.RIGI_MECA_ELAS, te=414,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.RIGI_MECA_GE, te=402,
...
ele.addCalcul(OP.RIGI_MECA_PRSU_F, te=486,
    para_in=((SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PPRESSF, CPRESSF),
             (SP.PTEMPSR, CTEMPSR), ),
...
ele.addCalcul(OP.RIGI_MECA_PRSU_R, te=486,
    para_in=((SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PPRESSR, EPRESNO),
             ),
    para_out=((SP.PMATUNS, MMATUNS), ),
...
ele.addCalcul(OP.RIGI_MECA_SFCO3D, te=486,
    para_in=((SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
             (SP.PFFCO3D, CFORCEF), (SP.PGEOMER, NGEOMER),
             (SP.PTEMPSR, CTEMPSR), ),
    para_out=((SP.PMATUNS, MMATUNS), ),
...
ele.addCalcul(OP.RIGI_MECA_SRCO3D, te=486,
    para_in=((SP.PDEPLMR, DDL_MECA), (SP.PDEPLPR, DDL_MECA),
             (SP.PFRCO3D, EFORCNO), (SP.PGEOMER, NGEOMER),
             ),
    para_out=((SP.PMATUNS, MMATUNS), ),
...
ele.addCalcul(OP.RIGI_MECA_TANG, te=414,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PCARCRI, CCARCRI),
...
ele.addCalcul(OP.SIEF_ELGA, te=410,
    para_in=((SP.PCACOQU, CCACOQU), (SP.PDEPLAR, DDL_MECA),
             (SP.PGEOMER, NGEOMER), (SP.PMATERC, LC.CMATERC),
...
ele.addCalcul(OP.SIEF_ELNO, te=40,
...
ele.addCalcul(OP.SIGM_ELNO, te=40,
...
ele.addCalcul(OP.VARI_ELNO, te=415,
...
#------------------------------------------------------------
MEC3QU9H = Element(modele=abstractElement)
ele = MEC3QU9H
...
ele.modifyCalcul(OP.CHAR_MECA_SFCO3D, te=486)


#------------------------------------------------------------
MEC3TR7H = Element(modele=abstractElement)
ele = MEC3TR7H
