...
ele.addCalcul(OP.EFGE_ELNO, te=185,
    para_in=((SP.PCAGEPO, CCAGEPO), (SP.PCAGNPO, CCAGNPO),
             (OP.EFGE_ELNO.PCAORIE, CCAORIE), (SP.PCHDYNR, DDL_MECA),
...
ele.addCalcul(OP.SIPM_ELNO, te=149,
    para_in=((SP.PCAGEPO, LC.CCAGRPO), (SP.PCAGNPO, CCAGNPO),
             (OP.SIPM_ELNO.PCAORIE, CCAORIE), (SP.PCHDYNR, DDL_MECA),
             (SP.PCOEFFC, LC.CCOEFC), (SP.PCOEFFR, LC.CCOEFR),
             (SP.PDEPLAR, DDL_MECA), (SP.PFF1D1D, CFORCEF),
             (SP.PFR1D1D, CFORCER), (SP.PGEOMER, NGEOMER),
...
ele.addCalcul(OP.SIPO_ELNO, te=149,
    para_in=((SP.PABSCUR, CABSCUR), (SP.PCAGEPO, LC.CCAGRPO),
             (SP.PCAGNPO, CCAGNPO), (OP.SIPO_ELNO.PCAORIE, CCAORIE),
...
#------------------------------------------------------------
MECA_POU_D_E = Element(modele=abstractElement)
ele = MECA_POU_D_E
ele.meshType = MT.SEG2
ele.elrefe=(
        ElrefeLoc(MT.SE2, gauss = ('RIGI=FPG3','NOEU=NOEU','FPG1=FPG1',), mater=('RIGI','NOEU','FPG1',),),
    )
