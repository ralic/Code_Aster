...
CFER1_R  = LocatedComponents(phys=PHY.FER1_R, type='ELEM',
    components=('TYPCOMB','ENROBG','CEQUI','SIGACI','SIGBET',
          'PIVA','PIVB','ES',))

CFER2_R  = LocatedComponents(phys=PHY.FER2_R, type='ELEM',
    components=('DNSXI','DNSXS','DNSYI','DNSYS','DNST',
          'SIGMBE','EPSIBE',))
...
EERREURT = LocatedComponents(phys=PHY.ERRE_R, type='ELEM',
    components=('ERTABS','ERTREL','TERMNO','TERMVO','TERMV2',
...
EPJSIGM  = LocatedComponents(phys=PHY.SIEF_R, type='ELEM',
    components=('SIG_NX','SIG_NY','SIG_NZ','SIG_N','SIG_TX',
...
EDERANO  = LocatedComponents(phys=PHY.DERA_R, type='ELNO',
    components=('DCHA_V','DCHA_T','IND_DCHA','VAL_DCHA','X11',
          'X22','X33','X12','X13','X23',
          'RADI_V','ERR_RADI',))
