...
/* MODIF ISOMP utilitai  DATE 11/08/2009   AUTEUR LEFEBVRE J-P.LEFEBVRE */
/* ================================================================== */
...
{
#ifdef _USE_OPENMP
   static INTEGER IND_COMP_OMP=1;
#else	
   static INTEGER IND_COMP_OMP=0;
#endif	
