...
/* MODIF HPCHECK UTILITAI  DATE 02/06/2006   AUTEUR MCOURTOI M.COURTOIS */
/* ================================================================== */
...
/* on appelle la version systeme sur CRAY */
  ...
  void hpcheck_(long *errcode)
#elif defined HPUX
  void hpcheck(long *errcode)
#elif defined PPRO_NT
  void __stdcall HPCHECK(long *errcode)
#endif
