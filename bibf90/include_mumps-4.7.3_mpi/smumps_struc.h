!
!   THIS FILE IS PART OF SMUMPS VERSION 4.7.3
...
!
!     $Id: smumps_struc.h,v 1.72 2007/03/25 19:43:31 jylexcel Exp $
...
!    ----------------------------------------
         ...
         REAL*4, DIMENSION(:), POINTER :: COLSCA, ROWSCA
!
!        ------------------------------------
...
!        ------------------------------------
         ...
         REAL*4, DIMENSION(:), POINTER :: A_loc
!
!    ----------------------------------------
...
!    ----------------------------------------
         ...
         REAL*4, DIMENSION(:), POINTER :: A_ELT
!
!    -----------------
!    MPI Communicator
!    -----------------
