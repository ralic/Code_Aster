         ...
         DDL_IMPO        =FACT(statut='f',max='**',
             ...
             regles=(AU_MOINS_UN('TOUT','GROUP_MA','MAILLE','GROUP_NO','NOEUD'),
                     AU_MOINS_UN('DX','DY','DZ','DRX','DRY','DRZ','GRX','PRES','PHI',
                                 ...
                                 'H4Y','H4Z','K1','K2','K3',
                                 'PRE_FLU','LAG_FLI','LAG_FLS','LAGS_C','LAGS_F1','LAGS_F2','JUPS_C','JUPS_F1','JUPS_F2','MUS_C','MUS_F1','MUS_F2',
                                 'PR2_FLU','LA2_FLI','LA2_FLS','LAG2_C','LAG2_F1','LAG2_F2','JUP2_C','JUP2_F1','JUP2_F2','MU2_C','MU2_F1','MU2_F2',
                                 'PR3_FLU','LA3_FLI','LA3_FLS','LAG3_C','LAG3_F1','LAG3_F2',
#                                 'JUP3_C','JUP3_F1','JUP3_F2','MU3_C','MU3_F1','MU3_F2',
             ...
             JUPS_C          =SIMP(statut='f',typ='R' ),
             JUPS_F1         =SIMP(statut='f',typ='R' ),
             JUPS_F2         =SIMP(statut='f',typ='R' ),
             JUP2_C          =SIMP(statut='f',typ='R' ),
             JUP2_F1         =SIMP(statut='f',typ='R' ),
             JUP2_F2         =SIMP(statut='f',typ='R' ),
#             JUP3_C          =SIMP(statut='f',typ='R' ),
#             JUP3_F1         =SIMP(statut='f',typ='R' ),
#             JUP3_F2         =SIMP(statut='f',typ='R' ),
             MUS_C           =SIMP(statut='f',typ='R' ),
             MUS_F1          =SIMP(statut='f',typ='R' ),
             MUS_F2          =SIMP(statut='f',typ='R' ),
             MU2_C           =SIMP(statut='f',typ='R' ),
             MU2_F1          =SIMP(statut='f',typ='R' ),
             MU2_F2          =SIMP(statut='f',typ='R' ),
#             MU3_C           =SIMP(statut='f',typ='R' ),
#             MU3_F1          =SIMP(statut='f',typ='R' ),
#             MU3_F2          =SIMP(statut='f',typ='R' ),
