...
#      *******************************************
         FISSURE            =FACT(statut='o',min=1,max='**',
           ...
           b_section_ellipse   =BLOC(condition="""equal_to("SECTION", 'ELLIPSE')""",fr=tr("Fissure a section elliptique"),
           ...
           b_section_rectangle =BLOC(condition="""equal_to("SECTION", 'RECTANGLE')""",fr=tr("Fissure a section rectangulaire"),
             LISTE_COTES_BL      =SIMP(statut='f',typ='R',max='**',
...
#      ********************************
         ECOULEMENT         =FACT(statut='o',min=1,max=1,
           ...
           b_condition_1       =BLOC(condition="""equal_to("FLUIDE_ENTREE", 1)""",
           ...
           b_condition_2       =BLOC(condition="""equal_to("FLUIDE_ENTREE", 2)""",
           ...
           b_condition_3       =BLOC(condition="""equal_to("FLUIDE_ENTREE", 3)""",
                                     regles=(UN_PARMI('TEMP_ENTREE', 'TEMP_ENTREE_FO')),
           ...
           b_condition_4       =BLOC(condition="""equal_to("FLUIDE_ENTREE", 4)""",
                                     regles=(UN_PARMI('TEMP_ENTREE', 'TEMP_ENTREE_FO'),
           ...
           b_condition_5       =BLOC(condition="""equal_to("FLUIDE_ENTREE", 5)""",
                                     regles=(UN_PARMI('TITR_MASS', 'TITR_MASS_FO'),
                                             UN_PARMI('PRES_PART', 'PRES_PART_FO')),
           ...
           b_condition_6       =BLOC(condition="""equal_to("FLUIDE_ENTREE", 6)""",
                                     regles=(UN_PARMI('TEMP_ENTREE', 'TEMP_ENTREE_FO')),
                                     fr=tr("Air seul"),
             TEMP_ENTREE         =SIMP(statut='f',typ='R',fr=tr("Temperature a l'entree (degres C) [te]") ),
             TEMP_ENTREE_FO      =SIMP(statut='f',typ=(fonction_sdaster,nappe_sdaster,formule),
...
#      *****************
         ...
         MODELE_ECRE        =FACT(statut='o',min=1,max=1,
           ...
           b_ecou_gele         =BLOC(condition="""equal_to("ECOULEMENT", 'GELE')""",fr=tr("Modele d'ecoulement gele"),
           ...
           b_frottement        =BLOC(condition="""less_than('FROTTEMENT', 0)""",fr=tr("Modele d'ecoulement gele"),
           ...
           b_transchal         =BLOC(condition="""less_than('TRANSFERT_CHAL', 0)""", fr=tr("Cas diphasique"),
