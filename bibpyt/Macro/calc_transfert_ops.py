...
#....................................................................................
#On extrait les résultats otenus pour ensuite traiter le cas de la liste de fréquence
#....................................................................................
...
#................................................................................................
    ...
    for aa in lst_entr :
        if typ_resu  == tran_gene or typ_resu ==dyna_trans :
            ...
            Tcal,Ordcal=_aaa.Valeurs() # on récupère la liste d'instant pour les signaux calcules par les operateurs de dynamique
    ...
    for bb in lst_sort :
        if typ_resu  == tran_gene or typ_resu ==dyna_trans :
            ...
            TcalS,OrdcalS=_bbb.Valeurs() # on récupère la liste d'instant pour les signaux calcules par les operateurs de dynamique 
            p_calS=TcalS[1]-TcalS[0] #on calcul le pas de temps des fonctions récupèrees
  ...
  #On verifie que les calculs dynamiques ont ete faits sur les m�mes listes   
...
#..............................................
             ...
             for mm in entrain :
                if type(s_entr[mm])==fonction_c:
                   ...
                   if (Test_F[len(Test_F)-1] - LISTFREQ[len(LISTFREQ)-1])/LISTFREQ[len(LISTFREQ)-1]>1.E-6:
                      UTMESS('F', 'DYNAMIQUE_36')  #On n'a pas encore traite le cas o� la frequence finale des signaux d'entrainement est plus petite que celle des calculs dynamiques 
                      break
                   else :
                   ...
                   if (Tcal[len(Tcal)-1]-Test_T[len(Test_T)-1])/Test_T[len(Test_T)-1]>1E-8:
                      UTMESS('F', 'DYNAMIQUE_37')  #On n'a pas encore traite le cas o� l'instant final des signaux d'entrainement est plus petit que celui des calculs dynamiques 
                      break
                   else :         
                      ...
                      Ab_Lfreq.append(A)
                      Ab_L_Re.append(B)
                      Ab_L_Im.append(C)#On récupère la demi liste et on regarde si elle est compatible
    else :
         _A=[]
    ...
    #On verifie que les signaux d'entrainements sont discretises de la m�me maniere    
    ...
    #les listes valent zéro tout le temps  
...
#...................................................
    ...
    d_signal={}    
    STEST=[]
# On récupère les signaux donnes par l'utilisateur
    if SIGNAL!= None :
            ...
            for ss in l_signal:
                if type(s_sign[ss])==fonction_c:
                   ...
                   if Test_F[len(Test_F)-1]<LISTFREQ[len(LISTFREQ)-1]:
                      UTMESS('F', 'DYNAMIQUE_38')  #On n'a pas encore traite le cas o� la frequence finale des signaux mesures est plus petite que celle des calculs dynamiques 
                      break
                   else:   
                   ...
                   if (Tcal[len(Tcal)-1]-Test_T[len(Test_T)-1])/Test_T[len(Test_T)-1]>1.E-8:
                      UTMESS('F', 'DYNAMIQUE_39')  #On n'a pas encore traite le cas o� l'instant final des signaux mesures est plus petit que celui des calculs dynamiques 
                      break      
                   else : 
                      if typ_resu  == tran_gene or typ_resu ==dyna_trans :
...
#On verifie que les signaux mesures sont discretises de la m�me maniere    
