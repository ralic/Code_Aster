   ...
   if GROUP_MA_BORD and GROUP_MA:
      ...
      for i in range(0,len(l_group_ma_bord)):
         ...
         __catp1=POST_ELEM(
            MODELE=__nomoth,
            CHAM_MATER=__chmath,
            CARA_POUTRE=_F(CARA_GEOM=__catp2, LAPL_PHI=__tempe1, RT=__rt, GROUP_MA=l_group_ma[i], OPTION='CARA_TORSION' ),
         )
         ...
         __catp2=POST_ELEM(
            ...
            CARA_POUTRE=_F(CARA_GEOM=__catp1,
                           ...
                           LONGUEUR=args['LONGUEUR'], MATERIAU=args['MATERIAU'],
                           LIAISON =args['LIAISON'], OPTION='CARA_CISAILLEMENT',),
         )
         #
      #
