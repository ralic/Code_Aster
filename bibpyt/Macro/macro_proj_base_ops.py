#@ MODIF macro_proj_base_ops Macro  DATE 28/06/2011   AUTEUR COURTOIS M.COURTOIS 
# -*- coding: iso-8859-1 -*-
...
def macro_proj_base_ops(self, BASE, NB_VECT, MATR_ASSE_GENE,
                              VECT_ASSE_GENE, STOCKAGE, **args):
    """
