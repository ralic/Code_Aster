...
loi = LoiComportement(
   ...
   """,
    ...
    mc_mater=None,
    modelisation=(
        'D_PLAN_THH', 'D_PLAN_THHD', 'D_PLAN_THHS', 'AXIS_THH', 'AXIS_THHD', 'AXIS_THHS', '3D_THH',
        '3D_THHD', '3D_THHS', 'D_PLAN_THH2D', 'AXIS_THH2D', '3D_THH2D', 'D_PLAN_THH2S', 'AXIS_THH2S', '3D_THH2S'),
