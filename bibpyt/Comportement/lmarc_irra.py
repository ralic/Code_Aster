...
loi = LoiComportement(
   ...
   Pour les poutres, le fluage n'a lieu que dans le sens axial de la poutre : dans les autres directions, le comportement est élastique.""",
    ...
    nb_vari=21,
    nom_vari=(
        'XCINXX', 'XCINYY', 'XCINZZ', 'XCINXY', 'XCINXZ', 'XCINYZ', 'XCIN1XX', 'XCIN1YY', 'XCIN1ZZ', 'XCIN1XY',
        'XCIN1XZ', 'XCIN1YZ',  'XCIN2XX', 'XCIN2YY', 'XCIN2ZZ', 'XCIN2XY', 'XCIN2XZ', 'XCIN2YZ', 'EPSPEQ', 'IRVECU', 'EPSGRD'),
