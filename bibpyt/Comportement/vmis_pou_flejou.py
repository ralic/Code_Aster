#@ MODIF vmis_pou_flejou Comportement  DATE 30/06/2008   AUTEUR PROIX J-M.PROIX 
# -*- coding: iso-8859-1 -*-
...
loi = LoiComportement(
   nom            = 'VMIS_POU_FLEJOU',
   doc = """Relation de comportement globale des poutres, à écrouissage isotrope de J.L.Flejou""",
   num_lc         = 9999,
   nb_vari        = 9,
