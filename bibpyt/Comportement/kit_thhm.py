...
loi = LoiComportement(
   ...
   """,
    ...
    mc_mater=None,
    modelisation=(
        'D_PLAN_THHM', 'D_PLAN_THHMS', 'D_PLAN_THHMD', 'AXIS_THHM', 'AXIS_THHMS', 'AXIS_THHMD', '3D_THHM',
        '3D_THHMS', '3D_THHMD', 'D_PLAN_THH2MD', 'AXIS_THH2MD', '3D_THH2MD D_PLAN_THH2MS', 'AXIS_THH2MS', '3D_THH2MS'),
    deformation = ('PETIT'),
    nom_varc = None,
