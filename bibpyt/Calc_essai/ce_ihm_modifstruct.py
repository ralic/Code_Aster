...
class InterfaceModifStruct(Frame):
    ...
    def interface_modifstruct(self):
        ...
        # panneau couplage
        # --------------------
        self.couplage = InterfaceCouplage(self, self.modifstruct, self.param_visu, self.mess)
...
class InterfaceExpansion(Frame):
    ...
    def __init__(self, root, modifstruct, param_visu, mess):
        ...
        Label(f,text="Matrice raideur (support)",justify='left').grid(row=2,column=0,sticky='w')
...
class InterfaceCouplage(Frame):
    ...
    def __init__(self, root, modif_struct, param_visu, mess):
        ...
        self.param_proj_mesu = ParamProjMesuModal(frm1, "Parametres de PROJ_MESU_MODAL")
...
class InterfaceVisu(Frame):
    ...
    def __init__(self, root, modif_struct, param_visu, mess):
        ...
        self.frf_button = Button(f2,text='Reponses frequentielles',command=self.view_frf)
