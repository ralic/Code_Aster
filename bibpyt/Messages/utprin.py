#@ MODIF utprin Messages  DATE 29/09/2006   AUTEUR VABHHTS J.PELLET 
# -*- coding: iso-8859-1 -*-
...
def utprin(typmess,unite,idmess,valk,vali,valr):
   ...
   if cata_msg.has_key(numess) :
      if typmess == 'I' :
        aster.affiche(unite,"\n <"+typmess+">" + cata_msg[numess] % dicarg  )
      else:
        aster.affiche(unite,"\n <"+typmess+"> <"+idmess+">" +cata_msg[numess] % dicarg )

   else:
      aster.affiche(unite, "\n <A> Erreur programmeur. Le message : "+idmess+" n'existe pas.")
