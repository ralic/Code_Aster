#@ MODIF checksd SD  DATE 09/05/2007   AUTEUR PELLET J.PELLET 
# -*- coding: iso-8859-1 -*-
...
def check(checker, sd, l_before):
    ...
    # un petit "print" pour vérifier que l'on passe bien par "check" :
    if 1 : print "AJACOT checksd "+type_concept+" >"+sd.nomj.nomj+'<'
