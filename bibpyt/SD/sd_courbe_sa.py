...
class sd_courbe_sa(AsBase):
    ...
    ORSGT = AsColl(SDNom(debut=8), acces='NU',
                   stockage='CONTIG', modelong='VARIABLE', type='R', ltyp=8, )
    EXSGT = AsColl(SDNom(debut=8), acces='NU',
                   stockage='CONTIG', modelong='VARIABLE', type='R', ltyp=8, )
    PAROR = AsColl(SDNom(debut=8), acces='NU',
                   stockage='CONTIG', modelong='VARIABLE', type='R', ltyp=8, )
    PAREX = AsColl(SDNom(debut=8), acces='NU',
                   stockage='CONTIG', modelong='VARIABLE', type='R', ltyp=8, )
    FACOR = AsColl(SDNom(debut=8), acces='NU',
                   stockage='CONTIG', modelong='VARIABLE', type='I', )
    FACEX = AsColl(SDNom(debut=8), acces='NU',
                   stockage='CONTIG', modelong='VARIABLE', type='I', )
    CNXOR = AsColl(SDNom(debut=8), acces='NU',
                   stockage='CONTIG', modelong='VARIABLE', type='I', )
    CNXEX = AsColl(SDNom(debut=8), acces='NU',
                   stockage='CONTIG', modelong='VARIABLE', type='I', )
