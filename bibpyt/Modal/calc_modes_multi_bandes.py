...
def calc_modes_multi_bandes(self, MATR_RIGI, MATR_MASS, CALC_FREQ, SOLVEUR_MODAL,
    ...
    # pour INFO_MODE, le mot-clé facteur SOLVEUR ne doit pas contenir les mot-clés POSTTRAITEMENTS et RESI_RELA
